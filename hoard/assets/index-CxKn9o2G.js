...
void main() {
  ...
  gl_FragColor = vec4(st.x, Snew, 0.0, 0.0);
}`;function Rn({renderer:e,N:t,cell:n,half:r,worldSize:i,seaY:a=0,FLOW:o,DAMP:l,MIN_DEPTH:u,KC:d,KE:f,KD:p,KADV:m,MAXD:h,readTerrain:g}){let _=e.getContext();if(!(_&&_.getExtension&&_.getExtension(`EXT_color_buffer_float`)))return typeof console<`u`&&console.warn(`[L87] EXT_color_buffer_float unavailable — GPU flow backend cannot run; staying on CPU.`),null;let v={type:b,format:he,minFilter:s,magFilter:s,wrapS:ae,wrapT:ae,depthBuffer:!1,stencilBuffer:!1},y=[new V(t,t,v),new V(t,t,v)],x=[new V(t,t,v),new V(t,t,v)],S=[new V(t,t,v),new V(t,t,v)],w=new Float32Array(t*t*4),T=new ve(w,t,t,he,b);T.minFilter=s,T.magFilter=s,T.wrapS=T.wrapT=ae;let D=new Float32Array(t*t),O=!1,A=1,M=!0,ee=new ne,N=new de(-1,1,1,-1,0,1),P=new c(new E(2,2),null);P.frustumCulled=!1,ee.add(P);let F=new I(1/t,1/t),L=(e,t)=>new k({vertexShader:An,fragmentShader:e,uniforms:t}),te=L(jn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:F},uN:{value:t},uDt:{value:0},uFlow:{value:o},uDamp:{value:l}}),re=L(Mn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:F},uN:{value:t},uDt:{value:0},uSeaY:{value:a}}),z=L(Nn,{uState:{value:null},uTerr:{value:null},uN:{value:t},uSeaY:{value:a},uRain:{value:0},uPourCount:{value:0},uPours:{value:Array.from({length:8},()=>new H)},uPourR:{value:new Float32Array(8)}}),B=L(Pn,{uSrc:{value:T}}),oe=()=>({uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:F},uN:{value:t},uDt:{value:0},uCell:{value:n},uSeaY:{value:a},uKC:{value:d},uKE:{value:f},uKD:{value:p},uMaxD:{value:h},uMinDepth:{value:u},uErosK:{value:A}}),se=L(Fn,oe()),ce=L(In,oe()),le=L(Ln,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:F},uN:{value:t},uDt:{value:0},uSeaY:{value:a},uKADV:{value:m}});function ue(t,n){P.material=t;let r=e.getRenderTarget();e.setRenderTarget(n),e.render(ee,N),e.setRenderTarget(r)}let fe=new R;function U(t){let n=e.getRenderTarget(),r=e.getClearAlpha();e.getClearColor(fe),e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1),e.setClearColor(fe,r),e.setRenderTarget(n)}function W(){g(D);for(let e=0;e<t*t;e++)w[e*4]=D[e];T.needsUpdate=!0,ue(B,S[0])}function me(){U(y[0]),U(y[1]),U(x[0]),U(x[1])}me();let ge=t*t,_e=new Float32Array(ge*3),ye=new Float32Array(ge*2);for(let e=0;e<t;e++)for(let i=0;i<t;i++){let a=e*t+i;_e[a*3]=i*n-r,_e[a*3+1]=0,_e[a*3+2]=e*n-r,ye[a*2]=(i+.5)/t,ye[a*2+1]=(e+.5)/t}let G=[];for(let e=0;e<t-1;e++)for(let n=0;n<t-1;n++){let r=e*t+n,i=e*t+n+1,a=(e+1)*t+n,o=(e+1)*t+n+1;G.push(r,a,i,i,a,o)}let be=new ie;be.setAttribute(`position`,new j(_e,3)),be.setAttribute(`aGridUv`,new j(ye,2)),be.setIndex(G),be.boundingSphere=new pe(new H(0,0,0),i);let K={uStateTex:{value:y[0].texture},uTerrTex:{value:S[0].texture},uMinDepth:{value:u}},xe=new C({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});xe.onBeforeCompile=e=>{e.uniforms.uStateTex=K.uStateTex,e.uniforms.uTerrTex=K.uTerrTex,e.uniforms.uMinDepth=K.uMinDepth,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
