import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,Q as _,R as v,S as y,T as b,U as x,V as S,W as C,X as w,Y as T,Z as E,_ as D,a as O,b as ee,c as k,d as A,et as j,f as M,g as te,h as N,i as P,j as F,k as ne,l as re,m as I,n as ie,nt as L,o as R,p as z,q as ae,r as oe,rt as se,s as B,t as ce,tt as V,u as H,v as le,w as ue,x as de,y as fe,z as pe}from"./three-B1EZZ7Lj.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var me=Math.atan(1/Math.SQRT2),he=Math.atan(.5),ge=Math.PI/4,U={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},_e=.12,W=1.45,ve=4,ye=40,be=1.5,xe=16,Se=6,Ce=22,we=3.5,G=11,K=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),Te=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function Ee({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new L(0,.8,0),azimuth:a=ge,elevation:o=.52,distance:s=12,zoom:c=5.5}={}){let l=new S(t,e,n,r),u=new pe(-1,1,1,-1,n,r),d=U.PERSPECTIVE,f=e,m={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},h={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},g=!1,_=()=>d===U.PERSPECTIVE?l:u;function v(e){e!==d&&(d=e,d===U.ISOMETRIC||d===U.DIMETRIC?(m.elevation=d===U.ISOMETRIC?me:he,m.azimuth=Te(ge,h.azimuth),g=!0):g=!1)}function y(e,t){m.azimuth+=e,g||(m.elevation=p.clamp(m.elevation+t,_e,W))}function b(e){d===U.PERSPECTIVE?m.distance=p.clamp(m.distance*e,ve,ye):m.zoom=p.clamp(m.zoom*e,be,xe)}function x(e,t){let n=m.azimuth,r=d===U.PERSPECTIVE?m.distance*.04:m.zoom*.08,i=new L(Math.cos(n),0,-Math.sin(n)),a=new L(-Math.sin(n),0,-Math.cos(n));m.target.addScaledVector(i,e*r),m.target.addScaledVector(a,t*r)}function C(e,t){f=e/t,l.aspect=f,l.updateProjectionMatrix()}function w(e){h.azimuth=K(h.azimuth,m.azimuth,e),h.elevation=K(h.elevation,m.elevation,e),h.distance=K(h.distance,m.distance,e),h.zoom=K(h.zoom,m.zoom,e),h.target.x=K(h.target.x,m.target.x,e),h.target.y=K(h.target.y,m.target.y,e),h.target.z=K(h.target.z,m.target.z,e);let t=Math.cos(h.elevation),n=Math.sin(h.elevation),r=Math.cos(h.azimuth),i=Math.sin(h.azimuth),a=_();if(a.position.set(h.target.x+h.distance*t*i,h.target.y+h.distance*n,h.target.z+h.distance*t*r),a.lookAt(h.target),a.isOrthographicCamera){let e=h.zoom,t=e*f;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function T(e,t,n,r=!1){m.target.set(e,t,n),r&&h.target.copy(m.target)}function E(e,t=!1){m.zoom=p.clamp(e,be,xe),t&&(h.zoom=m.zoom)}return{get camera(){return _()},get mode(){return d},get azimuth(){return h.azimuth},setTarget:T,setZoom:E,get styleT(){return d===U.PERSPECTIVE?p.clamp((h.distance-Se)/(Ce-Se),0,1):p.clamp((h.zoom-we)/(G-we),0,1)},setMode:v,orbit:y,zoomBy:b,pan:x,setViewport:C,update:w}}var De={value:0},Oe=new z(`#ffffff`),ke={value:0},Ae={value:0},je={value:0},Me=new V,Ne={value:0},Pe={value:0},q=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
`;function J(e){e.uniforms.uVector=De,e.uniforms.uVecTint={value:Oe},e.uniforms.uVecShadow=ke,e.uniforms.uSnow=Ae,e.uniforms.uCloud=je,e.uniforms.uCloudOff={value:Me},e.uniforms.uFogCharm=Ne}function Fe(e){return e.replace(`#include <fog_fragment>`,`
    #ifdef USE_FOG
...
#include <shadowmask_pars_fragment>`)}var Ie=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Le(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new z(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{J(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new z(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=Y(e.vertexShader),e.fragmentShader=Fe(X(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function Z(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{J(e),s||(e.uniforms.uVecColor={value:new z(t)}),c&&(e.uniforms.uGlow={value:new z(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=Pe),e.vertexShader=Y(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
`:``),f=c?`uGlow * mix(uGlowDay, uGlowNight, uWindowGlow)`:`vec3(0.0)`,p=Fe(X(e.fragmentShader.replace(`#include <common>`,`#include <common>
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Gt={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Kt=[`gb`,`8-bit`,`16-bit`,`modern`];function qt(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new z(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new te(n,t,1,d,de);return r.minFilter=f,r.magFilter=f,r.needsUpdate=!0,r}var Jt=220,Yt={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Xt={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Zt({demo:e=!1,citySeed:n=0,profileIndex:r=0}={}){let i=new ie({antialias:!0,preserveDrawingBuffer:!0});i.shadowMap.enabled=!0,i.shadowMap.type=1,i.shadowMap.autoUpdate=!1,i.shadowMap.needsUpdate=!0;let a=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);i.setPixelRatio(Math.min(window.devicePixelRatio,a?1.5:2)),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(920327,1),document.body.appendChild(i.domElement);let s=i.getDrawingBufferSize(new V),c=new T;c.fog=new y(10465470,0);let l=new z(`#aeb6c0`),h=.062,_=new z(`#74508f`),v=new z,b=Ee({aspect:window.innerWidth/window.innerHeight}),S=at({t:.5}),C={type:ue,format:d,minFilter:f,magFilter:f,wrapS:M,wrapT:M,depthBuffer:!1,stencilBuffer:!1},E=[new se(256,256,C),new se(256,256,C),new se(256,256,C)];for(let e of E)i.setRenderTarget(e),i.clear();i.setRenderTarget(null);let O=new T,ee=new pe(-1,1,1,-1,0,1),A=new w({vertexShader:It,fragmentShader:Lt,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new V(1/256,1/256)},uMouse:{value:new V(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new L)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new L)}}});O.add(new g(new x(2,2),A));let j=new se(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!0,stencilBuffer:!1});function te(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new k(t);return r.colorSpace=u,r}let N=new g(new x(28,28),new o({map:te(e)}));N.rotation.x=-Math.PI/2,N.position.y=-.35,c.add(N);let P=new g(new x(40,24),new w({depthWrite:!1,vertexShader:Pt,fragmentShader:Ft,uniforms:{uTime:{value:0},uInk:{value:S.horizon},uGold:{value:S.sky},uFogColor:{value:v},uFogAmt:{value:0},uFogCharm:Ne}}));P.position.set(0,3,-8),c.add(P);let F=new w({vertexShader:Rt,fragmentShader:zt,uniforms:{uHeight:{value:null},uScene:{value:j.texture},uTexel:{value:new V(1/256,1/256)},uResolution:{value:new V(s.x,s.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new m},uLightDir:{value:S.sunDir},uInk:{value:new z(`#2A2218`)},uGold:{value:new z(`#B89968`)},uVector:De,uVecWater:{value:new z(`#1fb8d8`)},uVecTint:{value:Oe}}}),ne=new g(new x(28,28,255,255),F);ne.rotation.x=-Math.PI/2,ne.updateMatrixWorld(!0),F.uniforms.uNormalMatrix.value.getNormalMatrix(ne.matrixWorld),c.add(ne);let re={value:0},I=Ot({windowGlow:re}),R=Ze({seed:n,profileIndex:r,landmarkFactory:I,windowGlow:re});c.add(R.group);let ae=ut({plinthTop:.3,extent:R.extent,profile:R.state.profile});c.add(ae.group);let oe=gt({extent:R.extent,waterSize:28,plinthTop:.3});c.add(oe.group),A.uniforms.uWakeDrops.value=oe.wakeDrops;let B=At({extent:R.extent});c.add(B.group),A.uniforms.uRainDrops.value=B.rainDrops;let ce=Mt({extent:R.extent});c.add(ce.group),R.group.remove(R.key),c.add(R.key),R.key.castShadow=!0,R.key.shadow.mapSize.set(2048,2048),R.key.shadow.bias=-18e-5,R.key.shadow.normalBias=.028,c.add(R.key.target);function H(){let e=R.key.shadow.camera,t=R.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),i.shadowMap.needsUpdate=!0}H();let le=new D(s.x,s.y),de=new se(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!0,stencilBuffer:!1,depthTexture:le}),fe=new se(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),me=new se(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),he=new se(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),ge=new T,U=new pe(-1,1,1,-1,0,1),_e=new g(new x(2,2));ge.add(_e);let W=new w({vertexShader:It,fragmentShader:Bt,uniforms:{uScene:{value:de.texture},uTime:{value:0},uResolution:{value:new V(s.x,s.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),ve=e=>{let t=e.map(e=>new z(e));for(;t.length<8;)t.push(new z(0,0,0));return t},ye=[`night`,`dawn`,`noon`,`dusk`],be={inkgold:ye.map(e=>ve(Yt[e])),terminal:ye.map(e=>ve(Xt[e]))},xe=new w({vertexShader:It,fragmentShader:Vt,uniforms:{uScene:{value:fe.texture},uResolution:{value:new V(s.x,s.y)},uPixelSize:{value:Jt},uPalette:{value:be.inkgold[2]},uPaletteB:{value:be.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),Se=new w({vertexShader:It,fragmentShader:Wt,uniforms:{uScene:{value:fe.texture},uResolution:{value:new V(s.x,s.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:qt(Gt[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Ce={};for(let e of Kt)Ce[e]=Gt[e].palette?qt(Gt[e].palette):null;let we=new w({vertexShader:It,fragmentShader:Ht,uniforms:{uScene:{value:fe.texture},uDepth:{value:le},uResolution:{value:new V(s.x,s.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:S.toonFloor},uOutline:{value:S.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),G=new w({vertexShader:It,fragmentShader:Ut,uniforms:{uToon:{value:me.texture},uPixel:{value:he.texture},uBlend:{value:0}}});function K(e,t){_e.material=e,i.setRenderTarget(t),i.render(ge,U)}function Te(){b.setViewport(window.innerWidth,window.innerHeight),i.setSize(window.innerWidth,window.innerHeight);let e=i.getDrawingBufferSize(new V);return j.setSize(e.x,e.y),de.setSize(e.x,e.y),fe.setSize(e.x,e.y),me.setSize(e.x,e.y),he.setSize(e.x,e.y),F.uniforms.uResolution.value.set(e.x,e.y),W.uniforms.uResolution.value.set(e.x,e.y),xe.uniforms.uResolution.value.set(e.x,e.y),Se.uniforms.uResolution.value.set(e.x,e.y),we.uniforms.uResolution.value.set(e.x,e.y),e}let q=3,J=!1,Fe=!1,Y=`native`,X=.3,Ie=.46,Le=[`native`,...Kt],Z={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=q,window.__vector=J,window.__era=Y);let Re=0,ze=performance.now(),Be=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=Be),Be&&(i.info.autoReset=!1);let Q=null;typeof window<`u`&&(window.__loaded=!1);let Ve=0,He=new L(1,1,1),Ue=!1;function We(e){let t=Fe?be.terminal:be.inkgold,n=e%1*4,r=Math.floor(n)%4;xe.uniforms.uPalette.value=t[r],xe.uniforms.uPaletteB.value=t[(r+1)%4],xe.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Ge(e){let t=Gt[e];t&&(Se.uniforms.uGridWidth.value=t.gridWidth,Se.uniforms.uDither.value=t.dither,Se.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(Se.uniforms.uPalette.value=Ce[e],Se.uniforms.uPaletteSize.value=t.palette.length))}function Ke(){Y!==`native`&&Ge(Y)}let qe=()=>Y===`native`?xe:Se;function Je(e,t){ne.visible=!1,i.setRenderTarget(j),i.render(c,e),ne.visible=!0,i.setRenderTarget(t),i.render(c,e)}function Ye(e,t){if(ne.visible=!1,i.setRenderTarget(j),i.render(c,b.camera),ne.visible=!0,q===1||J&&q!==7&&q!==8)i.setRenderTarget(t),i.render(c,b.camera);else if(i.setRenderTarget(de),i.render(c,b.camera),q===2)W.uniforms.uGrain.value=1,W.uniforms.uChroma.value=1,K(W,t);else{W.uniforms.uGrain.value=0,W.uniforms.uChroma.value=0,K(W,fe);let n=b.camera;we.uniforms.uNear.value=n.near,we.uniforms.uFar.value=n.far,we.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Ge(e.era),Se):qe();e.kind===`pixel`?(K(r,t),window.__style=`pixel`):e.kind===`toon`?(K(we,t),window.__style=`toon`):(K(we,me),K(r,he),G.uniforms.uBlend.value=e.blend,K(G,t),window.__style=`blend`)}}function Xe(){let e=Qe(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return F.uniforms.uChromaScale.value=p.lerp(1,.5,t),e}function Qe(){if(q===1||q===2)return{kind:`none`};if(q===7)return{kind:`pixel`};if(q===8)return{kind:`toon`};let e=b.styleT;return window.__styleT=e,e<=X?{kind:`toon`}:e>=Ie?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:p.smoothstep(e,X,Ie),era:`16-bit`}}function $e(e){return q===1||q===2?``:J&&q!==7&&q!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Z[e.era||Y]||`Pixel`:e.kind===`blend`?`Toon → `+(Z[e.era]||`Pixel`):``}function et(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){if(Be){let e=i.info;Q={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}P.material.uniforms.uTime.value=t,W.uniforms.uTime.value=t,S.update(e),R.key.position.copy(S.sunDir).multiplyScalar(24),R.key.color.copy(S.sunColor),R.key.intensity=S.sunIntensity,R.fill.color.copy(S.hemiSky),R.fill.groundColor.copy(S.hemiGround),re.value=S.windowGlow;let a=B.overcast;R.key.intensity*=1-.5*a,R.key.color.lerp(l,.45*a),R.fill.intensity=1+.7*a;let o=p.smoothstep(S.sunDir.y,.06,.34),s=p.lerp(.28,1,1-S.windowGlow),u=n?o*s:0;R.key.shadow.intensity=.72*u,ke.value=.52*u,(n&&!Ue||He.distanceToSquared(S.sunDir)>2e-5)&&(i.shadowMap.needsUpdate=!0,He.copy(S.sunDir)),Ue=n;let d=1-S.windowGlow;Oe.setRGB(p.lerp(.46,1,d),p.lerp(.52,1,d),p.lerp(.74,1,d)),W.uniforms.uExposure.value=S.exposure,we.uniforms.uToonGain.value=S.toonGain,i.setClearColor(S.horizon,1),We(S.t),window.__t=S.t,ae.update(e,t,S),R.update(t),oe.update(e,t,S),A.uniforms.uWakeCount.value=oe.wakeCount,B.update(e,t),A.uniforms.uRainCount.value=B.rainDropCount;let f=B.fog*(1-d);c.fog.density=B.fog*h,v.copy(S.horizon).lerp(_,.85*f),c.fog.color.copy(v),i.setClearColor(v,1),Ne.value=B.fog,P.material.uniforms.uFogAmt.value=.7*B.fog,Ae.value=B.snow,je.value=B.cloud*.55,Me.x+=e*.018,Me.y+=e*.009,Pe.value+=(r-Pe.value)*Math.min(1,e*1.5),ce.update(e,t,S,B),Re++;let m=performance.now();m-ze>=1e3&&(window.__fps=Re,Be&&Q&&(console.log(`[perf] ${Re} fps · ~${(1e3/Math.max(1,Re)).toFixed(2)} ms · calls ${Q.calls} · tris ${Q.tris} · programs ${Q.programs} · geo ${Q.geo} · tex ${Q.tex}`),window.__perfInfo={fps:Re,...Q}),Re=0,ze=m);let[g,y,b]=E;if(A.uniforms.uPrev.value=g.texture,A.uniforms.uCurr.value=y.texture,i.setRenderTarget(b),i.render(O,ee),E=[y,b,g],F.uniforms.uHeight.value=E[1].texture,Ve<2&&typeof document<`u`&&++Ve===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function tt(e){q=e,window.__mode=q}function nt(){return J=!J,De.value=+!!J,window.__vector=J,J}function rt(e){return J=!!e,De.value=+!!J,window.__vector=J,J}function it(){return Y=Le[(Le.indexOf(Y)+1)%Le.length],window.__era=Y,Ke(),Y}function ot(){return Fe=!Fe,Fe}return{updateWorld:et,decideStyle:Xe,renderCityPipeline:Ye,renderCityBeautyTo:Je,styleHintName:$e,setPostMode:tt,toggleVector:nt,setVector:rt,cycleEra:it,togglePalette:ot,get mode(){return q},get vector(){return J},get sceneEra(){return Y},renderer:i,drawBuffer:s,scene:c,rig:b,sunRig:S,SIM:256,targets:E,simScene:O,simCamera:ee,simMaterial:A,grabRT:j,card:N,backdrop:P,WATER_SIZE:28,water:ne,waterMaterial:F,windowGlow:re,landmarkFactory:I,city:R,cityLife:ae,waterLife:oe,weatherRig:B,clouds:ce,fitShadowFrustum:H,SHADOW_DIST:24,sceneDepth:le,sceneRT:de,filmicRT:fe,toonRT:me,pixelRT:he,postScene:ge,postCamera:U,postQuad:_e,filmicMaterial:W,pixelMaterial:xe,pixelkitMaterial:Se,toonMaterial:we,mixMaterial:G,PALCACHE:be,ERA_TEX:Ce,runPass:K,OVERCAST_GREY:l,FOG_DENSITY:h,FOG_NIGHT_TINT:_,_fogColor:v,resize:Te}}var Qt=`lgr_hints_`,$t=!1;function en(){if($t||typeof document>`u`)return;$t=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  @media (prefers-reduced-motion: reduce) {
  ...
  }`,document.head.appendChild(e)}function tn({key:e,title:t=`Tips`,tips:n=[],force:r=!1}={}){let i={key:e,shown:!1,dismissed:!1,seen:!1};if(typeof window<`u`&&(window.__hints=i),typeof document>`u`||!e)return{dismiss(){},el:null};let a=Qt+e,o=!1;try{o=localStorage.getItem(a)===`1`}catch{}if(o&&!r)return i.seen=!0,{dismiss(){},el:null};en();let s=!!(window.matchMedia&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches),c=document.createElement(`div`);c.className=`lgr-hints`,c.innerHTML=`<div class="lgr-hints-card">
    ...
    `,document.head.appendChild(a),Y=document.createElement(`button`),Y.className=`hoard-bagbtn`,Y.textContent=`🎒`,Y.title=`Inventory (I)`,document.body.appendChild(Y),Y.addEventListener(`click`,()=>Ge()),X=document.createElement(`div`),X.className=`hoard-bag`,document.body.appendChild(X)}let Le=0;function Re(e,t=1.8){Pe&&(Pe.textContent=e,Pe.style.display=`block`),Le=t}let ze=Math.PI/4;function Be(e){ze=e}function Q(e,t){W={x:e,z:t}}function Ve(e){_e=e}function He(){if(typeof window<`u`&&(window.__hoardBag=Object.fromEntries(I.map(e=>[e.id,e.n]))),!X)return;let e=`<div class="panel"><h3>INVENTORY</h3><div class="slots">`;for(let t=0;t<8;t++){let n=I[t];n?e+=`<button class="slot" data-id="${n.id}" title="${cn[n.id].name}">${cn[n.id].glyph}<span class="n">${n.n}</span></button>`:e+=`<div class="slot empty"></div>`}e+=`</div><div class="craft">`,ln.forEach((t,n)=>{let r=Object.keys(t.need).every(e=>ie(e)>=t.need[e]),i=Object.entries(t.need).map(([e,t])=>`${t}${cn[e].glyph}`).join(`+`);e+=`<button data-rec="${n}" ${r?``:`disabled`}>Craft ${cn[t.out].name} (${i})</button>`}),e+=`</div><button class="close">CLOSE (I)</button></div>`,X.innerHTML=e,X.querySelectorAll(`.slot[data-id]`).forEach(e=>e.addEventListener(`click`,()=>{cn[e.dataset.id].consumable&&oe(e.dataset.id)})),X.querySelectorAll(`[data-rec]`).forEach(e=>e.addEventListener(`click`,()=>se(ln[+e.dataset.rec]))),X.querySelector(`.close`).addEventListener(`click`,()=>We())}function Ue(){!ce||V||(Ie=!0,X&&X.classList.add(`open`),He())}function We(){Ie=!1,X&&X.classList.remove(`open`)}function Ge(){Ie?We():Ue()}function Ke(e){H=e,he=5+e*2,pe=`spawning`}function qe(){T.x=0,T.z=0,T.vx=0,T.vz=0,T.hp=100,T.stamina=100,T.hunger=100,T.thirst=100,T.facing=0,T.iframe=0;for(let e of D)e.alive=!1;le=0,ue=0,de=0,V=!1,_e=!1,W=null;for(let e of k)e.hp=150,e.alive=!0,e.mesh.scale.set(1,1,1);for(let e of te)e.active=!1,e.mesh.visible=!1;I.length=0;let e=[`food`,`water`,`food`,`water`,`bandage`,`scrap`];for(let t=0;t<6;t++){let n=Math.random()*Math.PI*2,r=1.6+Math.random()*(s-2);F(Math.cos(n)*r,Math.sin(n)*r,e[t])}q&&(q.style.display=`none`),m.position.set(0,i,0),m.visible=!0,Ke(1),He()}function Je(){qe()}function Ye(e){ce=e,n.visible=e;let t=e&&c;Ee&&(Ee.style.display=t?`block`:`none`),J&&(J.style.display=t?`block`:`none`),Fe&&(Fe.style.display=t?`block`:`none`),Oe&&(Oe.style.display=e?`block`:`none`),Pe&&!e&&(Pe.style.display=`none`),q&&!e&&(q.style.display=`none`),Y&&(Y.style.display=e?`block`:`none`),We();for(let e in G)G[e]=!1;K.x=K.y=0,_e=!1,e&&qe()}let Xe=new v;function Ze(e,t,n){if(!ce||Ie)return;let r=n?n.windowGlow:0;if(ge=Math.max(0,ge-e),U=Math.max(0,U-e),w.material.opacity=Math.max(0,w.material.opacity-e*8),S.material.opacity=Math.max(0,S.material.opacity-e*6),!V){de+=e,T.iframe=Math.max(0,T.iframe-e);let n=(G.d||G.arrowright?1:0)-(G.a||G.arrowleft?1:0)+K.x,r=(G.w||G.arrowup?1:0)-(G.s||G.arrowdown?1:0)+K.y,a=Math.hypot(n,r);a>1&&(n/=a,r/=a);let o=a>.05,c=(G.shift||K.y>.95)&&T.stamina>2&&o,l=Math.cos(ze),u=Math.sin(ze),h=l*n+-u*r,g=-u*n+-l*r,_=c?5.2:3,v=1-Math.exp(-14*e);T.vx+=(h*_-T.vx)*v,T.vz+=(g*_-T.vz)*v,T.x+=T.vx*e,T.z+=T.vz*e;let y=Math.hypot(T.x,T.z);y>s&&(T.x*=s/y,T.z*=s/y,T.vx=0,T.vz=0),o&&(T.facing=Math.atan2(h,g)),T.stamina=p.clamp(T.stamina+(c?-34:22)*e,0,100),T.hunger=Math.max(0,T.hunger-.9*e),T.thirst=Math.max(0,T.thirst-1.15*e),T.hunger<=0||T.thirst<=0?T.hp=Math.max(0,T.hp-3.5*e):T.hunger>55&&T.thirst>55&&T.hp<100&&(T.hp=Math.min(100,T.hp+2*e));for(let e of te)e.active&&(e.x-T.x)**2+(e.z-T.z)**2<.3&&R(e.kind)&&(e.active=!1,e.mesh.visible=!1,He());for(let t of k){if(t.hp>=150)continue;let n=Math.cos(t.ang)*d,r=Math.sin(t.ang)*d;(n-T.x)**2+(r-T.z)**2<f*f&&(t.hp=Math.min(150,t.hp+30*e),t.hp>0&&(t.alive=!0))}T.hp<=0&&Qe(),m.position.set(T.x,i,T.z),m.rotation.y=T.facing,m.visible=!(T.iframe>0&&Math.floor(t*20)%2==0),_e&&Ce(),S.position.set(T.x,i+.06,T.z),S.rotation.z=-T.facing}let a=0;V||pe===`spawning`&&(he>0&&Math.random()<e*(H===1?3.5:6)&&(ye(r),he--),he<=0&&(pe=`fighting`));let o=0,c=1/0;for(let n=0;n<48;n++){let r=D[n];if(!r.alive){Xe.position.set(0,-60,0),Xe.scale.setScalar(0),Xe.updateMatrix(),E.setMatrixAt(n,Xe.matrix);continue}a++;let s=T.x-r.x,l=T.z-r.z,f=Math.hypot(s,l)||1;if(f<c&&(c=f),!V){let t=s/f*r.speed,n=l/f*r.speed,i=1-Math.exp(-6*e);if(r.vx+=(t-r.vx)*i,r.vz+=(n-r.vz)*i,f>.52){let t=r.x+r.vx*e,n=r.z+r.vz*e,i=Math.hypot(r.x,r.z),a=Math.hypot(t,n);if(!r.in&&i>=d&&a<4.9){let r=M(t,n);if(r.alive){let i=Math.atan2(n,t),a=4.9;t=Math.cos(i)*a,n=Math.sin(i)*a,r.hp-=15*e,r.hp<=0&&(r.hp=0,r.alive=!1)}}a<d-.1&&(r.in=!0),r.x=t,r.z=n}else T.iframe<=0&&(o=Math.max(o,r.dmg))}r.flash=Math.max(0,r.flash-e);let p=Math.sin(t*6+r.phase)*.04;Xe.position.set(r.x,i+.3*r.size*u+p,r.z),Xe.rotation.set(0,Math.atan2(r.vx,r.vz),Math.sin(t*3+r.phase)*.12),Xe.scale.setScalar(r.size*u),Xe.updateMatrix(),E.setMatrixAt(n,Xe.matrix),ee.set(rn[r.type].color),r.flash>0?ee.lerp(on,.7):ee.lerp(sn,.35*(1-r.hp/r.maxhp)),E.setColorAt(n,ee)}E.instanceMatrix.needsUpdate=!0,E.instanceColor&&(E.instanceColor.needsUpdate=!0);let l=0;for(let e of k){e.alive&&l++;let t=Math.max(0,e.hp/150);e.mesh.scale.y=e.alive?Math.max(.18,t):.12,e.mesh.position.y=i+.35*e.mesh.scale.y,e.mesh.material.color.copy(e.baseColor).lerp(sn,(1-t)*.55)}!V&&o>0&&(T.hp=Math.max(0,T.hp-o*(H===1?.5:1)),T.iframe=.6,T.hp<=0&&Qe()),!V&&pe===`fighting`&&a===0&&he<=0&&(pe=`complete`,me=2.2,Re(`WAVE ${H} CLEAR`,2)),!V&&pe===`complete`&&(me-=e,me<=0&&(Ke(H+1),Re(`WAVE ${H}`,1.4))),Le>0&&(Le-=e,Le<=0&&Pe&&(Pe.style.display=`none`)),ke&&(ke.style.width=`${T.hp}%`),Ae&&(Ae.style.width=`${T.stamina}%`),je&&(je.style.width=`${T.hunger}%`),Me&&(Me.style.width=`${T.thirst}%`),Ne&&(Ne.textContent=`WAVE ${H}   KILLS ${le}   SCORE ${ue}`),typeof window<`u`&&(window.__hoard={active:ce,dead:V,paused:Ie,hp:Math.round(T.hp),stamina:Math.round(T.stamina),hunger:Math.round(T.hunger),thirst:Math.round(T.thirst),zombies:a,barriers:l,pickups:te.filter(e=>e.active).length,inv:Object.fromEntries(I.map(e=>[e.id,e.n])),wave:H,kills:le,score:ue,weapon:`gun`,znear:+c.toFixed(2),px:+T.x.toFixed(2),pz:+T.z.toFixed(2)})}function Qe(){V=!0,_e=!1,q&&(q.querySelector(`.ds`).innerHTML=`Wave reached: ${H}<br>Kills: ${le}<br>Score: ${ue}<br>Survived: ${de.toFixed(0)}s`,q.style.display=`flex`)}return{group:n,update:Ze,setActive:Ye,setAzimuth:Be,setAim:Q,setFiring:Ve,melee:we,reset:qe,restart:Je,openBag:Ue,closeBag:We,toggleBag:Ge,addItem:R,get player(){return T},get dead(){return V},get active(){return ce},get paused(){return Ie},get inv(){return I.map(e=>({...e}))},get nearestPickup(){let e=null,t=1e9;for(let n of te){if(!n.active)continue;let r=(n.x-T.x)**2+(n.z-T.z)**2;r<t&&(t=r,e=n)}return e?{x:e.x,z:e.z}:null},setTarget(){}}}var{Timer:dn}=oe,fn=new URLSearchParams(window.location.search),pn=fn.get(`demo`)===`1`||fn.has(`capture`);window.__demo=pn;var mn=(fn.get(`city`)?Number(fn.get(`city`)):0)||Math.random()*1e9|0,hn=0,gn=Zt({demo:pn,citySeed:mn,profileIndex:hn}),{renderer:_n,scene:vn,rig:yn,sunRig:bn,city:xn,landmarkFactory:Sn}=gn,Cn=un({extent:xn.extent,plinthTop:.3});vn.add(Cn.group),window.__hoardApi=Cn;var wn=!0;window.__shadows=wn,window.__scene=`hoard`;var Tn=new L,En=new Set,Dn=6.5;function On(e){xn.group.traverse(t=>{!t.isMesh||t.userData.ground||!t.visible||(t.getWorldPosition(Tn),Math.hypot(Tn.x,Tn.z)<e&&(t.visible=!1,En.add(t)))})}function kn(){for(let e of En)e.visible=!0;En.clear()}var An=new ae,jn=new L,Mn=new L,Nn=new Set;function Pn(){for(let e of Nn)e.material&&(e.material.opacity=1,e.material.transparent=!!e.userData._wasT,e.material.depthWrite=e.userData._wasDW!==!1);Nn.clear()}function Fn(e){Pn();let t=yn.camera;for(let[n,r]of[[0,0],[.7,.4],[-.7,.4]]){Mn.set(e.x+n,.6,e.z+r),jn.subVectors(Mn,t.position);let i=jn.length();An.set(t.position,jn.normalize()),An.far=i-.4;for(let e of An.intersectObject(xn.group,!0)){let t=e.object;!t.material||t.userData.ground||Nn.has(t)||(t.userData._wasT=t.material.transparent,t.userData._wasDW=t.material.depthWrite,t.material.transparent=!0,t.material.opacity=.16,t.material.depthWrite=!1,Nn.add(t))}}}function In(){Cn.setActive(!0),On(Dn),yn.setMode(U.DIMETRIC),yn.setZoom(2.8,!0),yn.setTarget(Cn.player.x,.6,Cn.player.z,!0)}var Ln=new ae,Rn=new V,zn=new c(new L(0,1,0),-.32),Bn=new L,Vn=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,Hn=!1,Un=0,Wn=0,Gn=.005,Kn=(e,t)=>{Rn.x=e/window.innerWidth*2-1,Rn.y=-(t/window.innerHeight)*2+1};_n.domElement.addEventListener(`contextmenu`,e=>e.preventDefault()),_n.domElement.addEventListener(`mousedown`,e=>{e.button===0&&(Kn(e.clientX,e.clientY),Cn.setFiring(!0)),e.button===2&&(Hn=!0,Un=e.clientX,Wn=e.clientY)}),window.addEventListener(`mousemove`,e=>{Kn(e.clientX,e.clientY),Hn&&(yn.orbit(-(e.clientX-Un)*Gn,-(e.clientY-Wn)*Gn),Un=e.clientX,Wn=e.clientY)}),window.addEventListener(`mouseup`,()=>{Cn.setFiring(!1),Hn=!1}),_n.domElement.addEventListener(`wheel`,e=>{e.preventDefault(),yn.zoomBy(Math.exp(e.deltaY*.0015))},{passive:!1}),window.addEventListener(`keydown`,e=>{(e.key===`h`||e.key===`H`)&&(wn=!wn,window.__shadows=wn)}),Sn.whenReady.then(()=>{xn.generate(mn,hn),gn.fitShadowFrustum(),kn(),On(Dn),window.__cityReady=!0});var qn=new dn;qn.connect(document);function Jn(){qn.update();let e=Math.min(qn.getDelta(),.1);Cn.setAzimuth(yn.azimuth),Vn||(Ln.setFromCamera(Rn,yn.camera),Ln.ray.intersectPlane(zn,Bn)&&Cn.setAim(Bn.x,Bn.z)),Cn.update(e,qn.getElapsed(),bn),yn.setTarget(Cn.player.x,.6,Cn.player.z),yn.update(e),Fn(Cn.player),gn.updateWorld(e,qn.getElapsed(),{shadowsOn:wn,seasonTarget:0});let t=gn.decideStyle();gn.renderCityPipeline(t,null),requestAnimationFrame(Jn)}In(),Jn(),tn({key:`hoard`,title:`The Hoard`,tips:[`Move: WASD / arrows · on touch: the left thumb-stick`,`Aim: mouse / drag · Fire: hold click / the FIRE button · Melee: the MELEE button`,`Survive the waves · B: bag & crafting · Esc: exit`]}),window.addEventListener(`resize`,()=>{gn.resize()});