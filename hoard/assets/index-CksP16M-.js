import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,Q as _,R as v,S as y,T as b,U as x,V as S,W as C,X as w,Y as T,Z as E,_ as D,a as O,at as ee,b as k,c as A,ct as j,d as M,dt as N,et as te,f as ne,ft as P,g as re,h as F,i as ie,it as I,j as L,k as R,l as ae,lt as z,m as oe,n as B,nt as V,o as se,ot as ce,p as le,q as ue,r as de,rt as fe,s as H,st as pe,t as me,tt as U,u as he,ut as W,v as G,w as ge,x as K,y as _e,z as ve}from"./three-C1iWrYku.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var ye=Math.atan(1/Math.SQRT2),be=Math.atan(.5),xe=Math.PI/4,Se={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},Ce=.12,we=1.45,Te=4,q=40,Ee=1.5,De=16,Oe=6,ke=22,Ae=3.5,je=11,Me=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),Ne=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function Pe({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new N(0,.8,0),azimuth:a=xe,elevation:o=.52,distance:s=12,zoom:c=5.5}={}){let l=new u(t,e,n,r),f=new d(-1,1,1,-1,n,r),p=Se.PERSPECTIVE,m=e,h={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},g={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},_=!1,y=null,b=new N,x=()=>p===Se.PERSPECTIVE?l:f;function S(e){e!==p&&(p=e,p===Se.ISOMETRIC||p===Se.DIMETRIC?(h.elevation=p===Se.ISOMETRIC?ye:be,h.azimuth=Ne(xe,g.azimuth),_=!0):_=!1)}function C(e,t){h.azimuth+=e,_||(h.elevation=v.clamp(h.elevation+t,Ce,we))}function w(e){p===Se.PERSPECTIVE?h.distance=v.clamp(h.distance*e,Te,q):h.zoom=v.clamp(h.zoom*e,Ee,De)}function T(e,t){let n=h.azimuth,r=p===Se.PERSPECTIVE?h.distance*.04:h.zoom*.08,i=new N(Math.cos(n),0,-Math.sin(n)),a=new N(-Math.sin(n),0,-Math.cos(n));h.target.addScaledVector(i,e*r),h.target.addScaledVector(a,t*r)}function E(e,t){m=e/t,l.aspect=m,l.updateProjectionMatrix()}function D(e){y&&(y(b),h.target.copy(b)),g.azimuth=Me(g.azimuth,h.azimuth,e),g.elevation=Me(g.elevation,h.elevation,e),g.distance=Me(g.distance,h.distance,e),g.zoom=Me(g.zoom,h.zoom,e),g.target.x=Me(g.target.x,h.target.x,e),g.target.y=Me(g.target.y,h.target.y,e),g.target.z=Me(g.target.z,h.target.z,e);let t=Math.cos(g.elevation),n=Math.sin(g.elevation),r=Math.cos(g.azimuth),i=Math.sin(g.azimuth),a=x();if(a.position.set(g.target.x+g.distance*t*i,g.target.y+g.distance*n,g.target.z+g.distance*t*r),a.lookAt(g.target),a.isOrthographicCamera){let e=g.zoom,t=e*m;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function O(e,t,n,r=!1){h.target.set(e,t,n),r&&g.target.copy(h.target)}function ee(e,t=!1){h.zoom=v.clamp(e,Ee,De),t&&(g.zoom=h.zoom)}function k(e,{frame:t,snap:n=!1}={}){y=e,n&&(y(b),h.target.copy(b),g.target.copy(b)),t!=null&&(p===Se.PERSPECTIVE?h.distance=v.clamp(t,Te,q):h.zoom=v.clamp(t,Ee,De))}function A(){y=null}return{get camera(){return x()},get mode(){return p},get azimuth(){return g.azimuth},get following(){return!!y},setTarget:O,setZoom:ee,setFollow:k,clearFollow:A,get styleT(){return p===Se.PERSPECTIVE?v.clamp((g.distance-Oe)/(ke-Oe),0,1):v.clamp((g.zoom-Ae)/(je-Ae),0,1)},setMode:S,orbit:C,zoomBy:w,pan:T,setViewport:E,update:D}}var Fe={value:0},Ie=new F(`#ffffff`),Le={value:0},Re={value:0},ze={value:0},Be=new W,Ve={value:0},He={value:0},Ue=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
#include <shadowmask_pars_fragment>`)}var Je=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Ye(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new F(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{We(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new F(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=Ke(e.vertexShader),e.fragmentShader=Ge(qe(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function J(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{We(e),s||(e.uniforms.uVecColor={value:new F(t)}),c&&(e.uniforms.uGlow={value:new F(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=He),e.vertexShader=Ke(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
}`,gr=`const float CA_STRENGTH   = 0.0030;  
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Cr={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},wr=[`gb`,`8-bit`,`16-bit`,`modern`];function Tr(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new F(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new G(n,t,1,te,ge);return r.minFilter=C,r.magFilter=C,r.needsUpdate=!0,r}var Er=220,Dr={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Or={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function kr({demo:e=!1,citySeed:t=0,profileIndex:n=0}={}){let r=new ie({antialias:!0,preserveDrawingBuffer:!0});r.shadowMap.enabled=!0,r.shadowMap.type=1,r.shadowMap.autoUpdate=!1,r.shadowMap.needsUpdate=!0;let a=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);r.setPixelRatio(Math.min(window.devicePixelRatio,a?1.5:2)),r.setSize(window.innerWidth,window.innerHeight),r.setClearColor(920327,1),document.body.appendChild(r.domElement);let o=r.getDrawingBufferSize(new W),s=new fe;s.fog=new b(10465470,0);let u=new F(`#aeb6c0`),f=.062,p=new F(`#74508f`),m=new F,h=Pe({aspect:window.innerWidth/window.innerHeight}),g=ht({t:.5}),_={type:i,format:te,minFilter:C,magFilter:C,wrapS:oe,wrapT:oe,depthBuffer:!1,stencilBuffer:!1},y=[new P(256,256,_),new P(256,256,_),new P(256,256,_)];for(let e of y)r.setRenderTarget(e),r.clear();r.setRenderTarget(null);let T=new fe,E=new d(-1,1,1,-1,0,1),D=new I({vertexShader:fr,fragmentShader:pr,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new W(1/256,1/256)},uMouse:{value:new W(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new N)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new N)}}});T.add(new S(new w(2,2),D));let O=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!0,stencilBuffer:!1});function ee(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new he(t);return r.colorSpace=V,r}let k=new S(new w(28,28),new c({map:ee(e)}));k.rotation.x=-Math.PI/2,k.position.y=-.35,s.add(k);let A=new S(new w(40,24),new I({depthWrite:!1,vertexShader:ur,fragmentShader:dr,uniforms:{uTime:{value:0},uInk:{value:g.horizon},uGold:{value:g.sky},uFogColor:{value:m},uFogAmt:{value:0},uFogCharm:Ve}}));A.position.set(0,3,-8),s.add(A);let j=new I({vertexShader:mr,fragmentShader:hr,uniforms:{uHeight:{value:null},uScene:{value:O.texture},uTexel:{value:new W(1/256,1/256)},uResolution:{value:new W(o.x,o.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new ve},uLightDir:{value:g.sunDir},uInk:{value:new F(`#2A2218`)},uGold:{value:new F(`#B89968`)},uVector:Fe,uVecWater:{value:new F(`#1fb8d8`)},uVecTint:{value:Ie}}}),M=new S(new w(28,28,255,255),j);M.rotation.x=-Math.PI/2,M.updateMatrixWorld(!0),j.uniforms.uNormalMatrix.value.getNormalMatrix(M.matrixWorld),s.add(M);let ne={value:0},re=Ht({windowGlow:ne}),L=ct({seed:t,profileIndex:n,landmarkFactory:re,windowGlow:ne});s.add(L.group);let R=bt({plinthTop:.3,extent:L.extent,profile:L.state.profile});s.add(R.group);let ae=At({extent:L.extent,waterSize:28,plinthTop:.3});s.add(ae.group),D.uniforms.uWakeDrops.value=ae.wakeDrops;let z=Wt({extent:L.extent});s.add(z.group),D.uniforms.uRainDrops.value=z.rainDrops;let B=Kt({extent:L.extent});s.add(B.group);let se=Yt({rig:h,getCamera:()=>h.camera,sources:[R,ae,B]}),ce=lr();s.add(ce.group);let le=Kn({scale:90});s.add(le.mesh),s.environmentIntensity=.32;let ue=!1;function de(e){let t=e&&g.sunArc.y>-.04;t!==ue&&(ue=t,le.mesh.visible=t,A.visible=!t)}let H=null,pe=-1;function me(){let e=Math.floor(g.t%1*4)%4;return(e!==pe||!H)&&(pe=e,H=le.buildEnv(r)),H}let U=null,G=null,ge=null,K=null,ye=!1,be=1234,xe=`valley`,Se=tn.map(e=>e.key),Ce=new x({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),we=()=>[L.group,R.group,ae.group],Te=()=>[U,G,ge].filter(Boolean);function q(){for(let e of Te())s.remove(e),e.userData.dispose?.();let e=sn({seed:be,size:160,preset:xe});K=e,U=mn(e,{worldSize:26,baseY:0,chunks:6}),G=zn({terrain:e,seed:be,worldSize:26,baseY:0,biomeKeys:Se}),ge=Hn(e,{worldSize:26,baseY:0,maxLakes:3,material:Ce});for(let e of Te())e.visible=ye,s.add(e);typeof window<`u`&&(window.__world={seed:be,preset:xe,active:ye,chunks:U.children.length,scatter:G.userData.counts,lakes:ge.userData.count})}let Ee=e=>{for(let t of Te())t.visible=e},De=null,Oe=new Set;function ke(){!K||!ge||(s.remove(ge),ge.userData.dispose?.(),ge=Hn(K,{worldSize:26,baseY:0,maxLakes:3,material:Ce}),ge.visible=ye,s.add(ge),window.__world&&(window.__world.lakes=ge.userData.count))}function Ae(){ke(),G&&Rn(G,K,{worldSize:26,baseY:0})}function je(e,t,n=1,r=2.2,i=.05){if(!K||!U)return;let a=K.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=K.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Oe.clear();for(let e of U.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Oe.add(e)}hn(U,K,Oe),De&&clearTimeout(De),De=setTimeout(Ae,140)}function Me(e,t,n,r=2.2){if(!K||!U||n==null)return;let i=K.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=K.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);Oe.clear();for(let e of U.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Oe.add(e)}hn(U,K,Oe,!0)}let Ne=[`tree`,`rock`,`tuft`];function Ue(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!K||!G)return 0;if(a)return In(G,n||`all`,e,t,i);let o=K.size,s=26/(o-1),c=K.height,l=K.sea,u=K.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Ln[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;Fn(G,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&G.userData.counts)for(let e of Ne)G.userData.counts[e]=(G.userData.placements[e]||[]).length;return g}let We=[];function Ge(){if(!G)return null;let e=G.userData.placements,t={};for(let n of Ne)t[n]=(e[n]||[]).map(e=>({...e}));return t}function Ke(){K&&(We.push({h:K.height.slice(),b:K.biome.slice(),sc:Ge()}),We.length>12&&We.shift())}function qe(){if(!K||!We.length)return!1;let e=We.pop();if(K.height.set(e.h),K.biome.set(e.b),e.sc&&G){let t=G.userData.placements;for(let n of Ne)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return hn(U,K,U.children,!0),Ae(),!0}let Je={enter(){U||q(),ye=!0,Ee(!0);for(let e of we())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){ye=!1,Ee(!1);for(let e of we())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return be=Math.random()*1e9|0,We.length=0,q(),Je.enter(),be},reset(){return We.length=0,q(),Je.enter(),be},setPreset(e){return on.includes(e)&&(xe=e,We.length=0,q(),Je.enter()),xe},sculpt:je,paintBiome:Me,paintScatter:Ue,repoolWater:ke,snapshot:Ke,undo:qe,get terrainGroup(){return U},get biomes(){return tn},get scatterCounts(){return G?G.userData.placements&&Ne.reduce((e,t)=>(e[t]=(G.userData.placements[t]||[]).length,e),{}):null},get canUndo(){return We.length>0},get active(){return ye},get seed(){return be},get preset(){return xe},get presets(){return on}},Ye=Wn();L.group.remove(L.key),s.add(L.key),L.key.castShadow=!0,L.key.shadow.mapSize.set(2048,2048),L.key.shadow.bias=-18e-5,L.key.shadow.normalBias=.028,s.add(L.key.target);function J(){let e=L.key.shadow.camera,t=L.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),r.shadowMap.needsUpdate=!0}J();let Xe=new _e(o.x,o.y),Ze=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!0,stencilBuffer:!1,depthTexture:Xe}),Qe=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),$e=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),Y=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),et=Math.max(1,Math.floor(o.x/2)),tt=Math.max(1,Math.floor(o.y/2)),nt=new P(et,tt,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),rt=new P(et,tt,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),it=new fe,at=new d(-1,1,1,-1,0,1),ot=new S(new w(2,2));it.add(ot);let X=new I({vertexShader:fr,fragmentShader:gr,uniforms:{uScene:{value:Ze.texture},uTime:{value:0},uResolution:{value:new W(o.x,o.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:nt.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:g.grade.tint},uGradeLift:{value:g.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1}}}),st=new I({vertexShader:fr,fragmentShader:br,uniforms:{uScene:{value:Ze.texture},uThreshold:{value:.78}}}),lt=new I({vertexShader:fr,fragmentShader:xr,uniforms:{uScene:{value:nt.texture},uDir:{value:new W}}});function ut(e){st.uniforms.uScene.value=e.texture,yt(st,nt),lt.uniforms.uScene.value=nt.texture,lt.uniforms.uDir.value.set(1.6/et,0),yt(lt,rt),lt.uniforms.uScene.value=rt.texture,lt.uniforms.uDir.value.set(0,1.6/tt),yt(lt,nt),X.uniforms.uBloom.value=nt.texture;let t=1-v.clamp(g.sunArc.y*2.2,0,1);X.uniforms.uBloomStrength.value=.85*(.32+.95*t)}let dt=e=>{let t=e.map(e=>new F(e));for(;t.length<8;)t.push(new F(0,0,0));return t},ft=[`night`,`dawn`,`noon`,`dusk`],pt={inkgold:ft.map(e=>dt(Dr[e])),terminal:ft.map(e=>dt(Or[e]))},Z=new I({vertexShader:fr,fragmentShader:_r,uniforms:{uScene:{value:Qe.texture},uResolution:{value:new W(o.x,o.y)},uPixelSize:{value:Er},uPalette:{value:pt.inkgold[2]},uPaletteB:{value:pt.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),mt=new I({vertexShader:fr,fragmentShader:Sr,uniforms:{uScene:{value:Qe.texture},uResolution:{value:new W(o.x,o.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Tr(Cr[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),gt={};for(let e of wr)gt[e]=Cr[e].palette?Tr(Cr[e].palette):null;let _t=new I({vertexShader:fr,fragmentShader:vr,uniforms:{uScene:{value:Qe.texture},uDepth:{value:Xe},uResolution:{value:new W(o.x,o.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:g.toonFloor},uOutline:{value:g.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),vt=new I({vertexShader:fr,fragmentShader:yr,uniforms:{uToon:{value:$e.texture},uPixel:{value:Y.texture},uBlend:{value:0}}});function yt(e,t){ot.material=e,r.setRenderTarget(t),r.render(it,at)}function xt(){h.setViewport(window.innerWidth,window.innerHeight),r.setSize(window.innerWidth,window.innerHeight);let e=r.getDrawingBufferSize(new W);return O.setSize(e.x,e.y),Ze.setSize(e.x,e.y),Qe.setSize(e.x,e.y),$e.setSize(e.x,e.y),Y.setSize(e.x,e.y),et=Math.max(1,e.x>>1),tt=Math.max(1,e.y>>1),nt.setSize(et,tt),rt.setSize(et,tt),j.uniforms.uResolution.value.set(e.x,e.y),X.uniforms.uResolution.value.set(e.x,e.y),Z.uniforms.uResolution.value.set(e.x,e.y),mt.uniforms.uResolution.value.set(e.x,e.y),_t.uniforms.uResolution.value.set(e.x,e.y),e}let Q=3,St=!1,Ct=!1,wt=`native`,Tt=.3,Et=.46,Dt=[`native`,...wr],Ot={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=Q,window.__vector=St,window.__era=wt);let kt=0,jt=performance.now(),Mt=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=Mt),Mt&&(r.info.autoReset=!1);let Nt=null;typeof window<`u`&&(window.__loaded=!1);let $=0,Pt=new N(1,1,1),Ft=!1;function It(e){let t=Ct?pt.terminal:pt.inkgold,n=e%1*4,r=Math.floor(n)%4;Z.uniforms.uPalette.value=t[r],Z.uniforms.uPaletteB.value=t[(r+1)%4],Z.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Lt(e){let t=Cr[e];t&&(mt.uniforms.uGridWidth.value=t.gridWidth,mt.uniforms.uDither.value=t.dither,mt.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(mt.uniforms.uPalette.value=gt[e],mt.uniforms.uPaletteSize.value=t.palette.length))}function Rt(){wt!==`native`&&Lt(wt)}let zt=()=>wt===`native`?Z:mt;function Bt(e,t){de(!0),s.environment=me(),M.visible=!1,r.setRenderTarget(O),r.render(s,e),M.visible=!0,r.setRenderTarget(Ze),r.render(s,e),ut(Ze),X.uniforms.uAces.value=1,X.uniforms.uGrade.value=1,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,yt(X,t)}function Vt(e,t){let n=!St&&(Q===1||Q===2);if(de(n),s.environment=n?me():null,X.uniforms.uBloomStrength.value=0,M.visible=!1,r.setRenderTarget(O),r.render(s,h.camera),M.visible=!0,Q===1&&!n)r.setRenderTarget(t),r.render(s,h.camera);else if(Q===1)r.setRenderTarget(Ze),r.render(s,h.camera),ut(Ze),X.uniforms.uAces.value=1,X.uniforms.uGrade.value=1,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,yt(X,t);else if(r.setRenderTarget(Ze),r.render(s,h.camera),Q===2)n&&ut(Ze),X.uniforms.uAces.value=+!!n,X.uniforms.uGrade.value=+!!n,X.uniforms.uGrain.value=1,X.uniforms.uChroma.value=1,yt(X,t);else{X.uniforms.uAces.value=0,X.uniforms.uGrade.value=0,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,yt(X,Qe);let n=h.camera;_t.uniforms.uNear.value=n.near,_t.uniforms.uFar.value=n.far,_t.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Lt(e.era),mt):zt();e.kind===`pixel`?(yt(r,t),window.__style=`pixel`):e.kind===`toon`?(yt(_t,t),window.__style=`toon`):(yt(_t,$e),yt(r,Y),vt.uniforms.uBlend.value=e.blend,yt(vt,t),window.__style=`blend`)}}function Ut(){let e=Gt(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return j.uniforms.uChromaScale.value=v.lerp(1,.5,t),e}function Gt(){if(Q===1||Q===2)return{kind:`none`};if(Q===7)return{kind:`pixel`};if(Q===8)return{kind:`toon`};let e=h.styleT;return window.__styleT=e,e<=Tt?{kind:`toon`}:e>=Et?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:v.smoothstep(e,Tt,Et),era:`16-bit`}}function qt(e){return Q===1||Q===2?``:St&&Q!==7&&Q!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Ot[e.era||wt]||`Pixel`:e.kind===`blend`?`Toon → `+(Ot[e.era]||`Pixel`):``}function Jt(e,t,{shadowsOn:n=!0,seasonTarget:i=0}={}){if(Mt){let e=r.info;Nt={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}A.material.uniforms.uTime.value=t,X.uniforms.uTime.value=t,g.update(e),L.key.position.copy(g.sunDir).multiplyScalar(24),L.key.color.copy(g.sunColor),L.key.intensity=g.sunIntensity,L.fill.color.copy(g.hemiSky),L.fill.groundColor.copy(g.hemiGround),ne.value=g.windowGlow,le.setSun(g.sunArc),le.setParams(g.skyParams),X.uniforms.uGradeSat.value=g.grade.sat,X.uniforms.uGradeContrast.value=g.grade.contrast,s.environmentIntensity=.34*(1-.6*v.clamp(g.sunArc.y*1.5,0,1));let a=z.overcast;L.key.intensity*=1-.5*a,L.key.color.lerp(u,.45*a),L.fill.intensity=1+.7*a;let o=v.smoothstep(g.sunDir.y,.06,.34),c=v.lerp(.28,1,1-g.windowGlow),l=n?o*c:0;L.key.shadow.intensity=.72*l,Le.value=.52*l,(n&&!Ft||Pt.distanceToSquared(g.sunDir)>2e-5)&&(r.shadowMap.needsUpdate=!0,Pt.copy(g.sunDir)),Ft=n;let d=1-g.windowGlow;Ie.setRGB(v.lerp(.46,1,d),v.lerp(.52,1,d),v.lerp(.74,1,d)),X.uniforms.uExposure.value=g.exposure,_t.uniforms.uToonGain.value=g.toonGain,r.setClearColor(g.horizon,1),It(g.t),window.__t=g.t,R.update(e,t,g),L.update(t),ae.update(e,t,g),D.uniforms.uWakeCount.value=ae.wakeCount,z.update(e,t),D.uniforms.uRainCount.value=z.rainDropCount;let h=z.fog*(1-d);s.fog.density=z.fog*f,m.copy(g.horizon).lerp(p,.85*h),s.fog.color.copy(m),r.setClearColor(m,1),Ve.value=z.fog,A.material.uniforms.uFogAmt.value=.7*z.fog,Re.value=z.snow,ze.value=z.cloud*.55,Be.x+=e*.018,Be.y+=e*.009,He.value+=(i-He.value)*Math.min(1,e*1.5),B.update(e,t,g,z);let _=Gt(),b=_.kind===`pixel`||_.kind===`blend`?`pixel`:St||_.kind===`toon`?`charm`:`realistic`;ce.update(e,t,g,z,b),kt++;let x=performance.now();x-jt>=1e3&&(window.__fps=kt,Mt&&Nt&&(console.log(`[perf] ${kt} fps · ~${(1e3/Math.max(1,kt)).toFixed(2)} ms · calls ${Nt.calls} · tris ${Nt.tris} · programs ${Nt.programs} · geo ${Nt.geo} · tex ${Nt.tex}`),window.__perfInfo={fps:kt,...Nt}),kt=0,jt=x);let[S,C,w]=y;if(D.uniforms.uPrev.value=S.texture,D.uniforms.uCurr.value=C.texture,r.setRenderTarget(w),r.render(T,E),y=[C,w,S],j.uniforms.uHeight.value=y[1].texture,$<2&&typeof document<`u`&&++$===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Xt(e){Q=e,window.__mode=Q}function Zt(){return St=!St,Fe.value=+!!St,window.__vector=St,St}function Qt(e){return St=!!e,Fe.value=+!!St,window.__vector=St,St}function $t(){return wt=Dt[(Dt.indexOf(wt)+1)%Dt.length],window.__era=wt,Rt(),wt}function en(){return Ct=!Ct,Ct}return{updateWorld:Jt,decideStyle:Ut,renderCityPipeline:Vt,renderCityBeautyTo:Bt,styleHintName:qt,setPostMode:Xt,toggleVector:Zt,setVector:Qt,cycleEra:$t,togglePalette:en,get mode(){return Q},get vector(){return St},get sceneEra(){return wt},renderer:r,drawBuffer:o,scene:s,rig:h,sunRig:g,SIM:256,targets:y,simScene:T,simCamera:E,simMaterial:D,grabRT:O,card:k,backdrop:A,WATER_SIZE:28,water:M,waterMaterial:j,windowGlow:ne,landmarkFactory:re,city:L,cityLife:R,waterLife:ae,weatherRig:z,clouds:B,inspector:se,world:Je,catalog:Ye,fitShadowFrustum:J,SHADOW_DIST:24,sceneDepth:Xe,sceneRT:Ze,filmicRT:Qe,toonRT:$e,pixelRT:Y,postScene:it,postCamera:at,postQuad:ot,filmicMaterial:X,pixelMaterial:Z,pixelkitMaterial:mt,toonMaterial:_t,mixMaterial:vt,PALCACHE:pt,ERA_TEX:gt,runPass:yt,OVERCAST_GREY:u,FOG_DENSITY:f,FOG_NIGHT_TINT:p,_fogColor:m,resize:xt}}var Ar=`lgr_hints_`,jr=!1;function Mr(){if(jr||typeof document>`u`)return;jr=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  @media (prefers-reduced-motion: reduce) {
  ...
  }`,document.head.appendChild(e)}function Nr({key:e,title:t=`Tips`,tips:n=[],force:r=!1}={}){let i={key:e,shown:!1,dismissed:!1,seen:!1};if(typeof window<`u`&&(window.__hints=i),typeof document>`u`||!e)return{dismiss(){},el:null};let a=Ar+e,o=!1;try{o=localStorage.getItem(a)===`1`}catch{}if(o&&!r)return i.seen=!0,{dismiss(){},el:null};Mr();let s=!!(window.matchMedia&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches),c=document.createElement(`div`);c.className=`lgr-hints`,c.innerHTML=`<div class="lgr-hints-card">
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var Pr=new Set([`w`,`a`,`s`,`d`,`arrowup`,`arrowdown`,`arrowleft`,`arrowright`,`shift`,` `]),Fr={walker:{p:.6,hp:26,speed:.85,dmg:9,score:10,size:1,color:`#6f8a45`},runner:{p:.25,hp:12,speed:1.75,dmg:7,score:16,size:.82,color:`#a6d24c`},tank:{p:.15,hp:95,speed:.5,dmg:20,score:34,size:1.5,color:`#39492a`}};function Ir(){let e=Math.random();return e<Fr.walker.p?`walker`:e<Fr.walker.p+Fr.runner.p?`runner`:`tank`}var Lr=new F(`#ffffff`),Rr=new F(`#d83a2a`),zr={food:{name:`Food`,glyph:`🍖`,color:`#c8782e`,consumable:!0},water:{name:`Water`,glyph:`💧`,color:`#3aa6dc`,consumable:!0},bandage:{name:`Bandage`,glyph:`➕`,color:`#e8e2d6`,consumable:!0},scrap:{name:`Scrap`,glyph:`⚙️`,color:`#8a8f96`,consumable:!1},medkit:{name:`Medkit`,glyph:`✚`,color:`#e0524a`,consumable:!0},repairkit:{name:`Repair Kit`,glyph:`🔧`,color:`#caa05a`,consumable:!0}},Br=[{out:`medkit`,need:{bandage:2}},{out:`repairkit`,need:{scrap:3}}];function Vr({extent:e=8,plinthTop:t=.3}={}){let n=new a;n.visible=!1,n.raycast=()=>{};let r=t+.02,i=Math.max(3,e-.7),o=typeof window<`u`&&window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,l=1.25,u=4.4,d=1.4,f=new a,p=new S(new M(.16,.34,4,10),J(new x({color:`#3f7fd0`,roughness:.6,flatShading:!0}),{color:`#3f7fd0`}));p.position.y=.33;let h=new S(new ce(.13,12,9),J(new x({color:`#e9caa1`,roughness:.75,flatShading:!0}),{color:`#e9caa1`}));h.position.y=.66;let _=new S(new H(.1,.1,.16),J(new x({color:`#ffd54a`,roughness:.5,flatShading:!0}),{color:`#ffd54a`}));_.position.set(0,.38,.18),f.add(p,h,_),f.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!1),e.raycast=()=>{}}),f.scale.setScalar(1.6),f.position.y=r,n.add(f);let y=new S(new le(.95,16,-.9,1.8),new c({color:`#ffe08a`,transparent:!0,opacity:0,depthWrite:!1,side:2}));y.rotation.x=-Math.PI/2,y.position.y=r+.06,y.raycast=()=>{},n.add(y);let b=new ae().setFromPoints([new N,new N]),C=new m(b,new g({color:`#fff3c0`,transparent:!0,opacity:0,depthWrite:!1}));C.raycast=()=>{},n.add(C);let w={x:0,z:0,vx:0,vz:0,hp:100,stamina:100,hunger:100,thirst:100,facing:0,iframe:0},T=new L(new M(.15,.3,4,8),J(new x({roughness:.85,flatShading:!0})),48);T.castShadow=!0,T.receiveShadow=!1,T.frustumCulled=!1,T.raycast=()=>{},T.instanceMatrix.setUsage(K),n.add(T);let E=[];for(let e=0;e<48;e++)E.push({x:0,z:0,vx:0,vz:0,alive:!1,in:!1,type:`walker`,hp:1,maxhp:1,speed:1,dmg:0,score:0,size:1,phase:0,flash:0});let D=new F,O=[],ee=J(new x({color:`#7a5a36`,roughness:.9,flatShading:!0}),{color:`#7a5a36`});for(let e=0;e<8;e++){let t=e/8*Math.PI*2,i=new S(new H(2.1,.7,.24),ee.clone());i.position.set(Math.cos(t)*u,r+.35,Math.sin(t)*u),i.rotation.y=-t+Math.PI/2,i.castShadow=!0,i.raycast=()=>{},n.add(i),O.push({mesh:i,ang:t,hp:150,alive:!0,baseColor:new F(`#7a5a36`)})}function k(e,t){let n=Math.atan2(t,e);return n<0&&(n+=Math.PI*2),O[Math.round(n/(Math.PI*2/8))%8]}let A=[];for(let e=0;e<14;e++){let e=new S(new H(.26,.26,.26),J(new x({roughness:.6,flatShading:!0})));e.castShadow=!0,e.visible=!1,e.raycast=()=>{},n.add(e),A.push({mesh:e,x:0,z:0,kind:`food`,active:!1})}let j=new F;function te(){let e=Math.random();return e<.36?`food`:e<.72?`water`:e<.88?`bandage`:`scrap`}function ne(e,t,n){let i=A.find(e=>!e.active);i&&(i.x=e,i.z=t,i.kind=n||te(),i.active=!0,i.mesh.position.set(e,r+.18,t),i.mesh.visible=!0,i.mesh.material.color.copy(j.set(zr[i.kind].color)))}let P=[];function re(e){let t=P.find(t=>t.id===e);return t?t.n:0}function ie(e,t=1){let n=P.find(t=>t.id===e);return n?(n.n+=t,!0):P.length<8?(P.push({id:e,n:t}),!0):!1}function I(e,t){let n=P.find(t=>t.id===e);return!n||n.n<t?!1:(n.n-=t,n.n<=0&&P.splice(P.indexOf(n),1),!0)}function R(e){if(re(e)<=0)return!1;if(e===`food`)w.hunger=Math.min(100,w.hunger+38);else if(e===`water`)w.thirst=Math.min(100,w.thirst+38);else if(e===`bandage`)w.hp=Math.min(100,w.hp+40);else if(e===`medkit`)w.hp=Math.min(100,w.hp+90);else if(e===`repairkit`){let e=null;for(let t of O)(!e||t.hp<e.hp)&&(e=t);e&&(e.hp=150,e.alive=!0)}else return!1;return I(e,1),Ke(),!0}function z(e){for(let t in e.need)if(re(t)<e.need[t])return!1;for(let t in e.need)I(t,e.need[t]);return ie(e.out,1),Ke(),!0}let oe=!1,B=!1,V=1,se=0,ue=0,de=0,fe=`spawning`,pe=0,me=0,U=0,he=0,W=!1,G=null;function ge(){for(let e=0;e<48;e++)if(!E[e].alive)return E[e];return null}function _e(e){let t=ge();if(!t)return;let n=Fr[Ir()];t.type=Object.keys(Fr).find(e=>Fr[e]===n)||`walker`;let r=Math.random()*Math.PI*2;t.x=Math.cos(r)*i,t.z=Math.sin(r)*i,t.vx=0,t.vz=0;let a=1+V*.08;t.maxhp=n.hp*a,t.hp=t.maxhp,t.speed=n.speed*(1+.4*e)*(1+V*.015)*(V===1?.85:1),t.dmg=n.dmg,t.score=n.score,t.size=n.size,t.phase=Math.random()*6.28,t.flash=0,t.in=!1,t.alive=!0}function ve(){let e=null,t=1/0;for(let n of E){if(!n.alive)continue;let r=(n.x-w.x)**2+(n.z-w.z)**2;r<t&&(t=r,e=n)}return e}function ye(e){e.alive=!1,se++,ue+=e.score,Math.random()<.3&&ne(e.x,e.z)}function be(e,t){e.hp-=t,e.flash=.12,e.hp<=0&&ye(e)}function xe(){if(B||U>0)return;U=.16;let e,t;if(G)e=G.x-w.x,t=G.z-w.z;else{let n=ve();n?(e=n.x-w.x,t=n.z-w.z):(e=Math.sin(w.facing),t=Math.cos(w.facing))}let n=Math.hypot(e,t)||1;e/=n,t/=n,w.facing=Math.atan2(e,t);let i=null,a=1/0;for(let n of E){if(!n.alive)continue;let r=n.x-w.x,o=n.z-w.z,s=r*e+o*t;s<0||s>9||Math.abs(r*t-o*e)<.7*(.4+.6*n.size)&&s<a&&(a=s,i=n)}let o=i?a:9,s=b.attributes.position;s.setXYZ(0,w.x,r+.5,w.z),s.setXYZ(1,w.x+e*o,r+.5,w.z+t*o),s.needsUpdate=!0,C.material.opacity=.95,i&&be(i,16)}function Se(){if(B||he>0)return;he=.42,y.material.opacity=.85;let e=Math.sin(w.facing),t=Math.cos(w.facing);for(let n of E){if(!n.alive)continue;let r=n.x-w.x,i=n.z-w.z,a=Math.hypot(r,i);a>1.05+n.size*.2||(r*e+i*t)/(a||1)>.2&&be(n,34)}}let Ce={},we={x:0,y:0};function Te(e,t){if(!oe)return;let n=e.key.toLowerCase();if(t&&n===`i`){e.stopImmediatePropagation(),Ye();return}if(t&&n===`escape`&&ze){e.stopImmediatePropagation(),Je();return}if(Pr.has(n)){if(e.stopImmediatePropagation(),n.startsWith(`arrow`)&&e.preventDefault(),n===` `){t&&Se();return}Ce[n]=t}}typeof window<`u`&&(window.addEventListener(`keydown`,e=>Te(e,!0)),window.addEventListener(`keyup`,e=>Te(e,!1)));let q=null,Ee=null,De=null,Oe=null,ke=null,Ae=null,je=null,Me=null,Ne=null,Pe=null,Fe=null,Ie=null,Le=null,Re=null,ze=!1;if(typeof document<`u`){let e=document.createElement(`style`);e.textContent=`
    ...
    `,document.head.appendChild(e),q=document.createElement(`div`),q.className=`hoard-stick`,Ee=document.createElement(`div`),Ee.className=`knob`,q.appendChild(Ee),document.body.appendChild(q);let t=!1,n=e=>{let t=q.getBoundingClientRect(),n=e.clientX-(t.left+t.width/2),r=e.clientY-(t.top+t.height/2),i=Math.hypot(n,r)||1;i>44&&(n*=44/i,r*=44/i),Ee.style.transform=`translate(${n}px,${r}px)`,we.x=n/44,we.y=-r/44};q.addEventListener(`pointerdown`,e=>{t=!0,q.setPointerCapture(e.pointerId),n(e)}),q.addEventListener(`pointermove`,e=>{t&&n(e)});let r=()=>{t=!1,we.x=0,we.y=0,Ee.style.transform=`translate(0,0)`};q.addEventListener(`pointerup`,r),q.addEventListener(`pointercancel`,r),Fe=document.createElement(`button`),Fe.className=`hoard-btn hoard-fire`,Fe.textContent=`FIRE`,document.body.appendChild(Fe),Ie=document.createElement(`button`),Ie.className=`hoard-btn hoard-melee`,Ie.textContent=`MELEE`,document.body.appendChild(Ie),Fe.addEventListener(`pointerdown`,e=>{e.preventDefault(),navigator.vibrate?.(12),W=!0}),Fe.addEventListener(`pointerup`,()=>{W=!1}),Fe.addEventListener(`pointercancel`,()=>{W=!1}),Ie.addEventListener(`pointerdown`,e=>{e.preventDefault(),navigator.vibrate?.(18),Se()}),De=document.createElement(`div`),De.className=`hoard-hud`,De.innerHTML=`HP<div class="bar"><i style="background:#e0524a"></i></div>STAMINA<div class="bar"><i style="background:#4ad08a"></i></div>HUNGER<div class="bar"><i style="background:#d89a3a"></i></div>THIRST<div class="bar"><i style="background:#3aa6dc"></i></div><div class="stat"></div>`,document.body.appendChild(De);let i=De.querySelectorAll(`i`);Oe=i[0],ke=i[1],Ae=i[2],je=i[3],Me=De.querySelector(`.stat`),Ne=document.createElement(`div`),Ne.className=`hoard-banner`,document.body.appendChild(Ne),Pe=document.createElement(`div`),Pe.className=`hoard-death`,Pe.innerHTML=`<h2>YOU DIED</h2><div class="ds"></div><button>RESTART</button>`,document.body.appendChild(Pe),Pe.querySelector(`button`).addEventListener(`click`,()=>Qe());let a=document.createElement(`style`);a.textContent=`
    ...
    `,document.head.appendChild(a),Le=document.createElement(`button`),Le.className=`hoard-bagbtn`,Le.textContent=`🎒`,Le.title=`Inventory (I)`,document.body.appendChild(Le),Le.addEventListener(`click`,()=>Ye()),Re=document.createElement(`div`),Re.className=`hoard-bag`,document.body.appendChild(Re)}let Be=0;function Ve(e,t=1.8){Ne&&(Ne.textContent=e,Ne.style.display=`block`),Be=t}let He=Math.PI/4;function Ue(e){He=e}function We(e,t){G={x:e,z:t}}function Ge(e){W=e}function Ke(){if(typeof window<`u`&&(window.__hoardBag=Object.fromEntries(P.map(e=>[e.id,e.n]))),!Re)return;let e=`<div class="panel"><h3>INVENTORY</h3><div class="slots">`;for(let t=0;t<8;t++){let n=P[t];n?e+=`<button class="slot" data-id="${n.id}" title="${zr[n.id].name}">${zr[n.id].glyph}<span class="n">${n.n}</span></button>`:e+=`<div class="slot empty"></div>`}e+=`</div><div class="craft">`,Br.forEach((t,n)=>{let r=Object.keys(t.need).every(e=>re(e)>=t.need[e]),i=Object.entries(t.need).map(([e,t])=>`${t}${zr[e].glyph}`).join(`+`);e+=`<button data-rec="${n}" ${r?``:`disabled`}>Craft ${zr[t.out].name} (${i})</button>`}),e+=`</div><button class="close">CLOSE (I)</button></div>`,Re.innerHTML=e,Re.querySelectorAll(`.slot[data-id]`).forEach(e=>e.addEventListener(`click`,()=>{zr[e.dataset.id].consumable&&R(e.dataset.id)})),Re.querySelectorAll(`[data-rec]`).forEach(e=>e.addEventListener(`click`,()=>z(Br[+e.dataset.rec]))),Re.querySelector(`.close`).addEventListener(`click`,()=>Je())}function qe(){!oe||B||(ze=!0,Re&&Re.classList.add(`open`),Ke())}function Je(){ze=!1,Re&&Re.classList.remove(`open`)}function Ye(){ze?Je():qe()}function Xe(e){V=e,me=5+e*2,fe=`spawning`}function Ze(){w.x=0,w.z=0,w.vx=0,w.vz=0,w.hp=100,w.stamina=100,w.hunger=100,w.thirst=100,w.facing=0,w.iframe=0;for(let e of E)e.alive=!1;se=0,ue=0,de=0,B=!1,W=!1,G=null;for(let e of O)e.hp=150,e.alive=!0,e.mesh.scale.set(1,1,1);for(let e of A)e.active=!1,e.mesh.visible=!1;P.length=0;let e=[`food`,`water`,`food`,`water`,`bandage`,`scrap`];for(let t=0;t<6;t++){let n=Math.random()*Math.PI*2,r=1.6+Math.random()*(i-2);ne(Math.cos(n)*r,Math.sin(n)*r,e[t])}Pe&&(Pe.style.display=`none`),f.position.set(0,r,0),f.visible=!0,Xe(1),Ke()}function Qe(){Ze()}function $e(e){oe=e,n.visible=e;let t=e&&o;q&&(q.style.display=t?`block`:`none`),Fe&&(Fe.style.display=t?`block`:`none`),Ie&&(Ie.style.display=t?`block`:`none`),De&&(De.style.display=e?`block`:`none`),Ne&&!e&&(Ne.style.display=`none`),Pe&&!e&&(Pe.style.display=`none`),Le&&(Le.style.display=e?`block`:`none`),Je();for(let e in Ce)Ce[e]=!1;we.x=we.y=0,W=!1,e&&Ze()}let Y=new s;function et(e,t,n){if(!oe||ze)return;let a=n?n.windowGlow:0;if(U=Math.max(0,U-e),he=Math.max(0,he-e),C.material.opacity=Math.max(0,C.material.opacity-e*8),y.material.opacity=Math.max(0,y.material.opacity-e*6),!B){de+=e,w.iframe=Math.max(0,w.iframe-e);let n=(Ce.d||Ce.arrowright?1:0)-(Ce.a||Ce.arrowleft?1:0)+we.x,a=(Ce.w||Ce.arrowup?1:0)-(Ce.s||Ce.arrowdown?1:0)+we.y,o=Math.hypot(n,a);o>1&&(n/=o,a/=o);let s=o>.05,c=(Ce.shift||we.y>.95)&&w.stamina>2&&s,l=Math.cos(He),p=Math.sin(He),m=l*n+-p*a,h=-p*n+-l*a,g=c?5.2:3,_=1-Math.exp(-14*e);w.vx+=(m*g-w.vx)*_,w.vz+=(h*g-w.vz)*_,w.x+=w.vx*e,w.z+=w.vz*e;let b=Math.hypot(w.x,w.z);b>i&&(w.x*=i/b,w.z*=i/b,w.vx=0,w.vz=0),s&&(w.facing=Math.atan2(m,h)),w.stamina=v.clamp(w.stamina+(c?-34:22)*e,0,100),w.hunger=Math.max(0,w.hunger-.9*e),w.thirst=Math.max(0,w.thirst-1.15*e),w.hunger<=0||w.thirst<=0?w.hp=Math.max(0,w.hp-3.5*e):w.hunger>55&&w.thirst>55&&w.hp<100&&(w.hp=Math.min(100,w.hp+2*e));for(let e of A)e.active&&(e.x-w.x)**2+(e.z-w.z)**2<.3&&ie(e.kind)&&(e.active=!1,e.mesh.visible=!1,Ke());for(let t of O){if(t.hp>=150)continue;let n=Math.cos(t.ang)*u,r=Math.sin(t.ang)*u;(n-w.x)**2+(r-w.z)**2<d*d&&(t.hp=Math.min(150,t.hp+30*e),t.hp>0&&(t.alive=!0))}w.hp<=0&&tt(),f.position.set(w.x,r,w.z),f.rotation.y=w.facing,f.visible=!(w.iframe>0&&Math.floor(t*20)%2==0),W&&xe(),y.position.set(w.x,r+.06,w.z),y.rotation.z=-w.facing}let o=0;B||fe===`spawning`&&(me>0&&Math.random()<e*(V===1?3.5:6)&&(_e(a),me--),me<=0&&(fe=`fighting`));let s=0,c=1/0;for(let n=0;n<48;n++){let i=E[n];if(!i.alive){Y.position.set(0,-60,0),Y.scale.setScalar(0),Y.updateMatrix(),T.setMatrixAt(n,Y.matrix);continue}o++;let a=w.x-i.x,d=w.z-i.z,f=Math.hypot(a,d)||1;if(f<c&&(c=f),!B){let t=a/f*i.speed,n=d/f*i.speed,r=1-Math.exp(-6*e);if(i.vx+=(t-i.vx)*r,i.vz+=(n-i.vz)*r,f>.52){let t=i.x+i.vx*e,n=i.z+i.vz*e,r=Math.hypot(i.x,i.z),a=Math.hypot(t,n);if(!i.in&&r>=u&&a<4.9){let r=k(t,n);if(r.alive){let i=Math.atan2(n,t),a=4.9;t=Math.cos(i)*a,n=Math.sin(i)*a,r.hp-=15*e,r.hp<=0&&(r.hp=0,r.alive=!1)}}a<u-.1&&(i.in=!0),i.x=t,i.z=n}else w.iframe<=0&&(s=Math.max(s,i.dmg))}i.flash=Math.max(0,i.flash-e);let p=Math.sin(t*6+i.phase)*.04;Y.position.set(i.x,r+.3*i.size*l+p,i.z),Y.rotation.set(0,Math.atan2(i.vx,i.vz),Math.sin(t*3+i.phase)*.12),Y.scale.setScalar(i.size*l),Y.updateMatrix(),T.setMatrixAt(n,Y.matrix),D.set(Fr[i.type].color),i.flash>0?D.lerp(Lr,.7):D.lerp(Rr,.35*(1-i.hp/i.maxhp)),T.setColorAt(n,D)}T.instanceMatrix.needsUpdate=!0,T.instanceColor&&(T.instanceColor.needsUpdate=!0);let p=0;for(let e of O){e.alive&&p++;let t=Math.max(0,e.hp/150);e.mesh.scale.y=e.alive?Math.max(.18,t):.12,e.mesh.position.y=r+.35*e.mesh.scale.y,e.mesh.material.color.copy(e.baseColor).lerp(Rr,(1-t)*.55)}!B&&s>0&&(w.hp=Math.max(0,w.hp-s*(V===1?.5:1)),w.iframe=.6,w.hp<=0&&tt()),!B&&fe===`fighting`&&o===0&&me<=0&&(fe=`complete`,pe=2.2,Ve(`WAVE ${V} CLEAR`,2)),!B&&fe===`complete`&&(pe-=e,pe<=0&&(Xe(V+1),Ve(`WAVE ${V}`,1.4))),Be>0&&(Be-=e,Be<=0&&Ne&&(Ne.style.display=`none`)),Oe&&(Oe.style.width=`${w.hp}%`),ke&&(ke.style.width=`${w.stamina}%`),Ae&&(Ae.style.width=`${w.hunger}%`),je&&(je.style.width=`${w.thirst}%`),Me&&(Me.textContent=`WAVE ${V}   KILLS ${se}   SCORE ${ue}`),typeof window<`u`&&(window.__hoard={active:oe,dead:B,paused:ze,hp:Math.round(w.hp),stamina:Math.round(w.stamina),hunger:Math.round(w.hunger),thirst:Math.round(w.thirst),zombies:o,barriers:p,pickups:A.filter(e=>e.active).length,inv:Object.fromEntries(P.map(e=>[e.id,e.n])),wave:V,kills:se,score:ue,weapon:`gun`,znear:+c.toFixed(2),px:+w.x.toFixed(2),pz:+w.z.toFixed(2)})}function tt(){B=!0,W=!1,Pe&&(Pe.querySelector(`.ds`).innerHTML=`Wave reached: ${V}<br>Kills: ${se}<br>Score: ${ue}<br>Survived: ${de.toFixed(0)}s`,Pe.style.display=`flex`)}return{group:n,update:et,setActive:$e,setAzimuth:Ue,setAim:We,setFiring:Ge,melee:Se,reset:Ze,restart:Qe,openBag:qe,closeBag:Je,toggleBag:Ye,addItem:ie,get player(){return w},get dead(){return B},get active(){return oe},get paused(){return ze},get inv(){return P.map(e=>({...e}))},get nearestPickup(){let e=null,t=1e9;for(let n of A){if(!n.active)continue;let r=(n.x-w.x)**2+(n.z-w.z)**2;r<t&&(t=r,e=n)}return e?{x:e.x,z:e.z}:null},setTarget(){}}}var{Timer:Hr}=O,Ur=new URLSearchParams(window.location.search),Wr=Ur.get(`demo`)===`1`||Ur.has(`capture`);window.__demo=Wr;var Gr=(Ur.get(`city`)?Number(Ur.get(`city`)):0)||Math.random()*1e9|0,Kr=0,qr=kr({demo:Wr,citySeed:Gr,profileIndex:Kr}),{renderer:Jr,scene:Yr,rig:Xr,sunRig:Zr,city:Qr,landmarkFactory:$r}=qr,ei=Vr({extent:Qr.extent,plinthTop:.3});Yr.add(ei.group),window.__hoardApi=ei;var ti=!0;window.__shadows=ti,window.__scene=`hoard`;var ni=new N,ri=new Set,ii=6.5;function ai(e){Qr.group.traverse(t=>{!t.isMesh||t.userData.ground||!t.visible||(t.getWorldPosition(ni),Math.hypot(ni.x,ni.z)<e&&(t.visible=!1,ri.add(t)))})}function oi(){for(let e of ri)e.visible=!0;ri.clear()}var si=new U,ci=new N,li=new N,ui=new Set;function di(){for(let e of ui)e.material&&(e.material.opacity=1,e.material.transparent=!!e.userData._wasT,e.material.depthWrite=e.userData._wasDW!==!1);ui.clear()}function fi(e){di();let t=Xr.camera;for(let[n,r]of[[0,0],[.7,.4],[-.7,.4]]){li.set(e.x+n,.6,e.z+r),ci.subVectors(li,t.position);let i=ci.length();si.set(t.position,ci.normalize()),si.far=i-.4;for(let e of si.intersectObject(Qr.group,!0)){let t=e.object;!t.material||t.userData.ground||ui.has(t)||(t.userData._wasT=t.material.transparent,t.userData._wasDW=t.material.depthWrite,t.material.transparent=!0,t.material.opacity=.16,t.material.depthWrite=!1,ui.add(t))}}}function pi(){ei.setActive(!0),ai(ii),Xr.setMode(Se.DIMETRIC),Xr.setZoom(2.8,!0),Xr.setTarget(ei.player.x,.6,ei.player.z,!0)}var mi=new U,hi=new W,gi=new T(new N(0,1,0),-.32),_i=new N,vi=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,yi=!1,bi=0,xi=0,Si=.005,Ci=(e,t)=>{hi.x=e/window.innerWidth*2-1,hi.y=-(t/window.innerHeight)*2+1};Jr.domElement.addEventListener(`contextmenu`,e=>e.preventDefault()),Jr.domElement.addEventListener(`mousedown`,e=>{e.button===0&&(Ci(e.clientX,e.clientY),ei.setFiring(!0)),e.button===2&&(yi=!0,bi=e.clientX,xi=e.clientY)}),window.addEventListener(`mousemove`,e=>{Ci(e.clientX,e.clientY),yi&&(Xr.orbit(-(e.clientX-bi)*Si,-(e.clientY-xi)*Si),bi=e.clientX,xi=e.clientY)}),window.addEventListener(`mouseup`,()=>{ei.setFiring(!1),yi=!1}),Jr.domElement.addEventListener(`wheel`,e=>{e.preventDefault(),Xr.zoomBy(Math.exp(e.deltaY*.0015))},{passive:!1}),window.addEventListener(`keydown`,e=>{(e.key===`h`||e.key===`H`)&&(ti=!ti,window.__shadows=ti)}),$r.whenReady.then(()=>{Qr.generate(Gr,Kr),qr.fitShadowFrustum(),oi(),ai(ii),window.__cityReady=!0});var wi=new Hr;wi.connect(document);function Ti(){wi.update();let e=Math.min(wi.getDelta(),.1);ei.setAzimuth(Xr.azimuth),vi||(mi.setFromCamera(hi,Xr.camera),mi.ray.intersectPlane(gi,_i)&&ei.setAim(_i.x,_i.z)),ei.update(e,wi.getElapsed(),Zr),Xr.setTarget(ei.player.x,.6,ei.player.z),Xr.update(e),fi(ei.player),qr.updateWorld(e,wi.getElapsed(),{shadowsOn:ti,seasonTarget:0});let t=qr.decideStyle();qr.renderCityPipeline(t,null),requestAnimationFrame(Ti)}pi(),Ti(),Nr({key:`hoard`,title:`The Hoard`,tips:[`Move: WASD / arrows · on touch: the left thumb-stick`,`Aim: mouse / drag · Fire: hold click / the FIRE button · Melee: the MELEE button`,`Survive the waves · B: bag & crafting · Esc: exit`]}),window.addEventListener(`resize`,()=>{qr.resize()});