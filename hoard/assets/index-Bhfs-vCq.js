...
void main() {
  ...
  gl_FragColor = vec4(st.x, Snew, 0.0, 0.0);
}`;function Vn({renderer:e,N:t,cell:n,half:r,worldSize:i,seaY:a=0,FLOW:o,DAMP:l,MIN_DEPTH:u,KC:d,KE:f,KD:p,KADV:m,MAXD:h,readTerrain:g}){let _=e.getContext();if(!(_&&_.getExtension&&_.getExtension(`EXT_color_buffer_float`)))return typeof console<`u`&&console.warn(`[L87] EXT_color_buffer_float unavailable — GPU flow backend cannot run; staying on CPU.`),null;let v={type:b,format:he,minFilter:s,magFilter:s,wrapS:se,wrapT:se,depthBuffer:!1,stencilBuffer:!1},y=[new z(t,t,v),new z(t,t,v)],x=[new z(t,t,v),new z(t,t,v)],S=[new z(t,t,v),new z(t,t,v)],w=new Float32Array(t*t*4),T=new ve(w,t,t,he,b);T.minFilter=s,T.magFilter=s,T.wrapS=T.wrapT=se;let D=new Float32Array(t*t),O=!1,A=1,M=!0,ee=new re,N=new de(-1,1,1,-1,0,1),te=new c(new E(2,2),null);te.frustumCulled=!1,ee.add(te);let P=new F(1/t,1/t),I=(e,t)=>new k({vertexShader:Nn,fragmentShader:e,uniforms:t}),ne=I(Pn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:P},uN:{value:t},uDt:{value:0},uFlow:{value:o},uDamp:{value:l}}),ie=I(Fn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:P},uN:{value:t},uDt:{value:0},uSeaY:{value:a}}),R=I(In,{uState:{value:null},uTerr:{value:null},uN:{value:t},uSeaY:{value:a},uRain:{value:0},uPourCount:{value:0},uPours:{value:Array.from({length:8},()=>new H)},uPourR:{value:new Float32Array(8)}}),oe=I(Ln,{uSrc:{value:T}}),B=()=>({uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:P},uN:{value:t},uDt:{value:0},uCell:{value:n},uSeaY:{value:a},uKC:{value:d},uKE:{value:f},uKD:{value:p},uMaxD:{value:h},uMinDepth:{value:u},uErosK:{value:A}}),ce=I(Rn,B()),le=I(zn,B()),V=I(Bn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:P},uN:{value:t},uDt:{value:0},uSeaY:{value:a},uKADV:{value:m}});function ue(t,n){te.material=t;let r=e.getRenderTarget();e.setRenderTarget(n),e.render(ee,N),e.setRenderTarget(r)}let fe=new L;function U(t){let n=e.getRenderTarget(),r=e.getClearAlpha();e.getClearColor(fe),e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1),e.setClearColor(fe,r),e.setRenderTarget(n)}function W(){g(D);for(let e=0;e<t*t;e++)w[e*4]=D[e];T.needsUpdate=!0,ue(oe,S[0])}function me(){U(y[0]),U(y[1]),U(x[0]),U(x[1])}me();let ge=t*t,_e=new Float32Array(ge*3),ye=new Float32Array(ge*2);for(let e=0;e<t;e++)for(let i=0;i<t;i++){let a=e*t+i;_e[a*3]=i*n-r,_e[a*3+1]=0,_e[a*3+2]=e*n-r,ye[a*2]=(i+.5)/t,ye[a*2+1]=(e+.5)/t}let be=[];for(let e=0;e<t-1;e++)for(let n=0;n<t-1;n++){let r=e*t+n,i=e*t+n+1,a=(e+1)*t+n,o=(e+1)*t+n+1;be.push(r,a,i,i,a,o)}let xe=new ae;xe.setAttribute(`position`,new j(_e,3)),xe.setAttribute(`aGridUv`,new j(ye,2)),xe.setIndex(be),xe.boundingSphere=new pe(new H(0,0,0),i);let G={uStateTex:{value:y[0].texture},uTerrTex:{value:S[0].texture},uMinDepth:{value:u}},Se=new C({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});Se.onBeforeCompile=e=>{e.uniforms.uStateTex=G.uStateTex,e.uniforms.uTerrTex=G.uTerrTex,e.uniforms.uMinDepth=G.uMinDepth,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,wi={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Ti=[`gb`,`8-bit`,`16-bit`,`modern`];function Ei(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new L(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new ve(n,t,1,he,b);return r.minFilter=s,r.magFilter=s,r.needsUpdate=!0,r}var Di=220,Oi={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},ki={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Ai(e){if(typeof document>`u`||document.getElementById(`lgr-nowebgl`))return;let t=document.createElement(`div`);t.id=`lgr-nowebgl`,t.style.cssText=`position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;background:#0e1116;color:#cdd6e4;font:16px/1.6 system-ui,-apple-system,sans-serif;text-align:center;padding:2rem;`,t.innerHTML=`<div style="max-width:30rem"><div style="font-size:2.4rem;margin-bottom:1rem">🌊</div><h1 style="font-size:1.3rem;margin:0 0 .6rem;color:#fff;font-weight:600">This experience needs a modern browser</h1><p style="margin:0;color:#9aa6b8">`+e+`</p></div>`,document.body&&document.body.appendChild(t)}function ji({demo:e=!1,citySeed:t=0,profileIndex:r=0}={}){let i;try{i=new ne({antialias:!0,preserveDrawingBuffer:!0})}catch(e){throw Ai(`This experience needs WebGL2 — please open it in an up-to-date browser (Chrome, Edge, Firefox, or Safari on iOS 15+) with hardware acceleration enabled.`),e}i.shadowMap.enabled=!0,i.shadowMap.type=1,i.shadowMap.autoUpdate=!1,i.shadowMap.needsUpdate=!0;let o=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches?1.5:2;i.setPixelRatio(Math.min(window.devicePixelRatio,o)),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(920327,1),document.body.appendChild(i.domElement);let l=i.getDrawingBufferSize(new F),u=!1,d=!1,p=()=>{};i.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),u=!0,typeof window<`u`&&(window.__contextLost=!0)},!1),i.domElement.addEventListener(`webglcontextrestored`,()=>{p(),u=!1,typeof window<`u`&&(window.__contextLost=!1)},!1);let m=new re;m.fog=new a(10465470,0);let g=new L(`#aeb6c0`),_=.062,v=new L(`#74508f`),y=new L,b=Le({aspect:window.innerWidth/window.innerHeight}),S=Tt({t:.5}),w=i.getContext(),T=!!(w&&w.getExtension&&(w.getExtension(`EXT_color_buffer_float`)||w.getExtension(`EXT_color_buffer_half_float`)));!T&&typeof console<`u`&&console.info(`[L90 H1] No float colour buffer (EXT_color_buffer_float/half_float) — wave sim OFF, flat-sea fallback.`);let D={type:h,format:he,minFilter:s,magFilter:s,wrapS:se,wrapT:se,depthBuffer:!1,stencilBuffer:!1},O=T?[new z(256,256,D),new z(256,256,D),new z(256,256,D)]:null;if(O){for(let e of O)i.setRenderTarget(e),i.clear();i.setRenderTarget(null)}let A=new ve(new Uint8Array([0,0,0,255]),1,1,he);A.needsUpdate=!0;let j=new re,M=new de(-1,1,1,-1,0,1),ee=new k({vertexShader:Nn,fragmentShader:mi,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new F(1/256,1/256)},uMouse:{value:new F(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new H)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new H)}}});j.add(new c(new E(2,2),ee));let N=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!0,stencilBuffer:!1});function te(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new ge(t);return r.colorSpace=U,r}let P=new c(new E(28,28),new x({map:te(e)}));P.rotation.x=-Math.PI/2,P.position.y=-.35,m.add(P);let I=new c(new E(40,24),new k({depthWrite:!1,vertexShader:fi,fragmentShader:pi,uniforms:{uTime:{value:0},uInk:{value:S.horizon},uGold:{value:S.sky},uFogColor:{value:y},uFogAmt:{value:0},uFogCharm:We}}));I.position.set(0,3,-8),m.add(I);let ie=new k({vertexShader:hi,fragmentShader:gi,uniforms:{uHeight:{value:T?null:A},uScene:{value:N.texture},uTexel:{value:new F(1/256,1/256)},uResolution:{value:new F(l.x,l.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new n},uLightDir:{value:S.sunDir},uInk:{value:new L(`#2A2218`)},uGold:{value:new L(`#B89968`)},uVector:Re,uVecWater:{value:new L(`#1fb8d8`)},uVecTint:{value:ze}}}),R=new c(new E(28,28,255,255),ie);R.rotation.x=-Math.PI/2,R.updateMatrixWorld(!0),ie.uniforms.uNormalMatrix.value.getNormalMatrix(R.matrixWorld),m.add(R);let ae={value:0},oe=Qt({windowGlow:ae}),B=_t({seed:t,profileIndex:r,landmarkFactory:oe,windowGlow:ae});m.add(B.group);let ce=At({plinthTop:.3,extent:B.extent,profile:B.state.profile});m.add(ce.group);let le=Bt({extent:B.extent,waterSize:28,plinthTop:.3});m.add(le.group),ee.uniforms.uWakeDrops.value=le.wakeDrops;let V=en({extent:B.extent});m.add(V.group),ee.uniforms.uRainDrops.value=V.rainDrops;let ue=nn({extent:B.extent});m.add(ue.group);let fe=[ce,le,ue],W=on({rig:b,getCamera:()=>b.camera,sources:fe}),pe=di();m.add(pe.group);let me=qr({scale:90});m.add(me.mesh),m.environmentIntensity=.32;let _e=!1;function ye(e){let t=e&&S.sunArc.y>-.04;t!==_e&&(_e=t,me.mesh.visible=t,I.visible=!t)}let be=null,Se=-1;p=()=>{be=null,Se=-1,i.shadowMap.needsUpdate=!0};function Ce(){let e=Math.floor(S.t%1*4)%4;return(e!==Se||!be)&&(Se=e,be=me.buildEnv(i)),be}let K=null,q=null,we=null,J=null,Te=!1,Ee=1234,De=`valley`,Oe=rr.map(e=>e.key),ke=new C({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Ae=()=>[B.group,ce.group,le.group],je=()=>[K,q,we].filter(Boolean);function Me(){for(let e of je())m.remove(e),e.userData.dispose?.();let e=cr({seed:Ee,size:160,preset:De});J=e,K=hr(e,{worldSize:26,baseY:0,chunks:6}),q=Br({terrain:e,seed:Ee,worldSize:26,baseY:0,biomeKeys:Oe}),we=Ur(e,{worldSize:26,baseY:0,maxLakes:3,material:ke});for(let e of je())e.visible=Te,m.add(e);Y!==void 0&&Y&&Y.clear(),X!==void 0&&X&&X.clear(),typeof window<`u`&&(window.__world={seed:Ee,preset:De,active:Te,chunks:K.children.length,scatter:q.userData.counts,lakes:we.userData.count})}let Ne=e=>{for(let t of je())t.visible=e};function Pe(e,t){if(!J)return 0;let{size:n,height:r,sea:i,relief:a}=J,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let Y=jn({heightAt:Pe,seaSurfaceY:0,waterY:.06});Y.group.visible=!1,m.add(Y.group),fe.push(Y);let Fe=0;function Ie(e,t){if(!J||!K)return;let{size:n,height:r,relief:i}=J,a=26/(n-1),o=26/(t-1),s=i>1e-6?1/i:0,c=!1;for(let i=0;i<t;i++)for(let l=0;l<t;l++){let u=e[i*t+l];if(u===0)continue;c=!0;let d=u*s,f=l*o/a,p=i*o/a,m=Math.max(0,Math.round(f-1)),h=Math.min(n-1,Math.round(f+1)),g=Math.max(0,Math.round(p-1)),_=Math.min(n-1,Math.round(p+1));for(let e=g;e<=_;e++)for(let t=m;t<=h;t++){let i=e*n+t,a=r[i]+d;r[i]=a<0?0:a>1?1:a}}c&&(Fe++,Fe%8==0&&gr(K,J,K.children),Fe%24==0&&q&&zr(q,J,{worldSize:26,baseY:0}))}function Ke(e,t){if(!J||!K)return;let{size:n,height:r,relief:i}=J,a=i>1e-6?1/i:0,o=(t-1)/(n-1),s=!1;for(let i=0;i<n;i++){let c=i*o,l=Math.floor(c),u=c-l,d=Math.min(t-1,l+1);for(let c=0;c<n;c++){let f=c*o,p=Math.floor(f),m=f-p,h=Math.min(t-1,p+1),g=e[l*t+p],_=e[l*t+h],v=e[d*t+p],y=e[d*t+h],b=(g*(1-m)+_*m)*(1-u)+(v*(1-m)+y*m)*u;if(b!==0){s=!0;let e=i*n+c,t=r[e]+b*a;r[e]=t<0?0:t>1?1:t}}}s&&(gr(K,J,K.children),q&&zr(q,J,{worldSize:26,baseY:0}))}let X=Hn({worldHeightAt:Pe,applyErosion:Ie,syncErodedTerrain:Ke,worldSize:26,grid:96,seaY:0,renderer:i});X.group.visible=!1,m.add(X.group);let qe=null,Je=new Set;function Ye(){!J||!we||(m.remove(we),we.userData.dispose?.(),we=Ur(J,{worldSize:26,baseY:0,maxLakes:3,material:ke}),we.visible=Te,m.add(we),window.__world&&(window.__world.lakes=we.userData.count))}function Xe(){Ye(),q&&zr(q,J,{worldSize:26,baseY:0})}function Ze(e,t,n=1,r=2.2,i=.05){if(!J||!K)return;let a=J.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=J.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Je.clear();for(let e of K.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Je.add(e)}gr(K,J,Je),qe&&clearTimeout(qe),qe=setTimeout(Xe,140)}function Z(e,t,n,r=2.2){if(!J||!K||n==null)return;let i=J.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=J.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);Je.clear();for(let e of K.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Je.add(e)}gr(K,J,Je,!0)}let $e=[`tree`,`rock`,`tuft`];function et(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!J||!q)return 0;if(a)return Lr(q,n||`all`,e,t,i);let o=J.size,s=26/(o-1),c=J.height,l=J.sea,u=J.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Rr[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;Ir(q,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&q.userData.counts)for(let e of $e)q.userData.counts[e]=(q.userData.placements[e]||[]).length;return g}let tt=[];function nt(){if(!q)return null;let e=q.userData.placements,t={};for(let n of $e)t[n]=(e[n]||[]).map(e=>({...e}));return t}function rt(){J&&(tt.push({h:J.height.slice(),b:J.biome.slice(),sc:nt(),pl:Y.snapshot()}),tt.length>12&&tt.shift())}function it(){if(!J||!tt.length)return!1;let e=tt.pop();if(J.height.set(e.h),J.biome.set(e.b),e.sc&&q){let t=q.userData.placements;for(let n of $e)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&Y.restore(e.pl),gr(K,J,K.children,!0),Xe(),!0}let at=new Set([`boat`,`fish`]),ot=new Set([`person`,`atv`]);function st(e,t,n){if(!J)return null;let r=Pe(t,n)<0;return at.has(e)&&!r||ot.has(e)&&r?null:Y.spawn(e,t,n)}function ct(e,t,n=2.5){return Y.removeNear(e,t,n)}function lt(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function ut(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let dt=e=>lt(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),ft=e=>lt(e);function pt(){let e=q?q.userData.placements:{},t={};for(let n of $e)t[n]=(e[n]||[]).map(e=>({...e}));return t}function mt(){return J?{v:1,seed:Ee,preset:De,size:J.size,height:dt(J.height),biome:ft(J.biome),scatter:pt(),entities:Y.snapshot()}:null}function ht(){if(!J)return null;let e=cr({seed:Ee,size:160,preset:De}),t=J.height,n=J.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:Ee,preset:De,hd:r,bd:i,entities:Y.snapshot()}}function gt(e){q&&(m.remove(q),q.userData.dispose?.()),q=Mr(e||{tree:[],rock:[],tuft:[]}),q.userData.counts=$e.reduce((e,t)=>(e[t]=(q.userData.placements[t]||[]).length,e),{}),q.visible=Te,m.add(q)}function vt(e){if(!e||e.v!==1)return!1;let t=25600;if(e.height!=null||e.biome!=null){if(typeof e.height!=`string`||typeof e.biome!=`string`)return!1;let n,r;try{n=ut(e.height),r=ut(e.biome)}catch{return!1}if(n.byteLength%4!=0||n.byteLength>>2!=t||r.length<t)return!1;let i=new Float32Array(n.buffer,n.byteOffset,n.byteLength>>2);for(let e=0;e<i.length;e++)if(!Number.isFinite(i[e]))return!1}if(e.hd!=null&&!Array.isArray(e.hd)||e.bd!=null&&!Array.isArray(e.bd))return!1;if(Array.isArray(e.hd))for(let n=0;n<e.hd.length;n+=2){let r=e.hd[n];if(!Number.isInteger(r)||r<0||r>=t||!Number.isFinite(e.hd[n+1]))return!1}if(Array.isArray(e.bd))for(let n=0;n<e.bd.length;n+=2){let r=e.bd[n];if(!Number.isInteger(r)||r<0||r>=t)return!1}Ee=e.seed|0,De=sr.includes(e.preset)?e.preset:De,tt.length=0,Me(),Te=!0,Ne(!0),Y.group.visible=!0,X.group.visible=!0;for(let e of Ae())e.visible=!1;window.__world&&(window.__world.active=!0);let n=e=>e<0?0:e>1?1:e,r=rr.length;if(e.height&&e.biome){let t=ut(e.height),i=new Float32Array(t.buffer,t.byteOffset,t.byteLength>>2);for(let e=0;e<i.length;e++)J.height[e]=n(i[e]);let a=ut(e.biome);for(let e=0;e<J.biome.length;e++)J.biome[e]=Math.min(r-1,a[e]|0)}else if(e.hd||e.bd){let t=e.hd||[],i=e.bd||[];for(let e=0;e<t.length;e+=2)J.height[t[e]]=n(t[e+1]);for(let e=0;e<i.length;e+=2)J.biome[i[e]]=Math.min(r-1,Math.max(0,i[e+1]|0))}return gr(K,J,K.children,!0),e.scatter&&gt(e.scatter),Ye(),q&&zr(q,J,{worldSize:26,baseY:0}),Y.restore(e.entities),window.__world&&(window.__world.scatter=q.userData.counts,window.__world.seed=Ee,window.__world.preset=De),!0}let yt={enter(){K||Me(),Te=!0,Ne(!0),Y.group.visible=!0,X.group.visible=!0;for(let e of Ae())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){Te=!1,Ne(!1),Y.group.visible=!1,X.group.visible=!1;for(let e of Ae())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return Ee=Math.random()*1e9|0,tt.length=0,Me(),yt.enter(),Ee},reset(){return tt.length=0,Me(),yt.enter(),Ee},setPreset(e){return sr.includes(e)&&(De=e,tt.length=0,Me(),yt.enter()),De},sculpt:Ze,paintBiome:Z,paintScatter:et,repoolWater:Ye,snapshot:rt,undo:it,placeEntity:st,removeEntityNear:ct,heightAt:Pe,serialize:mt,serializeCompact:ht,deserialize:vt,flowPourAt:(e,t,n,r)=>X.pourAt(e,t,n,r),flowRain:e=>X.rain(e),flowClear:()=>X.clear(),get flowTotal(){return X.totalWater()},flowAt:(e,t)=>X.cellAt(e,t),flowErosion:(e,t)=>X.setErosion(e,t),get flowErosionOn(){return X.erosion},get flowSediment(){return X.totalSediment()},setSimBackend:e=>X.setBackend(e),get simBackend(){return X.backend},_flowReadW:()=>X._debugReadW(),_flowReadTerr:()=>X._debugReadTerr(),_flowStepN:(e,t)=>X._debugStepN(e,t),get terrainGroup(){return K},get biomes(){return rr},get scatterCounts(){return q?q.userData.placements&&$e.reduce((e,t)=>(e[t]=(q.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return Y.counts()},setScatterHidden(e){q&&(q.visible=!e)},get placedLife(){return Y},get canUndo(){return tt.length>0},get active(){return Te},get seed(){return Ee},get preset(){return De},get presets(){return sr}},bt=Gr(),xt=qn({world:yt,catalog:bt,inspector:W});function St(e,t){return Pe(e,t)<0?0:-999}let Ct=vn({rig:b,world:{heightAt:Pe,waterHeightAt:St}});B.group.remove(B.key),m.add(B.key),B.key.castShadow=!0,B.key.shadow.mapSize.set(2048,2048),B.key.shadow.bias=-18e-5,B.key.shadow.normalBias=.028,m.add(B.key.target);function wt(){let e=B.key.shadow.camera,t=B.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),i.shadowMap.needsUpdate=!0}wt();let Et=new xe(l.x,l.y),Dt=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!0,stencilBuffer:!1,depthTexture:Et}),Ot=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),kt=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!0,stencilBuffer:!1,samples:4}),jt=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),Mt=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),Nt=Math.max(1,Math.floor(l.x/2)),Pt=Math.max(1,Math.floor(l.y/2)),Ft=new z(Nt,Pt,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),It=new z(Nt,Pt,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),Lt=new re,Rt=new de(-1,1,1,-1,0,1),zt=new c(new E(2,2));Lt.add(zt);let Q=new k({vertexShader:Nn,fragmentShader:_i,uniforms:{uScene:{value:Dt.texture},uTime:{value:0},uResolution:{value:new F(l.x,l.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:Ft.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:S.grade.tint},uGradeLift:{value:S.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1},uDither:{value:0},uTonemap:{value:0}}}),Vt=new k({vertexShader:Nn,fragmentShader:xi,uniforms:{uScene:{value:Dt.texture},uThreshold:{value:.78}}}),Ht=new k({vertexShader:Nn,fragmentShader:Si,uniforms:{uScene:{value:Ft.texture},uDir:{value:new F}}});function Ut(e){Vt.uniforms.uScene.value=e.texture,Zt(Vt,Ft),Ht.uniforms.uScene.value=Ft.texture,Ht.uniforms.uDir.value.set(1.6/Nt,0),Zt(Ht,It),Ht.uniforms.uScene.value=It.texture,Ht.uniforms.uDir.value.set(0,1.6/Pt),Zt(Ht,Ft),Q.uniforms.uBloom.value=Ft.texture;let t=1-G.clamp(S.sunArc.y*2.2,0,1);Q.uniforms.uBloomStrength.value=.85*(.32+.95*t)}let $=e=>{let t=e.map(e=>new L(e));for(;t.length<8;)t.push(new L(0,0,0));return t},Wt=[`night`,`dawn`,`noon`,`dusk`],Gt={inkgold:Wt.map(e=>$(Oi[e])),terminal:Wt.map(e=>$(ki[e]))},Kt=new k({vertexShader:Nn,fragmentShader:vi,uniforms:{uScene:{value:Ot.texture},uResolution:{value:new F(l.x,l.y)},uPixelSize:{value:Di},uPalette:{value:Gt.inkgold[2]},uPaletteB:{value:Gt.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),qt=new k({vertexShader:Nn,fragmentShader:Ci,uniforms:{uScene:{value:Ot.texture},uResolution:{value:new F(l.x,l.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Ei(wi[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Jt={};for(let e of Ti)Jt[e]=wi[e].palette?Ei(wi[e].palette):null;let Yt=new k({vertexShader:Nn,fragmentShader:yi,uniforms:{uScene:{value:Ot.texture},uDepth:{value:Et},uResolution:{value:new F(l.x,l.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:S.toonFloor},uOutline:{value:S.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Xt=new k({vertexShader:Nn,fragmentShader:bi,uniforms:{uToon:{value:jt.texture},uPixel:{value:Mt.texture},uBlend:{value:0}}});function Zt(e,t){zt.material=e,i.setRenderTarget(t),i.render(Lt,Rt)}function $t(){b.setViewport(window.innerWidth,window.innerHeight),i.setSize(window.innerWidth,window.innerHeight);let e=i.getDrawingBufferSize(new F);return N.setSize(e.x,e.y),Dt.setSize(e.x,e.y),Ot.setSize(e.x,e.y),kt.setSize(e.x,e.y),jt.setSize(e.x,e.y),Mt.setSize(e.x,e.y),Nt=Math.max(1,e.x>>1),Pt=Math.max(1,e.y>>1),Ft.setSize(Nt,Pt),It.setSize(Nt,Pt),ie.uniforms.uResolution.value.set(e.x,e.y),Q.uniforms.uResolution.value.set(e.x,e.y),Kt.uniforms.uResolution.value.set(e.x,e.y),qt.uniforms.uResolution.value.set(e.x,e.y),Yt.uniforms.uResolution.value.set(e.x,e.y),e}let tn=Xn({renderer:i}),rn=!0;function an(e,t){let n=t.dpr==null?o:t.dpr,r=Math.min(window.devicePixelRatio,n);Math.abs(i.getPixelRatio()-r)>.001&&(i.setPixelRatio(r),typeof window<`u`&&window.dispatchEvent?window.dispatchEvent(new Event(`resize`)):$t()),rn=t.shadows!==!1,rn||(i.shadowMap.needsUpdate=!1)}let sn=Qn({profiler:tn,apply:an});function cn(){!d&&!u&&tn.frameStart()}function ln(){d||u||(tn.frameEnd(),sn.update())}function un(e){d=!e,typeof window<`u`&&(window.__paused=d)}function dn(){try{i.compile(m,b.camera),Fn(1/60,0,{shadowsOn:!0}),kn(An(),Dt),i.setRenderTarget(null)}catch(e){typeof console<`u`&&console.warn(`[L79] prewarm`,e)}}let fn=3,pn=!1,mn=!1,hn=`native`,gn=.3,_n=.46,yn=[`native`,...Ti],bn={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=fn,window.__vector=pn,window.__era=hn),typeof window<`u`&&(window.__frames=0),typeof window<`u`&&(window.__loaded=!1);let xn=0,Sn=new H(1,1,1),Cn=!1;function wn(e){let t=mn?Gt.terminal:Gt.inkgold,n=e%1*4,r=Math.floor(n)%4;Kt.uniforms.uPalette.value=t[r],Kt.uniforms.uPaletteB.value=t[(r+1)%4],Kt.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Tn(e){let t=wi[e];t&&(qt.uniforms.uGridWidth.value=t.gridWidth,qt.uniforms.uDither.value=t.dither,qt.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(qt.uniforms.uPalette.value=Jt[e],qt.uniforms.uPaletteSize.value=t.palette.length))}function En(){hn!==`native`&&Tn(hn)}let Dn=()=>hn===`native`?Kt:qt;function On(e,t){ye(!0),m.environment=Ce(),Qe.value=1,R.visible=!1,i.setRenderTarget(N),i.render(m,e),R.visible=!0,i.setRenderTarget(kt),i.render(m,e),Ut(kt),Q.uniforms.uScene.value=kt.texture,Q.uniforms.uAces.value=1,Q.uniforms.uGrade.value=1,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=1,Zt(Q,t)}function kn(e,t){let n=!pn&&(fn===1||fn===2);if(ye(n),m.environment=n?Ce():null,Qe.value=+!!n,Q.uniforms.uBloomStrength.value=0,R.visible=!1,i.setRenderTarget(N),i.render(m,b.camera),R.visible=!0,fn===1&&!n)i.setRenderTarget(t),i.render(m,b.camera);else if(fn===1)i.setRenderTarget(kt),i.render(m,b.camera),Ut(kt),Q.uniforms.uScene.value=kt.texture,Q.uniforms.uAces.value=1,Q.uniforms.uGrade.value=1,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=1,Zt(Q,t);else if(i.setRenderTarget(n?kt:Dt),i.render(m,b.camera),fn===2)n&&Ut(kt),Q.uniforms.uScene.value=n?kt.texture:Dt.texture,Q.uniforms.uAces.value=+!!n,Q.uniforms.uGrade.value=+!!n,Q.uniforms.uGrain.value=1,Q.uniforms.uChroma.value=1,Q.uniforms.uDither.value=+!!n,Zt(Q,t);else{Q.uniforms.uScene.value=Dt.texture,Q.uniforms.uAces.value=0,Q.uniforms.uGrade.value=0,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=0,Zt(Q,Ot);let n=b.camera;Yt.uniforms.uNear.value=n.near,Yt.uniforms.uFar.value=n.far,Yt.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Tn(e.era),qt):Dn();e.kind===`pixel`?(Zt(r,t),window.__style=`pixel`):e.kind===`toon`?(Zt(Yt,t),window.__style=`toon`):(Zt(Yt,jt),Zt(r,Mt),Xt.uniforms.uBlend.value=e.blend,Zt(Xt,t),window.__style=`blend`)}}function An(){let e=Mn(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return ie.uniforms.uChromaScale.value=G.lerp(1,.5,t),e}function Mn(){if(fn===1||fn===2)return{kind:`none`};if(fn===7)return{kind:`pixel`};if(fn===8)return{kind:`toon`};let e=b.styleT;return window.__styleT=e,e<=gn?{kind:`toon`}:e>=_n?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:G.smoothstep(e,gn,_n),era:`16-bit`}}function Pn(e){return fn===1||fn===2?``:pn&&fn!==7&&fn!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?bn[e.era||hn]||`Pixel`:e.kind===`blend`?`Toon → `+(bn[e.era]||`Pixel`):``}function Fn(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){typeof window<`u`&&window.__frames++,n&&=rn,I.material.uniforms.uTime.value=t,Q.uniforms.uTime.value=t,S.update(e),B.key.position.copy(S.sunDir).multiplyScalar(24),B.key.color.copy(S.sunColor),B.key.intensity=S.sunIntensity,B.fill.color.copy(S.hemiSky),B.fill.groundColor.copy(S.hemiGround),ae.value=S.windowGlow,me.setSun(S.sunArc),me.setParams(S.skyParams),Q.uniforms.uGradeSat.value=S.grade.sat,Q.uniforms.uGradeContrast.value=S.grade.contrast,m.environmentIntensity=.34*(1-.6*G.clamp(S.sunArc.y*1.5,0,1));let a=V.overcast;B.key.intensity*=1-.5*a,B.key.color.lerp(g,.45*a),B.fill.intensity=1+.7*a;let o=G.smoothstep(S.sunDir.y,.06,.34),s=G.lerp(.28,1,1-S.windowGlow),c=n?o*s:0;B.key.shadow.intensity=.72*c,Be.value=.52*c,(n&&!Cn||Sn.distanceToSquared(S.sunDir)>2e-5)&&(i.shadowMap.needsUpdate=!0,Sn.copy(S.sunDir)),Cn=n;let l=1-S.windowGlow;ze.setRGB(G.lerp(.46,1,l),G.lerp(.52,1,l),G.lerp(.74,1,l)),Q.uniforms.uExposure.value=S.exposure,Yt.uniforms.uToonGain.value=S.toonGain,i.setClearColor(S.horizon,1),wn(S.t),window.__t=S.t,ce.update(e,t,S),B.update(t),le.update(e,t,S),ee.uniforms.uWakeCount.value=le.wakeCount,V.update(e,t),ee.uniforms.uRainCount.value=V.rainDropCount;let u=V.fog*(1-l);m.fog.density=.016+V.fog*_,y.copy(S.horizon).lerp(v,.85*u),m.fog.color.copy(y),i.setClearColor(y,1),We.value=V.fog,I.material.uniforms.uFogAmt.value=.7*V.fog,Ve.value=V.snow,He.value=V.cloud*.55,Ue.x+=e*.018,Ue.y+=e*.009,Ge.value+=(r-Ge.value)*Math.min(1,e*1.5),ue.update(e,t,S,V),Te&&Y.update(e,t,S),Te&&X.step(e);let d=Mn(),f=d.kind===`pixel`||d.kind===`blend`?`pixel`:pn?`vector`:d.kind===`toon`?`charm`:`realistic`;if(pe.update(e,t,S,V,f,b.camera),T){let[e,t,n]=O;ee.uniforms.uPrev.value=e.texture,ee.uniforms.uCurr.value=t.texture,i.setRenderTarget(n),i.render(j,M),O=[t,n,e],ie.uniforms.uHeight.value=O[1].texture}if(xn<2&&typeof document<`u`&&++xn===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function In(e){fn=e,window.__mode=fn}function Ln(){return pn=!pn,Re.value=+!!pn,window.__vector=pn,pn}function Rn(e){return pn=!!e,Re.value=+!!pn,window.__vector=pn,pn}function zn(){return hn=yn[(yn.indexOf(hn)+1)%yn.length],window.__era=hn,En(),hn}function Bn(){return mn=!mn,mn}return{updateWorld:Fn,decideStyle:An,renderCityPipeline:kn,renderCityBeautyTo:On,styleHintName:Pn,setPostMode:In,toggleVector:Ln,setVector:Rn,cycleEra:zn,togglePalette:Bn,setTonemap:e=>{let t=e===`agx`||e===1||e===!0;return Q.uniforms.uTonemap.value=+!!t,typeof window<`u`&&(window.__tonemap=t?`agx`:`aces`),t?`agx`:`aces`},get mode(){return fn},get vector(){return pn},get sceneEra(){return hn},renderer:i,drawBuffer:l,scene:m,rig:b,sunRig:S,SIM:256,targets:O,simScene:j,simCamera:M,simMaterial:ee,grabRT:N,card:P,backdrop:I,WATER_SIZE:28,water:R,waterMaterial:ie,windowGlow:ae,landmarkFactory:oe,city:B,cityLife:ce,waterLife:le,weatherRig:V,clouds:ue,inspector:W,world:yt,catalog:bt,editor:xt,pilot:Ct,profiler:tn,governor:sn,frameStart:cn,frameEnd:ln,setActive:un,get paused(){return d},get contextLost(){return u},prewarm:dn,fitShadowFrustum:wt,SHADOW_DIST:24,sceneDepth:Et,sceneRT:Dt,filmicRT:Ot,toonRT:jt,pixelRT:Mt,postScene:Lt,postCamera:Rt,postQuad:zt,filmicMaterial:Q,pixelMaterial:Kt,pixelkitMaterial:qt,toonMaterial:Yt,mixMaterial:Xt,PALCACHE:Gt,ERA_TEX:Jt,runPass:Zt,OVERCAST_GREY:g,FOG_DENSITY:_,FOG_NIGHT_TINT:v,_fogColor:y,resize:$t}}var Mi=`lgr_hints_`,Ni=!1;function Pi(){if(Ni||typeof document>`u`)return;Ni=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  @media (prefers-reduced-motion: reduce) {
    ...
    `,document.head.appendChild(a),Fe=document.createElement(`button`),Fe.className=`hoard-bagbtn`,Fe.textContent=`🎒`,Fe.title=`Inventory (I)`,document.body.appendChild(Fe),Fe.addEventListener(`click`,()=>X()),Ie=document.createElement(`div`),Ie.className=`hoard-bag`,document.body.appendChild(Ie)}let Re=0;function ze(e,t=1.8){Me&&(Me.textContent=e,Me.style.display=`block`),Re=t}let Be=Math.PI/4;function Ve(e){Be=e}function He(e,t){he={x:e,z:t}}function Ue(e){me=e}function We(){if(typeof window<`u`&&(window.__hoardBag=Object.fromEntries(F.map(e=>[e.id,e.n]))),!Ie)return;let e=`<div class="panel"><h3>INVENTORY</h3><div class="slots">`;for(let t=0;t<8;t++){let n=F[t];n?e+=`<button class="slot" data-id="${n.id}" title="${Vi[n.id].name}">${Vi[n.id].glyph}<span class="n">${n.n}</span></button>`:e+=`<div class="slot empty"></div>`}e+=`</div><div class="craft">`,Hi.forEach((t,n)=>{let r=Object.keys(t.need).every(e=>I(e)>=t.need[e]),i=Object.entries(t.need).map(([e,t])=>`${t}${Vi[e].glyph}`).join(`+`);e+=`<button data-rec="${n}" ${r?``:`disabled`}>Craft ${Vi[t.out].name} (${i})</button>`}),e+=`</div><button class="close">CLOSE (I)</button></div>`,Ie.innerHTML=e,Ie.querySelectorAll(`.slot[data-id]`).forEach(e=>e.addEventListener(`click`,()=>{Vi[e.dataset.id].consumable&&ie(e.dataset.id)})),Ie.querySelectorAll(`[data-rec]`).forEach(e=>e.addEventListener(`click`,()=>R(Hi[+e.dataset.rec]))),Ie.querySelector(`.close`).addEventListener(`click`,()=>Ke())}function Ge(){!oe||se||(Le=!0,Ie&&Ie.classList.add(`open`),We())}function Ke(){Le=!1,Ie&&Ie.classList.remove(`open`)}function X(){Le?Ke():Ge()}function qe(e){z=e,fe=5+e*2,V=`spawning`}function Je(){w.x=0,w.z=0,w.vx=0,w.vz=0,w.hp=100,w.stamina=100,w.hunger=100,w.thirst=100,w.facing=0,w.iframe=0;for(let e of E)e.alive=!1;B=0,ce=0,le=0,se=!1,me=!1,he=null;for(let e of O)e.hp=150,e.alive=!0,e.mesh.scale.set(1,1,1);for(let e of j)e.active=!1,e.mesh.visible=!1;F.length=0;let e=[`food`,`water`,`food`,`water`,`bandage`,`scrap`];for(let t=0;t<6;t++){let n=Math.random()*Math.PI*2,r=1.6+Math.random()*(a-2);P(Math.cos(n)*r,Math.sin(n)*r,e[t])}Ne&&(Ne.style.display=`none`),m.position.set(0,r,0),m.visible=!0,qe(1),We()}function Ye(){Je()}function Xe(e){oe=e,n.visible=e;let t=e&&s;J&&(J.style.display=t?`block`:`none`),Pe&&(Pe.style.display=t?`block`:`none`),Y&&(Y.style.display=t?`block`:`none`),Ee&&(Ee.style.display=e?`block`:`none`),Me&&!e&&(Me.style.display=`none`),Ne&&!e&&(Ne.style.display=`none`),Fe&&(Fe.style.display=e?`block`:`none`),Ke();for(let e in K)K[e]=!1;q.x=q.y=0,me=!1,e&&Je()}let Ze=new d;function Qe(e,t,n){if(!oe||Le)return;let i=n?n.windowGlow:0;if(U=Math.max(0,U-e),pe=Math.max(0,pe-e),S.material.opacity=Math.max(0,S.material.opacity-e*8),y.material.opacity=Math.max(0,y.material.opacity-e*6),!se){le+=e,w.iframe=Math.max(0,w.iframe-e);let n=(K.d||K.arrowright?1:0)-(K.a||K.arrowleft?1:0)+q.x,i=(K.w||K.arrowup?1:0)-(K.s||K.arrowdown?1:0)+q.y,o=Math.hypot(n,i);o>1&&(n/=o,i/=o);let s=o>.05,c=(K.shift||q.y>.95)&&w.stamina>2&&s,l=Math.cos(Be),d=Math.sin(Be),p=l*n+-d*i,h=-d*n+-l*i,g=c?5.2:3,_=1-Math.exp(-14*e);w.vx+=(p*g-w.vx)*_,w.vz+=(h*g-w.vz)*_,w.x+=w.vx*e,w.z+=w.vz*e;let v=Math.hypot(w.x,w.z);v>a&&(w.x*=a/v,w.z*=a/v,w.vx=0,w.vz=0),s&&(w.facing=Math.atan2(p,h)),w.stamina=G.clamp(w.stamina+(c?-34:22)*e,0,100),w.hunger=Math.max(0,w.hunger-.9*e),w.thirst=Math.max(0,w.thirst-1.15*e),w.hunger<=0||w.thirst<=0?w.hp=Math.max(0,w.hp-3.5*e):w.hunger>55&&w.thirst>55&&w.hp<100&&(w.hp=Math.min(100,w.hp+2*e));for(let e of j)e.active&&(e.x-w.x)**2+(e.z-w.z)**2<.3&&ne(e.kind)&&(e.active=!1,e.mesh.visible=!1,We());for(let t of O){if(t.hp>=150)continue;let n=Math.cos(t.ang)*u,r=Math.sin(t.ang)*u;(n-w.x)**2+(r-w.z)**2<f*f&&(t.hp=Math.min(150,t.hp+30*e),t.hp>0&&(t.alive=!0))}w.hp<=0&&$e(),m.position.set(w.x,r,w.z),m.rotation.y=w.facing,m.visible=!(w.iframe>0&&Math.floor(t*20)%2==0),me&&Se(),y.position.set(w.x,r+.06,w.z),y.rotation.z=-w.facing}let o=0;se||V===`spawning`&&(fe>0&&Math.random()<e*(z===1?3.5:6)&&(_e(i),fe--),fe<=0&&(V=`fighting`));let s=0,c=1/0;for(let n=0;n<48;n++){let i=E[n];if(!i.alive){Ze.position.set(0,-60,0),Ze.scale.setScalar(0),Ze.updateMatrix(),T.setMatrixAt(n,Ze.matrix);continue}o++;let a=w.x-i.x,d=w.z-i.z,f=Math.hypot(a,d)||1;if(f<c&&(c=f),!se){let t=a/f*i.speed,n=d/f*i.speed,r=1-Math.exp(-6*e);if(i.vx+=(t-i.vx)*r,i.vz+=(n-i.vz)*r,f>.52){let t=i.x+i.vx*e,n=i.z+i.vz*e,r=Math.hypot(i.x,i.z),a=Math.hypot(t,n);if(!i.in&&r>=u&&a<4.9){let r=A(t,n);if(r.alive){let i=Math.atan2(n,t),a=4.9;t=Math.cos(i)*a,n=Math.sin(i)*a,r.hp-=15*e,r.hp<=0&&(r.hp=0,r.alive=!1)}}a<u-.1&&(i.in=!0),i.x=t,i.z=n}else w.iframe<=0&&(s=Math.max(s,i.dmg))}i.flash=Math.max(0,i.flash-e);let p=Math.sin(t*6+i.phase)*.04;Ze.position.set(i.x,r+.3*i.size*l+p,i.z),Ze.rotation.set(0,Math.atan2(i.vx,i.vz),Math.sin(t*3+i.phase)*.12),Ze.scale.setScalar(i.size*l),Ze.updateMatrix(),T.setMatrixAt(n,Ze.matrix),D.set(Li[i.type].color),i.flash>0?D.lerp(zi,.7):D.lerp(Bi,.35*(1-i.hp/i.maxhp)),T.setColorAt(n,D)}T.instanceMatrix.needsUpdate=!0,T.instanceColor&&(T.instanceColor.needsUpdate=!0);let d=0;for(let e of O){e.alive&&d++;let t=Math.max(0,e.hp/150);e.mesh.scale.y=e.alive?Math.max(.18,t):.12,e.mesh.position.y=r+.35*e.mesh.scale.y,e.mesh.material.color.copy(e.baseColor).lerp(Bi,(1-t)*.55)}!se&&s>0&&(w.hp=Math.max(0,w.hp-s*(z===1?.5:1)),w.iframe=.6,w.hp<=0&&$e()),!se&&V===`fighting`&&o===0&&fe<=0&&(V=`complete`,de=2.2,ze(`WAVE ${z} CLEAR`,2)),!se&&V===`complete`&&(de-=e,de<=0&&(qe(z+1),ze(`WAVE ${z}`,1.4))),Re>0&&(Re-=e,Re<=0&&Me&&(Me.style.display=`none`)),De&&(De.style.width=`${w.hp}%`),Oe&&(Oe.style.width=`${w.stamina}%`),ke&&(ke.style.width=`${w.hunger}%`),Ae&&(Ae.style.width=`${w.thirst}%`),je&&(je.textContent=`WAVE ${z}   KILLS ${B}   SCORE ${ce}`),typeof window<`u`&&(window.__hoard={active:oe,dead:se,paused:Le,hp:Math.round(w.hp),stamina:Math.round(w.stamina),hunger:Math.round(w.hunger),thirst:Math.round(w.thirst),zombies:o,barriers:d,pickups:j.filter(e=>e.active).length,inv:Object.fromEntries(F.map(e=>[e.id,e.n])),wave:z,kills:B,score:ce,weapon:`gun`,znear:+c.toFixed(2),px:+w.x.toFixed(2),pz:+w.z.toFixed(2)})}function $e(){se=!0,me=!1,Ne&&(Ne.querySelector(`.ds`).innerHTML=`Wave reached: ${z}<br>Kills: ${B}<br>Score: ${ce}<br>Survived: ${le.toFixed(0)}s`,Ne.style.display=`flex`)}return{group:n,update:Qe,setActive:Xe,setAzimuth:Ve,setAim:He,setFiring:Ue,melee:Ce,reset:Je,restart:Ye,openBag:Ge,closeBag:Ke,toggleBag:X,addItem:ne,get player(){return w},get dead(){return se},get active(){return oe},get paused(){return Le},get inv(){return F.map(e=>({...e}))},get nearestPickup(){let e=null,t=1e9;for(let n of j){if(!n.active)continue;let r=(n.x-w.x)**2+(n.z-w.z)**2;r<t&&(t=r,e=n)}return e?{x:e.x,z:e.z}:null},setTarget(){}}}var{Timer:Wi}=O,Gi=new URLSearchParams(window.location.search),Ki=Gi.get(`demo`)===`1`||Gi.has(`capture`);window.__demo=Ki;var qi=(Gi.get(`city`)?Number(Gi.get(`city`)):0)||Math.random()*1e9|0,Ji=0,Yi=ji({demo:Ki,citySeed:qi,profileIndex:Ji}),{renderer:Xi,scene:Zi,rig:Qi,sunRig:$i,city:ea,landmarkFactory:ta}=Yi,na=Ui({extent:ea.extent,plinthTop:.3});Zi.add(na.group),window.__hoardApi=na,typeof window<`u`&&(window.__quality={get level(){return Yi.governor.level},forceLoad:e=>Yi.profiler.forceLoad(e)}),typeof window<`u`&&(window.__rig=Qi);var ra=!0;window.__shadows=ra,window.__scene=`hoard`;var ia=new H,aa=new Set,oa=6.5;function sa(e){ea.group.traverse(t=>{!t.isMesh||t.userData.ground||!t.visible||(t.getWorldPosition(ia),Math.hypot(ia.x,ia.z)<e&&(t.visible=!1,aa.add(t)))})}function ca(){for(let e of aa)e.visible=!0;aa.clear()}var la=new ce,ua=new H,da=new H,fa=new Set;function pa(){for(let e of fa)e.material&&(e.material.opacity=1,e.material.transparent=!!e.userData._wasT,e.material.depthWrite=e.userData._wasDW!==!1);fa.clear()}function ma(e){pa();let t=Qi.camera;for(let[n,r]of[[0,0],[.7,.4],[-.7,.4]]){da.set(e.x+n,.6,e.z+r),ua.subVectors(da,t.position);let i=ua.length();la.set(t.position,ua.normalize()),la.far=i-.4;for(let e of la.intersectObject(ea.group,!0)){let t=e.object;!t.material||t.userData.ground||fa.has(t)||(t.userData._wasT=t.material.transparent,t.userData._wasDW=t.material.depthWrite,t.material.transparent=!0,t.material.opacity=.16,t.material.depthWrite=!1,fa.add(t))}}}function ha(){na.setActive(!0),sa(oa),Qi.setMode(J.DIMETRIC),Qi.setZoom(2.8,!0),Qi.setTarget(na.player.x,.6,na.player.z,!0)}var ga=new ce,_a=new F,va=new w(new H(0,1,0),-.32),ya=new H,ba=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,xa=!1,Sa=0,Ca=0,wa=.005,Ta=(e,t)=>{_a.x=e/window.innerWidth*2-1,_a.y=-(t/window.innerHeight)*2+1};Xi.domElement.addEventListener(`contextmenu`,e=>e.preventDefault()),Xi.domElement.addEventListener(`mousedown`,e=>{e.button===0&&(Ta(e.clientX,e.clientY),na.setFiring(!0)),e.button===2&&(xa=!0,Sa=e.clientX,Ca=e.clientY)}),window.addEventListener(`mousemove`,e=>{Ta(e.clientX,e.clientY),xa&&(Qi.orbit(-(e.clientX-Sa)*wa,-(e.clientY-Ca)*wa),Sa=e.clientX,Ca=e.clientY)}),window.addEventListener(`mouseup`,()=>{na.setFiring(!1),xa=!1}),Xi.domElement.addEventListener(`wheel`,e=>{e.preventDefault(),Qi.zoomBy(Math.exp(e.deltaY*.0015))},{passive:!1});var Ea=0,Da=(e,t)=>[(e.clientX+t.clientX)/2,(e.clientY+t.clientY)/2],Oa=(e,t)=>Math.hypot(e.clientX-t.clientX,e.clientY-t.clientY);Xi.domElement.addEventListener(`touchstart`,e=>{e.touches.length===2&&(xa=!0,[Sa,Ca]=Da(e.touches[0],e.touches[1]),Ea=Oa(e.touches[0],e.touches[1]))},{passive:!0}),Xi.domElement.addEventListener(`touchmove`,e=>{if(e.touches.length!==2)return;e.preventDefault();let[t,n]=Da(e.touches[0],e.touches[1]);Qi.orbit(-(t-Sa)*wa,-(n-Ca)*wa),Sa=t,Ca=n;let r=Oa(e.touches[0],e.touches[1]);Ea>0&&Qi.zoomBy(Ea/r),Ea=r},{passive:!1}),window.addEventListener(`touchend`,e=>{(!e.touches||e.touches.length<2)&&(xa=!1,Ea=0)}),window.addEventListener(`keydown`,e=>{(e.key===`h`||e.key===`H`)&&(ra=!ra,window.__shadows=ra)}),ta.whenReady.then(()=>{ea.generate(qi,Ji),Yi.fitShadowFrustum(),ca(),sa(oa),window.__cityReady=!0});var ka=new Wi;ka.connect(document);function Aa(){ka.update(),Yi.frameStart();let e=Math.min(ka.getDelta(),.1);na.setAzimuth(Qi.azimuth),ba||(ga.setFromCamera(_a,Qi.camera),ga.ray.intersectPlane(va,ya)&&na.setAim(ya.x,ya.z)),na.update(e,ka.getElapsed(),$i),Qi.setTarget(na.player.x,.6,na.player.z),Qi.update(e),ma(na.player),Yi.updateWorld(e,ka.getElapsed(),{shadowsOn:ra,seasonTarget:0});let t=Yi.decideStyle();Yi.renderCityPipeline(t,null),Yi.frameEnd(),requestAnimationFrame(Aa)}ha(),Aa(),Fi({key:`hoard`,title:`The Hoard`,tips:[`Move: WASD / arrows · on touch: the left thumb-stick`,`Aim: mouse / drag · Fire: hold click / the FIRE button · Melee: the MELEE button`,`Survive the waves · B: bag & crafting · Esc: exit`]}),window.addEventListener(`resize`,()=>{Yi.resize()});