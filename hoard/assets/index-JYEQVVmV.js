...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,nn={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},rn=[`gb`,`8-bit`,`16-bit`,`modern`];function an(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new B(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new te(n,t,1,d,ue);return r.minFilter=f,r.magFilter=f,r.needsUpdate=!0,r}var on=220,sn={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},cn={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function ln({demo:e=!1,citySeed:n=0,profileIndex:r=0}={}){let i=new re({antialias:!0,preserveDrawingBuffer:!0});i.shadowMap.enabled=!0,i.shadowMap.type=1,i.shadowMap.autoUpdate=!1,i.shadowMap.needsUpdate=!0;let a=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);i.setPixelRatio(Math.min(window.devicePixelRatio,a?1.5:2)),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(920327,1),document.body.appendChild(i.domElement);let s=i.getDrawingBufferSize(new H),c=new T;c.fog=new y(10465470,0);let l=new B(`#aeb6c0`),h=.062,_=new B(`#74508f`),v=new B,b=Ee({aspect:window.innerWidth/window.innerHeight}),S=at({t:.5}),C={type:le,format:d,minFilter:f,magFilter:f,wrapS:ee,wrapT:ee,depthBuffer:!1,stencilBuffer:!1},E=[new oe(256,256,C),new oe(256,256,C),new oe(256,256,C)];for(let e of E)i.setRenderTarget(e),i.clear();i.setRenderTarget(null);let O=new T,k=new fe(-1,1,1,-1,0,1),j=new w({vertexShader:qt,fragmentShader:Jt,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new H(1/256,1/256)},uMouse:{value:new H(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new R)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new R)}}});O.add(new g(new x(2,2),j));let M=new oe(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!0,stencilBuffer:!1});function te(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new A(t);return r.colorSpace=u,r}let N=new g(new x(28,28),new o({map:te(e)}));N.rotation.x=-Math.PI/2,N.position.y=-.35,c.add(N);let P=new g(new x(40,24),new w({depthWrite:!1,vertexShader:Gt,fragmentShader:Kt,uniforms:{uTime:{value:0},uInk:{value:S.horizon},uGold:{value:S.sky},uFogColor:{value:v},uFogAmt:{value:0},uFogCharm:Ne}}));P.position.set(0,3,-8),c.add(P);let F=new w({vertexShader:Yt,fragmentShader:Xt,uniforms:{uHeight:{value:null},uScene:{value:M.texture},uTexel:{value:new H(1/256,1/256)},uResolution:{value:new H(s.x,s.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new m},uLightDir:{value:S.sunDir},uInk:{value:new B(`#2A2218`)},uGold:{value:new B(`#B89968`)},uVector:De,uVecWater:{value:new B(`#1fb8d8`)},uVecTint:{value:Oe}}}),I=new g(new x(28,28,255,255),F);I.rotation.x=-Math.PI/2,I.updateMatrixWorld(!0),F.uniforms.uNormalMatrix.value.getNormalMatrix(I.matrixWorld),c.add(I);let ne={value:0},L=kt({windowGlow:ne}),z=Ze({seed:n,profileIndex:r,landmarkFactory:L,windowGlow:ne});c.add(z.group);let ie=ut({plinthTop:.3,extent:z.extent,profile:z.state.profile});c.add(ie.group);let ae=_t({extent:z.extent,waterSize:28,plinthTop:.3});c.add(ae.group),j.uniforms.uWakeDrops.value=ae.wakeDrops;let V=jt({extent:z.extent});c.add(V.group),j.uniforms.uRainDrops.value=V.rainDrops;let se=Nt({extent:z.extent});c.add(se.group);let U=Wt();c.add(U.group),z.group.remove(z.key),c.add(z.key),z.key.castShadow=!0,z.key.shadow.mapSize.set(2048,2048),z.key.shadow.bias=-18e-5,z.key.shadow.normalBias=.028,c.add(z.key.target);function ce(){let e=z.key.shadow.camera,t=z.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),i.shadowMap.needsUpdate=!0}ce();let ue=new D(s.x,s.y),de=new oe(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!0,stencilBuffer:!1,depthTexture:ue}),pe=new oe(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),me=new oe(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),he=new oe(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),W=new T,ge=new fe(-1,1,1,-1,0,1),_e=new g(new x(2,2));W.add(_e);let ve=new w({vertexShader:qt,fragmentShader:Zt,uniforms:{uScene:{value:de.texture},uTime:{value:0},uResolution:{value:new H(s.x,s.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),ye=e=>{let t=e.map(e=>new B(e));for(;t.length<8;)t.push(new B(0,0,0));return t},be=[`night`,`dawn`,`noon`,`dusk`],xe={inkgold:be.map(e=>ye(sn[e])),terminal:be.map(e=>ye(cn[e]))},Se=new w({vertexShader:qt,fragmentShader:Qt,uniforms:{uScene:{value:pe.texture},uResolution:{value:new H(s.x,s.y)},uPixelSize:{value:on},uPalette:{value:xe.inkgold[2]},uPaletteB:{value:xe.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),Ce=new w({vertexShader:qt,fragmentShader:tn,uniforms:{uScene:{value:pe.texture},uResolution:{value:new H(s.x,s.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:an(nn[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),we={};for(let e of rn)we[e]=nn[e].palette?an(nn[e].palette):null;let G=new w({vertexShader:qt,fragmentShader:$t,uniforms:{uScene:{value:pe.texture},uDepth:{value:ue},uResolution:{value:new H(s.x,s.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:S.toonFloor},uOutline:{value:S.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),K=new w({vertexShader:qt,fragmentShader:en,uniforms:{uToon:{value:me.texture},uPixel:{value:he.texture},uBlend:{value:0}}});function Te(e,t){_e.material=e,i.setRenderTarget(t),i.render(W,ge)}function q(){b.setViewport(window.innerWidth,window.innerHeight),i.setSize(window.innerWidth,window.innerHeight);let e=i.getDrawingBufferSize(new H);return M.setSize(e.x,e.y),de.setSize(e.x,e.y),pe.setSize(e.x,e.y),me.setSize(e.x,e.y),he.setSize(e.x,e.y),F.uniforms.uResolution.value.set(e.x,e.y),ve.uniforms.uResolution.value.set(e.x,e.y),Se.uniforms.uResolution.value.set(e.x,e.y),Ce.uniforms.uResolution.value.set(e.x,e.y),G.uniforms.uResolution.value.set(e.x,e.y),e}let J=3,Y=!1,Fe=!1,X=`native`,Ie=.3,Le=.46,Z=[`native`,...rn],Re={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=J,window.__vector=Y,window.__era=X);let ze=0,Be=performance.now(),Ve=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=Ve),Ve&&(i.info.autoReset=!1);let Q=null;typeof window<`u`&&(window.__loaded=!1);let He=0,Ue=new R(1,1,1),We=!1;function Ge(e){let t=Fe?xe.terminal:xe.inkgold,n=e%1*4,r=Math.floor(n)%4;Se.uniforms.uPalette.value=t[r],Se.uniforms.uPaletteB.value=t[(r+1)%4],Se.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Ke(e){let t=nn[e];t&&(Ce.uniforms.uGridWidth.value=t.gridWidth,Ce.uniforms.uDither.value=t.dither,Ce.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(Ce.uniforms.uPalette.value=we[e],Ce.uniforms.uPaletteSize.value=t.palette.length))}function qe(){X!==`native`&&Ke(X)}let Je=()=>X===`native`?Se:Ce;function Ye(e,t){I.visible=!1,i.setRenderTarget(M),i.render(c,e),I.visible=!0,i.setRenderTarget(t),i.render(c,e)}function Xe(e,t){if(I.visible=!1,i.setRenderTarget(M),i.render(c,b.camera),I.visible=!0,J===1)i.setRenderTarget(t),i.render(c,b.camera);else if(i.setRenderTarget(de),i.render(c,b.camera),J===2)ve.uniforms.uGrain.value=1,ve.uniforms.uChroma.value=1,Te(ve,t);else{ve.uniforms.uGrain.value=0,ve.uniforms.uChroma.value=0,Te(ve,pe);let n=b.camera;G.uniforms.uNear.value=n.near,G.uniforms.uFar.value=n.far,G.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Ke(e.era),Ce):Je();e.kind===`pixel`?(Te(r,t),window.__style=`pixel`):e.kind===`toon`?(Te(G,t),window.__style=`toon`):(Te(G,me),Te(r,he),K.uniforms.uBlend.value=e.blend,Te(K,t),window.__style=`blend`)}}function Qe(){let e=$e(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return F.uniforms.uChromaScale.value=p.lerp(1,.5,t),e}function $e(){if(J===1||J===2)return{kind:`none`};if(J===7)return{kind:`pixel`};if(J===8)return{kind:`toon`};let e=b.styleT;return window.__styleT=e,e<=Ie?{kind:`toon`}:e>=Le?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:p.smoothstep(e,Ie,Le),era:`16-bit`}}function et(e){return J===1||J===2?``:Y&&J!==7&&J!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Re[e.era||X]||`Pixel`:e.kind===`blend`?`Toon → `+(Re[e.era]||`Pixel`):``}function tt(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){if(Ve){let e=i.info;Q={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}P.material.uniforms.uTime.value=t,ve.uniforms.uTime.value=t,S.update(e),z.key.position.copy(S.sunDir).multiplyScalar(24),z.key.color.copy(S.sunColor),z.key.intensity=S.sunIntensity,z.fill.color.copy(S.hemiSky),z.fill.groundColor.copy(S.hemiGround),ne.value=S.windowGlow;let a=V.overcast;z.key.intensity*=1-.5*a,z.key.color.lerp(l,.45*a),z.fill.intensity=1+.7*a;let o=p.smoothstep(S.sunDir.y,.06,.34),s=p.lerp(.28,1,1-S.windowGlow),u=n?o*s:0;z.key.shadow.intensity=.72*u,ke.value=.52*u,(n&&!We||Ue.distanceToSquared(S.sunDir)>2e-5)&&(i.shadowMap.needsUpdate=!0,Ue.copy(S.sunDir)),We=n;let d=1-S.windowGlow;Oe.setRGB(p.lerp(.46,1,d),p.lerp(.52,1,d),p.lerp(.74,1,d)),ve.uniforms.uExposure.value=S.exposure,G.uniforms.uToonGain.value=S.toonGain,i.setClearColor(S.horizon,1),Ge(S.t),window.__t=S.t,ie.update(e,t,S),z.update(t),ae.update(e,t,S),j.uniforms.uWakeCount.value=ae.wakeCount,V.update(e,t),j.uniforms.uRainCount.value=V.rainDropCount;let f=V.fog*(1-d);c.fog.density=V.fog*h,v.copy(S.horizon).lerp(_,.85*f),c.fog.color.copy(v),i.setClearColor(v,1),Ne.value=V.fog,P.material.uniforms.uFogAmt.value=.7*V.fog,Ae.value=V.snow,je.value=V.cloud*.55,Me.x+=e*.018,Me.y+=e*.009,Pe.value+=(r-Pe.value)*Math.min(1,e*1.5),se.update(e,t,S,V);let m=$e(),g=m.kind===`pixel`||m.kind===`blend`?`pixel`:Y||m.kind===`toon`?`charm`:`realistic`;U.update(e,t,S,V,g),ze++;let y=performance.now();y-Be>=1e3&&(window.__fps=ze,Ve&&Q&&(console.log(`[perf] ${ze} fps · ~${(1e3/Math.max(1,ze)).toFixed(2)} ms · calls ${Q.calls} · tris ${Q.tris} · programs ${Q.programs} · geo ${Q.geo} · tex ${Q.tex}`),window.__perfInfo={fps:ze,...Q}),ze=0,Be=y);let[b,x,C]=E;if(j.uniforms.uPrev.value=b.texture,j.uniforms.uCurr.value=x.texture,i.setRenderTarget(C),i.render(O,k),E=[x,C,b],F.uniforms.uHeight.value=E[1].texture,He<2&&typeof document<`u`&&++He===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function nt(e){J=e,window.__mode=J}function rt(){return Y=!Y,De.value=+!!Y,window.__vector=Y,Y}function it(e){return Y=!!e,De.value=+!!Y,window.__vector=Y,Y}function ot(){return X=Z[(Z.indexOf(X)+1)%Z.length],window.__era=X,qe(),X}function st(){return Fe=!Fe,Fe}return{updateWorld:tt,decideStyle:Qe,renderCityPipeline:Xe,renderCityBeautyTo:Ye,styleHintName:et,setPostMode:nt,toggleVector:rt,setVector:it,cycleEra:ot,togglePalette:st,get mode(){return J},get vector(){return Y},get sceneEra(){return X},renderer:i,drawBuffer:s,scene:c,rig:b,sunRig:S,SIM:256,targets:E,simScene:O,simCamera:k,simMaterial:j,grabRT:M,card:N,backdrop:P,WATER_SIZE:28,water:I,waterMaterial:F,windowGlow:ne,landmarkFactory:L,city:z,cityLife:ie,waterLife:ae,weatherRig:V,clouds:se,fitShadowFrustum:ce,SHADOW_DIST:24,sceneDepth:ue,sceneRT:de,filmicRT:pe,toonRT:me,pixelRT:he,postScene:W,postCamera:ge,postQuad:_e,filmicMaterial:ve,pixelMaterial:Se,pixelkitMaterial:Ce,toonMaterial:G,mixMaterial:K,PALCACHE:xe,ERA_TEX:we,runPass:Te,OVERCAST_GREY:l,FOG_DENSITY:h,FOG_NIGHT_TINT:_,_fogColor:v,resize:q}}var un=`lgr_hints_`,dn=!1;function fn(){if(dn||typeof document>`u`)return;dn=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  @media (prefers-reduced-motion: reduce) {
    ...
    `,document.head.appendChild(a),Fe=document.createElement(`button`),Fe.className=`hoard-bagbtn`,Fe.textContent=`🎒`,Fe.title=`Inventory (I)`,document.body.appendChild(Fe),Fe.addEventListener(`click`,()=>Ge()),X=document.createElement(`div`),X.className=`hoard-bag`,document.body.appendChild(X)}let Le=0;function Re(e,t=1.8){Pe&&(Pe.textContent=e,Pe.style.display=`block`),Le=t}let ze=Math.PI/4;function Be(e){ze=e}function Ve(e,t){_e={x:e,z:t}}function Q(e){ge=e}function He(){if(typeof window<`u`&&(window.__hoardBag=Object.fromEntries(L.map(e=>[e.id,e.n]))),!X)return;let e=`<div class="panel"><h3>INVENTORY</h3><div class="slots">`;for(let t=0;t<8;t++){let n=L[t];n?e+=`<button class="slot" data-id="${n.id}" title="${yn[n.id].name}">${yn[n.id].glyph}<span class="n">${n.n}</span></button>`:e+=`<div class="slot empty"></div>`}e+=`</div><div class="craft">`,bn.forEach((t,n)=>{let r=Object.keys(t.need).every(e=>re(e)>=t.need[e]),i=Object.entries(t.need).map(([e,t])=>`${t}${yn[e].glyph}`).join(`+`);e+=`<button data-rec="${n}" ${r?``:`disabled`}>Craft ${yn[t.out].name} (${i})</button>`}),e+=`</div><button class="close">CLOSE (I)</button></div>`,X.innerHTML=e,X.querySelectorAll(`.slot[data-id]`).forEach(e=>e.addEventListener(`click`,()=>{yn[e.dataset.id].consumable&&ae(e.dataset.id)})),X.querySelectorAll(`[data-rec]`).forEach(e=>e.addEventListener(`click`,()=>oe(bn[+e.dataset.rec]))),X.querySelector(`.close`).addEventListener(`click`,()=>We())}function Ue(){!se||H||(Ie=!0,X&&X.classList.add(`open`),He())}function We(){Ie=!1,X&&X.classList.remove(`open`)}function Ge(){Ie?We():Ue()}function Ke(e){U=e,me=5+e*2,fe=`spawning`}function qe(){T.x=0,T.z=0,T.vx=0,T.vz=0,T.hp=100,T.stamina=100,T.hunger=100,T.thirst=100,T.facing=0,T.iframe=0;for(let e of D)e.alive=!1;ce=0,le=0,ue=0,H=!1,ge=!1,_e=null;for(let e of A)e.hp=150,e.alive=!0,e.mesh.scale.set(1,1,1);for(let e of te)e.active=!1,e.mesh.visible=!1;L.length=0;let e=[`food`,`water`,`food`,`water`,`bandage`,`scrap`];for(let t=0;t<6;t++){let n=Math.random()*Math.PI*2,r=1.6+Math.random()*(s-2);F(Math.cos(n)*r,Math.sin(n)*r,e[t])}q&&(q.style.display=`none`),m.position.set(0,i,0),m.visible=!0,Ke(1),He()}function Je(){qe()}function Ye(e){se=e,n.visible=e;let t=e&&c;Ee&&(Ee.style.display=t?`block`:`none`),J&&(J.style.display=t?`block`:`none`),Y&&(Y.style.display=t?`block`:`none`),Oe&&(Oe.style.display=e?`block`:`none`),Pe&&!e&&(Pe.style.display=`none`),q&&!e&&(q.style.display=`none`),Fe&&(Fe.style.display=e?`block`:`none`),We();for(let e in G)G[e]=!1;K.x=K.y=0,ge=!1,e&&qe()}let Xe=new v;function Ze(e,t,n){if(!se||Ie)return;let r=n?n.windowGlow:0;if(he=Math.max(0,he-e),W=Math.max(0,W-e),w.material.opacity=Math.max(0,w.material.opacity-e*8),S.material.opacity=Math.max(0,S.material.opacity-e*6),!H){ue+=e,T.iframe=Math.max(0,T.iframe-e);let n=(G.d||G.arrowright?1:0)-(G.a||G.arrowleft?1:0)+K.x,r=(G.w||G.arrowup?1:0)-(G.s||G.arrowdown?1:0)+K.y,a=Math.hypot(n,r);a>1&&(n/=a,r/=a);let o=a>.05,c=(G.shift||K.y>.95)&&T.stamina>2&&o,l=Math.cos(ze),u=Math.sin(ze),h=l*n+-u*r,g=-u*n+-l*r,_=c?5.2:3,v=1-Math.exp(-14*e);T.vx+=(h*_-T.vx)*v,T.vz+=(g*_-T.vz)*v,T.x+=T.vx*e,T.z+=T.vz*e;let y=Math.hypot(T.x,T.z);y>s&&(T.x*=s/y,T.z*=s/y,T.vx=0,T.vz=0),o&&(T.facing=Math.atan2(h,g)),T.stamina=p.clamp(T.stamina+(c?-34:22)*e,0,100),T.hunger=Math.max(0,T.hunger-.9*e),T.thirst=Math.max(0,T.thirst-1.15*e),T.hunger<=0||T.thirst<=0?T.hp=Math.max(0,T.hp-3.5*e):T.hunger>55&&T.thirst>55&&T.hp<100&&(T.hp=Math.min(100,T.hp+2*e));for(let e of te)e.active&&(e.x-T.x)**2+(e.z-T.z)**2<.3&&z(e.kind)&&(e.active=!1,e.mesh.visible=!1,He());for(let t of A){if(t.hp>=150)continue;let n=Math.cos(t.ang)*d,r=Math.sin(t.ang)*d;(n-T.x)**2+(r-T.z)**2<f*f&&(t.hp=Math.min(150,t.hp+30*e),t.hp>0&&(t.alive=!0))}T.hp<=0&&Qe(),m.position.set(T.x,i,T.z),m.rotation.y=T.facing,m.visible=!(T.iframe>0&&Math.floor(t*20)%2==0),ge&&Ce(),S.position.set(T.x,i+.06,T.z),S.rotation.z=-T.facing}let a=0;H||fe===`spawning`&&(me>0&&Math.random()<e*(U===1?3.5:6)&&(ye(r),me--),me<=0&&(fe=`fighting`));let o=0,c=1/0;for(let n=0;n<48;n++){let r=D[n];if(!r.alive){Xe.position.set(0,-60,0),Xe.scale.setScalar(0),Xe.updateMatrix(),E.setMatrixAt(n,Xe.matrix);continue}a++;let s=T.x-r.x,l=T.z-r.z,f=Math.hypot(s,l)||1;if(f<c&&(c=f),!H){let t=s/f*r.speed,n=l/f*r.speed,i=1-Math.exp(-6*e);if(r.vx+=(t-r.vx)*i,r.vz+=(n-r.vz)*i,f>.52){let t=r.x+r.vx*e,n=r.z+r.vz*e,i=Math.hypot(r.x,r.z),a=Math.hypot(t,n);if(!r.in&&i>=d&&a<4.9){let r=ee(t,n);if(r.alive){let i=Math.atan2(n,t),a=4.9;t=Math.cos(i)*a,n=Math.sin(i)*a,r.hp-=15*e,r.hp<=0&&(r.hp=0,r.alive=!1)}}a<d-.1&&(r.in=!0),r.x=t,r.z=n}else T.iframe<=0&&(o=Math.max(o,r.dmg))}r.flash=Math.max(0,r.flash-e);let p=Math.sin(t*6+r.phase)*.04;Xe.position.set(r.x,i+.3*r.size*u+p,r.z),Xe.rotation.set(0,Math.atan2(r.vx,r.vz),Math.sin(t*3+r.phase)*.12),Xe.scale.setScalar(r.size*u),Xe.updateMatrix(),E.setMatrixAt(n,Xe.matrix),k.set(hn[r.type].color),r.flash>0?k.lerp(_n,.7):k.lerp(vn,.35*(1-r.hp/r.maxhp)),E.setColorAt(n,k)}E.instanceMatrix.needsUpdate=!0,E.instanceColor&&(E.instanceColor.needsUpdate=!0);let l=0;for(let e of A){e.alive&&l++;let t=Math.max(0,e.hp/150);e.mesh.scale.y=e.alive?Math.max(.18,t):.12,e.mesh.position.y=i+.35*e.mesh.scale.y,e.mesh.material.color.copy(e.baseColor).lerp(vn,(1-t)*.55)}!H&&o>0&&(T.hp=Math.max(0,T.hp-o*(U===1?.5:1)),T.iframe=.6,T.hp<=0&&Qe()),!H&&fe===`fighting`&&a===0&&me<=0&&(fe=`complete`,pe=2.2,Re(`WAVE ${U} CLEAR`,2)),!H&&fe===`complete`&&(pe-=e,pe<=0&&(Ke(U+1),Re(`WAVE ${U}`,1.4))),Le>0&&(Le-=e,Le<=0&&Pe&&(Pe.style.display=`none`)),ke&&(ke.style.width=`${T.hp}%`),Ae&&(Ae.style.width=`${T.stamina}%`),je&&(je.style.width=`${T.hunger}%`),Me&&(Me.style.width=`${T.thirst}%`),Ne&&(Ne.textContent=`WAVE ${U}   KILLS ${ce}   SCORE ${le}`),typeof window<`u`&&(window.__hoard={active:se,dead:H,paused:Ie,hp:Math.round(T.hp),stamina:Math.round(T.stamina),hunger:Math.round(T.hunger),thirst:Math.round(T.thirst),zombies:a,barriers:l,pickups:te.filter(e=>e.active).length,inv:Object.fromEntries(L.map(e=>[e.id,e.n])),wave:U,kills:ce,score:le,weapon:`gun`,znear:+c.toFixed(2),px:+T.x.toFixed(2),pz:+T.z.toFixed(2)})}function Qe(){H=!0,ge=!1,q&&(q.querySelector(`.ds`).innerHTML=`Wave reached: ${U}<br>Kills: ${ce}<br>Score: ${le}<br>Survived: ${ue.toFixed(0)}s`,q.style.display=`flex`)}return{group:n,update:Ze,setActive:Ye,setAzimuth:Be,setAim:Ve,setFiring:Q,melee:we,reset:qe,restart:Je,openBag:Ue,closeBag:We,toggleBag:Ge,addItem:z,get player(){return T},get dead(){return H},get active(){return se},get paused(){return Ie},get inv(){return L.map(e=>({...e}))},get nearestPickup(){let e=null,t=1e9;for(let n of te){if(!n.active)continue;let r=(n.x-T.x)**2+(n.z-T.z)**2;r<t&&(t=r,e=n)}return e?{x:e.x,z:e.z}:null},setTarget(){}}}var{Timer:Sn}=ae,Cn=new URLSearchParams(window.location.search),wn=Cn.get(`demo`)===`1`||Cn.has(`capture`);window.__demo=wn;var Tn=(Cn.get(`city`)?Number(Cn.get(`city`)):0)||Math.random()*1e9|0,En=0,Dn=ln({demo:wn,citySeed:Tn,profileIndex:En}),{renderer:On,scene:kn,rig:An,sunRig:jn,city:Mn,landmarkFactory:Nn}=Dn,Pn=xn({extent:Mn.extent,plinthTop:.3});kn.add(Pn.group),window.__hoardApi=Pn;var Fn=!0;window.__shadows=Fn,window.__scene=`hoard`;var In=new R,Ln=new Set,Rn=6.5;function zn(e){Mn.group.traverse(t=>{!t.isMesh||t.userData.ground||!t.visible||(t.getWorldPosition(In),Math.hypot(In.x,In.z)<e&&(t.visible=!1,Ln.add(t)))})}function Bn(){for(let e of Ln)e.visible=!0;Ln.clear()}var Vn=new ie,Hn=new R,Un=new R,Wn=new Set;function Gn(){for(let e of Wn)e.material&&(e.material.opacity=1,e.material.transparent=!!e.userData._wasT,e.material.depthWrite=e.userData._wasDW!==!1);Wn.clear()}function Kn(e){Gn();let t=An.camera;for(let[n,r]of[[0,0],[.7,.4],[-.7,.4]]){Un.set(e.x+n,.6,e.z+r),Hn.subVectors(Un,t.position);let i=Hn.length();Vn.set(t.position,Hn.normalize()),Vn.far=i-.4;for(let e of Vn.intersectObject(Mn.group,!0)){let t=e.object;!t.material||t.userData.ground||Wn.has(t)||(t.userData._wasT=t.material.transparent,t.userData._wasDW=t.material.depthWrite,t.material.transparent=!0,t.material.opacity=.16,t.material.depthWrite=!1,Wn.add(t))}}}function qn(){Pn.setActive(!0),zn(Rn),An.setMode(W.DIMETRIC),An.setZoom(2.8,!0),An.setTarget(Pn.player.x,.6,Pn.player.z,!0)}var Jn=new ie,Yn=new H,Xn=new c(new R(0,1,0),-.32),Zn=new R,Qn=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,$n=!1,er=0,tr=0,nr=.005,rr=(e,t)=>{Yn.x=e/window.innerWidth*2-1,Yn.y=-(t/window.innerHeight)*2+1};On.domElement.addEventListener(`contextmenu`,e=>e.preventDefault()),On.domElement.addEventListener(`mousedown`,e=>{e.button===0&&(rr(e.clientX,e.clientY),Pn.setFiring(!0)),e.button===2&&($n=!0,er=e.clientX,tr=e.clientY)}),window.addEventListener(`mousemove`,e=>{rr(e.clientX,e.clientY),$n&&(An.orbit(-(e.clientX-er)*nr,-(e.clientY-tr)*nr),er=e.clientX,tr=e.clientY)}),window.addEventListener(`mouseup`,()=>{Pn.setFiring(!1),$n=!1}),On.domElement.addEventListener(`wheel`,e=>{e.preventDefault(),An.zoomBy(Math.exp(e.deltaY*.0015))},{passive:!1}),window.addEventListener(`keydown`,e=>{(e.key===`h`||e.key===`H`)&&(Fn=!Fn,window.__shadows=Fn)}),Nn.whenReady.then(()=>{Mn.generate(Tn,En),Dn.fitShadowFrustum(),Bn(),zn(Rn),window.__cityReady=!0});var ir=new Sn;ir.connect(document);function ar(){ir.update();let e=Math.min(ir.getDelta(),.1);Pn.setAzimuth(An.azimuth),Qn||(Jn.setFromCamera(Yn,An.camera),Jn.ray.intersectPlane(Xn,Zn)&&Pn.setAim(Zn.x,Zn.z)),Pn.update(e,ir.getElapsed(),jn),An.setTarget(Pn.player.x,.6,Pn.player.z),An.update(e),Kn(Pn.player),Dn.updateWorld(e,ir.getElapsed(),{shadowsOn:Fn,seasonTarget:0});let t=Dn.decideStyle();Dn.renderCityPipeline(t,null),requestAnimationFrame(ar)}qn(),ar(),pn({key:`hoard`,title:`The Hoard`,tips:[`Move: WASD / arrows · on touch: the left thumb-stick`,`Aim: mouse / drag · Fire: hold click / the FIRE button · Melee: the MELEE button`,`Survive the waves · B: bag & crafting · Esc: exit`]}),window.addEventListener(`resize`,()=>{Dn.resize()});