import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,Q as _,R as v,S as y,T as b,U as x,V as S,W as C,X as w,Y as T,Z as E,_ as D,a as O,at as k,b as A,c as j,ct as M,d as ee,dt as N,et as P,f as F,ft as I,g as L,h as R,i as te,it as ne,j as re,k as ie,l as ae,lt as z,m as oe,mt as B,n as se,nt as V,o as ce,ot as le,p as ue,pt as H,q as de,r as fe,rt as pe,s as U,st as me,t as he,tt as ge,u as _e,ut as ve,v as ye,w as be,x as xe,y as Se,z as W}from"./three-Cd4EyEsF.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var Ce=(e,t,n,r)=>e+(t-e)*(1-Math.exp(-n*r)),we=(e,t,n)=>e<t?t:e>n?n:e,Te=Math.atan(1/Math.SQRT2),G=Math.atan(.5),K=Math.PI/4,q={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},J=8,Ee=.12,De=1.45,Oe=4,ke=40,Ae=1.5,je=16,Me=6,Ne=22,Pe=3.5,Fe=11,Y=(e,t,n)=>Ce(e,t,J,n),Ie=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function Le({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new H(0,.8,0),azimuth:a=K,elevation:o=.52,distance:s=12,zoom:c=5.5}={}){let l=new T(t,e,n,r),u=new de(-1,1,1,-1,n,r),d=q.PERSPECTIVE,f=e,p={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},m={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},h=!1,g=null,_=new H,v=()=>d===q.PERSPECTIVE?l:u;function y(e){e!==d&&(d=e,d===q.ISOMETRIC||d===q.DIMETRIC?(p.elevation=d===q.ISOMETRIC?Te:G,p.azimuth=Ie(K,m.azimuth),h=!0):h=!1)}function b(e,t){p.azimuth+=e,h||(p.elevation=W.clamp(p.elevation+t,Ee,De))}function x(e){d===q.PERSPECTIVE?p.distance=W.clamp(p.distance*e,Oe,ke):p.zoom=W.clamp(p.zoom*e,Ae,je)}function S(e,t){let n=p.azimuth,r=d===q.PERSPECTIVE?p.distance*.04:p.zoom*.08,i=new H(Math.cos(n),0,-Math.sin(n)),a=new H(-Math.sin(n),0,-Math.cos(n));p.target.addScaledVector(i,e*r),p.target.addScaledVector(a,t*r)}function C(e,t){f=e/t,l.aspect=f,l.updateProjectionMatrix()}function w(e){g&&(g(_),p.target.copy(_)),m.azimuth=Y(m.azimuth,p.azimuth,e),m.elevation=Y(m.elevation,p.elevation,e),m.distance=Y(m.distance,p.distance,e),m.zoom=Y(m.zoom,p.zoom,e),m.target.x=Y(m.target.x,p.target.x,e),m.target.y=Y(m.target.y,p.target.y,e),m.target.z=Y(m.target.z,p.target.z,e);let t=Math.cos(m.elevation),n=Math.sin(m.elevation),r=Math.cos(m.azimuth),i=Math.sin(m.azimuth),a=v();if(a.position.set(m.target.x+m.distance*t*i,m.target.y+m.distance*n,m.target.z+m.distance*t*r),a.lookAt(m.target),a.isOrthographicCamera){let e=m.zoom,t=e*f;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function E(e,t,n,r=!1){p.target.set(e,t,n),r&&m.target.copy(p.target)}function D(e,t=!1){p.zoom=W.clamp(e,Ae,je),t&&(m.zoom=p.zoom)}function O(e,t=!1){p.azimuth=Ie(e,m.azimuth),t&&(m.azimuth=p.azimuth)}function k(e,t=!1){p.elevation=W.clamp(e,Ee,De),t&&(m.elevation=p.elevation)}function A(e,{frame:t,snap:n=!1}={}){g=e,n&&(g(_),p.target.copy(_),m.target.copy(_)),t!=null&&(d===q.PERSPECTIVE?p.distance=W.clamp(t,Oe,ke):p.zoom=W.clamp(t,Ae,je))}function j(){g=null}return{get camera(){return v()},get mode(){return d},get azimuth(){return m.azimuth},get following(){return!!g},setTarget:E,setZoom:D,setFollow:A,clearFollow:j,setAzimuth:O,setElevation:k,get styleT(){return d===q.PERSPECTIVE?W.clamp((m.distance-Me)/(Ne-Me),0,1):W.clamp((m.zoom-Pe)/(Fe-Pe),0,1)},setMode:y,orbit:b,zoomBy:x,pan:S,setViewport:C,update:w}}var Re={value:0},ze=new R(`#ffffff`),Be={value:0},Ve={value:0},He={value:0},Ue=new I,We={value:0},Ge={value:0},Ke=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
#include <shadowmask_pars_fragment>`)}var Xe=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Ze(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new R(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{qe(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new R(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=Je(e.vertexShader),e.fragmentShader=X(Ye(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function Z(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{qe(e),s||(e.uniforms.uVecColor={value:new R(t)}),c&&(e.uniforms.uGlow={value:new R(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=Ge),e.vertexShader=Je(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
void main() {
  ...
  gl_FragColor = vec4(st.x, Snew, 0.0, 0.0);
}`;function Un({renderer:e,N:t,cell:n,half:r,worldSize:i,seaY:a=0,FLOW:o,DAMP:l,MIN_DEPTH:u,KC:d,KE:f,KD:p,KADV:m,MAXD:h,readTerrain:g}){let _=e.getContext();if(!(_&&_.getExtension&&_.getExtension(`EXT_color_buffer_float`)))return typeof console<`u`&&console.warn(`[L87] EXT_color_buffer_float unavailable — GPU flow backend cannot run; staying on CPU.`),null;let v={type:b,format:ge,minFilter:s,magFilter:s,wrapS:oe,wrapT:oe,depthBuffer:!1,stencilBuffer:!1},y=[new B(t,t,v),new B(t,t,v)],x=[new B(t,t,v),new B(t,t,v)],S=[new B(t,t,v),new B(t,t,v)],w=new Float32Array(t*t*4),T=new ye(w,t,t,ge,b);T.minFilter=s,T.magFilter=s,T.wrapS=T.wrapT=oe;let D=new Float32Array(t*t),O=!1,A=1,M=!0,ee=new ne,N=new de(-1,1,1,-1,0,1),P=new c(new E(2,2),null);P.frustumCulled=!1,ee.add(P);let F=new I(1/t,1/t),L=(e,t)=>new k({vertexShader:Fn,fragmentShader:e,uniforms:t}),te=L(In,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:F},uN:{value:t},uDt:{value:0},uFlow:{value:o},uDamp:{value:l}}),re=L(Ln,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:F},uN:{value:t},uDt:{value:0},uSeaY:{value:a}}),ie=L(Rn,{uState:{value:null},uTerr:{value:null},uN:{value:t},uSeaY:{value:a},uRain:{value:0},uPourCount:{value:0},uPours:{value:Array.from({length:8},()=>new H)},uPourR:{value:new Float32Array(8)}}),z=L(zn,{uSrc:{value:T}}),se=()=>({uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:F},uN:{value:t},uDt:{value:0},uCell:{value:n},uSeaY:{value:a},uKC:{value:d},uKE:{value:f},uKD:{value:p},uMaxD:{value:h},uMinDepth:{value:u},uErosK:{value:A}}),V=L(Bn,se()),ce=L(Vn,se()),le=L(Hn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:F},uN:{value:t},uDt:{value:0},uSeaY:{value:a},uKADV:{value:m}});function ue(t,n){P.material=t;let r=e.getRenderTarget();e.setRenderTarget(n),e.render(ee,N),e.setRenderTarget(r)}let fe=new R;function pe(t){let n=e.getRenderTarget(),r=e.getClearAlpha();e.getClearColor(fe),e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1),e.setClearColor(fe,r),e.setRenderTarget(n)}function U(){g(D);for(let e=0;e<t*t;e++)w[e*4]=D[e];T.needsUpdate=!0,ue(z,S[0])}function he(){pe(y[0]),pe(y[1]),pe(x[0]),pe(x[1])}he();let _e=t*t,ve=new Float32Array(_e*3),be=new Float32Array(_e*2);for(let e=0;e<t;e++)for(let i=0;i<t;i++){let a=e*t+i;ve[a*3]=i*n-r,ve[a*3+1]=0,ve[a*3+2]=e*n-r,be[a*2]=(i+.5)/t,be[a*2+1]=(e+.5)/t}let xe=[];for(let e=0;e<t-1;e++)for(let n=0;n<t-1;n++){let r=e*t+n,i=e*t+n+1,a=(e+1)*t+n,o=(e+1)*t+n+1;xe.push(r,a,i,i,a,o)}let Se=new ae;Se.setAttribute(`position`,new j(ve,3)),Se.setAttribute(`aGridUv`,new j(be,2)),Se.setIndex(xe),Se.boundingSphere=new me(new H(0,0,0),i);let W={uStateTex:{value:y[0].texture},uTerrTex:{value:S[0].texture},uMinDepth:{value:u}},Ce=new C({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});Ce.onBeforeCompile=e=>{e.uniforms.uStateTex=W.uStateTex,e.uniforms.uTerrTex=W.uTerrTex,e.uniforms.uMinDepth=W.uMinDepth,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
varying float vDepth;`).replace(`#include <dithering_fragment>`,`#include <dithering_fragment>
  ...
  gl_FragColor.a *= clamp((vDepth - 0.012) * 7.0, 0.16, 0.86);`)},Ce.customProgramCacheKey=()=>`lgr-flow-gpu`;let we=new c(Se,Ce);we.frustumCulled=!1,we.castShadow=!1,we.receiveShadow=!1,we.raycast=()=>{},we.renderOrder=3,we.visible=!1;function Te(){W.uStateTex.value=y[0].texture,W.uTerrTex.value=S[0].texture}function G(e){e=Math.min(e,1/30),(!O||M)&&(U(),M=!1),te.uniforms.uState.value=y[0].texture,te.uniforms.uTerr.value=S[0].texture,te.uniforms.uFlux.value=x[0].texture,te.uniforms.uDt.value=e,ue(te,x[1]),x.reverse(),re.uniforms.uState.value=y[0].texture,re.uniforms.uTerr.value=S[0].texture,re.uniforms.uFlux.value=x[0].texture,re.uniforms.uDt.value=e,ue(re,y[1]),y.reverse(),O&&(V.uniforms.uState.value=y[0].texture,V.uniforms.uTerr.value=S[0].texture,V.uniforms.uFlux.value=x[0].texture,V.uniforms.uDt.value=e,V.uniforms.uErosK.value=A,ue(V,S[1]),ce.uniforms.uState.value=y[0].texture,ce.uniforms.uTerr.value=S[0].texture,ce.uniforms.uFlux.value=x[0].texture,ce.uniforms.uDt.value=e,ce.uniforms.uErosK.value=A,ue(ce,y[1]),S.reverse(),y.reverse(),le.uniforms.uState.value=y[0].texture,le.uniforms.uTerr.value=S[0].texture,le.uniforms.uFlux.value=x[0].texture,le.uniforms.uDt.value=e,ue(le,y[1]),y.reverse()),Te()}function K(){ie.uniforms.uState.value=y[0].texture,ie.uniforms.uTerr.value=S[0].texture,ue(ie,y[1]),y.reverse(),Te()}function q(e,t,i=.5,a=1.6){(M||!O)&&(U(),M=!1);let o=(e+r)/n,s=(t+r)/n,c=Math.max(1,a/n);ie.uniforms.uRain.value=0,ie.uniforms.uPourCount.value=1,ie.uniforms.uPours.value[0].set(o,s,i),ie.uniforms.uPourR.value[0]=c,K()}function J(e=.004){(M||!O)&&(U(),M=!1),ie.uniforms.uPourCount.value=0,ie.uniforms.uRain.value=e,K()}function Ee(){he(),M=!0,Te()}function De(e,t){O=!!e,t!=null&&(A=Math.max(0,t)),M=!0}let Oe=new Float32Array(t*t*4);function ke(n){return e.readRenderTargetPixels(n,0,0,t,t,Oe),Oe}function Ae(){let e=ke(y[0]),n=0;for(let r=0;r<t*t;r++)n+=e[r*4];return n}function je(e,i){let a=Math.round((e+r)/n),o=Math.round((i+r)/n);return a<0||a>=t||o<0||o>=t?0:ke(y[0])[(o*t+a)*4]}function Me(){let e=ke(y[0]),n=0;for(let r=0;r<t*t;r++)n+=e[r*4+1];return n}function Ne(){let e=ke(y[0]),n=new Float32Array(t*t);for(let r=0;r<t*t;r++)n[r]=e[r*4];return n}function Pe(){let e=ke(S[0]),n=new Float32Array(t*t);for(let r=0;r<t*t;r++)n[r]=e[r*4];return n}function Fe(e){we.visible=!!e}function Y(){for(let e of y)e.dispose();for(let e of x)e.dispose();for(let e of S)e.dispose();T.dispose(),Se.dispose(),Ce.dispose(),P.geometry.dispose(),te.dispose(),re.dispose(),ie.dispose(),z.dispose(),V.dispose(),ce.dispose(),le.dispose()}return{mesh:we,step:G,pourAt:q,rain:J,clear:Ee,totalWater:Ae,cellAt:je,totalSediment:Me,readW:Ne,readTerr:Pe,setErosion:De,setVisible:Fe,dispose:Y,get grid(){return t},get erosion(){return O}}}function Wn({worldHeightAt:e,applyErosion:t=null,syncErodedTerrain:n=null,worldSize:r=26,grid:a=96,seaY:o=0,renderer:s=null}={}){let l=a,u=new Float32Array(l*l),d=new Float32Array(l*l),f=new Float32Array(l*l),p=new Float32Array(l*l),m=new Float32Array(l*l),h=new Float32Array(l*l),g=new Float32Array(l*l),_=new Float32Array(l*l),v=new Float32Array(l*l),y=!1,b=1,x=r/(l-1),S=r/2,w=e||(()=>0),T=e=>e*x-S,E=e=>e*x-S,D=(e,t)=>t*l+e,O=26*x,k=.9,A=.006,M=.5,ee=.25,N=.3,P=.006;function F(){for(let e=0;e<l;e++)for(let t=0;t<l;t++)h[D(t,e)]=w(T(t),E(e))}let I=`cpu`,L=null,R=new Float32Array(l*l),te=0;function ne(e){F();for(let t=0;t<l*l;t++)e[t]=h[t]}function re(){return L||!s?L:(L=Un({renderer:s,N:l,cell:x,half:S,worldSize:r,seaY:o,FLOW:O,DAMP:k,MIN_DEPTH:A,KC:M,KE:ee*3,KD:N*3,KADV:6,MAXD:P*3,readTerrain:ne}),L&&ve.add(L.mesh),L)}function ie(e){if(e===`gpu`){if(re(),!L)return typeof console<`u`&&console.info(`[L87] GPU backend unavailable (no renderer / no float RT) — staying on CPU (oracle).`),I=`cpu`,z(),I;I=`gpu`,L.setErosion(y,b),y&&(ne(R),te=0)}else I=`cpu`;return z(),I}function z(){L&&L.setVisible(I===`gpu`),I===`gpu`?_e.visible=!1:ye()}let oe=new Float32Array(l*l);function B(){if(++te<20)return;te=0;let e=L.readTerr(),t=!1;for(let n=0;n<l*l;n++){let r=e[n]-R[n];oe[n]=r,r!==0&&(t=!0),R[n]=e[n]}t&&n(oe,l)}function se(e){if(I===`gpu`&&L){L.step(e),y&&n&&B();return}e=Math.min(e,1/30),F();for(let t=0;t<l;t++)for(let n=0;n<l;n++){let r=D(n,t),i=h[r]+u[r],a=0,o=0,s=0,c=0;n>0&&(a=Math.max(0,d[r]*k+e*O*(i-(h[r-1]+u[r-1])))),n<l-1&&(o=Math.max(0,f[r]*k+e*O*(i-(h[r+1]+u[r+1])))),t>0&&(c=Math.max(0,m[r]*k+e*O*(i-(h[r-l]+u[r-l])))),t<l-1&&(s=Math.max(0,p[r]*k+e*O*(i-(h[r+l]+u[r+l]))));let g=(a+o+s+c)*e,_=g>1e-9?Math.min(1,u[r]/g):1;d[r]=a*_,f[r]=o*_,m[r]=c*_,p[r]=s*_}for(let t=0;t<l;t++)for(let n=0;n<l;n++){let r=D(n,t),i=0;n>0&&(i+=f[r-1]),n<l-1&&(i+=d[r+1]),t>0&&(i+=p[r-l]),t<l-1&&(i+=m[r+l]);let a=d[r]+f[r]+m[r]+p[r];u[r]+=e*(i-a),u[r]<0&&(u[r]=0),h[r]<o-.02&&(u[r]=0)}y&&t&&V(e),ye()}function V(e){v.fill(0);for(let t=0;t<l;t++)for(let n=0;n<l;n++){let r=D(n,t);if(u[r]<=A){if(g[r]>0){let t=Math.min(P,N*g[r]*e);v[r]+=t,g[r]-=t}continue}let i=(d[r]+f[r]+p[r]+m[r])/(u[r]+.02),a=n>0?h[r-1]:h[r],o=n<l-1?h[r+1]:h[r],s=t>0?h[r-l]:h[r],c=t<l-1?h[r+l]:h[r],_=Math.min(2,Math.hypot(o-a,c-s)/(2*x)),y=M*i*Math.max(.05,_)*b;if(y>g[r]){let t=Math.min(P,ee*(y-g[r])*e);v[r]-=t,g[r]+=t}else{let t=Math.min(P,N*(g[r]-y)*e);v[r]+=t,g[r]-=t,g[r]<0&&(g[r]=0)}}_.set(g);for(let t=0;t<l;t++)for(let n=0;n<l;n++){let r=D(n,t),i=d[r]+f[r]+p[r]+m[r];if(i<=1e-9||g[r]<=1e-9)continue;let a=Math.min(g[r],g[r]*6*e);_[r]-=a,n>0&&(_[r-1]+=a*d[r]/i),n<l-1&&(_[r+1]+=a*f[r]/i),t>0&&(_[r-l]+=a*m[r]/i),t<l-1&&(_[r+l]+=a*p[r]/i)}g.set(_);for(let e=0;e<l*l;e++)g[e]<0&&(g[e]=0),h[e]<o-.02&&(g[e]=0);t(v,l)}function ce(e,t){y=!!e,t!=null&&(b=Math.max(0,t)),e||g.fill(0),I===`gpu`&&L&&(L.setErosion(e,t),e&&(ne(R),te=0))}function le(e,t,n=.5,r=1.6){if(I===`gpu`&&L)return L.pourAt(e,t,n,r);let i=(e+S)/x,a=(t+S)/x,o=Math.max(1,r/x),s=Math.max(0,Math.floor(i-o)),c=Math.min(l-1,Math.ceil(i+o)),d=Math.max(0,Math.floor(a-o)),f=Math.min(l-1,Math.ceil(a+o));for(let e=d;e<=f;e++)for(let t=s;t<=c;t++){let r=Math.hypot(t-i,e-a);r<=o&&(u[D(t,e)]+=n*(1-r/o))}}function ue(e=.004){if(I===`gpu`&&L)return L.rain(e);F();for(let t=0;t<l*l;t++)h[t]>o&&(u[t]+=e)}function H(){if(I===`gpu`&&L)return L.clear();u.fill(0),d.fill(0),f.fill(0),p.fill(0),m.fill(0),g.fill(0),ye()}function de(){if(I===`gpu`&&L)return L.totalWater();let e=0;for(let t=0;t<l*l;t++)e+=u[t];return e}function fe(e,t){if(I===`gpu`&&L)return L.cellAt(e,t);let n=Math.round((e+S)/x),r=Math.round((t+S)/x);return n<0||n>=l||r<0||r>=l?0:u[D(n,r)]}let pe=new Float32Array(l*l*3),U=new Float32Array(l*l);for(let e=0;e<l;e++)for(let t=0;t<l;t++){let n=D(t,e);pe[n*3]=T(t),pe[n*3+1]=-50,pe[n*3+2]=E(e)}let me=[];for(let e=0;e<l-1;e++)for(let t=0;t<l-1;t++){let n=D(t,e),r=D(t+1,e),i=D(t,e+1),a=D(t+1,e+1);me.push(n,i,r,r,i,a)}let he=new ae;he.setAttribute(`position`,new j(pe,3)),he.setAttribute(`aDepth`,new j(U,1)),he.setIndex(me),he.computeVertexNormals();let ge=new C({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});ge.onBeforeCompile=e=>{e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
attribute float aDepth;
varying float vDepth;`).replace(`#include <begin_vertex>`,`#include <begin_vertex>
  vDepth = aDepth;`),e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>
varying float vDepth;`).replace(`#include <dithering_fragment>`,`#include <dithering_fragment>
  if (vDepth < 0.012) discard;
  gl_FragColor.a *= clamp((vDepth - 0.012) * 7.0, 0.16, 0.86);`)},ge.customProgramCacheKey=()=>`lgr-flow`;let _e=new c(he,ge);_e.frustumCulled=!1,_e.castShadow=!1,_e.receiveShadow=!1,_e.raycast=()=>{},_e.renderOrder=3;let ve=new i;ve.add(_e),ve.raycast=()=>{};function ye(){let e=0;for(let t=0;t<l*l;t++){let n=u[t];U[t]=n,pe[t*3+1]=n>A?h[t]+n:-50,n>A&&e++}he.attributes.position.needsUpdate=!0,he.attributes.aDepth.needsUpdate=!0,_e.visible=e>0,typeof window<`u`&&(window.__flowWet=e)}ye();function be(){if(I===`gpu`&&L)return L.totalSediment();let e=0;for(let t=0;t<l*l;t++)e+=g[t];return e}return{group:ve,step:se,pourAt:le,rain:ue,clear:H,totalWater:de,cellAt:fe,setErosion:ce,totalSediment:be,setBackend:ie,get backend(){return I},_debugReadW:()=>I===`gpu`&&L?L.readW():u.slice(),_debugReadTerr:()=>I===`gpu`&&L?L.readTerr():(F(),h.slice()),_debugReadS:()=>I===`gpu`&&L?L.totalSediment():be(),_debugStepN:(e,t=1/60)=>{for(let n=0;n<e;n++)se(t)},get erosion(){return y},get grid(){return l},get visible(){return _e.visible}}}function Gn({extent:e=26,count:t=2e3,seed:n=7,yLo:r=.4,yHi:a=7}={}){let o=nt((n^218462737)>>>0),s=e/2,c=new Float32Array(t*3),l=new Float32Array(t),u=new Float32Array(t);for(let e=0;e<t;e++)c[e*3]=(o()*2-1)*s,c[e*3+1]=r+o()*(a-r),c[e*3+2]=(o()*2-1)*s,l[e]=o()*Math.PI*2,u[e]=.6+o()*.8;let d=new ae;d.setAttribute(`position`,new j(c,3)),d.setAttribute(`aPh`,new j(l,1)),d.setAttribute(`aSp`,new j(u,1)),d.setDrawRange(0,t);let f={uTime:{value:0},uWind:{value:0},uHalf:{value:s},uOpacity:{value:0},uColor:{value:new R(`#fff3d4`)},uPx:{value:2.2}},p=new k({uniforms:f,transparent:!0,depthWrite:!1,depthTest:!0,blending:2,vertexShader:`
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Di={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Oi=[`gb`,`8-bit`,`16-bit`,`modern`];function ki(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new R(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new ye(n,t,1,ge,b);return r.minFilter=s,r.magFilter=s,r.needsUpdate=!0,r}var Ai=220,ji={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Mi={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Ni(e){if(typeof document>`u`||document.getElementById(`lgr-nowebgl`))return;let t=document.createElement(`div`);t.id=`lgr-nowebgl`,t.style.cssText=`position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;background:#0e1116;color:#cdd6e4;font:16px/1.6 system-ui,-apple-system,sans-serif;text-align:center;padding:2rem;`,t.innerHTML=`<div style="max-width:30rem"><div style="font-size:2.4rem;margin-bottom:1rem">🌊</div><h1 style="font-size:1.3rem;margin:0 0 .6rem;color:#fff;font-weight:600">This experience needs a modern browser</h1><p style="margin:0;color:#9aa6b8">`+e+`</p></div>`,document.body&&document.body.appendChild(t)}function Pi({demo:e=!1,citySeed:t=0,profileIndex:r=0}={}){let i;try{i=new te({antialias:!0,preserveDrawingBuffer:!0})}catch(e){throw Ni(`This experience needs WebGL2 — please open it in an up-to-date browser (Chrome, Edge, Firefox, or Safari on iOS 15+) with hardware acceleration enabled.`),e}i.shadowMap.enabled=!0,i.shadowMap.type=1,i.shadowMap.autoUpdate=!1,i.shadowMap.needsUpdate=!0;let o=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches),l=o?1.5:2;i.setPixelRatio(Math.min(window.devicePixelRatio,l)),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(920327,1),document.body.appendChild(i.domElement);let u=i.getDrawingBufferSize(new I),d=!1,p=!1,m=()=>{};i.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),d=!0,typeof window<`u`&&(window.__contextLost=!0)},!1),i.domElement.addEventListener(`webglcontextrestored`,()=>{m(),d=!1,typeof window<`u`&&(window.__contextLost=!1)},!1);let g=new ne;g.fog=new a(10465470,0);let _=new R(`#aeb6c0`),v=.062,y=new R(`#74508f`),b=new R,S=Le({aspect:window.innerWidth/window.innerHeight}),w=Dt({t:.5}),T=i.getContext(),D=!!(T&&T.getExtension&&(T.getExtension(`EXT_color_buffer_float`)||T.getExtension(`EXT_color_buffer_half_float`)));!D&&typeof console<`u`&&console.info(`[L90 H1] No float colour buffer (EXT_color_buffer_float/half_float) — wave sim OFF, flat-sea fallback.`);let O={type:h,format:ge,minFilter:s,magFilter:s,wrapS:oe,wrapT:oe,depthBuffer:!1,stencilBuffer:!1},A=D?[new B(256,256,O),new B(256,256,O),new B(256,256,O)]:null;if(A){for(let e of A)i.setRenderTarget(e),i.clear();i.setRenderTarget(null)}let j=new ye(new Uint8Array([0,0,0,255]),1,1,ge);j.needsUpdate=!0;let M=new ne,ee=new de(-1,1,1,-1,0,1),N=new k({vertexShader:Fn,fragmentShader:_i,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new I(1/256,1/256)},uMouse:{value:new I(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new H)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new H)}}});M.add(new c(new E(2,2),N));let P=new B(u.x,u.y,{minFilter:f,magFilter:f,depthBuffer:!0,stencilBuffer:!1});function F(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new _e(t);return r.colorSpace=pe,r}let L=new c(new E(28,28),new x({map:F(e)}));L.rotation.x=-Math.PI/2,L.position.y=-.35,g.add(L);let re=new c(new E(40,24),new k({depthWrite:!1,vertexShader:hi,fragmentShader:gi,uniforms:{uTime:{value:0},uInk:{value:w.horizon},uGold:{value:w.sky},uFogColor:{value:b},uFogAmt:{value:0},uFogCharm:We}}));re.position.set(0,3,-8),g.add(re);let ie=new k({vertexShader:vi,fragmentShader:yi,uniforms:{uHeight:{value:D?null:j},uScene:{value:P.texture},uTexel:{value:new I(1/256,1/256)},uResolution:{value:new I(u.x,u.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new n},uLightDir:{value:w.sunDir},uInk:{value:new R(`#2A2218`)},uGold:{value:new R(`#B89968`)},uVector:Re,uVecWater:{value:new R(`#1fb8d8`)},uVecTint:{value:ze}}}),ae=new c(new E(28,28,255,255),ie);ae.rotation.x=-Math.PI/2,ae.updateMatrixWorld(!0),ie.uniforms.uNormalMatrix.value.getNormalMatrix(ae.matrixWorld),g.add(ae);let z={value:0},se=en({windowGlow:z}),V=yt({seed:t,profileIndex:r,landmarkFactory:se,windowGlow:z});g.add(V.group);let ce=Mt({plinthTop:.3,extent:V.extent,profile:V.state.profile});g.add(ce.group);let le=Ut({extent:V.extent,waterSize:28,plinthTop:.3});g.add(le.group),N.uniforms.uWakeDrops.value=le.wakeDrops;let ue=nn({extent:V.extent});g.add(ue.group),N.uniforms.uRainDrops.value=ue.rainDrops;let fe=an({extent:V.extent});g.add(fe.group);let U=[ce,le,fe],me=cn({rig:S,getCamera:()=>S.camera,sources:U}),he=mi();g.add(he.group);let ve=Xr({scale:90});g.add(ve.mesh),g.environmentIntensity=.32;let be=!1;function xe(e){let t=e&&w.sunArc.y>-.04;t!==be&&(be=t,ve.mesh.visible=t,re.visible=!t)}let Ce=null,we=-1;m=()=>{Ce=null,we=-1,i.shadowMap.needsUpdate=!0};function Te(){let e=Math.floor(w.t%1*4)%4;return(e!==we||!Ce)&&(we=e,Ce=ve.buildEnv(i)),Ce}let G=null,K=null,q=null,J=null,Ee=!1,De=1234,Oe=`valley`,ke=or.map(e=>e.key),Ae=new C({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),je=()=>[V.group,ce.group,le.group],Me=()=>[G,K,q].filter(Boolean);function Ne(){for(let e of Me())g.remove(e),e.userData.dispose?.();let e=dr({seed:De,size:160,preset:Oe});J=e,G=vr(e,{worldSize:26,baseY:0,chunks:6}),K=Ur({terrain:e,seed:De,worldSize:26,baseY:0,biomeKeys:ke}),q=Kr(e,{worldSize:26,baseY:0,maxLakes:3,material:Ae});for(let e of Me())e.visible=Ee,g.add(e);Y!==void 0&&Y&&Y.clear(),X!==void 0&&X&&X.clear(),typeof window<`u`&&(window.__world={seed:De,preset:Oe,active:Ee,chunks:G.children.length,scatter:K.userData.counts,lakes:q.userData.count})}let Pe=e=>{for(let t of Me())t.visible=e};function Fe(e,t){if(!J)return 0;let{size:n,height:r,sea:i,relief:a}=J,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let Y=Nn({heightAt:Fe,seaSurfaceY:0,waterY:.06});Y.group.visible=!1,g.add(Y.group),U.push(Y);let Ie=0;function Ke(e,t){if(!J||!G)return;let{size:n,height:r,relief:i}=J,a=26/(n-1),o=26/(t-1),s=i>1e-6?1/i:0,c=!1;for(let i=0;i<t;i++)for(let l=0;l<t;l++){let u=e[i*t+l];if(u===0)continue;c=!0;let d=u*s,f=l*o/a,p=i*o/a,m=Math.max(0,Math.round(f-1)),h=Math.min(n-1,Math.round(f+1)),g=Math.max(0,Math.round(p-1)),_=Math.min(n-1,Math.round(p+1));for(let e=g;e<=_;e++)for(let t=m;t<=h;t++){let i=e*n+t,a=r[i]+d;r[i]=a<0?0:a>1?1:a}}c&&(Ie++,Ie%8==0&&yr(G,J,G.children),Ie%24==0&&K&&Hr(K,J,{worldSize:26,baseY:0}))}function qe(e,t){if(!J||!G)return;let{size:n,height:r,relief:i}=J,a=i>1e-6?1/i:0,o=(t-1)/(n-1),s=!1;for(let i=0;i<n;i++){let c=i*o,l=Math.floor(c),u=c-l,d=Math.min(t-1,l+1);for(let c=0;c<n;c++){let f=c*o,p=Math.floor(f),m=f-p,h=Math.min(t-1,p+1),g=e[l*t+p],_=e[l*t+h],v=e[d*t+p],y=e[d*t+h],b=(g*(1-m)+_*m)*(1-u)+(v*(1-m)+y*m)*u;if(b!==0){s=!0;let e=i*n+c,t=r[e]+b*a;r[e]=t<0?0:t>1?1:t}}}s&&(yr(G,J,G.children),K&&Hr(K,J,{worldSize:26,baseY:0}))}let X=Wn({worldHeightAt:Fe,applyErosion:Ke,syncErodedTerrain:qe,worldSize:26,grid:96,seaY:0,renderer:i});X.group.visible=!1,g.add(X.group);let Je=Gn({extent:26,count:o?500:2e3});Je.group.visible=!1,g.add(Je.group);let Ye=null,Xe=new Set;function Ze(){!J||!q||(g.remove(q),q.userData.dispose?.(),q=Kr(J,{worldSize:26,baseY:0,maxLakes:3,material:Ae}),q.visible=Ee,g.add(q),window.__world&&(window.__world.lakes=q.userData.count))}function Z(){Ze(),K&&Hr(K,J,{worldSize:26,baseY:0})}function tt(e,t,n=1,r=2.2,i=.05){if(!J||!G)return;let a=J.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=J.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Xe.clear();for(let e of G.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Xe.add(e)}yr(G,J,Xe),Ye&&clearTimeout(Ye),Ye=setTimeout(Z,140)}function nt(e,t,n,r=2.2){if(!J||!G||n==null)return;let i=J.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=J.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);Xe.clear();for(let e of G.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Xe.add(e)}yr(G,J,Xe,!0)}let rt=[`tree`,`rock`,`tuft`];function it(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!J||!K)return 0;if(a)return Br(K,n||`all`,e,t,i);let o=J.size,s=26/(o-1),c=J.height,l=J.sea,u=J.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Vr[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;zr(K,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&K.userData.counts)for(let e of rt)K.userData.counts[e]=(K.userData.placements[e]||[]).length;return g}let at=[];function ot(){if(!K)return null;let e=K.userData.placements,t={};for(let n of rt)t[n]=(e[n]||[]).map(e=>({...e}));return t}function st(){J&&(at.push({h:J.height.slice(),b:J.biome.slice(),sc:ot(),pl:Y.snapshot()}),at.length>12&&at.shift())}function ct(){if(!J||!at.length)return!1;let e=at.pop();if(J.height.set(e.h),J.biome.set(e.b),e.sc&&K){let t=K.userData.placements;for(let n of rt)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&Y.restore(e.pl),yr(G,J,G.children,!0),Z(),!0}let lt=new Set([`boat`,`fish`]),ut=new Set([`person`,`atv`]);function dt(e,t,n){if(!J)return null;let r=Fe(t,n)<0;return lt.has(e)&&!r||ut.has(e)&&r?null:Y.spawn(e,t,n)}function ft(e,t,n=2.5){return Y.removeNear(e,t,n)}function pt(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function mt(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let ht=e=>pt(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),gt=e=>pt(e);function _t(){let e=K?K.userData.placements:{},t={};for(let n of rt)t[n]=(e[n]||[]).map(e=>({...e}));return t}function vt(){return J?{v:1,seed:De,preset:Oe,size:J.size,height:ht(J.height),biome:gt(J.biome),scatter:_t(),entities:Y.snapshot()}:null}function bt(){if(!J)return null;let e=dr({seed:De,size:160,preset:Oe}),t=J.height,n=J.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:De,preset:Oe,hd:r,bd:i,entities:Y.snapshot()}}function xt(e){K&&(g.remove(K),K.userData.dispose?.()),K=Fr(e||{tree:[],rock:[],tuft:[]}),K.userData.counts=rt.reduce((e,t)=>(e[t]=(K.userData.placements[t]||[]).length,e),{}),K.visible=Ee,g.add(K)}function St(e){if(!e||e.v!==1)return!1;let t=25600;if(e.height!=null||e.biome!=null){if(typeof e.height!=`string`||typeof e.biome!=`string`)return!1;let n,r;try{n=mt(e.height),r=mt(e.biome)}catch{return!1}if(n.byteLength%4!=0||n.byteLength>>2!=t||r.length<t)return!1;let i=new Float32Array(n.buffer,n.byteOffset,n.byteLength>>2);for(let e=0;e<i.length;e++)if(!Number.isFinite(i[e]))return!1}if(e.hd!=null&&!Array.isArray(e.hd)||e.bd!=null&&!Array.isArray(e.bd))return!1;if(Array.isArray(e.hd))for(let n=0;n<e.hd.length;n+=2){let r=e.hd[n];if(!Number.isInteger(r)||r<0||r>=t||!Number.isFinite(e.hd[n+1]))return!1}if(Array.isArray(e.bd))for(let n=0;n<e.bd.length;n+=2){let r=e.bd[n];if(!Number.isInteger(r)||r<0||r>=t)return!1}De=e.seed|0,Oe=ur.includes(e.preset)?e.preset:Oe,at.length=0,Ne(),Ee=!0,Pe(!0),Y.group.visible=!0,X.group.visible=!0,Je.group.visible=!0;for(let e of je())e.visible=!1;window.__world&&(window.__world.active=!0);let n=e=>e<0?0:e>1?1:e,r=or.length;if(e.height&&e.biome){let t=mt(e.height),i=new Float32Array(t.buffer,t.byteOffset,t.byteLength>>2);for(let e=0;e<i.length;e++)J.height[e]=n(i[e]);let a=mt(e.biome);for(let e=0;e<J.biome.length;e++)J.biome[e]=Math.min(r-1,a[e]|0)}else if(e.hd||e.bd){let t=e.hd||[],i=e.bd||[];for(let e=0;e<t.length;e+=2)J.height[t[e]]=n(t[e+1]);for(let e=0;e<i.length;e+=2)J.biome[i[e]]=Math.min(r-1,Math.max(0,i[e+1]|0))}return yr(G,J,G.children,!0),e.scatter&&xt(e.scatter),Ze(),K&&Hr(K,J,{worldSize:26,baseY:0}),Y.restore(e.entities),window.__world&&(window.__world.scatter=K.userData.counts,window.__world.seed=De,window.__world.preset=Oe),!0}let Ct={enter(){G||Ne(),Ee=!0,Pe(!0),Y.group.visible=!0,X.group.visible=!0,Je.group.visible=!0;for(let e of je())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){Ee=!1,Pe(!1),Y.group.visible=!1,X.group.visible=!1,Je.group.visible=!1;for(let e of je())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return De=Math.random()*1e9|0,at.length=0,Ne(),Ct.enter(),De},reset(){return at.length=0,Ne(),Ct.enter(),De},setPreset(e){return ur.includes(e)&&(Oe=e,at.length=0,Ne(),Ct.enter()),Oe},sculpt:tt,paintBiome:nt,paintScatter:it,repoolWater:Ze,snapshot:st,undo:ct,placeEntity:dt,removeEntityNear:ft,heightAt:Fe,serialize:vt,serializeCompact:bt,deserialize:St,flowPourAt:(e,t,n,r)=>X.pourAt(e,t,n,r),flowRain:e=>X.rain(e),flowClear:()=>X.clear(),get flowTotal(){return X.totalWater()},flowAt:(e,t)=>X.cellAt(e,t),flowErosion:(e,t)=>X.setErosion(e,t),get flowErosionOn(){return X.erosion},get flowSediment(){return X.totalSediment()},setSimBackend:e=>X.setBackend(e),get simBackend(){return X.backend},_flowReadW:()=>X._debugReadW(),_flowReadTerr:()=>X._debugReadTerr(),_flowStepN:(e,t)=>X._debugStepN(e,t),get terrainGroup(){return G},get biomes(){return or},get scatterCounts(){return K?K.userData.placements&&rt.reduce((e,t)=>(e[t]=(K.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return Y.counts()},setScatterHidden(e){K&&(K.visible=!e)},get placedLife(){return Y},get canUndo(){return at.length>0},get active(){return Ee},get seed(){return De},get preset(){return Oe},get presets(){return ur}},wt=Jr(),Tt=Xn({world:Ct,catalog:wt,inspector:me});function Et(e,t){return Fe(e,t)<0?0:-999}let Ot=bn({rig:S,world:{heightAt:Fe,waterHeightAt:Et}});V.group.remove(V.key),g.add(V.key),V.key.castShadow=!0,V.key.shadow.mapSize.set(2048,2048),V.key.shadow.bias=-18e-5,V.key.shadow.normalBias=.028,g.add(V.key.target);function kt(){let e=V.key.shadow.camera,t=V.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),i.shadowMap.needsUpdate=!0}kt();let At=new Se(u.x,u.y),jt=new B(u.x,u.y,{minFilter:f,magFilter:f,depthBuffer:!0,stencilBuffer:!1,depthTexture:At}),Nt=new B(u.x,u.y,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),Pt=new B(u.x,u.y,{minFilter:f,magFilter:f,depthBuffer:!0,stencilBuffer:!1,samples:4}),Ft=new B(u.x,u.y,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),It=new B(u.x,u.y,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),Lt=Math.max(1,Math.floor(u.x/2)),Rt=Math.max(1,Math.floor(u.y/2)),zt=new B(Lt,Rt,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),Bt=new B(Lt,Rt,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),Vt=new ne,Ht=new de(-1,1,1,-1,0,1),Wt=new c(new E(2,2));Vt.add(Wt);let Q=new k({vertexShader:Fn,fragmentShader:bi,uniforms:{uScene:{value:jt.texture},uTime:{value:0},uResolution:{value:new I(u.x,u.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:zt.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:w.grade.tint},uGradeLift:{value:w.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1},uDither:{value:0},uTonemap:{value:0}}}),Gt=new k({vertexShader:Fn,fragmentShader:wi,uniforms:{uScene:{value:jt.texture},uThreshold:{value:.78}}}),$=new k({vertexShader:Fn,fragmentShader:Ti,uniforms:{uScene:{value:zt.texture},uDir:{value:new I}}});function Kt(e){Gt.uniforms.uScene.value=e.texture,rn(Gt,zt),$.uniforms.uScene.value=zt.texture,$.uniforms.uDir.value.set(1.6/Lt,0),rn($,Bt),$.uniforms.uScene.value=Bt.texture,$.uniforms.uDir.value.set(0,1.6/Rt),rn($,zt),Q.uniforms.uBloom.value=zt.texture;let t=1-W.clamp(w.sunArc.y*2.2,0,1);Q.uniforms.uBloomStrength.value=.85*(.32+.95*t)}let qt=e=>{let t=e.map(e=>new R(e));for(;t.length<8;)t.push(new R(0,0,0));return t},Jt=[`night`,`dawn`,`noon`,`dusk`],Yt={inkgold:Jt.map(e=>qt(ji[e])),terminal:Jt.map(e=>qt(Mi[e]))},Xt=new k({vertexShader:Fn,fragmentShader:xi,uniforms:{uScene:{value:Nt.texture},uResolution:{value:new I(u.x,u.y)},uPixelSize:{value:Ai},uPalette:{value:Yt.inkgold[2]},uPaletteB:{value:Yt.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),Zt=new k({vertexShader:Fn,fragmentShader:Ei,uniforms:{uScene:{value:Nt.texture},uResolution:{value:new I(u.x,u.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:ki(Di[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Qt={};for(let e of Oi)Qt[e]=Di[e].palette?ki(Di[e].palette):null;let $t=new k({vertexShader:Fn,fragmentShader:Si,uniforms:{uScene:{value:Nt.texture},uDepth:{value:At},uResolution:{value:new I(u.x,u.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:w.toonFloor},uOutline:{value:w.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),tn=new k({vertexShader:Fn,fragmentShader:Ci,uniforms:{uToon:{value:Ft.texture},uPixel:{value:It.texture},uBlend:{value:0}}});function rn(e,t){Wt.material=e,i.setRenderTarget(t),i.render(Vt,Ht)}function on(){S.setViewport(window.innerWidth,window.innerHeight),i.setSize(window.innerWidth,window.innerHeight);let e=i.getDrawingBufferSize(new I);return P.setSize(e.x,e.y),jt.setSize(e.x,e.y),Nt.setSize(e.x,e.y),Pt.setSize(e.x,e.y),Ft.setSize(e.x,e.y),It.setSize(e.x,e.y),Lt=Math.max(1,e.x>>1),Rt=Math.max(1,e.y>>1),zt.setSize(Lt,Rt),Bt.setSize(Lt,Rt),ie.uniforms.uResolution.value.set(e.x,e.y),Q.uniforms.uResolution.value.set(e.x,e.y),Xt.uniforms.uResolution.value.set(e.x,e.y),Zt.uniforms.uResolution.value.set(e.x,e.y),$t.uniforms.uResolution.value.set(e.x,e.y),e}let sn=$n({renderer:i}),ln=!0;function un(e,t){let n=t.dpr==null?l:t.dpr,r=Math.min(window.devicePixelRatio,n);Math.abs(i.getPixelRatio()-r)>.001&&(i.setPixelRatio(r),typeof window<`u`&&window.dispatchEvent?window.dispatchEvent(new Event(`resize`)):on()),ln=t.shadows!==!1,ln||(i.shadowMap.needsUpdate=!1)}let dn=tr({profiler:sn,apply:un});function fn(){!p&&!d&&sn.frameStart()}function pn(){p||d||(sn.frameEnd(),dn.update())}function mn(e){p=!e,typeof window<`u`&&(window.__paused=p)}function hn(){try{i.compile(g,S.camera),zn(1/60,0,{shadowsOn:!0}),Pn(In(),jt),i.setRenderTarget(null)}catch(e){typeof console<`u`&&console.warn(`[L79] prewarm`,e)}}let gn=3,_n=!1,vn=!1,yn=`native`,xn=.3,Sn=.46,Cn=[`native`,...Oi],wn={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=gn,window.__vector=_n,window.__era=yn),typeof window<`u`&&(window.__frames=0),typeof window<`u`&&(window.__loaded=!1);let Tn=0,En=new H(1,1,1),Dn=!1;function On(e){let t=vn?Yt.terminal:Yt.inkgold,n=e%1*4,r=Math.floor(n)%4;Xt.uniforms.uPalette.value=t[r],Xt.uniforms.uPaletteB.value=t[(r+1)%4],Xt.uniforms.uPaletteBlend.value=n-Math.floor(n)}function kn(e){let t=Di[e];t&&(Zt.uniforms.uGridWidth.value=t.gridWidth,Zt.uniforms.uDither.value=t.dither,Zt.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(Zt.uniforms.uPalette.value=Qt[e],Zt.uniforms.uPaletteSize.value=t.palette.length))}function An(){yn!==`native`&&kn(yn)}let jn=()=>yn===`native`?Xt:Zt;function Mn(e,t){xe(!0),g.environment=Te(),Qe.value=1,ae.visible=!1,i.setRenderTarget(P),i.render(g,e),ae.visible=!0,i.setRenderTarget(Pt),i.render(g,e),Kt(Pt),Q.uniforms.uScene.value=Pt.texture,Q.uniforms.uAces.value=1,Q.uniforms.uGrade.value=1,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=1,rn(Q,t)}function Pn(e,t){let n=!_n&&(gn===1||gn===2);if(xe(n),g.environment=n?Te():null,Qe.value=+!!n,Q.uniforms.uBloomStrength.value=0,ae.visible=!1,i.setRenderTarget(P),i.render(g,S.camera),ae.visible=!0,gn===1&&!n)i.setRenderTarget(t),i.render(g,S.camera);else if(gn===1)i.setRenderTarget(Pt),i.render(g,S.camera),Kt(Pt),Q.uniforms.uScene.value=Pt.texture,Q.uniforms.uAces.value=1,Q.uniforms.uGrade.value=1,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=1,rn(Q,t);else if(i.setRenderTarget(n?Pt:jt),i.render(g,S.camera),gn===2)n&&Kt(Pt),Q.uniforms.uScene.value=n?Pt.texture:jt.texture,Q.uniforms.uAces.value=+!!n,Q.uniforms.uGrade.value=+!!n,Q.uniforms.uGrain.value=1,Q.uniforms.uChroma.value=1,Q.uniforms.uDither.value=+!!n,rn(Q,t);else{Q.uniforms.uScene.value=jt.texture,Q.uniforms.uAces.value=0,Q.uniforms.uGrade.value=0,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=0,rn(Q,Nt);let n=S.camera;$t.uniforms.uNear.value=n.near,$t.uniforms.uFar.value=n.far,$t.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(kn(e.era),Zt):jn();e.kind===`pixel`?(rn(r,t),window.__style=`pixel`):e.kind===`toon`?(rn($t,t),window.__style=`toon`):(rn($t,Ft),rn(r,It),tn.uniforms.uBlend.value=e.blend,rn(tn,t),window.__style=`blend`)}}function In(){let e=Ln(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return ie.uniforms.uChromaScale.value=W.lerp(1,.5,t),e}function Ln(){if(gn===1||gn===2)return{kind:`none`};if(gn===7)return{kind:`pixel`};if(gn===8)return{kind:`toon`};let e=S.styleT;return window.__styleT=e,e<=xn?{kind:`toon`}:e>=Sn?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:W.smoothstep(e,xn,Sn),era:`16-bit`}}function Rn(e){return gn===1||gn===2?``:_n&&gn!==7&&gn!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?wn[e.era||yn]||`Pixel`:e.kind===`blend`?`Toon → `+(wn[e.era]||`Pixel`):``}function zn(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){typeof window<`u`&&window.__frames++,n&&=ln,re.material.uniforms.uTime.value=t,Q.uniforms.uTime.value=t,w.update(e),V.key.position.copy(w.sunDir).multiplyScalar(24),V.key.color.copy(w.sunColor),V.key.intensity=w.sunIntensity,V.fill.color.copy(w.hemiSky),V.fill.groundColor.copy(w.hemiGround),z.value=w.windowGlow,ve.setSun(w.sunArc),ve.setParams(w.skyParams),Q.uniforms.uGradeSat.value=w.grade.sat,Q.uniforms.uGradeContrast.value=w.grade.contrast,g.environmentIntensity=.34*(1-.6*W.clamp(w.sunArc.y*1.5,0,1));let a=ue.overcast;V.key.intensity*=1-.5*a,V.key.color.lerp(_,.45*a),V.fill.intensity=1+.7*a;let o=W.smoothstep(w.sunDir.y,.06,.34),s=W.lerp(.28,1,1-w.windowGlow),c=n?o*s:0;V.key.shadow.intensity=.72*c,Be.value=.52*c,(n&&!Dn||En.distanceToSquared(w.sunDir)>2e-5)&&(i.shadowMap.needsUpdate=!0,En.copy(w.sunDir)),Dn=n;let l=1-w.windowGlow;ze.setRGB(W.lerp(.46,1,l),W.lerp(.52,1,l),W.lerp(.74,1,l)),Q.uniforms.uExposure.value=w.exposure,$t.uniforms.uToonGain.value=w.toonGain,i.setClearColor(w.horizon,1),On(w.t),window.__t=w.t,ce.update(e,t,w),V.update(t),le.update(e,t,w),N.uniforms.uWakeCount.value=le.wakeCount,ue.update(e,t),N.uniforms.uRainCount.value=ue.rainDropCount;let u=ue.fog*(1-l);g.fog.density=.016+ue.fog*v,b.copy(w.horizon).lerp(y,.85*u),g.fog.color.copy(b),i.setClearColor(b,1),We.value=ue.fog,re.material.uniforms.uFogAmt.value=.7*ue.fog,Ve.value=ue.snow,He.value=ue.cloud*.55,Ue.x+=e*.018,Ue.y+=e*.009,Ge.value+=(r-Ge.value)*Math.min(1,e*1.5),$e.value=t,et.value=.035+.05*a,fe.update(e,t,w,ue),Ee&&Y.update(e,t,w),Ee&&X.step(e),Ee&&Je.update(e,t,w,{wind:.6*ue.cloud,qualityLevel:window.__quality&&window.__quality.level||0});let d=Ln(),f=d.kind===`pixel`||d.kind===`blend`?`pixel`:_n?`vector`:d.kind===`toon`?`charm`:`realistic`;if(he.update(e,t,w,ue,f,S.camera),D){let[e,t,n]=A;N.uniforms.uPrev.value=e.texture,N.uniforms.uCurr.value=t.texture,i.setRenderTarget(n),i.render(M,ee),A=[t,n,e],ie.uniforms.uHeight.value=A[1].texture}if(Tn<2&&typeof document<`u`&&++Tn===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Bn(e){gn=e,window.__mode=gn}function Vn(){return _n=!_n,Re.value=+!!_n,window.__vector=_n,_n}function Hn(e){return _n=!!e,Re.value=+!!_n,window.__vector=_n,_n}function Un(){return yn=Cn[(Cn.indexOf(yn)+1)%Cn.length],window.__era=yn,An(),yn}function Kn(){return vn=!vn,vn}return{updateWorld:zn,decideStyle:In,renderCityPipeline:Pn,renderCityBeautyTo:Mn,styleHintName:Rn,setPostMode:Bn,toggleVector:Vn,setVector:Hn,cycleEra:Un,togglePalette:Kn,setTonemap:e=>{let t=e===`agx`||e===1||e===!0;return Q.uniforms.uTonemap.value=+!!t,typeof window<`u`&&(window.__tonemap=t?`agx`:`aces`),t?`agx`:`aces`},get mode(){return gn},get vector(){return _n},get sceneEra(){return yn},renderer:i,drawBuffer:u,scene:g,rig:S,sunRig:w,SIM:256,targets:A,simScene:M,simCamera:ee,simMaterial:N,grabRT:P,card:L,backdrop:re,WATER_SIZE:28,water:ae,waterMaterial:ie,windowGlow:z,landmarkFactory:se,city:V,cityLife:ce,waterLife:le,weatherRig:ue,clouds:fe,inspector:me,world:Ct,catalog:wt,editor:Tt,pilot:Ot,profiler:sn,governor:dn,frameStart:fn,frameEnd:pn,setActive:mn,get paused(){return p},get contextLost(){return d},prewarm:hn,fitShadowFrustum:kt,SHADOW_DIST:24,sceneDepth:At,sceneRT:jt,filmicRT:Nt,toonRT:Ft,pixelRT:It,postScene:Vt,postCamera:Ht,postQuad:Wt,filmicMaterial:Q,pixelMaterial:Xt,pixelkitMaterial:Zt,toonMaterial:$t,mixMaterial:tn,PALCACHE:Yt,ERA_TEX:Qt,runPass:rn,OVERCAST_GREY:_,FOG_DENSITY:v,FOG_NIGHT_TINT:y,_fogColor:b,resize:on}}var Fi=`lgr_hints_`,Ii=!1;function Li(){if(Ii||typeof document>`u`)return;Ii=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  @media (prefers-reduced-motion: reduce) {
    ...
    `,document.head.appendChild(a),Y=document.createElement(`button`),Y.className=`hoard-bagbtn`,Y.textContent=`🎒`,Y.title=`Inventory (I)`,document.body.appendChild(Y),Y.addEventListener(`click`,()=>qe()),Ie=document.createElement(`div`),Ie.className=`hoard-bag`,document.body.appendChild(Ie)}let Re=0;function ze(e,t=1.8){Me&&(Me.textContent=e,Me.style.display=`block`),Re=t}let Be=Math.PI/4;function Ve(e){Be=e}function He(e,t){ge={x:e,z:t}}function Ue(e){he=e}function We(){if(typeof window<`u`&&(window.__hoardBag=Object.fromEntries(I.map(e=>[e.id,e.n]))),!Ie)return;let e=`<div class="panel"><h3>INVENTORY</h3><div class="slots">`;for(let t=0;t<8;t++){let n=I[t];n?e+=`<button class="slot" data-id="${n.id}" title="${Wi[n.id].name}">${Wi[n.id].glyph}<span class="n">${n.n}</span></button>`:e+=`<div class="slot empty"></div>`}e+=`</div><div class="craft">`,Gi.forEach((t,n)=>{let r=Object.keys(t.need).every(e=>L(e)>=t.need[e]),i=Object.entries(t.need).map(([e,t])=>`${t}${Wi[e].glyph}`).join(`+`);e+=`<button data-rec="${n}" ${r?``:`disabled`}>Craft ${Wi[t.out].name} (${i})</button>`}),e+=`</div><button class="close">CLOSE (I)</button></div>`,Ie.innerHTML=e,Ie.querySelectorAll(`.slot[data-id]`).forEach(e=>e.addEventListener(`click`,()=>{Wi[e.dataset.id].consumable&&re(e.dataset.id)})),Ie.querySelectorAll(`[data-rec]`).forEach(e=>e.addEventListener(`click`,()=>ie(Gi[+e.dataset.rec]))),Ie.querySelector(`.close`).addEventListener(`click`,()=>Ke())}function Ge(){!z||oe||(Le=!0,Ie&&Ie.classList.add(`open`),We())}function Ke(){Le=!1,Ie&&Ie.classList.remove(`open`)}function qe(){Le?Ke():Ge()}function X(e){B=e,fe=5+e*2,le=`spawning`}function Je(){w.x=0,w.z=0,w.vx=0,w.vz=0,w.hp=100,w.stamina=100,w.hunger=100,w.thirst=100,w.facing=0,w.iframe=0;for(let e of E)e.alive=!1;se=0,V=0,ce=0,oe=!1,he=!1,ge=null;for(let e of O)e.hp=150,e.alive=!0,e.mesh.scale.set(1,1,1);for(let e of j)e.active=!1,e.mesh.visible=!1;I.length=0;let e=[`food`,`water`,`food`,`water`,`bandage`,`scrap`];for(let t=0;t<6;t++){let n=Math.random()*Math.PI*2,r=1.6+Math.random()*(a-2);F(Math.cos(n)*r,Math.sin(n)*r,e[t])}Ne&&(Ne.style.display=`none`),m.position.set(0,r,0),m.visible=!0,X(1),We()}function Ye(){Je()}function Xe(e){z=e,n.visible=e;let t=e&&s;q&&(q.style.display=t?`block`:`none`),Pe&&(Pe.style.display=t?`block`:`none`),Fe&&(Fe.style.display=t?`block`:`none`),Ee&&(Ee.style.display=e?`block`:`none`),Me&&!e&&(Me.style.display=`none`),Ne&&!e&&(Ne.style.display=`none`),Y&&(Y.style.display=e?`block`:`none`),Ke();for(let e in Te)Te[e]=!1;G.x=G.y=0,he=!1,e&&Je()}let Ze=new d;function Qe(e,t,n){if(!z||Le)return;let i=n?n.windowGlow:0;if(pe=Math.max(0,pe-e),me=Math.max(0,me-e),S.material.opacity=Math.max(0,S.material.opacity-e*8),y.material.opacity=Math.max(0,y.material.opacity-e*6),!oe){ce+=e,w.iframe=Math.max(0,w.iframe-e);let n=(Te.d||Te.arrowright?1:0)-(Te.a||Te.arrowleft?1:0)+G.x,i=(Te.w||Te.arrowup?1:0)-(Te.s||Te.arrowdown?1:0)+G.y,o=Math.hypot(n,i);o>1&&(n/=o,i/=o);let s=o>.05,c=(Te.shift||G.y>.95)&&w.stamina>2&&s,l=Math.cos(Be),d=Math.sin(Be),p=l*n+-d*i,h=-d*n+-l*i,g=c?5.2:3,_=1-Math.exp(-14*e);w.vx+=(p*g-w.vx)*_,w.vz+=(h*g-w.vz)*_,w.x+=w.vx*e,w.z+=w.vz*e;let v=Math.hypot(w.x,w.z);v>a&&(w.x*=a/v,w.z*=a/v,w.vx=0,w.vz=0),s&&(w.facing=Math.atan2(p,h)),w.stamina=W.clamp(w.stamina+(c?-34:22)*e,0,100),w.hunger=Math.max(0,w.hunger-.9*e),w.thirst=Math.max(0,w.thirst-1.15*e),w.hunger<=0||w.thirst<=0?w.hp=Math.max(0,w.hp-3.5*e):w.hunger>55&&w.thirst>55&&w.hp<100&&(w.hp=Math.min(100,w.hp+2*e));for(let e of j)e.active&&(e.x-w.x)**2+(e.z-w.z)**2<.3&&te(e.kind)&&(e.active=!1,e.mesh.visible=!1,We());for(let t of O){if(t.hp>=150)continue;let n=Math.cos(t.ang)*u,r=Math.sin(t.ang)*u;(n-w.x)**2+(r-w.z)**2<f*f&&(t.hp=Math.min(150,t.hp+30*e),t.hp>0&&(t.alive=!0))}w.hp<=0&&$e(),m.position.set(w.x,r,w.z),m.rotation.y=w.facing,m.visible=!(w.iframe>0&&Math.floor(t*20)%2==0),he&&Ce(),y.position.set(w.x,r+.06,w.z),y.rotation.z=-w.facing}let o=0;oe||le===`spawning`&&(fe>0&&Math.random()<e*(B===1?3.5:6)&&(ve(i),fe--),fe<=0&&(le=`fighting`));let s=0,c=1/0;for(let n=0;n<48;n++){let i=E[n];if(!i.alive){Ze.position.set(0,-60,0),Ze.scale.setScalar(0),Ze.updateMatrix(),T.setMatrixAt(n,Ze.matrix);continue}o++;let a=w.x-i.x,d=w.z-i.z,f=Math.hypot(a,d)||1;if(f<c&&(c=f),!oe){let t=a/f*i.speed,n=d/f*i.speed,r=1-Math.exp(-6*e);if(i.vx+=(t-i.vx)*r,i.vz+=(n-i.vz)*r,f>.52){let t=i.x+i.vx*e,n=i.z+i.vz*e,r=Math.hypot(i.x,i.z),a=Math.hypot(t,n);if(!i.in&&r>=u&&a<4.9){let r=A(t,n);if(r.alive){let i=Math.atan2(n,t),a=4.9;t=Math.cos(i)*a,n=Math.sin(i)*a,r.hp-=15*e,r.hp<=0&&(r.hp=0,r.alive=!1)}}a<u-.1&&(i.in=!0),i.x=t,i.z=n}else w.iframe<=0&&(s=Math.max(s,i.dmg))}i.flash=Math.max(0,i.flash-e);let p=Math.sin(t*6+i.phase)*.04;Ze.position.set(i.x,r+.3*i.size*l+p,i.z),Ze.rotation.set(0,Math.atan2(i.vx,i.vz),Math.sin(t*3+i.phase)*.12),Ze.scale.setScalar(i.size*l),Ze.updateMatrix(),T.setMatrixAt(n,Ze.matrix),D.set(Bi[i.type].color),i.flash>0?D.lerp(Hi,.7):D.lerp(Ui,.35*(1-i.hp/i.maxhp)),T.setColorAt(n,D)}T.instanceMatrix.needsUpdate=!0,T.instanceColor&&(T.instanceColor.needsUpdate=!0);let d=0;for(let e of O){e.alive&&d++;let t=Math.max(0,e.hp/150);e.mesh.scale.y=e.alive?Math.max(.18,t):.12,e.mesh.position.y=r+.35*e.mesh.scale.y,e.mesh.material.color.copy(e.baseColor).lerp(Ui,(1-t)*.55)}!oe&&s>0&&(w.hp=Math.max(0,w.hp-s*(B===1?.5:1)),w.iframe=.6,w.hp<=0&&$e()),!oe&&le===`fighting`&&o===0&&fe<=0&&(le=`complete`,de=2.2,ze(`WAVE ${B} CLEAR`,2)),!oe&&le===`complete`&&(de-=e,de<=0&&(X(B+1),ze(`WAVE ${B}`,1.4))),Re>0&&(Re-=e,Re<=0&&Me&&(Me.style.display=`none`)),De&&(De.style.width=`${w.hp}%`),Oe&&(Oe.style.width=`${w.stamina}%`),ke&&(ke.style.width=`${w.hunger}%`),Ae&&(Ae.style.width=`${w.thirst}%`),je&&(je.textContent=`WAVE ${B}   KILLS ${se}   SCORE ${V}`),typeof window<`u`&&(window.__hoard={active:z,dead:oe,paused:Le,hp:Math.round(w.hp),stamina:Math.round(w.stamina),hunger:Math.round(w.hunger),thirst:Math.round(w.thirst),zombies:o,barriers:d,pickups:j.filter(e=>e.active).length,inv:Object.fromEntries(I.map(e=>[e.id,e.n])),wave:B,kills:se,score:V,weapon:`gun`,znear:+c.toFixed(2),px:+w.x.toFixed(2),pz:+w.z.toFixed(2)})}function $e(){oe=!0,he=!1,Ne&&(Ne.querySelector(`.ds`).innerHTML=`Wave reached: ${B}<br>Kills: ${se}<br>Score: ${V}<br>Survived: ${ce.toFixed(0)}s`,Ne.style.display=`flex`)}return{group:n,update:Qe,setActive:Xe,setAzimuth:Ve,setAim:He,setFiring:Ue,melee:we,reset:Je,restart:Ye,openBag:Ge,closeBag:Ke,toggleBag:qe,addItem:te,get player(){return w},get dead(){return oe},get active(){return z},get paused(){return Le},get inv(){return I.map(e=>({...e}))},get nearestPickup(){let e=null,t=1e9;for(let n of j){if(!n.active)continue;let r=(n.x-w.x)**2+(n.z-w.z)**2;r<t&&(t=r,e=n)}return e?{x:e.x,z:e.z}:null},setTarget(){}}}var{Timer:qi}=O,Ji=new URLSearchParams(window.location.search),Yi=Ji.get(`demo`)===`1`||Ji.has(`capture`);window.__demo=Yi;var Xi=(Ji.get(`city`)?Number(Ji.get(`city`)):0)||Math.random()*1e9|0,Zi=0,Qi=Pi({demo:Yi,citySeed:Xi,profileIndex:Zi}),{renderer:$i,scene:ea,rig:ta,sunRig:na,city:ra,landmarkFactory:ia}=Qi,aa=Ki({extent:ra.extent,plinthTop:.3});ea.add(aa.group),window.__hoardApi=aa,typeof window<`u`&&(window.__quality={get level(){return Qi.governor.level},forceLoad:e=>Qi.profiler.forceLoad(e)}),typeof window<`u`&&(window.__rig=ta);var oa=!0;window.__shadows=oa,window.__scene=`hoard`;var sa=new H,ca=new Set,la=6.5;function ua(e){ra.group.traverse(t=>{!t.isMesh||t.userData.ground||!t.visible||(t.getWorldPosition(sa),Math.hypot(sa.x,sa.z)<e&&(t.visible=!1,ca.add(t)))})}function da(){for(let e of ca)e.visible=!0;ca.clear()}var fa=new V,pa=new H,ma=new H,ha=new Set;function ga(){for(let e of ha)e.material&&(e.material.opacity=1,e.material.transparent=!!e.userData._wasT,e.material.depthWrite=e.userData._wasDW!==!1);ha.clear()}function _a(e){ga();let t=ta.camera;for(let[n,r]of[[0,0],[.7,.4],[-.7,.4]]){ma.set(e.x+n,.6,e.z+r),pa.subVectors(ma,t.position);let i=pa.length();fa.set(t.position,pa.normalize()),fa.far=i-.4;for(let e of fa.intersectObject(ra.group,!0)){let t=e.object;!t.material||t.userData.ground||ha.has(t)||(t.userData._wasT=t.material.transparent,t.userData._wasDW=t.material.depthWrite,t.material.transparent=!0,t.material.opacity=.16,t.material.depthWrite=!1,ha.add(t))}}}function va(){aa.setActive(!0),ua(la),ta.setMode(q.DIMETRIC),ta.setZoom(2.8,!0),ta.setTarget(aa.player.x,.6,aa.player.z,!0)}var ya=new V,ba=new I,xa=new w(new H(0,1,0),-.32),Sa=new H,Ca=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,wa=!1,Ta=0,Ea=0,Da=.005,Oa=(e,t)=>{ba.x=e/window.innerWidth*2-1,ba.y=-(t/window.innerHeight)*2+1};$i.domElement.addEventListener(`contextmenu`,e=>e.preventDefault()),$i.domElement.addEventListener(`mousedown`,e=>{e.button===0&&(Oa(e.clientX,e.clientY),aa.setFiring(!0)),e.button===2&&(wa=!0,Ta=e.clientX,Ea=e.clientY)}),window.addEventListener(`mousemove`,e=>{Oa(e.clientX,e.clientY),wa&&(ta.orbit(-(e.clientX-Ta)*Da,-(e.clientY-Ea)*Da),Ta=e.clientX,Ea=e.clientY)}),window.addEventListener(`mouseup`,()=>{aa.setFiring(!1),wa=!1}),$i.domElement.addEventListener(`wheel`,e=>{e.preventDefault(),ta.zoomBy(Math.exp(e.deltaY*.0015))},{passive:!1});var ka=0,Aa=(e,t)=>[(e.clientX+t.clientX)/2,(e.clientY+t.clientY)/2],ja=(e,t)=>Math.hypot(e.clientX-t.clientX,e.clientY-t.clientY);$i.domElement.addEventListener(`touchstart`,e=>{e.touches.length===2&&(wa=!0,[Ta,Ea]=Aa(e.touches[0],e.touches[1]),ka=ja(e.touches[0],e.touches[1]))},{passive:!0}),$i.domElement.addEventListener(`touchmove`,e=>{if(e.touches.length!==2)return;e.preventDefault();let[t,n]=Aa(e.touches[0],e.touches[1]);ta.orbit(-(t-Ta)*Da,-(n-Ea)*Da),Ta=t,Ea=n;let r=ja(e.touches[0],e.touches[1]);ka>0&&ta.zoomBy(ka/r),ka=r},{passive:!1}),window.addEventListener(`touchend`,e=>{(!e.touches||e.touches.length<2)&&(wa=!1,ka=0)}),window.addEventListener(`keydown`,e=>{(e.key===`h`||e.key===`H`)&&(oa=!oa,window.__shadows=oa)}),ia.whenReady.then(()=>{ra.generate(Xi,Zi),Qi.fitShadowFrustum(),da(),ua(la),window.__cityReady=!0});var Ma=new qi;Ma.connect(document);function Na(){Ma.update(),Qi.frameStart();let e=Math.min(Ma.getDelta(),.1);aa.setAzimuth(ta.azimuth),Ca||(ya.setFromCamera(ba,ta.camera),ya.ray.intersectPlane(xa,Sa)&&aa.setAim(Sa.x,Sa.z)),aa.update(e,Ma.getElapsed(),na),ta.setTarget(aa.player.x,.6,aa.player.z),ta.update(e),_a(aa.player),Qi.updateWorld(e,Ma.getElapsed(),{shadowsOn:oa,seasonTarget:0});let t=Qi.decideStyle();Qi.renderCityPipeline(t,null),Qi.frameEnd(),requestAnimationFrame(Na)}va(),Na(),Ri({key:`hoard`,title:`The Hoard`,tips:[`Move: WASD / arrows · on touch: the left thumb-stick`,`Aim: mouse / drag · Fire: hold click / the FIRE button · Melee: the MELEE button`,`Survive the waves · B: bag & crafting · Esc: exit`]}),window.addEventListener(`resize`,()=>{Qi.resize()});