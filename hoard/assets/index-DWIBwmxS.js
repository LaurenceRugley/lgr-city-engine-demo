import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,Q as _,R as v,S as y,T as b,U as x,V as S,W as C,X as w,Y as T,Z as E,_ as D,a as O,at as k,b as A,c as j,ct as ee,d as te,dt as M,et as N,f as P,ft as F,g as ne,h as I,i as re,it as ie,j as ae,k as L,l as oe,lt as R,m as se,mt as z,n as B,nt as V,o as ce,ot as le,p as ue,pt as H,q as de,r as fe,rt as pe,s as U,st as me,t as he,tt as ge,u as _e,ut as ve,v as ye,w as be,x as W,y as xe,z as G}from"./three-Cd4EyEsF.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var Se=(e,t,n,r)=>e+(t-e)*(1-Math.exp(-n*r)),K=(e,t,n)=>e<t?t:e>n?n:e,q=Math.atan(1/Math.SQRT2),Ce=Math.atan(.5),we=Math.PI/4,J={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},Te=8,Ee=.12,De=1.45,Oe=4,ke=40,Ae=1.5,Y=16,je=6,Me=22,X=3.5,Ne=11,Pe=(e,t,n)=>Se(e,t,Te,n),Fe=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function Ie({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new H(0,.8,0),azimuth:a=we,elevation:o=.52,distance:s=12,zoom:c=5.5}={}){let l=new T(t,e,n,r),u=new de(-1,1,1,-1,n,r),d=J.PERSPECTIVE,f=e,p={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},m={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},h=!1,g=null,_=new H,v=()=>d===J.PERSPECTIVE?l:u;function y(e){e!==d&&(d=e,d===J.ISOMETRIC||d===J.DIMETRIC?(p.elevation=d===J.ISOMETRIC?q:Ce,p.azimuth=Fe(we,m.azimuth),h=!0):h=!1)}function b(e,t){p.azimuth+=e,h||(p.elevation=G.clamp(p.elevation+t,Ee,De))}function x(e){d===J.PERSPECTIVE?p.distance=G.clamp(p.distance*e,Oe,ke):p.zoom=G.clamp(p.zoom*e,Ae,Y)}function S(e,t){let n=p.azimuth,r=d===J.PERSPECTIVE?p.distance*.04:p.zoom*.08,i=new H(Math.cos(n),0,-Math.sin(n)),a=new H(-Math.sin(n),0,-Math.cos(n));p.target.addScaledVector(i,e*r),p.target.addScaledVector(a,t*r)}function C(e,t){f=e/t,l.aspect=f,l.updateProjectionMatrix()}function w(e){g&&(g(_),p.target.copy(_)),m.azimuth=Pe(m.azimuth,p.azimuth,e),m.elevation=Pe(m.elevation,p.elevation,e),m.distance=Pe(m.distance,p.distance,e),m.zoom=Pe(m.zoom,p.zoom,e),m.target.x=Pe(m.target.x,p.target.x,e),m.target.y=Pe(m.target.y,p.target.y,e),m.target.z=Pe(m.target.z,p.target.z,e);let t=Math.cos(m.elevation),n=Math.sin(m.elevation),r=Math.cos(m.azimuth),i=Math.sin(m.azimuth),a=v();if(a.position.set(m.target.x+m.distance*t*i,m.target.y+m.distance*n,m.target.z+m.distance*t*r),a.lookAt(m.target),a.isOrthographicCamera){let e=m.zoom,t=e*f;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function E(e,t,n,r=!1){p.target.set(e,t,n),r&&m.target.copy(p.target)}function D(e,t=!1){p.zoom=G.clamp(e,Ae,Y),t&&(m.zoom=p.zoom)}function O(e,t=!1){p.azimuth=Fe(e,m.azimuth),t&&(m.azimuth=p.azimuth)}function k(e,t=!1){p.elevation=G.clamp(e,Ee,De),t&&(m.elevation=p.elevation)}function A(e,{frame:t,snap:n=!1}={}){g=e,n&&(g(_),p.target.copy(_),m.target.copy(_)),t!=null&&(d===J.PERSPECTIVE?p.distance=G.clamp(t,Oe,ke):p.zoom=G.clamp(t,Ae,Y))}function j(){g=null}return{get camera(){return v()},get mode(){return d},get azimuth(){return m.azimuth},get following(){return!!g},setTarget:E,setZoom:D,setFollow:A,clearFollow:j,setAzimuth:O,setElevation:k,get styleT(){return d===J.PERSPECTIVE?G.clamp((m.distance-je)/(Me-je),0,1):G.clamp((m.zoom-X)/(Ne-X),0,1)},setMode:y,orbit:b,zoomBy:x,pan:S,setViewport:C,update:w}}var Le={value:0},Re=new I(`#ffffff`),ze={value:0},Be={value:0},Ve={value:0},He=new F,Ue={value:0},We={value:0},Ge=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
}`;function Pn({renderer:e,N:t,cell:n,half:r,worldSize:i,seaY:a=0,FLOW:o,DAMP:l,MIN_DEPTH:u,readTerrain:d}){let f=e.getContext();if(!(f&&f.getExtension&&f.getExtension(`EXT_color_buffer_float`)))return typeof console<`u`&&console.warn(`[L87] EXT_color_buffer_float unavailable — GPU flow backend cannot run; staying on CPU.`),null;let p={type:b,format:ge,minFilter:s,magFilter:s,wrapS:se,wrapT:se,depthBuffer:!1,stencilBuffer:!1},m=[new z(t,t,p),new z(t,t,p)],h=[new z(t,t,p),new z(t,t,p)],g=new Float32Array(t*t*4),_=new ye(g,t,t,ge,b);_.minFilter=s,_.magFilter=s,_.wrapS=_.wrapT=se;let v=new Float32Array(t*t),y=new ie,x=new de(-1,1,1,-1,0,1),S=new c(new E(2,2),null);S.frustumCulled=!1,y.add(S);let w=new F(1/t,1/t),T=new k({vertexShader:An,fragmentShader:jn,uniforms:{uState:{value:null},uTerr:{value:_},uFlux:{value:null},uTexel:{value:w},uN:{value:t},uDt:{value:0},uFlow:{value:o},uDamp:{value:l}}}),D=new k({vertexShader:An,fragmentShader:Mn,uniforms:{uState:{value:null},uTerr:{value:_},uFlux:{value:null},uTexel:{value:w},uN:{value:t},uDt:{value:0},uSeaY:{value:a}}}),O=new k({vertexShader:An,fragmentShader:Nn,uniforms:{uState:{value:null},uTerr:{value:_},uN:{value:t},uSeaY:{value:a},uRain:{value:0},uPourCount:{value:0},uPours:{value:Array.from({length:8},()=>new H)},uPourR:{value:new Float32Array(8)}}});function A(t,n){S.material=t;let r=e.getRenderTarget();e.setRenderTarget(n),e.render(y,x),e.setRenderTarget(r)}let ee=new I;function te(t){let n=e.getRenderTarget(),r=e.getClearAlpha();e.getClearColor(ee),e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1),e.setClearColor(ee,r),e.setRenderTarget(n)}function M(){te(m[0]),te(m[1]),te(h[0]),te(h[1])}M();function N(){d(v);for(let e=0;e<t*t;e++)g[e*4]=v[e];_.needsUpdate=!0}let P=t*t,ne=new Float32Array(P*3),re=new Float32Array(P*2);for(let e=0;e<t;e++)for(let i=0;i<t;i++){let a=e*t+i;ne[a*3]=i*n-r,ne[a*3+1]=0,ne[a*3+2]=e*n-r,re[a*2]=(i+.5)/t,re[a*2+1]=(e+.5)/t}let ae=[];for(let e=0;e<t-1;e++)for(let n=0;n<t-1;n++){let r=e*t+n,i=e*t+n+1,a=(e+1)*t+n,o=(e+1)*t+n+1;ae.push(r,a,i,i,a,o)}let L=new oe;L.setAttribute(`position`,new j(ne,3)),L.setAttribute(`aGridUv`,new j(re,2)),L.setIndex(ae),L.boundingSphere=new me(new H(0,0,0),i);let R={uStateTex:{value:m[0].texture},uTerrTex:{value:_},uMinDepth:{value:u}},B=new C({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});B.onBeforeCompile=e=>{e.uniforms.uStateTex=R.uStateTex,e.uniforms.uTerrTex=R.uTerrTex,e.uniforms.uMinDepth=R.uMinDepth,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,_i={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},vi=[`gb`,`8-bit`,`16-bit`,`modern`];function yi(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new I(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new ye(n,t,1,ge,b);return r.minFilter=s,r.magFilter=s,r.needsUpdate=!0,r}var bi=220,xi={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Si={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Ci({demo:e=!1,citySeed:t=0,profileIndex:r=0}={}){let i=new re({antialias:!0,preserveDrawingBuffer:!0});i.shadowMap.enabled=!0,i.shadowMap.type=1,i.shadowMap.autoUpdate=!1,i.shadowMap.needsUpdate=!0;let o=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches?1.5:2;i.setPixelRatio(Math.min(window.devicePixelRatio,o)),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(920327,1),document.body.appendChild(i.domElement);let l=i.getDrawingBufferSize(new F),u=!1,d=!1,p=()=>{};i.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),u=!0,typeof window<`u`&&(window.__contextLost=!0)},!1),i.domElement.addEventListener(`webglcontextrestored`,()=>{p(),u=!1,typeof window<`u`&&(window.__contextLost=!1)},!1);let m=new ie;m.fog=new a(10465470,0);let g=new I(`#aeb6c0`),_=.062,v=new I(`#74508f`),y=new I,b=Ie({aspect:window.innerWidth/window.innerHeight}),S=St({t:.5}),w={type:h,format:ge,minFilter:s,magFilter:s,wrapS:se,wrapT:se,depthBuffer:!1,stencilBuffer:!1},T=[new z(256,256,w),new z(256,256,w),new z(256,256,w)];for(let e of T)i.setRenderTarget(e),i.clear();i.setRenderTarget(null);let D=new ie,O=new de(-1,1,1,-1,0,1),A=new k({vertexShader:An,fragmentShader:si,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new F(1/256,1/256)},uMouse:{value:new F(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new H)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new H)}}});D.add(new c(new E(2,2),A));let j=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!0,stencilBuffer:!1});function ee(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new _e(t);return r.colorSpace=pe,r}let te=new c(new E(28,28),new x({map:ee(e)}));te.rotation.x=-Math.PI/2,te.position.y=-.35,m.add(te);let M=new c(new E(40,24),new k({depthWrite:!1,vertexShader:ai,fragmentShader:oi,uniforms:{uTime:{value:0},uInk:{value:S.horizon},uGold:{value:S.sky},uFogColor:{value:y},uFogAmt:{value:0},uFogCharm:Ue}}));M.position.set(0,3,-8),m.add(M);let N=new k({vertexShader:ci,fragmentShader:li,uniforms:{uHeight:{value:null},uScene:{value:j.texture},uTexel:{value:new F(1/256,1/256)},uResolution:{value:new F(l.x,l.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new n},uLightDir:{value:S.sunDir},uInk:{value:new I(`#2A2218`)},uGold:{value:new I(`#B89968`)},uVector:Le,uVecWater:{value:new I(`#1fb8d8`)},uVecTint:{value:Re}}}),P=new c(new E(28,28,255,255),N);P.rotation.x=-Math.PI/2,P.updateMatrixWorld(!0),N.uniforms.uNormalMatrix.value.getNormalMatrix(P.matrixWorld),m.add(P);let ne={value:0},ae=Yt({windowGlow:ne}),L=mt({seed:t,profileIndex:r,landmarkFactory:ae,windowGlow:ne});m.add(L.group);let oe=Dt({plinthTop:.3,extent:L.extent,profile:L.state.profile});m.add(oe.group);let R=Lt({extent:L.extent,waterSize:28,plinthTop:.3});m.add(R.group),A.uniforms.uWakeDrops.value=R.wakeDrops;let B=Zt({extent:L.extent});m.add(B.group),A.uniforms.uRainDrops.value=B.rainDrops;let V=$t({extent:L.extent});m.add(V.group);let ce=[oe,R,V],le=nn({rig:b,getCamera:()=>b.camera,sources:ce}),ue=ii();m.add(ue.group);let fe=Br({scale:90});m.add(fe.mesh),m.environmentIntensity=.32;let U=!1;function me(e){let t=e&&S.sunArc.y>-.04;t!==U&&(U=t,fe.mesh.visible=t,M.visible=!t)}let he=null,ve=-1;p=()=>{he=null,ve=-1,i.shadowMap.needsUpdate=!0};function ye(){let e=Math.floor(S.t%1*4)%4;return(e!==ve||!he)&&(ve=e,he=fe.buildEnv(i)),he}let be=null,W=null,Se=null,K=null,q=!1,Ce=1234,we=`valley`,J=Xn.map(e=>e.key),Te=new C({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Ee=()=>[L.group,oe.group,R.group],De=()=>[be,W,Se].filter(Boolean);function Oe(){for(let e of De())m.remove(e),e.userData.dispose?.();let e=tr({seed:Ce,size:160,preset:we});K=e,be=cr(e,{worldSize:26,baseY:0,chunks:6}),W=Nr({terrain:e,seed:Ce,worldSize:26,baseY:0,biomeKeys:J}),Se=Ir(e,{worldSize:26,baseY:0,maxLakes:3,material:Te});for(let e of De())e.visible=q,m.add(e);Y!==void 0&&Y&&Y.clear(),X!==void 0&&X&&X.clear(),typeof window<`u`&&(window.__world={seed:Ce,preset:we,active:q,chunks:be.children.length,scatter:W.userData.counts,lakes:Se.userData.count})}let ke=e=>{for(let t of De())t.visible=e};function Ae(e,t){if(!K)return 0;let{size:n,height:r,sea:i,relief:a}=K,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let Y=On({heightAt:Ae,seaSurfaceY:0,waterY:.06});Y.group.visible=!1,m.add(Y.group),ce.push(Y);let je=0;function Me(e,t){if(!K||!be)return;let{size:n,height:r,relief:i}=K,a=26/(n-1),o=26/(t-1),s=i>1e-6?1/i:0,c=!1;for(let i=0;i<t;i++)for(let l=0;l<t;l++){let u=e[i*t+l];if(u===0)continue;c=!0;let d=u*s,f=l*o/a,p=i*o/a,m=Math.max(0,Math.round(f-1)),h=Math.min(n-1,Math.round(f+1)),g=Math.max(0,Math.round(p-1)),_=Math.min(n-1,Math.round(p+1));for(let e=g;e<=_;e++)for(let t=m;t<=h;t++){let i=e*n+t,a=r[i]+d;r[i]=a<0?0:a>1?1:a}}c&&(je++,je%8==0&&lr(be,K,be.children),je%24==0&&W&&Mr(W,K,{worldSize:26,baseY:0}))}let X=Fn({worldHeightAt:Ae,applyErosion:Me,worldSize:26,grid:96,seaY:0,renderer:i});X.group.visible=!1,m.add(X.group);let Ne=null,Pe=new Set;function Fe(){!K||!Se||(m.remove(Se),Se.userData.dispose?.(),Se=Ir(K,{worldSize:26,baseY:0,maxLakes:3,material:Te}),Se.visible=q,m.add(Se),window.__world&&(window.__world.lakes=Se.userData.count))}function Ge(){Fe(),W&&Mr(W,K,{worldSize:26,baseY:0})}function Ke(e,t,n=1,r=2.2,i=.05){if(!K||!be)return;let a=K.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=K.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Pe.clear();for(let e of be.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Pe.add(e)}lr(be,K,Pe),Ne&&clearTimeout(Ne),Ne=setTimeout(Ge,140)}function qe(e,t,n,r=2.2){if(!K||!be||n==null)return;let i=K.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=K.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);Pe.clear();for(let e of be.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Pe.add(e)}lr(be,K,Pe,!0)}let Je=[`tree`,`rock`,`tuft`];function Ye(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!K||!W)return 0;if(a)return Ar(W,n||`all`,e,t,i);let o=K.size,s=26/(o-1),c=K.height,l=K.sea,u=K.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=jr[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;kr(W,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&W.userData.counts)for(let e of Je)W.userData.counts[e]=(W.userData.placements[e]||[]).length;return g}let Xe=[];function Ze(){if(!W)return null;let e=W.userData.placements,t={};for(let n of Je)t[n]=(e[n]||[]).map(e=>({...e}));return t}function Z(){K&&(Xe.push({h:K.height.slice(),b:K.biome.slice(),sc:Ze(),pl:Y.snapshot()}),Xe.length>12&&Xe.shift())}function $e(){if(!K||!Xe.length)return!1;let e=Xe.pop();if(K.height.set(e.h),K.biome.set(e.b),e.sc&&W){let t=W.userData.placements;for(let n of Je)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&Y.restore(e.pl),lr(be,K,be.children,!0),Ge(),!0}let et=new Set([`boat`,`fish`]),tt=new Set([`person`,`atv`]);function nt(e,t,n){if(!K)return null;let r=Ae(t,n)<0;return et.has(e)&&!r||tt.has(e)&&r?null:Y.spawn(e,t,n)}function rt(e,t,n=2.5){return Y.removeNear(e,t,n)}function it(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function at(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let ot=e=>it(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),st=e=>it(e);function ct(){let e=W?W.userData.placements:{},t={};for(let n of Je)t[n]=(e[n]||[]).map(e=>({...e}));return t}function lt(){return K?{v:1,seed:Ce,preset:we,size:K.size,height:ot(K.height),biome:st(K.biome),scatter:ct(),entities:Y.snapshot()}:null}function ut(){if(!K)return null;let e=tr({seed:Ce,size:160,preset:we}),t=K.height,n=K.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:Ce,preset:we,hd:r,bd:i,entities:Y.snapshot()}}function dt(e){W&&(m.remove(W),W.userData.dispose?.()),W=Tr(e||{tree:[],rock:[],tuft:[]}),W.userData.counts=Je.reduce((e,t)=>(e[t]=(W.userData.placements[t]||[]).length,e),{}),W.visible=q,m.add(W)}function ft(e){if(!e||e.v!==1)return!1;Ce=e.seed|0,we=er.includes(e.preset)?e.preset:we,Xe.length=0,Oe(),q=!0,ke(!0),Y.group.visible=!0,X.group.visible=!0;for(let e of Ee())e.visible=!1;if(window.__world&&(window.__world.active=!0),e.height&&e.biome){let t=at(e.height);K.height.set(new Float32Array(t.buffer,t.byteOffset,t.byteLength/4));let n=at(e.biome);K.biome.set(n.subarray(0,K.biome.length))}else if(e.hd||e.bd){let t=e.hd||[],n=e.bd||[];for(let e=0;e<t.length;e+=2)K.height[t[e]]=t[e+1];for(let e=0;e<n.length;e+=2)K.biome[n[e]]=n[e+1]}return lr(be,K,be.children,!0),e.scatter&&dt(e.scatter),Fe(),W&&Mr(W,K,{worldSize:26,baseY:0}),Y.restore(e.entities),window.__world&&(window.__world.scatter=W.userData.counts,window.__world.seed=Ce,window.__world.preset=we),!0}let pt={enter(){be||Oe(),q=!0,ke(!0),Y.group.visible=!0,X.group.visible=!0;for(let e of Ee())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){q=!1,ke(!1),Y.group.visible=!1,X.group.visible=!1;for(let e of Ee())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return Ce=Math.random()*1e9|0,Xe.length=0,Oe(),pt.enter(),Ce},reset(){return Xe.length=0,Oe(),pt.enter(),Ce},setPreset(e){return er.includes(e)&&(we=e,Xe.length=0,Oe(),pt.enter()),we},sculpt:Ke,paintBiome:qe,paintScatter:Ye,repoolWater:Fe,snapshot:Z,undo:$e,placeEntity:nt,removeEntityNear:rt,heightAt:Ae,serialize:lt,serializeCompact:ut,deserialize:ft,flowPourAt:(e,t,n,r)=>X.pourAt(e,t,n,r),flowRain:e=>X.rain(e),flowClear:()=>X.clear(),get flowTotal(){return X.totalWater()},flowAt:(e,t)=>X.cellAt(e,t),flowErosion:(e,t)=>X.setErosion(e,t),get flowErosionOn(){return X.erosion},get flowSediment(){return X.totalSediment()},setSimBackend:e=>X.setBackend(e),get simBackend(){return X.backend},get terrainGroup(){return be},get biomes(){return Xn},get scatterCounts(){return W?W.userData.placements&&Je.reduce((e,t)=>(e[t]=(W.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return Y.counts()},setScatterHidden(e){W&&(W.visible=!e)},get placedLife(){return Y},get canUndo(){return Xe.length>0},get active(){return q},get seed(){return Ce},get preset(){return we},get presets(){return er}},ht=Rr(),gt=Bn({world:pt,catalog:ht,inspector:le});function _t(e,t){return Ae(e,t)<0?0:-999}let vt=hn({rig:b,world:{heightAt:Ae,waterHeightAt:_t}});L.group.remove(L.key),m.add(L.key),L.key.castShadow=!0,L.key.shadow.mapSize.set(2048,2048),L.key.shadow.bias=-18e-5,L.key.shadow.normalBias=.028,m.add(L.key.target);function yt(){let e=L.key.shadow.camera,t=L.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),i.shadowMap.needsUpdate=!0}yt();let bt=new xe(l.x,l.y),xt=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!0,stencilBuffer:!1,depthTexture:bt}),Ct=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),wt=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!0,stencilBuffer:!1,samples:4}),Tt=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),Et=new z(l.x,l.y,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),Ot=Math.max(1,Math.floor(l.x/2)),kt=Math.max(1,Math.floor(l.y/2)),At=new z(Ot,kt,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),jt=new z(Ot,kt,{minFilter:f,magFilter:f,depthBuffer:!1,stencilBuffer:!1}),Mt=new ie,Nt=new de(-1,1,1,-1,0,1),Pt=new c(new E(2,2));Mt.add(Pt);let Q=new k({vertexShader:An,fragmentShader:ui,uniforms:{uScene:{value:xt.texture},uTime:{value:0},uResolution:{value:new F(l.x,l.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:At.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:S.grade.tint},uGradeLift:{value:S.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1},uDither:{value:0},uTonemap:{value:0}}}),Ft=new k({vertexShader:An,fragmentShader:mi,uniforms:{uScene:{value:xt.texture},uThreshold:{value:.78}}}),It=new k({vertexShader:An,fragmentShader:hi,uniforms:{uScene:{value:At.texture},uDir:{value:new F}}});function Rt(e){Ft.uniforms.uScene.value=e.texture,Kt(Ft,At),It.uniforms.uScene.value=At.texture,It.uniforms.uDir.value.set(1.6/Ot,0),Kt(It,jt),It.uniforms.uScene.value=jt.texture,It.uniforms.uDir.value.set(0,1.6/kt),Kt(It,At),Q.uniforms.uBloom.value=At.texture;let t=1-G.clamp(S.sunArc.y*2.2,0,1);Q.uniforms.uBloomStrength.value=.85*(.32+.95*t)}let zt=e=>{let t=e.map(e=>new I(e));for(;t.length<8;)t.push(new I(0,0,0));return t},Bt=[`night`,`dawn`,`noon`,`dusk`],$={inkgold:Bt.map(e=>zt(xi[e])),terminal:Bt.map(e=>zt(Si[e]))},Vt=new k({vertexShader:An,fragmentShader:di,uniforms:{uScene:{value:Ct.texture},uResolution:{value:new F(l.x,l.y)},uPixelSize:{value:bi},uPalette:{value:$.inkgold[2]},uPaletteB:{value:$.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),Ht=new k({vertexShader:An,fragmentShader:gi,uniforms:{uScene:{value:Ct.texture},uResolution:{value:new F(l.x,l.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:yi(_i[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Ut={};for(let e of vi)Ut[e]=_i[e].palette?yi(_i[e].palette):null;let Wt=new k({vertexShader:An,fragmentShader:fi,uniforms:{uScene:{value:Ct.texture},uDepth:{value:bt},uResolution:{value:new F(l.x,l.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:S.toonFloor},uOutline:{value:S.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Gt=new k({vertexShader:An,fragmentShader:pi,uniforms:{uToon:{value:Tt.texture},uPixel:{value:Et.texture},uBlend:{value:0}}});function Kt(e,t){Pt.material=e,i.setRenderTarget(t),i.render(Mt,Nt)}function qt(){b.setViewport(window.innerWidth,window.innerHeight),i.setSize(window.innerWidth,window.innerHeight);let e=i.getDrawingBufferSize(new F);return j.setSize(e.x,e.y),xt.setSize(e.x,e.y),Ct.setSize(e.x,e.y),wt.setSize(e.x,e.y),Tt.setSize(e.x,e.y),Et.setSize(e.x,e.y),Ot=Math.max(1,e.x>>1),kt=Math.max(1,e.y>>1),At.setSize(Ot,kt),jt.setSize(Ot,kt),N.uniforms.uResolution.value.set(e.x,e.y),Q.uniforms.uResolution.value.set(e.x,e.y),Vt.uniforms.uResolution.value.set(e.x,e.y),Ht.uniforms.uResolution.value.set(e.x,e.y),Wt.uniforms.uResolution.value.set(e.x,e.y),e}let Jt=Un({renderer:i}),Xt=!0;function Qt(e,t){let n=t.dpr==null?o:t.dpr,r=Math.min(window.devicePixelRatio,n);Math.abs(i.getPixelRatio()-r)>.001&&(i.setPixelRatio(r),typeof window<`u`&&window.dispatchEvent?window.dispatchEvent(new Event(`resize`)):qt()),Xt=t.shadows!==!1,Xt||(i.shadowMap.needsUpdate=!1)}let en=Gn({profiler:Jt,apply:Qt});function tn(){!d&&!u&&Jt.frameStart()}function rn(){d||u||(Jt.frameEnd(),en.update())}function an(e){d=!e,typeof window<`u`&&(window.__paused=d)}function on(){try{i.compile(m,b.camera),kn(1/60,0,{shadowsOn:!0}),wn(Tn(),xt),i.setRenderTarget(null)}catch(e){typeof console<`u`&&console.warn(`[L79] prewarm`,e)}}let sn=3,cn=!1,ln=!1,un=`native`,dn=.3,fn=.46,pn=[`native`,...vi],mn={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=sn,window.__vector=cn,window.__era=un),typeof window<`u`&&(window.__frames=0),typeof window<`u`&&(window.__loaded=!1);let gn=0,_n=new H(1,1,1),vn=!1;function yn(e){let t=ln?$.terminal:$.inkgold,n=e%1*4,r=Math.floor(n)%4;Vt.uniforms.uPalette.value=t[r],Vt.uniforms.uPaletteB.value=t[(r+1)%4],Vt.uniforms.uPaletteBlend.value=n-Math.floor(n)}function bn(e){let t=_i[e];t&&(Ht.uniforms.uGridWidth.value=t.gridWidth,Ht.uniforms.uDither.value=t.dither,Ht.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(Ht.uniforms.uPalette.value=Ut[e],Ht.uniforms.uPaletteSize.value=t.palette.length))}function xn(){un!==`native`&&bn(un)}let Sn=()=>un===`native`?Vt:Ht;function Cn(e,t){me(!0),m.environment=ye(),Qe.value=1,P.visible=!1,i.setRenderTarget(j),i.render(m,e),P.visible=!0,i.setRenderTarget(wt),i.render(m,e),Rt(wt),Q.uniforms.uScene.value=wt.texture,Q.uniforms.uAces.value=1,Q.uniforms.uGrade.value=1,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=1,Kt(Q,t)}function wn(e,t){let n=!cn&&(sn===1||sn===2);if(me(n),m.environment=n?ye():null,Qe.value=+!!n,Q.uniforms.uBloomStrength.value=0,P.visible=!1,i.setRenderTarget(j),i.render(m,b.camera),P.visible=!0,sn===1&&!n)i.setRenderTarget(t),i.render(m,b.camera);else if(sn===1)i.setRenderTarget(wt),i.render(m,b.camera),Rt(wt),Q.uniforms.uScene.value=wt.texture,Q.uniforms.uAces.value=1,Q.uniforms.uGrade.value=1,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=1,Kt(Q,t);else if(i.setRenderTarget(n?wt:xt),i.render(m,b.camera),sn===2)n&&Rt(wt),Q.uniforms.uScene.value=n?wt.texture:xt.texture,Q.uniforms.uAces.value=+!!n,Q.uniforms.uGrade.value=+!!n,Q.uniforms.uGrain.value=1,Q.uniforms.uChroma.value=1,Q.uniforms.uDither.value=+!!n,Kt(Q,t);else{Q.uniforms.uScene.value=xt.texture,Q.uniforms.uAces.value=0,Q.uniforms.uGrade.value=0,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=0,Kt(Q,Ct);let n=b.camera;Wt.uniforms.uNear.value=n.near,Wt.uniforms.uFar.value=n.far,Wt.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(bn(e.era),Ht):Sn();e.kind===`pixel`?(Kt(r,t),window.__style=`pixel`):e.kind===`toon`?(Kt(Wt,t),window.__style=`toon`):(Kt(Wt,Tt),Kt(r,Et),Gt.uniforms.uBlend.value=e.blend,Kt(Gt,t),window.__style=`blend`)}}function Tn(){let e=En(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return N.uniforms.uChromaScale.value=G.lerp(1,.5,t),e}function En(){if(sn===1||sn===2)return{kind:`none`};if(sn===7)return{kind:`pixel`};if(sn===8)return{kind:`toon`};let e=b.styleT;return window.__styleT=e,e<=dn?{kind:`toon`}:e>=fn?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:G.smoothstep(e,dn,fn),era:`16-bit`}}function Dn(e){return sn===1||sn===2?``:cn&&sn!==7&&sn!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?mn[e.era||un]||`Pixel`:e.kind===`blend`?`Toon → `+(mn[e.era]||`Pixel`):``}function kn(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){typeof window<`u`&&window.__frames++,n&&=Xt,M.material.uniforms.uTime.value=t,Q.uniforms.uTime.value=t,S.update(e),L.key.position.copy(S.sunDir).multiplyScalar(24),L.key.color.copy(S.sunColor),L.key.intensity=S.sunIntensity,L.fill.color.copy(S.hemiSky),L.fill.groundColor.copy(S.hemiGround),ne.value=S.windowGlow,fe.setSun(S.sunArc),fe.setParams(S.skyParams),Q.uniforms.uGradeSat.value=S.grade.sat,Q.uniforms.uGradeContrast.value=S.grade.contrast,m.environmentIntensity=.34*(1-.6*G.clamp(S.sunArc.y*1.5,0,1));let a=B.overcast;L.key.intensity*=1-.5*a,L.key.color.lerp(g,.45*a),L.fill.intensity=1+.7*a;let o=G.smoothstep(S.sunDir.y,.06,.34),s=G.lerp(.28,1,1-S.windowGlow),c=n?o*s:0;L.key.shadow.intensity=.72*c,ze.value=.52*c,(n&&!vn||_n.distanceToSquared(S.sunDir)>2e-5)&&(i.shadowMap.needsUpdate=!0,_n.copy(S.sunDir)),vn=n;let l=1-S.windowGlow;Re.setRGB(G.lerp(.46,1,l),G.lerp(.52,1,l),G.lerp(.74,1,l)),Q.uniforms.uExposure.value=S.exposure,Wt.uniforms.uToonGain.value=S.toonGain,i.setClearColor(S.horizon,1),yn(S.t),window.__t=S.t,oe.update(e,t,S),L.update(t),R.update(e,t,S),A.uniforms.uWakeCount.value=R.wakeCount,B.update(e,t),A.uniforms.uRainCount.value=B.rainDropCount;let u=B.fog*(1-l);m.fog.density=B.fog*_,y.copy(S.horizon).lerp(v,.85*u),m.fog.color.copy(y),i.setClearColor(y,1),Ue.value=B.fog,M.material.uniforms.uFogAmt.value=.7*B.fog,Be.value=B.snow,Ve.value=B.cloud*.55,He.x+=e*.018,He.y+=e*.009,We.value+=(r-We.value)*Math.min(1,e*1.5),V.update(e,t,S,B),q&&Y.update(e,t,S),q&&X.step(e);let d=En(),f=d.kind===`pixel`||d.kind===`blend`?`pixel`:cn?`vector`:d.kind===`toon`?`charm`:`realistic`;ue.update(e,t,S,B,f,b.camera);let[p,h,x]=T;if(A.uniforms.uPrev.value=p.texture,A.uniforms.uCurr.value=h.texture,i.setRenderTarget(x),i.render(D,O),T=[h,x,p],N.uniforms.uHeight.value=T[1].texture,gn<2&&typeof document<`u`&&++gn===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function jn(e){sn=e,window.__mode=sn}function Mn(){return cn=!cn,Le.value=+!!cn,window.__vector=cn,cn}function Nn(e){return cn=!!e,Le.value=+!!cn,window.__vector=cn,cn}function Pn(){return un=pn[(pn.indexOf(un)+1)%pn.length],window.__era=un,xn(),un}function In(){return ln=!ln,ln}return{updateWorld:kn,decideStyle:Tn,renderCityPipeline:wn,renderCityBeautyTo:Cn,styleHintName:Dn,setPostMode:jn,toggleVector:Mn,setVector:Nn,cycleEra:Pn,togglePalette:In,setTonemap:e=>{let t=e===`agx`||e===1||e===!0;return Q.uniforms.uTonemap.value=+!!t,typeof window<`u`&&(window.__tonemap=t?`agx`:`aces`),t?`agx`:`aces`},get mode(){return sn},get vector(){return cn},get sceneEra(){return un},renderer:i,drawBuffer:l,scene:m,rig:b,sunRig:S,SIM:256,targets:T,simScene:D,simCamera:O,simMaterial:A,grabRT:j,card:te,backdrop:M,WATER_SIZE:28,water:P,waterMaterial:N,windowGlow:ne,landmarkFactory:ae,city:L,cityLife:oe,waterLife:R,weatherRig:B,clouds:V,inspector:le,world:pt,catalog:ht,editor:gt,pilot:vt,profiler:Jt,governor:en,frameStart:tn,frameEnd:rn,setActive:an,get paused(){return d},get contextLost(){return u},prewarm:on,fitShadowFrustum:yt,SHADOW_DIST:24,sceneDepth:bt,sceneRT:xt,filmicRT:Ct,toonRT:Tt,pixelRT:Et,postScene:Mt,postCamera:Nt,postQuad:Pt,filmicMaterial:Q,pixelMaterial:Vt,pixelkitMaterial:Ht,toonMaterial:Wt,mixMaterial:Gt,PALCACHE:$,ERA_TEX:Ut,runPass:Kt,OVERCAST_GREY:g,FOG_DENSITY:_,FOG_NIGHT_TINT:v,_fogColor:y,resize:qt}}var wi=`lgr_hints_`,Ti=!1;function Ei(){if(Ti||typeof document>`u`)return;Ti=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  @media (prefers-reduced-motion: reduce) {
  ...
  }`,document.head.appendChild(e)}function Di({key:e,title:t=`Tips`,tips:n=[],force:r=!1}={}){let i={key:e,shown:!1,dismissed:!1,seen:!1};if(typeof window<`u`&&(window.__hints=i),typeof document>`u`||!e)return{dismiss(){},el:null};let a=wi+e,o=!1;try{o=localStorage.getItem(a)===`1`}catch{}if(o&&!r)return i.seen=!0,{dismiss(){},el:null};Ei();let s=!!(window.matchMedia&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches),c=document.createElement(`div`);c.className=`lgr-hints`,c.innerHTML=`<div class="lgr-hints-card">
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var Oi=new Set([`w`,`a`,`s`,`d`,`arrowup`,`arrowdown`,`arrowleft`,`arrowright`,`shift`,` `]),ki={walker:{p:.6,hp:26,speed:.85,dmg:9,score:10,size:1,color:`#6f8a45`},runner:{p:.25,hp:12,speed:1.75,dmg:7,score:16,size:.82,color:`#a6d24c`},tank:{p:.15,hp:95,speed:.5,dmg:20,score:34,size:1.5,color:`#39492a`}};function Ai(){let e=Math.random();return e<ki.walker.p?`walker`:e<ki.walker.p+ki.runner.p?`runner`:`tank`}var ji=new I(`#ffffff`),Mi=new I(`#d83a2a`),Ni={food:{name:`Food`,glyph:`🍖`,color:`#c8782e`,consumable:!0},water:{name:`Water`,glyph:`💧`,color:`#3aa6dc`,consumable:!0},bandage:{name:`Bandage`,glyph:`➕`,color:`#e8e2d6`,consumable:!0},scrap:{name:`Scrap`,glyph:`⚙️`,color:`#8a8f96`,consumable:!1},medkit:{name:`Medkit`,glyph:`✚`,color:`#e0524a`,consumable:!0},repairkit:{name:`Repair Kit`,glyph:`🔧`,color:`#caa05a`,consumable:!0}},Pi=[{out:`medkit`,need:{bandage:2}},{out:`repairkit`,need:{scrap:3}}];function Fi({extent:e=8,plinthTop:t=.3}={}){let n=new i;n.visible=!1,n.raycast=()=>{};let r=t+.02,a=Math.max(3,e-.7),s=typeof window<`u`&&window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,l=1.25,u=4.4,f=1.4,m=new i,h=new c(new te(.16,.34,4,10),Z(new C({color:`#3f7fd0`,roughness:.6,flatShading:!0}),{color:`#3f7fd0`}));h.position.y=.33;let _=new c(new ee(.13,12,9),Z(new C({color:`#e9caa1`,roughness:.75,flatShading:!0}),{color:`#e9caa1`}));_.position.y=.66;let v=new c(new U(.1,.1,.16),Z(new C({color:`#ffd54a`,roughness:.5,flatShading:!0}),{color:`#ffd54a`}));v.position.set(0,.38,.18),m.add(h,_,v),m.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!1),e.raycast=()=>{}}),m.scale.setScalar(1.6),m.position.y=r,n.add(m);let y=new c(new ue(.95,16,-.9,1.8),new x({color:`#ffe08a`,transparent:!0,opacity:0,depthWrite:!1,side:2}));y.rotation.x=-Math.PI/2,y.position.y=r+.06,y.raycast=()=>{},n.add(y);let b=new oe().setFromPoints([new H,new H]),S=new g(b,new o({color:`#fff3c0`,transparent:!0,opacity:0,depthWrite:!1}));S.raycast=()=>{},n.add(S);let w={x:0,z:0,vx:0,vz:0,hp:100,stamina:100,hunger:100,thirst:100,facing:0,iframe:0},T=new p(new te(.15,.3,4,8),Z(new C({roughness:.85,flatShading:!0})),48);T.castShadow=!0,T.receiveShadow=!1,T.frustumCulled=!1,T.raycast=()=>{},T.instanceMatrix.setUsage(W),n.add(T);let E=[];for(let e=0;e<48;e++)E.push({x:0,z:0,vx:0,vz:0,alive:!1,in:!1,type:`walker`,hp:1,maxhp:1,speed:1,dmg:0,score:0,size:1,phase:0,flash:0});let D=new I,O=[],k=Z(new C({color:`#7a5a36`,roughness:.9,flatShading:!0}),{color:`#7a5a36`});for(let e=0;e<8;e++){let t=e/8*Math.PI*2,i=new c(new U(2.1,.7,.24),k.clone());i.position.set(Math.cos(t)*u,r+.35,Math.sin(t)*u),i.rotation.y=-t+Math.PI/2,i.castShadow=!0,i.raycast=()=>{},n.add(i),O.push({mesh:i,ang:t,hp:150,alive:!0,baseColor:new I(`#7a5a36`)})}function A(e,t){let n=Math.atan2(t,e);return n<0&&(n+=Math.PI*2),O[Math.round(n/(Math.PI*2/8))%8]}let j=[];for(let e=0;e<14;e++){let e=new c(new U(.26,.26,.26),Z(new C({roughness:.6,flatShading:!0})));e.castShadow=!0,e.visible=!1,e.raycast=()=>{},n.add(e),j.push({mesh:e,x:0,z:0,kind:`food`,active:!1})}let M=new I;function N(){let e=Math.random();return e<.36?`food`:e<.72?`water`:e<.88?`bandage`:`scrap`}function P(e,t,n){let i=j.find(e=>!e.active);i&&(i.x=e,i.z=t,i.kind=n||N(),i.active=!0,i.mesh.position.set(e,r+.18,t),i.mesh.visible=!0,i.mesh.material.color.copy(M.set(Ni[i.kind].color)))}let F=[];function ne(e){let t=F.find(t=>t.id===e);return t?t.n:0}function re(e,t=1){let n=F.find(t=>t.id===e);return n?(n.n+=t,!0):F.length<8?(F.push({id:e,n:t}),!0):!1}function ie(e,t){let n=F.find(t=>t.id===e);return!n||n.n<t?!1:(n.n-=t,n.n<=0&&F.splice(F.indexOf(n),1),!0)}function ae(e){if(ne(e)<=0)return!1;if(e===`food`)w.hunger=Math.min(100,w.hunger+38);else if(e===`water`)w.thirst=Math.min(100,w.thirst+38);else if(e===`bandage`)w.hp=Math.min(100,w.hp+40);else if(e===`medkit`)w.hp=Math.min(100,w.hp+90);else if(e===`repairkit`){let e=null;for(let t of O)(!e||t.hp<e.hp)&&(e=t);e&&(e.hp=150,e.alive=!0)}else return!1;return ie(e,1),Ue(),!0}function L(e){for(let t in e.need)if(ne(t)<e.need[t])return!1;for(let t in e.need)ie(t,e.need[t]);return re(e.out,1),Ue(),!0}let R=!1,se=!1,z=1,B=0,V=0,ce=0,le=`spawning`,de=0,fe=0,pe=0,me=0,he=!1,ge=null;function _e(){for(let e=0;e<48;e++)if(!E[e].alive)return E[e];return null}function ve(e){let t=_e();if(!t)return;let n=ki[Ai()];t.type=Object.keys(ki).find(e=>ki[e]===n)||`walker`;let r=Math.random()*Math.PI*2;t.x=Math.cos(r)*a,t.z=Math.sin(r)*a,t.vx=0,t.vz=0;let i=1+z*.08;t.maxhp=n.hp*i,t.hp=t.maxhp,t.speed=n.speed*(1+.4*e)*(1+z*.015)*(z===1?.85:1),t.dmg=n.dmg,t.score=n.score,t.size=n.size,t.phase=Math.random()*6.28,t.flash=0,t.in=!1,t.alive=!0}function ye(){let e=null,t=1/0;for(let n of E){if(!n.alive)continue;let r=(n.x-w.x)**2+(n.z-w.z)**2;r<t&&(t=r,e=n)}return e}function be(e){e.alive=!1,B++,V+=e.score,Math.random()<.3&&P(e.x,e.z)}function xe(e,t){e.hp-=t,e.flash=.12,e.hp<=0&&be(e)}function Se(){if(se||pe>0)return;pe=.16;let e,t;if(ge)e=ge.x-w.x,t=ge.z-w.z;else{let n=ye();n?(e=n.x-w.x,t=n.z-w.z):(e=Math.sin(w.facing),t=Math.cos(w.facing))}let n=Math.hypot(e,t)||1;e/=n,t/=n,w.facing=Math.atan2(e,t);let i=null,a=1/0;for(let n of E){if(!n.alive)continue;let r=n.x-w.x,o=n.z-w.z,s=r*e+o*t;s<0||s>9||Math.abs(r*t-o*e)<.7*(.4+.6*n.size)&&s<a&&(a=s,i=n)}let o=i?a:9,s=b.attributes.position;s.setXYZ(0,w.x,r+.5,w.z),s.setXYZ(1,w.x+e*o,r+.5,w.z+t*o),s.needsUpdate=!0,S.material.opacity=.95,i&&xe(i,16)}function K(){if(se||me>0)return;me=.42,y.material.opacity=.85;let e=Math.sin(w.facing),t=Math.cos(w.facing);for(let n of E){if(!n.alive)continue;let r=n.x-w.x,i=n.z-w.z,a=Math.hypot(r,i);a>1.05+n.size*.2||(r*e+i*t)/(a||1)>.2&&xe(n,34)}}let q={},Ce={x:0,y:0};function we(e,t){if(!R)return;let n=e.key.toLowerCase();if(t&&n===`i`){e.stopImmediatePropagation(),Ke();return}if(t&&n===`escape`&&Ie){e.stopImmediatePropagation(),Ge();return}if(Oi.has(n)){if(e.stopImmediatePropagation(),n.startsWith(`arrow`)&&e.preventDefault(),n===` `){t&&K();return}q[n]=t}}typeof window<`u`&&(window.addEventListener(`keydown`,e=>we(e,!0)),window.addEventListener(`keyup`,e=>we(e,!1)));let J=null,Te=null,Ee=null,De=null,Oe=null,ke=null,Ae=null,Y=null,je=null,Me=null,X=null,Ne=null,Pe=null,Fe=null,Ie=!1;if(typeof document<`u`){let e=document.createElement(`style`);e.textContent=`
    ...
    `,document.head.appendChild(a),Pe=document.createElement(`button`),Pe.className=`hoard-bagbtn`,Pe.textContent=`🎒`,Pe.title=`Inventory (I)`,document.body.appendChild(Pe),Pe.addEventListener(`click`,()=>Ke()),Fe=document.createElement(`div`),Fe.className=`hoard-bag`,document.body.appendChild(Fe)}let Le=0;function Re(e,t=1.8){je&&(je.textContent=e,je.style.display=`block`),Le=t}let ze=Math.PI/4;function Be(e){ze=e}function Ve(e,t){ge={x:e,z:t}}function He(e){he=e}function Ue(){if(typeof window<`u`&&(window.__hoardBag=Object.fromEntries(F.map(e=>[e.id,e.n]))),!Fe)return;let e=`<div class="panel"><h3>INVENTORY</h3><div class="slots">`;for(let t=0;t<8;t++){let n=F[t];n?e+=`<button class="slot" data-id="${n.id}" title="${Ni[n.id].name}">${Ni[n.id].glyph}<span class="n">${n.n}</span></button>`:e+=`<div class="slot empty"></div>`}e+=`</div><div class="craft">`,Pi.forEach((t,n)=>{let r=Object.keys(t.need).every(e=>ne(e)>=t.need[e]),i=Object.entries(t.need).map(([e,t])=>`${t}${Ni[e].glyph}`).join(`+`);e+=`<button data-rec="${n}" ${r?``:`disabled`}>Craft ${Ni[t.out].name} (${i})</button>`}),e+=`</div><button class="close">CLOSE (I)</button></div>`,Fe.innerHTML=e,Fe.querySelectorAll(`.slot[data-id]`).forEach(e=>e.addEventListener(`click`,()=>{Ni[e.dataset.id].consumable&&ae(e.dataset.id)})),Fe.querySelectorAll(`[data-rec]`).forEach(e=>e.addEventListener(`click`,()=>L(Pi[+e.dataset.rec]))),Fe.querySelector(`.close`).addEventListener(`click`,()=>Ge())}function We(){!R||se||(Ie=!0,Fe&&Fe.classList.add(`open`),Ue())}function Ge(){Ie=!1,Fe&&Fe.classList.remove(`open`)}function Ke(){Ie?Ge():We()}function qe(e){z=e,fe=5+e*2,le=`spawning`}function Je(){w.x=0,w.z=0,w.vx=0,w.vz=0,w.hp=100,w.stamina=100,w.hunger=100,w.thirst=100,w.facing=0,w.iframe=0;for(let e of E)e.alive=!1;B=0,V=0,ce=0,se=!1,he=!1,ge=null;for(let e of O)e.hp=150,e.alive=!0,e.mesh.scale.set(1,1,1);for(let e of j)e.active=!1,e.mesh.visible=!1;F.length=0;let e=[`food`,`water`,`food`,`water`,`bandage`,`scrap`];for(let t=0;t<6;t++){let n=Math.random()*Math.PI*2,r=1.6+Math.random()*(a-2);P(Math.cos(n)*r,Math.sin(n)*r,e[t])}Me&&(Me.style.display=`none`),m.position.set(0,r,0),m.visible=!0,qe(1),Ue()}function Ye(){Je()}function Xe(e){R=e,n.visible=e;let t=e&&s;J&&(J.style.display=t?`block`:`none`),X&&(X.style.display=t?`block`:`none`),Ne&&(Ne.style.display=t?`block`:`none`),Ee&&(Ee.style.display=e?`block`:`none`),je&&!e&&(je.style.display=`none`),Me&&!e&&(Me.style.display=`none`),Pe&&(Pe.style.display=e?`block`:`none`),Ge();for(let e in q)q[e]=!1;Ce.x=Ce.y=0,he=!1,e&&Je()}let Ze=new d;function Qe(e,t,n){if(!R||Ie)return;let i=n?n.windowGlow:0;if(pe=Math.max(0,pe-e),me=Math.max(0,me-e),S.material.opacity=Math.max(0,S.material.opacity-e*8),y.material.opacity=Math.max(0,y.material.opacity-e*6),!se){ce+=e,w.iframe=Math.max(0,w.iframe-e);let n=(q.d||q.arrowright?1:0)-(q.a||q.arrowleft?1:0)+Ce.x,i=(q.w||q.arrowup?1:0)-(q.s||q.arrowdown?1:0)+Ce.y,o=Math.hypot(n,i);o>1&&(n/=o,i/=o);let s=o>.05,c=(q.shift||Ce.y>.95)&&w.stamina>2&&s,l=Math.cos(ze),d=Math.sin(ze),p=l*n+-d*i,h=-d*n+-l*i,g=c?5.2:3,_=1-Math.exp(-14*e);w.vx+=(p*g-w.vx)*_,w.vz+=(h*g-w.vz)*_,w.x+=w.vx*e,w.z+=w.vz*e;let v=Math.hypot(w.x,w.z);v>a&&(w.x*=a/v,w.z*=a/v,w.vx=0,w.vz=0),s&&(w.facing=Math.atan2(p,h)),w.stamina=G.clamp(w.stamina+(c?-34:22)*e,0,100),w.hunger=Math.max(0,w.hunger-.9*e),w.thirst=Math.max(0,w.thirst-1.15*e),w.hunger<=0||w.thirst<=0?w.hp=Math.max(0,w.hp-3.5*e):w.hunger>55&&w.thirst>55&&w.hp<100&&(w.hp=Math.min(100,w.hp+2*e));for(let e of j)e.active&&(e.x-w.x)**2+(e.z-w.z)**2<.3&&re(e.kind)&&(e.active=!1,e.mesh.visible=!1,Ue());for(let t of O){if(t.hp>=150)continue;let n=Math.cos(t.ang)*u,r=Math.sin(t.ang)*u;(n-w.x)**2+(r-w.z)**2<f*f&&(t.hp=Math.min(150,t.hp+30*e),t.hp>0&&(t.alive=!0))}w.hp<=0&&$e(),m.position.set(w.x,r,w.z),m.rotation.y=w.facing,m.visible=!(w.iframe>0&&Math.floor(t*20)%2==0),he&&Se(),y.position.set(w.x,r+.06,w.z),y.rotation.z=-w.facing}let o=0;se||le===`spawning`&&(fe>0&&Math.random()<e*(z===1?3.5:6)&&(ve(i),fe--),fe<=0&&(le=`fighting`));let s=0,c=1/0;for(let n=0;n<48;n++){let i=E[n];if(!i.alive){Ze.position.set(0,-60,0),Ze.scale.setScalar(0),Ze.updateMatrix(),T.setMatrixAt(n,Ze.matrix);continue}o++;let a=w.x-i.x,d=w.z-i.z,f=Math.hypot(a,d)||1;if(f<c&&(c=f),!se){let t=a/f*i.speed,n=d/f*i.speed,r=1-Math.exp(-6*e);if(i.vx+=(t-i.vx)*r,i.vz+=(n-i.vz)*r,f>.52){let t=i.x+i.vx*e,n=i.z+i.vz*e,r=Math.hypot(i.x,i.z),a=Math.hypot(t,n);if(!i.in&&r>=u&&a<4.9){let r=A(t,n);if(r.alive){let i=Math.atan2(n,t),a=4.9;t=Math.cos(i)*a,n=Math.sin(i)*a,r.hp-=15*e,r.hp<=0&&(r.hp=0,r.alive=!1)}}a<u-.1&&(i.in=!0),i.x=t,i.z=n}else w.iframe<=0&&(s=Math.max(s,i.dmg))}i.flash=Math.max(0,i.flash-e);let p=Math.sin(t*6+i.phase)*.04;Ze.position.set(i.x,r+.3*i.size*l+p,i.z),Ze.rotation.set(0,Math.atan2(i.vx,i.vz),Math.sin(t*3+i.phase)*.12),Ze.scale.setScalar(i.size*l),Ze.updateMatrix(),T.setMatrixAt(n,Ze.matrix),D.set(ki[i.type].color),i.flash>0?D.lerp(ji,.7):D.lerp(Mi,.35*(1-i.hp/i.maxhp)),T.setColorAt(n,D)}T.instanceMatrix.needsUpdate=!0,T.instanceColor&&(T.instanceColor.needsUpdate=!0);let d=0;for(let e of O){e.alive&&d++;let t=Math.max(0,e.hp/150);e.mesh.scale.y=e.alive?Math.max(.18,t):.12,e.mesh.position.y=r+.35*e.mesh.scale.y,e.mesh.material.color.copy(e.baseColor).lerp(Mi,(1-t)*.55)}!se&&s>0&&(w.hp=Math.max(0,w.hp-s*(z===1?.5:1)),w.iframe=.6,w.hp<=0&&$e()),!se&&le===`fighting`&&o===0&&fe<=0&&(le=`complete`,de=2.2,Re(`WAVE ${z} CLEAR`,2)),!se&&le===`complete`&&(de-=e,de<=0&&(qe(z+1),Re(`WAVE ${z}`,1.4))),Le>0&&(Le-=e,Le<=0&&je&&(je.style.display=`none`)),De&&(De.style.width=`${w.hp}%`),Oe&&(Oe.style.width=`${w.stamina}%`),ke&&(ke.style.width=`${w.hunger}%`),Ae&&(Ae.style.width=`${w.thirst}%`),Y&&(Y.textContent=`WAVE ${z}   KILLS ${B}   SCORE ${V}`),typeof window<`u`&&(window.__hoard={active:R,dead:se,paused:Ie,hp:Math.round(w.hp),stamina:Math.round(w.stamina),hunger:Math.round(w.hunger),thirst:Math.round(w.thirst),zombies:o,barriers:d,pickups:j.filter(e=>e.active).length,inv:Object.fromEntries(F.map(e=>[e.id,e.n])),wave:z,kills:B,score:V,weapon:`gun`,znear:+c.toFixed(2),px:+w.x.toFixed(2),pz:+w.z.toFixed(2)})}function $e(){se=!0,he=!1,Me&&(Me.querySelector(`.ds`).innerHTML=`Wave reached: ${z}<br>Kills: ${B}<br>Score: ${V}<br>Survived: ${ce.toFixed(0)}s`,Me.style.display=`flex`)}return{group:n,update:Qe,setActive:Xe,setAzimuth:Be,setAim:Ve,setFiring:He,melee:K,reset:Je,restart:Ye,openBag:We,closeBag:Ge,toggleBag:Ke,addItem:re,get player(){return w},get dead(){return se},get active(){return R},get paused(){return Ie},get inv(){return F.map(e=>({...e}))},get nearestPickup(){let e=null,t=1e9;for(let n of j){if(!n.active)continue;let r=(n.x-w.x)**2+(n.z-w.z)**2;r<t&&(t=r,e=n)}return e?{x:e.x,z:e.z}:null},setTarget(){}}}var{Timer:Ii}=O,Li=new URLSearchParams(window.location.search),Ri=Li.get(`demo`)===`1`||Li.has(`capture`);window.__demo=Ri;var zi=(Li.get(`city`)?Number(Li.get(`city`)):0)||Math.random()*1e9|0,Bi=0,Vi=Ci({demo:Ri,citySeed:zi,profileIndex:Bi}),{renderer:Hi,scene:Ui,rig:Wi,sunRig:Gi,city:Ki,landmarkFactory:qi}=Vi,Ji=Fi({extent:Ki.extent,plinthTop:.3});Ui.add(Ji.group),window.__hoardApi=Ji;var Yi=!0;window.__shadows=Yi,window.__scene=`hoard`;var Xi=new H,Zi=new Set,Qi=6.5;function $i(e){Ki.group.traverse(t=>{!t.isMesh||t.userData.ground||!t.visible||(t.getWorldPosition(Xi),Math.hypot(Xi.x,Xi.z)<e&&(t.visible=!1,Zi.add(t)))})}function ea(){for(let e of Zi)e.visible=!0;Zi.clear()}var ta=new V,na=new H,ra=new H,ia=new Set;function aa(){for(let e of ia)e.material&&(e.material.opacity=1,e.material.transparent=!!e.userData._wasT,e.material.depthWrite=e.userData._wasDW!==!1);ia.clear()}function oa(e){aa();let t=Wi.camera;for(let[n,r]of[[0,0],[.7,.4],[-.7,.4]]){ra.set(e.x+n,.6,e.z+r),na.subVectors(ra,t.position);let i=na.length();ta.set(t.position,na.normalize()),ta.far=i-.4;for(let e of ta.intersectObject(Ki.group,!0)){let t=e.object;!t.material||t.userData.ground||ia.has(t)||(t.userData._wasT=t.material.transparent,t.userData._wasDW=t.material.depthWrite,t.material.transparent=!0,t.material.opacity=.16,t.material.depthWrite=!1,ia.add(t))}}}function sa(){Ji.setActive(!0),$i(Qi),Wi.setMode(J.DIMETRIC),Wi.setZoom(2.8,!0),Wi.setTarget(Ji.player.x,.6,Ji.player.z,!0)}var ca=new V,la=new F,ua=new w(new H(0,1,0),-.32),da=new H,fa=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,pa=!1,ma=0,ha=0,ga=.005,_a=(e,t)=>{la.x=e/window.innerWidth*2-1,la.y=-(t/window.innerHeight)*2+1};Hi.domElement.addEventListener(`contextmenu`,e=>e.preventDefault()),Hi.domElement.addEventListener(`mousedown`,e=>{e.button===0&&(_a(e.clientX,e.clientY),Ji.setFiring(!0)),e.button===2&&(pa=!0,ma=e.clientX,ha=e.clientY)}),window.addEventListener(`mousemove`,e=>{_a(e.clientX,e.clientY),pa&&(Wi.orbit(-(e.clientX-ma)*ga,-(e.clientY-ha)*ga),ma=e.clientX,ha=e.clientY)}),window.addEventListener(`mouseup`,()=>{Ji.setFiring(!1),pa=!1}),Hi.domElement.addEventListener(`wheel`,e=>{e.preventDefault(),Wi.zoomBy(Math.exp(e.deltaY*.0015))},{passive:!1}),window.addEventListener(`keydown`,e=>{(e.key===`h`||e.key===`H`)&&(Yi=!Yi,window.__shadows=Yi)}),qi.whenReady.then(()=>{Ki.generate(zi,Bi),Vi.fitShadowFrustum(),ea(),$i(Qi),window.__cityReady=!0});var va=new Ii;va.connect(document);function ya(){va.update();let e=Math.min(va.getDelta(),.1);Ji.setAzimuth(Wi.azimuth),fa||(ca.setFromCamera(la,Wi.camera),ca.ray.intersectPlane(ua,da)&&Ji.setAim(da.x,da.z)),Ji.update(e,va.getElapsed(),Gi),Wi.setTarget(Ji.player.x,.6,Ji.player.z),Wi.update(e),oa(Ji.player),Vi.updateWorld(e,va.getElapsed(),{shadowsOn:Yi,seasonTarget:0});let t=Vi.decideStyle();Vi.renderCityPipeline(t,null),requestAnimationFrame(ya)}sa(),ya(),Di({key:`hoard`,title:`The Hoard`,tips:[`Move: WASD / arrows · on touch: the left thumb-stick`,`Aim: mouse / drag · Fire: hold click / the FIRE button · Melee: the MELEE button`,`Survive the waves · B: bag & crafting · Esc: exit`]}),window.addEventListener(`resize`,()=>{Vi.resize()});