...
}`,jn={realistic:0,charm:0,pixel:2,vector:1},Mn={realistic:1,charm:1,pixel:1.9,vector:1.2};function Nn({seed:e=1517,count:t=340,spreadX:n=21,yLo:i=3,yHi:s=18,zBase:c=7.2}={}){let l=new a;l.raycast=()=>{};let u=Qe(e>>>0),d=new Float32Array(t*3),f=new Float32Array(t),p=new Float32Array(t),m=new Float32Array(t),h=[];for(let e=0;e<t;e++){let t=(u()*2-1)*n,r=i+u()*(s-i),a=-c-u()*.7;d[e*3]=t,d[e*3+1]=r,d[e*3+2]=a;let o=.35+u()*.65;p[e]=o,f[e]=1.6+u()*2.8+(o>.85?2.2:0),m[e]=u()*Math.PI*2,o>.82&&h.push([t,r,a])}let _=new ae;_.setAttribute(`position`,new A(d,3)),_.setAttribute(`aSize`,new A(f,1)),_.setAttribute(`aBright`,new A(p,1)),_.setAttribute(`aPhase`,new A(m,1));let v=new I({vertexShader:kn,fragmentShader:An,uniforms:{uTime:{value:0},uTwinkle:{value:1},uSizeScale:{value:1},uColor:{value:new F(`#eaf0ff`)},uNight:{value:0},uMode:{value:0}},transparent:!0,depthWrite:!1,blending:2,fog:!1,toneMapped:!1}),y=new E(_,v);y.raycast=()=>{},y.frustumCulled=!1,l.add(y);let b=[];if(h.length>6)for(let e=0;e<3;e++){let e=Math.floor(u()*h.length);for(let t=0;t<3;t++){let t=h[e],n=h[(e+1+Math.floor(u()*2))%h.length];b.push(t[0],t[1],t[2],n[0],n[1],n[2]),e=(e+1)%h.length}}let x=[[[0,2],[0,0]],[[0,0],[.7,0]],[[2.1,2],[1.4,2]],[[1.4,2],[1.4,0]],[[1.4,0],[2.1,0]],[[2.1,0],[2.1,1]],[[2.1,1],[1.7,1]],[[2.8,0],[2.8,2]],[[2.8,2],[3.5,2]],[[3.5,2],[3.5,1]],[[3.5,1],[2.8,1]],[[2.8,1],[3.6,0]]],S=-c-.4,C=.62;for(let[[e,t],[n,r]]of x)b.push(-3+e*C,12+t*C,S,-3+n*C,12+r*C,S);let w=new ae;w.setAttribute(`position`,new r(b,3));let T=new o(w,new g({color:`#9fb6e8`,transparent:!0,opacity:0,depthWrite:!1,fog:!1,toneMapped:!1}));T.raycast=()=>{},T.frustumCulled=!1,l.add(T);let D=new pe(new j({map:Pn(),transparent:!0,opacity:0,depthWrite:!1,blending:2,fog:!1,toneMapped:!1}));D.raycast=()=>{},D.scale.set(n*2.4,n*.95,1),D.position.set(2,12,-c-.7),D.material.rotation=-.5,D.renderOrder=-3,l.add(D);let O=-1;function ee(e,t=`realistic`,n=0,r=!1){v.uniforms.uTime.value=n,v.uniforms.uTwinkle.value=+!r,v.uniforms.uNight.value=e;let i=jn[t]??0;i!==O&&(v.uniforms.uMode.value=i,O=i),v.uniforms.uSizeScale.value=Mn[t]??1,T.material.opacity=e*.5,D.material.opacity=e*.32,l.visible=e>.001}return{group:l,update:ee}}function Pn(){let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(256/2,256/2,0,256/2,256/2,256/2);n.addColorStop(0,`rgba(150,170,230,0.5)`),n.addColorStop(.4,`rgba(120,130,200,0.22)`),n.addColorStop(1,`rgba(90,100,160,0)`),t.fillStyle=n,t.fillRect(0,0,256,256);let r=Qe(20145);for(let e=0;e<7;e++){let e=40+r()*176,n=70+r()*116,i=14+r()*30,a=t.createRadialGradient(e,n,0,e,n,i);a.addColorStop(0,`rgba(200,210,255,0.18)`),a.addColorStop(1,`rgba(200,210,255,0)`),t.fillStyle=a,t.beginPath(),t.arc(e,n,i,0,Math.PI*2),t.fill()}let i=new ge(e);return i.colorSpace=V,i}var Fn=Math.PI*2;function In(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=n.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return r.addColorStop(0,`#ffffff`),r.addColorStop(.34,`#fffaf0`),r.addColorStop(.66,e),r.addColorStop(.86,e),r.addColorStop(1,`rgba(255,255,255,0)`),n.fillStyle=r,n.beginPath(),n.arc(128/2,128/2,128/2,0,Fn),n.fill(),Un(t,!0)}function Ln(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);n.addColorStop(0,`#ffffff`),n.addColorStop(.4,`#eef3ff`),n.addColorStop(.82,`#c4cee6`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,Fn),t.fill(),t.globalAlpha=.14,t.fillStyle=`#8b97b4`;for(let[e,n,r]of[[54,50,9],[78,66,7],[60,82,5]])t.beginPath(),t.arc(e,n,r,0,Fn),t.fill();return Un(e,!0)}function Rn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`);t.translate(128/2,128/2),t.fillStyle=`rgba(255,210,120,0.9)`;for(let e=0;e<12;e++)t.rotate(Fn/12),t.beginPath(),t.moveTo(0,-28),t.lineTo(7,-54),t.lineTo(-7,-54),t.closePath(),t.fill();let n=t.createRadialGradient(0,0,0,0,0,32);return n.addColorStop(0,`#ffffff`),n.addColorStop(.4,`#fff1c8`),n.addColorStop(.8,`#ffb24a`),n.addColorStop(1,`#ff8a2a`),t.fillStyle=n,t.beginPath(),t.arc(0,0,32,0,Fn),t.fill(),Un(e,!0)}function zn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,46);n.addColorStop(0,`#ffffff`),n.addColorStop(.5,`#e6ecfb`),n.addColorStop(1,`#c2cce4`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,46,0,Fn),t.fill(),t.fillStyle=`#aab6d2`;for(let[e,n,r]of[[52,48,11],[80,62,8],[58,82,7],[40,66,5]])t.beginPath(),t.arc(e,n,r,0,Fn),t.fill();return Un(e,!0)}function Bn(e,t,n){let r=document.createElement(`canvas`);r.width=r.height=144;let i=r.getContext(`2d`),a=17/2,o=18/2-.5;for(let r=0;r<18;r++)for(let s=0;s<18;s++){let c=Math.hypot(s-a,r-a);c>o||(i.fillStyle=c<o*.45?e:c<o*.78?t:n,i.fillRect(Math.round(s*8),Math.round(r*8),8,8))}return Un(r,!1)}function Vn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(255,255,255,0.9)`),n.addColorStop(.38,`rgba(255,255,255,0.3)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,Fn),t.fill(),Un(e,!0)}function Hn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2),r=`20,30,48`;return n.addColorStop(0,`rgba(${r},0)`),n.addColorStop(.42,`rgba(${r},0)`),n.addColorStop(.6,`rgba(${r},0.6)`),n.addColorStop(1,`rgba(${r},0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,Fn),t.fill(),Un(e,!0)}function Un(e,t){let n=new ge(e);return n.colorSpace=V,t||(n.magFilter=C,n.minFilter=C),n}var Wn=(e,t,n)=>{let r=Math.max(0,Math.min(1,(e-t)/(n-t)));return r*r*(3-2*r)};function Gn({skyW:e=15,skyY0:t=3.4,skyH:n=3.8,z:r=-7.8,biasX:i=4.5,sunSize:o=4.6,moonSize:s=4}={}){let c=new a;c.raycast=()=>{};let l=(e,t)=>{let n=new pe(new j({map:e,transparent:!0,depthWrite:!1,fog:!1,toneMapped:!1,...t?{blending:2}:{}}));return n.raycast=()=>{},n},u={realistic:In(`#ffcf8a`),charm:Rn(),pixel:Bn(`#fff6e0`,`#ffc24a`,`#ff8a2a`)},d={realistic:Ln(),charm:zn(),pixel:Bn(`#ffffff`,`#cdd6ee`,`#9aa6c6`)},f=Vn(),p=l(Hn(),!1),m=l(f,!0),h=l(u.realistic),g=l(f,!0),_=l(d.realistic);p.renderOrder=-2,m.renderOrder=-1,c.add(p,m,h,g,_);let v=Nn({});v.group.renderOrder=-4,c.add(v.group);let y=typeof window<`u`&&window.matchMedia?window.matchMedia(`(prefers-reduced-motion: reduce)`):null,b={realistic:{sunGlow:3,sunGlowOp:.7,moonGlow:2.6,moonGlowOp:.5,sizeMul:1,sunHaloOp:.85},charm:{sunGlow:2.2,sunGlowOp:.55,moonGlow:2.1,moonGlowOp:.42,sizeMul:1.08,sunHaloOp:.7},pixel:{sunGlow:1.7,sunGlowOp:.4,moonGlow:1.7,moonGlowOp:.32,sizeMul:1,sunHaloOp:.6}},x=`realistic`;function S(e){e===x||!b[e]||(x=e,h.material.map=u[e],h.material.needsUpdate=!0,_.material.map=d[e],_.material.needsUpdate=!0)}new F;let C=new F(`#fff3df`),w=new F(`#ffb060`),T=new F(`#ff6a2a`),E=new F(`#eef2ff`),D=new F(`#9fbcff`);function O(a,c,l,u,d=`realistic`){S(d);let f=b[x],O=l.sunArc,ee=u?Math.min(1,(u.cloud||0)*.85+(u.fog||0)*.7):0,k=O.y,A=Wn(k,-.04,.1)*(1-.7*ee),j=1-Wn(Math.abs(k),.02,.5);h.position.set(O.x*e+i,t+O.y*n,r),m.position.copy(h.position);let M=o*f.sizeMul*(1+.55*j);h.scale.setScalar(M),m.scale.setScalar(M*f.sunGlow),h.material.color.copy(C),m.material.color.copy(w).lerp(T,j),h.material.opacity=A,m.material.opacity=A*f.sunGlowOp*(.7+.5*j),p.position.copy(h.position),p.scale.setScalar(M*1.7),p.material.opacity=A*(1-j)*f.sunHaloOp;let N=Wn(-O.y,-.04,.1)*(1-.65*ee);_.position.set(-O.x*e+i,t+-O.y*n,r),g.position.copy(_.position);let te=s*f.sizeMul;_.scale.setScalar(te),g.scale.setScalar(te*f.moonGlow),_.material.color.copy(E),g.material.color.copy(D),_.material.opacity=N,g.material.opacity=N*f.moonGlowOp;let ne=Wn(-O.y,-.05,.18)*(1-.85*ee);v.update(ne,d,c,!!(y&&y.matches))}return{group:c,update:O}}var Kn=`varying vec2 vUv;
...
}`,Qn=`const float CA_STRENGTH   = 0.0030;  
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,ar={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},or=[`gb`,`8-bit`,`16-bit`,`modern`];function sr(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new F(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new _e(n,t,1,te,ve);return r.minFilter=C,r.magFilter=C,r.needsUpdate=!0,r}var cr=220,lr={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},ur={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function dr({demo:e=!1,citySeed:t=0,profileIndex:n=0}={}){let r=new ie({antialias:!0,preserveDrawingBuffer:!0});r.shadowMap.enabled=!0,r.shadowMap.type=1,r.shadowMap.autoUpdate=!1,r.shadowMap.needsUpdate=!0;let a=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);r.setPixelRatio(Math.min(window.devicePixelRatio,a?1.5:2)),r.setSize(window.innerWidth,window.innerHeight),r.setClearColor(920327,1),document.body.appendChild(r.domElement);let o=r.getDrawingBufferSize(new U),s=new fe;s.fog=new b(10465470,0);let u=new F(`#aeb6c0`),f=.062,p=new F(`#74508f`),m=new F,h=Ie({aspect:window.innerWidth/window.innerHeight}),g=mt({t:.5}),_={type:i,format:te,minFilter:C,magFilter:C,wrapS:oe,wrapT:oe,depthBuffer:!1,stencilBuffer:!1},y=[new P(256,256,_),new P(256,256,_),new P(256,256,_)];for(let e of y)r.setRenderTarget(e),r.clear();r.setRenderTarget(null);let T=new fe,E=new d(-1,1,1,-1,0,1),D=new I({vertexShader:Jn,fragmentShader:Yn,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new U(1/256,1/256)},uMouse:{value:new U(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new N)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new N)}}});T.add(new S(new w(2,2),D));let O=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!0,stencilBuffer:!1});function ee(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new ge(t);return r.colorSpace=V,r}let k=new S(new w(28,28),new c({map:ee(e)}));k.rotation.x=-Math.PI/2,k.position.y=-.35,s.add(k);let A=new S(new w(40,24),new I({depthWrite:!1,vertexShader:Kn,fragmentShader:qn,uniforms:{uTime:{value:0},uInk:{value:g.horizon},uGold:{value:g.sky},uFogColor:{value:m},uFogAmt:{value:0},uFogCharm:Ue}}));A.position.set(0,3,-8),s.add(A);let j=new I({vertexShader:Xn,fragmentShader:Zn,uniforms:{uHeight:{value:null},uScene:{value:O.texture},uTexel:{value:new U(1/256,1/256)},uResolution:{value:new U(o.x,o.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new xe},uLightDir:{value:g.sunDir},uInk:{value:new F(`#2A2218`)},uGold:{value:new F(`#B89968`)},uVector:Le,uVecWater:{value:new F(`#1fb8d8`)},uVecTint:{value:Re}}}),M=new S(new w(28,28,255,255),j);M.rotation.x=-Math.PI/2,M.updateMatrixWorld(!0),j.uniforms.uNormalMatrix.value.getNormalMatrix(M.matrixWorld),s.add(M);let ne={value:0},re=Ht({windowGlow:ne}),L=lt({seed:t,profileIndex:n,landmarkFactory:re,windowGlow:ne});s.add(L.group);let R=yt({plinthTop:.3,extent:L.extent,profile:L.state.profile});s.add(R.group);let ae=At({extent:L.extent,waterSize:28,plinthTop:.3});s.add(ae.group),D.uniforms.uWakeDrops.value=ae.wakeDrops;let z=Wt({extent:L.extent});s.add(z.group),D.uniforms.uRainDrops.value=z.rainDrops;let B=Kt({extent:L.extent});s.add(B.group);let se=Yt({rig:h,getCamera:()=>h.camera,sources:[R,ae,B]}),ce=Gn();s.add(ce.group);let le=On({scale:90});s.add(le.mesh),s.environmentIntensity=.32;let ue=!1;function de(e){let t=e&&g.sunArc.y>-.04;t!==ue&&(ue=t,le.mesh.visible=t,A.visible=!t)}let H=null,pe=-1;function me(){let e=Math.floor(g.t%1*4)%4;return(e!==pe||!H)&&(pe=e,H=le.buildEnv(r)),H}let he=null,_e=null,ve=null,ye=null,Se=!1,Ce=1234,we=`valley`,Te=tn.map(e=>e.key),W=new x({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Ee=()=>[L.group,R.group,ae.group],De=()=>[he,_e,ve].filter(Boolean);function G(){for(let e of De())s.remove(e),e.userData.dispose?.();let e=sn({seed:Ce,size:160,preset:we});ye=e,he=mn(e,{worldSize:26,baseY:0,chunks:6}),_e=wn({terrain:e,seed:Ce,worldSize:26,baseY:0,biomeKeys:Te}),ve=Dn(e,{worldSize:26,baseY:0,maxLakes:3,material:W});for(let e of De())e.visible=Se,s.add(e);typeof window<`u`&&(window.__world={seed:Ce,preset:we,active:Se,chunks:he.children.length,scatter:_e.userData.counts,lakes:ve.userData.count})}let Oe=e=>{for(let t of De())t.visible=e},ke=null,Ae=new Set;function je(){!ye||!ve||(s.remove(ve),ve.userData.dispose?.(),ve=Dn(ye,{worldSize:26,baseY:0,maxLakes:3,material:W}),ve.visible=Se,s.add(ve),window.__world&&(window.__world.lakes=ve.userData.count))}function Me(e,t,n=1,r=2.2,i=.05){if(!ye||!he)return;let a=ye.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=ye.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Ae.clear();for(let e of he.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Ae.add(e)}hn(he,ye,Ae),ke&&clearTimeout(ke),ke=setTimeout(je,140)}let Ne={enter(){he||G(),Se=!0,Oe(!0);for(let e of Ee())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){Se=!1,Oe(!1);for(let e of Ee())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return Ce=Math.random()*1e9|0,G(),Ne.enter(),Ce},setPreset(e){return on.includes(e)&&(we=e,G(),Ne.enter()),we},sculpt:Me,repoolWater:je,get terrainGroup(){return he},get active(){return Se},get seed(){return Ce},get preset(){return we},get presets(){return on}};L.group.remove(L.key),s.add(L.key),L.key.castShadow=!0,L.key.shadow.mapSize.set(2048,2048),L.key.shadow.bias=-18e-5,L.key.shadow.normalBias=.028,s.add(L.key.target);function Pe(){let e=L.key.shadow.camera,t=L.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),r.shadowMap.needsUpdate=!0}Pe();let Fe=new be(o.x,o.y),Ge=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!0,stencilBuffer:!1,depthTexture:Fe}),Ke=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),qe=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),Je=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),Ye=Math.max(1,Math.floor(o.x/2)),Xe=Math.max(1,Math.floor(o.y/2)),Ze=new P(Ye,Xe,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),K=new P(Ye,Xe,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),Qe=new fe,$e=new d(-1,1,1,-1,0,1),et=new S(new w(2,2));Qe.add(et);let q=new I({vertexShader:Jn,fragmentShader:Qn,uniforms:{uScene:{value:Ge.texture},uTime:{value:0},uResolution:{value:new U(o.x,o.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:Ze.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:g.grade.tint},uGradeLift:{value:g.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1}}}),J=new I({vertexShader:Jn,fragmentShader:nr,uniforms:{uScene:{value:Ge.texture},uThreshold:{value:.78}}}),tt=new I({vertexShader:Jn,fragmentShader:rr,uniforms:{uScene:{value:Ze.texture},uDir:{value:new U}}});function nt(e){J.uniforms.uScene.value=e.texture,X(J,Ze),tt.uniforms.uScene.value=Ze.texture,tt.uniforms.uDir.value.set(1.6/Ye,0),X(tt,K),tt.uniforms.uScene.value=K.texture,tt.uniforms.uDir.value.set(0,1.6/Xe),X(tt,Ze),q.uniforms.uBloom.value=Ze.texture;let t=1-v.clamp(g.sunArc.y*2.2,0,1);q.uniforms.uBloomStrength.value=.85*(.32+.95*t)}let rt=e=>{let t=e.map(e=>new F(e));for(;t.length<8;)t.push(new F(0,0,0));return t},it=[`night`,`dawn`,`noon`,`dusk`],at={inkgold:it.map(e=>rt(lr[e])),terminal:it.map(e=>rt(ur[e]))},Y=new I({vertexShader:Jn,fragmentShader:$n,uniforms:{uScene:{value:Ke.texture},uResolution:{value:new U(o.x,o.y)},uPixelSize:{value:cr},uPalette:{value:at.inkgold[2]},uPaletteB:{value:at.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),ot=new I({vertexShader:Jn,fragmentShader:ir,uniforms:{uScene:{value:Ke.texture},uResolution:{value:new U(o.x,o.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:sr(ar[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),st={};for(let e of or)st[e]=ar[e].palette?sr(ar[e].palette):null;let ct=new I({vertexShader:Jn,fragmentShader:er,uniforms:{uScene:{value:Ke.texture},uDepth:{value:Fe},uResolution:{value:new U(o.x,o.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:g.toonFloor},uOutline:{value:g.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),ut=new I({vertexShader:Jn,fragmentShader:tr,uniforms:{uToon:{value:qe.texture},uPixel:{value:Je.texture},uBlend:{value:0}}});function X(e,t){et.material=e,r.setRenderTarget(t),r.render(Qe,$e)}function dt(){h.setViewport(window.innerWidth,window.innerHeight),r.setSize(window.innerWidth,window.innerHeight);let e=r.getDrawingBufferSize(new U);return O.setSize(e.x,e.y),Ge.setSize(e.x,e.y),Ke.setSize(e.x,e.y),qe.setSize(e.x,e.y),Je.setSize(e.x,e.y),Ye=Math.max(1,e.x>>1),Xe=Math.max(1,e.y>>1),Ze.setSize(Ye,Xe),K.setSize(Ye,Xe),j.uniforms.uResolution.value.set(e.x,e.y),q.uniforms.uResolution.value.set(e.x,e.y),Y.uniforms.uResolution.value.set(e.x,e.y),ot.uniforms.uResolution.value.set(e.x,e.y),ct.uniforms.uResolution.value.set(e.x,e.y),e}let Z=3,Q=!1,ft=!1,pt=`native`,ht=.3,gt=.46,_t=[`native`,...or],vt={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=Z,window.__vector=Q,window.__era=pt);let bt=0,xt=performance.now(),St=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=St),St&&(r.info.autoReset=!1);let Ct=null;typeof window<`u`&&(window.__loaded=!1);let wt=0,Tt=new N(1,1,1),Et=!1;function Dt(e){let t=ft?at.terminal:at.inkgold,n=e%1*4,r=Math.floor(n)%4;Y.uniforms.uPalette.value=t[r],Y.uniforms.uPaletteB.value=t[(r+1)%4],Y.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Ot(e){let t=ar[e];t&&(ot.uniforms.uGridWidth.value=t.gridWidth,ot.uniforms.uDither.value=t.dither,ot.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(ot.uniforms.uPalette.value=st[e],ot.uniforms.uPaletteSize.value=t.palette.length))}function kt(){pt!==`native`&&Ot(pt)}let jt=()=>pt===`native`?Y:ot;function Mt(e,t){de(!0),s.environment=me(),M.visible=!1,r.setRenderTarget(O),r.render(s,e),M.visible=!0,r.setRenderTarget(Ge),r.render(s,e),nt(Ge),q.uniforms.uAces.value=1,q.uniforms.uGrade.value=1,q.uniforms.uGrain.value=0,q.uniforms.uChroma.value=0,X(q,t)}function Nt(e,t){let n=!Q&&(Z===1||Z===2);if(de(n),s.environment=n?me():null,q.uniforms.uBloomStrength.value=0,M.visible=!1,r.setRenderTarget(O),r.render(s,h.camera),M.visible=!0,Z===1&&!n)r.setRenderTarget(t),r.render(s,h.camera);else if(Z===1)r.setRenderTarget(Ge),r.render(s,h.camera),nt(Ge),q.uniforms.uAces.value=1,q.uniforms.uGrade.value=1,q.uniforms.uGrain.value=0,q.uniforms.uChroma.value=0,X(q,t);else if(r.setRenderTarget(Ge),r.render(s,h.camera),Z===2)n&&nt(Ge),q.uniforms.uAces.value=+!!n,q.uniforms.uGrade.value=+!!n,q.uniforms.uGrain.value=1,q.uniforms.uChroma.value=1,X(q,t);else{q.uniforms.uAces.value=0,q.uniforms.uGrade.value=0,q.uniforms.uGrain.value=0,q.uniforms.uChroma.value=0,X(q,Ke);let n=h.camera;ct.uniforms.uNear.value=n.near,ct.uniforms.uFar.value=n.far,ct.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Ot(e.era),ot):jt();e.kind===`pixel`?(X(r,t),window.__style=`pixel`):e.kind===`toon`?(X(ct,t),window.__style=`toon`):(X(ct,qe),X(r,Je),ut.uniforms.uBlend.value=e.blend,X(ut,t),window.__style=`blend`)}}function $(){let e=Pt(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return j.uniforms.uChromaScale.value=v.lerp(1,.5,t),e}function Pt(){if(Z===1||Z===2)return{kind:`none`};if(Z===7)return{kind:`pixel`};if(Z===8)return{kind:`toon`};let e=h.styleT;return window.__styleT=e,e<=ht?{kind:`toon`}:e>=gt?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:v.smoothstep(e,ht,gt),era:`16-bit`}}function Ft(e){return Z===1||Z===2?``:Q&&Z!==7&&Z!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?vt[e.era||pt]||`Pixel`:e.kind===`blend`?`Toon → `+(vt[e.era]||`Pixel`):``}function It(e,t,{shadowsOn:n=!0,seasonTarget:i=0}={}){if(St){let e=r.info;Ct={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}A.material.uniforms.uTime.value=t,q.uniforms.uTime.value=t,g.update(e),L.key.position.copy(g.sunDir).multiplyScalar(24),L.key.color.copy(g.sunColor),L.key.intensity=g.sunIntensity,L.fill.color.copy(g.hemiSky),L.fill.groundColor.copy(g.hemiGround),ne.value=g.windowGlow,le.setSun(g.sunArc),le.setParams(g.skyParams),q.uniforms.uGradeSat.value=g.grade.sat,q.uniforms.uGradeContrast.value=g.grade.contrast,s.environmentIntensity=.34*(1-.6*v.clamp(g.sunArc.y*1.5,0,1));let a=z.overcast;L.key.intensity*=1-.5*a,L.key.color.lerp(u,.45*a),L.fill.intensity=1+.7*a;let o=v.smoothstep(g.sunDir.y,.06,.34),c=v.lerp(.28,1,1-g.windowGlow),l=n?o*c:0;L.key.shadow.intensity=.72*l,ze.value=.52*l,(n&&!Et||Tt.distanceToSquared(g.sunDir)>2e-5)&&(r.shadowMap.needsUpdate=!0,Tt.copy(g.sunDir)),Et=n;let d=1-g.windowGlow;Re.setRGB(v.lerp(.46,1,d),v.lerp(.52,1,d),v.lerp(.74,1,d)),q.uniforms.uExposure.value=g.exposure,ct.uniforms.uToonGain.value=g.toonGain,r.setClearColor(g.horizon,1),Dt(g.t),window.__t=g.t,R.update(e,t,g),L.update(t),ae.update(e,t,g),D.uniforms.uWakeCount.value=ae.wakeCount,z.update(e,t),D.uniforms.uRainCount.value=z.rainDropCount;let h=z.fog*(1-d);s.fog.density=z.fog*f,m.copy(g.horizon).lerp(p,.85*h),s.fog.color.copy(m),r.setClearColor(m,1),Ue.value=z.fog,A.material.uniforms.uFogAmt.value=.7*z.fog,Be.value=z.snow,Ve.value=z.cloud*.55,He.x+=e*.018,He.y+=e*.009,We.value+=(i-We.value)*Math.min(1,e*1.5),B.update(e,t,g,z);let _=Pt(),b=_.kind===`pixel`||_.kind===`blend`?`pixel`:Q||_.kind===`toon`?`charm`:`realistic`;ce.update(e,t,g,z,b),bt++;let x=performance.now();x-xt>=1e3&&(window.__fps=bt,St&&Ct&&(console.log(`[perf] ${bt} fps · ~${(1e3/Math.max(1,bt)).toFixed(2)} ms · calls ${Ct.calls} · tris ${Ct.tris} · programs ${Ct.programs} · geo ${Ct.geo} · tex ${Ct.tex}`),window.__perfInfo={fps:bt,...Ct}),bt=0,xt=x);let[S,C,w]=y;if(D.uniforms.uPrev.value=S.texture,D.uniforms.uCurr.value=C.texture,r.setRenderTarget(w),r.render(T,E),y=[C,w,S],j.uniforms.uHeight.value=y[1].texture,wt<2&&typeof document<`u`&&++wt===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Lt(e){Z=e,window.__mode=Z}function Rt(){return Q=!Q,Le.value=+!!Q,window.__vector=Q,Q}function zt(e){return Q=!!e,Le.value=+!!Q,window.__vector=Q,Q}function Bt(){return pt=_t[(_t.indexOf(pt)+1)%_t.length],window.__era=pt,kt(),pt}function Vt(){return ft=!ft,ft}return{updateWorld:It,decideStyle:$,renderCityPipeline:Nt,renderCityBeautyTo:Mt,styleHintName:Ft,setPostMode:Lt,toggleVector:Rt,setVector:zt,cycleEra:Bt,togglePalette:Vt,get mode(){return Z},get vector(){return Q},get sceneEra(){return pt},renderer:r,drawBuffer:o,scene:s,rig:h,sunRig:g,SIM:256,targets:y,simScene:T,simCamera:E,simMaterial:D,grabRT:O,card:k,backdrop:A,WATER_SIZE:28,water:M,waterMaterial:j,windowGlow:ne,landmarkFactory:re,city:L,cityLife:R,waterLife:ae,weatherRig:z,clouds:B,inspector:se,world:Ne,fitShadowFrustum:Pe,SHADOW_DIST:24,sceneDepth:Fe,sceneRT:Ge,filmicRT:Ke,toonRT:qe,pixelRT:Je,postScene:Qe,postCamera:$e,postQuad:et,filmicMaterial:q,pixelMaterial:Y,pixelkitMaterial:ot,toonMaterial:ct,mixMaterial:ut,PALCACHE:at,ERA_TEX:st,runPass:X,OVERCAST_GREY:u,FOG_DENSITY:f,FOG_NIGHT_TINT:p,_fogColor:m,resize:dt}}var fr=`lgr_hints_`,pr=!1;function mr(){if(pr||typeof document>`u`)return;pr=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  @media (prefers-reduced-motion: reduce) {
  ...
  }`,document.head.appendChild(e)}function hr({key:e,title:t=`Tips`,tips:n=[],force:r=!1}={}){let i={key:e,shown:!1,dismissed:!1,seen:!1};if(typeof window<`u`&&(window.__hints=i),typeof document>`u`||!e)return{dismiss(){},el:null};let a=fr+e,o=!1;try{o=localStorage.getItem(a)===`1`}catch{}if(o&&!r)return i.seen=!0,{dismiss(){},el:null};mr();let s=!!(window.matchMedia&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches),c=document.createElement(`div`);c.className=`lgr-hints`,c.innerHTML=`<div class="lgr-hints-card">
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var gr=new Set([`w`,`a`,`s`,`d`,`arrowup`,`arrowdown`,`arrowleft`,`arrowright`,`shift`,` `]),_r={walker:{p:.6,hp:26,speed:.85,dmg:9,score:10,size:1,color:`#6f8a45`},runner:{p:.25,hp:12,speed:1.75,dmg:7,score:16,size:.82,color:`#a6d24c`},tank:{p:.15,hp:95,speed:.5,dmg:20,score:34,size:1.5,color:`#39492a`}};function vr(){let e=Math.random();return e<_r.walker.p?`walker`:e<_r.walker.p+_r.runner.p?`runner`:`tank`}var yr=new F(`#ffffff`),br=new F(`#d83a2a`),xr={food:{name:`Food`,glyph:`🍖`,color:`#c8782e`,consumable:!0},water:{name:`Water`,glyph:`💧`,color:`#3aa6dc`,consumable:!0},bandage:{name:`Bandage`,glyph:`➕`,color:`#e8e2d6`,consumable:!0},scrap:{name:`Scrap`,glyph:`⚙️`,color:`#8a8f96`,consumable:!1},medkit:{name:`Medkit`,glyph:`✚`,color:`#e0524a`,consumable:!0},repairkit:{name:`Repair Kit`,glyph:`🔧`,color:`#caa05a`,consumable:!0}},Sr=[{out:`medkit`,need:{bandage:2}},{out:`repairkit`,need:{scrap:3}}];function Cr({extent:e=8,plinthTop:t=.3}={}){let n=new a;n.visible=!1,n.raycast=()=>{};let r=t+.02,i=Math.max(3,e-.7),o=typeof window<`u`&&window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,l=1.25,u=4.4,d=1.4,f=new a,p=new S(new M(.16,.34,4,10),K(new x({color:`#3f7fd0`,roughness:.6,flatShading:!0}),{color:`#3f7fd0`}));p.position.y=.33;let h=new S(new ce(.13,12,9),K(new x({color:`#e9caa1`,roughness:.75,flatShading:!0}),{color:`#e9caa1`}));h.position.y=.66;let _=new S(new H(.1,.1,.16),K(new x({color:`#ffd54a`,roughness:.5,flatShading:!0}),{color:`#ffd54a`}));_.position.set(0,.38,.18),f.add(p,h,_),f.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!1),e.raycast=()=>{}}),f.scale.setScalar(1.6),f.position.y=r,n.add(f);let y=new S(new le(.95,16,-.9,1.8),new c({color:`#ffe08a`,transparent:!0,opacity:0,depthWrite:!1,side:2}));y.rotation.x=-Math.PI/2,y.position.y=r+.06,y.raycast=()=>{},n.add(y);let b=new ae().setFromPoints([new N,new N]),C=new m(b,new g({color:`#fff3c0`,transparent:!0,opacity:0,depthWrite:!1}));C.raycast=()=>{},n.add(C);let w={x:0,z:0,vx:0,vz:0,hp:100,stamina:100,hunger:100,thirst:100,facing:0,iframe:0},T=new L(new M(.15,.3,4,8),K(new x({roughness:.85,flatShading:!0})),48);T.castShadow=!0,T.receiveShadow=!1,T.frustumCulled=!1,T.raycast=()=>{},T.instanceMatrix.setUsage(ye),n.add(T);let E=[];for(let e=0;e<48;e++)E.push({x:0,z:0,vx:0,vz:0,alive:!1,in:!1,type:`walker`,hp:1,maxhp:1,speed:1,dmg:0,score:0,size:1,phase:0,flash:0});let D=new F,O=[],ee=K(new x({color:`#7a5a36`,roughness:.9,flatShading:!0}),{color:`#7a5a36`});for(let e=0;e<8;e++){let t=e/8*Math.PI*2,i=new S(new H(2.1,.7,.24),ee.clone());i.position.set(Math.cos(t)*u,r+.35,Math.sin(t)*u),i.rotation.y=-t+Math.PI/2,i.castShadow=!0,i.raycast=()=>{},n.add(i),O.push({mesh:i,ang:t,hp:150,alive:!0,baseColor:new F(`#7a5a36`)})}function k(e,t){let n=Math.atan2(t,e);return n<0&&(n+=Math.PI*2),O[Math.round(n/(Math.PI*2/8))%8]}let A=[];for(let e=0;e<14;e++){let e=new S(new H(.26,.26,.26),K(new x({roughness:.6,flatShading:!0})));e.castShadow=!0,e.visible=!1,e.raycast=()=>{},n.add(e),A.push({mesh:e,x:0,z:0,kind:`food`,active:!1})}let j=new F;function te(){let e=Math.random();return e<.36?`food`:e<.72?`water`:e<.88?`bandage`:`scrap`}function ne(e,t,n){let i=A.find(e=>!e.active);i&&(i.x=e,i.z=t,i.kind=n||te(),i.active=!0,i.mesh.position.set(e,r+.18,t),i.mesh.visible=!0,i.mesh.material.color.copy(j.set(xr[i.kind].color)))}let P=[];function re(e){let t=P.find(t=>t.id===e);return t?t.n:0}function ie(e,t=1){let n=P.find(t=>t.id===e);return n?(n.n+=t,!0):P.length<8?(P.push({id:e,n:t}),!0):!1}function I(e,t){let n=P.find(t=>t.id===e);return!n||n.n<t?!1:(n.n-=t,n.n<=0&&P.splice(P.indexOf(n),1),!0)}function R(e){if(re(e)<=0)return!1;if(e===`food`)w.hunger=Math.min(100,w.hunger+38);else if(e===`water`)w.thirst=Math.min(100,w.thirst+38);else if(e===`bandage`)w.hp=Math.min(100,w.hp+40);else if(e===`medkit`)w.hp=Math.min(100,w.hp+90);else if(e===`repairkit`){let e=null;for(let t of O)(!e||t.hp<e.hp)&&(e=t);e&&(e.hp=150,e.alive=!0)}else return!1;return I(e,1),Je(),!0}function z(e){for(let t in e.need)if(re(t)<e.need[t])return!1;for(let t in e.need)I(t,e.need[t]);return ie(e.out,1),Je(),!0}let oe=!1,B=!1,V=1,se=0,ue=0,de=0,fe=`spawning`,pe=0,me=0,he=0,ge=0,U=!1,_e=null;function ve(){for(let e=0;e<48;e++)if(!E[e].alive)return E[e];return null}function be(e){let t=ve();if(!t)return;let n=_r[vr()];t.type=Object.keys(_r).find(e=>_r[e]===n)||`walker`;let r=Math.random()*Math.PI*2;t.x=Math.cos(r)*i,t.z=Math.sin(r)*i,t.vx=0,t.vz=0;let a=1+V*.08;t.maxhp=n.hp*a,t.hp=t.maxhp,t.speed=n.speed*(1+.4*e)*(1+V*.015)*(V===1?.85:1),t.dmg=n.dmg,t.score=n.score,t.size=n.size,t.phase=Math.random()*6.28,t.flash=0,t.in=!1,t.alive=!0}function xe(){let e=null,t=1/0;for(let n of E){if(!n.alive)continue;let r=(n.x-w.x)**2+(n.z-w.z)**2;r<t&&(t=r,e=n)}return e}function Se(e){e.alive=!1,se++,ue+=e.score,Math.random()<.3&&ne(e.x,e.z)}function Ce(e,t){e.hp-=t,e.flash=.12,e.hp<=0&&Se(e)}function we(){if(B||he>0)return;he=.16;let e,t;if(_e)e=_e.x-w.x,t=_e.z-w.z;else{let n=xe();n?(e=n.x-w.x,t=n.z-w.z):(e=Math.sin(w.facing),t=Math.cos(w.facing))}let n=Math.hypot(e,t)||1;e/=n,t/=n,w.facing=Math.atan2(e,t);let i=null,a=1/0;for(let n of E){if(!n.alive)continue;let r=n.x-w.x,o=n.z-w.z,s=r*e+o*t;s<0||s>9||Math.abs(r*t-o*e)<.7*(.4+.6*n.size)&&s<a&&(a=s,i=n)}let o=i?a:9,s=b.attributes.position;s.setXYZ(0,w.x,r+.5,w.z),s.setXYZ(1,w.x+e*o,r+.5,w.z+t*o),s.needsUpdate=!0,C.material.opacity=.95,i&&Ce(i,16)}function Te(){if(B||ge>0)return;ge=.42,y.material.opacity=.85;let e=Math.sin(w.facing),t=Math.cos(w.facing);for(let n of E){if(!n.alive)continue;let r=n.x-w.x,i=n.z-w.z,a=Math.hypot(r,i);a>1.05+n.size*.2||(r*e+i*t)/(a||1)>.2&&Ce(n,34)}}let W={},Ee={x:0,y:0};function De(e,t){if(!oe)return;let n=e.key.toLowerCase();if(t&&n===`i`){e.stopImmediatePropagation(),Ze();return}if(t&&n===`escape`&&Ve){e.stopImmediatePropagation(),Xe();return}if(gr.has(n)){if(e.stopImmediatePropagation(),n.startsWith(`arrow`)&&e.preventDefault(),n===` `){t&&Te();return}W[n]=t}}typeof window<`u`&&(window.addEventListener(`keydown`,e=>De(e,!0)),window.addEventListener(`keyup`,e=>De(e,!1)));let G=null,Oe=null,ke=null,Ae=null,je=null,Me=null,Ne=null,Pe=null,Fe=null,Ie=null,Le=null,Re=null,ze=null,Be=null,Ve=!1;if(typeof document<`u`){let e=document.createElement(`style`);e.textContent=`
    ...
    `,document.head.appendChild(e),G=document.createElement(`div`),G.className=`hoard-stick`,Oe=document.createElement(`div`),Oe.className=`knob`,G.appendChild(Oe),document.body.appendChild(G);let t=!1,n=e=>{let t=G.getBoundingClientRect(),n=e.clientX-(t.left+t.width/2),r=e.clientY-(t.top+t.height/2),i=Math.hypot(n,r)||1;i>44&&(n*=44/i,r*=44/i),Oe.style.transform=`translate(${n}px,${r}px)`,Ee.x=n/44,Ee.y=-r/44};G.addEventListener(`pointerdown`,e=>{t=!0,G.setPointerCapture(e.pointerId),n(e)}),G.addEventListener(`pointermove`,e=>{t&&n(e)});let r=()=>{t=!1,Ee.x=0,Ee.y=0,Oe.style.transform=`translate(0,0)`};G.addEventListener(`pointerup`,r),G.addEventListener(`pointercancel`,r),Le=document.createElement(`button`),Le.className=`hoard-btn hoard-fire`,Le.textContent=`FIRE`,document.body.appendChild(Le),Re=document.createElement(`button`),Re.className=`hoard-btn hoard-melee`,Re.textContent=`MELEE`,document.body.appendChild(Re),Le.addEventListener(`pointerdown`,e=>{e.preventDefault(),navigator.vibrate?.(12),U=!0}),Le.addEventListener(`pointerup`,()=>{U=!1}),Le.addEventListener(`pointercancel`,()=>{U=!1}),Re.addEventListener(`pointerdown`,e=>{e.preventDefault(),navigator.vibrate?.(18),Te()}),ke=document.createElement(`div`),ke.className=`hoard-hud`,ke.innerHTML=`HP<div class="bar"><i style="background:#e0524a"></i></div>STAMINA<div class="bar"><i style="background:#4ad08a"></i></div>HUNGER<div class="bar"><i style="background:#d89a3a"></i></div>THIRST<div class="bar"><i style="background:#3aa6dc"></i></div><div class="stat"></div>`,document.body.appendChild(ke);let i=ke.querySelectorAll(`i`);Ae=i[0],je=i[1],Me=i[2],Ne=i[3],Pe=ke.querySelector(`.stat`),Fe=document.createElement(`div`),Fe.className=`hoard-banner`,document.body.appendChild(Fe),Ie=document.createElement(`div`),Ie.className=`hoard-death`,Ie.innerHTML=`<h2>YOU DIED</h2><div class="ds"></div><button>RESTART</button>`,document.body.appendChild(Ie),Ie.querySelector(`button`).addEventListener(`click`,()=>et());let a=document.createElement(`style`);a.textContent=`
    ...
    `,document.head.appendChild(a),ze=document.createElement(`button`),ze.className=`hoard-bagbtn`,ze.textContent=`🎒`,ze.title=`Inventory (I)`,document.body.appendChild(ze),ze.addEventListener(`click`,()=>Ze()),Be=document.createElement(`div`),Be.className=`hoard-bag`,document.body.appendChild(Be)}let He=0;function Ue(e,t=1.8){Fe&&(Fe.textContent=e,Fe.style.display=`block`),He=t}let We=Math.PI/4;function Ge(e){We=e}function Ke(e,t){_e={x:e,z:t}}function qe(e){U=e}function Je(){if(typeof window<`u`&&(window.__hoardBag=Object.fromEntries(P.map(e=>[e.id,e.n]))),!Be)return;let e=`<div class="panel"><h3>INVENTORY</h3><div class="slots">`;for(let t=0;t<8;t++){let n=P[t];n?e+=`<button class="slot" data-id="${n.id}" title="${xr[n.id].name}">${xr[n.id].glyph}<span class="n">${n.n}</span></button>`:e+=`<div class="slot empty"></div>`}e+=`</div><div class="craft">`,Sr.forEach((t,n)=>{let r=Object.keys(t.need).every(e=>re(e)>=t.need[e]),i=Object.entries(t.need).map(([e,t])=>`${t}${xr[e].glyph}`).join(`+`);e+=`<button data-rec="${n}" ${r?``:`disabled`}>Craft ${xr[t.out].name} (${i})</button>`}),e+=`</div><button class="close">CLOSE (I)</button></div>`,Be.innerHTML=e,Be.querySelectorAll(`.slot[data-id]`).forEach(e=>e.addEventListener(`click`,()=>{xr[e.dataset.id].consumable&&R(e.dataset.id)})),Be.querySelectorAll(`[data-rec]`).forEach(e=>e.addEventListener(`click`,()=>z(Sr[+e.dataset.rec]))),Be.querySelector(`.close`).addEventListener(`click`,()=>Xe())}function Ye(){!oe||B||(Ve=!0,Be&&Be.classList.add(`open`),Je())}function Xe(){Ve=!1,Be&&Be.classList.remove(`open`)}function Ze(){Ve?Xe():Ye()}function Qe(e){V=e,me=5+e*2,fe=`spawning`}function $e(){w.x=0,w.z=0,w.vx=0,w.vz=0,w.hp=100,w.stamina=100,w.hunger=100,w.thirst=100,w.facing=0,w.iframe=0;for(let e of E)e.alive=!1;se=0,ue=0,de=0,B=!1,U=!1,_e=null;for(let e of O)e.hp=150,e.alive=!0,e.mesh.scale.set(1,1,1);for(let e of A)e.active=!1,e.mesh.visible=!1;P.length=0;let e=[`food`,`water`,`food`,`water`,`bandage`,`scrap`];for(let t=0;t<6;t++){let n=Math.random()*Math.PI*2,r=1.6+Math.random()*(i-2);ne(Math.cos(n)*r,Math.sin(n)*r,e[t])}Ie&&(Ie.style.display=`none`),f.position.set(0,r,0),f.visible=!0,Qe(1),Je()}function et(){$e()}function q(e){oe=e,n.visible=e;let t=e&&o;G&&(G.style.display=t?`block`:`none`),Le&&(Le.style.display=t?`block`:`none`),Re&&(Re.style.display=t?`block`:`none`),ke&&(ke.style.display=e?`block`:`none`),Fe&&!e&&(Fe.style.display=`none`),Ie&&!e&&(Ie.style.display=`none`),ze&&(ze.style.display=e?`block`:`none`),Xe();for(let e in W)W[e]=!1;Ee.x=Ee.y=0,U=!1,e&&$e()}let J=new s;function tt(e,t,n){if(!oe||Ve)return;let a=n?n.windowGlow:0;if(he=Math.max(0,he-e),ge=Math.max(0,ge-e),C.material.opacity=Math.max(0,C.material.opacity-e*8),y.material.opacity=Math.max(0,y.material.opacity-e*6),!B){de+=e,w.iframe=Math.max(0,w.iframe-e);let n=(W.d||W.arrowright?1:0)-(W.a||W.arrowleft?1:0)+Ee.x,a=(W.w||W.arrowup?1:0)-(W.s||W.arrowdown?1:0)+Ee.y,o=Math.hypot(n,a);o>1&&(n/=o,a/=o);let s=o>.05,c=(W.shift||Ee.y>.95)&&w.stamina>2&&s,l=Math.cos(We),p=Math.sin(We),m=l*n+-p*a,h=-p*n+-l*a,g=c?5.2:3,_=1-Math.exp(-14*e);w.vx+=(m*g-w.vx)*_,w.vz+=(h*g-w.vz)*_,w.x+=w.vx*e,w.z+=w.vz*e;let b=Math.hypot(w.x,w.z);b>i&&(w.x*=i/b,w.z*=i/b,w.vx=0,w.vz=0),s&&(w.facing=Math.atan2(m,h)),w.stamina=v.clamp(w.stamina+(c?-34:22)*e,0,100),w.hunger=Math.max(0,w.hunger-.9*e),w.thirst=Math.max(0,w.thirst-1.15*e),w.hunger<=0||w.thirst<=0?w.hp=Math.max(0,w.hp-3.5*e):w.hunger>55&&w.thirst>55&&w.hp<100&&(w.hp=Math.min(100,w.hp+2*e));for(let e of A)e.active&&(e.x-w.x)**2+(e.z-w.z)**2<.3&&ie(e.kind)&&(e.active=!1,e.mesh.visible=!1,Je());for(let t of O){if(t.hp>=150)continue;let n=Math.cos(t.ang)*u,r=Math.sin(t.ang)*u;(n-w.x)**2+(r-w.z)**2<d*d&&(t.hp=Math.min(150,t.hp+30*e),t.hp>0&&(t.alive=!0))}w.hp<=0&&nt(),f.position.set(w.x,r,w.z),f.rotation.y=w.facing,f.visible=!(w.iframe>0&&Math.floor(t*20)%2==0),U&&we(),y.position.set(w.x,r+.06,w.z),y.rotation.z=-w.facing}let o=0;B||fe===`spawning`&&(me>0&&Math.random()<e*(V===1?3.5:6)&&(be(a),me--),me<=0&&(fe=`fighting`));let s=0,c=1/0;for(let n=0;n<48;n++){let i=E[n];if(!i.alive){J.position.set(0,-60,0),J.scale.setScalar(0),J.updateMatrix(),T.setMatrixAt(n,J.matrix);continue}o++;let a=w.x-i.x,d=w.z-i.z,f=Math.hypot(a,d)||1;if(f<c&&(c=f),!B){let t=a/f*i.speed,n=d/f*i.speed,r=1-Math.exp(-6*e);if(i.vx+=(t-i.vx)*r,i.vz+=(n-i.vz)*r,f>.52){let t=i.x+i.vx*e,n=i.z+i.vz*e,r=Math.hypot(i.x,i.z),a=Math.hypot(t,n);if(!i.in&&r>=u&&a<4.9){let r=k(t,n);if(r.alive){let i=Math.atan2(n,t),a=4.9;t=Math.cos(i)*a,n=Math.sin(i)*a,r.hp-=15*e,r.hp<=0&&(r.hp=0,r.alive=!1)}}a<u-.1&&(i.in=!0),i.x=t,i.z=n}else w.iframe<=0&&(s=Math.max(s,i.dmg))}i.flash=Math.max(0,i.flash-e);let p=Math.sin(t*6+i.phase)*.04;J.position.set(i.x,r+.3*i.size*l+p,i.z),J.rotation.set(0,Math.atan2(i.vx,i.vz),Math.sin(t*3+i.phase)*.12),J.scale.setScalar(i.size*l),J.updateMatrix(),T.setMatrixAt(n,J.matrix),D.set(_r[i.type].color),i.flash>0?D.lerp(yr,.7):D.lerp(br,.35*(1-i.hp/i.maxhp)),T.setColorAt(n,D)}T.instanceMatrix.needsUpdate=!0,T.instanceColor&&(T.instanceColor.needsUpdate=!0);let p=0;for(let e of O){e.alive&&p++;let t=Math.max(0,e.hp/150);e.mesh.scale.y=e.alive?Math.max(.18,t):.12,e.mesh.position.y=r+.35*e.mesh.scale.y,e.mesh.material.color.copy(e.baseColor).lerp(br,(1-t)*.55)}!B&&s>0&&(w.hp=Math.max(0,w.hp-s*(V===1?.5:1)),w.iframe=.6,w.hp<=0&&nt()),!B&&fe===`fighting`&&o===0&&me<=0&&(fe=`complete`,pe=2.2,Ue(`WAVE ${V} CLEAR`,2)),!B&&fe===`complete`&&(pe-=e,pe<=0&&(Qe(V+1),Ue(`WAVE ${V}`,1.4))),He>0&&(He-=e,He<=0&&Fe&&(Fe.style.display=`none`)),Ae&&(Ae.style.width=`${w.hp}%`),je&&(je.style.width=`${w.stamina}%`),Me&&(Me.style.width=`${w.hunger}%`),Ne&&(Ne.style.width=`${w.thirst}%`),Pe&&(Pe.textContent=`WAVE ${V}   KILLS ${se}   SCORE ${ue}`),typeof window<`u`&&(window.__hoard={active:oe,dead:B,paused:Ve,hp:Math.round(w.hp),stamina:Math.round(w.stamina),hunger:Math.round(w.hunger),thirst:Math.round(w.thirst),zombies:o,barriers:p,pickups:A.filter(e=>e.active).length,inv:Object.fromEntries(P.map(e=>[e.id,e.n])),wave:V,kills:se,score:ue,weapon:`gun`,znear:+c.toFixed(2),px:+w.x.toFixed(2),pz:+w.z.toFixed(2)})}function nt(){B=!0,U=!1,Ie&&(Ie.querySelector(`.ds`).innerHTML=`Wave reached: ${V}<br>Kills: ${se}<br>Score: ${ue}<br>Survived: ${de.toFixed(0)}s`,Ie.style.display=`flex`)}return{group:n,update:tt,setActive:q,setAzimuth:Ge,setAim:Ke,setFiring:qe,melee:Te,reset:$e,restart:et,openBag:Ye,closeBag:Xe,toggleBag:Ze,addItem:ie,get player(){return w},get dead(){return B},get active(){return oe},get paused(){return Ve},get inv(){return P.map(e=>({...e}))},get nearestPickup(){let e=null,t=1e9;for(let n of A){if(!n.active)continue;let r=(n.x-w.x)**2+(n.z-w.z)**2;r<t&&(t=r,e=n)}return e?{x:e.x,z:e.z}:null},setTarget(){}}}var{Timer:wr}=O,Tr=new URLSearchParams(window.location.search),Er=Tr.get(`demo`)===`1`||Tr.has(`capture`);window.__demo=Er;var Dr=(Tr.get(`city`)?Number(Tr.get(`city`)):0)||Math.random()*1e9|0,Or=0,kr=dr({demo:Er,citySeed:Dr,profileIndex:Or}),{renderer:Ar,scene:jr,rig:Mr,sunRig:Nr,city:Pr,landmarkFactory:Fr}=kr,Ir=Cr({extent:Pr.extent,plinthTop:.3});jr.add(Ir.group),window.__hoardApi=Ir;var Lr=!0;window.__shadows=Lr,window.__scene=`hoard`;var Rr=new N,zr=new Set,Br=6.5;function Vr(e){Pr.group.traverse(t=>{!t.isMesh||t.userData.ground||!t.visible||(t.getWorldPosition(Rr),Math.hypot(Rr.x,Rr.z)<e&&(t.visible=!1,zr.add(t)))})}function Hr(){for(let e of zr)e.visible=!0;zr.clear()}var Ur=new he,Wr=new N,Gr=new N,Kr=new Set;function qr(){for(let e of Kr)e.material&&(e.material.opacity=1,e.material.transparent=!!e.userData._wasT,e.material.depthWrite=e.userData._wasDW!==!1);Kr.clear()}function Jr(e){qr();let t=Mr.camera;for(let[n,r]of[[0,0],[.7,.4],[-.7,.4]]){Gr.set(e.x+n,.6,e.z+r),Wr.subVectors(Gr,t.position);let i=Wr.length();Ur.set(t.position,Wr.normalize()),Ur.far=i-.4;for(let e of Ur.intersectObject(Pr.group,!0)){let t=e.object;!t.material||t.userData.ground||Kr.has(t)||(t.userData._wasT=t.material.transparent,t.userData._wasDW=t.material.depthWrite,t.material.transparent=!0,t.material.opacity=.16,t.material.depthWrite=!1,Kr.add(t))}}}function Yr(){Ir.setActive(!0),Vr(Br),Mr.setMode(Te.DIMETRIC),Mr.setZoom(2.8,!0),Mr.setTarget(Ir.player.x,.6,Ir.player.z,!0)}var Xr=new he,Zr=new U,Qr=new T(new N(0,1,0),-.32),$r=new N,ei=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,ti=!1,ni=0,ri=0,ii=.005,ai=(e,t)=>{Zr.x=e/window.innerWidth*2-1,Zr.y=-(t/window.innerHeight)*2+1};Ar.domElement.addEventListener(`contextmenu`,e=>e.preventDefault()),Ar.domElement.addEventListener(`mousedown`,e=>{e.button===0&&(ai(e.clientX,e.clientY),Ir.setFiring(!0)),e.button===2&&(ti=!0,ni=e.clientX,ri=e.clientY)}),window.addEventListener(`mousemove`,e=>{ai(e.clientX,e.clientY),ti&&(Mr.orbit(-(e.clientX-ni)*ii,-(e.clientY-ri)*ii),ni=e.clientX,ri=e.clientY)}),window.addEventListener(`mouseup`,()=>{Ir.setFiring(!1),ti=!1}),Ar.domElement.addEventListener(`wheel`,e=>{e.preventDefault(),Mr.zoomBy(Math.exp(e.deltaY*.0015))},{passive:!1}),window.addEventListener(`keydown`,e=>{(e.key===`h`||e.key===`H`)&&(Lr=!Lr,window.__shadows=Lr)}),Fr.whenReady.then(()=>{Pr.generate(Dr,Or),kr.fitShadowFrustum(),Hr(),Vr(Br),window.__cityReady=!0});var oi=new wr;oi.connect(document);function si(){oi.update();let e=Math.min(oi.getDelta(),.1);Ir.setAzimuth(Mr.azimuth),ei||(Xr.setFromCamera(Zr,Mr.camera),Xr.ray.intersectPlane(Qr,$r)&&Ir.setAim($r.x,$r.z)),Ir.update(e,oi.getElapsed(),Nr),Mr.setTarget(Ir.player.x,.6,Ir.player.z),Mr.update(e),Jr(Ir.player),kr.updateWorld(e,oi.getElapsed(),{shadowsOn:Lr,seasonTarget:0});let t=kr.decideStyle();kr.renderCityPipeline(t,null),requestAnimationFrame(si)}Yr(),si(),hr({key:`hoard`,title:`The Hoard`,tips:[`Move: WASD / arrows · on touch: the left thumb-stick`,`Aim: mouse / drag · Fire: hold click / the FIRE button · Melee: the MELEE button`,`Survive the waves · B: bag & crafting · Esc: exit`]}),window.addEventListener(`resize`,()=>{kr.resize()});