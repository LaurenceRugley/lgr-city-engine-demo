...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Fr={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Ir=[`gb`,`8-bit`,`16-bit`,`modern`];function Lr(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new F(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new U(n,t,1,te,W);return r.minFilter=C,r.magFilter=C,r.needsUpdate=!0,r}var Rr=220,zr={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Br={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Vr({demo:e=!1,citySeed:t=0,profileIndex:n=0}={}){let r=new ie({antialias:!0,preserveDrawingBuffer:!0});r.shadowMap.enabled=!0,r.shadowMap.type=1,r.shadowMap.autoUpdate=!1,r.shadowMap.needsUpdate=!0;let a=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);r.setPixelRatio(Math.min(window.devicePixelRatio,a?1.5:2)),r.setSize(window.innerWidth,window.innerHeight),r.setClearColor(920327,1),document.body.appendChild(r.domElement);let o=r.getDrawingBufferSize(new H),s=new pe;s.fog=new b(10465470,0);let u=new F(`#aeb6c0`),f=.062,p=new F(`#74508f`),m=new F,h=Ne({aspect:window.innerWidth/window.innerHeight}),g=gt({t:.5}),_={type:i,format:te,minFilter:C,magFilter:C,wrapS:se,wrapT:se,depthBuffer:!1,stencilBuffer:!1},y=[new P(256,256,_),new P(256,256,_),new P(256,256,_)];for(let e of y)r.setRenderTarget(e),r.clear();r.setRenderTarget(null);let T=new pe,E=new d(-1,1,1,-1,0,1),D=new ae({vertexShader:wr,fragmentShader:Tr,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new H(1/256,1/256)},uMouse:{value:new H(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new N)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new N)}}});T.add(new S(new w(2,2),D));let O=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!0,stencilBuffer:!1});function ee(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new _e(t);return r.colorSpace=B,r}let k=new S(new w(28,28),new c({map:ee(e)}));k.rotation.x=-Math.PI/2,k.position.y=-.35,s.add(k);let A=new S(new w(40,24),new ae({depthWrite:!1,vertexShader:Sr,fragmentShader:Cr,uniforms:{uTime:{value:0},uInk:{value:g.horizon},uGold:{value:g.sky},uFogColor:{value:m},uFogAmt:{value:0},uFogCharm:Be}}));A.position.set(0,3,-8),s.add(A);let j=new ae({vertexShader:Er,fragmentShader:Dr,uniforms:{uHeight:{value:null},uScene:{value:O.texture},uTexel:{value:new H(1/256,1/256)},uResolution:{value:new H(o.x,o.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new be},uLightDir:{value:g.sunDir},uInk:{value:new F(`#2A2218`)},uGold:{value:new F(`#B89968`)},uVector:Pe,uVecWater:{value:new F(`#1fb8d8`)},uVecTint:{value:Fe}}}),M=new S(new w(28,28,255,255),j);M.rotation.x=-Math.PI/2,M.updateMatrixWorld(!0),j.uniforms.uNormalMatrix.value.getNormalMatrix(M.matrixWorld),s.add(M);let ne={value:0},re=Ht({windowGlow:ne}),I=ct({seed:t,profileIndex:n,landmarkFactory:re,windowGlow:ne});s.add(I.group);let L=xt({plinthTop:.3,extent:I.extent,profile:I.state.profile});s.add(L.group);let oe=jt({extent:I.extent,waterSize:28,plinthTop:.3});s.add(oe.group),D.uniforms.uWakeDrops.value=oe.wakeDrops;let R=Wt({extent:I.extent});s.add(R.group),D.uniforms.uRainDrops.value=R.rainDrops;let z=Kt({extent:I.extent});s.add(z.group);let ce=[L,oe,z],le=Yt({rig:h,getCamera:()=>h.camera,sources:ce}),ue=xr();s.add(ue.group);let de=ir({scale:90});s.add(de.mesh),s.environmentIntensity=.32;let fe=!1;function V(e){let t=e&&g.sunArc.y>-.04;t!==fe&&(fe=t,de.mesh.visible=t,A.visible=!t)}let me=null,he=-1;function ge(){let e=Math.floor(g.t%1*4)%4;return(e!==he||!me)&&(he=e,me=de.buildEnv(r)),me}let U=null,W=null,ve=null,G=null,xe=!1,Se=1234,K=`valley`,Ce=mn.map(e=>e.key),we=new x({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Te=()=>[I.group,L.group,oe.group],q=()=>[U,W,ve].filter(Boolean);function Ee(){for(let e of q())s.remove(e),e.userData.dispose?.();let e=yn({seed:Se,size:160,preset:K});G=e,U=En(e,{worldSize:26,baseY:0,chunks:6}),W=Zn({terrain:e,seed:Se,worldSize:26,baseY:0,biomeKeys:Ce}),ve=er(e,{worldSize:26,baseY:0,maxLakes:3,material:we});for(let e of q())e.visible=xe,s.add(e);J!==void 0&&J&&J.clear(),typeof window<`u`&&(window.__world={seed:Se,preset:K,active:xe,chunks:U.children.length,scatter:W.userData.counts,lakes:ve.userData.count})}let De=e=>{for(let t of q())t.visible=e};function Oe(e,t){if(!G)return 0;let{size:n,height:r,sea:i,relief:a}=G,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let J=nn({heightAt:Oe,seaSurfaceY:0,waterY:.06});J.group.visible=!1,s.add(J.group),ce.push(J);let ke=null,Ae=new Set;function je(){!G||!ve||(s.remove(ve),ve.userData.dispose?.(),ve=er(G,{worldSize:26,baseY:0,maxLakes:3,material:we}),ve.visible=xe,s.add(ve),window.__world&&(window.__world.lakes=ve.userData.count))}function Me(){je(),W&&Xn(W,G,{worldSize:26,baseY:0})}function He(e,t,n=1,r=2.2,i=.05){if(!G||!U)return;let a=G.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=G.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Ae.clear();for(let e of U.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Ae.add(e)}Dn(U,G,Ae),ke&&clearTimeout(ke),ke=setTimeout(Me,140)}function Ue(e,t,n,r=2.2){if(!G||!U||n==null)return;let i=G.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=G.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);Ae.clear();for(let e of U.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Ae.add(e)}Dn(U,G,Ae,!0)}let We=[`tree`,`rock`,`tuft`];function Ge(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!G||!W)return 0;if(a)return Jn(W,n||`all`,e,t,i);let o=G.size,s=26/(o-1),c=G.height,l=G.sea,u=G.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Yn[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;qn(W,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&W.userData.counts)for(let e of We)W.userData.counts[e]=(W.userData.placements[e]||[]).length;return g}let Ke=[];function qe(){if(!W)return null;let e=W.userData.placements,t={};for(let n of We)t[n]=(e[n]||[]).map(e=>({...e}));return t}function Je(){G&&(Ke.push({h:G.height.slice(),b:G.biome.slice(),sc:qe(),pl:J.snapshot()}),Ke.length>12&&Ke.shift())}function Y(){if(!G||!Ke.length)return!1;let e=Ke.pop();if(G.height.set(e.h),G.biome.set(e.b),e.sc&&W){let t=W.userData.placements;for(let n of We)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&J.restore(e.pl),Dn(U,G,U.children,!0),Me(),!0}let Ye=new Set([`boat`,`fish`]),Xe=new Set([`person`]);function Ze(e,t,n){if(!G)return null;let r=Oe(t,n)<0;return Ye.has(e)&&!r||Xe.has(e)&&r?null:J.spawn(e,t,n)}function Qe(e,t,n=2.5){return J.removeNear(e,t,n)}function X(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function $e(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let et=e=>X(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),tt=e=>X(e);function nt(){let e=W?W.userData.placements:{},t={};for(let n of We)t[n]=(e[n]||[]).map(e=>({...e}));return t}function rt(){return G?{v:1,seed:Se,preset:K,size:G.size,height:et(G.height),biome:tt(G.biome),scatter:nt(),entities:J.snapshot()}:null}function it(){if(!G)return null;let e=yn({seed:Se,size:160,preset:K}),t=G.height,n=G.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:Se,preset:K,hd:r,bd:i,entities:J.snapshot()}}function at(e){W&&(s.remove(W),W.userData.dispose?.()),W=Un(e||{tree:[],rock:[],tuft:[]}),W.userData.counts=We.reduce((e,t)=>(e[t]=(W.userData.placements[t]||[]).length,e),{}),W.visible=xe,s.add(W)}function ot(e){if(!e||e.v!==1)return!1;Se=e.seed|0,K=vn.includes(e.preset)?e.preset:K,Ke.length=0,Ee(),xe=!0,De(!0),J.group.visible=!0;for(let e of Te())e.visible=!1;if(window.__world&&(window.__world.active=!0),e.height&&e.biome){let t=$e(e.height);G.height.set(new Float32Array(t.buffer,t.byteOffset,t.byteLength/4));let n=$e(e.biome);G.biome.set(n.subarray(0,G.biome.length))}else if(e.hd||e.bd){let t=e.hd||[],n=e.bd||[];for(let e=0;e<t.length;e+=2)G.height[t[e]]=t[e+1];for(let e=0;e<n.length;e+=2)G.biome[n[e]]=n[e+1]}return Dn(U,G,U.children,!0),e.scatter&&at(e.scatter),je(),W&&Xn(W,G,{worldSize:26,baseY:0}),J.restore(e.entities),window.__world&&(window.__world.scatter=W.userData.counts,window.__world.seed=Se,window.__world.preset=K),!0}let st={enter(){U||Ee(),xe=!0,De(!0),J.group.visible=!0;for(let e of Te())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){xe=!1,De(!1),J.group.visible=!1;for(let e of Te())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return Se=Math.random()*1e9|0,Ke.length=0,Ee(),st.enter(),Se},reset(){return Ke.length=0,Ee(),st.enter(),Se},setPreset(e){return vn.includes(e)&&(K=e,Ke.length=0,Ee(),st.enter()),K},sculpt:He,paintBiome:Ue,paintScatter:Ge,repoolWater:je,snapshot:Je,undo:Y,placeEntity:Ze,removeEntityNear:Qe,heightAt:Oe,serialize:rt,serializeCompact:it,deserialize:ot,get terrainGroup(){return U},get biomes(){return mn},get scatterCounts(){return W?W.userData.placements&&We.reduce((e,t)=>(e[t]=(W.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return J.counts()},setScatterHidden(e){W&&(W.visible=!e)},get placedLife(){return J},get canUndo(){return Ke.length>0},get active(){return xe},get seed(){return Se},get preset(){return K},get presets(){return vn}},lt=nr(),ut=ln({world:st,catalog:lt,inspector:le});I.group.remove(I.key),s.add(I.key),I.key.castShadow=!0,I.key.shadow.mapSize.set(2048,2048),I.key.shadow.bias=-18e-5,I.key.shadow.normalBias=.028,s.add(I.key.target);function dt(){let e=I.key.shadow.camera,t=I.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),r.shadowMap.needsUpdate=!0}dt();let ft=new ye(o.x,o.y),pt=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!0,stencilBuffer:!1,depthTexture:ft}),mt=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),ht=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),_t=new P(o.x,o.y,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),vt=Math.max(1,Math.floor(o.x/2)),yt=Math.max(1,Math.floor(o.y/2)),bt=new P(vt,yt,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),St=new P(vt,yt,{minFilter:l,magFilter:l,depthBuffer:!1,stencilBuffer:!1}),Ct=new pe,wt=new d(-1,1,1,-1,0,1),Tt=new S(new w(2,2));Ct.add(Tt);let Z=new ae({vertexShader:wr,fragmentShader:Or,uniforms:{uScene:{value:pt.texture},uTime:{value:0},uResolution:{value:new H(o.x,o.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:bt.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:g.grade.tint},uGradeLift:{value:g.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1}}}),Et=new ae({vertexShader:wr,fragmentShader:Mr,uniforms:{uScene:{value:pt.texture},uThreshold:{value:.78}}}),Dt=new ae({vertexShader:wr,fragmentShader:Nr,uniforms:{uScene:{value:bt.texture},uDir:{value:new H}}});function Ot(e){Et.uniforms.uScene.value=e.texture,Lt(Et,bt),Dt.uniforms.uScene.value=bt.texture,Dt.uniforms.uDir.value.set(1.6/vt,0),Lt(Dt,St),Dt.uniforms.uScene.value=St.texture,Dt.uniforms.uDir.value.set(0,1.6/yt),Lt(Dt,bt),Z.uniforms.uBloom.value=bt.texture;let t=1-v.clamp(g.sunArc.y*2.2,0,1);Z.uniforms.uBloomStrength.value=.85*(.32+.95*t)}let kt=e=>{let t=e.map(e=>new F(e));for(;t.length<8;)t.push(new F(0,0,0));return t},At=[`night`,`dawn`,`noon`,`dusk`],Mt={inkgold:At.map(e=>kt(zr[e])),terminal:At.map(e=>kt(Br[e]))},Nt=new ae({vertexShader:wr,fragmentShader:kr,uniforms:{uScene:{value:mt.texture},uResolution:{value:new H(o.x,o.y)},uPixelSize:{value:Rr},uPalette:{value:Mt.inkgold[2]},uPaletteB:{value:Mt.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),Pt=new ae({vertexShader:wr,fragmentShader:Pr,uniforms:{uScene:{value:mt.texture},uResolution:{value:new H(o.x,o.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Lr(Fr[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Q={};for(let e of Ir)Q[e]=Fr[e].palette?Lr(Fr[e].palette):null;let Ft=new ae({vertexShader:wr,fragmentShader:Ar,uniforms:{uScene:{value:mt.texture},uDepth:{value:ft},uResolution:{value:new H(o.x,o.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:g.toonFloor},uOutline:{value:g.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),It=new ae({vertexShader:wr,fragmentShader:jr,uniforms:{uToon:{value:ht.texture},uPixel:{value:_t.texture},uBlend:{value:0}}});function Lt(e,t){Tt.material=e,r.setRenderTarget(t),r.render(Ct,wt)}function Rt(){h.setViewport(window.innerWidth,window.innerHeight),r.setSize(window.innerWidth,window.innerHeight);let e=r.getDrawingBufferSize(new H);return O.setSize(e.x,e.y),pt.setSize(e.x,e.y),mt.setSize(e.x,e.y),ht.setSize(e.x,e.y),_t.setSize(e.x,e.y),vt=Math.max(1,e.x>>1),yt=Math.max(1,e.y>>1),bt.setSize(vt,yt),St.setSize(vt,yt),j.uniforms.uResolution.value.set(e.x,e.y),Z.uniforms.uResolution.value.set(e.x,e.y),Nt.uniforms.uResolution.value.set(e.x,e.y),Pt.uniforms.uResolution.value.set(e.x,e.y),Ft.uniforms.uResolution.value.set(e.x,e.y),e}let $=3,zt=!1,Bt=!1,Vt=`native`,Ut=.3,Gt=.46,qt=[`native`,...Ir],Jt={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=$,window.__vector=zt,window.__era=Vt);let Xt=0,Zt=performance.now(),Qt=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=Qt),Qt&&(r.info.autoReset=!1);let $t=null;typeof window<`u`&&(window.__loaded=!1);let en=0,tn=new N(1,1,1),rn=!1;function an(e){let t=Bt?Mt.terminal:Mt.inkgold,n=e%1*4,r=Math.floor(n)%4;Nt.uniforms.uPalette.value=t[r],Nt.uniforms.uPaletteB.value=t[(r+1)%4],Nt.uniforms.uPaletteBlend.value=n-Math.floor(n)}function on(e){let t=Fr[e];t&&(Pt.uniforms.uGridWidth.value=t.gridWidth,Pt.uniforms.uDither.value=t.dither,Pt.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(Pt.uniforms.uPalette.value=Q[e],Pt.uniforms.uPaletteSize.value=t.palette.length))}function sn(){Vt!==`native`&&on(Vt)}let cn=()=>Vt===`native`?Nt:Pt;function un(e,t){V(!0),s.environment=ge(),M.visible=!1,r.setRenderTarget(O),r.render(s,e),M.visible=!0,r.setRenderTarget(pt),r.render(s,e),Ot(pt),Z.uniforms.uAces.value=1,Z.uniforms.uGrade.value=1,Z.uniforms.uGrain.value=0,Z.uniforms.uChroma.value=0,Lt(Z,t)}function dn(e,t){let n=!zt&&($===1||$===2);if(V(n),s.environment=n?ge():null,Z.uniforms.uBloomStrength.value=0,M.visible=!1,r.setRenderTarget(O),r.render(s,h.camera),M.visible=!0,$===1&&!n)r.setRenderTarget(t),r.render(s,h.camera);else if($===1)r.setRenderTarget(pt),r.render(s,h.camera),Ot(pt),Z.uniforms.uAces.value=1,Z.uniforms.uGrade.value=1,Z.uniforms.uGrain.value=0,Z.uniforms.uChroma.value=0,Lt(Z,t);else if(r.setRenderTarget(pt),r.render(s,h.camera),$===2)n&&Ot(pt),Z.uniforms.uAces.value=+!!n,Z.uniforms.uGrade.value=+!!n,Z.uniforms.uGrain.value=1,Z.uniforms.uChroma.value=1,Lt(Z,t);else{Z.uniforms.uAces.value=0,Z.uniforms.uGrade.value=0,Z.uniforms.uGrain.value=0,Z.uniforms.uChroma.value=0,Lt(Z,mt);let n=h.camera;Ft.uniforms.uNear.value=n.near,Ft.uniforms.uFar.value=n.far,Ft.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(on(e.era),Pt):cn();e.kind===`pixel`?(Lt(r,t),window.__style=`pixel`):e.kind===`toon`?(Lt(Ft,t),window.__style=`toon`):(Lt(Ft,ht),Lt(r,_t),It.uniforms.uBlend.value=e.blend,Lt(It,t),window.__style=`blend`)}}function fn(){let e=pn(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return j.uniforms.uChromaScale.value=v.lerp(1,.5,t),e}function pn(){if($===1||$===2)return{kind:`none`};if($===7)return{kind:`pixel`};if($===8)return{kind:`toon`};let e=h.styleT;return window.__styleT=e,e<=Ut?{kind:`toon`}:e>=Gt?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:v.smoothstep(e,Ut,Gt),era:`16-bit`}}function hn(e){return $===1||$===2?``:zt&&$!==7&&$!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Jt[e.era||Vt]||`Pixel`:e.kind===`blend`?`Toon → `+(Jt[e.era]||`Pixel`):``}function gn(e,t,{shadowsOn:n=!0,seasonTarget:i=0}={}){if(Qt){let e=r.info;$t={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}A.material.uniforms.uTime.value=t,Z.uniforms.uTime.value=t,g.update(e),I.key.position.copy(g.sunDir).multiplyScalar(24),I.key.color.copy(g.sunColor),I.key.intensity=g.sunIntensity,I.fill.color.copy(g.hemiSky),I.fill.groundColor.copy(g.hemiGround),ne.value=g.windowGlow,de.setSun(g.sunArc),de.setParams(g.skyParams),Z.uniforms.uGradeSat.value=g.grade.sat,Z.uniforms.uGradeContrast.value=g.grade.contrast,s.environmentIntensity=.34*(1-.6*v.clamp(g.sunArc.y*1.5,0,1));let a=R.overcast;I.key.intensity*=1-.5*a,I.key.color.lerp(u,.45*a),I.fill.intensity=1+.7*a;let o=v.smoothstep(g.sunDir.y,.06,.34),c=v.lerp(.28,1,1-g.windowGlow),l=n?o*c:0;I.key.shadow.intensity=.72*l,Ie.value=.52*l,(n&&!rn||tn.distanceToSquared(g.sunDir)>2e-5)&&(r.shadowMap.needsUpdate=!0,tn.copy(g.sunDir)),rn=n;let d=1-g.windowGlow;Fe.setRGB(v.lerp(.46,1,d),v.lerp(.52,1,d),v.lerp(.74,1,d)),Z.uniforms.uExposure.value=g.exposure,Ft.uniforms.uToonGain.value=g.toonGain,r.setClearColor(g.horizon,1),an(g.t),window.__t=g.t,L.update(e,t,g),I.update(t),oe.update(e,t,g),D.uniforms.uWakeCount.value=oe.wakeCount,R.update(e,t),D.uniforms.uRainCount.value=R.rainDropCount;let h=R.fog*(1-d);s.fog.density=R.fog*f,m.copy(g.horizon).lerp(p,.85*h),s.fog.color.copy(m),r.setClearColor(m,1),Be.value=R.fog,A.material.uniforms.uFogAmt.value=.7*R.fog,Le.value=R.snow,Re.value=R.cloud*.55,ze.x+=e*.018,ze.y+=e*.009,Ve.value+=(i-Ve.value)*Math.min(1,e*1.5),z.update(e,t,g,R),xe&&J.update(e,t,g);let _=pn(),b=_.kind===`pixel`||_.kind===`blend`?`pixel`:zt||_.kind===`toon`?`charm`:`realistic`;ue.update(e,t,g,R,b),Xt++;let x=performance.now();x-Zt>=1e3&&(window.__fps=Xt,Qt&&$t&&(console.log(`[perf] ${Xt} fps · ~${(1e3/Math.max(1,Xt)).toFixed(2)} ms · calls ${$t.calls} · tris ${$t.tris} · programs ${$t.programs} · geo ${$t.geo} · tex ${$t.tex}`),window.__perfInfo={fps:Xt,...$t}),Xt=0,Zt=x);let[S,C,w]=y;if(D.uniforms.uPrev.value=S.texture,D.uniforms.uCurr.value=C.texture,r.setRenderTarget(w),r.render(T,E),y=[C,w,S],j.uniforms.uHeight.value=y[1].texture,en<2&&typeof document<`u`&&++en===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function _n(e){$=e,window.__mode=$}function bn(){return zt=!zt,Pe.value=+!!zt,window.__vector=zt,zt}function xn(e){return zt=!!e,Pe.value=+!!zt,window.__vector=zt,zt}function Sn(){return Vt=qt[(qt.indexOf(Vt)+1)%qt.length],window.__era=Vt,sn(),Vt}function Cn(){return Bt=!Bt,Bt}return{updateWorld:gn,decideStyle:fn,renderCityPipeline:dn,renderCityBeautyTo:un,styleHintName:hn,setPostMode:_n,toggleVector:bn,setVector:xn,cycleEra:Sn,togglePalette:Cn,get mode(){return $},get vector(){return zt},get sceneEra(){return Vt},renderer:r,drawBuffer:o,scene:s,rig:h,sunRig:g,SIM:256,targets:y,simScene:T,simCamera:E,simMaterial:D,grabRT:O,card:k,backdrop:A,WATER_SIZE:28,water:M,waterMaterial:j,windowGlow:ne,landmarkFactory:re,city:I,cityLife:L,waterLife:oe,weatherRig:R,clouds:z,inspector:le,world:st,catalog:lt,editor:ut,fitShadowFrustum:dt,SHADOW_DIST:24,sceneDepth:ft,sceneRT:pt,filmicRT:mt,toonRT:ht,pixelRT:_t,postScene:Ct,postCamera:wt,postQuad:Tt,filmicMaterial:Z,pixelMaterial:Nt,pixelkitMaterial:Pt,toonMaterial:Ft,mixMaterial:It,PALCACHE:Mt,ERA_TEX:Q,runPass:Lt,OVERCAST_GREY:u,FOG_DENSITY:f,FOG_NIGHT_TINT:p,_fogColor:m,resize:Rt}}var Hr=`lgr_hints_`,Ur=!1;function Wr(){if(Ur||typeof document>`u`)return;Ur=!0;let e=document.createElement(`style`);e.textContent=`
