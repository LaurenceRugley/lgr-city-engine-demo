import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,Q as _,R as v,S as y,T as b,U as x,V as S,W as C,X as w,Y as T,Z as E,_ as D,a as O,at as k,b as ee,c as A,d as j,et as M,f as N,g as P,h as te,i as ne,it as F,j as I,k as re,l as ie,m as ae,n as oe,nt as se,o as L,ot as ce,p as R,q as z,r as B,rt as V,s as le,t as ue,tt as de,u as H,v as fe,w as U,x as pe,y as me,z as he}from"./three-BoVXBq6m.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var ge=Math.atan(1/Math.SQRT2),_e=Math.atan(.5),ve=Math.PI/4,ye={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},be=.12,xe=1.45,Se=4,Ce=40,we=1.5,Te=16,W=6,G=22,Ee=3.5,De=11,K=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),Oe=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function ke({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new k(0,.8,0),azimuth:a=ve,elevation:o=.52,distance:s=12,zoom:c=5.5}={}){let l=new x(t,e,n,r),u=new S(-1,1,1,-1,n,r),d=ye.PERSPECTIVE,f=e,p={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},m={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},h=!1,_=null,v=new k,y=()=>d===ye.PERSPECTIVE?l:u;function b(e){e!==d&&(d=e,d===ye.ISOMETRIC||d===ye.DIMETRIC?(p.elevation=d===ye.ISOMETRIC?ge:_e,p.azimuth=Oe(ve,m.azimuth),h=!0):h=!1)}function C(e,t){p.azimuth+=e,h||(p.elevation=g.clamp(p.elevation+t,be,xe))}function w(e){d===ye.PERSPECTIVE?p.distance=g.clamp(p.distance*e,Se,Ce):p.zoom=g.clamp(p.zoom*e,we,Te)}function T(e,t){let n=p.azimuth,r=d===ye.PERSPECTIVE?p.distance*.04:p.zoom*.08,i=new k(Math.cos(n),0,-Math.sin(n)),a=new k(-Math.sin(n),0,-Math.cos(n));p.target.addScaledVector(i,e*r),p.target.addScaledVector(a,t*r)}function E(e,t){f=e/t,l.aspect=f,l.updateProjectionMatrix()}function D(e){_&&(_(v),p.target.copy(v)),m.azimuth=K(m.azimuth,p.azimuth,e),m.elevation=K(m.elevation,p.elevation,e),m.distance=K(m.distance,p.distance,e),m.zoom=K(m.zoom,p.zoom,e),m.target.x=K(m.target.x,p.target.x,e),m.target.y=K(m.target.y,p.target.y,e),m.target.z=K(m.target.z,p.target.z,e);let t=Math.cos(m.elevation),n=Math.sin(m.elevation),r=Math.cos(m.azimuth),i=Math.sin(m.azimuth),a=y();if(a.position.set(m.target.x+m.distance*t*i,m.target.y+m.distance*n,m.target.z+m.distance*t*r),a.lookAt(m.target),a.isOrthographicCamera){let e=m.zoom,t=e*f;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function O(e,t,n,r=!1){p.target.set(e,t,n),r&&m.target.copy(p.target)}function ee(e,t=!1){p.zoom=g.clamp(e,we,Te),t&&(m.zoom=p.zoom)}function A(e,{frame:t,snap:n=!1}={}){_=e,n&&(_(v),p.target.copy(v),m.target.copy(v)),t!=null&&(d===ye.PERSPECTIVE?p.distance=g.clamp(t,Se,Ce):p.zoom=g.clamp(t,we,Te))}function j(){_=null}return{get camera(){return y()},get mode(){return d},get azimuth(){return m.azimuth},get following(){return!!_},setTarget:O,setZoom:ee,setFollow:A,clearFollow:j,get styleT(){return d===ye.PERSPECTIVE?g.clamp((m.distance-W)/(G-W),0,1):g.clamp((m.zoom-Ee)/(De-Ee),0,1)},setMode:b,orbit:C,zoomBy:w,pan:T,setViewport:E,update:D}}var Ae={value:0},je=new R(`#ffffff`),Me={value:0},Ne={value:0},Pe={value:0},Fe=new F,Ie={value:0},Le={value:0},q=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
}`,an={realistic:0,charm:0,pixel:2,vector:1},on={realistic:1,charm:1,pixel:1.9,vector:1.2};function sn({seed:e=1517,count:n=340,spreadX:r=21,yLo:i=3,yHi:a=18,zBase:o=7.2}={}){let s=new U;s.raycast=()=>{};let c=Ve(e>>>0),l=new Float32Array(n*3),u=new Float32Array(n),f=new Float32Array(n),p=new Float32Array(n),m=[];for(let e=0;e<n;e++){let t=(c()*2-1)*r,n=i+c()*(a-i),s=-o-c()*.7;l[e*3]=t,l[e*3+1]=n,l[e*3+2]=s;let d=.35+c()*.65;f[e]=d,u[e]=1.6+c()*2.8+(d>.85?2.2:0),p[e]=c()*Math.PI*2,d>.82&&m.push([t,n,s])}let h=new le;h.setAttribute(`position`,new L(l,3)),h.setAttribute(`aSize`,new L(u,1)),h.setAttribute(`aBright`,new L(f,1)),h.setAttribute(`aPhase`,new L(p,1));let g=new _({vertexShader:nn,fragmentShader:rn,uniforms:{uTime:{value:0},uTwinkle:{value:1},uSizeScale:{value:1},uColor:{value:new R(`#eaf0ff`)},uNight:{value:0},uMode:{value:0}},transparent:!0,depthWrite:!1,blending:2,fog:!1,toneMapped:!1}),v=new d(h,g);v.raycast=()=>{},v.frustumCulled=!1,s.add(v);let y=[];if(m.length>6)for(let e=0;e<3;e++){let e=Math.floor(c()*m.length);for(let t=0;t<3;t++){let t=m[e],n=m[(e+1+Math.floor(c()*2))%m.length];y.push(t[0],t[1],t[2],n[0],n[1],n[2]),e=(e+1)%m.length}}let b=[[[0,2],[0,0]],[[0,0],[.7,0]],[[2.1,2],[1.4,2]],[[1.4,2],[1.4,0]],[[1.4,0],[2.1,0]],[[2.1,0],[2.1,1]],[[2.1,1],[1.7,1]],[[2.8,0],[2.8,2]],[[2.8,2],[3.5,2]],[[3.5,2],[3.5,1]],[[3.5,1],[2.8,1]],[[2.8,1],[3.6,0]]],x=-o-.4,S=.62;for(let[[e,t],[n,r]]of b)y.push(-3+e*S,12+t*S,x,-3+n*S,12+r*S,x);let C=new le;C.setAttribute(`position`,new pe(y,3));let w=new I(C,new t({color:`#9fb6e8`,transparent:!0,opacity:0,depthWrite:!1,fog:!1,toneMapped:!1}));w.raycast=()=>{},w.frustumCulled=!1,s.add(w);let T=new de(new se({map:cn(),transparent:!0,opacity:0,depthWrite:!1,blending:2,fog:!1,toneMapped:!1}));T.raycast=()=>{},T.scale.set(r*2.4,r*.95,1),T.position.set(2,12,-o-.7),T.material.rotation=-.5,T.renderOrder=-3,s.add(T);let E=-1;function D(e,t=`realistic`,n=0,r=!1){g.uniforms.uTime.value=n,g.uniforms.uTwinkle.value=+!r,g.uniforms.uNight.value=e;let i=an[t]??0;i!==E&&(g.uniforms.uMode.value=i,E=i),g.uniforms.uSizeScale.value=on[t]??1,w.material.opacity=e*.5,T.material.opacity=e*.32,s.visible=e>.001}return{group:s,update:D}}function cn(){let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(256/2,256/2,0,256/2,256/2,256/2);n.addColorStop(0,`rgba(150,170,230,0.5)`),n.addColorStop(.4,`rgba(120,130,200,0.22)`),n.addColorStop(1,`rgba(90,100,160,0)`),t.fillStyle=n,t.fillRect(0,0,256,256);let r=Ve(20145);for(let e=0;e<7;e++){let e=40+r()*176,n=70+r()*116,i=14+r()*30,a=t.createRadialGradient(e,n,0,e,n,i);a.addColorStop(0,`rgba(200,210,255,0.18)`),a.addColorStop(1,`rgba(200,210,255,0)`),t.fillStyle=a,t.beginPath(),t.arc(e,n,i,0,Math.PI*2),t.fill()}let i=new A(e);return i.colorSpace=w,i}var ln=Math.PI*2;function un(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=n.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return r.addColorStop(0,`#ffffff`),r.addColorStop(.34,`#fffaf0`),r.addColorStop(.66,e),r.addColorStop(.86,e),r.addColorStop(1,`rgba(255,255,255,0)`),n.fillStyle=r,n.beginPath(),n.arc(128/2,128/2,128/2,0,ln),n.fill(),_n(t,!0)}function dn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);n.addColorStop(0,`#ffffff`),n.addColorStop(.4,`#eef3ff`),n.addColorStop(.82,`#c4cee6`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,ln),t.fill(),t.globalAlpha=.14,t.fillStyle=`#8b97b4`;for(let[e,n,r]of[[54,50,9],[78,66,7],[60,82,5]])t.beginPath(),t.arc(e,n,r,0,ln),t.fill();return _n(e,!0)}function fn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`);t.translate(128/2,128/2),t.fillStyle=`rgba(255,210,120,0.9)`;for(let e=0;e<12;e++)t.rotate(ln/12),t.beginPath(),t.moveTo(0,-28),t.lineTo(7,-54),t.lineTo(-7,-54),t.closePath(),t.fill();let n=t.createRadialGradient(0,0,0,0,0,32);return n.addColorStop(0,`#ffffff`),n.addColorStop(.4,`#fff1c8`),n.addColorStop(.8,`#ffb24a`),n.addColorStop(1,`#ff8a2a`),t.fillStyle=n,t.beginPath(),t.arc(0,0,32,0,ln),t.fill(),_n(e,!0)}function pn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,46);n.addColorStop(0,`#ffffff`),n.addColorStop(.5,`#e6ecfb`),n.addColorStop(1,`#c2cce4`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,46,0,ln),t.fill(),t.fillStyle=`#aab6d2`;for(let[e,n,r]of[[52,48,11],[80,62,8],[58,82,7],[40,66,5]])t.beginPath(),t.arc(e,n,r,0,ln),t.fill();return _n(e,!0)}function mn(e,t,n){let r=document.createElement(`canvas`);r.width=r.height=144;let i=r.getContext(`2d`),a=17/2,o=18/2-.5;for(let r=0;r<18;r++)for(let s=0;s<18;s++){let c=Math.hypot(s-a,r-a);c>o||(i.fillStyle=c<o*.45?e:c<o*.78?t:n,i.fillRect(Math.round(s*8),Math.round(r*8),8,8))}return _n(r,!1)}function hn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(255,255,255,0.9)`),n.addColorStop(.38,`rgba(255,255,255,0.3)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,ln),t.fill(),_n(e,!0)}function gn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2),r=`20,30,48`;return n.addColorStop(0,`rgba(${r},0)`),n.addColorStop(.42,`rgba(${r},0)`),n.addColorStop(.6,`rgba(${r},0.6)`),n.addColorStop(1,`rgba(${r},0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,ln),t.fill(),_n(e,!0)}function _n(e,t){let n=new A(e);return n.colorSpace=w,t||(n.magFilter=he,n.minFilter=he),n}var vn=(e,t,n)=>{let r=Math.max(0,Math.min(1,(e-t)/(n-t)));return r*r*(3-2*r)};function yn({skyW:e=15,skyY0:t=3.4,skyH:n=3.8,z:r=-7.8,biasX:i=4.5,sunSize:a=4.6,moonSize:o=4}={}){let s=new U;s.raycast=()=>{};let c=(e,t)=>{let n=new de(new se({map:e,transparent:!0,depthWrite:!1,fog:!1,toneMapped:!1,...t?{blending:2}:{}}));return n.raycast=()=>{},n},l={realistic:un(`#ffcf8a`),charm:fn(),pixel:mn(`#fff6e0`,`#ffc24a`,`#ff8a2a`)},u={realistic:dn(),charm:pn(),pixel:mn(`#ffffff`,`#cdd6ee`,`#9aa6c6`)},d=hn(),f=c(gn(),!1),p=c(d,!0),m=c(l.realistic),h=c(d,!0),g=c(u.realistic);f.renderOrder=-2,p.renderOrder=-1,s.add(f,p,m,h,g);let _=sn({});_.group.renderOrder=-4,s.add(_.group);let v=typeof window<`u`&&window.matchMedia?window.matchMedia(`(prefers-reduced-motion: reduce)`):null,y={realistic:{sunGlow:3,sunGlowOp:.7,moonGlow:2.6,moonGlowOp:.5,sizeMul:1,sunHaloOp:.85},charm:{sunGlow:2.2,sunGlowOp:.55,moonGlow:2.1,moonGlowOp:.42,sizeMul:1.08,sunHaloOp:.7},pixel:{sunGlow:1.7,sunGlowOp:.4,moonGlow:1.7,moonGlowOp:.32,sizeMul:1,sunHaloOp:.6}},b=`realistic`;function x(e){e===b||!y[e]||(b=e,m.material.map=l[e],m.material.needsUpdate=!0,g.material.map=u[e],g.material.needsUpdate=!0)}new R;let S=new R(`#fff3df`),C=new R(`#ffb060`),w=new R(`#ff6a2a`),T=new R(`#eef2ff`),E=new R(`#9fbcff`);function D(s,c,l,u,d=`realistic`){x(d);let D=y[b],O=l.sunArc,k=u?Math.min(1,(u.cloud||0)*.85+(u.fog||0)*.7):0,ee=O.y,A=vn(ee,-.04,.1)*(1-.7*k),j=1-vn(Math.abs(ee),.02,.5);m.position.set(O.x*e+i,t+O.y*n,r),p.position.copy(m.position);let M=a*D.sizeMul*(1+.55*j);m.scale.setScalar(M),p.scale.setScalar(M*D.sunGlow),m.material.color.copy(S),p.material.color.copy(C).lerp(w,j),m.material.opacity=A,p.material.opacity=A*D.sunGlowOp*(.7+.5*j),f.position.copy(m.position),f.scale.setScalar(M*1.7),f.material.opacity=A*(1-j)*D.sunHaloOp;let N=vn(-O.y,-.04,.1)*(1-.65*k);g.position.set(-O.x*e+i,t+-O.y*n,r),h.position.copy(g.position);let P=o*D.sizeMul;g.scale.setScalar(P),h.scale.setScalar(P*D.moonGlow),g.material.color.copy(T),h.material.color.copy(E),g.material.opacity=N,h.material.opacity=N*D.moonGlowOp;let te=vn(-O.y,-.05,.18)*(1-.85*k);_.update(te,d,c,!!(v&&v.matches))}return{group:s,update:D}}var bn=`varying vec2 vUv;
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,jn={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Mn=[`gb`,`8-bit`,`16-bit`,`modern`];function Nn(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new R(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new P(n,t,1,u,y);return r.minFilter=he,r.magFilter=he,r.needsUpdate=!0,r}var Pn=220,Fn={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},In={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Ln({demo:e=!1,citySeed:t=0,profileIndex:n=0}={}){let i=new oe({antialias:!0,preserveDrawingBuffer:!0});i.shadowMap.enabled=!0,i.shadowMap.type=1,i.shadowMap.autoUpdate=!1,i.shadowMap.needsUpdate=!0;let a=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);i.setPixelRatio(Math.min(window.devicePixelRatio,a?1.5:2)),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(920327,1),document.body.appendChild(i.domElement);let c=i.getDrawingBufferSize(new F),d=new E;d.fog=new r(10465470,0);let m=new R(`#aeb6c0`),h=.062,v=new R(`#74508f`),y=new R,x=ke({aspect:window.innerWidth/window.innerHeight}),C=ct({t:.5}),T={type:b,format:u,minFilter:he,magFilter:he,wrapS:N,wrapT:N,depthBuffer:!1,stencilBuffer:!1},O=[new ce(256,256,T),new ce(256,256,T),new ce(256,256,T)];for(let e of O)i.setRenderTarget(e),i.clear();i.setRenderTarget(null);let ee=new E,j=new S(-1,1,1,-1,0,1),M=new _({vertexShader:Sn,fragmentShader:Cn,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new F(1/256,1/256)},uMouse:{value:new F(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new k)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new k)}}});ee.add(new l(new s(2,2),M));let P=new ce(c.x,c.y,{minFilter:p,magFilter:p,depthBuffer:!0,stencilBuffer:!1});function te(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new A(t);return r.colorSpace=w,r}let ne=new l(new s(28,28),new f({map:te(e)}));ne.rotation.x=-Math.PI/2,ne.position.y=-.35,d.add(ne);let I=new l(new s(40,24),new _({depthWrite:!1,vertexShader:bn,fragmentShader:xn,uniforms:{uTime:{value:0},uInk:{value:C.horizon},uGold:{value:C.sky},uFogColor:{value:y},uFogAmt:{value:0},uFogCharm:Ie}}));I.position.set(0,3,-8),d.add(I);let re=new _({vertexShader:wn,fragmentShader:Tn,uniforms:{uHeight:{value:null},uScene:{value:P.texture},uTexel:{value:new F(1/256,1/256)},uResolution:{value:new F(c.x,c.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new o},uLightDir:{value:C.sunDir},uInk:{value:new R(`#2A2218`)},uGold:{value:new R(`#B89968`)},uVector:Ae,uVecWater:{value:new R(`#1fb8d8`)},uVecTint:{value:je}}}),ie=new l(new s(28,28,255,255),re);ie.rotation.x=-Math.PI/2,ie.updateMatrixWorld(!0),re.uniforms.uNormalMatrix.value.getNormalMatrix(ie.matrixWorld),d.add(ie);let ae={value:0},se=It({windowGlow:ae}),L=et({seed:t,profileIndex:n,landmarkFactory:se,windowGlow:ae});d.add(L.group);let z=pt({plinthTop:.3,extent:L.extent,profile:L.state.profile});d.add(z.group);let B=wt({extent:L.extent,waterSize:28,plinthTop:.3});d.add(B.group),M.uniforms.uWakeDrops.value=B.wakeDrops;let V=Rt({extent:L.extent});d.add(V.group),M.uniforms.uRainDrops.value=V.rainDrops;let le=Bt({extent:L.extent});d.add(le.group);let ue=Ut({rig:x,getCamera:()=>x.camera,sources:[z,B,le]}),de=yn();d.add(de.group);let H=null,fe=!1,U=1234,pe=`valley`,me=()=>[L.group,z.group,B.group];function ge(){H&&(d.remove(H),H.userData.dispose?.()),H=tn(en({seed:U,size:160,preset:pe}),{worldSize:26,baseY:0,chunks:6}),H.visible=fe,d.add(H),typeof window<`u`&&(window.__world={seed:U,preset:pe,active:fe,chunks:H.children.length})}let _e={enter(){H||ge(),fe=!0,H.visible=!0;for(let e of me())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){fe=!1,H&&(H.visible=!1);for(let e of me())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return U=Math.random()*1e9|0,ge(),_e.enter(),U},setPreset(e){return $t.includes(e)&&(pe=e,ge(),_e.enter()),pe},get active(){return fe},get seed(){return U},get preset(){return pe},get presets(){return $t}};L.group.remove(L.key),d.add(L.key),L.key.castShadow=!0,L.key.shadow.mapSize.set(2048,2048),L.key.shadow.bias=-18e-5,L.key.shadow.normalBias=.028,d.add(L.key.target);function ve(){let e=L.key.shadow.camera,t=L.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),i.shadowMap.needsUpdate=!0}ve();let ye=new D(c.x,c.y),be=new ce(c.x,c.y,{minFilter:p,magFilter:p,depthBuffer:!0,stencilBuffer:!1,depthTexture:ye}),xe=new ce(c.x,c.y,{minFilter:p,magFilter:p,depthBuffer:!1,stencilBuffer:!1}),Se=new ce(c.x,c.y,{minFilter:p,magFilter:p,depthBuffer:!1,stencilBuffer:!1}),Ce=new ce(c.x,c.y,{minFilter:p,magFilter:p,depthBuffer:!1,stencilBuffer:!1}),we=new E,Te=new S(-1,1,1,-1,0,1),W=new l(new s(2,2));we.add(W);let G=new _({vertexShader:Sn,fragmentShader:En,uniforms:{uScene:{value:be.texture},uTime:{value:0},uResolution:{value:new F(c.x,c.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),Ee=e=>{let t=e.map(e=>new R(e));for(;t.length<8;)t.push(new R(0,0,0));return t},De=[`night`,`dawn`,`noon`,`dusk`],K={inkgold:De.map(e=>Ee(Fn[e])),terminal:De.map(e=>Ee(In[e]))},Oe=new _({vertexShader:Sn,fragmentShader:Dn,uniforms:{uScene:{value:xe.texture},uResolution:{value:new F(c.x,c.y)},uPixelSize:{value:Pn},uPalette:{value:K.inkgold[2]},uPaletteB:{value:K.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),q=new _({vertexShader:Sn,fragmentShader:An,uniforms:{uScene:{value:xe.texture},uResolution:{value:new F(c.x,c.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Nn(jn[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),J={};for(let e of Mn)J[e]=jn[e].palette?Nn(jn[e].palette):null;let Y=new _({vertexShader:Sn,fragmentShader:On,uniforms:{uScene:{value:xe.texture},uDepth:{value:ye},uResolution:{value:new F(c.x,c.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:C.toonFloor},uOutline:{value:C.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Re=new _({vertexShader:Sn,fragmentShader:kn,uniforms:{uToon:{value:Se.texture},uPixel:{value:Ce.texture},uBlend:{value:0}}});function ze(e,t){W.material=e,i.setRenderTarget(t),i.render(we,Te)}function Be(){x.setViewport(window.innerWidth,window.innerHeight),i.setSize(window.innerWidth,window.innerHeight);let e=i.getDrawingBufferSize(new F);return P.setSize(e.x,e.y),be.setSize(e.x,e.y),xe.setSize(e.x,e.y),Se.setSize(e.x,e.y),Ce.setSize(e.x,e.y),re.uniforms.uResolution.value.set(e.x,e.y),G.uniforms.uResolution.value.set(e.x,e.y),Oe.uniforms.uResolution.value.set(e.x,e.y),q.uniforms.uResolution.value.set(e.x,e.y),Y.uniforms.uResolution.value.set(e.x,e.y),e}let X=3,Z=!1,Ve=!1,He=`native`,Ue=.3,We=.46,Ge=[`native`,...Mn],Ke={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=X,window.__vector=Z,window.__era=He);let qe=0,Je=performance.now(),Ye=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=Ye),Ye&&(i.info.autoReset=!1);let Xe=null;typeof window<`u`&&(window.__loaded=!1);let Q=0,Ze=new k(1,1,1),Qe=!1;function $e(e){let t=Ve?K.terminal:K.inkgold,n=e%1*4,r=Math.floor(n)%4;Oe.uniforms.uPalette.value=t[r],Oe.uniforms.uPaletteB.value=t[(r+1)%4],Oe.uniforms.uPaletteBlend.value=n-Math.floor(n)}function tt(e){let t=jn[e];t&&(q.uniforms.uGridWidth.value=t.gridWidth,q.uniforms.uDither.value=t.dither,q.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(q.uniforms.uPalette.value=J[e],q.uniforms.uPaletteSize.value=t.palette.length))}function nt(){He!==`native`&&tt(He)}let rt=()=>He===`native`?Oe:q;function it(e,t){ie.visible=!1,i.setRenderTarget(P),i.render(d,e),ie.visible=!0,i.setRenderTarget(t),i.render(d,e)}function at(e,t){if(ie.visible=!1,i.setRenderTarget(P),i.render(d,x.camera),ie.visible=!0,X===1)i.setRenderTarget(t),i.render(d,x.camera);else if(i.setRenderTarget(be),i.render(d,x.camera),X===2)G.uniforms.uGrain.value=1,G.uniforms.uChroma.value=1,ze(G,t);else{G.uniforms.uGrain.value=0,G.uniforms.uChroma.value=0,ze(G,xe);let n=x.camera;Y.uniforms.uNear.value=n.near,Y.uniforms.uFar.value=n.far,Y.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(tt(e.era),q):rt();e.kind===`pixel`?(ze(r,t),window.__style=`pixel`):e.kind===`toon`?(ze(Y,t),window.__style=`toon`):(ze(Y,Se),ze(r,Ce),Re.uniforms.uBlend.value=e.blend,ze(Re,t),window.__style=`blend`)}}function ot(){let e=st(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return re.uniforms.uChromaScale.value=g.lerp(1,.5,t),e}function st(){if(X===1||X===2)return{kind:`none`};if(X===7)return{kind:`pixel`};if(X===8)return{kind:`toon`};let e=x.styleT;return window.__styleT=e,e<=Ue?{kind:`toon`}:e>=We?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:g.smoothstep(e,Ue,We),era:`16-bit`}}function lt(e){return X===1||X===2?``:Z&&X!==7&&X!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Ke[e.era||He]||`Pixel`:e.kind===`blend`?`Toon → `+(Ke[e.era]||`Pixel`):``}function ut(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){if(Ye){let e=i.info;Xe={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}I.material.uniforms.uTime.value=t,G.uniforms.uTime.value=t,C.update(e),L.key.position.copy(C.sunDir).multiplyScalar(24),L.key.color.copy(C.sunColor),L.key.intensity=C.sunIntensity,L.fill.color.copy(C.hemiSky),L.fill.groundColor.copy(C.hemiGround),ae.value=C.windowGlow;let a=V.overcast;L.key.intensity*=1-.5*a,L.key.color.lerp(m,.45*a),L.fill.intensity=1+.7*a;let o=g.smoothstep(C.sunDir.y,.06,.34),s=g.lerp(.28,1,1-C.windowGlow),c=n?o*s:0;L.key.shadow.intensity=.72*c,Me.value=.52*c,(n&&!Qe||Ze.distanceToSquared(C.sunDir)>2e-5)&&(i.shadowMap.needsUpdate=!0,Ze.copy(C.sunDir)),Qe=n;let l=1-C.windowGlow;je.setRGB(g.lerp(.46,1,l),g.lerp(.52,1,l),g.lerp(.74,1,l)),G.uniforms.uExposure.value=C.exposure,Y.uniforms.uToonGain.value=C.toonGain,i.setClearColor(C.horizon,1),$e(C.t),window.__t=C.t,z.update(e,t,C),L.update(t),B.update(e,t,C),M.uniforms.uWakeCount.value=B.wakeCount,V.update(e,t),M.uniforms.uRainCount.value=V.rainDropCount;let u=V.fog*(1-l);d.fog.density=V.fog*h,y.copy(C.horizon).lerp(v,.85*u),d.fog.color.copy(y),i.setClearColor(y,1),Ie.value=V.fog,I.material.uniforms.uFogAmt.value=.7*V.fog,Ne.value=V.snow,Pe.value=V.cloud*.55,Fe.x+=e*.018,Fe.y+=e*.009,Le.value+=(r-Le.value)*Math.min(1,e*1.5),le.update(e,t,C,V);let f=st(),p=f.kind===`pixel`||f.kind===`blend`?`pixel`:Z||f.kind===`toon`?`charm`:`realistic`;de.update(e,t,C,V,p),qe++;let _=performance.now();_-Je>=1e3&&(window.__fps=qe,Ye&&Xe&&(console.log(`[perf] ${qe} fps · ~${(1e3/Math.max(1,qe)).toFixed(2)} ms · calls ${Xe.calls} · tris ${Xe.tris} · programs ${Xe.programs} · geo ${Xe.geo} · tex ${Xe.tex}`),window.__perfInfo={fps:qe,...Xe}),qe=0,Je=_);let[b,x,S]=O;if(M.uniforms.uPrev.value=b.texture,M.uniforms.uCurr.value=x.texture,i.setRenderTarget(S),i.render(ee,j),O=[x,S,b],re.uniforms.uHeight.value=O[1].texture,Q<2&&typeof document<`u`&&++Q===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function dt(e){X=e,window.__mode=X}function ft(){return Z=!Z,Ae.value=+!!Z,window.__vector=Z,Z}function mt(e){return Z=!!e,Ae.value=+!!Z,window.__vector=Z,Z}function ht(){return He=Ge[(Ge.indexOf(He)+1)%Ge.length],window.__era=He,nt(),He}function gt(){return Ve=!Ve,Ve}return{updateWorld:ut,decideStyle:ot,renderCityPipeline:at,renderCityBeautyTo:it,styleHintName:lt,setPostMode:dt,toggleVector:ft,setVector:mt,cycleEra:ht,togglePalette:gt,get mode(){return X},get vector(){return Z},get sceneEra(){return He},renderer:i,drawBuffer:c,scene:d,rig:x,sunRig:C,SIM:256,targets:O,simScene:ee,simCamera:j,simMaterial:M,grabRT:P,card:ne,backdrop:I,WATER_SIZE:28,water:ie,waterMaterial:re,windowGlow:ae,landmarkFactory:se,city:L,cityLife:z,waterLife:B,weatherRig:V,clouds:le,inspector:ue,world:_e,fitShadowFrustum:ve,SHADOW_DIST:24,sceneDepth:ye,sceneRT:be,filmicRT:xe,toonRT:Se,pixelRT:Ce,postScene:we,postCamera:Te,postQuad:W,filmicMaterial:G,pixelMaterial:Oe,pixelkitMaterial:q,toonMaterial:Y,mixMaterial:Re,PALCACHE:K,ERA_TEX:J,runPass:ze,OVERCAST_GREY:m,FOG_DENSITY:h,FOG_NIGHT_TINT:v,_fogColor:y,resize:Be}}var Rn=`lgr_hints_`,zn=!1;function Bn(){if(zn||typeof document>`u`)return;zn=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  @media (prefers-reduced-motion: reduce) {
  ...
  }`,document.head.appendChild(e)}function Vn({key:e,title:t=`Tips`,tips:n=[],force:r=!1}={}){let i={key:e,shown:!1,dismissed:!1,seen:!1};if(typeof window<`u`&&(window.__hints=i),typeof document>`u`||!e)return{dismiss(){},el:null};let a=Rn+e,o=!1;try{o=localStorage.getItem(a)===`1`}catch{}if(o&&!r)return i.seen=!0,{dismiss(){},el:null};Bn();let s=!!(window.matchMedia&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches),c=document.createElement(`div`);c.className=`lgr-hints`,c.innerHTML=`<div class="lgr-hints-card">
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var Hn=new Set([`w`,`a`,`s`,`d`,`arrowup`,`arrowdown`,`arrowleft`,`arrowright`,`shift`,` `]),Un={walker:{p:.6,hp:26,speed:.85,dmg:9,score:10,size:1,color:`#6f8a45`},runner:{p:.25,hp:12,speed:1.75,dmg:7,score:16,size:.82,color:`#a6d24c`},tank:{p:.15,hp:95,speed:.5,dmg:20,score:34,size:1.5,color:`#39492a`}};function Wn(){let e=Math.random();return e<Un.walker.p?`walker`:e<Un.walker.p+Un.runner.p?`runner`:`tank`}var Gn=new R(`#ffffff`),Kn=new R(`#d83a2a`),qn={food:{name:`Food`,glyph:`🍖`,color:`#c8782e`,consumable:!0},water:{name:`Water`,glyph:`💧`,color:`#3aa6dc`,consumable:!0},bandage:{name:`Bandage`,glyph:`➕`,color:`#e8e2d6`,consumable:!0},scrap:{name:`Scrap`,glyph:`⚙️`,color:`#8a8f96`,consumable:!1},medkit:{name:`Medkit`,glyph:`✚`,color:`#e0524a`,consumable:!0},repairkit:{name:`Repair Kit`,glyph:`🔧`,color:`#caa05a`,consumable:!0}},Jn=[{out:`medkit`,need:{bandage:2}},{out:`repairkit`,need:{scrap:3}}];function Yn({extent:e=8,plinthTop:r=.3}={}){let a=new U;a.visible=!1,a.raycast=()=>{};let o=r+.02,s=Math.max(3,e-.7),c=typeof window<`u`&&window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,u=1.25,d=4.4,p=1.4,m=new U,h=new l(new ie(.16,.34,4,10),Z(new v({color:`#3f7fd0`,roughness:.6,flatShading:!0}),{color:`#3f7fd0`}));h.position.y=.33;let _=new l(new M(.13,12,9),Z(new v({color:`#e9caa1`,roughness:.75,flatShading:!0}),{color:`#e9caa1`}));_.position.y=.66;let y=new l(new O(.1,.1,.16),Z(new v({color:`#ffd54a`,roughness:.5,flatShading:!0}),{color:`#ffd54a`}));y.position.set(0,.38,.18),m.add(h,_,y),m.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!1),e.raycast=()=>{}}),m.scale.setScalar(1.6),m.position.y=o,a.add(m);let b=new l(new j(.95,16,-.9,1.8),new f({color:`#ffe08a`,transparent:!0,opacity:0,depthWrite:!1,side:2}));b.rotation.x=-Math.PI/2,b.position.y=o+.06,b.raycast=()=>{},a.add(b);let x=new le().setFromPoints([new k,new k]),S=new re(x,new t({color:`#fff3c0`,transparent:!0,opacity:0,depthWrite:!1}));S.raycast=()=>{},a.add(S);let C={x:0,z:0,vx:0,vz:0,hp:100,stamina:100,hunger:100,thirst:100,facing:0,iframe:0},w=new i(new ie(.15,.3,4,8),Z(new v({roughness:.85,flatShading:!0})),48);w.castShadow=!0,w.receiveShadow=!1,w.frustumCulled=!1,w.raycast=()=>{},w.instanceMatrix.setUsage(me),a.add(w);let T=[];for(let e=0;e<48;e++)T.push({x:0,z:0,vx:0,vz:0,alive:!1,in:!1,type:`walker`,hp:1,maxhp:1,speed:1,dmg:0,score:0,size:1,phase:0,flash:0});let E=new R,D=[],ee=Z(new v({color:`#7a5a36`,roughness:.9,flatShading:!0}),{color:`#7a5a36`});for(let e=0;e<8;e++){let t=e/8*Math.PI*2,n=new l(new O(2.1,.7,.24),ee.clone());n.position.set(Math.cos(t)*d,o+.35,Math.sin(t)*d),n.rotation.y=-t+Math.PI/2,n.castShadow=!0,n.raycast=()=>{},a.add(n),D.push({mesh:n,ang:t,hp:150,alive:!0,baseColor:new R(`#7a5a36`)})}function A(e,t){let n=Math.atan2(t,e);return n<0&&(n+=Math.PI*2),D[Math.round(n/(Math.PI*2/8))%8]}let N=[];for(let e=0;e<14;e++){let e=new l(new O(.26,.26,.26),Z(new v({roughness:.6,flatShading:!0})));e.castShadow=!0,e.visible=!1,e.raycast=()=>{},a.add(e),N.push({mesh:e,x:0,z:0,kind:`food`,active:!1})}let P=new R;function te(){let e=Math.random();return e<.36?`food`:e<.72?`water`:e<.88?`bandage`:`scrap`}function ne(e,t,n){let r=N.find(e=>!e.active);r&&(r.x=e,r.z=t,r.kind=n||te(),r.active=!0,r.mesh.position.set(e,o+.18,t),r.mesh.visible=!0,r.mesh.material.color.copy(P.set(qn[r.kind].color)))}let F=[];function I(e){let t=F.find(t=>t.id===e);return t?t.n:0}function ae(e,t=1){let n=F.find(t=>t.id===e);return n?(n.n+=t,!0):F.length<8?(F.push({id:e,n:t}),!0):!1}function oe(e,t){let n=F.find(t=>t.id===e);return!n||n.n<t?!1:(n.n-=t,n.n<=0&&F.splice(F.indexOf(n),1),!0)}function se(e){if(I(e)<=0)return!1;if(e===`food`)C.hunger=Math.min(100,C.hunger+38);else if(e===`water`)C.thirst=Math.min(100,C.thirst+38);else if(e===`bandage`)C.hp=Math.min(100,C.hp+40);else if(e===`medkit`)C.hp=Math.min(100,C.hp+90);else if(e===`repairkit`){let e=null;for(let t of D)(!e||t.hp<e.hp)&&(e=t);e&&(e.hp=150,e.alive=!0)}else return!1;return oe(e,1),Ue(),!0}function L(e){for(let t in e.need)if(I(t)<e.need[t])return!1;for(let t in e.need)oe(t,e.need[t]);return ae(e.out,1),Ue(),!0}let ce=!1,z=!1,B=1,V=0,ue=0,de=0,H=`spawning`,fe=0,pe=0,he=0,ge=0,_e=!1,ve=null;function ye(){for(let e=0;e<48;e++)if(!T[e].alive)return T[e];return null}function be(e){let t=ye();if(!t)return;let n=Un[Wn()];t.type=Object.keys(Un).find(e=>Un[e]===n)||`walker`;let r=Math.random()*Math.PI*2;t.x=Math.cos(r)*s,t.z=Math.sin(r)*s,t.vx=0,t.vz=0;let i=1+B*.08;t.maxhp=n.hp*i,t.hp=t.maxhp,t.speed=n.speed*(1+.4*e)*(1+B*.015)*(B===1?.85:1),t.dmg=n.dmg,t.score=n.score,t.size=n.size,t.phase=Math.random()*6.28,t.flash=0,t.in=!1,t.alive=!0}function xe(){let e=null,t=1/0;for(let n of T){if(!n.alive)continue;let r=(n.x-C.x)**2+(n.z-C.z)**2;r<t&&(t=r,e=n)}return e}function Se(e){e.alive=!1,V++,ue+=e.score,Math.random()<.3&&ne(e.x,e.z)}function Ce(e,t){e.hp-=t,e.flash=.12,e.hp<=0&&Se(e)}function we(){if(z||he>0)return;he=.16;let e,t;if(ve)e=ve.x-C.x,t=ve.z-C.z;else{let n=xe();n?(e=n.x-C.x,t=n.z-C.z):(e=Math.sin(C.facing),t=Math.cos(C.facing))}let n=Math.hypot(e,t)||1;e/=n,t/=n,C.facing=Math.atan2(e,t);let r=null,i=1/0;for(let n of T){if(!n.alive)continue;let a=n.x-C.x,o=n.z-C.z,s=a*e+o*t;s<0||s>9||Math.abs(a*t-o*e)<.7*(.4+.6*n.size)&&s<i&&(i=s,r=n)}let a=r?i:9,s=x.attributes.position;s.setXYZ(0,C.x,o+.5,C.z),s.setXYZ(1,C.x+e*a,o+.5,C.z+t*a),s.needsUpdate=!0,S.material.opacity=.95,r&&Ce(r,16)}function Te(){if(z||ge>0)return;ge=.42,b.material.opacity=.85;let e=Math.sin(C.facing),t=Math.cos(C.facing);for(let n of T){if(!n.alive)continue;let r=n.x-C.x,i=n.z-C.z,a=Math.hypot(r,i);a>1.05+n.size*.2||(r*e+i*t)/(a||1)>.2&&Ce(n,34)}}let W={},G={x:0,y:0};function Ee(e,t){if(!ce)return;let n=e.key.toLowerCase();if(t&&n===`i`){e.stopImmediatePropagation(),Ke();return}if(t&&n===`escape`&&Y){e.stopImmediatePropagation(),Ge();return}if(Hn.has(n)){if(e.stopImmediatePropagation(),n.startsWith(`arrow`)&&e.preventDefault(),n===` `){t&&Te();return}W[n]=t}}typeof window<`u`&&(window.addEventListener(`keydown`,e=>Ee(e,!0)),window.addEventListener(`keyup`,e=>Ee(e,!1)));let De=null,K=null,Oe=null,ke=null,Ae=null,je=null,Me=null,Ne=null,Pe=null,Fe=null,Ie=null,Le=null,q=null,J=null,Y=!1;if(typeof document<`u`){let e=document.createElement(`style`);e.textContent=`
    ...
    `,document.head.appendChild(e),De=document.createElement(`div`),De.className=`hoard-stick`,K=document.createElement(`div`),K.className=`knob`,De.appendChild(K),document.body.appendChild(De);let t=!1,n=e=>{let t=De.getBoundingClientRect(),n=e.clientX-(t.left+t.width/2),r=e.clientY-(t.top+t.height/2),i=Math.hypot(n,r)||1;i>44&&(n*=44/i,r*=44/i),K.style.transform=`translate(${n}px,${r}px)`,G.x=n/44,G.y=-r/44};De.addEventListener(`pointerdown`,e=>{t=!0,De.setPointerCapture(e.pointerId),n(e)}),De.addEventListener(`pointermove`,e=>{t&&n(e)});let r=()=>{t=!1,G.x=0,G.y=0,K.style.transform=`translate(0,0)`};De.addEventListener(`pointerup`,r),De.addEventListener(`pointercancel`,r),Ie=document.createElement(`button`),Ie.className=`hoard-btn hoard-fire`,Ie.textContent=`FIRE`,document.body.appendChild(Ie),Le=document.createElement(`button`),Le.className=`hoard-btn hoard-melee`,Le.textContent=`MELEE`,document.body.appendChild(Le),Ie.addEventListener(`pointerdown`,e=>{e.preventDefault(),navigator.vibrate?.(12),_e=!0}),Ie.addEventListener(`pointerup`,()=>{_e=!1}),Ie.addEventListener(`pointercancel`,()=>{_e=!1}),Le.addEventListener(`pointerdown`,e=>{e.preventDefault(),navigator.vibrate?.(18),Te()}),Oe=document.createElement(`div`),Oe.className=`hoard-hud`,Oe.innerHTML=`HP<div class="bar"><i style="background:#e0524a"></i></div>STAMINA<div class="bar"><i style="background:#4ad08a"></i></div>HUNGER<div class="bar"><i style="background:#d89a3a"></i></div>THIRST<div class="bar"><i style="background:#3aa6dc"></i></div><div class="stat"></div>`,document.body.appendChild(Oe);let i=Oe.querySelectorAll(`i`);ke=i[0],Ae=i[1],je=i[2],Me=i[3],Ne=Oe.querySelector(`.stat`),Pe=document.createElement(`div`),Pe.className=`hoard-banner`,document.body.appendChild(Pe),Fe=document.createElement(`div`),Fe.className=`hoard-death`,Fe.innerHTML=`<h2>YOU DIED</h2><div class="ds"></div><button>RESTART</button>`,document.body.appendChild(Fe),Fe.querySelector(`button`).addEventListener(`click`,()=>Ye());let a=document.createElement(`style`);a.textContent=`
    ...
    `,document.head.appendChild(a),q=document.createElement(`button`),q.className=`hoard-bagbtn`,q.textContent=`🎒`,q.title=`Inventory (I)`,document.body.appendChild(q),q.addEventListener(`click`,()=>Ke()),J=document.createElement(`div`),J.className=`hoard-bag`,document.body.appendChild(J)}let Re=0;function ze(e,t=1.8){Pe&&(Pe.textContent=e,Pe.style.display=`block`),Re=t}let Be=Math.PI/4;function X(e){Be=e}function Ve(e,t){ve={x:e,z:t}}function He(e){_e=e}function Ue(){if(typeof window<`u`&&(window.__hoardBag=Object.fromEntries(F.map(e=>[e.id,e.n]))),!J)return;let e=`<div class="panel"><h3>INVENTORY</h3><div class="slots">`;for(let t=0;t<8;t++){let n=F[t];n?e+=`<button class="slot" data-id="${n.id}" title="${qn[n.id].name}">${qn[n.id].glyph}<span class="n">${n.n}</span></button>`:e+=`<div class="slot empty"></div>`}e+=`</div><div class="craft">`,Jn.forEach((t,n)=>{let r=Object.keys(t.need).every(e=>I(e)>=t.need[e]),i=Object.entries(t.need).map(([e,t])=>`${t}${qn[e].glyph}`).join(`+`);e+=`<button data-rec="${n}" ${r?``:`disabled`}>Craft ${qn[t.out].name} (${i})</button>`}),e+=`</div><button class="close">CLOSE (I)</button></div>`,J.innerHTML=e,J.querySelectorAll(`.slot[data-id]`).forEach(e=>e.addEventListener(`click`,()=>{qn[e.dataset.id].consumable&&se(e.dataset.id)})),J.querySelectorAll(`[data-rec]`).forEach(e=>e.addEventListener(`click`,()=>L(Jn[+e.dataset.rec]))),J.querySelector(`.close`).addEventListener(`click`,()=>Ge())}function We(){!ce||z||(Y=!0,J&&J.classList.add(`open`),Ue())}function Ge(){Y=!1,J&&J.classList.remove(`open`)}function Ke(){Y?Ge():We()}function qe(e){B=e,pe=5+e*2,H=`spawning`}function Je(){C.x=0,C.z=0,C.vx=0,C.vz=0,C.hp=100,C.stamina=100,C.hunger=100,C.thirst=100,C.facing=0,C.iframe=0;for(let e of T)e.alive=!1;V=0,ue=0,de=0,z=!1,_e=!1,ve=null;for(let e of D)e.hp=150,e.alive=!0,e.mesh.scale.set(1,1,1);for(let e of N)e.active=!1,e.mesh.visible=!1;F.length=0;let e=[`food`,`water`,`food`,`water`,`bandage`,`scrap`];for(let t=0;t<6;t++){let n=Math.random()*Math.PI*2,r=1.6+Math.random()*(s-2);ne(Math.cos(n)*r,Math.sin(n)*r,e[t])}Fe&&(Fe.style.display=`none`),m.position.set(0,o,0),m.visible=!0,qe(1),Ue()}function Ye(){Je()}function Xe(e){ce=e,a.visible=e;let t=e&&c;De&&(De.style.display=t?`block`:`none`),Ie&&(Ie.style.display=t?`block`:`none`),Le&&(Le.style.display=t?`block`:`none`),Oe&&(Oe.style.display=e?`block`:`none`),Pe&&!e&&(Pe.style.display=`none`),Fe&&!e&&(Fe.style.display=`none`),q&&(q.style.display=e?`block`:`none`),Ge();for(let e in W)W[e]=!1;G.x=G.y=0,_e=!1,e&&Je()}let Q=new n;function Ze(e,t,n){if(!ce||Y)return;let r=n?n.windowGlow:0;if(he=Math.max(0,he-e),ge=Math.max(0,ge-e),S.material.opacity=Math.max(0,S.material.opacity-e*8),b.material.opacity=Math.max(0,b.material.opacity-e*6),!z){de+=e,C.iframe=Math.max(0,C.iframe-e);let n=(W.d||W.arrowright?1:0)-(W.a||W.arrowleft?1:0)+G.x,r=(W.w||W.arrowup?1:0)-(W.s||W.arrowdown?1:0)+G.y,i=Math.hypot(n,r);i>1&&(n/=i,r/=i);let a=i>.05,c=(W.shift||G.y>.95)&&C.stamina>2&&a,l=Math.cos(Be),u=Math.sin(Be),f=l*n+-u*r,h=-u*n+-l*r,_=c?5.2:3,v=1-Math.exp(-14*e);C.vx+=(f*_-C.vx)*v,C.vz+=(h*_-C.vz)*v,C.x+=C.vx*e,C.z+=C.vz*e;let y=Math.hypot(C.x,C.z);y>s&&(C.x*=s/y,C.z*=s/y,C.vx=0,C.vz=0),a&&(C.facing=Math.atan2(f,h)),C.stamina=g.clamp(C.stamina+(c?-34:22)*e,0,100),C.hunger=Math.max(0,C.hunger-.9*e),C.thirst=Math.max(0,C.thirst-1.15*e),C.hunger<=0||C.thirst<=0?C.hp=Math.max(0,C.hp-3.5*e):C.hunger>55&&C.thirst>55&&C.hp<100&&(C.hp=Math.min(100,C.hp+2*e));for(let e of N)e.active&&(e.x-C.x)**2+(e.z-C.z)**2<.3&&ae(e.kind)&&(e.active=!1,e.mesh.visible=!1,Ue());for(let t of D){if(t.hp>=150)continue;let n=Math.cos(t.ang)*d,r=Math.sin(t.ang)*d;(n-C.x)**2+(r-C.z)**2<p*p&&(t.hp=Math.min(150,t.hp+30*e),t.hp>0&&(t.alive=!0))}C.hp<=0&&Qe(),m.position.set(C.x,o,C.z),m.rotation.y=C.facing,m.visible=!(C.iframe>0&&Math.floor(t*20)%2==0),_e&&we(),b.position.set(C.x,o+.06,C.z),b.rotation.z=-C.facing}let i=0;z||H===`spawning`&&(pe>0&&Math.random()<e*(B===1?3.5:6)&&(be(r),pe--),pe<=0&&(H=`fighting`));let a=0,c=1/0;for(let n=0;n<48;n++){let r=T[n];if(!r.alive){Q.position.set(0,-60,0),Q.scale.setScalar(0),Q.updateMatrix(),w.setMatrixAt(n,Q.matrix);continue}i++;let s=C.x-r.x,l=C.z-r.z,f=Math.hypot(s,l)||1;if(f<c&&(c=f),!z){let t=s/f*r.speed,n=l/f*r.speed,i=1-Math.exp(-6*e);if(r.vx+=(t-r.vx)*i,r.vz+=(n-r.vz)*i,f>.52){let t=r.x+r.vx*e,n=r.z+r.vz*e,i=Math.hypot(r.x,r.z),a=Math.hypot(t,n);if(!r.in&&i>=d&&a<4.9){let r=A(t,n);if(r.alive){let i=Math.atan2(n,t),a=4.9;t=Math.cos(i)*a,n=Math.sin(i)*a,r.hp-=15*e,r.hp<=0&&(r.hp=0,r.alive=!1)}}a<d-.1&&(r.in=!0),r.x=t,r.z=n}else C.iframe<=0&&(a=Math.max(a,r.dmg))}r.flash=Math.max(0,r.flash-e);let p=Math.sin(t*6+r.phase)*.04;Q.position.set(r.x,o+.3*r.size*u+p,r.z),Q.rotation.set(0,Math.atan2(r.vx,r.vz),Math.sin(t*3+r.phase)*.12),Q.scale.setScalar(r.size*u),Q.updateMatrix(),w.setMatrixAt(n,Q.matrix),E.set(Un[r.type].color),r.flash>0?E.lerp(Gn,.7):E.lerp(Kn,.35*(1-r.hp/r.maxhp)),w.setColorAt(n,E)}w.instanceMatrix.needsUpdate=!0,w.instanceColor&&(w.instanceColor.needsUpdate=!0);let l=0;for(let e of D){e.alive&&l++;let t=Math.max(0,e.hp/150);e.mesh.scale.y=e.alive?Math.max(.18,t):.12,e.mesh.position.y=o+.35*e.mesh.scale.y,e.mesh.material.color.copy(e.baseColor).lerp(Kn,(1-t)*.55)}!z&&a>0&&(C.hp=Math.max(0,C.hp-a*(B===1?.5:1)),C.iframe=.6,C.hp<=0&&Qe()),!z&&H===`fighting`&&i===0&&pe<=0&&(H=`complete`,fe=2.2,ze(`WAVE ${B} CLEAR`,2)),!z&&H===`complete`&&(fe-=e,fe<=0&&(qe(B+1),ze(`WAVE ${B}`,1.4))),Re>0&&(Re-=e,Re<=0&&Pe&&(Pe.style.display=`none`)),ke&&(ke.style.width=`${C.hp}%`),Ae&&(Ae.style.width=`${C.stamina}%`),je&&(je.style.width=`${C.hunger}%`),Me&&(Me.style.width=`${C.thirst}%`),Ne&&(Ne.textContent=`WAVE ${B}   KILLS ${V}   SCORE ${ue}`),typeof window<`u`&&(window.__hoard={active:ce,dead:z,paused:Y,hp:Math.round(C.hp),stamina:Math.round(C.stamina),hunger:Math.round(C.hunger),thirst:Math.round(C.thirst),zombies:i,barriers:l,pickups:N.filter(e=>e.active).length,inv:Object.fromEntries(F.map(e=>[e.id,e.n])),wave:B,kills:V,score:ue,weapon:`gun`,znear:+c.toFixed(2),px:+C.x.toFixed(2),pz:+C.z.toFixed(2)})}function Qe(){z=!0,_e=!1,Fe&&(Fe.querySelector(`.ds`).innerHTML=`Wave reached: ${B}<br>Kills: ${V}<br>Score: ${ue}<br>Survived: ${de.toFixed(0)}s`,Fe.style.display=`flex`)}return{group:a,update:Ze,setActive:Xe,setAzimuth:X,setAim:Ve,setFiring:He,melee:Te,reset:Je,restart:Ye,openBag:We,closeBag:Ge,toggleBag:Ke,addItem:ae,get player(){return C},get dead(){return z},get active(){return ce},get paused(){return Y},get inv(){return F.map(e=>({...e}))},get nearestPickup(){let e=null,t=1e9;for(let n of N){if(!n.active)continue;let r=(n.x-C.x)**2+(n.z-C.z)**2;r<t&&(t=r,e=n)}return e?{x:e.x,z:e.z}:null},setTarget(){}}}var{Timer:Xn}=B,Zn=new URLSearchParams(window.location.search),Qn=Zn.get(`demo`)===`1`||Zn.has(`capture`);window.__demo=Qn;var $n=(Zn.get(`city`)?Number(Zn.get(`city`)):0)||Math.random()*1e9|0,er=0,tr=Ln({demo:Qn,citySeed:$n,profileIndex:er}),{renderer:nr,scene:rr,rig:ir,sunRig:ar,city:or,landmarkFactory:sr}=tr,cr=Yn({extent:or.extent,plinthTop:.3});rr.add(cr.group),window.__hoardApi=cr;var lr=!0;window.__shadows=lr,window.__scene=`hoard`;var ur=new k,dr=new Set,fr=6.5;function pr(e){or.group.traverse(t=>{!t.isMesh||t.userData.ground||!t.visible||(t.getWorldPosition(ur),Math.hypot(ur.x,ur.z)<e&&(t.visible=!1,dr.add(t)))})}function mr(){for(let e of dr)e.visible=!0;dr.clear()}var hr=new T,gr=new k,_r=new k,vr=new Set;function yr(){for(let e of vr)e.material&&(e.material.opacity=1,e.material.transparent=!!e.userData._wasT,e.material.depthWrite=e.userData._wasDW!==!1);vr.clear()}function br(e){yr();let t=ir.camera;for(let[n,r]of[[0,0],[.7,.4],[-.7,.4]]){_r.set(e.x+n,.6,e.z+r),gr.subVectors(_r,t.position);let i=gr.length();hr.set(t.position,gr.normalize()),hr.far=i-.4;for(let e of hr.intersectObject(or.group,!0)){let t=e.object;!t.material||t.userData.ground||vr.has(t)||(t.userData._wasT=t.material.transparent,t.userData._wasDW=t.material.depthWrite,t.material.transparent=!0,t.material.opacity=.16,t.material.depthWrite=!1,vr.add(t))}}}function xr(){cr.setActive(!0),pr(fr),ir.setMode(ye.DIMETRIC),ir.setZoom(2.8,!0),ir.setTarget(cr.player.x,.6,cr.player.z,!0)}var Sr=new T,Cr=new F,wr=new C(new k(0,1,0),-.32),Tr=new k,Er=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches,Dr=!1,Or=0,kr=0,Ar=.005,jr=(e,t)=>{Cr.x=e/window.innerWidth*2-1,Cr.y=-(t/window.innerHeight)*2+1};nr.domElement.addEventListener(`contextmenu`,e=>e.preventDefault()),nr.domElement.addEventListener(`mousedown`,e=>{e.button===0&&(jr(e.clientX,e.clientY),cr.setFiring(!0)),e.button===2&&(Dr=!0,Or=e.clientX,kr=e.clientY)}),window.addEventListener(`mousemove`,e=>{jr(e.clientX,e.clientY),Dr&&(ir.orbit(-(e.clientX-Or)*Ar,-(e.clientY-kr)*Ar),Or=e.clientX,kr=e.clientY)}),window.addEventListener(`mouseup`,()=>{cr.setFiring(!1),Dr=!1}),nr.domElement.addEventListener(`wheel`,e=>{e.preventDefault(),ir.zoomBy(Math.exp(e.deltaY*.0015))},{passive:!1}),window.addEventListener(`keydown`,e=>{(e.key===`h`||e.key===`H`)&&(lr=!lr,window.__shadows=lr)}),sr.whenReady.then(()=>{or.generate($n,er),tr.fitShadowFrustum(),mr(),pr(fr),window.__cityReady=!0});var Mr=new Xn;Mr.connect(document);function Nr(){Mr.update();let e=Math.min(Mr.getDelta(),.1);cr.setAzimuth(ir.azimuth),Er||(Sr.setFromCamera(Cr,ir.camera),Sr.ray.intersectPlane(wr,Tr)&&cr.setAim(Tr.x,Tr.z)),cr.update(e,Mr.getElapsed(),ar),ir.setTarget(cr.player.x,.6,cr.player.z),ir.update(e),br(cr.player),tr.updateWorld(e,Mr.getElapsed(),{shadowsOn:lr,seasonTarget:0});let t=tr.decideStyle();tr.renderCityPipeline(t,null),requestAnimationFrame(Nr)}xr(),Nr(),Vn({key:`hoard`,title:`The Hoard`,tips:[`Move: WASD / arrows · on touch: the left thumb-stick`,`Aim: mouse / drag · Fire: hold click / the FIRE button · Melee: the MELEE button`,`Survive the waves · B: bag & crafting · Esc: exit`]}),window.addEventListener(`resize`,()=>{tr.resize()});