...
void main() {
  ...
  gl_FragColor = vec4(st.x, Snew, 0.0, 0.0);
}`;function zn({renderer:e,N:t,cell:n,half:r,worldSize:o,seaY:s=0,FLOW:u,DAMP:d,MIN_DEPTH:f,KC:p,KE:m,KD:g,KADV:_,MAXD:y,readTerrain:b}){let x=e.getContext();if(!(x&&x.getExtension&&x.getExtension(`EXT_color_buffer_float`)))return typeof console<`u`&&console.warn(`[L87] EXT_color_buffer_float unavailable — GPU flow backend cannot run; staying on CPU.`),null;let S={type:i,format:de,minFilter:l,magFilter:l,wrapS:ie,wrapT:ie,depthBuffer:!1,stencilBuffer:!1},C=[new W(t,t,S),new W(t,t,S)],w=[new W(t,t,S),new W(t,t,S)],T=[new W(t,t,S),new W(t,t,S)],k=new Float32Array(t*t*4),j=new he(k,t,t,de,i);j.minFilter=l,j.magFilter=l,j.wrapS=j.wrapT=ie;let ee=new Float32Array(t*t),M=!1,te=1,ne=!0,P=new O,F=new c(-1,1,1,-1,0,1),L=new v(new h(2,2),null);L.frustumCulled=!1,P.add(L);let ae=new G(1/t,1/t),oe=(e,t)=>new I({vertexShader:jn,fragmentShader:e,uniforms:t}),se=oe(Mn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uFlow:{value:u},uDamp:{value:d}}),ce=oe(Nn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uSeaY:{value:s}}),le=oe(Pn,{uState:{value:null},uTerr:{value:null},uN:{value:t},uSeaY:{value:s},uRain:{value:0},uPourCount:{value:0},uPours:{value:Array.from({length:8},()=>new E)},uPourR:{value:new Float32Array(8)}}),ue=oe(Fn,{uSrc:{value:j}}),R=()=>({uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uCell:{value:n},uSeaY:{value:s},uKC:{value:p},uKE:{value:m},uKD:{value:g},uMaxD:{value:y},uMinDepth:{value:f},uErosK:{value:te}}),z=oe(In,R()),fe=oe(Ln,R()),B=oe(Rn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uSeaY:{value:s},uKADV:{value:_}});function V(t,n){L.material=t;let r=e.getRenderTarget();e.setRenderTarget(n),e.render(P,F),e.setRenderTarget(r)}let pe=new N;function H(t){let n=e.getRenderTarget(),r=e.getClearAlpha();e.getClearColor(pe),e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1),e.setClearColor(pe,r),e.setRenderTarget(n)}function U(){b(ee);for(let e=0;e<t*t;e++)k[e*4]=ee[e];j.needsUpdate=!0,V(ue,T[0])}function me(){H(C[0]),H(C[1]),H(w[0]),H(w[1])}me();let ge=t*t,_e=new Float32Array(ge*3),ve=new Float32Array(ge*2);for(let e=0;e<t;e++)for(let i=0;i<t;i++){let a=e*t+i;_e[a*3]=i*n-r,_e[a*3+1]=0,_e[a*3+2]=e*n-r,ve[a*2]=(i+.5)/t,ve[a*2+1]=(e+.5)/t}let ye=[];for(let e=0;e<t-1;e++)for(let n=0;n<t-1;n++){let r=e*t+n,i=e*t+n+1,a=(e+1)*t+n,o=(e+1)*t+n+1;ye.push(r,a,i,i,a,o)}let be=new re;be.setAttribute(`position`,new D(_e,3)),be.setAttribute(`aGridUv`,new D(ve,2)),be.setIndex(ye),be.boundingSphere=new A(new E(0,0,0),o);let xe={uStateTex:{value:C[0].texture},uTerrTex:{value:T[0].texture},uMinDepth:{value:f}},Se=new a({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});Se.onBeforeCompile=e=>{e.uniforms.uStateTex=xe.uStateTex,e.uniforms.uTerrTex=xe.uTerrTex,e.uniforms.uMinDepth=xe.uMinDepth,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
