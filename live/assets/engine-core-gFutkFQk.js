import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,I as c,K as l,L as u,M as d,N as f,P as p,Q as m,R as h,S as g,T as _,U as v,V as y,X as b,Y as x,Z as S,_ as C,a as w,at as T,b as E,c as D,f as O,g as ee,h as k,i as A,j,l as M,m as N,n as P,nt as F,o as I,ot as L,p as R,q as z,s as B,st as V,t as te,tt as H,u as U,v as ne,w as re,x as ie,z as ae}from"./three-CAqSPQgM.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var W=Math.atan(1/Math.SQRT2),oe=Math.atan(.5),se=Math.PI/4,G={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},ce=.12,le=1.45,ue=4,de=40,fe=1.5,pe=16,me=6,K=22,he=3.5,ge=11,q=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),_e=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function ve({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new L(0,.8,0),azimuth:a=se,elevation:o=.52,distance:s=12,zoom:c=5.5}={}){let l=new y(t,e,n,r),u=new ae(-1,1,1,-1,n,r),f=G.PERSPECTIVE,p=e,m={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},h={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},g=!1,_=()=>f===G.PERSPECTIVE?l:u;function v(e){e!==f&&(f=e,f===G.ISOMETRIC||f===G.DIMETRIC?(m.elevation=f===G.ISOMETRIC?W:oe,m.azimuth=_e(se,h.azimuth),g=!0):g=!1)}function b(e,t){m.azimuth+=e,g||(m.elevation=d.clamp(m.elevation+t,ce,le))}function x(e){f===G.PERSPECTIVE?m.distance=d.clamp(m.distance*e,ue,de):m.zoom=d.clamp(m.zoom*e,fe,pe)}function S(e,t){let n=m.azimuth,r=f===G.PERSPECTIVE?m.distance*.04:m.zoom*.08,i=new L(Math.cos(n),0,-Math.sin(n)),a=new L(-Math.sin(n),0,-Math.cos(n));m.target.addScaledVector(i,e*r),m.target.addScaledVector(a,t*r)}function C(e,t){p=e/t,l.aspect=p,l.updateProjectionMatrix()}function w(e){h.azimuth=q(h.azimuth,m.azimuth,e),h.elevation=q(h.elevation,m.elevation,e),h.distance=q(h.distance,m.distance,e),h.zoom=q(h.zoom,m.zoom,e),h.target.x=q(h.target.x,m.target.x,e),h.target.y=q(h.target.y,m.target.y,e),h.target.z=q(h.target.z,m.target.z,e);let t=Math.cos(h.elevation),n=Math.sin(h.elevation),r=Math.cos(h.azimuth),i=Math.sin(h.azimuth),a=_();if(a.position.set(h.target.x+h.distance*t*i,h.target.y+h.distance*n,h.target.z+h.distance*t*r),a.lookAt(h.target),a.isOrthographicCamera){let e=h.zoom,t=e*p;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function T(e,t,n,r=!1){m.target.set(e,t,n),r&&h.target.copy(m.target)}function E(e,t=!1){m.zoom=d.clamp(e,fe,pe),t&&(h.zoom=m.zoom)}return{get camera(){return _()},get mode(){return f},get azimuth(){return h.azimuth},setTarget:T,setZoom:E,get styleT(){return f===G.PERSPECTIVE?d.clamp((h.distance-me)/(K-me),0,1):d.clamp((h.zoom-he)/(ge-he),0,1)},setMode:v,orbit:b,zoomBy:x,pan:S,setViewport:C,update:w}}var ye={value:0},be=new R(`#ffffff`),xe={value:0},Se={value:0},Ce={value:0},we=new T,Te={value:0},Ee={value:0},J=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
`;function De(e){e.uniforms.uVector=ye,e.uniforms.uVecTint={value:be},e.uniforms.uVecShadow=xe,e.uniforms.uSnow=Se,e.uniforms.uCloud=Ce,e.uniforms.uCloudOff={value:we},e.uniforms.uFogCharm=Te}function Oe(e){return e.replace(`#include <fog_fragment>`,`
    #ifdef USE_FOG
...
#include <shadowmask_pars_fragment>`)}var je=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Y(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new R(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{De(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new R(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=ke(e.vertexShader),e.fragmentShader=Oe(Ae(e.fragmentShader.replace(`#include <common>`,`#include <common>
...
`:``),f=c?`uGlow * mix(uGlowDay, uGlowNight, uWindowGlow)`:`vec3(0.0)`,p=Oe(Ae(e.fragmentShader.replace(`#include <common>`,`#include <common>
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,zt={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Bt=[`gb`,`8-bit`,`16-bit`,`modern`],Vt={"ink-gold (day)":[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],"ink-gold (night)":[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],"terminal (day)":[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],"terminal (night)":[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`]};function Ht(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new R(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new ee(n,t,1,z,ie);return r.minFilter=u,r.magFilter=u,r.needsUpdate=!0,r}function Ut(e,t){let n=[];for(let t=0;t+2<e.length;t+=3)n.push([e[t],e[t+1],e[t+2]]);if(n.length===0)return[`#000000`];let r=e=>{let t=[255,255,255],n=[0,0,0];for(let r of e)for(let e=0;e<3;e++)t[e]=Math.min(t[e],r[e]),n[e]=Math.max(n[e],r[e]);let r=[n[0]-t[0],n[1]-t[1],n[2]-t[2]],i=r[0]>=r[1]&&r[0]>=r[2]?0:r[1]>=r[2]?1:2;return{ax:i,range:r[i]}},i=[n];for(;i.length<t;){let e=-1,t=-1;if(i.forEach((n,i)=>{if(n.length>1){let{range:a}=r(n);a>t&&(t=a,e=i)}}),e<0)break;let n=i[e],{ax:a}=r(n);n.sort((e,t)=>e[a]-t[a]);let o=n.length>>1;i.splice(e,1,n.slice(0,o),n.slice(o))}return i.map(e=>{let t=[0,0,0];for(let n of e)for(let e=0;e<3;e++)t[e]+=n[e];return`#`+t.map(t=>Math.round(t/e.length)).map(e=>e.toString(16).padStart(2,`0`)).join(``)})}var Wt=220,Gt={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Kt={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function qt({demo:e=!1,citySeed:n=0,profileIndex:r=0}={}){let i=new P({antialias:!0,preserveDrawingBuffer:!0});i.shadowMap.enabled=!0,i.shadowMap.type=1,i.setPixelRatio(Math.min(window.devicePixelRatio,2)),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(920327,1),document.body.appendChild(i.domElement);let a=i.getDrawingBufferSize(new T),s=new b;s.fog=new g(10465470,0);let c=new R(`#aeb6c0`),l=.062,m=new R(`#74508f`),h=new R,_=ve({aspect:window.innerWidth/window.innerHeight}),y=$e({t:.5}),w={type:re,format:z,minFilter:u,magFilter:u,wrapS:O,wrapT:O,depthBuffer:!1,stencilBuffer:!1},E=[new V(256,256,w),new V(256,256,w),new V(256,256,w)];for(let e of E)i.setRenderTarget(e),i.clear();i.setRenderTarget(null);let ee=new b,k=new ae(-1,1,1,-1,0,1),A=new S({vertexShader:At,fragmentShader:jt,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new T(1/256,1/256)},uMouse:{value:new T(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new L)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new L)}}});ee.add(new p(new v(2,2),A));let j=new V(a.x,a.y,{minFilter:t,magFilter:t,depthBuffer:!0,stencilBuffer:!1});function M(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new D(t);return r.colorSpace=x,r}let N=new p(new v(28,28),new o({map:M(e)}));N.rotation.x=-Math.PI/2,N.position.y=-.35,s.add(N);let F=new p(new v(40,24),new S({depthWrite:!1,vertexShader:Ot,fragmentShader:kt,uniforms:{uTime:{value:0},uInk:{value:y.horizon},uGold:{value:y.sky},uFogColor:{value:h},uFogAmt:{value:0},uFogCharm:Te}}));F.position.set(0,3,-8),s.add(F);let I=new S({vertexShader:Mt,fragmentShader:Nt,uniforms:{uHeight:{value:null},uScene:{value:j.texture},uTexel:{value:new T(1/256,1/256)},uResolution:{value:new T(a.x,a.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new f},uLightDir:{value:y.sunDir},uInk:{value:new R(`#2A2218`)},uGold:{value:new R(`#B89968`)},uVector:ye,uVecWater:{value:new R(`#1fb8d8`)},uVecTint:{value:be}}}),B=new p(new v(28,28,255,255),I);B.rotation.x=-Math.PI/2,B.updateMatrixWorld(!0),I.uniforms.uNormalMatrix.value.getNormalMatrix(B.matrixWorld),s.add(B);let te={value:0},H=St({windowGlow:te}),U=Ge({seed:n,profileIndex:r,landmarkFactory:H,windowGlow:te});s.add(U.group);let ne=it({plinthTop:.3,extent:U.extent,profile:U.state.profile});s.add(ne.group);let ie=ut({extent:U.extent,waterSize:28,plinthTop:.3});s.add(ie.group),A.uniforms.uWakeDrops.value=ie.wakeDrops;let W=wt({extent:U.extent});s.add(W.group),A.uniforms.uRainDrops.value=W.rainDrops;let oe=Et({extent:U.extent});s.add(oe.group),U.group.remove(U.key),s.add(U.key),U.key.castShadow=!0,U.key.shadow.mapSize.set(2048,2048),U.key.shadow.bias=-18e-5,U.key.shadow.normalBias=.028,s.add(U.key.target);function se(){let e=U.key.shadow.camera,t=U.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix()}se();let G=new C(a.x,a.y),ce=new V(a.x,a.y,{minFilter:t,magFilter:t,depthBuffer:!0,stencilBuffer:!1,depthTexture:G}),le=new V(a.x,a.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),ue=new V(a.x,a.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),de=new V(a.x,a.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),fe=new b,pe=new ae(-1,1,1,-1,0,1),me=new p(new v(2,2));fe.add(me);let K=new S({vertexShader:At,fragmentShader:Pt,uniforms:{uScene:{value:ce.texture},uTime:{value:0},uResolution:{value:new T(a.x,a.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),he=e=>{let t=e.map(e=>new R(e));for(;t.length<8;)t.push(new R(0,0,0));return t},ge=[`night`,`dawn`,`noon`,`dusk`],q={inkgold:ge.map(e=>he(Gt[e])),terminal:ge.map(e=>he(Kt[e]))},_e=new S({vertexShader:At,fragmentShader:Ft,uniforms:{uScene:{value:le.texture},uResolution:{value:new T(a.x,a.y)},uPixelSize:{value:Wt},uPalette:{value:q.inkgold[2]},uPaletteB:{value:q.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),J=new S({vertexShader:At,fragmentShader:Rt,uniforms:{uScene:{value:le.texture},uResolution:{value:new T(a.x,a.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Ht(zt[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),De={};for(let e of Bt)De[e]=zt[e].palette?Ht(zt[e].palette):null;let Oe=new S({vertexShader:At,fragmentShader:It,uniforms:{uScene:{value:le.texture},uDepth:{value:G},uResolution:{value:new T(a.x,a.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:y.toonFloor},uOutline:{value:y.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),ke=new S({vertexShader:At,fragmentShader:Lt,uniforms:{uToon:{value:ue.texture},uPixel:{value:de.texture},uBlend:{value:0}}});function Ae(e,t){me.material=e,i.setRenderTarget(t),i.render(fe,pe)}function je(){_.setViewport(window.innerWidth,window.innerHeight),i.setSize(window.innerWidth,window.innerHeight);let e=i.getDrawingBufferSize(new T);return j.setSize(e.x,e.y),ce.setSize(e.x,e.y),le.setSize(e.x,e.y),ue.setSize(e.x,e.y),de.setSize(e.x,e.y),I.uniforms.uResolution.value.set(e.x,e.y),K.uniforms.uResolution.value.set(e.x,e.y),_e.uniforms.uResolution.value.set(e.x,e.y),J.uniforms.uResolution.value.set(e.x,e.y),Oe.uniforms.uResolution.value.set(e.x,e.y),e}let Y=3,X=!1,Me=!1,Z=`native`,Ne=.3,Pe=.46,Q=[`native`,...Bt],Fe={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=Y,window.__vector=X,window.__era=Z);let Ie=0,Le=performance.now();function Re(e){let t=Me?q.terminal:q.inkgold,n=e%1*4,r=Math.floor(n)%4;_e.uniforms.uPalette.value=t[r],_e.uniforms.uPaletteB.value=t[(r+1)%4],_e.uniforms.uPaletteBlend.value=n-Math.floor(n)}function ze(e){let t=zt[e];t&&(J.uniforms.uGridWidth.value=t.gridWidth,J.uniforms.uDither.value=t.dither,J.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(J.uniforms.uPalette.value=De[e],J.uniforms.uPaletteSize.value=t.palette.length))}function Be(){Z!==`native`&&ze(Z)}let Ve=()=>Z===`native`?_e:J;function He(e,t){B.visible=!1,i.setRenderTarget(j),i.render(s,e),B.visible=!0,i.setRenderTarget(t),i.render(s,e)}function Ue(e,t){if(B.visible=!1,i.setRenderTarget(j),i.render(s,_.camera),B.visible=!0,Y===1||X&&Y!==7&&Y!==8)i.setRenderTarget(t),i.render(s,_.camera);else if(i.setRenderTarget(ce),i.render(s,_.camera),Y===2)K.uniforms.uGrain.value=1,K.uniforms.uChroma.value=1,Ae(K,t);else{K.uniforms.uGrain.value=0,K.uniforms.uChroma.value=0,Ae(K,le);let n=_.camera;Oe.uniforms.uNear.value=n.near,Oe.uniforms.uFar.value=n.far,Oe.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(ze(e.era),J):Ve();e.kind===`pixel`?(Ae(r,t),window.__style=`pixel`):e.kind===`toon`?(Ae(Oe,t),window.__style=`toon`):(Ae(Oe,ue),Ae(r,de),ke.uniforms.uBlend.value=e.blend,Ae(ke,t),window.__style=`blend`)}}function We(){let e=Ke(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return I.uniforms.uChromaScale.value=d.lerp(1,.5,t),e}function Ke(){if(Y===1||Y===2)return{kind:`none`};if(Y===7)return{kind:`pixel`};if(Y===8)return{kind:`toon`};let e=_.styleT;return window.__styleT=e,e<=Ne?{kind:`toon`}:e>=Pe?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:d.smoothstep(e,Ne,Pe),era:`16-bit`}}function qe(e){return Y===1||Y===2?``:X&&Y!==7&&Y!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Fe[e.era||Z]||`Pixel`:e.kind===`blend`?`Toon → `+(Fe[e.era]||`Pixel`):``}function Je(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){F.material.uniforms.uTime.value=t,K.uniforms.uTime.value=t,y.update(e),U.key.position.copy(y.sunDir).multiplyScalar(24),U.key.color.copy(y.sunColor),U.key.intensity=y.sunIntensity,U.fill.color.copy(y.hemiSky),U.fill.groundColor.copy(y.hemiGround),te.value=y.windowGlow;let a=W.overcast;U.key.intensity*=1-.5*a,U.key.color.lerp(c,.45*a),U.fill.intensity=1+.7*a;let o=d.smoothstep(y.sunDir.y,.06,.34),u=d.lerp(.28,1,1-y.windowGlow),f=n?o*u:0;U.key.shadow.intensity=.72*f,xe.value=.52*f;let p=1-y.windowGlow;be.setRGB(d.lerp(.46,1,p),d.lerp(.52,1,p),d.lerp(.74,1,p)),K.uniforms.uExposure.value=y.exposure,Oe.uniforms.uToonGain.value=y.toonGain,i.setClearColor(y.horizon,1),Re(y.t),window.__t=y.t,ne.update(e,t,y),U.update(t),ie.update(e,t,y),A.uniforms.uWakeCount.value=ie.wakeCount,W.update(e,t),A.uniforms.uRainCount.value=W.rainDropCount;let g=W.fog*(1-p);s.fog.density=W.fog*l,h.copy(y.horizon).lerp(m,.85*g),s.fog.color.copy(h),i.setClearColor(h,1),Te.value=W.fog,F.material.uniforms.uFogAmt.value=.7*W.fog,Se.value=W.snow,Ce.value=W.cloud*.55,we.x+=e*.018,we.y+=e*.009,Ee.value+=(r-Ee.value)*Math.min(1,e*1.5),oe.update(e,t,y,W),Ie++;let _=performance.now();_-Le>=1e3&&(window.__fps=Ie,Ie=0,Le=_);let[v,b,x]=E;A.uniforms.uPrev.value=v.texture,A.uniforms.uCurr.value=b.texture,i.setRenderTarget(x),i.render(ee,k),E=[b,x,v],I.uniforms.uHeight.value=E[1].texture}function Ye(e){Y=e,window.__mode=Y}function Xe(){return X=!X,ye.value=+!!X,window.__vector=X,X}function Ze(e){return X=!!e,ye.value=+!!X,window.__vector=X,X}function Qe(){return Z=Q[(Q.indexOf(Z)+1)%Q.length],window.__era=Z,Be(),Z}function et(){return Me=!Me,Me}return{updateWorld:Je,decideStyle:We,renderCityPipeline:Ue,renderCityBeautyTo:He,styleHintName:qe,setPostMode:Ye,toggleVector:Xe,setVector:Ze,cycleEra:Qe,togglePalette:et,get mode(){return Y},get vector(){return X},get sceneEra(){return Z},renderer:i,drawBuffer:a,scene:s,rig:_,sunRig:y,SIM:256,targets:E,simScene:ee,simCamera:k,simMaterial:A,grabRT:j,card:N,backdrop:F,WATER_SIZE:28,water:B,waterMaterial:I,windowGlow:te,landmarkFactory:H,city:U,cityLife:ne,waterLife:ie,weatherRig:W,clouds:oe,fitShadowFrustum:se,SHADOW_DIST:24,sceneDepth:G,sceneRT:ce,filmicRT:le,toonRT:ue,pixelRT:de,postScene:fe,postCamera:pe,postQuad:me,filmicMaterial:K,pixelMaterial:_e,pixelkitMaterial:J,toonMaterial:Oe,mixMaterial:ke,PALCACHE:q,ERA_TEX:De,runPass:Ae,OVERCAST_GREY:c,FOG_DENSITY:l,FOG_NIGHT_TINT:m,_fogColor:h,resize:je}}var Jt=[`video/mp4;codecs=avc1.42E01E`,`video/mp4`,`video/webm;codecs=vp9`,`video/webm`];function Yt({renderer:e,rig:t,sunRig:n,poke:r,getState:i,office:a={}}){let o=e.domElement,s=new URLSearchParams(window.location.search),c=e=>{let t=i();return`lgr-${t.lesson}-${String(t.clock||``).replace(`:`,``)}-${t.style}.${e}`},l=(e,t)=>{let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,document.body.appendChild(r),r.click(),r.remove(),setTimeout(()=>URL.revokeObjectURL(n),1e3)};function u(){o.toBlob(e=>{e&&(l(e,c(`png`)),window.__lastStill=e.size)},`image/png`)}let d=()=>Jt.find(e=>window.MediaRecorder&&MediaRecorder.isTypeSupported(e))||``,f=Xt(),p=null,m=[],h=!1;function g(){if(h)return;let e=d(),t=o.captureStream(60);p=new MediaRecorder(t,e?{mimeType:e,videoBitsPerSecond:12e6}:{}),m=[],p.ondataavailable=e=>{e.data&&e.data.size&&m.push(e.data)},p.onstop=()=>{let e=new Blob(m,{type:p.mimeType});l(e,c(p.mimeType.includes(`mp4`)?`mp4`:`webm`)),window.__lastVideo=e.size},p.start(),h=!0,window.__recording=!0,f.show()}function _(){h&&(p.stop(),h=!1,window.__recording=!1,f.hide())}let v=()=>h?_():g(),y=e=>new Promise(t=>setTimeout(t,e)),b=e=>window.dispatchEvent(new KeyboardEvent(`keydown`,{key:e}));async function x(){let e=o.clientWidth,t=o.clientHeight,n=e*.26,i=t*.74;for(let t=0;t<=10;t++)r.at(n+t*e*.028,i+Math.sin(t*.7)*16),await y(100);r.stop()}async function S(e){if(e.keys)for(let t of e.keys)b(t),await y(70);e.zoom&&t.zoomBy(e.zoom),e.orbit&&t.orbit(e.orbit[0],e.orbit[1]),e.timeTo!==void 0&&n.goTo(e.timeTo),e.office&&a[e.office]?.(),e.ripple&&await x(),e.waitMs&&await y(e.waitMs)}let C={tour:[{keys:[`6`,`0`],waitMs:600},{zoom:.72,waitMs:1700},{ripple:!0,waitMs:2400},{orbit:[.55,0],waitMs:1700},{timeTo:0,waitMs:3e3},{timeTo:.5,waitMs:1500},{keys:[`7`],waitMs:1e3},{zoom:1.5,waitMs:1400},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`8`],waitMs:900},{zoom:.65,waitMs:1200},{ripple:!0,waitMs:2600},{keys:[`7`],waitMs:700},{keys:[`B`],waitMs:300},{keys:[`B`],waitMs:900},{zoom:1.4,waitMs:2600}],daycycle:[{keys:[`6`,`0`],waitMs:700},{timeTo:.75,waitMs:2600},{timeTo:1,waitMs:2600},{timeTo:1.25,waitMs:2600},{timeTo:1.5,waitMs:2600},{timeTo:1.5,waitMs:800}],office:[{keys:[`o`],waitMs:1700},{office:`pet`,waitMs:1300},{office:`feed`,waitMs:1700},{office:`travel`,waitMs:1700},{keys:[`W`,`W`,`W`],waitMs:1800},{timeTo:0,waitMs:2400},{office:`laptop`,waitMs:800},{office:`closeLaptop`,waitMs:300},{timeTo:.5,waitMs:900},{keys:[`W`],waitMs:200},{keys:[`o`],waitMs:1500}],cities:[{keys:[`6`,`0`],waitMs:500},{timeTo:.78,waitMs:2800},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:2e3}],water:[{keys:[`6`,`0`],waitMs:600},{zoom:1.35,waitMs:2800},{orbit:[.7,0],waitMs:2600},{ripple:!0,waitMs:2200},{timeTo:0,waitMs:3200},{timeTo:.5,waitMs:1500},{orbit:[-.5,0],waitMs:2200}],morph:[{keys:[`6`,`3`],waitMs:700},{zoom:.55,waitMs:1800},{zoom:2.3,waitMs:1700},{zoom:1.26,waitMs:1700},{zoom:1.16,waitMs:1900},{zoom:.3,waitMs:2200}],skin:[{keys:[`o`],waitMs:1800},{keys:[`j`],waitMs:2e3},{keys:[`j`],waitMs:2e3},{timeTo:0,waitMs:2600},{timeTo:.5,waitMs:1500},{keys:[`u`],waitMs:2e3},{keys:[`j`],waitMs:1400},{keys:[`o`],waitMs:1500}]};async function w(e){let t=C[e];if(t){window.__director=e;for(let e of t)await S(e);window.__director=null}}async function T(e){await y(1600),g(),await w(e),await y(400),_(),window.__captureDone=!0}window.addEventListener(`keydown`,e=>{(e.key===`s`||e.key===`S`)&&u(),(e.key===`r`||e.key===`R`)&&v()});let E=s.get(`capture`);return E&&C[E]&&T(E),window.__capture={still:u,toggleRec:v,run:w,sequences:Object.keys(C)},window.__capture}function Xt(){let e=document.createElement(`div`);return e.textContent=`● REC`,e.style.cssText=`position:fixed;top:14px;right:16px;z-index:2;font:bold 12px ui-monospace,monospace;color:#ff3b30;letter-spacing:.12em;text-shadow:0 1px 3px #000;display:none;`,document.body.appendChild(e),{show:()=>{e.style.display=`block`},hide:()=>{e.style.display=`none`}}}var Zt=`
...
void main() {
  ...
  gl_FragColor = vec4(col, 1.0);
}`;export{zt as a,Ut as c,Ne as d,Pe as f,qt as i,Rt as l,G as m,Qt as n,Vt as o,X as p,Yt as r,Ht as s,$t as t,At as u};