...
}`,fn=`const float CA_STRENGTH   = 0.0030;  
...
void main() {
  ...
  gl_FragColor = vec4(col, 1.0);
}`,_n=220,vn=new URLSearchParams(window.location.search),yn=vn.get(`demo`)===`1`||vn.has(`capture`);window.__demo=yn;var bn={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},xn={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]},W=new se({antialias:!0,preserveDrawingBuffer:!0});W.shadowMap.enabled=!0,W.shadowMap.type=1,W.setPixelRatio(Math.min(window.devicePixelRatio,2)),W.setSize(window.innerWidth,window.innerHeight),W.setClearColor(920327,1),document.body.appendChild(W.domElement);var G=W.getDrawingBufferSize(new N),K=new f;K.fog=new j(10465470,0);var Sn=new P(`#aeb6c0`),Cn=.062,wn=new P(`#74508f`),Tn=new P,q=Ne({aspect:window.innerWidth/window.innerHeight}),J=vt({t:.5}),En=256,Dn={type:C,format:p,minFilter:y,magFilter:y,wrapS:ne,wrapT:ne,depthBuffer:!1,stencilBuffer:!1},On=[new L(En,En,Dn),new L(En,En,Dn),new L(En,En,Dn)];for(let e of On)W.setRenderTarget(e),W.clear();W.setRenderTarget(null);var kn=new f,An=new d(-1,1,1,-1,0,1),jn=new g({vertexShader:r,fragmentShader:ln,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new N(1/En,1/En)},uMouse:{value:new N(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new R)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new R)}}});kn.add(new o(new S(2,2),jn));var Mn=new L(G.x,G.y,{minFilter:u,magFilter:u,depthBuffer:!0,stencilBuffer:!1});function Nn(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new fe(t);return r.colorSpace=D,r}var Pn=28,Fn=new o(new S(Pn,Pn),new ie({map:Nn(yn)}));Fn.rotation.x=-Math.PI/2,Fn.position.y=-.35,K.add(Fn);var In=new o(new S(40,24),new g({depthWrite:!1,vertexShader:sn,fragmentShader:cn,uniforms:{uTime:{value:0},uInk:{value:J.horizon},uGold:{value:J.sky},uFogColor:{value:Tn},uFogAmt:{value:0},uFogCharm:Be}}));In.position.set(0,3,-8),K.add(In);var Ln=new g({vertexShader:un,fragmentShader:dn,uniforms:{uHeight:{value:null},uScene:{value:Mn.texture},uTexel:{value:new N(1/En,1/En)},uResolution:{value:new N(G.x,G.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new I},uLightDir:{value:J.sunDir},uInk:{value:new P(`#2A2218`)},uGold:{value:new P(`#B89968`)},uVector:Pe,uVecWater:{value:new P(`#1fb8d8`)},uVecTint:{value:Fe}}}),Rn=new o(new S(Pn,Pn,En-1,En-1),Ln);Rn.rotation.x=-Math.PI/2,Rn.updateMatrixWorld(!0),Ln.uniforms.uNormalMatrix.value.getNormalMatrix(Rn.matrixWorld),K.add(Rn);var zn={value:0},Bn=new URLSearchParams(window.location.search),Vn=(Bn.get(`city`)?Number(Bn.get(`city`)):0)||Math.random()*1e9|0,Hn=Math.max(0,Qe.indexOf(Bn.get(`profile`)||`manhattan`)),Un=Bt({windowGlow:zn}),Y=ut({seed:Vn,profileIndex:Hn,landmarkFactory:Un,windowGlow:zn});K.add(Y.group);var Wn=Ct({plinthTop:.3,extent:Y.extent,profile:Y.state.profile});K.add(Wn.group);var Gn=Ot({extent:Y.extent,waterSize:Pn,plinthTop:.3});K.add(Gn.group),jn.uniforms.uWakeDrops.value=Gn.wakeDrops;var X=qt({extent:Y.extent});K.add(X.group),jn.uniforms.uRainDrops.value=X.rainDrops;var Kn=an({extent:Y.extent});K.add(Kn.group);var qn=[0,.33,.66,1],Jn=0;window.__season=qn[Jn],Y.group.remove(Y.key),K.add(Y.key),Y.key.castShadow=!0,Y.key.shadow.mapSize.set(2048,2048),Y.key.shadow.bias=-18e-5,Y.key.shadow.normalBias=.028,K.add(Y.key.target);function Yn(){let e=Y.key.shadow.camera,t=Y.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=Xn*2,e.updateProjectionMatrix()}var Xn=24;Yn();var Zn=!0;window.__shadows=Zn;function Qn(){Y.generate(Vn,Hn),Ln.uniforms.uVecWater.value.set(Y.waterColor),Wn.setProfile(Y.state.profile),Yn(),Ti()}Un.whenReady.then(()=>{Qn(),window.__cityReady=!0}),Ln.uniforms.uVecWater.value.set(Y.waterColor);var $n=new re(G.x,G.y),er=new L(G.x,G.y,{minFilter:u,magFilter:u,depthBuffer:!0,stencilBuffer:!1,depthTexture:$n}),tr=new L(G.x,G.y,{minFilter:u,magFilter:u,depthBuffer:!1,stencilBuffer:!1}),nr=new L(G.x,G.y,{minFilter:u,magFilter:u,depthBuffer:!1,stencilBuffer:!1}),rr=new L(G.x,G.y,{minFilter:u,magFilter:u,depthBuffer:!1,stencilBuffer:!1}),ir=new f,ar=new d(-1,1,1,-1,0,1),or=new o(new S(2,2));ir.add(or);var sr=new g({vertexShader:r,fragmentShader:fn,uniforms:{uScene:{value:er.texture},uTime:{value:0},uResolution:{value:new N(G.x,G.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),cr=5,lr=e=>{let t=e.map(e=>new P(e));for(;t.length<8;)t.push(new P(0,0,0));return t},ur=[`night`,`dawn`,`noon`,`dusk`],dr={inkgold:ur.map(e=>lr(bn[e])),terminal:ur.map(e=>lr(xn[e]))},fr=new g({vertexShader:r,fragmentShader:pn,uniforms:{uScene:{value:tr.texture},uResolution:{value:new N(G.x,G.y)},uPixelSize:{value:_n},uPalette:{value:dr.inkgold[2]},uPaletteB:{value:dr.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:cr}}});function pr(e){let t=Jr?dr.terminal:dr.inkgold,n=e%1*4,r=Math.floor(n)%4;fr.uniforms.uPalette.value=t[r],fr.uniforms.uPaletteB.value=t[(r+1)%4],fr.uniforms.uPaletteBlend.value=n-Math.floor(n)}var mr=new g({vertexShader:r,fragmentShader:t,uniforms:{uScene:{value:tr.texture},uResolution:{value:new N(G.x,G.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:e(i[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),hr={};for(let t of n)hr[t]=i[t].palette?e(i[t].palette):null;var gr=[`native`,...n],_r=`native`;window.__era=_r;function vr(e){let t=i[e];t&&(mr.uniforms.uGridWidth.value=t.gridWidth,mr.uniforms.uDither.value=t.dither,mr.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(mr.uniforms.uPalette.value=hr[e],mr.uniforms.uPaletteSize.value=t.palette.length))}function yr(){_r!==`native`&&vr(_r)}var br=()=>_r===`native`?fr:mr,xr=new g({vertexShader:r,fragmentShader:mn,uniforms:{uScene:{value:tr.texture},uDepth:{value:$n},uResolution:{value:new N(G.x,G.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:J.toonFloor},uOutline:{value:J.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Sr=new g({vertexShader:r,fragmentShader:hn,uniforms:{uToon:{value:nr.texture},uPixel:{value:rr.texture},uBlend:{value:0}}});function Cr(e,t){or.material=e,W.setRenderTarget(t),W.render(ir,ar)}var Z=Jt({tier:`corner`});Z.camera.aspect=window.innerWidth/window.innerHeight,Z.camera.updateProjectionMatrix();var wr=new _(55,1.4,.1,100);wr.position.set(2.2,3.4,11.5),wr.lookAt(0,2,0);var Tr=new L(1024,720,{minFilter:u,magFilter:u,depthBuffer:!0,stencilBuffer:!1});Z.setCityTexture(Tr.texture);var Er=new L(512,320,{minFilter:u,magFilter:u,depthBuffer:!0,stencilBuffer:!1});Z.setVignetteTexture(Er.texture);var Dr=new L(G.x,G.y,{minFilter:u,magFilter:u,depthBuffer:!1,stencilBuffer:!1}),Or=new L(G.x,G.y,{minFilter:u,magFilter:u,depthBuffer:!1,stencilBuffer:!1}),kr=new g({vertexShader:r,fragmentShader:gn,uniforms:{uCity:{value:Dr.texture},uOffice:{value:Or.texture},uT:{value:0},uFocus:{value:new N(.5,.5)}}}),Q=`city`,Ar=0,jr=4.6;window.__scene=Q;var Mr=null;function Nr(e){Q===`city`&&(kr.uniforms.uFocus.value.copy(e||new N(.5,.5)),Q=`diving-in`,window.__scene=Q)}function Pr(){Q!==`office`&&Q!==`diving-in`||(Q=`diving-out`,window.__scene=Q)}var Fr=!1,Ir=(()=>{if(typeof document>`u`)return{showLap(){},toast(){},flash(){}};let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.className=`lap`,t.innerHTML=`<div class="lap-win"><div class="lap-bar"><b>PORTFOLIO OS — John's Game</b>
    ...
    </div></div>`;let n=document.createElement(`div`);n.className=`otoast`;let r=document.createElement(`div`);r.className=`oflash`,document.body.append(t,n,r),t.querySelector(`.lap-x`).addEventListener(`click`,()=>Rr()),t.addEventListener(`click`,e=>{e.target===t&&Rr()});let i=0;return{showLap(e){t.classList.toggle(`on`,e)},toast(e){n.textContent=e,n.classList.add(`on`),clearTimeout(i),i=setTimeout(()=>n.classList.remove(`on`),1400)},flash(){r.style.transition=`none`,r.style.opacity=`0.85`,requestAnimationFrame(()=>{r.style.transition=`opacity .55s`,r.style.opacity=`0`})}}})();function Lr(){Fr=!0,Ir.showLap(!0)}function Rr(){Fr=!1,Ir.showLap(!1)}function zr(){Hn=(Hn+1)%Ze.length,Ir.flash(),Qn(),Ir.toast(`✈  `+Y.state.profile.name),window.__profile=Y.state.profile.key}function Br(e){let t=Z.setFitout(e);return Ir.toast(t===`basement`?`🏚  Basement office`:`🏙  Corner office`),window.__tier=t,t}function Vr(){return Br(Z.tier===`corner`?`basement`:`corner`)}window.__tier=Z.tier;function Hr(e,t){Rn.visible=!1,W.setRenderTarget(Mn),W.render(K,e),Rn.visible=!0,W.setRenderTarget(t),W.render(K,e)}function Ur(e,t){if(Rn.visible=!1,W.setRenderTarget(Mn),W.render(K,q.camera),Rn.visible=!0,$===1||Yr&&$!==7&&$!==8)W.setRenderTarget(t),W.render(K,q.camera);else if(W.setRenderTarget(er),W.render(K,q.camera),$===2)sr.uniforms.uGrain.value=1,sr.uniforms.uChroma.value=1,Cr(sr,t);else{sr.uniforms.uGrain.value=0,sr.uniforms.uChroma.value=0,Cr(sr,tr);let n=q.camera;xr.uniforms.uNear.value=n.near,xr.uniforms.uFar.value=n.far,xr.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(vr(e.era),mr):br();e.kind===`pixel`?(Cr(r,t),window.__style=`pixel`):e.kind===`toon`?(Cr(xr,t),window.__style=`toon`):(Cr(xr,nr),Cr(r,rr),Sr.uniforms.uBlend.value=e.blend,Cr(Sr,t),window.__style=`blend`)}}var Wr=.3,Gr=.46,Kr=.62,qr=.8,$=3,Jr=!1,Yr=!1;window.__mode=$,window.__camMode=q.mode,window.__vector=Yr,window.addEventListener(`keydown`,e=>{(e.key===`1`||e.key===`2`||e.key===`3`)&&($=Number(e.key),window.__mode=$),(e.key===`7`||e.key===`8`)&&($=Number(e.key),window.__mode=$),e.key===`4`&&(q.setMode(B.PERSPECTIVE),window.__camMode=q.mode),e.key===`5`&&(q.setMode(B.ISOMETRIC),window.__camMode=q.mode),e.key===`6`&&(q.setMode(B.DIMETRIC),window.__camMode=q.mode),e.key===`ArrowLeft`&&(q.pan(-1,0),e.preventDefault()),e.key===`ArrowRight`&&(q.pan(1,0),e.preventDefault()),e.key===`ArrowUp`&&(q.pan(0,1),e.preventDefault()),e.key===`ArrowDown`&&(q.pan(0,-1),e.preventDefault()),e.key===`0`&&(Yr=!Yr,Pe.value=+!!Yr,window.__vector=Yr),(e.key===`w`||e.key===`W`)&&(X.cycle(),window.__weather=X.kind),(e.key===`k`||e.key===`K`)&&(Jn=(Jn+1)%qn.length,window.__season=qn[Jn]),(e.key===`g`||e.key===`G`)&&(Vn=Math.random()*1e9|0,Qn()),(e.key===`c`||e.key===`C`)&&(Hn=(Hn+1)%Ze.length,Qn()),(e.key===`h`||e.key===`H`)&&(Zn=!Zn,window.__shadows=Zn),(e.key===`p`||e.key===`P`)&&(Jr=!Jr),(e.key===`b`||e.key===`B`)&&(_r=gr[(gr.indexOf(_r)+1)%gr.length],window.__era=_r,yr()),(e.key===`t`||e.key===`T`)&&J.cyclePreset(),e.key===`[`&&J.nudge(-.5),e.key===`]`&&J.nudge(.5),e.key===`9`&&(J.toggleAuto(),window.__auto=J.auto),e.key===`Escape`&&(Fr?Rr():Pr()),(e.key===`o`||e.key===`O`)&&(Q===`city`?Nr():Pr()),(e.key===`f`||e.key===`F`)&&Q!==`city`&&Vr(),(e.key===`m`||e.key===`M`)&&Mr&&Mr.toggle()});var Xr=window.matchMedia(`(prefers-reduced-motion: reduce)`);J.setReducedMotion(Xr.matches),Xr.addEventListener(`change`,e=>J.setReducedMotion(e.matches));var Zr=new T,Qr=new N,$r=!1,ei=!1,ti=0,ni=0,ri=.005,ii=(e,t)=>{Qr.x=e/window.innerWidth*2-1,Qr.y=-(t/window.innerHeight)*2+1},ai=0,oi=0,si=0;function ci(){return Zr.setFromCamera(Qr,q.camera),Zr.intersectObject(Y.group,!0)[0]?new N(Qr.x*.5+.5,Qr.y*.5+.5):null}function li(){Zr.setFromCamera(Qr,Z.camera);let e=Zr.intersectObjects(Z.interactables,!0)[0];if(!e)return null;let t=e.object;for(;t&&!t.userData.role;)t=t.parent;return t?t.userData.role:null}W.domElement.addEventListener(`contextmenu`,e=>e.preventDefault()),W.domElement.addEventListener(`mousedown`,e=>{e.button===0&&($r=Q===`city`,ii(e.clientX,e.clientY),ai=e.clientX,oi=e.clientY,si=performance.now()),e.button===2&&(ei=!0,ti=e.clientX,ni=e.clientY)}),window.addEventListener(`mousemove`,e=>{$r&&ii(e.clientX,e.clientY),ei?(q.orbit(-(e.clientX-ti)*ri,-(e.clientY-ni)*ri),ti=e.clientX,ni=e.clientY):Q===`city`&&!$r?(ii(e.clientX,e.clientY),W.domElement.style.cursor=ci()?`pointer`:`default`):Q===`office`&&(ii(e.clientX,e.clientY),W.domElement.style.cursor=li()?`pointer`:`default`)}),window.addEventListener(`mouseup`,e=>{let t=Math.hypot(e.clientX-ai,e.clientY-oi)<6&&performance.now()-si<350;if($r&&Q===`city`&&t){ii(e.clientX,e.clientY);let t=ci();t&&Nr(t)}else if(Q===`office`&&t&&!Fr){ii(e.clientX,e.clientY);let t=li();t===`laptop`?Lr():t===`phone`?zr():t===`cat`?Z.petCat():t===`tank`&&Z.feedFish()}$r=!1,ei=!1}),W.domElement.addEventListener(`wheel`,e=>{e.preventDefault(),q.zoomBy(Math.exp(e.deltaY*.0015))},{passive:!1});var ui=0,di=(e,t)=>[(e.clientX+t.clientX)/2,(e.clientY+t.clientY)/2],fi=(e,t)=>Math.hypot(e.clientX-t.clientX,e.clientY-t.clientY),pi=!1;W.domElement.addEventListener(`touchstart`,e=>{e.touches.length===1&&($r=Q===`city`,ii(e.touches[0].clientX,e.touches[0].clientY),ai=e.touches[0].clientX,oi=e.touches[0].clientY,si=performance.now(),pi=!1),e.touches.length===2&&($r=!1,ei=!0,[ti,ni]=di(e.touches[0],e.touches[1]),ui=fi(e.touches[0],e.touches[1]))},{passive:!1}),W.domElement.addEventListener(`touchmove`,e=>{if(e.preventDefault(),e.touches.length===1)ii(e.touches[0].clientX,e.touches[0].clientY),Math.hypot(e.touches[0].clientX-ai,e.touches[0].clientY-oi)>8&&(pi=!0);else if(e.touches.length===2){let[t,n]=di(e.touches[0],e.touches[1]);q.orbit(-(t-ti)*ri,-(n-ni)*ri),ti=t,ni=n;let r=fi(e.touches[0],e.touches[1]);ui>0&&q.zoomBy(ui/r),ui=r}},{passive:!1}),window.addEventListener(`touchend`,e=>{if(!pi&&performance.now()-si<350&&(!e.touches||e.touches.length===0)){if(Q===`city`){let e=ci();e&&Nr(e)}else if(Q===`office`&&!Fr){let e=li();e===`laptop`?Lr():e===`phone`?zr():e===`cat`?Z.petCat():e===`tank`&&Z.feedFish()}}$r=!1,ei=!1,ui=0,e.touches&&e.touches.length===1&&($r=!0)});var mi=new a;mi.connect(document);var hi=0,gi=performance.now();function _i(){if($===1||$===2)return{kind:`none`};if($===7)return{kind:`pixel`};if($===8)return{kind:`toon`};let e=q.styleT;return window.__styleT=e,e<=Wr?{kind:`toon`}:e>=Gr?{kind:`pixel`,era:e<Kr?`16-bit`:e<qr?`8-bit`:`gb`}:{kind:`blend`,blend:b.smoothstep(e,Wr,Gr),era:`16-bit`}}var vi={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};function yi(e){return $===1||$===2?``:Yr&&$!==7&&$!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?vi[e.era||_r]||`Pixel`:e.kind===`blend`?`Toon → `+(vi[e.era]||`Pixel`):``}var bi=yn?null:document.querySelector(`.hint`);if(yn){let e=document.querySelector(`.hint`);e&&(e.style.display=`none`)}var xi=bi?bi.textContent:``,Si=``,Ci=``;function wi(e){!bi||e===Si||(Si=e,bi.textContent=`${xi} · ${Ci} · ${e}`)}function Ti(){Ci=`seed ${Y.state.seed} · ${Y.state.profile.name}`,window.__profile=Y.state.profile.key,Si=``}Ti();function Ei(){mi.update();let e=Math.min(mi.getDelta(),.1);q.update(e),In.material.uniforms.uTime.value=mi.getElapsed(),sr.uniforms.uTime.value=mi.getElapsed(),J.update(e),Y.key.position.copy(J.sunDir).multiplyScalar(Xn),Y.key.color.copy(J.sunColor),Y.key.intensity=J.sunIntensity,Y.fill.color.copy(J.hemiSky),Y.fill.groundColor.copy(J.hemiGround),zn.value=J.windowGlow;let t=X.overcast;Y.key.intensity*=1-.5*t,Y.key.color.lerp(Sn,.45*t),Y.fill.intensity=1+.7*t;let n=b.smoothstep(J.sunDir.y,.06,.34),r=b.lerp(.28,1,1-J.windowGlow),i=Zn?n*r:0;Y.key.shadow.intensity=.72*i,Ie.value=.52*i;let a=1-J.windowGlow;Fe.setRGB(b.lerp(.46,1,a),b.lerp(.52,1,a),b.lerp(.74,1,a)),sr.uniforms.uExposure.value=J.exposure,xr.uniforms.uToonGain.value=J.toonGain,W.setClearColor(J.horizon,1),pr(J.t),wi(J.clock),window.__t=J.t,Wn.update(e,mi.getElapsed(),J),Y.update(mi.getElapsed()),Gn.update(e,mi.getElapsed(),J),jn.uniforms.uWakeCount.value=Gn.wakeCount,X.update(e,mi.getElapsed()),jn.uniforms.uRainCount.value=X.rainDropCount;let o=X.fog*(1-a);K.fog.density=X.fog*Cn,Tn.copy(J.horizon).lerp(wn,.85*o),K.fog.color.copy(Tn),W.setClearColor(Tn,1),Be.value=X.fog,In.material.uniforms.uFogAmt.value=.7*X.fog,Le.value=X.snow,Re.value=X.cloud*.55,ze.x+=e*.018,ze.y+=e*.009,Ve.value+=(qn[Jn]-Ve.value)*Math.min(1,e*1.5),Kn.update(e,mi.getElapsed(),J,X);let s=_i(),c=s.kind===`toon`?1:s.kind===`blend`?1-s.blend:0;Ln.uniforms.uChromaScale.value=b.lerp(1,.5,c),Mr&&Mr.setStyleHint(Q===`city`?yi(s):``),hi++;let l=performance.now();l-gi>=1e3&&(window.__fps=hi,hi=0,gi=l);let u=0;if($r&&Q===`city`){Zr.setFromCamera(Qr,q.camera);let e=Zr.intersectObject(Rn)[0];e&&e.uv&&(jn.uniforms.uMouse.value.copy(e.uv),u=.06)}jn.uniforms.uMouseStrength.value=u;let[d,f,p]=On;jn.uniforms.uPrev.value=d.texture,jn.uniforms.uCurr.value=f.texture,W.setRenderTarget(p),W.render(kn,An),On=[f,p,d],Ln.uniforms.uHeight.value=On[1].texture,Ar+=(+(Q===`office`||Q===`diving-in`)-Ar)*Math.min(1,e*jr),Q===`diving-in`&&Ar>.992&&(Ar=1,Q=`office`,window.__scene=Q),Q===`diving-out`&&Ar<.008&&(Ar=0,Q=`city`,window.__scene=Q),Q===`city`?Ur(s,null):(Z.update(e,mi.getElapsed(),J),Z.tier===`basement`?(W.setRenderTarget(Er),W.render(Z.vignette.scene,Z.vignette.camera)):Hr(wr,Tr),Q===`office`?(W.setRenderTarget(null),W.render(Z.scene,Z.camera)):(Ur(s,Dr),W.setRenderTarget(Or),W.render(Z.scene,Z.camera),kr.uniforms.uT.value=Ar,Cr(kr,null))),requestAnimationFrame(Ei)}var Di={at:(e,t)=>{ii(e,t),$r=!0},stop:()=>{$r=!1}};function Oi(){let e=window.__style||($===1?`raw`:$===2?`filmic`:`auto`);return{lesson:23,clock:J.clock,style:(Yr?`vec-`:``)+e,profile:Y.state.profile.key,weather:X.kind,scene:Q}}Ht({renderer:W,rig:q,sunRig:J,poke:Di,getState:Oi,office:{pet:()=>Z.petCat(),feed:()=>Z.feedFish(),laptop:()=>Lr(),closeLaptop:()=>Rr(),travel:()=>zr(),fitout:()=>Vr()}});var ki=e=>window.dispatchEvent(new KeyboardEvent(`keydown`,{key:e})),Ai={cam:e=>ki({iso:`5`,dimetric:`6`,persp:`4`}[e]),style:e=>{e===`auto`?(ki(`3`),Yr&&ki(`0`)):e===`vector`?(Yr||ki(`0`),($===7||$===8)&&ki(`2`)):e===`pixel`?ki(`7`):e===`toon`&&ki(`8`)},era:()=>ki(`b`),city:()=>ki(`C`),shuffle:()=>ki(`G`),weather:()=>ki(`W`),season:()=>ki(`K`),office:()=>ki(`o`),time:e=>J.goTo(e),auto:()=>ki(`9`)};Mr=Gt({controls:Ai,state:()=>({cam:{4:`persp`,5:`iso`,6:`dimetric`}[q.mode],style:$===7?`pixel`:$===8?`toon`:Yr?`vector`:`auto`,era:_r,auto:J.auto,t:J.t,weather:X.kind,season:Jn,office:Q!==`city`}),show:vn.get(`ui`)!==`0`&&!vn.has(`capture`),coarse:window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches});var ji=vn.get(`cam`);ji&&[`iso`,`dimetric`,`persp`].includes(ji)&&Ai.cam(ji);var Mi=vn.get(`style`);[`vector`,`pixel`,`toon`].includes(Mi)&&Ai.style(Mi);var Ni=vn.get(`t`);Ni!==null&&Ni!==``&&!Number.isNaN(parseFloat(Ni))&&J.goTo(parseFloat(Ni));var Pi=vn.get(`time`);Pi&&J.goTo({dawn:.25,noon:.5,dusk:.75,night:0}[Pi]??.5);var Fi=vn.get(`weather`);[`clear`,`rain`,`snow`,`fog`].includes(Fi)&&(X.setKind(Fi),window.__weather=X.kind);var Ii=vn.get(`office`);(Ii===`1`||Ii===`corner`||Ii===`basement`)&&(Ii===`basement`&&Br(`basement`),Q=`office`,Ar=1,window.__scene=Q),Ei(),window.addEventListener(`resize`,()=>{q.setViewport(window.innerWidth,window.innerHeight),W.setSize(window.innerWidth,window.innerHeight);let e=W.getDrawingBufferSize(new N);Mn.setSize(e.x,e.y),er.setSize(e.x,e.y),tr.setSize(e.x,e.y),nr.setSize(e.x,e.y),rr.setSize(e.x,e.y),Dr.setSize(e.x,e.y),Or.setSize(e.x,e.y),Z.camera.aspect=window.innerWidth/window.innerHeight,Z.camera.updateProjectionMatrix(),Ln.uniforms.uResolution.value.set(e.x,e.y),sr.uniforms.uResolution.value.set(e.x,e.y),fr.uniforms.uResolution.value.set(e.x,e.y),mr.uniforms.uResolution.value.set(e.x,e.y),xr.uniforms.uResolution.value.set(e.x,e.y)});