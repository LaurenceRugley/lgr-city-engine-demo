import{A as e,B as t,C as n,D as r,E as i,G as a,H as o,I as s,J as c,K as l,L as u,M as d,N as f,O as p,P as m,Q as h,R as g,T as _,U as v,V as y,W as b,X as x,Y as S,_ as C,_t as w,b as T,bt as E,c as D,ct as O,d as k,dt as A,et as j,f as ee,ft as M,g as N,ht as te,i as ne,j as P,k as F,l as re,lt as ie,m as ae,mt as I,n as oe,nt as se,o as ce,p as le,q as L,r as ue,rt as de,s as R,st as z,t as fe,tt as B,u as V,ut as pe,v as H,w as U,x as me,xt as W,y as he,yt as G,z as ge}from"./three-fptASJPj.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var _e=(e,t,n,r)=>e+(t-e)*(1-Math.exp(-n*r)),ve=(e,t,n)=>e<t?t:e>n?n:e,ye=Math.atan(1/Math.SQRT2),be=Math.atan(.5),xe=Math.PI/4,Se={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},Ce=8,we=.03,K=1.45,q=4,Te=40,J=1.5,Ee=16,De=6,Y=22,Oe=3.5,ke=11,Ae=(e,t,n)=>_e(e,t,Ce,n),je=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function Me({aspect:e,fov:n=48,near:r=.1,far:i=100,target:a=new E(0,.8,0),azimuth:o=xe,elevation:s=.52,distance:l=12,zoom:u=5.5}={}){let d=new x(n,e,r,i),f=new c(-1,1,1,-1,r,i),p=Se.PERSPECTIVE,m=e,h={azimuth:o,elevation:s,distance:l,zoom:u,target:a.clone()},g={azimuth:o,elevation:s,distance:l,zoom:u,target:a.clone()},_=!1,v=null,y=new E,b=()=>p===Se.PERSPECTIVE?d:f;function S(e){e!==p&&(p=e,p===Se.ISOMETRIC||p===Se.DIMETRIC?(h.elevation=p===Se.ISOMETRIC?ye:be,h.azimuth=je(xe,g.azimuth),_=!0):_=!1)}function C(e,n){h.azimuth+=e,_||(h.elevation=t.clamp(h.elevation+n,we,K))}function w(e){p===Se.PERSPECTIVE?h.distance=t.clamp(h.distance*e,q,Te):h.zoom=t.clamp(h.zoom*e,J,Ee)}function T(e,t){let n=h.azimuth,r=p===Se.PERSPECTIVE?h.distance*.04:h.zoom*.08,i=new E(Math.cos(n),0,-Math.sin(n)),a=new E(-Math.sin(n),0,-Math.cos(n));h.target.addScaledVector(i,e*r),h.target.addScaledVector(a,t*r)}function D(e,t){m=e/t,d.aspect=m,d.updateProjectionMatrix()}function O(e){v&&(v(y),h.target.copy(y)),g.azimuth=Ae(g.azimuth,h.azimuth,e),g.elevation=Ae(g.elevation,h.elevation,e),g.distance=Ae(g.distance,h.distance,e),g.zoom=Ae(g.zoom,h.zoom,e),g.target.x=Ae(g.target.x,h.target.x,e),g.target.y=Ae(g.target.y,h.target.y,e),g.target.z=Ae(g.target.z,h.target.z,e);let t=Math.cos(g.elevation),n=Math.sin(g.elevation),r=Math.cos(g.azimuth),i=Math.sin(g.azimuth),a=b();if(a.position.set(g.target.x+g.distance*t*i,g.target.y+g.distance*n,g.target.z+g.distance*t*r),a.lookAt(g.target),a.isOrthographicCamera){let e=g.zoom,t=e*m;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function k(e,t,n,r=!1){h.target.set(e,t,n),r&&g.target.copy(h.target)}function A(e,n=!1){h.zoom=t.clamp(e,J,Ee),n&&(g.zoom=h.zoom)}function j(e,t=!1){h.azimuth=je(e,g.azimuth),t&&(g.azimuth=h.azimuth)}function ee(e,n=!1){h.elevation=t.clamp(e,we,K),n&&(g.elevation=h.elevation)}function M(e,{frame:n,snap:r=!1}={}){v=e,r&&(v(y),h.target.copy(y),g.target.copy(y)),n!=null&&(p===Se.PERSPECTIVE?h.distance=t.clamp(n,q,Te):h.zoom=t.clamp(n,J,Ee))}function N(){v=null}return{get camera(){return b()},get mode(){return p},get azimuth(){return g.azimuth},get following(){return!!v},setTarget:k,setZoom:A,setFollow:M,clearFollow:N,setAzimuth:j,setElevation:ee,get styleT(){return p===Se.PERSPECTIVE?t.clamp((g.distance-De)/(Y-De),0,1):t.clamp((g.zoom-Oe)/(ke-Oe),0,1)},setMode:S,orbit:C,zoomBy:w,pan:T,setViewport:D,update:O}}var Ne={value:0},Pe=new N(`#ffffff`),Fe={value:0},Ie={value:0},Le={value:0},Re=new G,ze={value:0},Be={value:0},Ve=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
`;function He(e){e.uniforms.uVector=Ne,e.uniforms.uVecTint={value:Pe},e.uniforms.uVecShadow=Fe,e.uniforms.uSnow=Ie,e.uniforms.uCloud=Le,e.uniforms.uCloudOff={value:Re},e.uniforms.uFogCharm=ze}function Ue(e){return e.replace(`#include <fog_fragment>`,`
    ...
    #endif
  `)}function X(e){return e.replace(`#include <common>`,`#include <common>
varying vec3 vVecN;
varying vec3 vVecP;
...
#include <shadowmask_pars_fragment>`)}var Ge=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Ke(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new N(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{He(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new N(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=X(e.vertexShader),e.fragmentShader=Ue(We(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function Z(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{He(e),s||(e.uniforms.uVecColor={value:new N(t)}),c&&(e.uniforms.uGlow={value:new N(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=Be),e.vertexShader=X(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
`:``),f=c?`uGlow * mix(uGlowDay, uGlowNight, uWindowGlow)`:`vec3(0.0)`,p=Ue(We(e.fragmentShader.replace(`#include <common>`,`#include <common>
...
void main() {
  ...
  gl_FragColor = vec4(st.x, Snew, 0.0, 0.0);
}`;function zn({renderer:e,N:t,cell:n,half:r,worldSize:o,seaY:s=0,FLOW:u,DAMP:d,MIN_DEPTH:f,KC:p,KE:m,KD:g,KADV:_,MAXD:y,readTerrain:b}){let x=e.getContext();if(!(x&&x.getExtension&&x.getExtension(`EXT_color_buffer_float`)))return typeof console<`u`&&console.warn(`[L87] EXT_color_buffer_float unavailable — GPU flow backend cannot run; staying on CPU.`),null;let S={type:i,format:de,minFilter:l,magFilter:l,wrapS:ae,wrapT:ae,depthBuffer:!1,stencilBuffer:!1},C=[new W(t,t,S),new W(t,t,S)],w=[new W(t,t,S),new W(t,t,S)],T=[new W(t,t,S),new W(t,t,S)],k=new Float32Array(t*t*4),j=new he(k,t,t,de,i);j.minFilter=l,j.magFilter=l,j.wrapS=j.wrapT=ae;let ee=new Float32Array(t*t),M=!1,te=1,ne=!0,P=new O,F=new c(-1,1,1,-1,0,1),I=new v(new h(2,2),null);I.frustumCulled=!1,P.add(I);let oe=new G(1/t,1/t),se=(e,t)=>new ie({vertexShader:jn,fragmentShader:e,uniforms:t}),ce=se(Mn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:oe},uN:{value:t},uDt:{value:0},uFlow:{value:u},uDamp:{value:d}}),le=se(Nn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:oe},uN:{value:t},uDt:{value:0},uSeaY:{value:s}}),L=se(Pn,{uState:{value:null},uTerr:{value:null},uN:{value:t},uSeaY:{value:s},uRain:{value:0},uPourCount:{value:0},uPours:{value:Array.from({length:8},()=>new E)},uPourR:{value:new Float32Array(8)}}),ue=se(Fn,{uSrc:{value:j}}),R=()=>({uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:oe},uN:{value:t},uDt:{value:0},uCell:{value:n},uSeaY:{value:s},uKC:{value:p},uKE:{value:m},uKD:{value:g},uMaxD:{value:y},uMinDepth:{value:f},uErosK:{value:te}}),z=se(In,R()),fe=se(Ln,R()),B=se(Rn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:oe},uN:{value:t},uDt:{value:0},uSeaY:{value:s},uKADV:{value:_}});function V(t,n){I.material=t;let r=e.getRenderTarget();e.setRenderTarget(n),e.render(P,F),e.setRenderTarget(r)}let pe=new N;function H(t){let n=e.getRenderTarget(),r=e.getClearAlpha();e.getClearColor(pe),e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1),e.setClearColor(pe,r),e.setRenderTarget(n)}function U(){b(ee);for(let e=0;e<t*t;e++)k[e*4]=ee[e];j.needsUpdate=!0,V(ue,T[0])}function me(){H(C[0]),H(C[1]),H(w[0]),H(w[1])}me();let ge=t*t,_e=new Float32Array(ge*3),ve=new Float32Array(ge*2);for(let e=0;e<t;e++)for(let i=0;i<t;i++){let a=e*t+i;_e[a*3]=i*n-r,_e[a*3+1]=0,_e[a*3+2]=e*n-r,ve[a*2]=(i+.5)/t,ve[a*2+1]=(e+.5)/t}let ye=[];for(let e=0;e<t-1;e++)for(let n=0;n<t-1;n++){let r=e*t+n,i=e*t+n+1,a=(e+1)*t+n,o=(e+1)*t+n+1;ye.push(r,a,i,i,a,o)}let be=new re;be.setAttribute(`position`,new D(_e,3)),be.setAttribute(`aGridUv`,new D(ve,2)),be.setIndex(ye),be.boundingSphere=new A(new E(0,0,0),o);let xe={uStateTex:{value:C[0].texture},uTerrTex:{value:T[0].texture},uMinDepth:{value:f}},Se=new a({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});Se.onBeforeCompile=e=>{e.uniforms.uStateTex=xe.uStateTex,e.uniforms.uTerrTex=xe.uTerrTex,e.uniforms.uMinDepth=xe.uMinDepth,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
varying float vDepth;`).replace(`#include <dithering_fragment>`,`#include <dithering_fragment>
  ...
  gl_FragColor.a *= clamp((vDepth - 0.012) * 7.0, 0.16, 0.86);`)},Se.customProgramCacheKey=()=>`lgr-flow-gpu`;let Ce=new v(be,Se);Ce.frustumCulled=!1,Ce.castShadow=!1,Ce.receiveShadow=!1,Ce.raycast=()=>{},Ce.renderOrder=3,Ce.visible=!1;function we(){xe.uStateTex.value=C[0].texture,xe.uTerrTex.value=T[0].texture}function K(e){e=Math.min(e,1/30),(!M||ne)&&(U(),ne=!1),ce.uniforms.uState.value=C[0].texture,ce.uniforms.uTerr.value=T[0].texture,ce.uniforms.uFlux.value=w[0].texture,ce.uniforms.uDt.value=e,V(ce,w[1]),w.reverse(),le.uniforms.uState.value=C[0].texture,le.uniforms.uTerr.value=T[0].texture,le.uniforms.uFlux.value=w[0].texture,le.uniforms.uDt.value=e,V(le,C[1]),C.reverse(),M&&(z.uniforms.uState.value=C[0].texture,z.uniforms.uTerr.value=T[0].texture,z.uniforms.uFlux.value=w[0].texture,z.uniforms.uDt.value=e,z.uniforms.uErosK.value=te,V(z,T[1]),fe.uniforms.uState.value=C[0].texture,fe.uniforms.uTerr.value=T[0].texture,fe.uniforms.uFlux.value=w[0].texture,fe.uniforms.uDt.value=e,fe.uniforms.uErosK.value=te,V(fe,C[1]),T.reverse(),C.reverse(),B.uniforms.uState.value=C[0].texture,B.uniforms.uTerr.value=T[0].texture,B.uniforms.uFlux.value=w[0].texture,B.uniforms.uDt.value=e,V(B,C[1]),C.reverse()),we()}function q(){L.uniforms.uState.value=C[0].texture,L.uniforms.uTerr.value=T[0].texture,V(L,C[1]),C.reverse(),we()}function Te(e,t,i=.5,a=1.6){(ne||!M)&&(U(),ne=!1);let o=(e+r)/n,s=(t+r)/n,c=Math.max(1,a/n);L.uniforms.uRain.value=0,L.uniforms.uPourCount.value=1,L.uniforms.uPours.value[0].set(o,s,i),L.uniforms.uPourR.value[0]=c,q()}function J(e=.004){(ne||!M)&&(U(),ne=!1),L.uniforms.uPourCount.value=0,L.uniforms.uRain.value=e,q()}function Ee(){me(),ne=!0,we()}function De(e,t){M=!!e,t!=null&&(te=Math.max(0,t)),ne=!0}let Y=new Float32Array(t*t*4);function Oe(n){return e.readRenderTargetPixels(n,0,0,t,t,Y),Y}function ke(){let e=Oe(C[0]),n=0;for(let r=0;r<t*t;r++)n+=e[r*4];return n}function Ae(e,i){let a=Math.round((e+r)/n),o=Math.round((i+r)/n);return a<0||a>=t||o<0||o>=t?0:Oe(C[0])[(o*t+a)*4]}function je(){let e=Oe(C[0]),n=0;for(let r=0;r<t*t;r++)n+=e[r*4+1];return n}function Me(){let e=Oe(C[0]),n=new Float32Array(t*t);for(let r=0;r<t*t;r++)n[r]=e[r*4];return n}function Ne(){let e=Oe(T[0]),n=new Float32Array(t*t);for(let r=0;r<t*t;r++)n[r]=e[r*4];return n}function Pe(e){Ce.visible=!!e}function Fe(){for(let e of C)e.dispose();for(let e of w)e.dispose();for(let e of T)e.dispose();j.dispose(),be.dispose(),Se.dispose(),I.geometry.dispose(),ce.dispose(),le.dispose(),L.dispose(),ue.dispose(),z.dispose(),fe.dispose(),B.dispose()}return{mesh:Ce,step:K,pourAt:Te,rain:J,clear:Ee,totalWater:ke,cellAt:Ae,totalSediment:je,readW:Me,readTerr:Ne,setErosion:De,setVisible:Pe,dispose:Fe,get grid(){return t},get erosion(){return M}}}function Bn({worldHeightAt:e,applyErosion:t=null,syncErodedTerrain:n=null,worldSize:r=26,grid:i=96,seaY:o=0,renderer:s=null}={}){let c=i,l=new Float32Array(c*c),u=new Float32Array(c*c),d=new Float32Array(c*c),f=new Float32Array(c*c),m=new Float32Array(c*c),h=new Float32Array(c*c),g=new Float32Array(c*c),_=new Float32Array(c*c),y=new Float32Array(c*c),b=!1,x=1,S=r/(c-1),C=r/2,w=e||(()=>0),T=e=>e*S-C,E=e=>e*S-C,O=(e,t)=>t*c+e,k=26*S,A=.9,j=.006,ee=.5,M=.25,N=.3,te=.006;function ne(){for(let e=0;e<c;e++)for(let t=0;t<c;t++)h[O(t,e)]=w(T(t),E(e))}let P=`cpu`,F=null,ie=new Float32Array(c*c),ae=0;function I(e){ne();for(let t=0;t<c*c;t++)e[t]=h[t]}function oe(){return F||!s?F:(F=zn({renderer:s,N:c,cell:S,half:C,worldSize:r,seaY:o,FLOW:k,DAMP:A,MIN_DEPTH:j,KC:ee,KE:M*3,KD:N*3,KADV:6,MAXD:te*3,readTerrain:I}),F&&ge.add(F.mesh),F)}function se(e){if(e===`gpu`){if(oe(),!F)return typeof console<`u`&&console.info(`[L87] GPU backend unavailable (no renderer / no float RT) — staying on CPU (oracle).`),P=`cpu`,ce(),P;P=`gpu`,F.setErosion(b,x),b&&(I(ie),ae=0)}else P=`cpu`;return ce(),P}function ce(){F&&F.setVisible(P===`gpu`),P===`gpu`?G.visible=!1:_e()}let le=new Float32Array(c*c);function L(){if(++ae<20)return;ae=0;let e=F.readTerr(),t=!1;for(let n=0;n<c*c;n++){let r=e[n]-ie[n];le[n]=r,r!==0&&(t=!0),ie[n]=e[n]}t&&n(le,c)}function ue(e){if(P===`gpu`&&F){F.step(e),b&&n&&L();return}e=Math.min(e,1/30),ne();for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t),i=h[r]+l[r],a=0,o=0,s=0,p=0;n>0&&(a=Math.max(0,u[r]*A+e*k*(i-(h[r-1]+l[r-1])))),n<c-1&&(o=Math.max(0,d[r]*A+e*k*(i-(h[r+1]+l[r+1])))),t>0&&(p=Math.max(0,m[r]*A+e*k*(i-(h[r-c]+l[r-c])))),t<c-1&&(s=Math.max(0,f[r]*A+e*k*(i-(h[r+c]+l[r+c]))));let g=(a+o+s+p)*e,_=g>1e-9?Math.min(1,l[r]/g):1;u[r]=a*_,d[r]=o*_,m[r]=p*_,f[r]=s*_}for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t),i=0;n>0&&(i+=d[r-1]),n<c-1&&(i+=u[r+1]),t>0&&(i+=f[r-c]),t<c-1&&(i+=m[r+c]);let a=u[r]+d[r]+m[r]+f[r];l[r]+=e*(i-a),l[r]<0&&(l[r]=0),h[r]<o-.02&&(l[r]=0)}b&&t&&de(e),_e()}function de(e){y.fill(0);for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t);if(l[r]<=j){if(g[r]>0){let t=Math.min(te,N*g[r]*e);y[r]+=t,g[r]-=t}continue}let i=(u[r]+d[r]+f[r]+m[r])/(l[r]+.02),a=n>0?h[r-1]:h[r],o=n<c-1?h[r+1]:h[r],s=t>0?h[r-c]:h[r],p=t<c-1?h[r+c]:h[r],_=Math.min(2,Math.hypot(o-a,p-s)/(2*S)),v=ee*i*Math.max(.05,_)*x;if(v>g[r]){let t=Math.min(te,M*(v-g[r])*e);y[r]-=t,g[r]+=t}else{let t=Math.min(te,N*(g[r]-v)*e);y[r]+=t,g[r]-=t,g[r]<0&&(g[r]=0)}}_.set(g);for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t),i=u[r]+d[r]+f[r]+m[r];if(i<=1e-9||g[r]<=1e-9)continue;let a=Math.min(g[r],g[r]*6*e);_[r]-=a,n>0&&(_[r-1]+=a*u[r]/i),n<c-1&&(_[r+1]+=a*d[r]/i),t>0&&(_[r-c]+=a*m[r]/i),t<c-1&&(_[r+c]+=a*f[r]/i)}g.set(_);for(let e=0;e<c*c;e++)g[e]<0&&(g[e]=0),h[e]<o-.02&&(g[e]=0);t(y,c)}function R(e,t){b=!!e,t!=null&&(x=Math.max(0,t)),e||g.fill(0),P===`gpu`&&F&&(F.setErosion(e,t),e&&(I(ie),ae=0))}function z(e,t,n=.5,r=1.6){if(P===`gpu`&&F)return F.pourAt(e,t,n,r);let i=(e+C)/S,a=(t+C)/S,o=Math.max(1,r/S),s=Math.max(0,Math.floor(i-o)),u=Math.min(c-1,Math.ceil(i+o)),d=Math.max(0,Math.floor(a-o)),f=Math.min(c-1,Math.ceil(a+o));for(let e=d;e<=f;e++)for(let t=s;t<=u;t++){let r=Math.hypot(t-i,e-a);r<=o&&(l[O(t,e)]+=n*(1-r/o))}}function fe(e=.004){if(P===`gpu`&&F)return F.rain(e);ne();for(let t=0;t<c*c;t++)h[t]>o&&(l[t]+=e)}function B(){if(P===`gpu`&&F)return F.clear();l.fill(0),u.fill(0),d.fill(0),f.fill(0),m.fill(0),g.fill(0),_e()}function V(){if(P===`gpu`&&F)return F.totalWater();let e=0;for(let t=0;t<c*c;t++)e+=l[t];return e}function pe(e,t){if(P===`gpu`&&F)return F.cellAt(e,t);let n=Math.round((e+C)/S),r=Math.round((t+C)/S);return n<0||n>=c||r<0||r>=c?0:l[O(n,r)]}let H=new Float32Array(c*c*3),U=new Float32Array(c*c);for(let e=0;e<c;e++)for(let t=0;t<c;t++){let n=O(t,e);H[n*3]=T(t),H[n*3+1]=-50,H[n*3+2]=E(e)}let me=[];for(let e=0;e<c-1;e++)for(let t=0;t<c-1;t++){let n=O(t,e),r=O(t+1,e),i=O(t,e+1),a=O(t+1,e+1);me.push(n,i,r,r,i,a)}let W=new re;W.setAttribute(`position`,new D(H,3)),W.setAttribute(`aDepth`,new D(U,1)),W.setIndex(me),W.computeVertexNormals();let he=new a({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});he.onBeforeCompile=e=>{e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
attribute float aDepth;
varying float vDepth;`).replace(`#include <begin_vertex>`,`#include <begin_vertex>
  vDepth = aDepth;`),e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>
varying float vDepth;`).replace(`#include <dithering_fragment>`,`#include <dithering_fragment>
  if (vDepth < 0.012) discard;
  gl_FragColor.a *= clamp((vDepth - 0.012) * 7.0, 0.16, 0.86);`)},he.customProgramCacheKey=()=>`lgr-flow`;let G=new v(W,he);G.frustumCulled=!1,G.castShadow=!1,G.receiveShadow=!1,G.raycast=()=>{},G.renderOrder=3;let ge=new p;ge.add(G),ge.raycast=()=>{};function _e(){let e=0;for(let t=0;t<c*c;t++){let n=l[t];U[t]=n,H[t*3+1]=n>j?h[t]+n:-50,n>j&&e++}W.attributes.position.needsUpdate=!0,W.attributes.aDepth.needsUpdate=!0,G.visible=e>0,typeof window<`u`&&(window.__flowWet=e)}_e();function ve(){if(P===`gpu`&&F)return F.totalSediment();let e=0;for(let t=0;t<c*c;t++)e+=g[t];return e}return{group:ge,step:ue,pourAt:z,rain:fe,clear:B,totalWater:V,cellAt:pe,setErosion:R,totalSediment:ve,setBackend:se,get backend(){return P},_debugReadW:()=>P===`gpu`&&F?F.readW():l.slice(),_debugReadTerr:()=>P===`gpu`&&F?F.readTerr():(ne(),h.slice()),_debugReadS:()=>P===`gpu`&&F?F.totalSediment():ve(),_debugStepN:(e,t=1/60)=>{for(let n=0;n<e;n++)ue(t)},get erosion(){return b},get grid(){return c},get visible(){return G.visible}}}function Vn({extent:e=26,count:t=2e3,seed:n=7,yLo:r=.4,yHi:i=7}={}){let a=Ze((n^218462737)>>>0),o=e/2,s=new Float32Array(t*3),c=new Float32Array(t),l=new Float32Array(t);for(let e=0;e<t;e++)s[e*3]=(a()*2-1)*o,s[e*3+1]=r+a()*(i-r),s[e*3+2]=(a()*2-1)*o,c[e]=a()*Math.PI*2,l[e]=.6+a()*.8;let u=new re;u.setAttribute(`position`,new D(s,3)),u.setAttribute(`aPh`,new D(c,1)),u.setAttribute(`aSp`,new D(l,1)),u.setDrawRange(0,t);let d={uTime:{value:0},uWind:{value:0},uHalf:{value:o},uOpacity:{value:0},uColor:{value:new N(`#fff3d4`)},uPx:{value:2.2}},f=new ie({uniforms:d,transparent:!0,depthWrite:!1,depthTest:!0,blending:2,vertexShader:`
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Ci={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},wi=[`gb`,`8-bit`,`16-bit`,`modern`],Ti={"ink-gold (day)":[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],"ink-gold (night)":[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],"terminal (day)":[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],"terminal (night)":[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],"neutral (photoreal)":[`#1B1B1E`,`#3D3A3A`,`#5E5750`,`#867C70`,`#A99C8A`,`#C8BCAB`,`#E3DCCF`,`#F5F1E8`],"cool (noir)":[`#0A0E14`,`#16202E`,`#243447`,`#3A536B`,`#5A7D96`,`#86A6BD`,`#B6CDDA`,`#E6EEF2`],"warm (sunset)":[`#190B0A`,`#3B150F`,`#6E2A17`,`#A8421F`,`#DB702F`,`#F2A23E`,`#F9CF76`,`#FDF0C4`],"vibrant (pop)":[`#1A1A2E`,`#E43F5A`,`#F9A826`,`#FFE05D`,`#2EC4B6`,`#3A86FF`,`#8338EC`,`#FFFFFF`],"mono (ink)":[`#0C0C0C`,`#2A2A2A`,`#474747`,`#666666`,`#8A8A8A`,`#B0B0B0`,`#D6D6D6`,`#F5F5F5`]};function Ei(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new N(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new he(n,t,1,de,i);return r.minFilter=l,r.magFilter=l,r.needsUpdate=!0,r}function Di(e,t){let n=[];for(let t=0;t+2<e.length;t+=3)n.push([e[t],e[t+1],e[t+2]]);if(n.length===0)return[`#000000`];let r=e=>{let t=[255,255,255],n=[0,0,0];for(let r of e)for(let e=0;e<3;e++)t[e]=Math.min(t[e],r[e]),n[e]=Math.max(n[e],r[e]);let r=[n[0]-t[0],n[1]-t[1],n[2]-t[2]],i=r[0]>=r[1]&&r[0]>=r[2]?0:r[1]>=r[2]?1:2;return{ax:i,range:r[i]}},i=[n];for(;i.length<t;){let e=-1,t=-1;if(i.forEach((n,i)=>{if(n.length>1){let{range:a}=r(n);a>t&&(t=a,e=i)}}),e<0)break;let n=i[e],{ax:a}=r(n);n.sort((e,t)=>e[a]-t[a]);let o=n.length>>1;i.splice(e,1,n.slice(0,o),n.slice(o))}return i.map(e=>{let t=[0,0,0];for(let n of e)for(let e=0;e<3;e++)t[e]+=n[e];return`#`+t.map(t=>Math.round(t/e.length)).map(e=>e.toString(16).padStart(2,`0`)).join(``)})}var Oi=220,ki={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Ai={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function ji(e){if(typeof document>`u`||document.getElementById(`lgr-nowebgl`))return;let t=document.createElement(`div`);t.id=`lgr-nowebgl`,t.style.cssText=`position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;background:#0e1116;color:#cdd6e4;font:16px/1.6 system-ui,-apple-system,sans-serif;text-align:center;padding:2rem;`,t.innerHTML=`<div style="max-width:30rem"><div style="font-size:2.4rem;margin-bottom:1rem">🌊</div><h1 style="font-size:1.3rem;margin:0 0 .6rem;color:#fff;font-weight:600">This experience needs a modern browser</h1><p style="margin:0;color:#9aa6b8">`+e+`</p></div>`,document.body&&document.body.appendChild(t)}function Mi({demo:e=!1,citySeed:n=0,profileIndex:i=0}={}){let o;try{o=new ne({antialias:!0,preserveDrawingBuffer:!0})}catch(e){throw ji(`This experience needs WebGL2 — please open it in an up-to-date browser (Chrome, Edge, Firefox, or Safari on iOS 15+) with hardware acceleration enabled.`),e}o.shadowMap.enabled=!0,o.shadowMap.type=1,o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0;let s=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches),u=s?1.5:2;o.setPixelRatio(Math.min(window.devicePixelRatio,u)),o.setSize(window.innerWidth,window.innerHeight),o.setClearColor(920327,1),document.body.appendChild(o.domElement);let d=o.getDrawingBufferSize(new G),f=!1,p=!1,m=()=>{};o.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),f=!0,typeof window<`u`&&(window.__contextLost=!0)},!1),o.domElement.addEventListener(`webglcontextrestored`,()=>{m(),f=!1,typeof window<`u`&&(window.__contextLost=!1)},!1);let _=new O;_.fog=new r(10465470,0);let x=new N(`#aeb6c0`),S=.062,C=new N(`#74508f`),w=new N,D=Me({aspect:window.innerWidth/window.innerHeight}),k=Ct({t:.5}),A=o.getContext(),j=!!(A&&A.getExtension&&(A.getExtension(`EXT_color_buffer_float`)||A.getExtension(`EXT_color_buffer_half_float`)));!j&&typeof console<`u`&&console.info(`[L90 H1] No float colour buffer (EXT_color_buffer_float/half_float) — wave sim OFF, flat-sea fallback.`);let ee={type:F,format:de,minFilter:l,magFilter:l,wrapS:ae,wrapT:ae,depthBuffer:!1,stencilBuffer:!1},M=j?[new W(256,256,ee),new W(256,256,ee),new W(256,256,ee)]:null;if(M){for(let e of M)o.setRenderTarget(e),o.clear();o.setRenderTarget(null)}let te=new he(new Uint8Array([0,0,0,255]),1,1,de);te.needsUpdate=!0;let P=new O,re=new c(-1,1,1,-1,0,1),I=new ie({vertexShader:jn,fragmentShader:pi,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new G(1/256,1/256)},uMouse:{value:new G(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new E)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new E)}}});P.add(new v(new h(2,2),I));let oe=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1});function se(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new V(t);return r.colorSpace=z,r}let ce=new v(new h(28,28),new b({map:se(e)}));ce.rotation.x=-Math.PI/2,ce.position.y=-.35,_.add(ce);let le=new v(new h(40,24),new ie({depthWrite:!1,vertexShader:di,fragmentShader:fi,uniforms:{uTime:{value:0},uInk:{value:k.horizon},uGold:{value:k.sky},uFogColor:{value:w},uFogAmt:{value:0},uFogCharm:ze}}));le.position.set(0,3,-8),_.add(le);let L=new ie({vertexShader:mi,fragmentShader:hi,uniforms:{uHeight:{value:j?null:te},uScene:{value:oe.texture},uTexel:{value:new G(1/256,1/256)},uResolution:{value:new G(d.x,d.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new y},uLightDir:{value:k.sunDir},uInk:{value:new N(`#2A2218`)},uGold:{value:new N(`#B89968`)},uVector:Ne,uVecWater:{value:new N(`#1fb8d8`)},uVecTint:{value:Pe}}}),ue=new v(new h(28,28,255,255),L);ue.rotation.x=-Math.PI/2,ue.updateMatrixWorld(!0),L.uniforms.uNormalMatrix.value.getNormalMatrix(ue.matrixWorld),_.add(ue);let R={value:0},fe=Xt({windowGlow:R}),B=ht({seed:n,profileIndex:i,landmarkFactory:fe,windowGlow:R});_.add(B.group);let pe=Ot({plinthTop:.3,extent:B.extent,profile:B.state.profile});_.add(pe.group);let H=zt({extent:B.extent,waterSize:28,plinthTop:.3});_.add(H.group),I.uniforms.uWakeDrops.value=H.wakeDrops;let U=Qt({extent:B.extent});_.add(U.group),I.uniforms.uRainDrops.value=U.rainDrops;let me=en({extent:B.extent});_.add(me.group);let ge=[pe,H,me],_e=rn({rig:D,getCamera:()=>D.camera,sources:ge}),ve=ui();_.add(ve.group);let ye=Kr({scale:90});_.add(ye.mesh),_.environmentIntensity=.32;let be=!1;function xe(e){let t=e&&k.sunArc.y>-.04;t!==be&&(be=t,ye.mesh.visible=t,le.visible=!t)}let Se=null,Ce=-1;m=()=>{Se=null,Ce=-1,o.shadowMap.needsUpdate=!0};function we(){let e=Math.floor(k.t%1*4)%4;return(e!==Ce||!Se)&&(Ce=e,Se=ye.buildEnv(o)),Se}let K=null,q=null,Te=null,J=null,Ee=!1,De=1234,Y=`valley`,Oe=nr.map(e=>e.key),ke=new a({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Ae=()=>[B.group,pe.group,H.group],je=()=>[K,q,Te].filter(Boolean);function Ve(){for(let e of je())_.remove(e),e.userData.dispose?.();let e=sr({seed:De,size:160,preset:Y});J=e,K=mr(e,{worldSize:26,baseY:0,chunks:6}),q=zr({terrain:e,seed:De,worldSize:26,baseY:0,biomeKeys:Oe}),Te=Hr(e,{worldSize:26,baseY:0,maxLakes:3,material:ke});for(let e of je())e.visible=Ee,_.add(e);X!==void 0&&X&&X.clear(),Z!==void 0&&Z&&Z.clear(),typeof window<`u`&&(window.__world={seed:De,preset:Y,active:Ee,chunks:K.children.length,scatter:q.userData.counts,lakes:Te.userData.count})}let He=e=>{for(let t of je())t.visible=e};function Ue(e,t){if(!J)return 0;let{size:n,height:r,sea:i,relief:a}=J,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let X=kn({heightAt:Ue,seaSurfaceY:0,waterY:.06});X.group.visible=!1,_.add(X.group),ge.push(X);let We=0;function Ge(e,t){if(!J||!K)return;let{size:n,height:r,relief:i}=J,a=26/(n-1),o=26/(t-1),s=i>1e-6?1/i:0,c=!1;for(let i=0;i<t;i++)for(let l=0;l<t;l++){let u=e[i*t+l];if(u===0)continue;c=!0;let d=u*s,f=l*o/a,p=i*o/a,m=Math.max(0,Math.round(f-1)),h=Math.min(n-1,Math.round(f+1)),g=Math.max(0,Math.round(p-1)),_=Math.min(n-1,Math.round(p+1));for(let e=g;e<=_;e++)for(let t=m;t<=h;t++){let i=e*n+t,a=r[i]+d;r[i]=a<0?0:a>1?1:a}}c&&(We++,We%8==0&&hr(K,J,K.children),We%24==0&&q&&Rr(q,J,{worldSize:26,baseY:0}))}function Ke(e,t){if(!J||!K)return;let{size:n,height:r,relief:i}=J,a=i>1e-6?1/i:0,o=(t-1)/(n-1),s=!1;for(let i=0;i<n;i++){let c=i*o,l=Math.floor(c),u=c-l,d=Math.min(t-1,l+1);for(let c=0;c<n;c++){let f=c*o,p=Math.floor(f),m=f-p,h=Math.min(t-1,p+1),g=e[l*t+p],_=e[l*t+h],v=e[d*t+p],y=e[d*t+h],b=(g*(1-m)+_*m)*(1-u)+(v*(1-m)+y*m)*u;if(b!==0){s=!0;let e=i*n+c,t=r[e]+b*a;r[e]=t<0?0:t>1?1:t}}}s&&(hr(K,J,K.children),q&&Rr(q,J,{worldSize:26,baseY:0}))}let Z=Bn({worldHeightAt:Ue,applyErosion:Ge,syncErodedTerrain:Ke,worldSize:26,grid:96,seaY:0,renderer:o});Z.group.visible=!1,_.add(Z.group);let Xe=Vn({extent:26,count:s?500:2e3});Xe.group.visible=!1,_.add(Xe.group);let Ze=null,Qe=!1,$e=new Set;function et(){!J||!Te||(_.remove(Te),Te.userData.dispose?.(),Te=Hr(J,{worldSize:26,baseY:0,maxLakes:3,material:ke}),Te.visible=Ee&&!Qe,_.add(Te),window.__world&&(window.__world.lakes=Te.userData.count))}function tt(){et(),q&&Rr(q,J,{worldSize:26,baseY:0})}function nt(e,t,n=1,r=2.2,i=.05){if(!J||!K)return;let a=J.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=J.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}$e.clear();for(let e of K.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&$e.add(e)}hr(K,J,$e),Ze&&clearTimeout(Ze),Ze=setTimeout(tt,140)}function rt(e,t,n,r=2.2){if(!J||!K||n==null)return;let i=J.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=J.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);$e.clear();for(let e of K.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&$e.add(e)}hr(K,J,$e,!0)}let it=[`tree`,`rock`,`tuft`];function at(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!J||!q)return 0;if(a)return Ir(q,n||`all`,e,t,i);let o=J.size,s=26/(o-1),c=J.height,l=J.sea,u=J.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Lr[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;Fr(q,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&q.userData.counts)for(let e of it)q.userData.counts[e]=(q.userData.placements[e]||[]).length;return g}let ot=[];function st(){if(!q)return null;let e=q.userData.placements,t={};for(let n of it)t[n]=(e[n]||[]).map(e=>({...e}));return t}function ct(){J&&(ot.push({h:J.height.slice(),b:J.biome.slice(),sc:st(),pl:X.snapshot()}),ot.length>12&&ot.shift())}function lt(){if(!J||!ot.length)return!1;let e=ot.pop();if(J.height.set(e.h),J.biome.set(e.b),e.sc&&q){let t=q.userData.placements;for(let n of it)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&X.restore(e.pl),hr(K,J,K.children,!0),tt(),!0}let ut=new Set([`boat`,`fish`]),dt=new Set([`person`,`atv`]);function ft(e,t,n){if(!J)return null;let r=Ue(t,n)<0;return ut.has(e)&&!r||dt.has(e)&&r?null:X.spawn(e,t,n)}function pt(e,t,n=2.5){return X.removeNear(e,t,n)}function mt(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function gt(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let _t=e=>mt(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),vt=e=>mt(e);function yt(){let e=q?q.userData.placements:{},t={};for(let n of it)t[n]=(e[n]||[]).map(e=>({...e}));return t}function bt(){return J?{v:1,seed:De,preset:Y,size:J.size,height:_t(J.height),biome:vt(J.biome),scatter:yt(),entities:X.snapshot()}:null}function xt(){if(!J)return null;let e=sr({seed:De,size:160,preset:Y}),t=J.height,n=J.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:De,preset:Y,hd:r,bd:i,entities:X.snapshot()}}function St(e){q&&(_.remove(q),q.userData.dispose?.()),q=jr(e||{tree:[],rock:[],tuft:[]}),q.userData.counts=it.reduce((e,t)=>(e[t]=(q.userData.placements[t]||[]).length,e),{}),q.visible=Ee,_.add(q)}function wt(e){if(!e||e.v!==1)return!1;let t=25600;if(e.height!=null||e.biome!=null){if(typeof e.height!=`string`||typeof e.biome!=`string`)return!1;let n,r;try{n=gt(e.height),r=gt(e.biome)}catch{return!1}if(n.byteLength%4!=0||n.byteLength>>2!=t||r.length<t)return!1;let i=new Float32Array(n.buffer,n.byteOffset,n.byteLength>>2);for(let e=0;e<i.length;e++)if(!Number.isFinite(i[e]))return!1}if(e.hd!=null&&!Array.isArray(e.hd)||e.bd!=null&&!Array.isArray(e.bd))return!1;if(Array.isArray(e.hd))for(let n=0;n<e.hd.length;n+=2){let r=e.hd[n];if(!Number.isInteger(r)||r<0||r>=t||!Number.isFinite(e.hd[n+1]))return!1}if(Array.isArray(e.bd))for(let n=0;n<e.bd.length;n+=2){let r=e.bd[n];if(!Number.isInteger(r)||r<0||r>=t)return!1}De=e.seed|0,Y=or.includes(e.preset)?e.preset:Y,ot.length=0,Ve(),Ee=!0,He(!0),X.group.visible=!0,Z.group.visible=!0,Xe.group.visible=!0;for(let e of Ae())e.visible=!1;window.__world&&(window.__world.active=!0);let n=e=>e<0?0:e>1?1:e,r=nr.length;if(e.height&&e.biome){let t=gt(e.height),i=new Float32Array(t.buffer,t.byteOffset,t.byteLength>>2);for(let e=0;e<i.length;e++)J.height[e]=n(i[e]);let a=gt(e.biome);for(let e=0;e<J.biome.length;e++)J.biome[e]=Math.min(r-1,a[e]|0)}else if(e.hd||e.bd){let t=e.hd||[],i=e.bd||[];for(let e=0;e<t.length;e+=2)J.height[t[e]]=n(t[e+1]);for(let e=0;e<i.length;e+=2)J.biome[i[e]]=Math.min(r-1,Math.max(0,i[e+1]|0))}return hr(K,J,K.children,!0),e.scatter&&St(e.scatter),et(),q&&Rr(q,J,{worldSize:26,baseY:0}),X.restore(e.entities),window.__world&&(window.__world.scatter=q.userData.counts,window.__world.seed=De,window.__world.preset=Y),!0}let Tt={enter(){K||Ve(),Ee=!0,He(!0),X.group.visible=!0,Z.group.visible=!0,Xe.group.visible=!0;for(let e of Ae())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){Qe=!1,Ee=!1,He(!1),X.group.visible=!1,Z.group.visible=!1,Xe.group.visible=!1;for(let e of Ae())e.visible=!0;window.__world&&(window.__world.active=!1)},setEditing(e){return Qe=!!e,ue.visible=Ee&&!Qe,Te&&(Te.visible=Ee&&!Qe),Z.group.visible=Ee&&!Qe,!Qe&&Ee&&et(),Qe},get editing(){return Qe},get waterHidden(){return Qe&&!ue.visible},reroll(){return De=Math.random()*1e9|0,ot.length=0,Ve(),Tt.enter(),De},reset(){return ot.length=0,Ve(),Tt.enter(),De},setPreset(e){return or.includes(e)&&(Y=e,ot.length=0,Ve(),Tt.enter()),Y},sculpt:nt,paintBiome:rt,paintScatter:at,repoolWater:et,snapshot:ct,undo:lt,placeEntity:ft,removeEntityNear:pt,heightAt:Ue,serialize:bt,serializeCompact:xt,deserialize:wt,flowPourAt:(e,t,n,r)=>Z.pourAt(e,t,n,r),flowRain:e=>Z.rain(e),flowClear:()=>Z.clear(),get flowTotal(){return Z.totalWater()},flowAt:(e,t)=>Z.cellAt(e,t),flowErosion:(e,t)=>Z.setErosion(e,t),get flowErosionOn(){return Z.erosion},get flowSediment(){return Z.totalSediment()},setSimBackend:e=>Z.setBackend(e),get simBackend(){return Z.backend},_flowReadW:()=>Z._debugReadW(),_flowReadTerr:()=>Z._debugReadTerr(),_flowStepN:(e,t)=>Z._debugStepN(e,t),get terrainGroup(){return K},get biomes(){return nr},get scatterCounts(){return q?q.userData.placements&&it.reduce((e,t)=>(e[t]=(q.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return X.counts()},setScatterHidden(e){q&&(q.visible=!e)},get placedLife(){return X},get canUndo(){return ot.length>0},get active(){return Ee},get seed(){return De},get preset(){return Y},get presets(){return or}},Et=Wr(),Dt=Kn({world:Tt,catalog:Et,inspector:_e});function kt(e,t){return Ue(e,t)<0?0:-999}let At=gn({rig:D,world:{heightAt:Ue,waterHeightAt:kt}});B.group.remove(B.key),_.add(B.key),B.key.castShadow=!0,B.key.shadow.mapSize.set(2048,2048),B.key.shadow.bias=-18e-5,B.key.shadow.normalBias=.028,_.add(B.key.target);function jt(){let e=B.key.shadow.camera,t=B.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),o.shadowMap.needsUpdate=!0}jt();let Mt=new T(d.x,d.y),Nt=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1,depthTexture:Mt}),Pt=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Ft=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1,samples:4}),It=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Lt=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Rt=Math.max(1,Math.floor(d.x/2)),Bt=Math.max(1,Math.floor(d.y/2)),Vt=new W(Rt,Bt,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Ht=new W(Rt,Bt,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Q=new O,Ut=new c(-1,1,1,-1,0,1),Wt=new v(new h(2,2));Q.add(Wt);let $=new ie({vertexShader:jn,fragmentShader:gi,uniforms:{uScene:{value:Nt.texture},uTime:{value:0},uResolution:{value:new G(d.x,d.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:Vt.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:k.grade.tint},uGradeLift:{value:k.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1},uDither:{value:0},uTonemap:{value:0}}}),Gt=new ie({vertexShader:jn,fragmentShader:bi,uniforms:{uScene:{value:Nt.texture},uThreshold:{value:.78}}}),Kt=new ie({vertexShader:jn,fragmentShader:xi,uniforms:{uScene:{value:Vt.texture},uDir:{value:new G}}});function qt(e){Gt.uniforms.uScene.value=e.texture,sn(Gt,Vt),Kt.uniforms.uScene.value=Vt.texture,Kt.uniforms.uDir.value.set(1.6/Rt,0),sn(Kt,Ht),Kt.uniforms.uScene.value=Ht.texture,Kt.uniforms.uDir.value.set(0,1.6/Bt),sn(Kt,Vt),$.uniforms.uBloom.value=Vt.texture;let n=1-t.clamp(k.sunArc.y*2.2,0,1);$.uniforms.uBloomStrength.value=.85*(.32+.95*n)}let Jt=e=>{let t=e.map(e=>new N(e));for(;t.length<8;)t.push(new N(0,0,0));return t},Yt=[`night`,`dawn`,`noon`,`dusk`],Zt={inkgold:Yt.map(e=>Jt(ki[e])),terminal:Yt.map(e=>Jt(Ai[e]))},$t=new ie({vertexShader:jn,fragmentShader:_i,uniforms:{uScene:{value:Pt.texture},uResolution:{value:new G(d.x,d.y)},uPixelSize:{value:Oi},uPalette:{value:Zt.inkgold[2]},uPaletteB:{value:Zt.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),tn=new ie({vertexShader:jn,fragmentShader:Si,uniforms:{uScene:{value:Pt.texture},uResolution:{value:new G(d.x,d.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Ei(Ci[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),nn={};for(let e of wi)nn[e]=Ci[e].palette?Ei(Ci[e].palette):null;let an=new ie({vertexShader:jn,fragmentShader:vi,uniforms:{uScene:{value:Pt.texture},uDepth:{value:Mt},uResolution:{value:new G(d.x,d.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:k.toonFloor},uOutline:{value:k.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),on=new ie({vertexShader:jn,fragmentShader:yi,uniforms:{uToon:{value:It.texture},uPixel:{value:Lt.texture},uBlend:{value:0}}});function sn(e,t){Wt.material=e,o.setRenderTarget(t),o.render(Q,Ut)}function cn(){D.setViewport(window.innerWidth,window.innerHeight),o.setSize(window.innerWidth,window.innerHeight);let e=o.getDrawingBufferSize(new G);return oe.setSize(e.x,e.y),Nt.setSize(e.x,e.y),Pt.setSize(e.x,e.y),Ft.setSize(e.x,e.y),It.setSize(e.x,e.y),Lt.setSize(e.x,e.y),Rt=Math.max(1,e.x>>1),Bt=Math.max(1,e.y>>1),Vt.setSize(Rt,Bt),Ht.setSize(Rt,Bt),L.uniforms.uResolution.value.set(e.x,e.y),$.uniforms.uResolution.value.set(e.x,e.y),$t.uniforms.uResolution.value.set(e.x,e.y),tn.uniforms.uResolution.value.set(e.x,e.y),an.uniforms.uResolution.value.set(e.x,e.y),e}let ln=Yn({renderer:o}),un=!0;function dn(e,t){let n=t.dpr==null?u:t.dpr,r=Math.min(window.devicePixelRatio,n);Math.abs(o.getPixelRatio()-r)>.001&&(o.setPixelRatio(r),typeof window<`u`&&window.dispatchEvent?window.dispatchEvent(new Event(`resize`)):cn()),un=t.shadows!==!1,un||(o.shadowMap.needsUpdate=!1)}let fn=Zn({profiler:ln,apply:dn});function pn(){!p&&!f&&ln.frameStart()}function mn(){p||f||(ln.frameEnd(),fn.update())}function hn(e){p=!e,typeof window<`u`&&(window.__paused=p)}function _n(){try{o.compile(_,D.camera),Wn(1/60,0,{shadowsOn:!0}),Rn(zn(),Nt),o.setRenderTarget(null)}catch(e){typeof console<`u`&&console.warn(`[L79] prewarm`,e)}}let vn=3,yn=!1,bn=!1,xn=`native`,Sn=.3,Cn=.46,wn=[`native`,...wi],Tn={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=vn,window.__vector=yn,window.__era=xn),typeof window<`u`&&(window.__frames=0),typeof window<`u`&&(window.__loaded=!1);let En=0,Dn=new E(1,1,1),On=!1;function An(e){let t=bn?Zt.terminal:Zt.inkgold,n=e%1*4,r=Math.floor(n)%4;$t.uniforms.uPalette.value=t[r],$t.uniforms.uPaletteB.value=t[(r+1)%4],$t.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Mn(e){let t=Ci[e];t&&(tn.uniforms.uGridWidth.value=t.gridWidth,tn.uniforms.uDither.value=t.dither,tn.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(tn.uniforms.uPalette.value=nn[e],tn.uniforms.uPaletteSize.value=t.palette.length))}function Nn(){xn!==`native`&&Mn(xn)}let Pn=()=>xn===`native`?$t:tn;function Fn(e,n){xe(!0),_.environment=we(),qe.value=1;let r=t.smoothstep(t.clamp(k.sunArc.y,0,1),.22,.8);B.fill.intensity=In*(1-.6*r),_.environmentIntensity=Ln*(1-.45*r),ve.place(e),ue.visible=!1,o.setRenderTarget(oe),o.render(_,e),ue.visible=!0,o.setRenderTarget(Ft),o.render(_,e),qt(Ft),$.uniforms.uScene.value=Ft.texture,$.uniforms.uAces.value=1,$.uniforms.uGrade.value=1,$.uniforms.uGrain.value=0,$.uniforms.uChroma.value=0,$.uniforms.uDither.value=1,sn($,n),ve.place(D.camera)}let In=1,Ln=.34;function Rn(e,n){let r=!yn&&(vn===1||vn===2);xe(r),_.environment=r?we():null,qe.value=+!!r;let i=t.smoothstep(t.clamp(k.sunArc.y,0,1),.22,.8);if(B.fill.intensity=r?In*(1-.6*i):In,r&&(_.environmentIntensity=Ln*(1-.45*i)),$.uniforms.uBloomStrength.value=0,ue.visible=!1,o.setRenderTarget(oe),o.render(_,D.camera),ue.visible=!Qe,vn===1&&!r)o.setRenderTarget(n),o.render(_,D.camera);else if(vn===1)o.setRenderTarget(Ft),o.render(_,D.camera),qt(Ft),$.uniforms.uScene.value=Ft.texture,$.uniforms.uAces.value=1,$.uniforms.uGrade.value=1,$.uniforms.uGrain.value=0,$.uniforms.uChroma.value=0,$.uniforms.uDither.value=1,sn($,n);else if(o.setRenderTarget(r?Ft:Nt),o.render(_,D.camera),vn===2)r&&qt(Ft),$.uniforms.uScene.value=r?Ft.texture:Nt.texture,$.uniforms.uAces.value=+!!r,$.uniforms.uGrade.value=+!!r,$.uniforms.uGrain.value=1,$.uniforms.uChroma.value=1,$.uniforms.uDither.value=+!!r,sn($,n);else{$.uniforms.uScene.value=Nt.texture,$.uniforms.uAces.value=0,$.uniforms.uGrade.value=0,$.uniforms.uGrain.value=0,$.uniforms.uChroma.value=0,$.uniforms.uDither.value=0,sn($,Pt);let t=D.camera;an.uniforms.uNear.value=t.near,an.uniforms.uFar.value=t.far,an.uniforms.uIsPerspective.value=+!!t.isPerspectiveCamera;let r=e.era?(Mn(e.era),tn):Pn();e.kind===`pixel`?(sn(r,n),window.__style=`pixel`):e.kind===`toon`?(sn(an,n),window.__style=`toon`):(sn(an,It),sn(r,Lt),on.uniforms.uBlend.value=e.blend,sn(on,n),window.__style=`blend`)}}function zn(){let e=Hn(),n=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return L.uniforms.uChromaScale.value=t.lerp(1,.5,n),e}function Hn(){if(vn===1||vn===2)return{kind:`none`};if(vn===7)return{kind:`pixel`};if(vn===8)return{kind:`toon`};let e=D.styleT;return window.__styleT=e,e<=Sn?{kind:`toon`}:e>=Cn?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:t.smoothstep(e,Sn,Cn),era:`16-bit`}}function Un(e){return vn===1||vn===2?``:yn&&vn!==7&&vn!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Tn[e.era||xn]||`Pixel`:e.kind===`blend`?`Toon → `+(Tn[e.era]||`Pixel`):``}function Wn(e,n,{shadowsOn:r=!0,seasonTarget:i=0}={}){typeof window<`u`&&window.__frames++,r&&=un,le.material.uniforms.uTime.value=n,$.uniforms.uTime.value=n,k.update(e),B.key.position.copy(k.sunDir).multiplyScalar(24),B.key.color.copy(k.sunColor),B.key.intensity=k.sunIntensity,B.fill.color.copy(k.hemiSky),B.fill.groundColor.copy(k.hemiGround),R.value=k.windowGlow,ye.setSun(k.sunArc),ye.setParams(k.skyParams),$.uniforms.uGradeSat.value=k.grade.sat,$.uniforms.uGradeContrast.value=k.grade.contrast,_.environmentIntensity=.34*(1-.6*t.clamp(k.sunArc.y*1.5,0,1)),Ln=_.environmentIntensity;let a=U.overcast;B.key.intensity*=1-.5*a,B.key.color.lerp(x,.45*a),B.fill.intensity=1+.7*a,In=B.fill.intensity;let s=t.smoothstep(k.sunDir.y,.06,.34),c=t.lerp(.28,1,1-k.windowGlow),l=r?s*c:0;B.key.shadow.intensity=.72*l,Fe.value=.52*l,(r&&!On||Dn.distanceToSquared(k.sunDir)>2e-5)&&(o.shadowMap.needsUpdate=!0,Dn.copy(k.sunDir)),On=r;let u=1-k.windowGlow;Pe.setRGB(t.lerp(.46,1,u),t.lerp(.52,1,u),t.lerp(.74,1,u)),$.uniforms.uExposure.value=k.exposure,an.uniforms.uToonGain.value=k.toonGain,o.setClearColor(k.horizon,1),An(k.t),window.__t=k.t,pe.update(e,n,k),B.update(n),H.update(e,n,k),I.uniforms.uWakeCount.value=H.wakeCount,U.update(e,n),I.uniforms.uRainCount.value=U.rainDropCount;let d=U.fog*(1-u);_.fog.density=.016+U.fog*S,w.copy(k.horizon).lerp(C,.85*d),_.fog.color.copy(w),o.setClearColor(w,1),ze.value=U.fog,le.material.uniforms.uFogAmt.value=.7*U.fog,Ie.value=U.snow,Le.value=U.cloud*.55,Re.x+=e*.018,Re.y+=e*.009,Be.value+=(i-Be.value)*Math.min(1,e*1.5),Je.value=n,Ye.value=.035+.05*a,me.update(e,n,k,U),Ee&&X.update(e,n,k),Ee&&Z.step(e),Ee&&Xe.update(e,n,k,{wind:.6*U.cloud,qualityLevel:window.__quality&&window.__quality.level||0});let f=Hn(),p=f.kind===`pixel`||f.kind===`blend`?`pixel`:yn?`vector`:f.kind===`toon`?`charm`:`realistic`;if(ve.update(e,n,k,U,p,D.camera),j){let[e,t,n]=M;I.uniforms.uPrev.value=e.texture,I.uniforms.uCurr.value=t.texture,o.setRenderTarget(n),o.render(P,re),M=[t,n,e],L.uniforms.uHeight.value=M[1].texture}if(En<2&&typeof document<`u`&&++En===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Gn(e){vn=e,window.__mode=vn}function qn(){return yn=!yn,Ne.value=+!!yn,window.__vector=yn,yn}function Jn(e){return yn=!!e,Ne.value=+!!yn,window.__vector=yn,yn}function Xn(){return xn=wn[(wn.indexOf(xn)+1)%wn.length],window.__era=xn,Nn(),xn}function Qn(){return bn=!bn,bn}return{updateWorld:Wn,decideStyle:zn,renderCityPipeline:Rn,renderCityBeautyTo:Fn,styleHintName:Un,setPostMode:Gn,toggleVector:qn,setVector:Jn,cycleEra:Xn,togglePalette:Qn,setTonemap:e=>{let t=e===`agx`||e===1||e===!0;return $.uniforms.uTonemap.value=+!!t,typeof window<`u`&&(window.__tonemap=t?`agx`:`aces`),t?`agx`:`aces`},get mode(){return vn},get vector(){return yn},get sceneEra(){return xn},renderer:o,drawBuffer:d,scene:_,rig:D,sunRig:k,SIM:256,targets:M,simScene:P,simCamera:re,simMaterial:I,grabRT:oe,card:ce,backdrop:le,WATER_SIZE:28,water:ue,waterMaterial:L,windowGlow:R,landmarkFactory:fe,city:B,cityLife:pe,waterLife:H,weatherRig:U,clouds:me,inspector:_e,world:Tt,catalog:Et,editor:Dt,pilot:At,profiler:ln,governor:fn,frameStart:pn,frameEnd:mn,setActive:hn,get paused(){return p},get contextLost(){return f},prewarm:_n,fitShadowFrustum:jt,SHADOW_DIST:24,sceneDepth:Mt,sceneRT:Nt,filmicRT:Pt,toonRT:It,pixelRT:Lt,postScene:Q,postCamera:Ut,postQuad:Wt,filmicMaterial:$,pixelMaterial:$t,pixelkitMaterial:tn,toonMaterial:an,mixMaterial:on,PALCACHE:Zt,ERA_TEX:nn,runPass:sn,OVERCAST_GREY:x,FOG_DENSITY:S,FOG_NIGHT_TINT:C,_fogColor:w,resize:cn}}var Ni=[`video/mp4;codecs=avc1.42E01E`,`video/mp4`,`video/webm;codecs=vp9`,`video/webm`];function Pi({renderer:e,rig:t,sunRig:n,poke:r,getState:i,office:a={},world:o=null}){let s=e.domElement,c=new URLSearchParams(window.location.search),l=e=>{let t=i();return`lgr-${t.lesson}-${String(t.clock||``).replace(`:`,``)}-${t.style}.${e}`},u=(e,t)=>{let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,document.body.appendChild(r),r.click(),r.remove(),setTimeout(()=>URL.revokeObjectURL(n),1e3)};function d(){s.toBlob(e=>{e&&(u(e,l(`png`)),window.__lastStill=e.size)},`image/png`)}let f=()=>Ni.find(e=>window.MediaRecorder&&MediaRecorder.isTypeSupported(e))||``,p=Fi(),m=null,h=[],g=!1;function _(){if(g)return;let e=f(),t=s.captureStream(60);m=new MediaRecorder(t,e?{mimeType:e,videoBitsPerSecond:12e6}:{}),h=[],m.ondataavailable=e=>{e.data&&e.data.size&&h.push(e.data)},m.onstop=()=>{let e=new Blob(h,{type:m.mimeType});u(e,l(m.mimeType.includes(`mp4`)?`mp4`:`webm`)),window.__lastVideo=e.size},m.start(),g=!0,window.__recording=!0,p.show()}function v(){g&&(m.stop(),g=!1,window.__recording=!1,p.hide())}let y=()=>g?v():_(),b=e=>new Promise(t=>setTimeout(t,e)),x=e=>{let t=e.startsWith(`Shift+`),n=t?e.slice(6):e;window.dispatchEvent(new KeyboardEvent(`keydown`,{key:n,shiftKey:t}))};async function S(){let e=s.clientWidth,t=s.clientHeight,n=e*.26,i=t*.74;for(let t=0;t<=10;t++)r.at(n+t*e*.028,i+Math.sin(t*.7)*16),await b(100);r.stop()}async function C(e){if(e.world&&o?.[e.world]?.(),e.keys)for(let t of e.keys)x(t),await b(70);if(e.zoom&&t.zoomBy(e.zoom),e.orbit&&t.orbit(e.orbit[0],e.orbit[1]),e.timeTo!==void 0&&n.goTo(e.timeTo),e.pour&&o?.flowPourAt)for(let t=0;t<10;t++)o.flowPourAt(e.pour[0],e.pour[1],e.pour[2],e.pour[3]);e.office&&a[e.office]?.(),e.ripple&&await S(),e.waitMs&&await b(e.waitMs)}let w={tour:[{keys:[`6`,`0`],waitMs:600},{zoom:.72,waitMs:1700},{ripple:!0,waitMs:2400},{orbit:[.55,0],waitMs:1700},{timeTo:0,waitMs:3e3},{timeTo:.5,waitMs:1500},{keys:[`7`],waitMs:1e3},{zoom:1.5,waitMs:1400},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`8`],waitMs:900},{zoom:.65,waitMs:1200},{ripple:!0,waitMs:2600},{keys:[`7`],waitMs:700},{keys:[`B`],waitMs:300},{keys:[`B`],waitMs:900},{zoom:1.4,waitMs:2600}],daycycle:[{keys:[`6`,`0`],waitMs:700},{timeTo:.75,waitMs:2600},{timeTo:1,waitMs:2600},{timeTo:1.25,waitMs:2600},{timeTo:1.5,waitMs:2600},{timeTo:1.5,waitMs:800}],office:[{keys:[`o`],waitMs:1700},{office:`pet`,waitMs:1300},{office:`feed`,waitMs:1700},{office:`travel`,waitMs:1700},{keys:[`Shift+W`,`Shift+W`,`Shift+W`],waitMs:1800},{timeTo:0,waitMs:2400},{office:`laptop`,waitMs:800},{office:`closeLaptop`,waitMs:300},{timeTo:.5,waitMs:900},{keys:[`Shift+W`],waitMs:200},{keys:[`o`],waitMs:1500}],cities:[{keys:[`6`,`0`],waitMs:500},{timeTo:.78,waitMs:2800},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:2e3}],water:[{keys:[`6`,`0`],waitMs:600},{zoom:1.35,waitMs:2800},{orbit:[.7,0],waitMs:2600},{ripple:!0,waitMs:2200},{timeTo:0,waitMs:3200},{timeTo:.5,waitMs:1500},{orbit:[-.5,0],waitMs:2200}],morph:[{keys:[`6`,`3`],waitMs:700},{zoom:.55,waitMs:1800},{zoom:2.3,waitMs:1700},{zoom:1.26,waitMs:1700},{zoom:1.16,waitMs:1900},{zoom:.3,waitMs:2200}],skin:[{keys:[`o`],waitMs:1800},{keys:[`j`],waitMs:2e3},{keys:[`j`],waitMs:2e3},{timeTo:0,waitMs:2600},{timeTo:.5,waitMs:1500},{keys:[`u`],waitMs:2e3},{keys:[`j`],waitMs:1400},{keys:[`o`],waitMs:1500}]};w.hero=[{world:`enter`,keys:[`2`],waitMs:1400},{timeTo:.3,waitMs:300},{pour:[3.2,-5.24,.7,1.9],waitMs:300},{orbit:[.5,.05],waitMs:2700},{orbit:[-.3,-.04],zoom:.9,waitMs:2500},{timeTo:.74,waitMs:1400},{orbit:[.18,-.42],waitMs:3e3},{keys:[`8`],waitMs:1500},{keys:[`7`],waitMs:1500},{keys:[`2`],waitMs:2200}],w.heroCity=[{keys:[`6`,`2`],waitMs:1300},{timeTo:.3,waitMs:1900},{orbit:[.5,0],waitMs:2500},{timeTo:.74,waitMs:2100},{orbit:[-.45,0],zoom:.85,waitMs:2600},{keys:[`8`],waitMs:1500},{keys:[`7`],waitMs:1500},{keys:[`2`],waitMs:2200}];async function T(e){let t=w[e];if(t){window.__director=e;for(let e of t)await C(e);window.__director=null}}async function E(e){await b(1600),_(),await T(e),await b(400),v(),window.__captureDone=!0}c.has(`capture`)&&window.addEventListener(`keydown`,e=>{(e.key===`s`||e.key===`S`)&&d(),(e.key===`r`||e.key===`R`)&&y()});let D=c.get(`capture`);return D&&w[D]&&E(D),window.__capture={still:d,toggleRec:y,run:T,sequences:Object.keys(w)},window.__capture}function Fi(){let e=document.createElement(`div`);return e.textContent=`● REC`,e.style.cssText=`position:fixed;top:14px;right:16px;z-index:2;font:bold 12px ui-monospace,monospace;color:#ff3b30;letter-spacing:.12em;text-shadow:0 1px 3px #000;display:none;`,document.body.appendChild(e),{show:()=>{e.style.display=`block`},hide:()=>{e.style.display=`none`}}}var Ii=`
...
`;function zi({controls:e,state:t,show:n,coarse:r}){if(typeof document>`u`)return;let i=document.createElement(`style`);i.textContent=Ri,document.head.appendChild(i);let a=document.createElement(`div`);a.className=`vui`;let o=document.createElement(`div`);o.className=`vui-info`,o.innerHTML=`KEYS · WASD move · 4/5/6 cam · 0 vector · 7/8 pixel/toon · B era · T time · [ ] scrub · 9 auto · Shift+W weather · K season · G shuffle · C city · I inspect · click a building / O office · J office skin · U painted props · Esc exit · M hide UI · H shadows · P theme · drag water to ripple`;let s=(e,t,n)=>{let r=document.createElement(`button`);return r.textContent=e,n&&(r.title=n),r.addEventListener(`click`,e=>{navigator.vibrate?.(10),t(e)}),r},c=e=>{let t=document.createElement(`div`);return t.className=`seg`,{seg:t,btns:e.map(([n,r])=>{let i=s(n,()=>e.find(e=>e[1]===r)[2](),n);return i.dataset.val=r,t.appendChild(i),i})}},l=e=>{let t=document.createElement(`span`);return t.className=`clbl`,t.textContent=e,t},u=(e,t,n,r)=>{let i=document.createElement(`input`);return i.type=`range`,i.min=String(e),i.max=String(t),i.step=String(n),i.addEventListener(`input`,()=>r(parseFloat(i.value))),i},d=s(`City`,()=>e.city(),`Next city profile (C)`),f=s(`Shuffle`,()=>e.shuffle(),`New random seed (G)`),p={clear:`Clear`,rain:`Rain`,snow:`Snow`,fog:`Fog`},m=[`Spring`,`Summer`,`Autumn`,`Winter`],h=s(`Clear`,()=>e.weather(),`Cycle weather: clear→rain→snow→fog (Shift+W)`),g=s(`Spring`,()=>e.season(),`Cycle season: spring→summer→autumn→winter (K)`),_=s(`Office`,()=>e.office(),`Dive into / exit the office (O · Esc)`),v={"3d":`3D`,dressed2:`Dressed`,night2:`Night`,modern:`Modern`,charm:`Charm`},y=s(`Skin`,()=>e.officeSkin(),`Office look: 3D → dressed → night → modern → charm diffusion (J)`),b={painted:`Painted`,"3d":`Live 3D`},x=s(`Props`,()=>e.officeProps(),`Office props: painted (cohesive) ↔ live 3D (animated) — under a skin (U)`),S=s(`Inspect`,()=>e.inspect(),`Inspect: fly + click/tap any car·person·bird·boat·cloud to follow + watch its behaviour (I)`),C={valley:`Valley`,archipelago:`Archi`,mountains:`Mountains`,plains:`Plains`},w=s(`World`,()=>e.world(),`Generate + explore a procedural terrain world`),T=s(`🎲`,()=>e.worldReroll(),`New random world (seed) — G`),E=s(`Valley`,()=>e.worldPreset(),`Cycle biome preset: valley → archipelago → mountains → plains`),D=s(`✎ Edit`,()=>e.sculpt&&e.sculpt(),`World editor — brush the terrain (Sculpt to reshape, Paint to recolour)`),O=document.createElement(`div`);O.className=`vui-rail`;let k=null;function A(t){k||!t||(k=t.map(t=>{let n=document.createElement(`button`);return n.dataset.id=t.id,n.title=`${t.label} (${t.key})`,n.innerHTML=`${t.icon}<span class="rk">${t.key}</span>`,n.addEventListener(`click`,()=>{navigator.vibrate?.(10),e.editTool&&e.editTool(t.id)}),O.appendChild(n),n}))}let j=document.createElement(`div`);j.className=`vui-card`;let ee=document.createElement(`div`);ee.className=`ct`;let M=document.createElement(`div`);M.className=`crow`;let N=u(.8,6,.1,t=>e.brushSize&&e.brushSize(t));M.append(l(`Size`),N);let te=document.createElement(`div`);te.className=`crow`;let ne=u(.01,.15,.005,t=>e.brushStrength&&e.brushStrength(t));te.append(l(`Force`),ne);let P=document.createElement(`div`);P.className=`crow`;let F=u(.1,1,.05,t=>e.brushDensity&&e.brushDensity(t));P.append(l(`Density`),F);let re=s(`↑ Raise`,()=>e.sculptDir&&e.sculptDir(),`Brush direction: raise ↔ lower / add ↔ erase / place ↔ delete`),ie=s(`↶ Undo`,()=>e.worldUndo&&e.worldUndo(),`Undo the last edit (Z)`),ae=s(`↺ Reset`,()=>e.worldReset&&e.worldReset(),`Reset to the generated world (discard edits) — same seed, NOT a reroll`),I=s(`↺ Reset`,()=>e.worldReset&&e.worldReset(),`Reset the world (discard edits) — same seed`),oe=s(`👁 Trees`,()=>e.hideScatter&&e.hideScatter(),`Hide the scatter (trees/rocks) to see the ground you are editing`),se=document.createElement(`div`);se.className=`seg`,se.style.display=`none`;let ce=null;function le(t){ce||!t||(ce=t.map((t,n)=>{let r=document.createElement(`button`);return r.title=t.key,r.style.cssText=`min-width:30px;padding:0;background:${t.color};border:0;border-radius:8px;`,r.addEventListener(`click`,()=>{navigator.vibrate?.(8),e.material&&e.material(n)}),se.appendChild(r),r}))}let L=document.createElement(`div`);L.className=`seg`,L.style.display=`none`;let ue=null;function de(t){ue||!t||(ue=t.map(t=>{let n=document.createElement(`button`);return n.dataset.key=t.key,n.textContent=t.icon,n.title=t.label,n.style.cssText=`min-width:30px;padding:4px 6px;`,n.addEventListener(`click`,()=>{navigator.vibrate?.(8),e.scatterType&&e.scatterType(t.key)}),L.appendChild(n),n}))}let R=document.createElement(`div`);R.className=`seg`,R.style.display=`none`;let z=null;function fe(t){z||!t||(z=t.map(t=>{let n=document.createElement(`button`);return n.dataset.key=t.key,n.textContent=t.icon,n.title=t.label,n.style.cssText=`min-width:30px;padding:4px 6px;`,n.addEventListener(`click`,()=>{navigator.vibrate?.(8),e.entity&&e.entity(t.key)}),R.appendChild(n),n}))}let B=c([[`×1`,`1`,()=>e.dropN&&e.dropN(1)],[`×10`,`10`,()=>e.dropN&&e.dropN(10)],[`×50`,`50`,()=>e.dropN&&e.dropN(50)]]);B.seg.style.display=`none`,B.seg.title=`How many to drop per click (scattered in the ring)`;let V=document.createElement(`div`);V.className=`crow`,V.append(re,ie,I,oe),j.append(ee,M,te,se,L,P,R,B.seg,V);let pe=document.createElement(`div`);pe.className=`vui-save`;let H=document.createElement(`div`);H.className=`ct`,H.textContent=`💾 Save / Load`;let U=document.createElement(`input`);U.type=`text`,U.placeholder=`world name`,U.value=`my-world`;let me=document.createElement(`select`),W=``;me.addEventListener(`change`,()=>{me.value&&(U.value=me.value)});let he=document.createElement(`input`);he.type=`file`,he.accept=`.json,application/json`,he.style.display=`none`,he.addEventListener(`change`,()=>{he.files[0]&&(e.importWorld(he.files[0]),he.value=``)});let G=s(`💾 Save`,()=>e.saveWorld(U.value.trim()),`Save to this device (a named slot)`),ge=s(`📂 Load`,()=>e.loadWorld(U.value.trim()),`Load the named slot`),_e=s(`🗑`,()=>e.deleteWorld(U.value.trim()),`Delete the named slot`),ve=s(`⬇ Export`,()=>e.exportWorld(U.value.trim()),`Download the world as a JSON file (portable, lossless)`),ye=s(`⬆ Import`,()=>he.click(),`Load a world from a JSON file`),be=s(`🔗 Link`,()=>e.shareLink(),`Copy a shareable link (light edits only — else use Export)`),xe=document.createElement(`div`);xe.className=`st`;let Se=document.createElement(`div`);Se.className=`srow`,Se.append(U);let Ce=document.createElement(`div`);Ce.className=`srow`,Ce.append(me);let we=document.createElement(`div`);we.className=`srow`,we.append(G,ge,_e);let K=document.createElement(`div`);K.className=`srow`,K.append(ve,ye,be),pe.append(H,Se,Ce,we,K,xe,he);let q=s(`✨ Realistic`,()=>e.realistic(),`Cinematic beauty look — atmospheric sky, glowing sun, colour-graded (showcase)`),Te=c([[`Auto`,`auto`,()=>e.post(`auto`)],[`Pixel`,`pixel`,()=>e.post(`pixel`)],[`Toon`,`toon`,()=>e.post(`toon`)],[`None`,`none`,()=>e.post(`none`)]]);Te.btns[0].title=`AUTO: zoom morphs the style (toon → 16-bit → 8-bit → Game Boy)`,Te.btns[3].title=`NONE: raw beauty render, no post-crunch (clean flat-vector when Vector is on)`;let J=s(`Vector`,()=>e.vector(),`Flat-vector materials — LAYERS onto the post mode (Vector + Pixel/Toon/Auto). Toggle (0)`),Ee={native:`Era`,gb:`GB`,"8-bit":`8-bit`,"16-bit":`16-bit`,modern:`Modern`,"1-bit":`1-bit`},De=s(`Era`,()=>e.era(),`Cycle the pixel era (B): native → GB → 8-bit → 16-bit → Modern`),Y=document.createElement(`input`);Y.type=`range`,Y.min=`0`,Y.max=`1`,Y.step=`0.01`,Y.title=`Time of day`;let Oe=!1;Y.addEventListener(`pointerdown`,()=>{Oe=!0}),Y.addEventListener(`pointerup`,()=>{Oe=!1}),Y.addEventListener(`input`,()=>e.time(parseFloat(Y.value)));let ke=s(`▶`,()=>e.auto(),`Play/pause day cycle (9)`),Ae=document.createElement(`div`);Ae.style.cssText=`display:flex;align-items:center;gap:6px;`;let je=document.createElement(`span`);je.className=`lbl`,je.textContent=`Day`,Ae.append(je,Y);let Me=s(`☀ Shadows`,()=>e.shadows&&e.shadows(),`Sun shadows on/off (H)`),Ne=s(`◐ Theme`,()=>e.theme&&e.theme(),`Swap the UI palette: ink/gold ↔ terminal (P)`),Pe=document.createElement(`div`);Pe.className=`vui-env`,Pe.setAttribute(`role`,`group`),Pe.setAttribute(`aria-label`,`Environment and view settings`);let Fe=s(`⚙ More ▾`,()=>{Pe.classList.toggle(`open`)},`Environment & view: day/night play · weather · season · shadows · theme`),Ie=c([[`Iso`,`iso`,()=>e.cam(`iso`)],[`Dim`,`dimetric`,()=>e.cam(`dimetric`)],[`3D`,`persp`,()=>e.cam(`persp`)]]),Le=s(`ⓘ`,()=>o.classList.toggle(`open`),`All keys`),Re=s(`⌄`,()=>at(!0),`Hide controls — watch unobstructed (M)`),ze=Li({commands:[{group:`Modes`,label:`Go to City`,shortcut:``,run:()=>e.mode(`city`)},{group:`Modes`,label:`Go to World — terrain editor`,shortcut:``,run:()=>e.mode(`world`)},{group:`Modes`,label:`Go to Office`,shortcut:`O`,run:()=>e.mode(`office`)},{group:`Modes`,label:`Go to Hoard — the game`,shortcut:`X`,run:()=>e.mode(`hoard`)},{group:`Camera`,label:`Camera: Perspective (3D orbit)`,shortcut:`4`,run:()=>e.cam(`persp`)},{group:`Camera`,label:`Camera: Isometric`,shortcut:`5`,run:()=>e.cam(`iso`)},{group:`Camera`,label:`Camera: Dimetric (2:1)`,shortcut:`6`,run:()=>e.cam(`dimetric`)},{group:`Art`,label:`Art tier: Auto LOD (zoom morph)`,shortcut:`3`,run:()=>e.post(`auto`)},{group:`Art`,label:`Art tier: Pixel`,shortcut:`7`,run:()=>e.post(`pixel`)},{group:`Art`,label:`Art tier: Toon`,shortcut:`8`,run:()=>e.post(`toon`)},{group:`Art`,label:`Art tier: Raw (no crunch)`,shortcut:`1`,run:()=>e.post(`none`)},{group:`Art`,label:`Toggle Vector (flat materials)`,shortcut:`0`,run:()=>e.vector()},{group:`Art`,label:`Realistic — cinematic beauty`,shortcut:``,run:()=>e.realistic()},{group:`Art`,label:`Cycle pixel Era`,shortcut:`B`,run:()=>e.era()},{group:`Environment`,label:`Play / pause day-night`,shortcut:`9`,run:()=>e.auto()},{group:`Environment`,label:`Time of day: Dawn`,shortcut:``,run:()=>e.time(.25)},{group:`Environment`,label:`Time of day: Noon`,shortcut:``,run:()=>e.time(.5)},{group:`Environment`,label:`Time of day: Dusk`,shortcut:``,run:()=>e.time(.75)},{group:`Environment`,label:`Time of day: Night`,shortcut:``,run:()=>e.time(0)},{group:`Environment`,label:`Cycle Weather`,shortcut:`Shift+W`,run:()=>e.weather()},{group:`Environment`,label:`Cycle Season`,shortcut:`K`,run:()=>e.season()},{group:`Environment`,label:`Toggle sun Shadows`,shortcut:`H`,run:()=>e.shadows&&e.shadows()},{group:`Environment`,label:`Swap UI Theme`,shortcut:`P`,run:()=>e.theme&&e.theme()},{group:`City`,label:`Next city profile`,shortcut:`C`,run:()=>e.city()},{group:`City`,label:`Shuffle city seed`,shortcut:`G`,run:()=>e.shuffle()},{group:`City`,label:`Inspect — follow a car/person/bird…`,shortcut:`I`,run:()=>e.inspect()},{group:`Office`,label:`Cycle office look (skin)`,shortcut:`J`,run:()=>e.officeSkin()},{group:`Office`,label:`Office props: painted ↔ live 3D`,shortcut:`U`,run:()=>e.officeProps()},{group:`World editor`,label:`Toggle ✎ Sculpt editor`,shortcut:``,run:()=>e.sculpt&&e.sculpt()},{group:`World editor`,label:`New random world`,shortcut:`G`,run:()=>e.worldReroll&&e.worldReroll()},{group:`World editor`,label:`Reset world (discard edits)`,shortcut:``,run:()=>e.worldReset&&e.worldReset()},{group:`World editor`,label:`Cycle biome preset`,shortcut:``,run:()=>e.worldPreset&&e.worldPreset()},{group:`World editor`,label:`Undo last edit`,shortcut:`Z`,run:()=>e.worldUndo&&e.worldUndo()},{group:`World editor`,label:`Export world (JSON file)`,shortcut:``,run:()=>e.exportWorld&&e.exportWorld(`my-world`)},{group:`World editor`,label:`Copy share link`,shortcut:``,run:()=>e.shareLink&&e.shareLink()},{group:`View`,label:`Hide / show controls`,shortcut:`M`,run:()=>ot()},{group:`View`,label:`Show all keyboard shortcuts`,shortcut:``,run:()=>o.classList.add(`open`)}]}),Be=s(`⌘K`,()=>ze.open(),`Command palette — run anything (⌘K / Ctrl-K)`),Ve=c([[`City`,`city`,()=>e.mode(`city`)],[`World`,`world`,()=>e.mode(`world`)],[`Office`,`office`,()=>e.mode(`office`)],[`Hoard`,`hoard`,()=>e.mode(`hoard`)]]);Ve.btns[0].title=`City — the living skyline`,Ve.btns[1].title=`World — the procedural terrain editor`,Ve.btns[2].title=`Office — dive into the building`,Ve.btns[3].title=`Hoard — the survival game`;let He=document.createElement(`div`);He.className=`vui-more`;let Ue=s(`More`,()=>{He.classList.toggle(`open`),st()},`More controls`);if(r){a.append(Ve.seg,S,ke,Te.seg,Be,Ue,Re);let e=document.createElement(`div`);e.style.cssText=`display:flex;align-items:center;gap:6px;`,e.append(je,Y),He.append(d,f,q,T,ae,E,D,h,g,Me,Ne,y,x,J,De,Ie.seg,e)}else a.append(Ve.seg,mt(),d,f,y,x,S,mt(),T,ae,E,D,mt(),Te.seg,q,J,De,mt(),Ae,Fe,mt(),Ie.seg,Be,Le,mt(),Re),Pe.append(ke,h,g,Me,Ne);let X=document.createElement(`div`);X.className=`vui-inspect`;let We=document.createElement(`div`);We.className=`ik`;let Ge=document.createElement(`div`);Ge.className=`it`;let Ke=document.createElement(`div`);Ke.className=`ii`;let Z=document.createElement(`div`);Z.className=`ir`;let qe=s(`▸ Next`,()=>e.inspectNext&&e.inspectNext(),`Follow the next object (Tab)`),Je=s(`✕`,()=>e.inspect(),`Exit inspect (Esc)`);Z.append(qe,Je),X.append(We,Ge,Ke,Z);let Ye=document.createElement(`button`);Ye.className=`vui-show`,Ye.innerHTML=`⌃ Controls`,Ye.title=`Show controls (M)`,Ye.addEventListener(`click`,()=>at(!1));let Xe=document.createElement(`div`);Xe.className=`vui-style`,a.setAttribute(`role`,`toolbar`),a.setAttribute(`aria-label`,`Global controls`),O.setAttribute(`role`,`toolbar`),O.setAttribute(`aria-label`,`Tools`),O.setAttribute(`aria-orientation`,`vertical`),j.setAttribute(`role`,`group`),j.setAttribute(`aria-label`,`Tool properties`),pe.setAttribute(`role`,`group`),pe.setAttribute(`aria-label`,`Save and load worlds`);let Ze=document.createElement(`div`);Ze.className=`vui-live`,Ze.setAttribute(`role`,`status`),Ze.setAttribute(`aria-live`,`polite`),document.body.append(o,He,a,Ye,Xe,X,O,j,pe,Ze,Pe);let Qe=n,$e=null,et=null;if(r&&Qe){$e=document.createElement(`div`),$e.className=`vui-sheet`,$e.setAttribute(`role`,`group`),$e.setAttribute(`aria-label`,`Editor tools and properties`);let e=document.createElement(`button`);e.className=`vui-sheet-grip`,e.title=`Expand / collapse`,e.setAttribute(`aria-label`,`Expand or collapse the editor sheet`),e.setAttribute(`aria-expanded`,`true`);let t=document.createElement(`div`);t.className=`vui-sheet-title`,t.textContent=`✎ Editor`;let n=document.createElement(`div`);n.className=`vui-sheet-tools`;let r=document.createElement(`div`);r.className=`vui-sheet-body`,n.append(O),r.append(j),$e.append(e,t,n,r),e.addEventListener(`click`,()=>{navigator.vibrate?.(8);let t=$e.classList.toggle(`peek`);e.setAttribute(`aria-expanded`,String(!t))}),document.body.append($e),et=document.createElement(`button`),et.className=`vui-fab on`,et.textContent=`⌘K`,et.title=`Command palette`,et.setAttribute(`aria-label`,`Open the command palette`),et.addEventListener(`click`,()=>{navigator.vibrate?.(10),ze.open()}),document.body.append(et)}let tt=!1;at(r);let nt=null;function rt(){let e=t();Te.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===e.post)),J.classList.toggle(`on`,!!e.vector),Ie.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===e.cam)),h.textContent=p[e.weather]||`Clear`,h.classList.toggle(`on`,e.weather!==`clear`),g.textContent=m[e.season]||`Spring`,g.classList.toggle(`on`,(e.season||0)>0),_.textContent=e.office?`Exit`:`Office`,_.classList.toggle(`on`,!!e.office),y.textContent=v[e.officeSkin]||`Skin`,y.classList.toggle(`on`,e.officeSkin&&e.officeSkin!==`3d`),x.textContent=b[e.officeProps]||`Props`,x.classList.toggle(`on`,e.officeProps===`painted`&&e.officeSkin&&e.officeSkin!==`3d`),ke.textContent=e.auto?`❚❚`:`▶`,ke.classList.toggle(`on`,e.auto),De.textContent=Ee[e.era]||`Era`,De.classList.toggle(`on`,e.era&&e.era!==`native`),S.textContent=e.inspect?`Exit`:`Inspect`,S.classList.toggle(`on`,!!e.inspect),w.textContent=e.world?`Exit`:`World`,w.classList.toggle(`on`,!!e.world),E.textContent=C[e.worldPreset]||`Valley`,T.style.display=e.world?``:`none`,ae.style.display=e.world?``:`none`,E.style.display=e.world?``:`none`,D.style.display=e.world?``:`none`;let n=e.currentMode,r=n===`city`,i=n===`world`,a=n===`office`,o=r||i,s=e.audienceModes||[`city`,`world`,`office`,`hoard`];Ve.btns.forEach(e=>{let t=e.dataset.val;e.style.display=s.includes(t)?``:`none`,e.classList.toggle(`on`,t===n)}),d.style.display=r?``:`none`,f.style.display=r?``:`none`,S.style.display=r?``:`none`,y.style.display=a?``:`none`,x.style.display=a?``:`none`,h.style.display=o?``:`none`,g.style.display=o?``:`none`;let c=i?e.sculpt?`World editor — editing`:`World`:a?`Office`:n===`hoard`?`Hoard`:`City`;c!==nt&&(nt=c,Ze.textContent=`${c} mode — controls updated`),Me.classList.toggle(`on`,!!e.shadows),Ne.classList.toggle(`on`,!!e.theme),D.classList.toggle(`on`,!!e.sculpt),A(e.tools),O.classList.toggle(`open`,!!e.sculpt),k&&k.forEach(t=>t.classList.toggle(`on`,t.dataset.id===e.editTool)),j.classList.toggle(`open`,!!e.sculpt),$e&&$e.classList.toggle(`on`,!!e.sculpt);let l=e.editTool,u=l===`paint`,I=l===`scatter`,V=l===`place`,H=l===`sculpt`;ee.textContent={place:`✚ Place`,sculpt:`⛰ Sculpt`,paint:`🎨 Paint`,scatter:`🌲 Objects`,select:`◳ Select`}[l]||`Editor`,M.style.display=l===`select`?`none`:``,te.style.display=H?``:`none`,P.style.display=I?``:`none`,le(e.materials),se.style.display=u?``:`none`,ce&&ce.forEach((t,n)=>t.classList.toggle(`on`,n===e.material)),de(e.scatterKinds),L.style.display=I?``:`none`,ue&&ue.forEach(t=>t.classList.toggle(`on`,t.dataset.key===e.scatterType)),fe(e.entityKinds),R.style.display=V?``:`none`,z&&z.forEach(t=>t.classList.toggle(`on`,t.dataset.key===e.entityKind)),B.seg.style.display=V?``:`none`,B.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===String(e.dropN))),re.style.display=I||V||H?``:`none`,re.textContent=V?e.sculptRaise?`➕ Place`:`🗑 Delete`:I?e.sculptRaise?`➕ Add`:`➖ Erase`:e.sculptRaise?`↑ Raise`:`↓ Lower`,ie.disabled=!e.canUndo,ie.style.opacity=e.canUndo?``:`0.45`,oe.classList.toggle(`on`,!!e.scatterHidden),N.value=String(e.brushRadius),ne.value=String(e.brushStrength),F.value=String(e.brushDensity),pe.classList.toggle(`open`,!!e.sculpt);let U=e.saveSlots||[],he=U.join(`,`);if(he!==W){W=he,me.innerHTML=``;let e=document.createElement(`option`);e.value=``,e.textContent=U.length?`— ${U.length} saved —`:`— no saves —`,me.append(e);for(let e of U){let t=document.createElement(`option`);t.value=e,t.textContent=e,me.append(t)}}xe.textContent=e.saveStatus||``,q.classList.toggle(`on`,!!e.realistic),Oe||(Y.value=String(e.t))}rt();let it=setInterval(rt,200);function at(e){if(!Qe){a.style.display=`none`,Ye.classList.remove(`on`),o.classList.remove(`open`),He.classList.remove(`open`),Xe.classList.remove(`on`);return}tt=e,a.style.display=e?`none`:`flex`,Ye.classList.toggle(`on`,e),e&&(o.classList.remove(`open`),He.classList.remove(`open`),Xe.classList.remove(`on`))}function ot(){at(!tt)}function st(){if(!He.classList.contains(`open`))return;let e=a.getBoundingClientRect();He.style.top=Math.round(e.bottom+8)+`px`,He.style.bottom=`auto`}let ct=()=>st();window.addEventListener(`resize`,ct);let lt=null,ut=null;function dt(e){if(!Qe||tt){Xe.classList.remove(`on`),lt=null;return}if(!e){Xe.classList.remove(`on`),lt=``;return}e!==lt&&(lt=e,Xe.textContent=e,Xe.classList.add(`on`),clearTimeout(ut),ut=setTimeout(()=>Xe.classList.remove(`on`),2e3))}let ft=null;function pt(e){if(!Qe||!e){X.classList.remove(`open`),ft=null;return}let t=e.hint?`hint:${e.hint}`:`${e.kind}|${e.info}`;t!==ft&&(ft=t,e.hint?(We.textContent=`INSPECT`,Ge.textContent=`Free-fly`,Ke.textContent=e.hint,qe.style.display=``):(We.textContent=e.kind,Ge.textContent=e.label||e.kind,Ke.textContent=e.info||``,qe.style.display=``),X.classList.add(`open`))}return[a,o,He,Ye,Xe,X,O,j,pe,Pe,$e,i].forEach(e=>e&&e.querySelectorAll&&e.querySelectorAll(`button[title]:not([aria-label])`).forEach(e=>e.setAttribute(`aria-label`,e.title))),{toggle:ot,setHidden:at,refresh:rt,setStyleHint:dt,setInspect:pt,destroy(){clearInterval(it),window.removeEventListener(`resize`,ct),a.remove(),o.remove(),He.remove(),Ye.remove(),Xe.remove(),X.remove(),O.remove(),j.remove(),pe.remove(),Ze.remove(),Pe.remove(),$e&&$e.remove(),et&&et.remove(),ze.destroy(),i.remove(),clearTimeout(ut)}};function mt(){let e=document.createElement(`div`);return e.className=`sep`,e}}var Bi=`lgr_hints_`,Vi=!1;function Hi(){if(Vi||typeof document>`u`)return;Vi=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  }`,document.head.appendChild(e)}function Ui({key:e,title:t=`Tips`,tips:n=[],force:r=!1}={}){let i={key:e,shown:!1,dismissed:!1,seen:!1};if(typeof window<`u`&&(window.__hints=i),typeof document>`u`||!e)return{dismiss(){},el:null};let a=Bi+e,o=!1;try{o=localStorage.getItem(a)===`1`}catch{}if(o&&!r)return i.seen=!0,{dismiss(){},el:null};Hi();let s=!!(window.matchMedia&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches),c=document.createElement(`div`);c.className=`lgr-hints`,c.innerHTML=`<div class="lgr-hints-card">
...
void main() {
  ...
  gl_FragColor = vec4(col, 1.0);
}`;function Gi({rate:e=4.6}={}){let t=new ie({vertexShader:jn,fragmentShader:Wi,uniforms:{uA:{value:null},uB:{value:null},uT:{value:0},uFocus:{value:new G(.5,.5)}}}),n=`a`,r=0;function i(e,n){t.uniforms.uA.value=e,t.uniforms.uB.value=n}function a(e){return n===`a`?(e&&t.uniforms.uFocus.value.copy(e),n=`in`,!0):!1}function o(){return n!==`b`&&n!==`in`?!1:(n=`out`,!0)}function s(e){n=e===`b`?`b`:`a`,r=+(e===`b`),t.uniforms.uT.value=r}function c(i){return r+=(+(n===`b`||n===`in`)-r)*Math.min(1,i*e),n===`in`&&r>.992&&(r=1,n=`b`),n===`out`&&r<.008&&(r=0,n=`a`),t.uniforms.uT.value=r,n}return{material:t,setSources:i,enter:a,exit:o,update:c,snap:s,get mode(){return n},get t(){return r},get transitioning(){return n===`in`||n===`out`}}}var Ki=null;function qi(){if(Ki)return Ki;let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(0,0,0,0.60)`),n.addColorStop(.55,`rgba(0,0,0,0.32)`),n.addColorStop(1,`rgba(0,0,0,0.0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,Math.PI*2),t.fill(),Ki=new V(e),Ki.colorSpace=z,Ki}function Ji({w:e=.6,d:t=.6,x:n=0,y:r=.002,z:i=0,opacity:a=.5,rotation:o=0}={}){let s=new v(new h(e,t),new b({map:qi(),transparent:!0,opacity:a,depthWrite:!1,toneMapped:!1}));return s.rotation.x=-Math.PI/2,s.rotation.z=o,s.position.set(n,r,i),s.renderOrder=-1,s.raycast=()=>{},s}function Yi({yawLimit:e=80,pitchUp:t=32,pitchDown:n=20,sensitivity:r=.16,keySpeed:i=70,damp:a=9}={}){let o=Math.PI/180,s=(e,t,n)=>e<t?t:e>n?n:e,c=0,l=0,u=0,d=0;return{addDrag(i,a){u=s(u-i*r,-e,e),d=s(d-a*r,-n,t)},addKeys(r,{left:a,right:o,up:c,down:l}){let f=i*r;a&&(u=s(u+f,-e,e)),o&&(u=s(u-f,-e,e)),c&&(d=s(d+f,-n,t)),l&&(d=s(d-f,-n,t))},recenter(){u=0,d=0},update(e){let t=1-Math.exp(-a*e);c+=(u-c)*t,l+=(d-l)*t},get yaw(){return c*o},get pitch(){return l*o},get active(){return Math.abs(c)>.05||Math.abs(l)>.05}}}var Xi=null;function Zi(){if(Xi)return Xi;let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(256/2,256/2,256*.32,256/2,256/2,256*.72);return n.addColorStop(0,`rgba(0,0,0,0)`),n.addColorStop(1,`rgba(0,0,0,1)`),t.fillStyle=n,t.fillRect(0,0,256,256),Xi=new V(e),Xi.colorSpace=z,Xi}function Qi({strength:e=.55,dist:n=.5}={}){let r=new v(new h(1,1),new b({map:Zi(),transparent:!0,opacity:e,depthTest:!1,depthWrite:!1,toneMapped:!1}));r.renderOrder=9999,r.raycast=()=>{},r.frustumCulled=!1;let i=new E;return r.fit=e=>{e.getWorldDirection(i),r.position.copy(e.position).addScaledVector(i,n),r.quaternion.copy(e.quaternion);let a=2*Math.tan(t.degToRad(e.fov)*.5)*n*1.05;r.scale.set(a*e.aspect,a,1)},r}export{rt as _,Ui as a,Mi as c,Ei as d,Di as f,nt as g,At as h,Gi as i,Ci as l,jn as m,Ji as n,zi as o,Si as p,Qi as r,Pi as s,Yi as t,Ti as u,Z as v,Se as y};