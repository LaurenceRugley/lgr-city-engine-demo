import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,I as c,K as l,L as u,M as d,N as f,P as p,Q as m,R as h,S as g,T as _,U as v,V as y,X as b,Y as x,Z as S,_ as C,a as w,at as T,b as E,c as D,f as O,g as k,h as A,i as j,j as M,l as N,m as P,n as F,nt as I,o as L,ot as R,p as z,q as B,s as V,st as H,t as U,tt as W,u as G,v as ee,w as te,x as ne,z as re}from"./three-CAqSPQgM.js";var ie=Math.atan(1/Math.SQRT2),ae=Math.atan(.5),K=Math.PI/4,q={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},oe=.12,se=1.45,ce=4,le=40,ue=1.5,de=16,fe=6,pe=22,me=3.5,he=11,J=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),ge=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function _e({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new R(0,.8,0),azimuth:a=K,elevation:o=.52,distance:s=12,zoom:c=5.5}={}){let l=new y(t,e,n,r),u=new re(-1,1,1,-1,n,r),f=q.PERSPECTIVE,p=e,m={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},h={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},g=!1,_=()=>f===q.PERSPECTIVE?l:u;function v(e){e!==f&&(f=e,f===q.ISOMETRIC||f===q.DIMETRIC?(m.elevation=f===q.ISOMETRIC?ie:ae,m.azimuth=ge(K,h.azimuth),g=!0):g=!1)}function b(e,t){m.azimuth+=e,g||(m.elevation=d.clamp(m.elevation+t,oe,se))}function x(e){f===q.PERSPECTIVE?m.distance=d.clamp(m.distance*e,ce,le):m.zoom=d.clamp(m.zoom*e,ue,de)}function S(e,t){let n=m.azimuth,r=f===q.PERSPECTIVE?m.distance*.04:m.zoom*.08,i=new R(Math.cos(n),0,-Math.sin(n)),a=new R(-Math.sin(n),0,-Math.cos(n));m.target.addScaledVector(i,e*r),m.target.addScaledVector(a,t*r)}function C(e,t){p=e/t,l.aspect=p,l.updateProjectionMatrix()}function w(e){h.azimuth=J(h.azimuth,m.azimuth,e),h.elevation=J(h.elevation,m.elevation,e),h.distance=J(h.distance,m.distance,e),h.zoom=J(h.zoom,m.zoom,e),h.target.x=J(h.target.x,m.target.x,e),h.target.y=J(h.target.y,m.target.y,e),h.target.z=J(h.target.z,m.target.z,e);let t=Math.cos(h.elevation),n=Math.sin(h.elevation),r=Math.cos(h.azimuth),i=Math.sin(h.azimuth),a=_();if(a.position.set(h.target.x+h.distance*t*i,h.target.y+h.distance*n,h.target.z+h.distance*t*r),a.lookAt(h.target),a.isOrthographicCamera){let e=h.zoom,t=e*p;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function T(e,t,n,r=!1){m.target.set(e,t,n),r&&h.target.copy(m.target)}function E(e,t=!1){m.zoom=d.clamp(e,ue,de),t&&(h.zoom=m.zoom)}return{get camera(){return _()},get mode(){return f},get azimuth(){return h.azimuth},setTarget:T,setZoom:E,get styleT(){return f===q.PERSPECTIVE?d.clamp((h.distance-fe)/(pe-fe),0,1):d.clamp((h.zoom-me)/(he-me),0,1)},setMode:v,orbit:b,zoomBy:x,pan:S,setViewport:C,update:w}}var ve={value:0},ye=new z(`#ffffff`),be={value:0},xe={value:0},Se={value:0},Ce=new T,we={value:0},Te={value:0},Ee=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
`;function De(e){e.uniforms.uVector=ve,e.uniforms.uVecTint={value:ye},e.uniforms.uVecShadow=be,e.uniforms.uSnow=xe,e.uniforms.uCloud=Se,e.uniforms.uCloudOff={value:Ce},e.uniforms.uFogCharm=we}function Oe(e){return e.replace(`#include <fog_fragment>`,`
    #ifdef USE_FOG
...
#include <shadowmask_pars_fragment>`)}var je=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Me(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new z(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{De(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new z(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=ke(e.vertexShader),e.fragmentShader=Oe(Ae(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function Y(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{De(e),s||(e.uniforms.uVecColor={value:new z(t)}),c&&(e.uniforms.uGlow={value:new z(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=Te),e.vertexShader=ke(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,zt={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Bt=[`gb`,`8-bit`,`16-bit`,`modern`],Vt={"ink-gold (day)":[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],"ink-gold (night)":[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],"terminal (day)":[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],"terminal (night)":[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`]};function Ht(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new z(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new k(n,t,1,B,ne);return r.minFilter=u,r.magFilter=u,r.needsUpdate=!0,r}function Ut(e,t){let n=[];for(let t=0;t+2<e.length;t+=3)n.push([e[t],e[t+1],e[t+2]]);if(n.length===0)return[`#000000`];let r=e=>{let t=[255,255,255],n=[0,0,0];for(let r of e)for(let e=0;e<3;e++)t[e]=Math.min(t[e],r[e]),n[e]=Math.max(n[e],r[e]);let r=[n[0]-t[0],n[1]-t[1],n[2]-t[2]],i=r[0]>=r[1]&&r[0]>=r[2]?0:r[1]>=r[2]?1:2;return{ax:i,range:r[i]}},i=[n];for(;i.length<t;){let e=-1,t=-1;if(i.forEach((n,i)=>{if(n.length>1){let{range:a}=r(n);a>t&&(t=a,e=i)}}),e<0)break;let n=i[e],{ax:a}=r(n);n.sort((e,t)=>e[a]-t[a]);let o=n.length>>1;i.splice(e,1,n.slice(0,o),n.slice(o))}return i.map(e=>{let t=[0,0,0];for(let n of e)for(let e=0;e<3;e++)t[e]+=n[e];return`#`+t.map(t=>Math.round(t/e.length)).map(e=>e.toString(16).padStart(2,`0`)).join(``)})}var Wt=220,Gt={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Kt={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function qt({demo:e=!1,citySeed:n=0,profileIndex:r=0}={}){let i=new F({antialias:!0,preserveDrawingBuffer:!0});i.shadowMap.enabled=!0,i.shadowMap.type=1,i.setPixelRatio(Math.min(window.devicePixelRatio,2)),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(920327,1),document.body.appendChild(i.domElement);let a=i.getDrawingBufferSize(new T),s=new b;s.fog=new g(10465470,0);let c=new z(`#aeb6c0`),l=new z(`#74508f`),d=new z,m=_e({aspect:window.innerWidth/window.innerHeight}),h=$e({t:.5}),_={type:te,format:B,minFilter:u,magFilter:u,wrapS:O,wrapT:O,depthBuffer:!1,stencilBuffer:!1},y=[new H(256,256,_),new H(256,256,_),new H(256,256,_)];for(let e of y)i.setRenderTarget(e),i.clear();i.setRenderTarget(null);let w=new b,E=new re(-1,1,1,-1,0,1),k=new S({vertexShader:At,fragmentShader:jt,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new T(1/256,1/256)},uMouse:{value:new T(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new R)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new R)}}});w.add(new p(new v(2,2),k));let A=new H(a.x,a.y,{minFilter:t,magFilter:t,depthBuffer:!0,stencilBuffer:!1});function j(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new D(t);return r.colorSpace=x,r}let M=new p(new v(28,28),new o({map:j(e)}));M.rotation.x=-Math.PI/2,M.position.y=-.35,s.add(M);let N=new p(new v(40,24),new S({depthWrite:!1,vertexShader:Ot,fragmentShader:kt,uniforms:{uTime:{value:0},uInk:{value:h.horizon},uGold:{value:h.sky},uFogColor:{value:d},uFogAmt:{value:0},uFogCharm:we}}));N.position.set(0,3,-8),s.add(N);let P=new S({vertexShader:Mt,fragmentShader:Nt,uniforms:{uHeight:{value:null},uScene:{value:A.texture},uTexel:{value:new T(1/256,1/256)},uResolution:{value:new T(a.x,a.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new f},uLightDir:{value:h.sunDir},uInk:{value:new z(`#2A2218`)},uGold:{value:new z(`#B89968`)},uVector:ve,uVecWater:{value:new z(`#1fb8d8`)},uVecTint:{value:ye}}}),I=new p(new v(28,28,255,255),P);I.rotation.x=-Math.PI/2,I.updateMatrixWorld(!0),P.uniforms.uNormalMatrix.value.getNormalMatrix(I.matrixWorld),s.add(I);let L={value:0},V=St({windowGlow:L}),U=Ge({seed:n,profileIndex:r,landmarkFactory:V,windowGlow:L});s.add(U.group);let W=it({plinthTop:.3,extent:U.extent,profile:U.state.profile});s.add(W.group);let G=ut({extent:U.extent,waterSize:28,plinthTop:.3});s.add(G.group),k.uniforms.uWakeDrops.value=G.wakeDrops;let ee=wt({extent:U.extent});s.add(ee.group),k.uniforms.uRainDrops.value=ee.rainDrops;let ne=Et({extent:U.extent});s.add(ne.group),U.group.remove(U.key),s.add(U.key),U.key.castShadow=!0,U.key.shadow.mapSize.set(2048,2048),U.key.shadow.bias=-18e-5,U.key.shadow.normalBias=.028,s.add(U.key.target);function ie(){let e=U.key.shadow.camera,t=U.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix()}ie();let ae=new C(a.x,a.y),K=new H(a.x,a.y,{minFilter:t,magFilter:t,depthBuffer:!0,stencilBuffer:!1,depthTexture:ae}),q=new H(a.x,a.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),oe=new H(a.x,a.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),se=new H(a.x,a.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),ce=new b,le=new re(-1,1,1,-1,0,1),ue=new p(new v(2,2));ce.add(ue);let de=new S({vertexShader:At,fragmentShader:Pt,uniforms:{uScene:{value:K.texture},uTime:{value:0},uResolution:{value:new T(a.x,a.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),fe=e=>{let t=e.map(e=>new z(e));for(;t.length<8;)t.push(new z(0,0,0));return t},pe=[`night`,`dawn`,`noon`,`dusk`],me={inkgold:pe.map(e=>fe(Gt[e])),terminal:pe.map(e=>fe(Kt[e]))},he=new S({vertexShader:At,fragmentShader:Ft,uniforms:{uScene:{value:q.texture},uResolution:{value:new T(a.x,a.y)},uPixelSize:{value:Wt},uPalette:{value:me.inkgold[2]},uPaletteB:{value:me.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),J=new S({vertexShader:At,fragmentShader:Rt,uniforms:{uScene:{value:q.texture},uResolution:{value:new T(a.x,a.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Ht(zt[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),ge={};for(let e of Bt)ge[e]=zt[e].palette?Ht(zt[e].palette):null;let be=new S({vertexShader:At,fragmentShader:It,uniforms:{uScene:{value:q.texture},uDepth:{value:ae},uResolution:{value:new T(a.x,a.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:h.toonFloor},uOutline:{value:h.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),xe=new S({vertexShader:At,fragmentShader:Lt,uniforms:{uToon:{value:oe.texture},uPixel:{value:se.texture},uBlend:{value:0}}});function Se(e,t){ue.material=e,i.setRenderTarget(t),i.render(ce,le)}function Ce(){m.setViewport(window.innerWidth,window.innerHeight),i.setSize(window.innerWidth,window.innerHeight);let e=i.getDrawingBufferSize(new T);return A.setSize(e.x,e.y),K.setSize(e.x,e.y),q.setSize(e.x,e.y),oe.setSize(e.x,e.y),se.setSize(e.x,e.y),P.uniforms.uResolution.value.set(e.x,e.y),de.uniforms.uResolution.value.set(e.x,e.y),he.uniforms.uResolution.value.set(e.x,e.y),J.uniforms.uResolution.value.set(e.x,e.y),be.uniforms.uResolution.value.set(e.x,e.y),e}return{renderer:i,drawBuffer:a,scene:s,rig:m,sunRig:h,SIM:256,targets:y,simScene:w,simCamera:E,simMaterial:k,grabRT:A,card:M,backdrop:N,WATER_SIZE:28,water:I,waterMaterial:P,windowGlow:L,landmarkFactory:V,city:U,cityLife:W,waterLife:G,weatherRig:ee,clouds:ne,fitShadowFrustum:ie,SHADOW_DIST:24,sceneDepth:ae,sceneRT:K,filmicRT:q,toonRT:oe,pixelRT:se,postScene:ce,postCamera:le,postQuad:ue,filmicMaterial:de,pixelMaterial:he,pixelkitMaterial:J,toonMaterial:be,mixMaterial:xe,PALCACHE:me,ERA_TEX:ge,runPass:Se,OVERCAST_GREY:c,FOG_DENSITY:.062,FOG_NIGHT_TINT:l,_fogColor:d,resize:Ce}}var Jt=[`video/mp4;codecs=avc1.42E01E`,`video/mp4`,`video/webm;codecs=vp9`,`video/webm`];function Yt({renderer:e,rig:t,sunRig:n,poke:r,getState:i,office:a={}}){let o=e.domElement,s=new URLSearchParams(window.location.search),c=e=>{let t=i();return`lgr-${t.lesson}-${String(t.clock||``).replace(`:`,``)}-${t.style}.${e}`},l=(e,t)=>{let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,document.body.appendChild(r),r.click(),r.remove(),setTimeout(()=>URL.revokeObjectURL(n),1e3)};function u(){o.toBlob(e=>{e&&(l(e,c(`png`)),window.__lastStill=e.size)},`image/png`)}let d=()=>Jt.find(e=>window.MediaRecorder&&MediaRecorder.isTypeSupported(e))||``,f=Xt(),p=null,m=[],h=!1;function g(){if(h)return;let e=d(),t=o.captureStream(60);p=new MediaRecorder(t,e?{mimeType:e,videoBitsPerSecond:12e6}:{}),m=[],p.ondataavailable=e=>{e.data&&e.data.size&&m.push(e.data)},p.onstop=()=>{let e=new Blob(m,{type:p.mimeType});l(e,c(p.mimeType.includes(`mp4`)?`mp4`:`webm`)),window.__lastVideo=e.size},p.start(),h=!0,window.__recording=!0,f.show()}function _(){h&&(p.stop(),h=!1,window.__recording=!1,f.hide())}let v=()=>h?_():g(),y=e=>new Promise(t=>setTimeout(t,e)),b=e=>window.dispatchEvent(new KeyboardEvent(`keydown`,{key:e}));async function x(){let e=o.clientWidth,t=o.clientHeight,n=e*.26,i=t*.74;for(let t=0;t<=10;t++)r.at(n+t*e*.028,i+Math.sin(t*.7)*16),await y(100);r.stop()}async function S(e){if(e.keys)for(let t of e.keys)b(t),await y(70);e.zoom&&t.zoomBy(e.zoom),e.orbit&&t.orbit(e.orbit[0],e.orbit[1]),e.timeTo!==void 0&&n.goTo(e.timeTo),e.office&&a[e.office]?.(),e.ripple&&await x(),e.waitMs&&await y(e.waitMs)}let C={tour:[{keys:[`6`,`0`],waitMs:600},{zoom:.72,waitMs:1700},{ripple:!0,waitMs:2400},{orbit:[.55,0],waitMs:1700},{timeTo:0,waitMs:3e3},{timeTo:.5,waitMs:1500},{keys:[`7`],waitMs:1e3},{zoom:1.5,waitMs:1400},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`8`],waitMs:900},{zoom:.65,waitMs:1200},{ripple:!0,waitMs:2600},{keys:[`7`],waitMs:700},{keys:[`B`],waitMs:300},{keys:[`B`],waitMs:900},{zoom:1.4,waitMs:2600}],daycycle:[{keys:[`6`,`0`],waitMs:700},{timeTo:.75,waitMs:2600},{timeTo:1,waitMs:2600},{timeTo:1.25,waitMs:2600},{timeTo:1.5,waitMs:2600},{timeTo:1.5,waitMs:800}],office:[{keys:[`o`],waitMs:1700},{office:`pet`,waitMs:1300},{office:`feed`,waitMs:1700},{office:`travel`,waitMs:1700},{keys:[`W`,`W`,`W`],waitMs:1800},{timeTo:0,waitMs:2400},{office:`laptop`,waitMs:800},{office:`closeLaptop`,waitMs:300},{timeTo:.5,waitMs:900},{keys:[`W`],waitMs:200},{keys:[`o`],waitMs:1500}],cities:[{keys:[`6`,`0`],waitMs:500},{timeTo:.78,waitMs:2800},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:2e3}],water:[{keys:[`6`,`0`],waitMs:600},{zoom:1.35,waitMs:2800},{orbit:[.7,0],waitMs:2600},{ripple:!0,waitMs:2200},{timeTo:0,waitMs:3200},{timeTo:.5,waitMs:1500},{orbit:[-.5,0],waitMs:2200}],morph:[{keys:[`6`,`3`],waitMs:700},{zoom:.55,waitMs:1800},{zoom:2.3,waitMs:1700},{zoom:1.26,waitMs:1700},{zoom:1.16,waitMs:1900},{zoom:.3,waitMs:2200}],skin:[{keys:[`o`],waitMs:1800},{keys:[`j`],waitMs:2e3},{keys:[`j`],waitMs:2e3},{timeTo:0,waitMs:2600},{timeTo:.5,waitMs:1500},{keys:[`u`],waitMs:2e3},{keys:[`j`],waitMs:1400},{keys:[`o`],waitMs:1500}]};async function w(e){let t=C[e];if(t){window.__director=e;for(let e of t)await S(e);window.__director=null}}async function T(e){await y(1600),g(),await w(e),await y(400),_(),window.__captureDone=!0}window.addEventListener(`keydown`,e=>{(e.key===`s`||e.key===`S`)&&u(),(e.key===`r`||e.key===`R`)&&v()});let E=s.get(`capture`);return E&&C[E]&&T(E),window.__capture={still:u,toggleRec:v,run:w,sequences:Object.keys(C)},window.__capture}function Xt(){let e=document.createElement(`div`);return e.textContent=`● REC`,e.style.cssText=`position:fixed;top:14px;right:16px;z-index:2;font:bold 12px ui-monospace,monospace;color:#ff3b30;letter-spacing:.12em;text-shadow:0 1px 3px #000;display:none;`,document.body.appendChild(e),{show:()=>{e.style.display=`block`},hide:()=>{e.style.display=`none`}}}var Zt=`
...
void main() {
  ...
  gl_FragColor = vec4(col, 1.0);
}`;export{q as C,xe as S,ye as _,zt as a,Ce as b,Ht as c,At as d,Fe as f,be as g,ve as h,qt as i,Ut as l,we as m,Qt as n,Vt as o,Ie as p,Yt as r,Bt as s,$t as t,Rt as u,Y as v,Te as x,Se as y};