import{$ as e,B as t,C as n,D as r,E as i,F as a,H as o,I as s,K as c,L as l,M as u,N as d,O as f,P as p,Q as m,R as h,S as g,T as _,V as v,W as y,Y as b,_ as x,a as S,at as C,c as w,dt as T,et as E,f as D,g as O,h as k,i as A,it as j,j as M,l as N,lt as P,m as ee,n as F,nt as I,o as te,p as L,q as ne,s as re,t as R,tt as z,u as B,ut as V,v as ie,w as H,x as U,z as ae}from"./three-fx94vX-a.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var oe=Math.atan(1/Math.SQRT2),W=Math.atan(.5),se=Math.PI/4,G={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},ce=.12,le=1.45,ue=4,de=40,fe=1.5,pe=16,me=6,he=22,ge=3.5,K=11,_e=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),ve=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function ye({aspect:e,fov:n=48,near:r=.1,far:i=100,target:a=new V(0,.8,0),azimuth:s=se,elevation:c=.52,distance:l=12,zoom:u=5.5}={}){let f=new o(n,e,r,i),p=new t(-1,1,1,-1,r,i),m=G.PERSPECTIVE,h=e,g={azimuth:s,elevation:c,distance:l,zoom:u,target:a.clone()},_={azimuth:s,elevation:c,distance:l,zoom:u,target:a.clone()},v=!1,y=()=>m===G.PERSPECTIVE?f:p;function b(e){e!==m&&(m=e,m===G.ISOMETRIC||m===G.DIMETRIC?(g.elevation=m===G.ISOMETRIC?oe:W,g.azimuth=ve(se,_.azimuth),v=!0):v=!1)}function x(e,t){g.azimuth+=e,v||(g.elevation=d.clamp(g.elevation+t,ce,le))}function S(e){m===G.PERSPECTIVE?g.distance=d.clamp(g.distance*e,ue,de):g.zoom=d.clamp(g.zoom*e,fe,pe)}function C(e,t){let n=g.azimuth,r=m===G.PERSPECTIVE?g.distance*.04:g.zoom*.08,i=new V(Math.cos(n),0,-Math.sin(n)),a=new V(-Math.sin(n),0,-Math.cos(n));g.target.addScaledVector(i,e*r),g.target.addScaledVector(a,t*r)}function w(e,t){h=e/t,f.aspect=h,f.updateProjectionMatrix()}function T(e){_.azimuth=_e(_.azimuth,g.azimuth,e),_.elevation=_e(_.elevation,g.elevation,e),_.distance=_e(_.distance,g.distance,e),_.zoom=_e(_.zoom,g.zoom,e),_.target.x=_e(_.target.x,g.target.x,e),_.target.y=_e(_.target.y,g.target.y,e),_.target.z=_e(_.target.z,g.target.z,e);let t=Math.cos(_.elevation),n=Math.sin(_.elevation),r=Math.cos(_.azimuth),i=Math.sin(_.azimuth),a=y();if(a.position.set(_.target.x+_.distance*t*i,_.target.y+_.distance*n,_.target.z+_.distance*t*r),a.lookAt(_.target),a.isOrthographicCamera){let e=_.zoom,t=e*h;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function E(e,t,n,r=!1){g.target.set(e,t,n),r&&_.target.copy(g.target)}function D(e,t=!1){g.zoom=d.clamp(e,fe,pe),t&&(_.zoom=g.zoom)}return{get camera(){return y()},get mode(){return m},get azimuth(){return _.azimuth},setTarget:E,setZoom:D,get styleT(){return m===G.PERSPECTIVE?d.clamp((_.distance-me)/(he-me),0,1):d.clamp((_.zoom-ge)/(K-ge),0,1)},setMode:b,orbit:x,zoomBy:S,pan:C,setViewport:w,update:T}}var be={value:0},xe=new L(`#ffffff`),Se={value:0},Ce={value:0},we={value:0},Te=new P,Ee={value:0},De={value:0},Oe=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
`;function ke(e){e.uniforms.uVector=be,e.uniforms.uVecTint={value:xe},e.uniforms.uVecShadow=Se,e.uniforms.uSnow=Ce,e.uniforms.uCloud=we,e.uniforms.uCloudOff={value:Te},e.uniforms.uFogCharm=Ee}function q(e){return e.replace(`#include <fog_fragment>`,`
    #ifdef USE_FOG
...
#include <shadowmask_pars_fragment>`)}var Me=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function J(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new L(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{ke(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new L(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=Ae(e.vertexShader),e.fragmentShader=q(je(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function Y(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{ke(e),s||(e.uniforms.uVecColor={value:new L(t)}),c&&(e.uniforms.uGlow={value:new L(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=De),e.vertexShader=Ae(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
`:``),f=c?`uGlow * mix(uGlowDay, uGlowNight, uWindowGlow)`:`vec3(0.0)`,p=q(je(e.fragmentShader.replace(`#include <common>`,`#include <common>
...
void main() {
  ...
  gl_FragColor = vec4(col, 1.0);
}`;export{Y as _,mn as a,an as c,$t as d,en as f,Pe as g,Ne as h,xn as i,Xt as l,Vt as m,vn as n,un as o,Yt as p,_n as r,sn as s,Sn as t,Qt as u,G as v};