import{A as e,B as t,C as n,D as r,E as i,G as a,H as o,I as s,J as c,K as l,L as u,M as d,N as f,O as p,P as m,Q as h,R as g,T as _,U as v,V as y,W as b,X as x,Y as S,_ as C,_t as w,b as T,bt as E,c as D,ct as O,d as k,dt as A,et as j,f as ee,ft as M,g as N,ht as P,i as te,j as F,k as I,l as ne,lt as re,m as ie,mt as L,n as ae,nt as R,o as oe,p as se,q as ce,r as le,rt as ue,s as z,st as B,t as de,tt as fe,u as V,ut as H,v as U,w as W,x as G,xt as pe,y as me,yt as he,z as ge}from"./three-fptASJPj.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var _e=(e,t,n,r)=>e+(t-e)*(1-Math.exp(-n*r)),ve=(e,t,n)=>e<t?t:e>n?n:e,ye=Math.atan(1/Math.SQRT2),be=Math.atan(.5),xe=Math.PI/4,Se={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},Ce=8,we=.03,Te=1.45,K=4,q=40,Ee=1.5,J=16,De=6,Oe=22,ke=3.5,Ae=11,je=(e,t,n)=>_e(e,t,Ce,n),Me=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function Ne({aspect:e,fov:n=48,near:r=.1,far:i=100,target:a=new E(0,.8,0),azimuth:o=xe,elevation:s=.52,distance:l=12,zoom:u=5.5}={}){let d=new x(n,e,r,i),f=new c(-1,1,1,-1,r,i),p=Se.PERSPECTIVE,m=e,h={azimuth:o,elevation:s,distance:l,zoom:u,target:a.clone()},g={azimuth:o,elevation:s,distance:l,zoom:u,target:a.clone()},_=!1,v=null,y=new E,b=()=>p===Se.PERSPECTIVE?d:f;function S(e){e!==p&&(p=e,p===Se.ISOMETRIC||p===Se.DIMETRIC?(h.elevation=p===Se.ISOMETRIC?ye:be,h.azimuth=Me(xe,g.azimuth),_=!0):_=!1)}function C(e,n){h.azimuth+=e,_||(h.elevation=t.clamp(h.elevation+n,we,Te))}function w(e){p===Se.PERSPECTIVE?h.distance=t.clamp(h.distance*e,K,q):h.zoom=t.clamp(h.zoom*e,Ee,J)}function T(e,t){let n=h.azimuth,r=p===Se.PERSPECTIVE?h.distance*.04:h.zoom*.08,i=new E(Math.cos(n),0,-Math.sin(n)),a=new E(-Math.sin(n),0,-Math.cos(n));h.target.addScaledVector(i,e*r),h.target.addScaledVector(a,t*r)}function D(e,t){m=e/t,d.aspect=m,d.updateProjectionMatrix()}function O(e){v&&(v(y),h.target.copy(y)),g.azimuth=je(g.azimuth,h.azimuth,e),g.elevation=je(g.elevation,h.elevation,e),g.distance=je(g.distance,h.distance,e),g.zoom=je(g.zoom,h.zoom,e),g.target.x=je(g.target.x,h.target.x,e),g.target.y=je(g.target.y,h.target.y,e),g.target.z=je(g.target.z,h.target.z,e);let t=Math.cos(g.elevation),n=Math.sin(g.elevation),r=Math.cos(g.azimuth),i=Math.sin(g.azimuth),a=b();if(a.position.set(g.target.x+g.distance*t*i,g.target.y+g.distance*n,g.target.z+g.distance*t*r),a.lookAt(g.target),a.isOrthographicCamera){let e=g.zoom,t=e*m;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function k(e,t,n,r=!1){h.target.set(e,t,n),r&&g.target.copy(h.target)}function A(e,n=!1){h.zoom=t.clamp(e,Ee,J),n&&(g.zoom=h.zoom)}function j(e,t=!1){h.azimuth=Me(e,g.azimuth),t&&(g.azimuth=h.azimuth)}function ee(e,n=!1){h.elevation=t.clamp(e,we,Te),n&&(g.elevation=h.elevation)}function M(e,{frame:n,snap:r=!1}={}){v=e,r&&(v(y),h.target.copy(y),g.target.copy(y)),n!=null&&(p===Se.PERSPECTIVE?h.distance=t.clamp(n,K,q):h.zoom=t.clamp(n,Ee,J))}function N(){v=null}return{get camera(){return b()},get mode(){return p},get azimuth(){return g.azimuth},get following(){return!!v},setTarget:k,setZoom:A,setFollow:M,clearFollow:N,setAzimuth:j,setElevation:ee,get styleT(){return p===Se.PERSPECTIVE?t.clamp((g.distance-De)/(Oe-De),0,1):t.clamp((g.zoom-ke)/(Ae-ke),0,1)},setMode:S,orbit:C,zoomBy:w,pan:T,setViewport:D,update:O}}var Pe={value:0},Fe=new N(`#ffffff`),Ie={value:0},Le={value:0},Re={value:0},ze=new he,Be={value:0},Ve={value:0},He=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
`:``),f=c?`uGlow * mix(uGlowDay, uGlowNight, uWindowGlow)`:`vec3(0.0)`,p=We(Y(e.fragmentShader.replace(`#include <common>`,`#include <common>
`+d+He).replace(`#include <opaque_fragment>`,`#include <opaque_fragment>
        ...
        }`)));c&&(p=p.replace(`#include <emissivemap_fragment>`,`#include <emissivemap_fragment>\n  totalEmissiveRadiance += ${f};`)),e.fragmentShader=p},e}var Je={value:0},Ye={value:0},Xe={value:0};function Ze(e,{sway:t=!1}={}){return e.customProgramCacheKey=()=>t?`lgr-ao-sway`:`lgr-ao`,e.onBeforeCompile=e=>{e.uniforms.uAoStrength=Je,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
attribute float aAo;
varying float vAo;`+(t?`
...
void main() { gl_FragColor = vec4(texture2D(uSrc, vUv).r, 0.0, 0.0, 0.0); }`,Ln=`precision highp float;
varying vec2 vUv;
...
void main() {
  ...
  gl_FragColor = vec4(st.x, Snew, 0.0, 0.0);
}`;function Bn({renderer:e,N:t,cell:n,half:r,worldSize:o,seaY:s=0,FLOW:u,DAMP:d,MIN_DEPTH:f,KC:p,KE:m,KD:g,KADV:_,MAXD:y,readTerrain:b}){let x=e.getContext();if(!(x&&x.getExtension&&x.getExtension(`EXT_color_buffer_float`)))return typeof console<`u`&&console.warn(`[L87] EXT_color_buffer_float unavailable — GPU flow backend cannot run; staying on CPU.`),null;let S={type:i,format:ue,minFilter:l,magFilter:l,wrapS:ie,wrapT:ie,depthBuffer:!1,stencilBuffer:!1},C=[new pe(t,t,S),new pe(t,t,S)],w=[new pe(t,t,S),new pe(t,t,S)],T=[new pe(t,t,S),new pe(t,t,S)],k=new Float32Array(t*t*4),j=new me(k,t,t,ue,i);j.minFilter=l,j.magFilter=l,j.wrapS=j.wrapT=ie;let ee=new Float32Array(t*t),M=!1,P=1,te=!0,F=new O,I=new c(-1,1,1,-1,0,1),L=new v(new h(2,2),null);L.frustumCulled=!1,F.add(L);let ae=new he(1/t,1/t),R=(e,t)=>new re({vertexShader:Mn,fragmentShader:e,uniforms:t}),oe=R(Nn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uFlow:{value:u},uDamp:{value:d}}),se=R(Pn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uSeaY:{value:s}}),ce=R(Fn,{uState:{value:null},uTerr:{value:null},uN:{value:t},uSeaY:{value:s},uRain:{value:0},uPourCount:{value:0},uPours:{value:Array.from({length:8},()=>new E)},uPourR:{value:new Float32Array(8)}}),le=R(In,{uSrc:{value:j}}),z=()=>({uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uCell:{value:n},uSeaY:{value:s},uKC:{value:p},uKE:{value:m},uKD:{value:g},uMaxD:{value:y},uMinDepth:{value:f},uErosK:{value:P}}),B=R(Ln,z()),de=R(Rn,z()),fe=R(zn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uSeaY:{value:s},uKADV:{value:_}});function V(t,n){L.material=t;let r=e.getRenderTarget();e.setRenderTarget(n),e.render(F,I),e.setRenderTarget(r)}let H=new N;function U(t){let n=e.getRenderTarget(),r=e.getClearAlpha();e.getClearColor(H),e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1),e.setClearColor(H,r),e.setRenderTarget(n)}function W(){b(ee);for(let e=0;e<t*t;e++)k[e*4]=ee[e];j.needsUpdate=!0,V(le,T[0])}function G(){U(C[0]),U(C[1]),U(w[0]),U(w[1])}G();let ge=t*t,_e=new Float32Array(ge*3),ve=new Float32Array(ge*2);for(let e=0;e<t;e++)for(let i=0;i<t;i++){let a=e*t+i;_e[a*3]=i*n-r,_e[a*3+1]=0,_e[a*3+2]=e*n-r,ve[a*2]=(i+.5)/t,ve[a*2+1]=(e+.5)/t}let ye=[];for(let e=0;e<t-1;e++)for(let n=0;n<t-1;n++){let r=e*t+n,i=e*t+n+1,a=(e+1)*t+n,o=(e+1)*t+n+1;ye.push(r,a,i,i,a,o)}let be=new ne;be.setAttribute(`position`,new D(_e,3)),be.setAttribute(`aGridUv`,new D(ve,2)),be.setIndex(ye),be.boundingSphere=new A(new E(0,0,0),o);let xe={uStateTex:{value:C[0].texture},uTerrTex:{value:T[0].texture},uMinDepth:{value:f}},Se=new a({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});Se.onBeforeCompile=e=>{e.uniforms.uStateTex=xe.uStateTex,e.uniforms.uTerrTex=xe.uTerrTex,e.uniforms.uMinDepth=xe.uMinDepth,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
varying float vDepth;`).replace(`#include <dithering_fragment>`,`#include <dithering_fragment>
  ...
  gl_FragColor.a *= clamp((vDepth - 0.012) * 7.0, 0.16, 0.86);`)},Se.customProgramCacheKey=()=>`lgr-flow-gpu`;let Ce=new v(be,Se);Ce.frustumCulled=!1,Ce.castShadow=!1,Ce.receiveShadow=!1,Ce.raycast=()=>{},Ce.renderOrder=3,Ce.visible=!1;function we(){xe.uStateTex.value=C[0].texture,xe.uTerrTex.value=T[0].texture}function Te(e){e=Math.min(e,1/30),(!M||te)&&(W(),te=!1),oe.uniforms.uState.value=C[0].texture,oe.uniforms.uTerr.value=T[0].texture,oe.uniforms.uFlux.value=w[0].texture,oe.uniforms.uDt.value=e,V(oe,w[1]),w.reverse(),se.uniforms.uState.value=C[0].texture,se.uniforms.uTerr.value=T[0].texture,se.uniforms.uFlux.value=w[0].texture,se.uniforms.uDt.value=e,V(se,C[1]),C.reverse(),M&&(B.uniforms.uState.value=C[0].texture,B.uniforms.uTerr.value=T[0].texture,B.uniforms.uFlux.value=w[0].texture,B.uniforms.uDt.value=e,B.uniforms.uErosK.value=P,V(B,T[1]),de.uniforms.uState.value=C[0].texture,de.uniforms.uTerr.value=T[0].texture,de.uniforms.uFlux.value=w[0].texture,de.uniforms.uDt.value=e,de.uniforms.uErosK.value=P,V(de,C[1]),T.reverse(),C.reverse(),fe.uniforms.uState.value=C[0].texture,fe.uniforms.uTerr.value=T[0].texture,fe.uniforms.uFlux.value=w[0].texture,fe.uniforms.uDt.value=e,V(fe,C[1]),C.reverse()),we()}function K(){ce.uniforms.uState.value=C[0].texture,ce.uniforms.uTerr.value=T[0].texture,V(ce,C[1]),C.reverse(),we()}function q(e,t,i=.5,a=1.6){(te||!M)&&(W(),te=!1);let o=(e+r)/n,s=(t+r)/n,c=Math.max(1,a/n);ce.uniforms.uRain.value=0,ce.uniforms.uPourCount.value=1,ce.uniforms.uPours.value[0].set(o,s,i),ce.uniforms.uPourR.value[0]=c,K()}function Ee(e=.004){(te||!M)&&(W(),te=!1),ce.uniforms.uPourCount.value=0,ce.uniforms.uRain.value=e,K()}function J(){G(),te=!0,we()}function De(e,t){M=!!e,t!=null&&(P=Math.max(0,t)),te=!0}let Oe=new Float32Array(t*t*4);function ke(n){return e.readRenderTargetPixels(n,0,0,t,t,Oe),Oe}function Ae(){let e=ke(C[0]),n=0;for(let r=0;r<t*t;r++)n+=e[r*4];return n}function je(e,i){let a=Math.round((e+r)/n),o=Math.round((i+r)/n);return a<0||a>=t||o<0||o>=t?0:ke(C[0])[(o*t+a)*4]}function Me(){let e=ke(C[0]),n=0;for(let r=0;r<t*t;r++)n+=e[r*4+1];return n}function Ne(){let e=ke(C[0]),n=new Float32Array(t*t);for(let r=0;r<t*t;r++)n[r]=e[r*4];return n}function Pe(){let e=ke(T[0]),n=new Float32Array(t*t);for(let r=0;r<t*t;r++)n[r]=e[r*4];return n}function Fe(e){Ce.visible=!!e}function Ie(){for(let e of C)e.dispose();for(let e of w)e.dispose();for(let e of T)e.dispose();j.dispose(),be.dispose(),Se.dispose(),L.geometry.dispose(),oe.dispose(),se.dispose(),ce.dispose(),le.dispose(),B.dispose(),de.dispose(),fe.dispose()}return{mesh:Ce,step:Te,pourAt:q,rain:Ee,clear:J,totalWater:Ae,cellAt:je,totalSediment:Me,readW:Ne,readTerr:Pe,setErosion:De,setVisible:Fe,dispose:Ie,get grid(){return t},get erosion(){return M}}}function Vn({worldHeightAt:e,applyErosion:t=null,syncErodedTerrain:n=null,worldSize:r=26,grid:i=96,seaY:o=0,renderer:s=null}={}){let c=i,l=new Float32Array(c*c),u=new Float32Array(c*c),d=new Float32Array(c*c),f=new Float32Array(c*c),m=new Float32Array(c*c),h=new Float32Array(c*c),g=new Float32Array(c*c),_=new Float32Array(c*c),y=new Float32Array(c*c),b=!1,x=1,S=r/(c-1),C=r/2,w=e||(()=>0),T=e=>e*S-C,E=e=>e*S-C,O=(e,t)=>t*c+e,k=26*S,A=.9,j=.006,ee=.5,M=.25,N=.3,P=.006;function te(){for(let e=0;e<c;e++)for(let t=0;t<c;t++)h[O(t,e)]=w(T(t),E(e))}let F=`cpu`,I=null,re=new Float32Array(c*c),ie=0;function L(e){te();for(let t=0;t<c*c;t++)e[t]=h[t]}function ae(){return I||!s?I:(I=Bn({renderer:s,N:c,cell:S,half:C,worldSize:r,seaY:o,FLOW:k,DAMP:A,MIN_DEPTH:j,KC:ee,KE:M*3,KD:N*3,KADV:6,MAXD:P*3,readTerrain:L}),I&&ge.add(I.mesh),I)}function R(e){if(e===`gpu`){if(ae(),!I)return typeof console<`u`&&console.info(`[L87] GPU backend unavailable (no renderer / no float RT) — staying on CPU (oracle).`),F=`cpu`,oe(),F;F=`gpu`,I.setErosion(b,x),b&&(L(re),ie=0)}else F=`cpu`;return oe(),F}function oe(){I&&I.setVisible(F===`gpu`),F===`gpu`?he.visible=!1:_e()}let se=new Float32Array(c*c);function ce(){if(++ie<20)return;ie=0;let e=I.readTerr(),t=!1;for(let n=0;n<c*c;n++){let r=e[n]-re[n];se[n]=r,r!==0&&(t=!0),re[n]=e[n]}t&&n(se,c)}function le(e){if(F===`gpu`&&I){I.step(e),b&&n&&ce();return}e=Math.min(e,1/30),te();for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t),i=h[r]+l[r],a=0,o=0,s=0,p=0;n>0&&(a=Math.max(0,u[r]*A+e*k*(i-(h[r-1]+l[r-1])))),n<c-1&&(o=Math.max(0,d[r]*A+e*k*(i-(h[r+1]+l[r+1])))),t>0&&(p=Math.max(0,m[r]*A+e*k*(i-(h[r-c]+l[r-c])))),t<c-1&&(s=Math.max(0,f[r]*A+e*k*(i-(h[r+c]+l[r+c]))));let g=(a+o+s+p)*e,_=g>1e-9?Math.min(1,l[r]/g):1;u[r]=a*_,d[r]=o*_,m[r]=p*_,f[r]=s*_}for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t),i=0;n>0&&(i+=d[r-1]),n<c-1&&(i+=u[r+1]),t>0&&(i+=f[r-c]),t<c-1&&(i+=m[r+c]);let a=u[r]+d[r]+m[r]+f[r];l[r]+=e*(i-a),l[r]<0&&(l[r]=0),h[r]<o-.02&&(l[r]=0)}b&&t&&ue(e),_e()}function ue(e){y.fill(0);for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t);if(l[r]<=j){if(g[r]>0){let t=Math.min(P,N*g[r]*e);y[r]+=t,g[r]-=t}continue}let i=(u[r]+d[r]+f[r]+m[r])/(l[r]+.02),a=n>0?h[r-1]:h[r],o=n<c-1?h[r+1]:h[r],s=t>0?h[r-c]:h[r],p=t<c-1?h[r+c]:h[r],_=Math.min(2,Math.hypot(o-a,p-s)/(2*S)),v=ee*i*Math.max(.05,_)*x;if(v>g[r]){let t=Math.min(P,M*(v-g[r])*e);y[r]-=t,g[r]+=t}else{let t=Math.min(P,N*(g[r]-v)*e);y[r]+=t,g[r]-=t,g[r]<0&&(g[r]=0)}}_.set(g);for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t),i=u[r]+d[r]+f[r]+m[r];if(i<=1e-9||g[r]<=1e-9)continue;let a=Math.min(g[r],g[r]*6*e);_[r]-=a,n>0&&(_[r-1]+=a*u[r]/i),n<c-1&&(_[r+1]+=a*d[r]/i),t>0&&(_[r-c]+=a*m[r]/i),t<c-1&&(_[r+c]+=a*f[r]/i)}g.set(_);for(let e=0;e<c*c;e++)g[e]<0&&(g[e]=0),h[e]<o-.02&&(g[e]=0);t(y,c)}function z(e,t){b=!!e,t!=null&&(x=Math.max(0,t)),e||g.fill(0),F===`gpu`&&I&&(I.setErosion(e,t),e&&(L(re),ie=0))}function B(e,t,n=.5,r=1.6){if(F===`gpu`&&I)return I.pourAt(e,t,n,r);let i=(e+C)/S,a=(t+C)/S,o=Math.max(1,r/S),s=Math.max(0,Math.floor(i-o)),u=Math.min(c-1,Math.ceil(i+o)),d=Math.max(0,Math.floor(a-o)),f=Math.min(c-1,Math.ceil(a+o));for(let e=d;e<=f;e++)for(let t=s;t<=u;t++){let r=Math.hypot(t-i,e-a);r<=o&&(l[O(t,e)]+=n*(1-r/o))}}function de(e=.004){if(F===`gpu`&&I)return I.rain(e);te();for(let t=0;t<c*c;t++)h[t]>o&&(l[t]+=e)}function fe(){if(F===`gpu`&&I)return I.clear();l.fill(0),u.fill(0),d.fill(0),f.fill(0),m.fill(0),g.fill(0),_e()}function V(){if(F===`gpu`&&I)return I.totalWater();let e=0;for(let t=0;t<c*c;t++)e+=l[t];return e}function H(e,t){if(F===`gpu`&&I)return I.cellAt(e,t);let n=Math.round((e+C)/S),r=Math.round((t+C)/S);return n<0||n>=c||r<0||r>=c?0:l[O(n,r)]}let U=new Float32Array(c*c*3),W=new Float32Array(c*c);for(let e=0;e<c;e++)for(let t=0;t<c;t++){let n=O(t,e);U[n*3]=T(t),U[n*3+1]=-50,U[n*3+2]=E(e)}let G=[];for(let e=0;e<c-1;e++)for(let t=0;t<c-1;t++){let n=O(t,e),r=O(t+1,e),i=O(t,e+1),a=O(t+1,e+1);G.push(n,i,r,r,i,a)}let pe=new ne;pe.setAttribute(`position`,new D(U,3)),pe.setAttribute(`aDepth`,new D(W,1)),pe.setIndex(G),pe.computeVertexNormals();let me=new a({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});me.onBeforeCompile=e=>{e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
attribute float aDepth;
varying float vDepth;`).replace(`#include <begin_vertex>`,`#include <begin_vertex>
  vDepth = aDepth;`),e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>
varying float vDepth;`).replace(`#include <dithering_fragment>`,`#include <dithering_fragment>
  if (vDepth < 0.012) discard;
  gl_FragColor.a *= clamp((vDepth - 0.012) * 7.0, 0.16, 0.86);`)},me.customProgramCacheKey=()=>`lgr-flow`;let he=new v(pe,me);he.frustumCulled=!1,he.castShadow=!1,he.receiveShadow=!1,he.raycast=()=>{},he.renderOrder=3;let ge=new p;ge.add(he),ge.raycast=()=>{};function _e(){let e=0;for(let t=0;t<c*c;t++){let n=l[t];W[t]=n,U[t*3+1]=n>j?h[t]+n:-50,n>j&&e++}pe.attributes.position.needsUpdate=!0,pe.attributes.aDepth.needsUpdate=!0,he.visible=e>0,typeof window<`u`&&(window.__flowWet=e)}_e();function ve(){if(F===`gpu`&&I)return I.totalSediment();let e=0;for(let t=0;t<c*c;t++)e+=g[t];return e}return{group:ge,step:le,pourAt:B,rain:de,clear:fe,totalWater:V,cellAt:H,setErosion:z,totalSediment:ve,setBackend:R,get backend(){return F},_debugReadW:()=>F===`gpu`&&I?I.readW():l.slice(),_debugReadTerr:()=>F===`gpu`&&I?I.readTerr():(te(),h.slice()),_debugReadS:()=>F===`gpu`&&I?I.totalSediment():ve(),_debugStepN:(e,t=1/60)=>{for(let n=0;n<e;n++)le(t)},get erosion(){return b},get grid(){return c},get visible(){return he.visible}}}function Hn({extent:e=26,count:t=2e3,seed:n=7,yLo:r=.4,yHi:i=7}={}){let a=Qe((n^218462737)>>>0),o=e/2,s=new Float32Array(t*3),c=new Float32Array(t),l=new Float32Array(t);for(let e=0;e<t;e++)s[e*3]=(a()*2-1)*o,s[e*3+1]=r+a()*(i-r),s[e*3+2]=(a()*2-1)*o,c[e]=a()*Math.PI*2,l[e]=.6+a()*.8;let u=new ne;u.setAttribute(`position`,new D(s,3)),u.setAttribute(`aPh`,new D(c,1)),u.setAttribute(`aSp`,new D(l,1)),u.setDrawRange(0,t);let d={uTime:{value:0},uWind:{value:0},uHalf:{value:o},uOpacity:{value:0},uColor:{value:new N(`#fff3d4`)},uPx:{value:2.2}},f=new re({uniforms:d,transparent:!0,depthWrite:!1,depthTest:!0,blending:2,vertexShader:`
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,wi={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Ti=[`gb`,`8-bit`,`16-bit`,`modern`],Ei={"ink-gold (day)":[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],"ink-gold (night)":[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],"terminal (day)":[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],"terminal (night)":[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],"neutral (photoreal)":[`#1B1B1E`,`#3D3A3A`,`#5E5750`,`#867C70`,`#A99C8A`,`#C8BCAB`,`#E3DCCF`,`#F5F1E8`],"cool (noir)":[`#0A0E14`,`#16202E`,`#243447`,`#3A536B`,`#5A7D96`,`#86A6BD`,`#B6CDDA`,`#E6EEF2`],"warm (sunset)":[`#190B0A`,`#3B150F`,`#6E2A17`,`#A8421F`,`#DB702F`,`#F2A23E`,`#F9CF76`,`#FDF0C4`],"vibrant (pop)":[`#1A1A2E`,`#E43F5A`,`#F9A826`,`#FFE05D`,`#2EC4B6`,`#3A86FF`,`#8338EC`,`#FFFFFF`],"mono (ink)":[`#0C0C0C`,`#2A2A2A`,`#474747`,`#666666`,`#8A8A8A`,`#B0B0B0`,`#D6D6D6`,`#F5F5F5`]};function Di(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new N(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new me(n,t,1,ue,i);return r.minFilter=l,r.magFilter=l,r.needsUpdate=!0,r}function Oi(e,t){let n=[];for(let t=0;t+2<e.length;t+=3)n.push([e[t],e[t+1],e[t+2]]);if(n.length===0)return[`#000000`];let r=e=>{let t=[255,255,255],n=[0,0,0];for(let r of e)for(let e=0;e<3;e++)t[e]=Math.min(t[e],r[e]),n[e]=Math.max(n[e],r[e]);let r=[n[0]-t[0],n[1]-t[1],n[2]-t[2]],i=r[0]>=r[1]&&r[0]>=r[2]?0:r[1]>=r[2]?1:2;return{ax:i,range:r[i]}},i=[n];for(;i.length<t;){let e=-1,t=-1;if(i.forEach((n,i)=>{if(n.length>1){let{range:a}=r(n);a>t&&(t=a,e=i)}}),e<0)break;let n=i[e],{ax:a}=r(n);n.sort((e,t)=>e[a]-t[a]);let o=n.length>>1;i.splice(e,1,n.slice(0,o),n.slice(o))}return i.map(e=>{let t=[0,0,0];for(let n of e)for(let e=0;e<3;e++)t[e]+=n[e];return`#`+t.map(t=>Math.round(t/e.length)).map(e=>e.toString(16).padStart(2,`0`)).join(``)})}var ki=220,Ai={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},ji={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Mi(e){if(typeof document>`u`||document.getElementById(`lgr-nowebgl`))return;let t=document.createElement(`div`);t.id=`lgr-nowebgl`,t.style.cssText=`position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;background:#0e1116;color:#cdd6e4;font:16px/1.6 system-ui,-apple-system,sans-serif;text-align:center;padding:2rem;`,t.innerHTML=`<div style="max-width:30rem"><div style="font-size:2.4rem;margin-bottom:1rem">🌊</div><h1 style="font-size:1.3rem;margin:0 0 .6rem;color:#fff;font-weight:600">This experience needs a modern browser</h1><p style="margin:0;color:#9aa6b8">`+e+`</p></div>`,document.body&&document.body.appendChild(t)}function Ni({demo:e=!1,citySeed:n=0,profileIndex:i=0}={}){let o;try{o=new te({antialias:!0,preserveDrawingBuffer:!0})}catch(e){throw Mi(`This experience needs WebGL2 — please open it in an up-to-date browser (Chrome, Edge, Firefox, or Safari on iOS 15+) with hardware acceleration enabled.`),e}o.shadowMap.enabled=!0,o.shadowMap.type=1,o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0;let s=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches),u=s?1.5:2;o.setPixelRatio(Math.min(window.devicePixelRatio,u)),o.setSize(window.innerWidth,window.innerHeight),o.setClearColor(920327,1),document.body.appendChild(o.domElement);let d=o.getDrawingBufferSize(new he),f=!1,m=!1,_=()=>{};o.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),f=!0,typeof window<`u`&&(window.__contextLost=!0)},!1),o.domElement.addEventListener(`webglcontextrestored`,()=>{_(),f=!1,typeof window<`u`&&(window.__contextLost=!1)},!1);let x=new O;x.fog=new r(10465470,0);let S=new N(`#aeb6c0`),C=.062,w=new N(`#74508f`),D=new N,k=Ne({aspect:window.innerWidth/window.innerHeight}),A=Ct({t:.5}),j=o.getContext(),ee=!!(j&&j.getExtension&&(j.getExtension(`EXT_color_buffer_float`)||j.getExtension(`EXT_color_buffer_half_float`)));!ee&&typeof console<`u`&&console.info(`[L90 H1] No float colour buffer (EXT_color_buffer_float/half_float) — wave sim OFF, flat-sea fallback.`);let M={type:I,format:ue,minFilter:l,magFilter:l,wrapS:ie,wrapT:ie,depthBuffer:!1,stencilBuffer:!1},P=ee?[new pe(256,256,M),new pe(256,256,M),new pe(256,256,M)]:null;if(P){for(let e of P)o.setRenderTarget(e),o.clear();o.setRenderTarget(null)}let F=new me(new Uint8Array([0,0,0,255]),1,1,ue);F.needsUpdate=!0;let ne=new O,L=new c(-1,1,1,-1,0,1),ae=new re({vertexShader:Mn,fragmentShader:mi,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new he(1/256,1/256)},uMouse:{value:new he(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new E)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new E)}}});ne.add(new v(new h(2,2),ae));let R=new pe(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1});function oe(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new V(t);return r.colorSpace=B,r}let se=new v(new h(28,28),new b({map:oe(e)}));se.rotation.x=-Math.PI/2,se.position.y=-.35,x.add(se);let ce=new v(new h(40,24),new re({depthWrite:!1,vertexShader:fi,fragmentShader:pi,uniforms:{uTime:{value:0},uInk:{value:A.horizon},uGold:{value:A.sky},uFogColor:{value:D},uFogAmt:{value:0},uFogCharm:Be}}));ce.position.set(0,3,-8),x.add(ce);let le=new re({vertexShader:hi,fragmentShader:gi,uniforms:{uHeight:{value:ee?null:F},uScene:{value:R.texture},uTexel:{value:new he(1/256,1/256)},uResolution:{value:new he(d.x,d.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new y},uLightDir:{value:A.sunDir},uInk:{value:new N(`#2A2218`)},uGold:{value:new N(`#B89968`)},uVector:Pe,uVecWater:{value:new N(`#1fb8d8`)},uVecTint:{value:Fe}}}),z=new v(new h(28,28,255,255),le);z.rotation.x=-Math.PI/2,z.updateMatrixWorld(!0),le.uniforms.uNormalMatrix.value.getNormalMatrix(z.matrixWorld),x.add(z);let de={value:0},fe=Xt({windowGlow:de}),H=ht({seed:n,profileIndex:i,landmarkFactory:fe,windowGlow:de});x.add(H.group);let U=Ot({plinthTop:.3,extent:H.extent,profile:H.state.profile});x.add(U.group);let W=zt({extent:H.extent,waterSize:28,plinthTop:.3});x.add(W.group),ae.uniforms.uWakeDrops.value=W.wakeDrops;let G=Qt({extent:H.extent});x.add(G.group),ae.uniforms.uRainDrops.value=G.rainDrops;let ge=en({extent:H.extent});x.add(ge.group);let _e=[U,W,ge],ve=rn({rig:k,getCamera:()=>k.camera,sources:_e}),ye=di();x.add(ye.group);let be=qr({scale:90});x.add(be.mesh),x.environmentIntensity=.32;let xe=!1;function Se(e){let t=e&&A.sunArc.y>-.04;t!==xe&&(xe=t,be.mesh.visible=t,ce.visible=!t)}let Ce=null,we=-1;_=()=>{Ce=null,we=-1,o.shadowMap.needsUpdate=!0};function Te(){let e=Math.floor(A.t%1*4)%4;return(e!==we||!Ce)&&(we=e,Ce=be.buildEnv(o)),Ce}let K=null,q=null,Ee=null,J=null,De=!1,Oe=1234,ke=`valley`,Ae=rr.map(e=>e.key),je=new a({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Me=()=>[H.group,U.group,W.group],He=()=>[K,q,Ee].filter(Boolean);function Ue(){for(let e of He())x.remove(e),e.userData.dispose?.();let e=cr({seed:Oe,size:160,preset:ke});J=e,K=hr(e,{worldSize:26,baseY:0,chunks:6}),q=Br({terrain:e,seed:Oe,worldSize:26,baseY:0,biomeKeys:Ae}),Ee=Ur(e,{worldSize:26,baseY:0,maxLakes:3,material:je});for(let e of He())e.visible=De,x.add(e);Y!==void 0&&Y&&Y.clear(),Z!==void 0&&Z&&Z.clear(),typeof window<`u`&&(window.__world={seed:Oe,preset:ke,active:De,chunks:K.children.length,scatter:q.userData.counts,lakes:Ee.userData.count})}let We=e=>{for(let t of He())t.visible=e};function Ge(e,t){if(!J)return 0;let{size:n,height:r,sea:i,relief:a}=J,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let Y=An({heightAt:Ge,seaSurfaceY:0,waterY:.06});Y.group.visible=!1,x.add(Y.group),_e.push(Y);let Ke=new p;Ke.raycast=()=>{},x.add(Ke);let qe=null;function X(e,t=0,n=0,r={}){return qe&&=(Ke.remove(qe.obj),Y.despawn(qe),null),qe=Y.spawn(e,t,n,r),qe&&(Y.group.remove(qe.obj),Ke.add(qe.obj)),qe?qe.followable:null}let Ze=0;function Qe(e,t){if(!J||!K)return;let{size:n,height:r,relief:i}=J,a=26/(n-1),o=26/(t-1),s=i>1e-6?1/i:0,c=!1;for(let i=0;i<t;i++)for(let l=0;l<t;l++){let u=e[i*t+l];if(u===0)continue;c=!0;let d=u*s,f=l*o/a,p=i*o/a,m=Math.max(0,Math.round(f-1)),h=Math.min(n-1,Math.round(f+1)),g=Math.max(0,Math.round(p-1)),_=Math.min(n-1,Math.round(p+1));for(let e=g;e<=_;e++)for(let t=m;t<=h;t++){let i=e*n+t,a=r[i]+d;r[i]=a<0?0:a>1?1:a}}c&&(Ze++,Ze%8==0&&gr(K,J,K.children),Ze%24==0&&q&&zr(q,J,{worldSize:26,baseY:0}))}function $e(e,t){if(!J||!K)return;let{size:n,height:r,relief:i}=J,a=i>1e-6?1/i:0,o=(t-1)/(n-1),s=!1;for(let i=0;i<n;i++){let c=i*o,l=Math.floor(c),u=c-l,d=Math.min(t-1,l+1);for(let c=0;c<n;c++){let f=c*o,p=Math.floor(f),m=f-p,h=Math.min(t-1,p+1),g=e[l*t+p],_=e[l*t+h],v=e[d*t+p],y=e[d*t+h],b=(g*(1-m)+_*m)*(1-u)+(v*(1-m)+y*m)*u;if(b!==0){s=!0;let e=i*n+c,t=r[e]+b*a;r[e]=t<0?0:t>1?1:t}}}s&&(gr(K,J,K.children),q&&zr(q,J,{worldSize:26,baseY:0}))}let Z=Vn({worldHeightAt:Ge,applyErosion:Qe,syncErodedTerrain:$e,worldSize:26,grid:96,seaY:0,renderer:o});Z.group.visible=!1,x.add(Z.group);let et=Hn({extent:26,count:s?500:2e3});et.group.visible=!1,x.add(et.group);let tt=null,nt=!1,rt=new Set;function it(){!J||!Ee||(x.remove(Ee),Ee.userData.dispose?.(),Ee=Ur(J,{worldSize:26,baseY:0,maxLakes:3,material:je}),Ee.visible=De&&!nt,x.add(Ee),window.__world&&(window.__world.lakes=Ee.userData.count))}function at(){it(),q&&zr(q,J,{worldSize:26,baseY:0})}function ot(e,t,n=1,r=2.2,i=.05){if(!J||!K)return;let a=J.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=J.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}rt.clear();for(let e of K.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&rt.add(e)}gr(K,J,rt),tt&&clearTimeout(tt),tt=setTimeout(at,140)}function st(e,t,n,r=2.2){if(!J||!K||n==null)return;let i=J.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=J.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);rt.clear();for(let e of K.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&rt.add(e)}gr(K,J,rt,!0)}let ct=[`tree`,`rock`,`tuft`];function lt(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!J||!q)return 0;if(a)return Lr(q,n||`all`,e,t,i);let o=J.size,s=26/(o-1),c=J.height,l=J.sea,u=J.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Rr[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;Ir(q,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&q.userData.counts)for(let e of ct)q.userData.counts[e]=(q.userData.placements[e]||[]).length;return g}let ut=[];function dt(){if(!q)return null;let e=q.userData.placements,t={};for(let n of ct)t[n]=(e[n]||[]).map(e=>({...e}));return t}function ft(){J&&(ut.push({h:J.height.slice(),b:J.biome.slice(),sc:dt(),pl:Y.snapshot()}),ut.length>12&&ut.shift())}function pt(){if(!J||!ut.length)return!1;let e=ut.pop();if(J.height.set(e.h),J.biome.set(e.b),e.sc&&q){let t=q.userData.placements;for(let n of ct)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&Y.restore(e.pl),gr(K,J,K.children,!0),at(),!0}let mt=new Set([`boat`,`fish`]),gt=new Set([`person`,`atv`]);function _t(e,t,n){if(!J)return null;let r=Ge(t,n)<0;return mt.has(e)&&!r||gt.has(e)&&r?null:Y.spawn(e,t,n)}function vt(e,t,n=2.5){return Y.removeNear(e,t,n)}function yt(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function bt(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let xt=e=>yt(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),St=e=>yt(e);function wt(){let e=q?q.userData.placements:{},t={};for(let n of ct)t[n]=(e[n]||[]).map(e=>({...e}));return t}function Tt(){return J?{v:1,seed:Oe,preset:ke,size:J.size,height:xt(J.height),biome:St(J.biome),scatter:wt(),entities:Y.snapshot()}:null}function Et(){if(!J)return null;let e=cr({seed:Oe,size:160,preset:ke}),t=J.height,n=J.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:Oe,preset:ke,hd:r,bd:i,entities:Y.snapshot()}}function Dt(e){q&&(x.remove(q),q.userData.dispose?.()),q=Mr(e||{tree:[],rock:[],tuft:[]}),q.userData.counts=ct.reduce((e,t)=>(e[t]=(q.userData.placements[t]||[]).length,e),{}),q.visible=De,x.add(q)}function kt(e){if(!e||e.v!==1)return!1;let t=25600;if(e.height!=null||e.biome!=null){if(typeof e.height!=`string`||typeof e.biome!=`string`)return!1;let n,r;try{n=bt(e.height),r=bt(e.biome)}catch{return!1}if(n.byteLength%4!=0||n.byteLength>>2!=t||r.length<t)return!1;let i=new Float32Array(n.buffer,n.byteOffset,n.byteLength>>2);for(let e=0;e<i.length;e++)if(!Number.isFinite(i[e]))return!1}if(e.hd!=null&&!Array.isArray(e.hd)||e.bd!=null&&!Array.isArray(e.bd))return!1;if(Array.isArray(e.hd))for(let n=0;n<e.hd.length;n+=2){let r=e.hd[n];if(!Number.isInteger(r)||r<0||r>=t||!Number.isFinite(e.hd[n+1]))return!1}if(Array.isArray(e.bd))for(let n=0;n<e.bd.length;n+=2){let r=e.bd[n];if(!Number.isInteger(r)||r<0||r>=t)return!1}Oe=e.seed|0,ke=sr.includes(e.preset)?e.preset:ke,ut.length=0,Ue(),De=!0,We(!0),Y.group.visible=!0,Z.group.visible=!0,et.group.visible=!0;for(let e of Me())e.visible=!1;window.__world&&(window.__world.active=!0);let n=e=>e<0?0:e>1?1:e,r=rr.length;if(e.height&&e.biome){let t=bt(e.height),i=new Float32Array(t.buffer,t.byteOffset,t.byteLength>>2);for(let e=0;e<i.length;e++)J.height[e]=n(i[e]);let a=bt(e.biome);for(let e=0;e<J.biome.length;e++)J.biome[e]=Math.min(r-1,a[e]|0)}else if(e.hd||e.bd){let t=e.hd||[],i=e.bd||[];for(let e=0;e<t.length;e+=2)J.height[t[e]]=n(t[e+1]);for(let e=0;e<i.length;e+=2)J.biome[i[e]]=Math.min(r-1,Math.max(0,i[e+1]|0))}return gr(K,J,K.children,!0),e.scatter&&Dt(e.scatter),it(),q&&zr(q,J,{worldSize:26,baseY:0}),Y.restore(e.entities),window.__world&&(window.__world.scatter=q.userData.counts,window.__world.seed=Oe,window.__world.preset=ke),!0}let At={enter(){K||Ue(),De=!0,We(!0),Y.group.visible=!0,Z.group.visible=!0,et.group.visible=!0;for(let e of Me())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){nt=!1,De=!1,We(!1),Y.group.visible=!1,Z.group.visible=!1,et.group.visible=!1;for(let e of Me())e.visible=!0;window.__world&&(window.__world.active=!1)},setEditing(e){return nt=!!e,z.visible=De&&!nt,Ee&&(Ee.visible=De&&!nt),Z.group.visible=De&&!nt,!nt&&De&&it(),nt},get editing(){return nt},get waterHidden(){return nt&&!z.visible},reroll(){return Oe=Math.random()*1e9|0,ut.length=0,Ue(),At.enter(),Oe},reset(){return ut.length=0,Ue(),At.enter(),Oe},setPreset(e){return sr.includes(e)&&(ke=e,ut.length=0,Ue(),At.enter()),ke},sculpt:ot,paintBiome:st,paintScatter:lt,repoolWater:it,snapshot:ft,undo:pt,placeEntity:_t,removeEntityNear:vt,heightAt:Ge,serialize:Tt,serializeCompact:Et,deserialize:kt,flowPourAt:(e,t,n,r)=>Z.pourAt(e,t,n,r),flowRain:e=>Z.rain(e),flowClear:()=>Z.clear(),get flowTotal(){return Z.totalWater()},flowAt:(e,t)=>Z.cellAt(e,t),flowErosion:(e,t)=>Z.setErosion(e,t),get flowErosionOn(){return Z.erosion},get flowSediment(){return Z.totalSediment()},setSimBackend:e=>Z.setBackend(e),get simBackend(){return Z.backend},_flowReadW:()=>Z._debugReadW(),_flowReadTerr:()=>Z._debugReadTerr(),_flowStepN:(e,t)=>Z._debugStepN(e,t),get terrainGroup(){return K},get biomes(){return rr},get scatterCounts(){return q?q.userData.placements&&ct.reduce((e,t)=>(e[t]=(q.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return Y.counts()},setScatterHidden(e){q&&(q.visible=!e)},get placedLife(){return Y},get canUndo(){return ut.length>0},get active(){return De},get seed(){return Oe},get preset(){return ke},get presets(){return sr}},jt=Gr(),Mt=qn({world:At,catalog:jt,inspector:ve});function Nt(e,t){return Ge(e,t)<0?0:-999}let Pt=gn({rig:k,world:{heightAt:Ge,waterHeightAt:Nt}});H.group.remove(H.key),x.add(H.key),H.key.castShadow=!0,H.key.shadow.mapSize.set(2048,2048),H.key.shadow.bias=-18e-5,H.key.shadow.normalBias=.028,x.add(H.key.target);function Ft(){let e=H.key.shadow.camera,t=H.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),o.shadowMap.needsUpdate=!0}Ft();let It=new T(d.x,d.y),Lt=new pe(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1,depthTexture:It}),Rt=new pe(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Bt=new pe(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1,samples:4}),Vt=new pe(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Ht=new pe(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Q=Math.max(1,Math.floor(d.x/2)),Ut=Math.max(1,Math.floor(d.y/2)),Wt=new pe(Q,Ut,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Gt=new pe(Q,Ut,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Kt=new O,qt=new c(-1,1,1,-1,0,1),Jt=new v(new h(2,2));Kt.add(Jt);let $=new re({vertexShader:Mn,fragmentShader:_i,uniforms:{uScene:{value:Lt.texture},uTime:{value:0},uResolution:{value:new he(d.x,d.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:Wt.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:A.grade.tint},uGradeLift:{value:A.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1},uDither:{value:0},uTonemap:{value:0}}}),Yt=new re({vertexShader:Mn,fragmentShader:xi,uniforms:{uScene:{value:Lt.texture},uThreshold:{value:.78}}}),Zt=new re({vertexShader:Mn,fragmentShader:Si,uniforms:{uScene:{value:Wt.texture},uDir:{value:new he}}});function $t(e){Yt.uniforms.uScene.value=e.texture,dn(Yt,Wt),Zt.uniforms.uScene.value=Wt.texture,Zt.uniforms.uDir.value.set(1.6/Q,0),dn(Zt,Gt),Zt.uniforms.uScene.value=Gt.texture,Zt.uniforms.uDir.value.set(0,1.6/Ut),dn(Zt,Wt),$.uniforms.uBloom.value=Wt.texture;let n=1-t.clamp(A.sunArc.y*2.2,0,1);$.uniforms.uBloomStrength.value=.85*(.32+.95*n)}let tn=e=>{let t=e.map(e=>new N(e));for(;t.length<8;)t.push(new N(0,0,0));return t},nn=[`night`,`dawn`,`noon`,`dusk`],an={inkgold:nn.map(e=>tn(Ai[e])),terminal:nn.map(e=>tn(ji[e]))},on=new re({vertexShader:Mn,fragmentShader:vi,uniforms:{uScene:{value:Rt.texture},uResolution:{value:new he(d.x,d.y)},uPixelSize:{value:ki},uPalette:{value:an.inkgold[2]},uPaletteB:{value:an.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),sn=new re({vertexShader:Mn,fragmentShader:Ci,uniforms:{uScene:{value:Rt.texture},uResolution:{value:new he(d.x,d.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Di(wi[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),cn={};for(let e of Ti)cn[e]=wi[e].palette?Di(wi[e].palette):null;let ln=new re({vertexShader:Mn,fragmentShader:yi,uniforms:{uScene:{value:Rt.texture},uDepth:{value:It},uResolution:{value:new he(d.x,d.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:A.toonFloor},uOutline:{value:A.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),un=new re({vertexShader:Mn,fragmentShader:bi,uniforms:{uToon:{value:Vt.texture},uPixel:{value:Ht.texture},uBlend:{value:0}}});function dn(e,t){Jt.material=e,o.setRenderTarget(t),o.render(Kt,qt)}function fn(){k.setViewport(window.innerWidth,window.innerHeight),o.setSize(window.innerWidth,window.innerHeight);let e=o.getDrawingBufferSize(new he);return R.setSize(e.x,e.y),Lt.setSize(e.x,e.y),Rt.setSize(e.x,e.y),Bt.setSize(e.x,e.y),Vt.setSize(e.x,e.y),Ht.setSize(e.x,e.y),Q=Math.max(1,e.x>>1),Ut=Math.max(1,e.y>>1),Wt.setSize(Q,Ut),Gt.setSize(Q,Ut),le.uniforms.uResolution.value.set(e.x,e.y),$.uniforms.uResolution.value.set(e.x,e.y),on.uniforms.uResolution.value.set(e.x,e.y),sn.uniforms.uResolution.value.set(e.x,e.y),ln.uniforms.uResolution.value.set(e.x,e.y),e}let pn=Xn({renderer:o}),mn=!0;function hn(e,t){let n=t.dpr==null?u:t.dpr,r=Math.min(window.devicePixelRatio,n);Math.abs(o.getPixelRatio()-r)>.001&&(o.setPixelRatio(r),typeof window<`u`&&window.dispatchEvent?window.dispatchEvent(new Event(`resize`)):fn()),mn=t.shadows!==!1,mn||(o.shadowMap.needsUpdate=!1)}let _n=Qn({profiler:pn,apply:hn});function vn(){!m&&!f&&pn.frameStart()}function yn(){m||f||(pn.frameEnd(),_n.update())}function bn(e){m=!e,typeof window<`u`&&(window.__paused=m)}function xn(){try{o.compile(x,k.camera),Yn(1/60,0,{shadowsOn:!0}),Wn(Gn(),Lt),o.setRenderTarget(null)}catch(e){typeof console<`u`&&console.warn(`[L79] prewarm`,e)}}let Sn=3,Cn=!1,wn=!1,Tn=`native`,En=.3,Dn=.46,On=[`native`,...Ti],kn={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=Sn,window.__vector=Cn,window.__era=Tn),typeof window<`u`&&(window.__frames=0),typeof window<`u`&&(window.__loaded=!1);let jn=0,Nn=new E(1,1,1),Pn=!1;function Fn(e){let t=wn?an.terminal:an.inkgold,n=e%1*4,r=Math.floor(n)%4;on.uniforms.uPalette.value=t[r],on.uniforms.uPaletteB.value=t[(r+1)%4],on.uniforms.uPaletteBlend.value=n-Math.floor(n)}function In(e){let t=wi[e];t&&(sn.uniforms.uGridWidth.value=t.gridWidth,sn.uniforms.uDither.value=t.dither,sn.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(sn.uniforms.uPalette.value=cn[e],sn.uniforms.uPaletteSize.value=t.palette.length))}function Ln(){Tn!==`native`&&In(Tn)}let Rn=()=>Tn===`native`?on:sn;function zn(e,n){Se(!0),x.environment=Te(),Je.value=1;let r=t.smoothstep(t.clamp(A.sunArc.y,0,1),.22,.8);H.fill.intensity=Bn*(1-.6*r),x.environmentIntensity=Un*(1-.45*r),ye.place(e),z.visible=!1,o.setRenderTarget(R),o.render(x,e),z.visible=!0,o.setRenderTarget(Bt),o.render(x,e),$t(Bt),$.uniforms.uScene.value=Bt.texture,$.uniforms.uAces.value=1,$.uniforms.uGrade.value=1,$.uniforms.uGrain.value=0,$.uniforms.uChroma.value=0,$.uniforms.uDither.value=1,dn($,n),ye.place(k.camera)}let Bn=1,Un=.34;function Wn(e,n){let r=!Cn&&(Sn===1||Sn===2);Se(r),x.environment=r?Te():null,Je.value=+!!r;let i=t.smoothstep(t.clamp(A.sunArc.y,0,1),.22,.8);if(H.fill.intensity=r?Bn*(1-.6*i):Bn,r&&(x.environmentIntensity=Un*(1-.45*i)),$.uniforms.uBloomStrength.value=0,z.visible=!1,o.setRenderTarget(R),o.render(x,k.camera),z.visible=!nt,Sn===1&&!r)o.setRenderTarget(n),o.render(x,k.camera);else if(Sn===1)o.setRenderTarget(Bt),o.render(x,k.camera),$t(Bt),$.uniforms.uScene.value=Bt.texture,$.uniforms.uAces.value=1,$.uniforms.uGrade.value=1,$.uniforms.uGrain.value=0,$.uniforms.uChroma.value=0,$.uniforms.uDither.value=1,dn($,n);else if(o.setRenderTarget(r?Bt:Lt),o.render(x,k.camera),Sn===2)r&&$t(Bt),$.uniforms.uScene.value=r?Bt.texture:Lt.texture,$.uniforms.uAces.value=+!!r,$.uniforms.uGrade.value=+!!r,$.uniforms.uGrain.value=1,$.uniforms.uChroma.value=1,$.uniforms.uDither.value=+!!r,dn($,n);else{$.uniforms.uScene.value=Lt.texture,$.uniforms.uAces.value=0,$.uniforms.uGrade.value=0,$.uniforms.uGrain.value=0,$.uniforms.uChroma.value=0,$.uniforms.uDither.value=0,dn($,Rt);let t=k.camera;ln.uniforms.uNear.value=t.near,ln.uniforms.uFar.value=t.far,ln.uniforms.uIsPerspective.value=+!!t.isPerspectiveCamera;let r=e.era?(In(e.era),sn):Rn();e.kind===`pixel`?(dn(r,n),window.__style=`pixel`):e.kind===`toon`?(dn(ln,n),window.__style=`toon`):(dn(ln,Vt),dn(r,Ht),un.uniforms.uBlend.value=e.blend,dn(un,n),window.__style=`blend`)}}function Gn(){let e=Kn(),n=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return le.uniforms.uChromaScale.value=t.lerp(1,.5,n),e}function Kn(){if(Sn===1||Sn===2)return{kind:`none`};if(Sn===7)return{kind:`pixel`};if(Sn===8)return{kind:`toon`};let e=k.styleT;return window.__styleT=e,e<=En?{kind:`toon`}:e>=Dn?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:t.smoothstep(e,En,Dn),era:`16-bit`}}function Jn(e){return Sn===1||Sn===2?``:Cn&&Sn!==7&&Sn!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?kn[e.era||Tn]||`Pixel`:e.kind===`blend`?`Toon → `+(kn[e.era]||`Pixel`):``}function Yn(e,n,{shadowsOn:r=!0,seasonTarget:i=0}={}){typeof window<`u`&&window.__frames++,r&&=mn,ce.material.uniforms.uTime.value=n,$.uniforms.uTime.value=n,A.update(e),H.key.position.copy(A.sunDir).multiplyScalar(24),H.key.color.copy(A.sunColor),H.key.intensity=A.sunIntensity,H.fill.color.copy(A.hemiSky),H.fill.groundColor.copy(A.hemiGround),de.value=A.windowGlow,be.setSun(A.sunArc),be.setParams(A.skyParams),$.uniforms.uGradeSat.value=A.grade.sat,$.uniforms.uGradeContrast.value=A.grade.contrast,x.environmentIntensity=.34*(1-.6*t.clamp(A.sunArc.y*1.5,0,1)),Un=x.environmentIntensity;let a=G.overcast;H.key.intensity*=1-.5*a,H.key.color.lerp(S,.45*a),H.fill.intensity=1+.7*a,Bn=H.fill.intensity;let s=t.smoothstep(A.sunDir.y,.06,.34),c=t.lerp(.28,1,1-A.windowGlow),l=r?s*c:0;H.key.shadow.intensity=.72*l,Ie.value=.52*l,(r&&!Pn||Nn.distanceToSquared(A.sunDir)>2e-5)&&(o.shadowMap.needsUpdate=!0,Nn.copy(A.sunDir)),Pn=r;let u=1-A.windowGlow;Fe.setRGB(t.lerp(.46,1,u),t.lerp(.52,1,u),t.lerp(.74,1,u)),$.uniforms.uExposure.value=A.exposure,ln.uniforms.uToonGain.value=A.toonGain,o.setClearColor(A.horizon,1),Fn(A.t),window.__t=A.t,U.update(e,n,A),H.update(n),W.update(e,n,A),ae.uniforms.uWakeCount.value=W.wakeCount,G.update(e,n),ae.uniforms.uRainCount.value=G.rainDropCount;let d=G.fog*(1-u);x.fog.density=.016+G.fog*C,D.copy(A.horizon).lerp(w,.85*d),x.fog.color.copy(D),o.setClearColor(D,1),Be.value=G.fog,ce.material.uniforms.uFogAmt.value=.7*G.fog,Le.value=G.snow,Re.value=G.cloud*.55,ze.x+=e*.018,ze.y+=e*.009,Ve.value+=(i-Ve.value)*Math.min(1,e*1.5),Ye.value=n,Xe.value=.035+.05*a,ge.update(e,n,A,G),De&&Y.update(e,n,A),Ke.visible=!De,qe&&!De&&qe.update(e,n,A),De&&Z.step(e),De&&et.update(e,n,A,{wind:.6*G.cloud,qualityLevel:window.__quality&&window.__quality.level||0});let f=Kn(),p=f.kind===`pixel`||f.kind===`blend`?`pixel`:Cn?`vector`:f.kind===`toon`?`charm`:`realistic`;if(ye.update(e,n,A,G,p,k.camera),ee){let[e,t,n]=P;ae.uniforms.uPrev.value=e.texture,ae.uniforms.uCurr.value=t.texture,o.setRenderTarget(n),o.render(ne,L),P=[t,n,e],le.uniforms.uHeight.value=P[1].texture}if(jn<2&&typeof document<`u`&&++jn===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Zn(e){Sn=e,window.__mode=Sn}function $n(){return Cn=!Cn,Pe.value=+!!Cn,window.__vector=Cn,Cn}function er(e){return Cn=!!e,Pe.value=+!!Cn,window.__vector=Cn,Cn}function tr(){return Tn=On[(On.indexOf(Tn)+1)%On.length],window.__era=Tn,Ln(),Tn}function nr(){return wn=!wn,wn}return{updateWorld:Yn,decideStyle:Gn,renderCityPipeline:Wn,renderCityBeautyTo:zn,styleHintName:Jn,setPostMode:Zn,toggleVector:$n,setVector:er,cycleEra:tr,togglePalette:nr,setTonemap:e=>{let t=e===`agx`||e===1||e===!0;return $.uniforms.uTonemap.value=+!!t,typeof window<`u`&&(window.__tonemap=t?`agx`:`aces`),t?`agx`:`aces`},get mode(){return Sn},get vector(){return Cn},get sceneEra(){return Tn},renderer:o,drawBuffer:d,scene:x,rig:k,sunRig:A,SIM:256,targets:P,simScene:ne,simCamera:L,simMaterial:ae,grabRT:R,card:se,backdrop:ce,WATER_SIZE:28,water:z,waterMaterial:le,windowGlow:de,landmarkFactory:fe,city:H,cityLife:U,waterLife:W,weatherRig:G,clouds:ge,inspector:ve,world:At,catalog:jt,editor:Mt,pilot:Pt,spawnSeizeCraft:X,get seizeCraft(){return qe?qe.followable:null},profiler:pn,governor:_n,frameStart:vn,frameEnd:yn,setActive:bn,get paused(){return m},get contextLost(){return f},prewarm:xn,fitShadowFrustum:Ft,SHADOW_DIST:24,sceneDepth:It,sceneRT:Lt,filmicRT:Rt,toonRT:Vt,pixelRT:Ht,postScene:Kt,postCamera:qt,postQuad:Jt,filmicMaterial:$,pixelMaterial:on,pixelkitMaterial:sn,toonMaterial:ln,mixMaterial:un,PALCACHE:an,ERA_TEX:cn,runPass:dn,OVERCAST_GREY:S,FOG_DENSITY:C,FOG_NIGHT_TINT:w,_fogColor:D,resize:fn}}var Pi=[`video/mp4;codecs=avc1.42E01E`,`video/mp4`,`video/webm;codecs=vp9`,`video/webm`];function Fi({renderer:e,rig:t,sunRig:n,poke:r,getState:i,office:a={},world:o=null}){let s=e.domElement,c=new URLSearchParams(window.location.search),l=e=>{let t=i();return`lgr-${t.lesson}-${String(t.clock||``).replace(`:`,``)}-${t.style}.${e}`},u=(e,t)=>{let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,document.body.appendChild(r),r.click(),r.remove(),setTimeout(()=>URL.revokeObjectURL(n),1e3)};function d(){s.toBlob(e=>{e&&(u(e,l(`png`)),window.__lastStill=e.size)},`image/png`)}let f=()=>Pi.find(e=>window.MediaRecorder&&MediaRecorder.isTypeSupported(e))||``,p=Ii(),m=null,h=[],g=!1;function _(){if(g)return;let e=f(),t=s.captureStream(60);m=new MediaRecorder(t,e?{mimeType:e,videoBitsPerSecond:12e6}:{}),h=[],m.ondataavailable=e=>{e.data&&e.data.size&&h.push(e.data)},m.onstop=()=>{let e=new Blob(h,{type:m.mimeType});u(e,l(m.mimeType.includes(`mp4`)?`mp4`:`webm`)),window.__lastVideo=e.size},m.start(),g=!0,window.__recording=!0,p.show()}function v(){g&&(m.stop(),g=!1,window.__recording=!1,p.hide())}let y=()=>g?v():_(),b=e=>new Promise(t=>setTimeout(t,e)),x=e=>{let t=e.startsWith(`Shift+`),n=t?e.slice(6):e;window.dispatchEvent(new KeyboardEvent(`keydown`,{key:n,shiftKey:t}))};async function S(){let e=s.clientWidth,t=s.clientHeight,n=e*.26,i=t*.74;for(let t=0;t<=10;t++)r.at(n+t*e*.028,i+Math.sin(t*.7)*16),await b(100);r.stop()}async function C(e){if(e.world&&o?.[e.world]?.(),e.keys)for(let t of e.keys)x(t),await b(70);if(e.zoom&&t.zoomBy(e.zoom),e.orbit&&t.orbit(e.orbit[0],e.orbit[1]),e.timeTo!==void 0&&n.goTo(e.timeTo),e.pour&&o?.flowPourAt)for(let t=0;t<10;t++)o.flowPourAt(e.pour[0],e.pour[1],e.pour[2],e.pour[3]);e.office&&a[e.office]?.(),e.ripple&&await S(),e.waitMs&&await b(e.waitMs)}let w={tour:[{keys:[`6`,`0`],waitMs:600},{zoom:.72,waitMs:1700},{ripple:!0,waitMs:2400},{orbit:[.55,0],waitMs:1700},{timeTo:0,waitMs:3e3},{timeTo:.5,waitMs:1500},{keys:[`7`],waitMs:1e3},{zoom:1.5,waitMs:1400},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`8`],waitMs:900},{zoom:.65,waitMs:1200},{ripple:!0,waitMs:2600},{keys:[`7`],waitMs:700},{keys:[`B`],waitMs:300},{keys:[`B`],waitMs:900},{zoom:1.4,waitMs:2600}],daycycle:[{keys:[`6`,`0`],waitMs:700},{timeTo:.75,waitMs:2600},{timeTo:1,waitMs:2600},{timeTo:1.25,waitMs:2600},{timeTo:1.5,waitMs:2600},{timeTo:1.5,waitMs:800}],office:[{keys:[`o`],waitMs:1700},{office:`pet`,waitMs:1300},{office:`feed`,waitMs:1700},{office:`travel`,waitMs:1700},{keys:[`Shift+W`,`Shift+W`,`Shift+W`],waitMs:1800},{timeTo:0,waitMs:2400},{office:`laptop`,waitMs:800},{office:`closeLaptop`,waitMs:300},{timeTo:.5,waitMs:900},{keys:[`Shift+W`],waitMs:200},{keys:[`o`],waitMs:1500}],cities:[{keys:[`6`,`0`],waitMs:500},{timeTo:.78,waitMs:2800},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:2e3}],water:[{keys:[`6`,`0`],waitMs:600},{zoom:1.35,waitMs:2800},{orbit:[.7,0],waitMs:2600},{ripple:!0,waitMs:2200},{timeTo:0,waitMs:3200},{timeTo:.5,waitMs:1500},{orbit:[-.5,0],waitMs:2200}],morph:[{keys:[`6`,`3`],waitMs:700},{zoom:.55,waitMs:1800},{zoom:2.3,waitMs:1700},{zoom:1.26,waitMs:1700},{zoom:1.16,waitMs:1900},{zoom:.3,waitMs:2200}],skin:[{keys:[`o`],waitMs:1800},{keys:[`j`],waitMs:2e3},{keys:[`j`],waitMs:2e3},{timeTo:0,waitMs:2600},{timeTo:.5,waitMs:1500},{keys:[`u`],waitMs:2e3},{keys:[`j`],waitMs:1400},{keys:[`o`],waitMs:1500}]};w.hero=[{world:`enter`,keys:[`2`],waitMs:1400},{timeTo:.3,waitMs:300},{pour:[3.2,-5.24,.7,1.9],waitMs:300},{orbit:[.5,.05],waitMs:2700},{orbit:[-.3,-.04],zoom:.9,waitMs:2500},{timeTo:.74,waitMs:1400},{orbit:[.18,-.42],waitMs:3e3},{keys:[`8`],waitMs:1500},{keys:[`7`],waitMs:1500},{keys:[`2`],waitMs:2200}],w.heroCity=[{keys:[`6`,`2`],waitMs:1300},{timeTo:.3,waitMs:1900},{orbit:[.5,0],waitMs:2500},{timeTo:.9,waitMs:2100},{orbit:[-.45,0],zoom:.85,waitMs:2600},{keys:[`8`],waitMs:1500},{keys:[`7`],waitMs:1500},{keys:[`2`],waitMs:2200}];async function T(e){let t=w[e];if(t){window.__director=e;for(let e of t)await C(e);window.__director=null}}async function E(e){await b(1600),_(),await T(e),await b(400),v(),window.__captureDone=!0}c.has(`capture`)&&window.addEventListener(`keydown`,e=>{(e.key===`s`||e.key===`S`)&&d(),(e.key===`r`||e.key===`R`)&&y()});let D=c.get(`capture`);return D&&w[D]&&E(D),window.__capture={still:d,toggleRec:y,run:T,sequences:Object.keys(w)},window.__capture}function Ii(){let e=document.createElement(`div`);return e.textContent=`● REC`,e.style.cssText=`position:fixed;top:14px;right:16px;z-index:2;font:bold 12px ui-monospace,monospace;color:#ff3b30;letter-spacing:.12em;text-shadow:0 1px 3px #000;display:none;`,document.body.appendChild(e),{show:()=>{e.style.display=`block`},hide:()=>{e.style.display=`none`}}}var Li=`
...
`;function Bi({controls:e,state:t,show:n,coarse:r}){if(typeof document>`u`)return;let i=document.createElement(`style`);i.textContent=zi,document.head.appendChild(i);let a=document.createElement(`div`);a.className=`vui`;let o=document.createElement(`div`);o.className=`vui-info`,o.innerHTML=`KEYS · WASD move · 4/5/6 cam · 0 vector · 7/8 pixel/toon · B era · T time · [ ] scrub · 9 auto · Shift+W weather · K season · G shuffle · C city · I inspect · click a building / O office · J office skin · U painted props · Esc exit · M hide UI · H shadows · P theme · drag water to ripple`;let s=(e,t,n)=>{let r=document.createElement(`button`);return r.textContent=e,n&&(r.title=n),r.addEventListener(`click`,e=>{navigator.vibrate?.(10),t(e)}),r},c=e=>{let t=document.createElement(`div`);return t.className=`seg`,{seg:t,btns:e.map(([n,r])=>{let i=s(n,()=>e.find(e=>e[1]===r)[2](),n);return i.dataset.val=r,t.appendChild(i),i})}},l=e=>{let t=document.createElement(`span`);return t.className=`clbl`,t.textContent=e,t},u=(e,t,n,r)=>{let i=document.createElement(`input`);return i.type=`range`,i.min=String(e),i.max=String(t),i.step=String(n),i.addEventListener(`input`,()=>r(parseFloat(i.value))),i},d=s(`City`,()=>e.city(),`Next city profile (C)`),f=s(`Shuffle`,()=>e.shuffle(),`New random seed (G)`),p={clear:`Clear`,rain:`Rain`,snow:`Snow`,fog:`Fog`},m=[`Spring`,`Summer`,`Autumn`,`Winter`],h=s(`Clear`,()=>e.weather(),`Cycle weather: clear→rain→snow→fog (Shift+W)`),g=s(`Spring`,()=>e.season(),`Cycle season: spring→summer→autumn→winter (K)`),_=s(`Office`,()=>e.office(),`Dive into / exit the office (O · Esc)`),v={"3d":`3D`,dressed2:`Dressed`,night2:`Night`,modern:`Modern`,charm:`Charm`},y=s(`Skin`,()=>e.officeSkin(),`Office look: 3D → dressed → night → modern → charm diffusion (J)`),b={painted:`Painted`,"3d":`Live 3D`},x=s(`Props`,()=>e.officeProps(),`Office props: painted (cohesive) ↔ live 3D (animated) — under a skin (U)`),S=s(`Inspect`,()=>e.inspect(),`Inspect: fly + click/tap any car·person·bird·boat·cloud to follow + watch its behaviour (I)`),C={valley:`Valley`,archipelago:`Archi`,mountains:`Mountains`,plains:`Plains`},w=s(`World`,()=>e.world(),`Generate + explore a procedural terrain world`),T=s(`🎲`,()=>e.worldReroll(),`New random world (seed) — G`),E=s(`Valley`,()=>e.worldPreset(),`Cycle biome preset: valley → archipelago → mountains → plains`),D=s(`✎ Edit`,()=>e.sculpt&&e.sculpt(),`World editor — brush the terrain (Sculpt to reshape, Paint to recolour)`),O=document.createElement(`div`);O.className=`vui-rail`;let k=null;function A(t){k||!t||(k=t.map(t=>{let n=document.createElement(`button`);return n.dataset.id=t.id,n.title=`${t.label} (${t.key})`,n.innerHTML=`${t.icon}<span class="rk">${t.key}</span>`,n.addEventListener(`click`,()=>{navigator.vibrate?.(10),e.editTool&&e.editTool(t.id)}),O.appendChild(n),n}))}let j=document.createElement(`div`);j.className=`vui-card`;let ee=document.createElement(`div`);ee.className=`ct`;let M=document.createElement(`div`);M.className=`crow`;let N=u(.8,6,.1,t=>e.brushSize&&e.brushSize(t));M.append(l(`Size`),N);let P=document.createElement(`div`);P.className=`crow`;let te=u(.01,.15,.005,t=>e.brushStrength&&e.brushStrength(t));P.append(l(`Force`),te);let F=document.createElement(`div`);F.className=`crow`;let I=u(.1,1,.05,t=>e.brushDensity&&e.brushDensity(t));F.append(l(`Density`),I);let ne=s(`↑ Raise`,()=>e.sculptDir&&e.sculptDir(),`Brush direction: raise ↔ lower / add ↔ erase / place ↔ delete`),re=s(`↶ Undo`,()=>e.worldUndo&&e.worldUndo(),`Undo the last edit (Z)`),ie=s(`↺ Reset`,()=>e.worldReset&&e.worldReset(),`Reset to the generated world (discard edits) — same seed, NOT a reroll`),L=s(`↺ Reset`,()=>e.worldReset&&e.worldReset(),`Reset the world (discard edits) — same seed`),ae=s(`👁 Trees`,()=>e.hideScatter&&e.hideScatter(),`Hide the scatter (trees/rocks) to see the ground you are editing`),R=document.createElement(`div`);R.className=`seg`,R.style.display=`none`;let oe=null;function se(t){oe||!t||(oe=t.map((t,n)=>{let r=document.createElement(`button`);return r.title=t.key,r.style.cssText=`min-width:30px;padding:0;background:${t.color};border:0;border-radius:8px;`,r.addEventListener(`click`,()=>{navigator.vibrate?.(8),e.material&&e.material(n)}),R.appendChild(r),r}))}let ce=document.createElement(`div`);ce.className=`seg`,ce.style.display=`none`;let le=null;function ue(t){le||!t||(le=t.map(t=>{let n=document.createElement(`button`);return n.dataset.key=t.key,n.textContent=t.icon,n.title=t.label,n.style.cssText=`min-width:30px;padding:4px 6px;`,n.addEventListener(`click`,()=>{navigator.vibrate?.(8),e.scatterType&&e.scatterType(t.key)}),ce.appendChild(n),n}))}let z=document.createElement(`div`);z.className=`seg`,z.style.display=`none`;let B=null;function de(t){B||!t||(B=t.map(t=>{let n=document.createElement(`button`);return n.dataset.key=t.key,n.textContent=t.icon,n.title=t.label,n.style.cssText=`min-width:30px;padding:4px 6px;`,n.addEventListener(`click`,()=>{navigator.vibrate?.(8),e.entity&&e.entity(t.key)}),z.appendChild(n),n}))}let fe=c([[`×1`,`1`,()=>e.dropN&&e.dropN(1)],[`×10`,`10`,()=>e.dropN&&e.dropN(10)],[`×50`,`50`,()=>e.dropN&&e.dropN(50)]]);fe.seg.style.display=`none`,fe.seg.title=`How many to drop per click (scattered in the ring)`;let V=document.createElement(`div`);V.className=`crow`,V.append(ne,re,L,ae),j.append(ee,M,P,R,ce,F,z,fe.seg,V);let H=document.createElement(`div`);H.className=`vui-save`;let U=document.createElement(`div`);U.className=`ct`,U.textContent=`💾 Save / Load`;let W=document.createElement(`input`);W.type=`text`,W.placeholder=`world name`,W.value=`my-world`;let G=document.createElement(`select`),pe=``;G.addEventListener(`change`,()=>{G.value&&(W.value=G.value)});let me=document.createElement(`input`);me.type=`file`,me.accept=`.json,application/json`,me.style.display=`none`,me.addEventListener(`change`,()=>{me.files[0]&&(e.importWorld(me.files[0]),me.value=``)});let he=s(`💾 Save`,()=>e.saveWorld(W.value.trim()),`Save to this device (a named slot)`),ge=s(`📂 Load`,()=>e.loadWorld(W.value.trim()),`Load the named slot`),_e=s(`🗑`,()=>e.deleteWorld(W.value.trim()),`Delete the named slot`),ve=s(`⬇ Export`,()=>e.exportWorld(W.value.trim()),`Download the world as a JSON file (portable, lossless)`),ye=s(`⬆ Import`,()=>me.click(),`Load a world from a JSON file`),be=s(`🔗 Link`,()=>e.shareLink(),`Copy a shareable link (light edits only — else use Export)`),xe=document.createElement(`div`);xe.className=`st`;let Se=document.createElement(`div`);Se.className=`srow`,Se.append(W);let Ce=document.createElement(`div`);Ce.className=`srow`,Ce.append(G);let we=document.createElement(`div`);we.className=`srow`,we.append(he,ge,_e);let Te=document.createElement(`div`);Te.className=`srow`,Te.append(ve,ye,be),H.append(U,Se,Ce,we,Te,xe,me);let K=s(`✨ Realistic`,()=>e.realistic(),`Cinematic beauty look — atmospheric sky, glowing sun, colour-graded (showcase)`),q=c([[`Auto`,`auto`,()=>e.post(`auto`)],[`Pixel`,`pixel`,()=>e.post(`pixel`)],[`Toon`,`toon`,()=>e.post(`toon`)],[`None`,`none`,()=>e.post(`none`)]]);q.btns[0].title=`AUTO: zoom morphs the style (toon → 16-bit → 8-bit → Game Boy)`,q.btns[3].title=`NONE: raw beauty render, no post-crunch (clean flat-vector when Vector is on)`;let Ee=s(`Vector`,()=>e.vector(),`Flat-vector materials — LAYERS onto the post mode (Vector + Pixel/Toon/Auto). Toggle (0)`),J={native:`Era`,gb:`GB`,"8-bit":`8-bit`,"16-bit":`16-bit`,modern:`Modern`,"1-bit":`1-bit`},De=s(`Era`,()=>e.era(),`Cycle the pixel era (B): native → GB → 8-bit → 16-bit → Modern`),Oe=document.createElement(`input`);Oe.type=`range`,Oe.min=`0`,Oe.max=`1`,Oe.step=`0.01`,Oe.title=`Time of day`;let ke=!1;Oe.addEventListener(`pointerdown`,()=>{ke=!0}),Oe.addEventListener(`pointerup`,()=>{ke=!1}),Oe.addEventListener(`input`,()=>e.time(parseFloat(Oe.value)));let Ae=s(`▶`,()=>e.auto(),`Play/pause day cycle (9)`),je=document.createElement(`div`);je.style.cssText=`display:flex;align-items:center;gap:6px;`;let Me=document.createElement(`span`);Me.className=`lbl`,Me.textContent=`Day`,je.append(Me,Oe);let Ne=s(`☀ Shadows`,()=>e.shadows&&e.shadows(),`Sun shadows on/off (H)`),Pe=s(`◐ Theme`,()=>e.theme&&e.theme(),`Swap the UI palette: ink/gold ↔ terminal (P)`),Fe=document.createElement(`div`);Fe.className=`vui-env`,Fe.setAttribute(`role`,`group`),Fe.setAttribute(`aria-label`,`Environment and view settings`);let Ie=s(`⚙ More ▾`,()=>{Fe.classList.toggle(`open`)},`Environment & view: day/night play · weather · season · shadows · theme`),Le=c([[`Iso`,`iso`,()=>e.cam(`iso`)],[`Dim`,`dimetric`,()=>e.cam(`dimetric`)],[`3D`,`persp`,()=>e.cam(`persp`)]]),Re=s(`ⓘ`,()=>o.classList.toggle(`open`),`All keys`),ze=s(`⌄`,()=>at(!0),`Hide controls — watch unobstructed (M)`),Be=Ri({commands:[{group:`Modes`,label:`Go to City`,shortcut:``,run:()=>e.mode(`city`)},{group:`Modes`,label:`Go to World — terrain editor`,shortcut:``,run:()=>e.mode(`world`)},{group:`Modes`,label:`Go to Office`,shortcut:`O`,run:()=>e.mode(`office`)},{group:`Modes`,label:`Go to Hoard — the game`,shortcut:`X`,run:()=>e.mode(`hoard`)},{group:`Camera`,label:`Camera: Perspective (3D orbit)`,shortcut:`4`,run:()=>e.cam(`persp`)},{group:`Camera`,label:`Camera: Isometric`,shortcut:`5`,run:()=>e.cam(`iso`)},{group:`Camera`,label:`Camera: Dimetric (2:1)`,shortcut:`6`,run:()=>e.cam(`dimetric`)},{group:`Art`,label:`Art tier: Auto LOD (zoom morph)`,shortcut:`3`,run:()=>e.post(`auto`)},{group:`Art`,label:`Art tier: Pixel`,shortcut:`7`,run:()=>e.post(`pixel`)},{group:`Art`,label:`Art tier: Toon`,shortcut:`8`,run:()=>e.post(`toon`)},{group:`Art`,label:`Art tier: Raw (no crunch)`,shortcut:`1`,run:()=>e.post(`none`)},{group:`Art`,label:`Toggle Vector (flat materials)`,shortcut:`0`,run:()=>e.vector()},{group:`Art`,label:`Realistic — cinematic beauty`,shortcut:``,run:()=>e.realistic()},{group:`Art`,label:`Cycle pixel Era`,shortcut:`B`,run:()=>e.era()},{group:`Environment`,label:`Play / pause day-night`,shortcut:`9`,run:()=>e.auto()},{group:`Environment`,label:`Time of day: Dawn`,shortcut:``,run:()=>e.time(.25)},{group:`Environment`,label:`Time of day: Noon`,shortcut:``,run:()=>e.time(.5)},{group:`Environment`,label:`Time of day: Dusk`,shortcut:``,run:()=>e.time(.75)},{group:`Environment`,label:`Time of day: Night`,shortcut:``,run:()=>e.time(0)},{group:`Environment`,label:`Cycle Weather`,shortcut:`Shift+W`,run:()=>e.weather()},{group:`Environment`,label:`Cycle Season`,shortcut:`K`,run:()=>e.season()},{group:`Environment`,label:`Toggle sun Shadows`,shortcut:`H`,run:()=>e.shadows&&e.shadows()},{group:`Environment`,label:`Swap UI Theme`,shortcut:`P`,run:()=>e.theme&&e.theme()},{group:`City`,label:`Next city profile`,shortcut:`C`,run:()=>e.city()},{group:`City`,label:`Shuffle city seed`,shortcut:`G`,run:()=>e.shuffle()},{group:`City`,label:`Inspect — follow a car/person/bird…`,shortcut:`I`,run:()=>e.inspect()},{group:`Office`,label:`Cycle office look (skin)`,shortcut:`J`,run:()=>e.officeSkin()},{group:`Office`,label:`Office props: painted ↔ live 3D`,shortcut:`U`,run:()=>e.officeProps()},{group:`World editor`,label:`Toggle ✎ Sculpt editor`,shortcut:``,run:()=>e.sculpt&&e.sculpt()},{group:`World editor`,label:`New random world`,shortcut:`G`,run:()=>e.worldReroll&&e.worldReroll()},{group:`World editor`,label:`Reset world (discard edits)`,shortcut:``,run:()=>e.worldReset&&e.worldReset()},{group:`World editor`,label:`Cycle biome preset`,shortcut:``,run:()=>e.worldPreset&&e.worldPreset()},{group:`World editor`,label:`Undo last edit`,shortcut:`Z`,run:()=>e.worldUndo&&e.worldUndo()},{group:`World editor`,label:`Export world (JSON file)`,shortcut:``,run:()=>e.exportWorld&&e.exportWorld(`my-world`)},{group:`World editor`,label:`Copy share link`,shortcut:``,run:()=>e.shareLink&&e.shareLink()},{group:`View`,label:`Hide / show controls`,shortcut:`M`,run:()=>ot()},{group:`View`,label:`Show all keyboard shortcuts`,shortcut:``,run:()=>o.classList.add(`open`)}]}),Ve=s(`⌘K`,()=>Be.open(),`Command palette — run anything (⌘K / Ctrl-K)`),He=c([[`City`,`city`,()=>e.mode(`city`)],[`World`,`world`,()=>e.mode(`world`)],[`Office`,`office`,()=>e.mode(`office`)],[`Hoard`,`hoard`,()=>e.mode(`hoard`)]]);He.btns[0].title=`City — the living skyline`,He.btns[1].title=`World — the procedural terrain editor`,He.btns[2].title=`Office — dive into the building`,He.btns[3].title=`Hoard — the survival game`;let Ue=document.createElement(`div`);Ue.className=`vui-more`;let We=s(`More`,()=>{Ue.classList.toggle(`open`),st()},`More controls`);if(r){a.append(He.seg,S,Ae,q.seg,Ve,We,ze);let e=document.createElement(`div`);e.style.cssText=`display:flex;align-items:center;gap:6px;`,e.append(Me,Oe),Ue.append(d,f,K,T,ie,E,D,h,g,Ne,Pe,y,x,Ee,De,Le.seg,e)}else a.append(He.seg,ht(),d,f,y,x,S,ht(),T,ie,E,D,ht(),q.seg,K,Ee,De,ht(),je,Ie,ht(),Le.seg,Ve,Re,ht(),ze),Fe.append(Ae,h,g,Ne,Pe);let Ge=document.createElement(`div`);Ge.className=`vui-inspect`;let Y=document.createElement(`div`);Y.className=`ik`;let Ke=document.createElement(`div`);Ke.className=`it`;let qe=document.createElement(`div`);qe.className=`ii`;let X=document.createElement(`div`);X.className=`ir`;let Je=s(`▸ Next`,()=>e.inspectNext&&e.inspectNext(),`Follow the next object (Tab)`),Ye=s(`✕`,()=>e.inspect(),`Exit inspect (Esc)`);X.append(Je,Ye),Ge.append(Y,Ke,qe,X);let Xe=document.createElement(`button`);Xe.className=`vui-show`,Xe.innerHTML=`⌃ Controls`,Xe.title=`Show controls (M)`,Xe.addEventListener(`click`,()=>at(!1));let Ze=document.createElement(`div`);Ze.className=`vui-style`,a.setAttribute(`role`,`toolbar`),a.setAttribute(`aria-label`,`Global controls`),O.setAttribute(`role`,`toolbar`),O.setAttribute(`aria-label`,`Tools`),O.setAttribute(`aria-orientation`,`vertical`),j.setAttribute(`role`,`group`),j.setAttribute(`aria-label`,`Tool properties`),H.setAttribute(`role`,`group`),H.setAttribute(`aria-label`,`Save and load worlds`);let Qe=document.createElement(`div`);Qe.className=`vui-live`,Qe.setAttribute(`role`,`status`),Qe.setAttribute(`aria-live`,`polite`),document.body.append(o,Ue,a,Xe,Ze,Ge,O,j,H,Qe,Fe);let $e=n,Z=null,et=null;if(r&&$e){Z=document.createElement(`div`),Z.className=`vui-sheet`,Z.setAttribute(`role`,`group`),Z.setAttribute(`aria-label`,`Editor tools and properties`);let e=document.createElement(`button`);e.className=`vui-sheet-grip`,e.title=`Expand / collapse`,e.setAttribute(`aria-label`,`Expand or collapse the editor sheet`),e.setAttribute(`aria-expanded`,`true`);let t=document.createElement(`div`);t.className=`vui-sheet-title`,t.textContent=`✎ Editor`;let n=document.createElement(`div`);n.className=`vui-sheet-tools`;let r=document.createElement(`div`);r.className=`vui-sheet-body`,n.append(O),r.append(j),Z.append(e,t,n,r),e.addEventListener(`click`,()=>{navigator.vibrate?.(8);let t=Z.classList.toggle(`peek`);e.setAttribute(`aria-expanded`,String(!t))}),document.body.append(Z),et=document.createElement(`button`),et.className=`vui-fab on`,et.textContent=`⌘K`,et.title=`Command palette`,et.setAttribute(`aria-label`,`Open the command palette`),et.addEventListener(`click`,()=>{navigator.vibrate?.(10),Be.open()}),document.body.append(et)}let tt=!1;at(r);let nt=null;function rt(){let e=t();q.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===e.post)),Ee.classList.toggle(`on`,!!e.vector),Le.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===e.cam)),h.textContent=p[e.weather]||`Clear`,h.classList.toggle(`on`,e.weather!==`clear`),g.textContent=m[e.season]||`Spring`,g.classList.toggle(`on`,(e.season||0)>0),_.textContent=e.office?`Exit`:`Office`,_.classList.toggle(`on`,!!e.office),y.textContent=v[e.officeSkin]||`Skin`,y.classList.toggle(`on`,e.officeSkin&&e.officeSkin!==`3d`),x.textContent=b[e.officeProps]||`Props`,x.classList.toggle(`on`,e.officeProps===`painted`&&e.officeSkin&&e.officeSkin!==`3d`),Ae.textContent=e.auto?`❚❚`:`▶`,Ae.classList.toggle(`on`,e.auto),De.textContent=J[e.era]||`Era`,De.classList.toggle(`on`,e.era&&e.era!==`native`),S.textContent=e.inspect?`Exit`:`Inspect`,S.classList.toggle(`on`,!!e.inspect),w.textContent=e.world?`Exit`:`World`,w.classList.toggle(`on`,!!e.world),E.textContent=C[e.worldPreset]||`Valley`,T.style.display=e.world?``:`none`,ie.style.display=e.world?``:`none`,E.style.display=e.world?``:`none`,D.style.display=e.world?``:`none`;let n=e.currentMode,r=n===`city`,i=n===`world`,a=n===`office`,o=r||i,s=e.audienceModes||[`city`,`world`,`office`,`hoard`];He.btns.forEach(e=>{let t=e.dataset.val;e.style.display=s.includes(t)?``:`none`,e.classList.toggle(`on`,t===n)}),d.style.display=r?``:`none`,f.style.display=r?``:`none`,S.style.display=r?``:`none`,y.style.display=a?``:`none`,x.style.display=a?``:`none`,h.style.display=o?``:`none`,g.style.display=o?``:`none`;let c=i?e.sculpt?`World editor — editing`:`World`:a?`Office`:n===`hoard`?`Hoard`:`City`;c!==nt&&(nt=c,Qe.textContent=`${c} mode — controls updated`),Ne.classList.toggle(`on`,!!e.shadows),Pe.classList.toggle(`on`,!!e.theme),D.classList.toggle(`on`,!!e.sculpt),A(e.tools),O.classList.toggle(`open`,!!e.sculpt),k&&k.forEach(t=>t.classList.toggle(`on`,t.dataset.id===e.editTool)),j.classList.toggle(`open`,!!e.sculpt),Z&&Z.classList.toggle(`on`,!!e.sculpt);let l=e.editTool,u=l===`paint`,L=l===`scatter`,V=l===`place`,U=l===`sculpt`;ee.textContent={place:`✚ Place`,sculpt:`⛰ Sculpt`,paint:`🎨 Paint`,scatter:`🌲 Objects`,select:`◳ Select`}[l]||`Editor`,M.style.display=l===`select`?`none`:``,P.style.display=U?``:`none`,F.style.display=L?``:`none`,se(e.materials),R.style.display=u?``:`none`,oe&&oe.forEach((t,n)=>t.classList.toggle(`on`,n===e.material)),ue(e.scatterKinds),ce.style.display=L?``:`none`,le&&le.forEach(t=>t.classList.toggle(`on`,t.dataset.key===e.scatterType)),de(e.entityKinds),z.style.display=V?``:`none`,B&&B.forEach(t=>t.classList.toggle(`on`,t.dataset.key===e.entityKind)),fe.seg.style.display=V?``:`none`,fe.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===String(e.dropN))),ne.style.display=L||V||U?``:`none`,ne.textContent=V?e.sculptRaise?`➕ Place`:`🗑 Delete`:L?e.sculptRaise?`➕ Add`:`➖ Erase`:e.sculptRaise?`↑ Raise`:`↓ Lower`,re.disabled=!e.canUndo,re.style.opacity=e.canUndo?``:`0.45`,ae.classList.toggle(`on`,!!e.scatterHidden),N.value=String(e.brushRadius),te.value=String(e.brushStrength),I.value=String(e.brushDensity),H.classList.toggle(`open`,!!e.sculpt);let W=e.saveSlots||[],me=W.join(`,`);if(me!==pe){pe=me,G.innerHTML=``;let e=document.createElement(`option`);e.value=``,e.textContent=W.length?`— ${W.length} saved —`:`— no saves —`,G.append(e);for(let e of W){let t=document.createElement(`option`);t.value=e,t.textContent=e,G.append(t)}}xe.textContent=e.saveStatus||``,K.classList.toggle(`on`,!!e.realistic),ke||(Oe.value=String(e.t))}rt();let it=setInterval(rt,200);function at(e){if(!$e){a.style.display=`none`,Xe.classList.remove(`on`),o.classList.remove(`open`),Ue.classList.remove(`open`),Ze.classList.remove(`on`);return}tt=e,a.style.display=e?`none`:`flex`,Xe.classList.toggle(`on`,e),e&&(o.classList.remove(`open`),Ue.classList.remove(`open`),Ze.classList.remove(`on`))}function ot(){at(!tt)}function st(){if(!Ue.classList.contains(`open`))return;let e=a.getBoundingClientRect();Ue.style.top=Math.round(e.bottom+8)+`px`,Ue.style.bottom=`auto`}let ct=()=>st();window.addEventListener(`resize`,ct);let lt=null,ut=null;function dt(e){if(!$e||tt){Ze.classList.remove(`on`),lt=null;return}if(!e){Ze.classList.remove(`on`),lt=``;return}e!==lt&&(lt=e,Ze.textContent=e,Ze.classList.add(`on`),clearTimeout(ut),ut=setTimeout(()=>Ze.classList.remove(`on`),2e3))}let ft=null;function pt(e){if(!$e||!e){Ge.classList.remove(`open`),ft=null;return}let t=e.hint?`hint:${e.hint}`:`${e.kind}|${e.info}`;t!==ft&&(ft=t,e.hint?(Y.textContent=`INSPECT`,Ke.textContent=`Free-fly`,qe.textContent=e.hint,Je.style.display=``):(Y.textContent=e.kind,Ke.textContent=e.label||e.kind,qe.textContent=e.info||``,Je.style.display=``),Ge.classList.add(`open`))}[a,o,Ue,Xe,Ze,Ge,O,j,H,Fe,Z,i].forEach(e=>e&&e.querySelectorAll&&e.querySelectorAll(`button[title]:not([aria-label])`).forEach(e=>e.setAttribute(`aria-label`,e.title)));function mt(e){Qe&&e&&(Qe.textContent=``,Qe.textContent=String(e))}return{toggle:ot,setHidden:at,refresh:rt,setStyleHint:dt,setInspect:pt,announce:mt,destroy(){clearInterval(it),window.removeEventListener(`resize`,ct),a.remove(),o.remove(),Ue.remove(),Xe.remove(),Ze.remove(),Ge.remove(),O.remove(),j.remove(),H.remove(),Qe.remove(),Fe.remove(),Z&&Z.remove(),et&&et.remove(),Be.destroy(),i.remove(),clearTimeout(ut)}};function ht(){let e=document.createElement(`div`);return e.className=`sep`,e}}var Vi=`lgr_hints_`,Hi=!1;function Ui(){if(Hi||typeof document>`u`)return;Hi=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var Gi=`precision highp float;
...
void main() {
  ...
  gl_FragColor = vec4(col, 1.0);
}`;function Ki({rate:e=4.6}={}){let t=new re({vertexShader:Mn,fragmentShader:Gi,uniforms:{uA:{value:null},uB:{value:null},uT:{value:0},uFocus:{value:new he(.5,.5)}}}),n=`a`,r=0;function i(e,n){t.uniforms.uA.value=e,t.uniforms.uB.value=n}function a(e){return n===`a`?(e&&t.uniforms.uFocus.value.copy(e),n=`in`,!0):!1}function o(){return n!==`b`&&n!==`in`?!1:(n=`out`,!0)}function s(e){n=e===`b`?`b`:`a`,r=+(e===`b`),t.uniforms.uT.value=r}function c(i){return r+=(+(n===`b`||n===`in`)-r)*Math.min(1,i*e),n===`in`&&r>.992&&(r=1,n=`b`),n===`out`&&r<.008&&(r=0,n=`a`),t.uniforms.uT.value=r,n}return{material:t,setSources:i,enter:a,exit:o,update:c,snap:s,get mode(){return n},get t(){return r},get transitioning(){return n===`in`||n===`out`}}}var qi=null;function Ji(){if(qi)return qi;let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(0,0,0,0.60)`),n.addColorStop(.55,`rgba(0,0,0,0.32)`),n.addColorStop(1,`rgba(0,0,0,0.0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,Math.PI*2),t.fill(),qi=new V(e),qi.colorSpace=B,qi}function Yi({w:e=.6,d:t=.6,x:n=0,y:r=.002,z:i=0,opacity:a=.5,rotation:o=0}={}){let s=new v(new h(e,t),new b({map:Ji(),transparent:!0,opacity:a,depthWrite:!1,toneMapped:!1}));return s.rotation.x=-Math.PI/2,s.rotation.z=o,s.position.set(n,r,i),s.renderOrder=-1,s.raycast=()=>{},s}function Xi({yawLimit:e=80,pitchUp:t=32,pitchDown:n=20,sensitivity:r=.16,keySpeed:i=70,damp:a=9}={}){let o=Math.PI/180,s=(e,t,n)=>e<t?t:e>n?n:e,c=0,l=0,u=0,d=0;return{addDrag(i,a){u=s(u-i*r,-e,e),d=s(d-a*r,-n,t)},addKeys(r,{left:a,right:o,up:c,down:l}){let f=i*r;a&&(u=s(u+f,-e,e)),o&&(u=s(u-f,-e,e)),c&&(d=s(d+f,-n,t)),l&&(d=s(d-f,-n,t))},recenter(){u=0,d=0},update(e){let t=1-Math.exp(-a*e);c+=(u-c)*t,l+=(d-l)*t},get yaw(){return c*o},get pitch(){return l*o},get active(){return Math.abs(c)>.05||Math.abs(l)>.05}}}var Zi=null;function Qi(){if(Zi)return Zi;let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(256/2,256/2,256*.32,256/2,256/2,256*.72);return n.addColorStop(0,`rgba(0,0,0,0)`),n.addColorStop(1,`rgba(0,0,0,1)`),t.fillStyle=n,t.fillRect(0,0,256,256),Zi=new V(e),Zi.colorSpace=B,Zi}function $i({strength:e=.55,dist:n=.5}={}){let r=new v(new h(1,1),new b({map:Qi(),transparent:!0,opacity:e,depthTest:!1,depthWrite:!1,toneMapped:!1}));r.renderOrder=9999,r.raycast=()=>{},r.frustumCulled=!1;let i=new E;return r.fit=e=>{e.getWorldDirection(i),r.position.copy(e.position).addScaledVector(i,n),r.quaternion.copy(e.quaternion);let a=2*Math.tan(t.degToRad(e.fov)*.5)*n*1.05;r.scale.set(a*e.aspect,a,1)},r}export{rt as _,Wi as a,Ni as c,Di as d,Oi as f,nt as g,At as h,Ki as i,wi as l,Mn as m,Yi as n,Bi as o,Ci as p,$i as r,Fi as s,Xi as t,Ei as u,X as v,Se as y};