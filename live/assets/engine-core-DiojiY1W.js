import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,I as c,K as l,L as u,M as d,N as f,P as p,Q as m,R as h,S as g,T as _,U as v,V as y,X as b,Z as x,_ as S,a as C,b as w,c as T,ct as E,et as D,f as O,g as k,h as A,i as j,j as M,l as N,lt as P,m as ee,n as F,nt as I,o as te,p as L,q as R,rt as z,s as B,st as V,t as H,u as U,v as W,w as ne,x as re,z as ie}from"./three-CmV-rJ7Z.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var ae=Math.atan(1/Math.SQRT2),G=Math.atan(.5),oe=Math.PI/4,K={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},se=.12,ce=1.45,le=4,ue=40,de=1.5,fe=16,pe=6,me=22,q=3.5,he=11,ge=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),_e=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function ve({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new E(0,.8,0),azimuth:a=oe,elevation:o=.52,distance:s=12,zoom:c=5.5}={}){let l=new y(t,e,n,r),u=new ie(-1,1,1,-1,n,r),f=K.PERSPECTIVE,p=e,m={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},h={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},g=!1,_=()=>f===K.PERSPECTIVE?l:u;function v(e){e!==f&&(f=e,f===K.ISOMETRIC||f===K.DIMETRIC?(m.elevation=f===K.ISOMETRIC?ae:G,m.azimuth=_e(oe,h.azimuth),g=!0):g=!1)}function b(e,t){m.azimuth+=e,g||(m.elevation=d.clamp(m.elevation+t,se,ce))}function x(e){f===K.PERSPECTIVE?m.distance=d.clamp(m.distance*e,le,ue):m.zoom=d.clamp(m.zoom*e,de,fe)}function S(e,t){let n=m.azimuth,r=f===K.PERSPECTIVE?m.distance*.04:m.zoom*.08,i=new E(Math.cos(n),0,-Math.sin(n)),a=new E(-Math.sin(n),0,-Math.cos(n));m.target.addScaledVector(i,e*r),m.target.addScaledVector(a,t*r)}function C(e,t){p=e/t,l.aspect=p,l.updateProjectionMatrix()}function w(e){h.azimuth=ge(h.azimuth,m.azimuth,e),h.elevation=ge(h.elevation,m.elevation,e),h.distance=ge(h.distance,m.distance,e),h.zoom=ge(h.zoom,m.zoom,e),h.target.x=ge(h.target.x,m.target.x,e),h.target.y=ge(h.target.y,m.target.y,e),h.target.z=ge(h.target.z,m.target.z,e);let t=Math.cos(h.elevation),n=Math.sin(h.elevation),r=Math.cos(h.azimuth),i=Math.sin(h.azimuth),a=_();if(a.position.set(h.target.x+h.distance*t*i,h.target.y+h.distance*n,h.target.z+h.distance*t*r),a.lookAt(h.target),a.isOrthographicCamera){let e=h.zoom,t=e*p;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function T(e,t,n,r=!1){m.target.set(e,t,n),r&&h.target.copy(m.target)}function D(e,t=!1){m.zoom=d.clamp(e,de,fe),t&&(h.zoom=m.zoom)}return{get camera(){return _()},get mode(){return f},get azimuth(){return h.azimuth},setTarget:T,setZoom:D,get styleT(){return f===K.PERSPECTIVE?d.clamp((h.distance-pe)/(me-pe),0,1):d.clamp((h.zoom-q)/(he-q),0,1)},setMode:v,orbit:b,zoomBy:x,pan:S,setViewport:C,update:w}}var ye={value:0},be=new L(`#ffffff`),xe={value:0},Se={value:0},Ce={value:0},we=new V,Te={value:0},Ee={value:0},De=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
#include <shadowmask_pars_fragment>`)}var Me=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Ne(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new L(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{Oe(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new L(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=Ae(e.vertexShader),e.fragmentShader=ke(je(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function J(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{Oe(e),s||(e.uniforms.uVecColor={value:new L(t)}),c&&(e.uniforms.uGlow={value:new L(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=Ee),e.vertexShader=Ae(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
`+d+De).replace(`#include <opaque_fragment>`,`#include <opaque_fragment>
        ...
        }`)));c&&(p=p.replace(`#include <emissivemap_fragment>`,`#include <emissivemap_fragment>\n  totalEmissiveRadiance += ${f};`)),e.fragmentShader=p},e}function Y(e){let t=e>>>0;return function(){t|=0,t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function Pe(e){let t=Y(e);return{next:t,range:(e,n)=>e+(n-e)*t(),int:(e,n)=>e+Math.floor(t()*(n-e+1)),pick:e=>e[Math.floor(t()*e.length)],chance:e=>t()<e}}var X=[{key:`manhattan`,name:`Manhattan`,towers:[`#EDE3C8`,`#D9B98A`,`#B5562F`,`#A8C8E8`,`#2E3F5C`],ground:`#7CC455`,street:`#9AA0A6`,sidewalk:`#C8CCD0`,park:`#5DB347`,water:`#29A8D8`,shopfronts:[`#C04A3A`,`#3A7AC0`,`#C09A2A`],glass:`#7FA8CC`,winColors:[`#ffd27a`,`#9ad6ff`],hMax:4.6,sigma:.36,roofRate:.35,pSplit:.6,nightLit:.55,roofTint:null,coast:{base:.55,out:1,in:.6,jag:1.05},landmarks:[`empireState`,`chrysler`,`liberty`]},{key:`paris`,name:`Paris`,towers:[`#E8DCC0`,`#F2EAD6`,`#E0D2B4`],ground:`#8CC46A`,street:`#A8A29A`,sidewalk:`#D4CEC2`,park:`#6DB35A`,water:`#3FA8C8`,shopfronts:[`#C04A3A`,`#3A6B5A`,`#7A5AC0`],glass:`#5A6B7A`,winColors:[`#ffdca0`,`#ffcaa0`],hMax:1.5,sigma:.9,roofRate:.15,pSplit:.75,nightLit:.45,roofTint:`#6A7886`,coast:{base:1.05,out:.55,in:.3,jag:.5},landmarks:[`eiffel`,`arcDeTriomphe`,`sacreCoeur`]},{key:`neoTokyo`,name:`Neo-Tokyo`,towers:[`#2A3038`,`#3A4250`,`#252B36`,`#4A4456`],ground:`#3A4A42`,street:`#5A6068`,sidewalk:`#7A8088`,park:`#2E5E46`,water:`#0E6878`,shopfronts:[`#E8483A`,`#5AE8E0`,`#E85AA0`],glass:`#5AE8E0`,winColors:[`#5AE8E0`,`#E85AA0`,`#E8E06A`],hMax:5.2,sigma:.42,roofRate:.6,pSplit:.6,nightLit:.7,roofTint:null,coast:{base:.7,out:1.05,in:.62,jag:1.7},landmarks:[`tokyoTower`,`pagoda`,`neonBillboard`]}],Fe=X.map(e=>e.key),Ie=.3,Le=1.9,Re=.55,Z=2.45,ze=.12,Be=.6,Q=6,Ve={BASE:.7,OUT:.95,IN:.55,JAG:1,SAMPLES_PER_EDGE:28,HARBOR_DEPTH:.55,HARBOR_WIDTH:.26},He={PLINTH_TOP:Ie,BLOCK:Le,STREET:Re,PITCH:Z,SIDEWALK:ze,SHORE:Be,N:Q,COAST:Ve};function Ue(e,t,n){let r=n?.base??Ve.BASE,i=n?.out??Ve.OUT,a=n?.in??Ve.IN,o=n?.jag??Ve.JAG,s=t+r,c=Pe((e^789079)>>>0),l=[2,3,5,8,11,13].map(e=>({k:e,amp:1/e*o**((e-2)/6),phase:c.range(0,Math.PI*2)})),u=l.reduce((e,t)=>e+t.amp,0),d=e=>{let t=0;for(let n of l)t+=n.amp*Math.sin(n.k*e*Math.PI*2+n.phase);return Math.max(-1,Math.min(1,t/(u*.6)))},f=[{fix:+s,nx:1,nz:0,sign:1},{fix:+s,nx:0,nz:1,sign:-1},{fix:-s,nx:-1,nz:0,sign:-1},{fix:-s,nx:0,nz:-1,sign:1}],p=t+.22,m=Ve.SAMPLES_PER_EDGE,h=4*m,g=[],_=0;for(let e=0;e<4;e++){let t=f[e];for(let n=0;n<m;n++,_++){let o=n/m,c=_/h,l=(-s+2*s*o)*t.sign,u=d(c),f=u>=0?u*i:u*a;if(e===0){let e=Math.abs(o-.5);if(e<Ve.HARBOR_WIDTH){let t=.5+.5*Math.cos(e/Ve.HARBOR_WIDTH*Math.PI);f-=(r+Ve.HARBOR_DEPTH)*t}}let v,y;t.nx===0?(y=t.fix+t.nz*f,v=l,y=t.nz>0?Math.max(y,p):Math.min(y,-p)):(v=t.fix+t.nx*f,y=l,v=t.nx>0?Math.max(v,p):Math.min(v,-p)),g.push(new V(v,y))}}return{points:g,B:s,maxR:s+i,harborX:p}}function We(e){(Array.isArray(e)?e:[e]).forEach(e=>e&&e.dispose&&e.dispose())}function Ge({seed:t=1,profileIndex:n=0,landmarkFactory:i=null,windowGlow:a}){let s=new r,l=new r,u=new r;l.raycast=()=>{},u.raycast=()=>{},s.add(l,u);let d=new W(16773594,3);d.position.set(.45,.6,-.65).multiplyScalar(10);let f=new _(7313331,2762272,1);s.add(d,f);let m=0,h=[],g={seed:t,profileIndex:n,profile:X[n],extent:0,meshCount:0};function v(e,t,n,r){let i=new p(new C(e,.04,t),J(new c({color:r,roughness:.95,flatShading:!0}),{color:r}));return i.position.y=n,i.userData.ground=!0,i}function y(t,n){for(let e of l.children)e.geometry&&e.geometry.dispose(),We(e.material);l.clear();for(let e of u.children)e.traverse(e=>{e.isMesh&&We(e.material)});u.clear(),h.length=0,m=0;let r=Pe(t),a=X[n],o=(Q-1)/2*Z,s=7.075;g={seed:t,profileIndex:n,profile:a,extent:s+(a.coast?.base??Ve.BASE),meshCount:0};let d=Ue(t,s,a.coast);g.coast=d;let f=new e;d.points.forEach((e,t)=>t?f.lineTo(e.x,e.y):f.moveTo(e.x,e.y)),f.closePath();let _=new p(new w(f,{depth:2,bevelEnabled:!1,steps:1}),J(new c({color:a.ground,roughness:.9,flatShading:!0,side:2}),{color:a.ground}));_.rotation.x=-Math.PI/2,_.position.y=Ie-2,_.userData.ground=!0,l.add(_);let y=2*7.195;l.add(v(y,y,.32,a.street)),T(d.harborX,a);let C=[];for(let e=0;e<Q;e++)for(let t=0;t<Q;t++)C.push([e,t]);let D=new Set,O=Math.max(1,Math.round(C.length*.08));for(;D.size<O;)D.add(r.int(0,C.length-1));let k=r.range(-2.45*.6,Z*.6),A=r.range(-2.45*.6,Z*.6),M=Math.hypot(o,o),N=[];if(C.forEach(([e,t],n)=>{let i=(e-(Q-1)/2)*Z,o=(t-(Q-1)/2)*Z;if(l.add(v(Le,Le,.32999999999999996,a.sidewalk).translateX(i).translateZ(o)),D.has(n)){l.add(v(Le-ze*2,Le-ze*2,.35,a.park).translateX(i).translateZ(o));let e=r.int(3,5);for(let t=0;t<e;t++)E(i+r.range(-.6,.6),o+r.range(-.6,.6),a,r);return}let s=Le-ze*2,c=r.chance(a.pSplit)?2:1,u=r.chance(a.pSplit)?2:1,d=s/c,f=s/u;for(let e=0;e<c;e++)for(let t=0;t<u;t++){let n=i-s/2+d*(e+.5),c=o-s/2+f*(t+.5),l=Math.max(.6,d-.1),u=Math.max(.6,f-.1),p=Math.hypot(n-k,c-A)/M,m=Math.exp(-(p*p)/(2*a.sigma*a.sigma)),h=Math.max(.5,.5+(a.hMax-.5)*m*r.range(.75,1.25));h>a.hMax*.5&&Math.min(l,u)>=.7&&N.push({lx:n,lz:c,fw:l,fd:u,h,r:p}),b(n,c,l,u,h,a,r)}}),i&&i.ready){N.sort((e,t)=>e.r-t.r);let e=[],t=a.landmarks;for(let n=0;n<t.length&&N.length;n++){let r=null;for(let t of N)if(e.every(e=>Math.hypot(e.lx-t.lx,e.lz-t.lz)>Z*.9)){r=t;break}r||=N[0],e.push(r),x(r.lx,r.lz);let o=a.hMax*i.heightFactor(t[n]),s=i.make(t[n],{x:r.lx,z:r.lz,w:r.fw,d:r.fd,h:o,plinthTop:Ie});if(s){u.add(s);let e=new j().setFromObject(s);S(e.min.x-.15,e.max.x+.15,e.min.z-.15,e.max.z+.15)}}}l.traverse(e=>{e.isMesh&&(e.userData.ground?(e.castShadow=!1,e.receiveShadow=!0):e.material&&e.material.isMeshBasicMaterial?(e.castShadow=!1,e.receiveShadow=!1):(e.castShadow=!0,e.receiveShadow=!0))}),u.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)}),g.meshCount=l.children.length+u.children.length;let P=0;for(let e of l.children){let t=e.position;P=(Math.imul(P,16777619)^(Math.round(t.x*100)*2654435761^Math.round(t.y*100)*40503^Math.round(t.z*100)*2246822519))>>>0}for(let e of g.coast.points)P=(Math.imul(P,16777619)^(Math.round(e.x*100)*2654435761^Math.round(e.y*100)*40503))>>>0;g.sig=P,window.__city={seed:t,profile:a.key,meshes:g.meshCount,sig:P}}function b(e,t,n,r,i,s,u){let d=Ne(new c({flatShading:!0,roughness:.7,metalness:.05}),{color:u.pick(s.towers),id:++m,windowGlow:a,winColors:s.winColors,litFrac:s.nightLit}),f=new p(new C(n,i,r),d);if(f.position.set(e,Ie+i/2,t),f.userData.lot=[e,t],l.add(f),s.roofTint){let a=J(new c({color:s.roofTint,roughness:.85,flatShading:!0}),{color:s.roofTint}),o=new p(new C(n*1.02,.08,r*1.02),a);o.position.set(e,Ie+i+.04,t),o.userData.lot=[e,t],l.add(o)}if(i<1.4){let i=u.pick(s.shopfronts),a=new p(new C(n*1.04,.18,r*1.04),J(new c({color:i,roughness:.8,flatShading:!0}),{color:i}));a.position.set(e,.39,t),a.userData.lot=[e,t],l.add(a)}if(i>s.hMax*.45&&u.chance(s.roofRate)){let a=u.chance(.5)?new p(new C(n*.4,.18,r*.4),J(new c({color:`#9a9a9a`,flatShading:!0}),{color:`#9a9a9a`})):new p(new A(n*.18,n*.18,.22,10),J(new c({color:`#b9bec4`,flatShading:!0}),{color:`#b9bec4`}));if(a.position.set(e+u.range(-.1,.1),Ie+i+.11,t+u.range(-.1,.1)),a.userData.lot=[e,t],l.add(a),u.chance(.25)){let n=new p(new D(.05,6,5),new o({color:`#ff3b30`,transparent:!0,opacity:1}));n.position.set(e,Ie+i+.26,t),n.userData.lot=[e,t],n.raycast=()=>{},l.add(n),h.push({mesh:n,phase:u.range(0,6.28)})}}}function x(e,t){for(let n=l.children.length-1;n>=0;n--){let r=l.children[n];r.userData.lot&&Math.abs(r.userData.lot[0]-e)<1e-4&&Math.abs(r.userData.lot[1]-t)<1e-4&&(r.geometry&&r.geometry.dispose(),We(r.material),l.remove(r))}for(let e=h.length-1;e>=0;e--)h[e].mesh.parent||h.splice(e,1)}function S(e,t,n,r){for(let i=l.children.length-1;i>=0;i--){let a=l.children[i];a.userData.lot&&a.position.x>=e&&a.position.x<=t&&a.position.z>=n&&a.position.z<=r&&(a.geometry&&a.geometry.dispose(),We(a.material),l.remove(a))}}function T(e,t){let n=J(new c({color:`#7a5634`,roughness:.95,flatShading:!0}),{color:`#7a5634`}),r=(e,t,r,i)=>{let a=new p(new C(e,.06,t),n);a.position.set(r,Ie-.16,i),l.add(a)};r(.24,2,e+.02,0),r(1.3,.22,e+.7,-.72),r(1.3,.22,e+.7,.72)}function E(e,t,n,r){let i=new L(n.park),a=(n,a)=>{let o=i.clone().offsetHSL(0,0,r.range(-.06,.06)).getStyle(),s=new p(new D(n,7,6),J(new c({color:o,flatShading:!0}),{color:o,season:!0}));s.scale.y=.7,s.position.set(e,Ie+a,t),s.userData.lot=null,l.add(s)},o=new p(new C(.05,.18,.05),J(new c({color:`#6b4a2a`,flatShading:!0}),{color:`#6b4a2a`}));o.position.set(e,.39,t),l.add(o),a(.22,.28),a(.16,.46)}function O(e){for(let t of h)t.mesh.material.opacity=.35+.65*(.5+.5*Math.sin(e*3+t.phase))}return y(t,n),{group:s,key:d,fill:f,update:O,generate:y,get state(){return g},get extent(){return g.extent},get waterColor(){return g.profile.water},profiles:X}}var Ke=Math.PI*2,qe=.7,Je=90,Ye=[{name:`night`,sun:`#4a6f9e`,intensity:.35,hemiSky:`#26344f`,hemiGround:`#0c1018`,horizon:`#1e2942`,sky:`#36486e`,exposure:.95,outline:`#101a30`,window:1,toonGain:2.6},{name:`dawn`,sun:`#ff9e54`,intensity:2.4,hemiSky:`#8a7686`,hemiGround:`#2a1f1a`,horizon:`#b8512c`,sky:`#ffb070`,exposure:1.05,outline:`#241826`,window:.3,toonGain:2},{name:`noon`,sun:`#fff4e0`,intensity:4.6,hemiSky:`#9cb8cc`,hemiGround:`#33302a`,horizon:`#5e7689`,sky:`#aacadd`,exposure:1.18,outline:`#0b0a08`,window:0,toonGain:1.7},{name:`dusk`,sun:`#ff6b35`,intensity:2,hemiSky:`#7a566a`,hemiGround:`#281a18`,horizon:`#b0432a`,sky:`#ff8a5a`,exposure:1.05,outline:`#1f1420`,window:.4,toonGain:2}],Xe=e=>e-Math.floor(e),Ze=(e,t,n)=>e+(t-e)*n,Qe=(e,t,n)=>e+(t-e)*(1-Math.exp(-6*n));function $e({t:e=.5}={}){let t=e,n=e,r=!1,i=!1,a=Ye.map(e=>({name:e.name,sun:new L(e.sun),hemiSky:new L(e.hemiSky),hemiGround:new L(e.hemiGround),horizon:new L(e.horizon),sky:new L(e.sky),outline:new L(e.outline),intensity:e.intensity,exposure:e.exposure,window:e.window,toonGain:e.toonGain})),o=new E(0,1,0),s=new L(`#fff4e0`),c=new L(`#6f97b3`),l=new L(`#2a2620`),u=new L(`#3a4a57`),d=new L(`#7da3bd`),f=new L(`#0b0a08`),p=new L(`#000000`),m=3,h=1,g=0,_=1.7,v=new E;function y(e){let t=Xe(e)*4,n=Math.floor(t)%4,r=(n+1)%4,i=t-Math.floor(t),y=a[n],b=a[r];s.lerpColors(y.sun,b.sun,i),c.lerpColors(y.hemiSky,b.hemiSky,i),l.lerpColors(y.hemiGround,b.hemiGround,i),u.lerpColors(y.horizon,b.horizon,i),d.lerpColors(y.sky,b.sky,i),f.lerpColors(y.outline,b.outline,i),m=Ze(y.intensity,b.intensity,i),h=Ze(y.exposure,b.exposure,i),g=Ze(y.window,b.window,i),_=Ze(y.toonGain,b.toonGain,i),p.setRGB(.045*g,.075*g,.14*g);let x=Xe(e)*Ke-Math.PI/2,S=Math.cos(x),C=Math.sin(x);v.set(S,C*Math.cos(qe),C*Math.sin(qe)),v.y>=0?o.copy(v):o.copy(v).negate()}return y(t),{sunDir:o,sunColor:s,hemiSky:c,hemiGround:l,horizon:u,sky:d,outline:f,toonFloor:p,get sunIntensity(){return m},get exposure(){return h},get windowGlow(){return g},get toonGain(){return _},get t(){return Xe(t)},get auto(){return r},get clock(){let e=Math.round(Xe(t)*24*60)%1440;return`${String(Math.floor(e/60)).padStart(2,`0`)}:${String(e%60).padStart(2,`0`)}`},cyclePreset(){n=(Math.floor(t*4+1e-4)+1)/4},nudge(e){n+=e/24},goTo(e){n=e},toggleAuto(){r=!r},setReducedMotion(e){i=e},update(e){r&&!i&&(n+=e/Je),t=Qe(t,n,e),y(t)}}}function et(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.35,`rgba(255,255,255,0.55)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64);let r=new T(e);return r.colorSpace=b,r}function tt(e,t){let n=[];for(let r=0;r<16;r++){let i=r/16*Math.PI*2;n.push(new E(Math.cos(i)*e,t,Math.sin(i)*e))}return new U(n,!0,`catmullrom`,.5)}function nt(e){let t=(t,n)=>Math.exp(-((e-t)*(e-t))/(2*n*n)),n=Math.max(t(.33,.05),t(.75,.06)),r=d.smoothstep(e,.24,.3)*(1-d.smoothstep(e,.8,.88));return d.clamp(.15+.55*r+.45*n,.12,1)}function rt(){let{PITCH:e,N:t,PLINTH_TOP:n}=He,r=t+1,i=n+.04,a=n=>(n-t/2)*e,o=t/2,s=[],c=(e,t)=>t*r+e;for(let e=0;e<r;e++)for(let t=0;t<r;t++)s.push({x:a(t),z:a(e),i:t,j:e,edges:[]});let l=[],u=(t,n)=>{let r=(s[t].i===o||s[t].j===o)&&(s[n].i===o||s[n].j===o),i=l.length;l.push({a:t,b:n,len:e,main:r}),s[t].edges.push(i),s[n].edges.push(i)};for(let e=0;e<r;e++)for(let t=0;t<r;t++)t<r-1&&u(c(t,e),c(t+1,e)),e<r-1&&u(c(t,e),c(t,e+1));return{nodes:s,edges:l,y:i,mid:o}}function it({plinthTop:e=.3,extent:t=4,profile:n=null}={}){let i=new r,u=rt(),{nodes:f,edges:p}=u,m=u.y,g=.34,_=0;{let e=He.PITCH-g*2;_=Math.max(1,Math.floor((e+.26)/.56))}let v=new o({color:`#e8c84a`,fog:!0}),y=new a(new C(.05,.012,.3),v,p.length*_);y.frustumCulled=!1,y.raycast=()=>{},y.receiveShadow=!1,y.castShadow=!1,i.add(y);{let e=new h,t=0;for(let n of p){let r=f[n.a],i=f[n.b],a=i.x-r.x,o=i.z-r.z,s=Math.hypot(a,o),c=a/s,l=o/s,u=Math.atan2(c,l),d=s-g*2;for(let n=0;n<_;n++){let i=g+(_===1?d/2:d*n/(_-1));e.position.set(r.x+c*i,m,r.z+l*i),e.rotation.set(0,u,0),e.updateMatrix(),y.setMatrixAt(t++,e.matrix)}}y.instanceMatrix.needsUpdate=!0}let b=new a(new C(.34,.26,.74),J(new c({flatShading:!0,roughness:.5,metalness:.3})),12);b.castShadow=!0,b.receiveShadow=!1,b.frustumCulled=!1,b.raycast=()=>{};let x=new B,S=new Float32Array(72),w=new Float32Array(72),T=new L(`#fff0c0`),D=new L(`#ff3528`);for(let e=0;e<12;e++)T.toArray(w,e*3),D.toArray(w,(12+e)*3),S[e*3+1]=-50,S[(12+e)*3+1]=-50;x.setAttribute(`position`,new te(S,3)),x.setAttribute(`color`,new te(w,3));let O=new l({size:.72,sizeAttenuation:!0,map:et(),vertexColors:!0,transparent:!0,opacity:0,blending:2,depthWrite:!1}),k=new s(x,O);k.frustumCulled=!1,k.raycast=()=>{},i.add(b,k);let A=[`#f4c430`,`#c0392b`,`#d8dde2`,`#9aa7b4`,`#6b7785`,`#5a7d9a`],j=Y(2403557),M=p.map((e,t)=>t).filter(e=>p[e].main),P=[];for(let e=0;e<12;e++){let t=e<4&&M.length?M[j()*M.length|0]:j()*p.length|0,n=e===1;P.push({edge:t,fwd:j()<.5,s:j()*p[t].len,speed:n?.5:.78+e%3*.1,lenZ:n?1.45:1,color:A[n?1:e===0?0:2+e%4],rng:Y(12648430+e*2654435761)})}let ee=new L;P.forEach((e,t)=>b.setColorAt(t,ee.set(e.color)));function F(e,t,n){let r=f[e],i=r.edges.filter(e=>e!==t);if(i.length===0)return t;let a=p[t],o=a.a===e?a.b:a.a,s=r.x-f[o].x,c=r.z-f[o].z,l=Math.hypot(s,c)||1,u=i[0],d=-2;for(let t of i){let n=p[t],i=n.a===e?n.b:n.a,a=f[i].x-r.x,o=f[i].z-r.z,m=Math.hypot(a,o)||1,h=s/l*(a/m)+c/l*(o/m);h>d&&(d=h,u=t)}return n()<.65?u:i[n()*i.length|0]}let I=F,R=new h,z=(e,t)=>{R.position.set(0,-50,0),R.scale.setScalar(0),R.updateMatrix(),e.setMatrixAt(t,R.matrix)},V=.085,H=He.PLINTH_TOP+.02+.13,U=new a(new N(.04,.1,3,6),J(new c({flatShading:!0,roughness:.8})),14);U.castShadow=!0,U.receiveShadow=!1,U.frustumCulled=!1,U.raycast=()=>{};let W=tt(t-.72,e),ne=[];for(let e=0;e<14;e++)ne.push({phase:e/14,speed:.12+e%4*.02,dir:e%2?1:-1});let re=new E,ie=new E,ae=new L;ne.forEach((e,t)=>U.setColorAt(t,ae.set([`#caa`,`#9ab`,`#bba`,`#ab9`][t%4]))),i.add(U);let G={manhattan:`#e8c84a`,paris:`#dcd2bc`,neoTokyo:`#5ae8e0`};function oe(e){e&&v.color.set(G[e.key]||`#e8c84a`)}oe(n);function K(t,n,r){let i=r?r.t:.5,a=r?r.windowGlow:0,o=Math.max(2,Math.round(nt(i)*12)),s=a>.05;for(let e=0;e<12;e++){if(e>=o){z(b,e),S[e*3+1]=-50,S[(12+e)*3+1]=-50;continue}let n=P[e];n.s+=t*n.speed;let r=0;for(;n.s>=p[n.edge].len&&r++<4;){n.s-=p[n.edge].len;let e=n.fwd?p[n.edge].b:p[n.edge].a,t=I(e,n.edge,n.rng);n.edge=t,n.fwd=p[t].a===e}let i=p[n.edge],a=n.fwd?f[i.a]:f[i.b],c=n.fwd?f[i.b]:f[i.a],l=c.x-a.x,u=c.z-a.z,d=Math.hypot(l,u)||1,m=l/d,h=u/d,g=-h,_=m,v=a.x+m*n.s+g*V,y=a.z+h*n.s+_*V,x=Math.atan2(m,h);R.position.set(v,H,y),R.rotation.set(0,x,0),R.scale.set(1,1,n.lenZ),R.updateMatrix(),b.setMatrixAt(e,R.matrix);let C=.74*n.lenZ*.5,w=H+.06,T=e*3,E=(12+e)*3;s?(S[T]=v+m*(C+.04),S[T+1]=w,S[T+2]=y+h*(C+.04),S[E]=v-m*(C+.02),S[E+1]=w,S[E+2]=y-h*(C+.02)):(S[T+1]=-50,S[E+1]=-50)}b.instanceMatrix.needsUpdate=!0,x.attributes.position.needsUpdate=!0,O.opacity=d.clamp(a*1.8,0,1);let c=Math.max(2,Math.round(nt(i)*14));for(let t=0;t<14;t++){if(t>=c){z(U,t);continue}let r=ne[t],i=(r.phase+r.dir*r.speed*n*.02+1e3)%1;W.getPointAt(i,re),W.getTangentAt(i,ie);let a=Math.sin(n*6+r.phase*30)*.015;R.position.set(re.x,e+.09+a,re.z),R.rotation.set(0,Math.atan2(ie.x*r.dir,ie.z*r.dir),Math.sin(n*6+r.phase*30)*.06),R.scale.setScalar(1),R.updateMatrix(),U.setMatrixAt(t,R.matrix)}U.instanceMatrix.needsUpdate=!0}return{group:i,update:K,setProfile:oe,graph:u,setRouter(e){I=e||F}}}function at({frames:e=4,fps:t=8}={}){function n(t){let n=t.clone();return n.needsUpdate=!0,n.repeat.set(1/e,1),n.offset.set(0,0),n}function r(n,r,i=0){let a=(Math.floor(r*t+i)%e+e)%e;return n.offset.x=a/e,a}return{frames:e,fps:t,makeInstanceTexture:n,step:r}}function ot(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.4,`rgba(255,255,255,0.5)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64);let r=new T(e);return r.colorSpace=b,r}function st(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64/2,64*.62,0,64/2,64*.62,64*.5);n.addColorStop(0,`rgba(240,250,255,0.95)`),n.addColorStop(1,`rgba(240,250,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64);let r=new T(e);return r.colorSpace=b,r}function ct(){let e=document.createElement(`canvas`);e.width=256,e.height=64;let t=e.getContext(`2d`);t.strokeStyle=`#ffffff`,t.lineWidth=6,t.lineCap=`round`,t.lineJoin=`round`;let n=[14,24,36,24];for(let e=0;e<4;e++){let r=e*64,i=n[e];t.beginPath(),t.moveTo(r+8,40),t.quadraticCurveTo(r+24,i,r+32,36),t.quadraticCurveTo(r+40,i,r+56,40),t.stroke()}let r=new T(e);return r.colorSpace=b,r}function lt(e,t,n=18){let r=[];for(let i=0;i<n;i++){let a=i/n*Math.PI*2;r.push(new E(Math.cos(a)*e,t,Math.sin(a)*e))}return new U(r,!0,`catmullrom`,.5)}function ut(e,t,n){let r=e-t,i=[],a=(e,t)=>i.push(new E(e,n,t)),o=(e,n,r,i,o=4)=>{for(let s=1;s<=o;s++){let c=r+(i-r)*(s/o);a(e+Math.cos(c)*t,n+Math.sin(c)*t)}};for(let t=0;t<4;t++)a(e,-r+2*r*t/4);o(r,r,0,Math.PI/2);for(let t=0;t<4;t++)a(r-2*r*t/4,e);o(-r,r,Math.PI/2,Math.PI);for(let t=0;t<4;t++)a(-e,r-2*r*t/4);o(-r,-r,Math.PI,1.5*Math.PI);for(let t=0;t<4;t++)a(-r+2*r*t/4,-e);return o(r,-r,1.5*Math.PI,2*Math.PI),new U(i,!0,`catmullrom`,.5)}function dt({extent:e=8,waterSize:t=28,plinthTop:n=.3}={}){let i=new r;i.raycast=()=>{};let a=.06,o=(e,n,r)=>r.set(e/t+.5,-n/t+.5,0),u=[ut(9.5,3,a),lt(12.7,a),new U([new E(8.4,a,0),new E(11,a,-3.6),new E(13,a,0),new E(11,a,3.6)],!0,`catmullrom`,.5)],f=u.map(e=>e.getLength());function m({scale:e=1,hull:t=`#6b7785`,cabin:n=`#e7ecf2`}){let i=new r,a=new p(new C(.46*e,.2*e,1.1*e),J(new c({color:t,roughness:.6,metalness:.2,flatShading:!0}),{color:t}));a.position.y=.02;let o=new p(new C(.3*e,.22*e,.42*e),J(new c({color:n,roughness:.7,flatShading:!0}),{color:n}));return o.position.set(0,.18*e,.08*e),i.add(a,o),i.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!1),e.raycast=()=>{}}),i.userData.halfLen=.55*e,i}let h=[{laneIndex:0,dir:1,speed:.5,wake:.024,scale:1,hull:`#5a6675`,cabin:`#e7ecf2`},{laneIndex:1,dir:-1,speed:.42,wake:.022,scale:1,hull:`#7a5b46`,cabin:`#d9c3a6`},{laneIndex:0,dir:1,speed:.56,wake:.024,scale:.9,hull:`#456079`,cabin:`#cfe0ee`},{laneIndex:2,dir:1,speed:.34,wake:.03,scale:1.35,hull:`#39505f`,cabin:`#e2b85a`}];h.forEach((e,t)=>{e.mesh=m(e),e.u=t*.27%1,e.phase=t*1.7,e.isFerry=e.laneIndex===2,i.add(e.mesh)});let g=h.length,_=g*2,v=new B,y=new Float32Array(_*3).fill(-50),b=new Float32Array(_*3),x=new L(`#fff0c0`),S=new L(`#ff3528`);for(let e=0;e<g;e++)x.toArray(b,e*3),S.toArray(b,(g+e)*3);v.setAttribute(`position`,new te(y,3)),v.setAttribute(`color`,new te(b,3));let w=new s(v,new l({size:.6,sizeAttenuation:!0,map:ot(),vertexColors:!0,transparent:!0,opacity:0,blending:2,depthWrite:!1}));w.frustumCulled=!1,w.raycast=()=>{},i.add(w);function T(e,t){let n=new p(new D(e,9,7),J(new c({color:t,roughness:.5,flatShading:!0}),{color:t}));return n.scale.set(.55,.5,1),n.castShadow=!1,n.receiveShadow=!1,n.raycast=()=>{},n.position.y=-5,n}let O=[{x:-9.5,z:6,size:.18,color:`#5b6f86`,period:11,arcH:.55,span:1.1,whale:!1},{x:7.5,z:-9.5,size:.16,color:`#4a6076`,period:14,arcH:.5,span:1,whale:!1},{x:-7,z:-8.5,size:.2,color:`#607089`,period:9,arcH:.6,span:1.2,whale:!1},{x:10.5,z:7,size:.62,color:`#3a4350`,period:38,arcH:.9,span:2.6,whale:!0}];O.forEach((e,t)=>{e.mesh=T(e.size,e.color),e.heading=Math.atan2(-e.x,-e.z),e.t=t/O.length*e.period,e.splashed=!1,i.add(e.mesh),e.whale&&(e.spout=new I(new z({map:st(),transparent:!0,opacity:0,depthWrite:!1,fog:!0})),e.spout.scale.set(.6,1.1,1),e.spout.position.set(e.x,-5,e.z),i.add(e.spout))});let k=ct(),A=at({frames:4,fps:7}),j=[`#ffffff`,`#cfd4da`,`#c8a06a`],M=[];for(let e=0;e<4;e++){let t=new I(new z({map:A.makeInstanceTexture(k),color:new L(j[e%j.length]),transparent:!0,opacity:0,depthWrite:!1,fog:!0}));t.scale.setScalar(.5),M.push({sp:t,r:8.6+e*.5,y:1.1+e%2*.5,speed:(.18+e*.03)*(e%2?-1:1),phase:e*1.9}),i.add(t)}typeof window<`u`&&(window.__gullAnim={frames:A.frames,variants:j.length,fps:A.fps});let N=O.length,P=Array.from({length:g+N},()=>new E),ee=e=>e.laneIndex,F=new E,R=new E,V=new E;function H(e,t,n){let r=n?n.windowGlow:0,i=1-r;for(let n=0;n<g;n++){let i=h[n],s=u[i.laneIndex],c=f[i.laneIndex],l=i.isFerry?.45+.55*Math.min(1,Math.abs((i.u+.5)%1-.5)*3):1,d=i.u;i.u=(i.u+i.dir*e*i.speed*l/c+1)%1,(i.dir>0?i.u<d:i.u>d)&&(i.laneIndex=ee(i)),s.getPointAt(i.u,F),s.getTangentAt(i.u,R);let p=R.x*i.dir,m=R.z*i.dir,_=Math.atan2(p,m),v=Math.sin(t*1.1+i.phase)*.025;i.mesh.position.set(F.x,a+v,F.z),i.mesh.rotation.set(Math.sin(t*.9+i.phase)*.04,_,0);let b=i.mesh.userData.halfLen;o(F.x-p*b,F.z-m*b,V),P[n].set(V.x,V.y,i.wake);let x=n*3,S=(g+n)*3;if(r>.05){let e=.18;y[x]=F.x+p*(b+.05),y[x+1]=e,y[x+2]=F.z+m*(b+.05),y[S]=F.x-p*(b+.02),y[S+1]=e,y[S+2]=F.z-m*(b+.02)}else y[x+1]=-50,y[S+1]=-50}W(),w.material.opacity=d.clamp(r*1.8,0,1);for(let t=0;t<N;t++){let n=O[t];n.t+=e;let r=g+t,i=n.whale?3.2:1.3;if(n.t>=n.period){let e=(n.t-n.period)/i;if(e>=1){n.t=0,n.splashed=!1,n.mesh.position.y=-5,n.spout&&(n.spout.material.opacity=0),P[r].set(0,0,0);continue}let t=Math.sin(Math.PI*e),s=(e-.5)*n.span,c=n.x+Math.sin(n.heading)*s,l=n.z+Math.cos(n.heading)*s;n.mesh.position.set(c,a-.1+t*n.arcH,l),n.mesh.rotation.set(Math.cos(Math.PI*e)*.9,n.heading,0);let u=e<.16||e>.84;if(o(c,l,V),P[r].set(V.x,V.y,u?n.whale?.07:.05:0),n.spout){let t=d.clamp((e-.15)*3,0,1)*(1-e);n.spout.position.set(c,.56+t*.6,l),n.spout.material.opacity=t*.9}}else n.mesh.position.y=-5,P[r].set(0,0,0),n.spout&&(n.spout.material.opacity=0)}for(let e=0;e<4;e++){let n=M[e],r=n.phase+t*n.speed*.25;n.sp.position.set(Math.cos(r)*n.r,n.y+Math.sin(t*1.4+n.phase)*.12,Math.sin(r)*n.r),n.sp.material.opacity=d.clamp(i*.9-.05,0,.85);let a=A.step(n.sp.material.map,t,n.phase);e===0&&typeof window<`u`&&(window.__gullFrame=a)}if(typeof window<`u`){let e=0;for(let t of O)t.mesh.position.y>a&&e++;window.__waterLife={boats:g,breaching:e,gulls:+M[0].sp.material.opacity.toFixed(2),lights:+w.material.opacity.toFixed(2)}}}function W(){v.attributes.position.needsUpdate=!0}function ne(){return P.length}return{group:i,update:H,wakeDrops:P,get wakeCount(){return ne()},lanes:u,setRouter(e){ee=e||(e=>e.laneIndex)}}}var ft=[`empireState`,`chrysler`,`liberty`,`eiffel`,`arcDeTriomphe`,`sacreCoeur`,`tokyoTower`,`pagoda`,`neonBillboard`],pt={empireState:1.25,chrysler:1.1,liberty:.55,eiffel:3.2,arcDeTriomphe:1.5,sacreCoeur:1.75,tokyoTower:1.35,pagoda:.5,neonBillboard:.9};function mt(e){let t=()=>new c({flatShading:!0,roughness:.7,metalness:.1}),n=(n,r={})=>r.windows?Ne(t(),{color:n,id:e.id(),windowGlow:e.windowGlow,winColors:e.winColors,litFrac:e.litFrac}):J(t(),{color:n,glow:r.glow??null,glowDay:r.glowDay??0,glowNight:r.glowNight??1,windowGlow:r.glow?e.windowGlow:null});return{box:(e,t,r,i,a={})=>new p(new C(e,t,r),n(i,a)),cyl:(e,t,r,i,a={})=>new p(new A(e,t,r,a.seg||12),n(i,a)),cone:(e,t,r,i={})=>new p(new ee(e,t,i.seg||8),n(r,i)),sphere:(e,t,r={})=>new p(new D(e,r.seg||12,r.seg2||8),n(t,r)),lathe:(e,t,r={})=>new p(new i(e.map(e=>new V(e[0],e[1])),r.seg||4),n(t,r))}}var $=(e,t,n,r)=>(e.position.set(t,n,r),e),ht=[`#7FB0E0`,`#E07FB0`,`#7FE0A0`,`#E0C97F`,`#9FE07F`,`#7FE0E0`,`#FF8C42`,`#E0E07F`,`#C97FE0`,`#E07F7F`,`#7F9FE0`,`#E0483A`],gt={empireState(e,t){let n=`#E8E0CF`;e.add($(t.box(.42,.18,.42,n,{windows:!0}),0,.09,0)),e.add($(t.box(.34,.16,.34,n,{windows:!0}),0,.26,0)),e.add($(t.box(.26,.14,.26,n,{windows:!0}),0,.41,0)),e.add($(t.box(.19,.34,.19,n,{windows:!0}),0,.65,0)),e.add($(t.box(.13,.06,.13,n,{windows:!0}),0,.85,0));let r=ht[new Date().getMonth()];e.add($(t.cyl(.03,.045,.12,n,{seg:10,glow:r,glowNight:1.85}),0,.94,0)),e.add($(t.cone(.012,.07,n,{seg:8}),0,1.04,0))},chrysler(e,t){let n=`#C9CED4`;e.add($(t.box(.22,.55,.22,`#9AA7B4`,{windows:!0}),0,.275,0));let r=.55;for(let i=0;i<5;i++){let a=.14-i*.024,o=.07;e.add($(t.cyl(a*.7,a,o,n,{seg:8,glow:`#dfeaff`,glowNight:.5}),0,r+o/2,0)),r+=o}e.add($(t.cone(.018,.16,n,{seg:8}),0,r+.08,0))},liberty(e,t){let n=`#B9B4A6`,r=`#4FA890`;e.add($(t.box(.42,.16,.42,n),0,.08,0)),e.add($(t.box(.3,.2,.3,n),0,.26,0)),e.add($(t.cyl(.1,.15,.42,r,{seg:10}),0,.57,0)),e.add($(t.box(.11,.1,.11,r),0,.83,0));for(let n=0;n<7;n++){let i=(n/6-.5)*Math.PI*1.1;e.add($(t.cone(.012,.1,r,{seg:5}),Math.sin(i)*.1,.92,Math.cos(i)*.06-.02))}let i=$(t.cyl(.025,.03,.34,r,{seg:8}),.14,.98,0);i.rotation.z=.35,e.add(i),e.add($(t.box(.06,.06,.06,r,{glow:`#ffd060`,glowDay:.6,glowNight:1.2}),.2,1.16,0)),e.add($(t.cone(.04,.09,`#ffcf66`,{seg:6,glow:`#ffd060`,glowDay:.7,glowNight:1.3}),.2,1.24,0))},eiffel(e,t){let n=`#6E5C4C`,r=[[.2,0],[.13,.16],[.085,.33],[.055,.5],[.035,.66],[.02,.85],[0,.92]];e.add(t.lathe(r,n,{seg:4}));let i=t.lathe(r,n,{seg:4});i.rotation.y=Math.PI/4,e.add(i),e.add($(t.box(.26,.025,.26,n),0,.33,0)),e.add($(t.box(.14,.02,.14,n),0,.66,0)),e.add($(t.cone(.01,.1,n,{seg:6}),0,.97,0))},arcDeTriomphe(t,r){let i=`#D9D0C1`,a=.58,o=.5,s=.34,l=new e;l.moveTo(-.58/2,0),l.lineTo(a/2,0),l.lineTo(a/2,o),l.lineTo(-.58/2,o),l.lineTo(-.58/2,0);let u=new n,d=.15,f=.22;u.moveTo(-.15,0),u.lineTo(-.15,f),u.absarc(0,f,d,Math.PI,0,!0),u.lineTo(d,0),u.lineTo(-.15,0),l.holes.push(u);let m=new w(l,{depth:s,bevelEnabled:!1});m.translate(0,0,-.34/2),m.computeVertexNormals(),t.add(new p(m,J(new c({color:i,flatShading:!0}),{color:i}))),t.add($(r.box(a*1.06,.08,s*1.06,i),0,.54,0))},sacreCoeur(e,t){let n=`#F1EEE6`;e.add($(t.box(.5,.26,.4,n),0,.13,0));let r=(r,i,a,o)=>{e.add($(t.cyl(a*.9,a,i,n,{seg:12}),r,o,0));let s=$(t.sphere(a,n,{seg:12}),r,o+i/2,0);s.scale.y=1.5,e.add(s)};r(0,.22,.15,.4),r(-.2,.1,.07,.33),r(.2,.1,.07,.33)},tokyoTower(e,t){let n=`#F25822`,r=`#EDEDED`,i=0;for(let a=0;a<9;a++){let o=a/9,s=(a+1)/9,c=.19*(1-o)+.03*o,l=.19*(1-s)+.03*s,u=.085,d=a%2?r:n;e.add($(t.cyl(l,c,u,d,{seg:4,glow:n,glowDay:0,glowNight:.7}),0,i+u/2,0)),i+=u}e.add($(t.box(.22,.02,.22,n,{glow:n,glowNight:.7}),0,.28,0)),e.add($(t.box(.12,.02,.12,r),0,.5,0)),e.add($(t.cone(.012,.16,r,{seg:6,glow:`#ff6a2a`,glowNight:.9}),0,i+.08,0))},pagoda(e,t){let n=0;for(let r=0;r<5;r++){let i=.42-r*.06,a=.11;e.add($(t.box(i,a,i,`#B23A2C`,{windows:r<4}),0,n+a/2,0)),e.add($(t.box(i*1.34,.03,i*1.34,`#7A3B2A`),0,n+a+.015,0)),n+=.16999999999999998}e.add($(t.cyl(.012,.012,.1,`#E0C040`,{seg:6}),0,n+.05,0)),e.add($(t.sphere(.03,`#E0C040`,{seg:8,glow:`#ffe680`,glowNight:.8}),0,n+.12,0))},neonBillboard(e,t){let n=`#20242C`;e.add($(t.box(.3,1,.3,n,{windows:!0}),0,.5,0));let r=[`#5AE8E0`,`#E85AA0`,`#E8E06A`],i=(n,r,i,a,o,s,c)=>{let l=$(t.box(n,r,.02,i,{glow:i,glowDay:.6,glowNight:1.1}),a,o,s);l.rotation.y=c,e.add(l)};i(.22,.34,r[0],0,.75,.16,0),i(.16,.5,r[1],.16,.5,0,Math.PI/2),i(.2,.22,r[2],0,.34,-.16,0),e.add($(t.cone(.01,.14,n,{seg:6,glow:`#E85AA0`,glowDay:.4,glowNight:1}),0,1.08,0))}};function _t(e,t){let n=new r;return gt[e](n,mt(t)),n}var vt=``+new URL(`building-skyscraper-d-CapD2Zqe.glb`,import.meta.url).href,yt=``+new URL(`building-n-hdv8kKtN.glb`,import.meta.url).href,bt=``+new URL(`building-g-CsTB1qH9.glb`,import.meta.url).href,xt=``+new URL(`colormap-CK8fW2HB.png`,import.meta.url).href,St={skyscraper:{url:vt,color:`#9cc1dd`,fill:.92},midrise:{url:yt,color:`#c9a07a`,fill:.96},setback:{url:bt,color:`#d9c7a0`,fill:.9}};function Ct({windowGlow:e}){let t=new M;t.setURLModifier(e=>e.includes(`colormap.png`)?xt:e);let n=new H(t),r={},i=!1,a=Promise.all(Object.entries(St).map(async([e,t])=>{r[e]=(await n.loadAsync(t.url)).scene})).then(()=>{i=!0,window.__landmarksReady=!0}).catch(e=>console.error(`landmark models failed:`,e)),o=9e3;function s(t,n,i={}){let a,s;if(ft.includes(t))a=_t(t,{windowGlow:e,winColors:i.winColors,litFrac:i.litFrac,id:()=>++o}),s=1;else{let e=r[t],n=St[t];if(!e||!n)return null;a=e.clone(!0),s=n.fill}a.updateMatrixWorld(!0);let c=new j().setFromObject(a).getSize(new E);a.scale.setScalar(n.h*s/c.y),a.updateMatrixWorld(!0);let l=new j().setFromObject(a),u=l.getCenter(new E);return a.position.x+=n.x-u.x,a.position.z+=n.z-u.z,a.position.y+=n.plinthTop-l.min.y,ft.includes(t)?a.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.raycast=()=>{})}):a.traverse(n=>{if(!n.isMesh)return;n.castShadow=!1,n.raycast=()=>{};let r=n=>Ne(n.clone(),{color:St[t].color,id:++o,windowGlow:e,winColors:i.winColors,litFrac:i.litFrac});n.material=Array.isArray(n.material)?n.material.map(r):r(n.material)}),a}return{make:s,whenReady:a,heightFactor:e=>pt[e]??1,get ready(){return i}}}var wt=[`clear`,`rain`,`snow`,`fog`];function Tt({extent:e=7}={}){let t=new r;t.raycast=()=>{};let n=e+2,i=.25,s=(e,t)=>e+Math.random()*(t-e),c=new a(new v(.015,.5),new o({color:`#a9bdd6`,transparent:!0,opacity:0,depthWrite:!1,fog:!1}),600);c.frustumCulled=!1,c.raycast=()=>{};let l=new Float32Array(600*3),u=new Float32Array(600);for(let e=0;e<600;e++)l[e*3]=s(-n,n),l[e*3+1]=s(i,11),l[e*3+2]=s(-n,n),u[e]=s(9,14);let d=new a(new v(.07,.07),new o({color:`#f3f7ff`,transparent:!0,opacity:0,depthWrite:!1,fog:!1}),700);d.frustumCulled=!1,d.raycast=()=>{};let f=new Float32Array(700*3),p=new Float32Array(700),m=new Float32Array(700);for(let e=0;e<700;e++)f[e*3]=s(-n,n),f[e*3+1]=s(i,11),f[e*3+2]=s(-n,n),p[e]=s(0,6.28),m[e]=s(.6,1.2);t.add(c,d);let g=Array.from({length:8},()=>new E),_=0,y=`clear`,b=0,x=0,S=0,C=0,w=0,T=new h,D=(e,t,n,r)=>e+(t-e)*Math.min(1,n*r);function O(e){wt.includes(e)&&(y=e)}function k(){y=wt[(wt.indexOf(y)+1)%wt.length]}function A(e,t){let r=y===`rain`,a=y===`snow`,o=y===`fog`,h=y!==`clear`;b=D(b,+!!h,e,1.4),x=D(x,+!!h,e,1.2),S=D(S,+!!o,e,.9),w=D(w,h&&!o?1:0,e,1),C=D(C,+!!a,e,a?.22:.5);let v=r?b:0,E=Math.round(600*v);for(let t=0;t<600;t++){if(t>=E){T.position.set(0,-50,0),T.scale.setScalar(0),T.updateMatrix(),c.setMatrixAt(t,T.matrix);continue}l[t*3+1]-=u[t]*e,l[t*3]+=e*1.1,l[t*3+1]<i&&(l[t*3]=s(-n,n),l[t*3+1]=11,l[t*3+2]=s(-n,n)),T.position.set(l[t*3],l[t*3+1],l[t*3+2]),T.rotation.set(0,0,0),T.scale.set(1,1,1),T.updateMatrix(),c.setMatrixAt(t,T.matrix)}c.instanceMatrix.needsUpdate=!0,c.material.opacity=.55*v,_=r?Math.round(8*b):0;for(let e=0;e<_;e++)g[e].set(Math.random(),Math.random(),.05*b);let O=Math.round(700*(a?b:0));for(let r=0;r<700;r++){if(r>=O){T.position.set(0,-50,0),T.scale.setScalar(0),T.updateMatrix(),d.setMatrixAt(r,T.matrix);continue}f[r*3+1]-=m[r]*e;let a=Math.sin(t*1.5+p[r])*.5;f[r*3+1]<i&&(f[r*3]=s(-n,n),f[r*3+1]=11,f[r*3+2]=s(-n,n)),T.position.set(f[r*3]+a,f[r*3+1],f[r*3+2]),T.rotation.set(0,0,0),T.scale.setScalar(1),T.updateMatrix(),d.setMatrixAt(r,T.matrix)}d.instanceMatrix.needsUpdate=!0,d.material.opacity=.9*(a?b:0)}return{group:t,update:A,cycle:k,setKind:O,rainDrops:g,get kind(){return y},get intensity(){return b},get overcast(){return x},get fog(){return S},get snow(){return C},get cloud(){return w},get rainDropCount(){return _},poolCounts:{rain:600,snow:700}}}function Et(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=(e,n,r)=>{let i=t.createRadialGradient(e,n,0,e,n,r);i.addColorStop(0,`rgba(255,255,255,0.95)`),i.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=i,t.beginPath(),t.arc(e,n,r,0,7),t.fill()};n(128*.42,128*.56,128*.26),n(128*.6,128*.5,128*.3),n(128*.5,128*.46,128*.22),n(128*.34,128*.54,128*.18),n(128*.7,128*.58,128*.18);let r=[0,8,2,10,12,4,14,6,3,11,1,9,15,7,13,5],i=t.getImageData(0,0,128,128),a=i.data;for(let e=0;e<128;e++)for(let t=0;t<128;t++){let n=(e*128+t)*4,i=a[n+3]/255,o=(r[e%4*4+t%4]+.5)/16-.5;a[n+3]=Math.max(0,Math.min(1,Math.floor(i*5+.5+o)/5))*255}t.putImageData(i,0,0);let o=new T(e);return o.colorSpace=b,o}function Dt({extent:e=8,count:t=16}={}){let n=new r;n.raycast=()=>{};let i=Et(),a=e+6,o=(e,t)=>e+Math.random()*(t-e),s=[];for(let e=0;e<t;e++){let e=new z({map:i,transparent:!0,depthWrite:!1,opacity:0,fog:!0}),t=new I(e),r={sp:t,mat:e,wisp:Math.random(),x:o(-a,a),z:o(-a,a),hiY:o(4,6.8),loY:o(.6,2.2),w:o(3,5.6),h:o(1.7,3),speed:o(.25,.7),op:o(.6,1)};t.raycast=()=>{},s.push(r),n.add(t)}let c=new L,l=new L(`#ffffff`),u=new L(`#5b626e`);function d(e,t,n,r){let i=r?r.cloud:0,d=r?r.fog:0,f=Math.min(1,.4+.6*i+.5*d);c.copy(n.sky).lerp(l,.62),c.lerp(u,.6*i);for(let n=0;n<s.length;n++){let r=s[n],l=n/s.length<f;r.x+=r.speed*e*(.6+.8*i),r.x>a&&(r.x=-a,r.z=o(-a,a));let u=Math.min(Ot(r.x,-a,-a+3),1-Ot(r.x,a-3,a)),p=r.hiY*(1-d)+r.loY*d,m=1-.5*r.wisp,h=.72*Math.max(0,1-d-i)+1*i+.42*d,g=l?Math.max(0,h)*r.op*m*u:0;r.mat.opacity+=(g-r.mat.opacity)*Math.min(1,e*2.5),r.mat.color.copy(c);let _=r.w*(1+.6*d)*(1+.4*r.wisp),v=r.h*(1-.35*d);r.sp.scale.set(_,v,1),r.sp.position.set(r.x,p+Math.sin(t*.3+n)*.15,r.z)}}function f(e){i=e;for(let t of s)t.mat.map=e,t.mat.needsUpdate=!0}return{group:n,update:d,setTexture:f,get count(){return s.length}}}function Ot(e,t,n){let r=Math.max(0,Math.min(1,(e-t)/(n-t)));return r*r*(3-2*r)}var kt=`varying vec2 vUv;
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Bt={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Vt=[`gb`,`8-bit`,`16-bit`,`modern`],Ht={"ink-gold (day)":[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],"ink-gold (night)":[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],"terminal (day)":[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],"terminal (night)":[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`]};function Ut(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new L(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new k(n,t,1,R,re);return r.minFilter=u,r.magFilter=u,r.needsUpdate=!0,r}function Wt(e,t){let n=[];for(let t=0;t+2<e.length;t+=3)n.push([e[t],e[t+1],e[t+2]]);if(n.length===0)return[`#000000`];let r=e=>{let t=[255,255,255],n=[0,0,0];for(let r of e)for(let e=0;e<3;e++)t[e]=Math.min(t[e],r[e]),n[e]=Math.max(n[e],r[e]);let r=[n[0]-t[0],n[1]-t[1],n[2]-t[2]],i=r[0]>=r[1]&&r[0]>=r[2]?0:r[1]>=r[2]?1:2;return{ax:i,range:r[i]}},i=[n];for(;i.length<t;){let e=-1,t=-1;if(i.forEach((n,i)=>{if(n.length>1){let{range:a}=r(n);a>t&&(t=a,e=i)}}),e<0)break;let n=i[e],{ax:a}=r(n);n.sort((e,t)=>e[a]-t[a]);let o=n.length>>1;i.splice(e,1,n.slice(0,o),n.slice(o))}return i.map(e=>{let t=[0,0,0];for(let n of e)for(let e=0;e<3;e++)t[e]+=n[e];return`#`+t.map(t=>Math.round(t/e.length)).map(e=>e.toString(16).padStart(2,`0`)).join(``)})}var Gt=220,Kt={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},qt={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Jt({demo:e=!1,citySeed:n=0,profileIndex:r=0}={}){let i=new F({antialias:!0,preserveDrawingBuffer:!0});i.shadowMap.enabled=!0,i.shadowMap.type=1,i.shadowMap.autoUpdate=!1,i.shadowMap.needsUpdate=!0;let a=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);i.setPixelRatio(Math.min(window.devicePixelRatio,a?1.5:2)),i.setSize(window.innerWidth,window.innerHeight),i.setClearColor(920327,1),document.body.appendChild(i.domElement);let s=i.getDrawingBufferSize(new V),c=new x;c.fog=new g(10465470,0);let l=new L(`#aeb6c0`),h=.062,_=new L(`#74508f`),y=new L,C=ve({aspect:window.innerWidth/window.innerHeight}),w=$e({t:.5}),D={type:ne,format:R,minFilter:u,magFilter:u,wrapS:O,wrapT:O,depthBuffer:!1,stencilBuffer:!1},k=[new P(256,256,D),new P(256,256,D),new P(256,256,D)];for(let e of k)i.setRenderTarget(e),i.clear();i.setRenderTarget(null);let A=new x,j=new ie(-1,1,1,-1,0,1),M=new m({vertexShader:jt,fragmentShader:Mt,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new V(1/256,1/256)},uMouse:{value:new V(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new E)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new E)}}});A.add(new p(new v(2,2),M));let N=new P(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!0,stencilBuffer:!1});function ee(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new T(t);return r.colorSpace=b,r}let I=new p(new v(28,28),new o({map:ee(e)}));I.rotation.x=-Math.PI/2,I.position.y=-.35,c.add(I);let te=new p(new v(40,24),new m({depthWrite:!1,vertexShader:kt,fragmentShader:At,uniforms:{uTime:{value:0},uInk:{value:w.horizon},uGold:{value:w.sky},uFogColor:{value:y},uFogAmt:{value:0},uFogCharm:Te}}));te.position.set(0,3,-8),c.add(te);let z=new m({vertexShader:Nt,fragmentShader:Pt,uniforms:{uHeight:{value:null},uScene:{value:N.texture},uTexel:{value:new V(1/256,1/256)},uResolution:{value:new V(s.x,s.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new f},uLightDir:{value:w.sunDir},uInk:{value:new L(`#2A2218`)},uGold:{value:new L(`#B89968`)},uVector:ye,uVecWater:{value:new L(`#1fb8d8`)},uVecTint:{value:be}}}),B=new p(new v(28,28,255,255),z);B.rotation.x=-Math.PI/2,B.updateMatrixWorld(!0),z.uniforms.uNormalMatrix.value.getNormalMatrix(B.matrixWorld),c.add(B);let H={value:0},U=Ct({windowGlow:H}),W=Ge({seed:n,profileIndex:r,landmarkFactory:U,windowGlow:H});c.add(W.group);let re=it({plinthTop:.3,extent:W.extent,profile:W.state.profile});c.add(re.group);let ae=dt({extent:W.extent,waterSize:28,plinthTop:.3});c.add(ae.group),M.uniforms.uWakeDrops.value=ae.wakeDrops;let G=Tt({extent:W.extent});c.add(G.group),M.uniforms.uRainDrops.value=G.rainDrops;let oe=Dt({extent:W.extent});c.add(oe.group),W.group.remove(W.key),c.add(W.key),W.key.castShadow=!0,W.key.shadow.mapSize.set(2048,2048),W.key.shadow.bias=-18e-5,W.key.shadow.normalBias=.028,c.add(W.key.target);function K(){let e=W.key.shadow.camera,t=W.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),i.shadowMap.needsUpdate=!0}K();let se=new S(s.x,s.y),ce=new P(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!0,stencilBuffer:!1,depthTexture:se}),le=new P(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),ue=new P(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),de=new P(s.x,s.y,{minFilter:t,magFilter:t,depthBuffer:!1,stencilBuffer:!1}),fe=new x,pe=new ie(-1,1,1,-1,0,1),me=new p(new v(2,2));fe.add(me);let q=new m({vertexShader:jt,fragmentShader:Ft,uniforms:{uScene:{value:ce.texture},uTime:{value:0},uResolution:{value:new V(s.x,s.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),he=e=>{let t=e.map(e=>new L(e));for(;t.length<8;)t.push(new L(0,0,0));return t},ge=[`night`,`dawn`,`noon`,`dusk`],_e={inkgold:ge.map(e=>he(Kt[e])),terminal:ge.map(e=>he(qt[e]))},De=new m({vertexShader:jt,fragmentShader:It,uniforms:{uScene:{value:le.texture},uResolution:{value:new V(s.x,s.y)},uPixelSize:{value:Gt},uPalette:{value:_e.inkgold[2]},uPaletteB:{value:_e.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),Oe=new m({vertexShader:jt,fragmentShader:zt,uniforms:{uScene:{value:le.texture},uResolution:{value:new V(s.x,s.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Ut(Bt[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),ke={};for(let e of Vt)ke[e]=Bt[e].palette?Ut(Bt[e].palette):null;let Ae=new m({vertexShader:jt,fragmentShader:Lt,uniforms:{uScene:{value:le.texture},uDepth:{value:se},uResolution:{value:new V(s.x,s.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:w.toonFloor},uOutline:{value:w.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),je=new m({vertexShader:jt,fragmentShader:Rt,uniforms:{uToon:{value:ue.texture},uPixel:{value:de.texture},uBlend:{value:0}}});function Me(e,t){me.material=e,i.setRenderTarget(t),i.render(fe,pe)}function Ne(){C.setViewport(window.innerWidth,window.innerHeight),i.setSize(window.innerWidth,window.innerHeight);let e=i.getDrawingBufferSize(new V);return N.setSize(e.x,e.y),ce.setSize(e.x,e.y),le.setSize(e.x,e.y),ue.setSize(e.x,e.y),de.setSize(e.x,e.y),z.uniforms.uResolution.value.set(e.x,e.y),q.uniforms.uResolution.value.set(e.x,e.y),De.uniforms.uResolution.value.set(e.x,e.y),Oe.uniforms.uResolution.value.set(e.x,e.y),Ae.uniforms.uResolution.value.set(e.x,e.y),e}let J=3,Y=!1,Pe=!1,X=`native`,Fe=.3,Ie=.46,Le=[`native`,...Vt],Re={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=J,window.__vector=Y,window.__era=X);let Z=0,ze=performance.now(),Be=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=Be),Be&&(i.info.autoReset=!1);let Q=null;typeof window<`u`&&(window.__loaded=!1);let Ve=0,He=new E(1,1,1),Ue=!1;function We(e){let t=Pe?_e.terminal:_e.inkgold,n=e%1*4,r=Math.floor(n)%4;De.uniforms.uPalette.value=t[r],De.uniforms.uPaletteB.value=t[(r+1)%4],De.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Ke(e){let t=Bt[e];t&&(Oe.uniforms.uGridWidth.value=t.gridWidth,Oe.uniforms.uDither.value=t.dither,Oe.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(Oe.uniforms.uPalette.value=ke[e],Oe.uniforms.uPaletteSize.value=t.palette.length))}function qe(){X!==`native`&&Ke(X)}let Je=()=>X===`native`?De:Oe;function Ye(e,t){B.visible=!1,i.setRenderTarget(N),i.render(c,e),B.visible=!0,i.setRenderTarget(t),i.render(c,e)}function Xe(e,t){if(B.visible=!1,i.setRenderTarget(N),i.render(c,C.camera),B.visible=!0,J===1||Y&&J!==7&&J!==8)i.setRenderTarget(t),i.render(c,C.camera);else if(i.setRenderTarget(ce),i.render(c,C.camera),J===2)q.uniforms.uGrain.value=1,q.uniforms.uChroma.value=1,Me(q,t);else{q.uniforms.uGrain.value=0,q.uniforms.uChroma.value=0,Me(q,le);let n=C.camera;Ae.uniforms.uNear.value=n.near,Ae.uniforms.uFar.value=n.far,Ae.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Ke(e.era),Oe):Je();e.kind===`pixel`?(Me(r,t),window.__style=`pixel`):e.kind===`toon`?(Me(Ae,t),window.__style=`toon`):(Me(Ae,ue),Me(r,de),je.uniforms.uBlend.value=e.blend,Me(je,t),window.__style=`blend`)}}function Ze(){let e=Qe(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return z.uniforms.uChromaScale.value=d.lerp(1,.5,t),e}function Qe(){if(J===1||J===2)return{kind:`none`};if(J===7)return{kind:`pixel`};if(J===8)return{kind:`toon`};let e=C.styleT;return window.__styleT=e,e<=Fe?{kind:`toon`}:e>=Ie?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:d.smoothstep(e,Fe,Ie),era:`16-bit`}}function et(e){return J===1||J===2?``:Y&&J!==7&&J!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Re[e.era||X]||`Pixel`:e.kind===`blend`?`Toon → `+(Re[e.era]||`Pixel`):``}function tt(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){if(Be){let e=i.info;Q={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}te.material.uniforms.uTime.value=t,q.uniforms.uTime.value=t,w.update(e),W.key.position.copy(w.sunDir).multiplyScalar(24),W.key.color.copy(w.sunColor),W.key.intensity=w.sunIntensity,W.fill.color.copy(w.hemiSky),W.fill.groundColor.copy(w.hemiGround),H.value=w.windowGlow;let a=G.overcast;W.key.intensity*=1-.5*a,W.key.color.lerp(l,.45*a),W.fill.intensity=1+.7*a;let o=d.smoothstep(w.sunDir.y,.06,.34),s=d.lerp(.28,1,1-w.windowGlow),u=n?o*s:0;W.key.shadow.intensity=.72*u,xe.value=.52*u,(n&&!Ue||He.distanceToSquared(w.sunDir)>2e-5)&&(i.shadowMap.needsUpdate=!0,He.copy(w.sunDir)),Ue=n;let f=1-w.windowGlow;be.setRGB(d.lerp(.46,1,f),d.lerp(.52,1,f),d.lerp(.74,1,f)),q.uniforms.uExposure.value=w.exposure,Ae.uniforms.uToonGain.value=w.toonGain,i.setClearColor(w.horizon,1),We(w.t),window.__t=w.t,re.update(e,t,w),W.update(t),ae.update(e,t,w),M.uniforms.uWakeCount.value=ae.wakeCount,G.update(e,t),M.uniforms.uRainCount.value=G.rainDropCount;let p=G.fog*(1-f);c.fog.density=G.fog*h,y.copy(w.horizon).lerp(_,.85*p),c.fog.color.copy(y),i.setClearColor(y,1),Te.value=G.fog,te.material.uniforms.uFogAmt.value=.7*G.fog,Se.value=G.snow,Ce.value=G.cloud*.55,we.x+=e*.018,we.y+=e*.009,Ee.value+=(r-Ee.value)*Math.min(1,e*1.5),oe.update(e,t,w,G),Z++;let m=performance.now();m-ze>=1e3&&(window.__fps=Z,Be&&Q&&(console.log(`[perf] ${Z} fps · ~${(1e3/Math.max(1,Z)).toFixed(2)} ms · calls ${Q.calls} · tris ${Q.tris} · programs ${Q.programs} · geo ${Q.geo} · tex ${Q.tex}`),window.__perfInfo={fps:Z,...Q}),Z=0,ze=m);let[g,v,b]=k;if(M.uniforms.uPrev.value=g.texture,M.uniforms.uCurr.value=v.texture,i.setRenderTarget(b),i.render(A,j),k=[v,b,g],z.uniforms.uHeight.value=k[1].texture,Ve<2&&typeof document<`u`&&++Ve===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function nt(e){J=e,window.__mode=J}function rt(){return Y=!Y,ye.value=+!!Y,window.__vector=Y,Y}function at(e){return Y=!!e,ye.value=+!!Y,window.__vector=Y,Y}function ot(){return X=Le[(Le.indexOf(X)+1)%Le.length],window.__era=X,qe(),X}function st(){return Pe=!Pe,Pe}return{updateWorld:tt,decideStyle:Ze,renderCityPipeline:Xe,renderCityBeautyTo:Ye,styleHintName:et,setPostMode:nt,toggleVector:rt,setVector:at,cycleEra:ot,togglePalette:st,get mode(){return J},get vector(){return Y},get sceneEra(){return X},renderer:i,drawBuffer:s,scene:c,rig:C,sunRig:w,SIM:256,targets:k,simScene:A,simCamera:j,simMaterial:M,grabRT:N,card:I,backdrop:te,WATER_SIZE:28,water:B,waterMaterial:z,windowGlow:H,landmarkFactory:U,city:W,cityLife:re,waterLife:ae,weatherRig:G,clouds:oe,fitShadowFrustum:K,SHADOW_DIST:24,sceneDepth:se,sceneRT:ce,filmicRT:le,toonRT:ue,pixelRT:de,postScene:fe,postCamera:pe,postQuad:me,filmicMaterial:q,pixelMaterial:De,pixelkitMaterial:Oe,toonMaterial:Ae,mixMaterial:je,PALCACHE:_e,ERA_TEX:ke,runPass:Me,OVERCAST_GREY:l,FOG_DENSITY:h,FOG_NIGHT_TINT:_,_fogColor:y,resize:Ne}}var Yt=[`video/mp4;codecs=avc1.42E01E`,`video/mp4`,`video/webm;codecs=vp9`,`video/webm`];function Xt({renderer:e,rig:t,sunRig:n,poke:r,getState:i,office:a={}}){let o=e.domElement,s=new URLSearchParams(window.location.search),c=e=>{let t=i();return`lgr-${t.lesson}-${String(t.clock||``).replace(`:`,``)}-${t.style}.${e}`},l=(e,t)=>{let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,document.body.appendChild(r),r.click(),r.remove(),setTimeout(()=>URL.revokeObjectURL(n),1e3)};function u(){o.toBlob(e=>{e&&(l(e,c(`png`)),window.__lastStill=e.size)},`image/png`)}let d=()=>Yt.find(e=>window.MediaRecorder&&MediaRecorder.isTypeSupported(e))||``,f=Zt(),p=null,m=[],h=!1;function g(){if(h)return;let e=d(),t=o.captureStream(60);p=new MediaRecorder(t,e?{mimeType:e,videoBitsPerSecond:12e6}:{}),m=[],p.ondataavailable=e=>{e.data&&e.data.size&&m.push(e.data)},p.onstop=()=>{let e=new Blob(m,{type:p.mimeType});l(e,c(p.mimeType.includes(`mp4`)?`mp4`:`webm`)),window.__lastVideo=e.size},p.start(),h=!0,window.__recording=!0,f.show()}function _(){h&&(p.stop(),h=!1,window.__recording=!1,f.hide())}let v=()=>h?_():g(),y=e=>new Promise(t=>setTimeout(t,e)),b=e=>window.dispatchEvent(new KeyboardEvent(`keydown`,{key:e}));async function x(){let e=o.clientWidth,t=o.clientHeight,n=e*.26,i=t*.74;for(let t=0;t<=10;t++)r.at(n+t*e*.028,i+Math.sin(t*.7)*16),await y(100);r.stop()}async function S(e){if(e.keys)for(let t of e.keys)b(t),await y(70);e.zoom&&t.zoomBy(e.zoom),e.orbit&&t.orbit(e.orbit[0],e.orbit[1]),e.timeTo!==void 0&&n.goTo(e.timeTo),e.office&&a[e.office]?.(),e.ripple&&await x(),e.waitMs&&await y(e.waitMs)}let C={tour:[{keys:[`6`,`0`],waitMs:600},{zoom:.72,waitMs:1700},{ripple:!0,waitMs:2400},{orbit:[.55,0],waitMs:1700},{timeTo:0,waitMs:3e3},{timeTo:.5,waitMs:1500},{keys:[`7`],waitMs:1e3},{zoom:1.5,waitMs:1400},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`8`],waitMs:900},{zoom:.65,waitMs:1200},{ripple:!0,waitMs:2600},{keys:[`7`],waitMs:700},{keys:[`B`],waitMs:300},{keys:[`B`],waitMs:900},{zoom:1.4,waitMs:2600}],daycycle:[{keys:[`6`,`0`],waitMs:700},{timeTo:.75,waitMs:2600},{timeTo:1,waitMs:2600},{timeTo:1.25,waitMs:2600},{timeTo:1.5,waitMs:2600},{timeTo:1.5,waitMs:800}],office:[{keys:[`o`],waitMs:1700},{office:`pet`,waitMs:1300},{office:`feed`,waitMs:1700},{office:`travel`,waitMs:1700},{keys:[`W`,`W`,`W`],waitMs:1800},{timeTo:0,waitMs:2400},{office:`laptop`,waitMs:800},{office:`closeLaptop`,waitMs:300},{timeTo:.5,waitMs:900},{keys:[`W`],waitMs:200},{keys:[`o`],waitMs:1500}],cities:[{keys:[`6`,`0`],waitMs:500},{timeTo:.78,waitMs:2800},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:2e3}],water:[{keys:[`6`,`0`],waitMs:600},{zoom:1.35,waitMs:2800},{orbit:[.7,0],waitMs:2600},{ripple:!0,waitMs:2200},{timeTo:0,waitMs:3200},{timeTo:.5,waitMs:1500},{orbit:[-.5,0],waitMs:2200}],morph:[{keys:[`6`,`3`],waitMs:700},{zoom:.55,waitMs:1800},{zoom:2.3,waitMs:1700},{zoom:1.26,waitMs:1700},{zoom:1.16,waitMs:1900},{zoom:.3,waitMs:2200}],skin:[{keys:[`o`],waitMs:1800},{keys:[`j`],waitMs:2e3},{keys:[`j`],waitMs:2e3},{timeTo:0,waitMs:2600},{timeTo:.5,waitMs:1500},{keys:[`u`],waitMs:2e3},{keys:[`j`],waitMs:1400},{keys:[`o`],waitMs:1500}]};async function w(e){let t=C[e];if(t){window.__director=e;for(let e of t)await S(e);window.__director=null}}async function T(e){await y(1600),g(),await w(e),await y(400),_(),window.__captureDone=!0}window.addEventListener(`keydown`,e=>{(e.key===`s`||e.key===`S`)&&u(),(e.key===`r`||e.key===`R`)&&v()});let E=s.get(`capture`);return E&&C[E]&&T(E),window.__capture={still:u,toggleRec:v,run:w,sequences:Object.keys(C)},window.__capture}function Zt(){let e=document.createElement(`div`);return e.textContent=`● REC`,e.style.cssText=`position:fixed;top:14px;right:16px;z-index:2;font:bold 12px ui-monospace,monospace;color:#ff3b30;letter-spacing:.12em;text-shadow:0 1px 3px #000;display:none;`,document.body.appendChild(e),{show:()=>{e.style.display=`block`},hide:()=>{e.style.display=`none`}}}var Qt=`
...
`;function $t({controls:e,state:t,show:n,coarse:r}){if(typeof document>`u`)return;let i=document.createElement(`style`);i.textContent=Qt,document.head.appendChild(i);let a=document.createElement(`div`);a.className=`vui`;let o=document.createElement(`div`);o.className=`vui-info`,o.innerHTML=`KEYS · 4/5/6 cam · 0 vector · 7/8 pixel/toon · B era · T time · [ ] scrub · 9 auto · C city · G shuffle · W weather · K season · click a building / O office · J office skin · U painted props · Esc exit · M hide UI · S still · R rec · H shadows · P theme · drag water to ripple`;let s=(e,t,n)=>{let r=document.createElement(`button`);return r.textContent=e,n&&(r.title=n),r.addEventListener(`click`,e=>{navigator.vibrate?.(10),t(e)}),r},c=e=>{let t=document.createElement(`div`);return t.className=`seg`,{seg:t,btns:e.map(([n,r])=>{let i=s(n,()=>e.find(e=>e[1]===r)[2](),n);return i.dataset.val=r,t.appendChild(i),i})}},l=s(`City`,()=>e.city(),`Next city profile (C)`),u=s(`Shuffle`,()=>e.shuffle(),`New random seed (G)`),d={clear:`Clear`,rain:`Rain`,snow:`Snow`,fog:`Fog`},f=[`Spring`,`Summer`,`Autumn`,`Winter`],p=s(`Clear`,()=>e.weather(),`Cycle weather: clear→rain→snow→fog (W)`),m=s(`Spring`,()=>e.season(),`Cycle season: spring→summer→autumn→winter (K)`),h=s(`Office`,()=>e.office(),`Dive into / exit the office (O · Esc)`),g={"3d":`3D`,smooth:`Smooth`,charm:`Charm`},_=s(`Skin`,()=>e.officeSkin(),`Office look: 3D → smooth → charm diffusion (J)`),v={painted:`Painted`,"3d":`Live 3D`},y=s(`Props`,()=>e.officeProps(),`Office props: painted (cohesive) ↔ live 3D (animated) — under a skin (U)`),b=c([[`Auto`,`auto`,()=>e.style(`auto`)],[`Vector`,`vector`,()=>e.style(`vector`)],[`Pixel`,`pixel`,()=>e.style(`pixel`)],[`Toon`,`toon`,()=>e.style(`toon`)]]);b.btns[0].title=`AUTO: zoom morphs the style (toon → 16-bit → 8-bit → Game Boy)`;let x={native:`Era`,gb:`GB`,"8-bit":`8-bit`,"16-bit":`16-bit`,modern:`Modern`,"1-bit":`1-bit`},S=s(`Era`,()=>e.era(),`Cycle the pixel era (B): native → GB → 8-bit → 16-bit → Modern`),C=document.createElement(`input`);C.type=`range`,C.min=`0`,C.max=`1`,C.step=`0.01`,C.title=`Time of day`;let w=!1;C.addEventListener(`pointerdown`,()=>{w=!0}),C.addEventListener(`pointerup`,()=>{w=!1}),C.addEventListener(`input`,()=>e.time(parseFloat(C.value)));let T=s(`▶`,()=>e.auto(),`Play/pause day cycle (9)`),E=document.createElement(`div`);E.style.cssText=`display:flex;align-items:center;gap:6px;`;let D=document.createElement(`span`);D.className=`lbl`,D.textContent=`Day`,E.append(D,C,T);let O=c([[`Iso`,`iso`,()=>e.cam(`iso`)],[`Dim`,`dimetric`,()=>e.cam(`dimetric`)],[`3D`,`persp`,()=>e.cam(`persp`)]]),k=s(`ⓘ`,()=>o.classList.toggle(`open`),`All keys`),A=s(`⌄`,()=>L(!0),`Hide controls — watch unobstructed (M)`),j=document.createElement(`div`);j.className=`vui-more`;let M=s(`More`,()=>j.classList.toggle(`open`),`More controls`);if(r){a.append(l,u,h,T,b.seg,M,A);let e=document.createElement(`div`);e.style.cssText=`display:flex;align-items:center;gap:6px;`,e.append(D,C),j.append(p,m,_,y,S,O.seg,e)}else a.append(l,u,H(),p,m,h,_,y,H(),b.seg,S,H(),E,H(),O.seg,k,H(),A);let N=document.createElement(`button`);N.className=`vui-show`,N.innerHTML=`⌃ Controls`,N.title=`Show controls (M)`,N.addEventListener(`click`,()=>L(!1));let P=document.createElement(`div`);P.className=`vui-style`,document.body.append(o,j,a,N,P);let ee=n,F=!1;L(r);function I(){let e=t();b.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===e.style)),O.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===e.cam)),p.textContent=d[e.weather]||`Clear`,p.classList.toggle(`on`,e.weather!==`clear`),m.textContent=f[e.season]||`Spring`,m.classList.toggle(`on`,(e.season||0)>0),h.textContent=e.office?`Exit`:`Office`,h.classList.toggle(`on`,!!e.office),_.textContent=g[e.officeSkin]||`Skin`,_.classList.toggle(`on`,e.officeSkin&&e.officeSkin!==`3d`),y.textContent=v[e.officeProps]||`Props`,y.classList.toggle(`on`,e.officeProps===`painted`&&e.officeSkin&&e.officeSkin!==`3d`),T.textContent=e.auto?`❚❚`:`▶`,T.classList.toggle(`on`,e.auto),S.textContent=x[e.era]||`Era`,S.classList.toggle(`on`,e.era&&e.era!==`native`),w||(C.value=String(e.t))}I();let te=setInterval(I,200);function L(e){if(!ee){a.style.display=`none`,N.classList.remove(`on`),o.classList.remove(`open`),j.classList.remove(`open`),P.classList.remove(`on`);return}F=e,a.style.display=e?`none`:`flex`,N.classList.toggle(`on`,e),e&&(o.classList.remove(`open`),j.classList.remove(`open`),P.classList.remove(`on`))}function R(){L(!F)}let z=null,B=null;function V(e){if(!ee||F){P.classList.remove(`on`),z=null;return}if(!e){P.classList.remove(`on`),z=``;return}e!==z&&(z=e,P.textContent=e,P.classList.add(`on`),clearTimeout(B),B=setTimeout(()=>P.classList.remove(`on`),2e3))}return{toggle:R,setHidden:L,refresh:I,setStyleHint:V,destroy(){clearInterval(te),a.remove(),o.remove(),j.remove(),N.remove(),P.remove(),i.remove(),clearTimeout(B)}};function H(){let e=document.createElement(`div`);return e.className=`sep`,e}}var en=`lgr_hints_`,tn=!1;function nn(){if(tn||typeof document>`u`)return;tn=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var an=`precision highp float;
...
void main() {
  ...
  gl_FragColor = vec4(col, 1.0);
}`;export{Jt as a,Ut as c,jt as d,X as f,K as h,Xt as i,Wt as l,J as m,rn as n,Bt as o,Fe as p,$t as r,Ht as s,an as t,zt as u};