import{A as e,B as t,C as n,D as r,E as i,G as a,H as o,I as s,J as c,K as l,L as u,M as d,N as f,O as p,P as m,Q as h,R as g,T as _,U as v,V as y,W as b,X as x,Y as S,_ as C,_t as w,b as T,bt as E,c as D,ct as O,d as ee,dt as te,et as k,f as ne,ft as A,g as j,ht as M,i as N,j as P,k as F,l as re,lt as I,m as ie,mt as L,n as ae,nt as R,o as z,p as oe,q as B,r as se,rt as ce,s as V,st as H,t as U,tt as le,u as ue,ut as de,v as fe,w as pe,x as me,xt as W,y as he,yt as G,z as ge}from"./three-fptASJPj.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var _e=(e,t,n,r)=>e+(t-e)*(1-Math.exp(-n*r)),ve=(e,t,n)=>e<t?t:e>n?n:e,ye=Math.atan(1/Math.SQRT2),K=Math.atan(.5),q=Math.PI/4,J={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},Y=8,be=.12,xe=1.45,Se=4,Ce=40,we=1.5,Te=16,Ee=6,De=22,Oe=3.5,ke=11,X=(e,t,n)=>_e(e,t,Y,n),Ae=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function je({aspect:e,fov:n=48,near:r=.1,far:i=100,target:a=new E(0,.8,0),azimuth:o=q,elevation:s=.52,distance:l=12,zoom:u=5.5}={}){let d=new x(n,e,r,i),f=new c(-1,1,1,-1,r,i),p=J.PERSPECTIVE,m=e,h={azimuth:o,elevation:s,distance:l,zoom:u,target:a.clone()},g={azimuth:o,elevation:s,distance:l,zoom:u,target:a.clone()},_=!1,v=null,y=new E,b=()=>p===J.PERSPECTIVE?d:f;function S(e){e!==p&&(p=e,p===J.ISOMETRIC||p===J.DIMETRIC?(h.elevation=p===J.ISOMETRIC?ye:K,h.azimuth=Ae(q,g.azimuth),_=!0):_=!1)}function C(e,n){h.azimuth+=e,_||(h.elevation=t.clamp(h.elevation+n,be,xe))}function w(e){p===J.PERSPECTIVE?h.distance=t.clamp(h.distance*e,Se,Ce):h.zoom=t.clamp(h.zoom*e,we,Te)}function T(e,t){let n=h.azimuth,r=p===J.PERSPECTIVE?h.distance*.04:h.zoom*.08,i=new E(Math.cos(n),0,-Math.sin(n)),a=new E(-Math.sin(n),0,-Math.cos(n));h.target.addScaledVector(i,e*r),h.target.addScaledVector(a,t*r)}function D(e,t){m=e/t,d.aspect=m,d.updateProjectionMatrix()}function O(e){v&&(v(y),h.target.copy(y)),g.azimuth=X(g.azimuth,h.azimuth,e),g.elevation=X(g.elevation,h.elevation,e),g.distance=X(g.distance,h.distance,e),g.zoom=X(g.zoom,h.zoom,e),g.target.x=X(g.target.x,h.target.x,e),g.target.y=X(g.target.y,h.target.y,e),g.target.z=X(g.target.z,h.target.z,e);let t=Math.cos(g.elevation),n=Math.sin(g.elevation),r=Math.cos(g.azimuth),i=Math.sin(g.azimuth),a=b();if(a.position.set(g.target.x+g.distance*t*i,g.target.y+g.distance*n,g.target.z+g.distance*t*r),a.lookAt(g.target),a.isOrthographicCamera){let e=g.zoom,t=e*m;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function ee(e,t,n,r=!1){h.target.set(e,t,n),r&&g.target.copy(h.target)}function te(e,n=!1){h.zoom=t.clamp(e,we,Te),n&&(g.zoom=h.zoom)}function k(e,t=!1){h.azimuth=Ae(e,g.azimuth),t&&(g.azimuth=h.azimuth)}function ne(e,n=!1){h.elevation=t.clamp(e,be,xe),n&&(g.elevation=h.elevation)}function A(e,{frame:n,snap:r=!1}={}){v=e,r&&(v(y),h.target.copy(y),g.target.copy(y)),n!=null&&(p===J.PERSPECTIVE?h.distance=t.clamp(n,Se,Ce):h.zoom=t.clamp(n,we,Te))}function j(){v=null}return{get camera(){return b()},get mode(){return p},get azimuth(){return g.azimuth},get following(){return!!v},setTarget:ee,setZoom:te,setFollow:A,clearFollow:j,setAzimuth:k,setElevation:ne,get styleT(){return p===J.PERSPECTIVE?t.clamp((g.distance-Ee)/(De-Ee),0,1):t.clamp((g.zoom-Oe)/(ke-Oe),0,1)},setMode:S,orbit:C,zoomBy:w,pan:T,setViewport:D,update:O}}var Me={value:0},Ne=new j(`#ffffff`),Pe={value:0},Fe={value:0},Ie={value:0},Le=new G,Re={value:0},ze={value:0},Be=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
void main() {
  ...
  gl_FragColor = vec4(st.x, Snew, 0.0, 0.0);
}`;function Pn({renderer:e,N:t,cell:n,half:r,worldSize:o,seaY:s=0,FLOW:u,DAMP:d,MIN_DEPTH:f,KC:p,KE:m,KD:g,KADV:_,MAXD:y,readTerrain:b}){let x=e.getContext();if(!(x&&x.getExtension&&x.getExtension(`EXT_color_buffer_float`)))return typeof console<`u`&&console.warn(`[L87] EXT_color_buffer_float unavailable — GPU flow backend cannot run; staying on CPU.`),null;let S={type:i,format:ce,minFilter:l,magFilter:l,wrapS:ie,wrapT:ie,depthBuffer:!1,stencilBuffer:!1},C=[new W(t,t,S),new W(t,t,S)],w=[new W(t,t,S),new W(t,t,S)],T=[new W(t,t,S),new W(t,t,S)],ee=new Float32Array(t*t*4),k=new he(ee,t,t,ce,i);k.minFilter=l,k.magFilter=l,k.wrapS=k.wrapT=ie;let ne=new Float32Array(t*t),A=!1,M=1,N=!0,P=new O,F=new c(-1,1,1,-1,0,1),L=new v(new h(2,2),null);L.frustumCulled=!1,P.add(L);let ae=new G(1/t,1/t),R=(e,t)=>new I({vertexShader:En,fragmentShader:e,uniforms:t}),z=R(Dn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uFlow:{value:u},uDamp:{value:d}}),oe=R(On,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uSeaY:{value:s}}),B=R(kn,{uState:{value:null},uTerr:{value:null},uN:{value:t},uSeaY:{value:s},uRain:{value:0},uPourCount:{value:0},uPours:{value:Array.from({length:8},()=>new E)},uPourR:{value:new Float32Array(8)}}),se=R(An,{uSrc:{value:k}}),V=()=>({uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uCell:{value:n},uSeaY:{value:s},uKC:{value:p},uKE:{value:m},uKD:{value:g},uMaxD:{value:y},uMinDepth:{value:f},uErosK:{value:M}}),H=R(jn,V()),U=R(Mn,V()),le=R(Nn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uSeaY:{value:s},uKADV:{value:_}});function ue(t,n){L.material=t;let r=e.getRenderTarget();e.setRenderTarget(n),e.render(P,F),e.setRenderTarget(r)}let de=new j;function fe(t){let n=e.getRenderTarget(),r=e.getClearAlpha();e.getClearColor(de),e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1),e.setClearColor(de,r),e.setRenderTarget(n)}function pe(){b(ne);for(let e=0;e<t*t;e++)ee[e*4]=ne[e];k.needsUpdate=!0,ue(se,T[0])}function me(){fe(C[0]),fe(C[1]),fe(w[0]),fe(w[1])}me();let ge=t*t,_e=new Float32Array(ge*3),ve=new Float32Array(ge*2);for(let e=0;e<t;e++)for(let i=0;i<t;i++){let a=e*t+i;_e[a*3]=i*n-r,_e[a*3+1]=0,_e[a*3+2]=e*n-r,ve[a*2]=(i+.5)/t,ve[a*2+1]=(e+.5)/t}let ye=[];for(let e=0;e<t-1;e++)for(let n=0;n<t-1;n++){let r=e*t+n,i=e*t+n+1,a=(e+1)*t+n,o=(e+1)*t+n+1;ye.push(r,a,i,i,a,o)}let K=new re;K.setAttribute(`position`,new D(_e,3)),K.setAttribute(`aGridUv`,new D(ve,2)),K.setIndex(ye),K.boundingSphere=new te(new E(0,0,0),o);let q={uStateTex:{value:C[0].texture},uTerrTex:{value:T[0].texture},uMinDepth:{value:f}},J=new a({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});J.onBeforeCompile=e=>{e.uniforms.uStateTex=q.uStateTex,e.uniforms.uTerrTex=q.uTerrTex,e.uniforms.uMinDepth=q.uMinDepth,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,_i={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},vi=[`gb`,`8-bit`,`16-bit`,`modern`],yi={"ink-gold (day)":[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],"ink-gold (night)":[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],"terminal (day)":[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],"terminal (night)":[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],"neutral (photoreal)":[`#1B1B1E`,`#3D3A3A`,`#5E5750`,`#867C70`,`#A99C8A`,`#C8BCAB`,`#E3DCCF`,`#F5F1E8`],"cool (noir)":[`#0A0E14`,`#16202E`,`#243447`,`#3A536B`,`#5A7D96`,`#86A6BD`,`#B6CDDA`,`#E6EEF2`],"warm (sunset)":[`#190B0A`,`#3B150F`,`#6E2A17`,`#A8421F`,`#DB702F`,`#F2A23E`,`#F9CF76`,`#FDF0C4`],"vibrant (pop)":[`#1A1A2E`,`#E43F5A`,`#F9A826`,`#FFE05D`,`#2EC4B6`,`#3A86FF`,`#8338EC`,`#FFFFFF`],"mono (ink)":[`#0C0C0C`,`#2A2A2A`,`#474747`,`#666666`,`#8A8A8A`,`#B0B0B0`,`#D6D6D6`,`#F5F5F5`]};function bi(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new j(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new he(n,t,1,ce,i);return r.minFilter=l,r.magFilter=l,r.needsUpdate=!0,r}function xi(e,t){let n=[];for(let t=0;t+2<e.length;t+=3)n.push([e[t],e[t+1],e[t+2]]);if(n.length===0)return[`#000000`];let r=e=>{let t=[255,255,255],n=[0,0,0];for(let r of e)for(let e=0;e<3;e++)t[e]=Math.min(t[e],r[e]),n[e]=Math.max(n[e],r[e]);let r=[n[0]-t[0],n[1]-t[1],n[2]-t[2]],i=r[0]>=r[1]&&r[0]>=r[2]?0:r[1]>=r[2]?1:2;return{ax:i,range:r[i]}},i=[n];for(;i.length<t;){let e=-1,t=-1;if(i.forEach((n,i)=>{if(n.length>1){let{range:a}=r(n);a>t&&(t=a,e=i)}}),e<0)break;let n=i[e],{ax:a}=r(n);n.sort((e,t)=>e[a]-t[a]);let o=n.length>>1;i.splice(e,1,n.slice(0,o),n.slice(o))}return i.map(e=>{let t=[0,0,0];for(let n of e)for(let e=0;e<3;e++)t[e]+=n[e];return`#`+t.map(t=>Math.round(t/e.length)).map(e=>e.toString(16).padStart(2,`0`)).join(``)})}var Si=220,Ci={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},wi={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Ti({demo:e=!1,citySeed:n=0,profileIndex:i=0}={}){let o=new N({antialias:!0,preserveDrawingBuffer:!0});o.shadowMap.enabled=!0,o.shadowMap.type=1,o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0;let s=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches?1.5:2;o.setPixelRatio(Math.min(window.devicePixelRatio,s)),o.setSize(window.innerWidth,window.innerHeight),o.setClearColor(920327,1),document.body.appendChild(o.domElement);let u=o.getDrawingBufferSize(new G),d=!1,f=!1,p=()=>{};o.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),d=!0,typeof window<`u`&&(window.__contextLost=!0)},!1),o.domElement.addEventListener(`webglcontextrestored`,()=>{p(),d=!1,typeof window<`u`&&(window.__contextLost=!1)},!1);let m=new O;m.fog=new r(10465470,0);let _=new j(`#aeb6c0`),x=.062,S=new j(`#74508f`),C=new j,w=je({aspect:window.innerWidth/window.innerHeight}),D=vt({t:.5}),ee={type:F,format:ce,minFilter:l,magFilter:l,wrapS:ie,wrapT:ie,depthBuffer:!1,stencilBuffer:!1},te=[new W(256,256,ee),new W(256,256,ee),new W(256,256,ee)];for(let e of te)o.setRenderTarget(e),o.clear();o.setRenderTarget(null);let k=new O,ne=new c(-1,1,1,-1,0,1),A=new I({vertexShader:En,fragmentShader:si,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new G(1/256,1/256)},uMouse:{value:new G(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new E)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new E)}}});k.add(new v(new h(2,2),A));let M=new W(u.x,u.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1});function P(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new ue(t);return r.colorSpace=H,r}let re=new v(new h(28,28),new b({map:P(e)}));re.rotation.x=-Math.PI/2,re.position.y=-.35,m.add(re);let L=new v(new h(40,24),new I({depthWrite:!1,vertexShader:ai,fragmentShader:oi,uniforms:{uTime:{value:0},uInk:{value:D.horizon},uGold:{value:D.sky},uFogColor:{value:C},uFogAmt:{value:0},uFogCharm:Re}}));L.position.set(0,3,-8),m.add(L);let ae=new I({vertexShader:ci,fragmentShader:li,uniforms:{uHeight:{value:null},uScene:{value:M.texture},uTexel:{value:new G(1/256,1/256)},uResolution:{value:new G(u.x,u.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new y},uLightDir:{value:D.sunDir},uInk:{value:new j(`#2A2218`)},uGold:{value:new j(`#B89968`)},uVector:Me,uVecWater:{value:new j(`#1fb8d8`)},uVecTint:{value:Ne}}}),R=new v(new h(28,28,255,255),ae);R.rotation.x=-Math.PI/2,R.updateMatrixWorld(!0),ae.uniforms.uNormalMatrix.value.getNormalMatrix(R.matrixWorld),m.add(R);let z={value:0},oe=Gt({windowGlow:z}),B=ut({seed:n,profileIndex:i,landmarkFactory:oe,windowGlow:z});m.add(B.group);let se=Ct({plinthTop:.3,extent:B.extent,profile:B.state.profile});m.add(se.group);let V=Pt({extent:B.extent,waterSize:28,plinthTop:.3});m.add(V.group),A.uniforms.uWakeDrops.value=V.wakeDrops;let U=qt({extent:B.extent});m.add(U.group),A.uniforms.uRainDrops.value=U.rainDrops;let le=Yt({extent:B.extent});m.add(le.group);let de=[se,V,le],fe=Qt({rig:w,getCamera:()=>w.camera,sources:de}),pe=ii();m.add(pe.group);let me=Br({scale:90});m.add(me.mesh),m.environmentIntensity=.32;let he=!1;function ge(e){let t=e&&D.sunArc.y>-.04;t!==he&&(he=t,me.mesh.visible=t,L.visible=!t)}let _e=null,ve=-1;p=()=>{_e=null,ve=-1,o.shadowMap.needsUpdate=!0};function ye(){let e=Math.floor(D.t%1*4)%4;return(e!==ve||!_e)&&(ve=e,_e=me.buildEnv(o)),_e}let K=null,q=null,J=null,Y=null,be=!1,xe=1234,Se=`valley`,Ce=Xn.map(e=>e.key),we=new a({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Te=()=>[B.group,se.group,V.group],Ee=()=>[K,q,J].filter(Boolean);function De(){for(let e of Ee())m.remove(e),e.userData.dispose?.();let e=tr({seed:xe,size:160,preset:Se});Y=e,K=cr(e,{worldSize:26,baseY:0,chunks:6}),q=Nr({terrain:e,seed:xe,worldSize:26,baseY:0,biomeKeys:Ce}),J=Ir(e,{worldSize:26,baseY:0,maxLakes:3,material:we});for(let e of Ee())e.visible=be,m.add(e);X!==void 0&&X&&X.clear(),He!==void 0&&He&&He.clear(),typeof window<`u`&&(window.__world={seed:xe,preset:Se,active:be,chunks:K.children.length,scatter:q.userData.counts,lakes:J.userData.count})}let Oe=e=>{for(let t of Ee())t.visible=e};function ke(e,t){if(!Y)return 0;let{size:n,height:r,sea:i,relief:a}=Y,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let X=wn({heightAt:ke,seaSurfaceY:0,waterY:.06});X.group.visible=!1,m.add(X.group),de.push(X);let Ae=0;function Be(e,t){if(!Y||!K)return;let{size:n,height:r,relief:i}=Y,a=26/(n-1),o=26/(t-1),s=i>1e-6?1/i:0,c=!1;for(let i=0;i<t;i++)for(let l=0;l<t;l++){let u=e[i*t+l];if(u===0)continue;c=!0;let d=u*s,f=l*o/a,p=i*o/a,m=Math.max(0,Math.round(f-1)),h=Math.min(n-1,Math.round(f+1)),g=Math.max(0,Math.round(p-1)),_=Math.min(n-1,Math.round(p+1));for(let e=g;e<=_;e++)for(let t=m;t<=h;t++){let i=e*n+t,a=r[i]+d;r[i]=a<0?0:a>1?1:a}}c&&(Ae++,Ae%8==0&&lr(K,Y,K.children),Ae%24==0&&q&&Mr(q,Y,{worldSize:26,baseY:0}))}function Ve(e,t){if(!Y||!K)return;let{size:n,height:r,relief:i}=Y,a=i>1e-6?1/i:0,o=(t-1)/(n-1),s=!1;for(let i=0;i<n;i++){let c=i*o,l=Math.floor(c),u=c-l,d=Math.min(t-1,l+1);for(let c=0;c<n;c++){let f=c*o,p=Math.floor(f),m=f-p,h=Math.min(t-1,p+1),g=e[l*t+p],_=e[l*t+h],v=e[d*t+p],y=e[d*t+h],b=(g*(1-m)+_*m)*(1-u)+(v*(1-m)+y*m)*u;if(b!==0){s=!0;let e=i*n+c,t=r[e]+b*a;r[e]=t<0?0:t>1?1:t}}}s&&(lr(K,Y,K.children),q&&Mr(q,Y,{worldSize:26,baseY:0}))}let He=Fn({worldHeightAt:ke,applyErosion:Be,syncErodedTerrain:Ve,worldSize:26,grid:96,seaY:0,renderer:o});He.group.visible=!1,m.add(He.group);let Ue=null,We=new Set;function Ge(){!Y||!J||(m.remove(J),J.userData.dispose?.(),J=Ir(Y,{worldSize:26,baseY:0,maxLakes:3,material:we}),J.visible=be,m.add(J),window.__world&&(window.__world.lakes=J.userData.count))}function Ke(){Ge(),q&&Mr(q,Y,{worldSize:26,baseY:0})}function Z(e,t,n=1,r=2.2,i=.05){if(!Y||!K)return;let a=Y.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=Y.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}We.clear();for(let e of K.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&We.add(e)}lr(K,Y,We),Ue&&clearTimeout(Ue),Ue=setTimeout(Ke,140)}function Je(e,t,n,r=2.2){if(!Y||!K||n==null)return;let i=Y.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=Y.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);We.clear();for(let e of K.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&We.add(e)}lr(K,Y,We,!0)}let Ye=[`tree`,`rock`,`tuft`];function Xe(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!Y||!q)return 0;if(a)return Ar(q,n||`all`,e,t,i);let o=Y.size,s=26/(o-1),c=Y.height,l=Y.sea,u=Y.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=jr[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;kr(q,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&q.userData.counts)for(let e of Ye)q.userData.counts[e]=(q.userData.placements[e]||[]).length;return g}let Ze=[];function Qe(){if(!q)return null;let e=q.userData.placements,t={};for(let n of Ye)t[n]=(e[n]||[]).map(e=>({...e}));return t}function $e(){Y&&(Ze.push({h:Y.height.slice(),b:Y.biome.slice(),sc:Qe(),pl:X.snapshot()}),Ze.length>12&&Ze.shift())}function et(){if(!Y||!Ze.length)return!1;let e=Ze.pop();if(Y.height.set(e.h),Y.biome.set(e.b),e.sc&&q){let t=q.userData.placements;for(let n of Ye)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&X.restore(e.pl),lr(K,Y,K.children,!0),Ke(),!0}let tt=new Set([`boat`,`fish`]),nt=new Set([`person`,`atv`]);function rt(e,t,n){if(!Y)return null;let r=ke(t,n)<0;return tt.has(e)&&!r||nt.has(e)&&r?null:X.spawn(e,t,n)}function it(e,t,n=2.5){return X.removeNear(e,t,n)}function at(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function ot(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let st=e=>at(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),ct=e=>at(e);function lt(){let e=q?q.userData.placements:{},t={};for(let n of Ye)t[n]=(e[n]||[]).map(e=>({...e}));return t}function dt(){return Y?{v:1,seed:xe,preset:Se,size:Y.size,height:st(Y.height),biome:ct(Y.biome),scatter:lt(),entities:X.snapshot()}:null}function ft(){if(!Y)return null;let e=tr({seed:xe,size:160,preset:Se}),t=Y.height,n=Y.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:xe,preset:Se,hd:r,bd:i,entities:X.snapshot()}}function pt(e){q&&(m.remove(q),q.userData.dispose?.()),q=Tr(e||{tree:[],rock:[],tuft:[]}),q.userData.counts=Ye.reduce((e,t)=>(e[t]=(q.userData.placements[t]||[]).length,e),{}),q.visible=be,m.add(q)}function mt(e){if(!e||e.v!==1)return!1;xe=e.seed|0,Se=er.includes(e.preset)?e.preset:Se,Ze.length=0,De(),be=!0,Oe(!0),X.group.visible=!0,He.group.visible=!0;for(let e of Te())e.visible=!1;if(window.__world&&(window.__world.active=!0),e.height&&e.biome){let t=ot(e.height);Y.height.set(new Float32Array(t.buffer,t.byteOffset,t.byteLength/4));let n=ot(e.biome);Y.biome.set(n.subarray(0,Y.biome.length))}else if(e.hd||e.bd){let t=e.hd||[],n=e.bd||[];for(let e=0;e<t.length;e+=2)Y.height[t[e]]=t[e+1];for(let e=0;e<n.length;e+=2)Y.biome[n[e]]=n[e+1]}return lr(K,Y,K.children,!0),e.scatter&&pt(e.scatter),Ge(),q&&Mr(q,Y,{worldSize:26,baseY:0}),X.restore(e.entities),window.__world&&(window.__world.scatter=q.userData.counts,window.__world.seed=xe,window.__world.preset=Se),!0}let ht={enter(){K||De(),be=!0,Oe(!0),X.group.visible=!0,He.group.visible=!0;for(let e of Te())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){be=!1,Oe(!1),X.group.visible=!1,He.group.visible=!1;for(let e of Te())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return xe=Math.random()*1e9|0,Ze.length=0,De(),ht.enter(),xe},reset(){return Ze.length=0,De(),ht.enter(),xe},setPreset(e){return er.includes(e)&&(Se=e,Ze.length=0,De(),ht.enter()),Se},sculpt:Z,paintBiome:Je,paintScatter:Xe,repoolWater:Ge,snapshot:$e,undo:et,placeEntity:rt,removeEntityNear:it,heightAt:ke,serialize:dt,serializeCompact:ft,deserialize:mt,flowPourAt:(e,t,n,r)=>He.pourAt(e,t,n,r),flowRain:e=>He.rain(e),flowClear:()=>He.clear(),get flowTotal(){return He.totalWater()},flowAt:(e,t)=>He.cellAt(e,t),flowErosion:(e,t)=>He.setErosion(e,t),get flowErosionOn(){return He.erosion},get flowSediment(){return He.totalSediment()},setSimBackend:e=>He.setBackend(e),get simBackend(){return He.backend},_flowReadW:()=>He._debugReadW(),_flowReadTerr:()=>He._debugReadTerr(),_flowStepN:(e,t)=>He._debugStepN(e,t),get terrainGroup(){return K},get biomes(){return Xn},get scatterCounts(){return q?q.userData.placements&&Ye.reduce((e,t)=>(e[t]=(q.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return X.counts()},setScatterHidden(e){q&&(q.visible=!e)},get placedLife(){return X},get canUndo(){return Ze.length>0},get active(){return be},get seed(){return xe},get preset(){return Se},get presets(){return er}},gt=Rr(),_t=Bn({world:ht,catalog:gt,inspector:fe});function yt(e,t){return ke(e,t)<0?0:-999}let bt=dn({rig:w,world:{heightAt:ke,waterHeightAt:yt}});B.group.remove(B.key),m.add(B.key),B.key.castShadow=!0,B.key.shadow.mapSize.set(2048,2048),B.key.shadow.bias=-18e-5,B.key.shadow.normalBias=.028,m.add(B.key.target);function xt(){let e=B.key.shadow.camera,t=B.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),o.shadowMap.needsUpdate=!0}xt();let St=new T(u.x,u.y),wt=new W(u.x,u.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1,depthTexture:St}),Tt=new W(u.x,u.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Et=new W(u.x,u.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1,samples:4}),Dt=new W(u.x,u.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Ot=new W(u.x,u.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),kt=Math.max(1,Math.floor(u.x/2)),At=Math.max(1,Math.floor(u.y/2)),jt=new W(kt,At,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Mt=new W(kt,At,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Nt=new O,Ft=new c(-1,1,1,-1,0,1),It=new v(new h(2,2));Nt.add(It);let Q=new I({vertexShader:En,fragmentShader:ui,uniforms:{uScene:{value:wt.texture},uTime:{value:0},uResolution:{value:new G(u.x,u.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:jt.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:D.grade.tint},uGradeLift:{value:D.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1},uDither:{value:0},uTonemap:{value:0}}}),$=new I({vertexShader:En,fragmentShader:mi,uniforms:{uScene:{value:wt.texture},uThreshold:{value:.78}}}),Lt=new I({vertexShader:En,fragmentShader:hi,uniforms:{uScene:{value:jt.texture},uDir:{value:new G}}});function Rt(e){$.uniforms.uScene.value=e.texture,Xt($,jt),Lt.uniforms.uScene.value=jt.texture,Lt.uniforms.uDir.value.set(1.6/kt,0),Xt(Lt,Mt),Lt.uniforms.uScene.value=Mt.texture,Lt.uniforms.uDir.value.set(0,1.6/At),Xt(Lt,jt),Q.uniforms.uBloom.value=jt.texture;let n=1-t.clamp(D.sunArc.y*2.2,0,1);Q.uniforms.uBloomStrength.value=.85*(.32+.95*n)}let zt=e=>{let t=e.map(e=>new j(e));for(;t.length<8;)t.push(new j(0,0,0));return t},Bt=[`night`,`dawn`,`noon`,`dusk`],Vt={inkgold:Bt.map(e=>zt(Ci[e])),terminal:Bt.map(e=>zt(wi[e]))},Ht=new I({vertexShader:En,fragmentShader:di,uniforms:{uScene:{value:Tt.texture},uResolution:{value:new G(u.x,u.y)},uPixelSize:{value:Si},uPalette:{value:Vt.inkgold[2]},uPaletteB:{value:Vt.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),Ut=new I({vertexShader:En,fragmentShader:gi,uniforms:{uScene:{value:Tt.texture},uResolution:{value:new G(u.x,u.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:bi(_i[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Wt={};for(let e of vi)Wt[e]=_i[e].palette?bi(_i[e].palette):null;let Kt=new I({vertexShader:En,fragmentShader:fi,uniforms:{uScene:{value:Tt.texture},uDepth:{value:St},uResolution:{value:new G(u.x,u.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:D.toonFloor},uOutline:{value:D.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Jt=new I({vertexShader:En,fragmentShader:pi,uniforms:{uToon:{value:Dt.texture},uPixel:{value:Ot.texture},uBlend:{value:0}}});function Xt(e,t){It.material=e,o.setRenderTarget(t),o.render(Nt,Ft)}function Zt(){w.setViewport(window.innerWidth,window.innerHeight),o.setSize(window.innerWidth,window.innerHeight);let e=o.getDrawingBufferSize(new G);return M.setSize(e.x,e.y),wt.setSize(e.x,e.y),Tt.setSize(e.x,e.y),Et.setSize(e.x,e.y),Dt.setSize(e.x,e.y),Ot.setSize(e.x,e.y),kt=Math.max(1,e.x>>1),At=Math.max(1,e.y>>1),jt.setSize(kt,At),Mt.setSize(kt,At),ae.uniforms.uResolution.value.set(e.x,e.y),Q.uniforms.uResolution.value.set(e.x,e.y),Ht.uniforms.uResolution.value.set(e.x,e.y),Ut.uniforms.uResolution.value.set(e.x,e.y),Kt.uniforms.uResolution.value.set(e.x,e.y),e}let $t=Un({renderer:o}),en=!0;function tn(e,t){let n=t.dpr==null?s:t.dpr,r=Math.min(window.devicePixelRatio,n);Math.abs(o.getPixelRatio()-r)>.001&&(o.setPixelRatio(r),typeof window<`u`&&window.dispatchEvent?window.dispatchEvent(new Event(`resize`)):Zt()),en=t.shadows!==!1,en||(o.shadowMap.needsUpdate=!1)}let nn=Gn({profiler:$t,apply:tn});function rn(){!f&&!d&&$t.frameStart()}function an(){f||d||($t.frameEnd(),nn.update())}function on(e){f=!e,typeof window<`u`&&(window.__paused=f)}function sn(){try{o.compile(m,w.camera),jn(1/60,0,{shadowsOn:!0}),Dn(On(),wt),o.setRenderTarget(null)}catch(e){typeof console<`u`&&console.warn(`[L79] prewarm`,e)}}let cn=3,ln=!1,un=!1,fn=`native`,pn=.3,mn=.46,hn=[`native`,...vi],gn={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=cn,window.__vector=ln,window.__era=fn),typeof window<`u`&&(window.__frames=0),typeof window<`u`&&(window.__loaded=!1);let _n=0,vn=new E(1,1,1),yn=!1;function bn(e){let t=un?Vt.terminal:Vt.inkgold,n=e%1*4,r=Math.floor(n)%4;Ht.uniforms.uPalette.value=t[r],Ht.uniforms.uPaletteB.value=t[(r+1)%4],Ht.uniforms.uPaletteBlend.value=n-Math.floor(n)}function xn(e){let t=_i[e];t&&(Ut.uniforms.uGridWidth.value=t.gridWidth,Ut.uniforms.uDither.value=t.dither,Ut.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(Ut.uniforms.uPalette.value=Wt[e],Ut.uniforms.uPaletteSize.value=t.palette.length))}function Sn(){fn!==`native`&&xn(fn)}let Cn=()=>fn===`native`?Ht:Ut;function Tn(e,t){ge(!0),m.environment=ye(),qe.value=1,R.visible=!1,o.setRenderTarget(M),o.render(m,e),R.visible=!0,o.setRenderTarget(Et),o.render(m,e),Rt(Et),Q.uniforms.uScene.value=Et.texture,Q.uniforms.uAces.value=1,Q.uniforms.uGrade.value=1,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=1,Xt(Q,t)}function Dn(e,t){let n=!ln&&(cn===1||cn===2);if(ge(n),m.environment=n?ye():null,qe.value=+!!n,Q.uniforms.uBloomStrength.value=0,R.visible=!1,o.setRenderTarget(M),o.render(m,w.camera),R.visible=!0,cn===1&&!n)o.setRenderTarget(t),o.render(m,w.camera);else if(cn===1)o.setRenderTarget(Et),o.render(m,w.camera),Rt(Et),Q.uniforms.uScene.value=Et.texture,Q.uniforms.uAces.value=1,Q.uniforms.uGrade.value=1,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=1,Xt(Q,t);else if(o.setRenderTarget(n?Et:wt),o.render(m,w.camera),cn===2)n&&Rt(Et),Q.uniforms.uScene.value=n?Et.texture:wt.texture,Q.uniforms.uAces.value=+!!n,Q.uniforms.uGrade.value=+!!n,Q.uniforms.uGrain.value=1,Q.uniforms.uChroma.value=1,Q.uniforms.uDither.value=+!!n,Xt(Q,t);else{Q.uniforms.uScene.value=wt.texture,Q.uniforms.uAces.value=0,Q.uniforms.uGrade.value=0,Q.uniforms.uGrain.value=0,Q.uniforms.uChroma.value=0,Q.uniforms.uDither.value=0,Xt(Q,Tt);let n=w.camera;Kt.uniforms.uNear.value=n.near,Kt.uniforms.uFar.value=n.far,Kt.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(xn(e.era),Ut):Cn();e.kind===`pixel`?(Xt(r,t),window.__style=`pixel`):e.kind===`toon`?(Xt(Kt,t),window.__style=`toon`):(Xt(Kt,Dt),Xt(r,Ot),Jt.uniforms.uBlend.value=e.blend,Xt(Jt,t),window.__style=`blend`)}}function On(){let e=kn(),n=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return ae.uniforms.uChromaScale.value=t.lerp(1,.5,n),e}function kn(){if(cn===1||cn===2)return{kind:`none`};if(cn===7)return{kind:`pixel`};if(cn===8)return{kind:`toon`};let e=w.styleT;return window.__styleT=e,e<=pn?{kind:`toon`}:e>=mn?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:t.smoothstep(e,pn,mn),era:`16-bit`}}function An(e){return cn===1||cn===2?``:ln&&cn!==7&&cn!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?gn[e.era||fn]||`Pixel`:e.kind===`blend`?`Toon → `+(gn[e.era]||`Pixel`):``}function jn(e,n,{shadowsOn:r=!0,seasonTarget:i=0}={}){typeof window<`u`&&window.__frames++,r&&=en,L.material.uniforms.uTime.value=n,Q.uniforms.uTime.value=n,D.update(e),B.key.position.copy(D.sunDir).multiplyScalar(24),B.key.color.copy(D.sunColor),B.key.intensity=D.sunIntensity,B.fill.color.copy(D.hemiSky),B.fill.groundColor.copy(D.hemiGround),z.value=D.windowGlow,me.setSun(D.sunArc),me.setParams(D.skyParams),Q.uniforms.uGradeSat.value=D.grade.sat,Q.uniforms.uGradeContrast.value=D.grade.contrast,m.environmentIntensity=.34*(1-.6*t.clamp(D.sunArc.y*1.5,0,1));let a=U.overcast;B.key.intensity*=1-.5*a,B.key.color.lerp(_,.45*a),B.fill.intensity=1+.7*a;let s=t.smoothstep(D.sunDir.y,.06,.34),c=t.lerp(.28,1,1-D.windowGlow),l=r?s*c:0;B.key.shadow.intensity=.72*l,Pe.value=.52*l,(r&&!yn||vn.distanceToSquared(D.sunDir)>2e-5)&&(o.shadowMap.needsUpdate=!0,vn.copy(D.sunDir)),yn=r;let u=1-D.windowGlow;Ne.setRGB(t.lerp(.46,1,u),t.lerp(.52,1,u),t.lerp(.74,1,u)),Q.uniforms.uExposure.value=D.exposure,Kt.uniforms.uToonGain.value=D.toonGain,o.setClearColor(D.horizon,1),bn(D.t),window.__t=D.t,se.update(e,n,D),B.update(n),V.update(e,n,D),A.uniforms.uWakeCount.value=V.wakeCount,U.update(e,n),A.uniforms.uRainCount.value=U.rainDropCount;let d=U.fog*(1-u);m.fog.density=U.fog*x,C.copy(D.horizon).lerp(S,.85*d),m.fog.color.copy(C),o.setClearColor(C,1),Re.value=U.fog,L.material.uniforms.uFogAmt.value=.7*U.fog,Fe.value=U.snow,Ie.value=U.cloud*.55,Le.x+=e*.018,Le.y+=e*.009,ze.value+=(i-ze.value)*Math.min(1,e*1.5),le.update(e,n,D,U),be&&X.update(e,n,D),be&&He.step(e);let f=kn(),p=f.kind===`pixel`||f.kind===`blend`?`pixel`:ln?`vector`:f.kind===`toon`?`charm`:`realistic`;pe.update(e,n,D,U,p,w.camera);let[h,g,v]=te;if(A.uniforms.uPrev.value=h.texture,A.uniforms.uCurr.value=g.texture,o.setRenderTarget(v),o.render(k,ne),te=[g,v,h],ae.uniforms.uHeight.value=te[1].texture,_n<2&&typeof document<`u`&&++_n===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Mn(e){cn=e,window.__mode=cn}function Nn(){return ln=!ln,Me.value=+!!ln,window.__vector=ln,ln}function Pn(e){return ln=!!e,Me.value=+!!ln,window.__vector=ln,ln}function In(){return fn=hn[(hn.indexOf(fn)+1)%hn.length],window.__era=fn,Sn(),fn}function Ln(){return un=!un,un}return{updateWorld:jn,decideStyle:On,renderCityPipeline:Dn,renderCityBeautyTo:Tn,styleHintName:An,setPostMode:Mn,toggleVector:Nn,setVector:Pn,cycleEra:In,togglePalette:Ln,setTonemap:e=>{let t=e===`agx`||e===1||e===!0;return Q.uniforms.uTonemap.value=+!!t,typeof window<`u`&&(window.__tonemap=t?`agx`:`aces`),t?`agx`:`aces`},get mode(){return cn},get vector(){return ln},get sceneEra(){return fn},renderer:o,drawBuffer:u,scene:m,rig:w,sunRig:D,SIM:256,targets:te,simScene:k,simCamera:ne,simMaterial:A,grabRT:M,card:re,backdrop:L,WATER_SIZE:28,water:R,waterMaterial:ae,windowGlow:z,landmarkFactory:oe,city:B,cityLife:se,waterLife:V,weatherRig:U,clouds:le,inspector:fe,world:ht,catalog:gt,editor:_t,pilot:bt,profiler:$t,governor:nn,frameStart:rn,frameEnd:an,setActive:on,get paused(){return f},get contextLost(){return d},prewarm:sn,fitShadowFrustum:xt,SHADOW_DIST:24,sceneDepth:St,sceneRT:wt,filmicRT:Tt,toonRT:Dt,pixelRT:Ot,postScene:Nt,postCamera:Ft,postQuad:It,filmicMaterial:Q,pixelMaterial:Ht,pixelkitMaterial:Ut,toonMaterial:Kt,mixMaterial:Jt,PALCACHE:Vt,ERA_TEX:Wt,runPass:Xt,OVERCAST_GREY:_,FOG_DENSITY:x,FOG_NIGHT_TINT:S,_fogColor:C,resize:Zt}}var Ei=[`video/mp4;codecs=avc1.42E01E`,`video/mp4`,`video/webm;codecs=vp9`,`video/webm`];function Di({renderer:e,rig:t,sunRig:n,poke:r,getState:i,office:a={}}){let o=e.domElement,s=new URLSearchParams(window.location.search),c=e=>{let t=i();return`lgr-${t.lesson}-${String(t.clock||``).replace(`:`,``)}-${t.style}.${e}`},l=(e,t)=>{let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,document.body.appendChild(r),r.click(),r.remove(),setTimeout(()=>URL.revokeObjectURL(n),1e3)};function u(){o.toBlob(e=>{e&&(l(e,c(`png`)),window.__lastStill=e.size)},`image/png`)}let d=()=>Ei.find(e=>window.MediaRecorder&&MediaRecorder.isTypeSupported(e))||``,f=Oi(),p=null,m=[],h=!1;function g(){if(h)return;let e=d(),t=o.captureStream(60);p=new MediaRecorder(t,e?{mimeType:e,videoBitsPerSecond:12e6}:{}),m=[],p.ondataavailable=e=>{e.data&&e.data.size&&m.push(e.data)},p.onstop=()=>{let e=new Blob(m,{type:p.mimeType});l(e,c(p.mimeType.includes(`mp4`)?`mp4`:`webm`)),window.__lastVideo=e.size},p.start(),h=!0,window.__recording=!0,f.show()}function _(){h&&(p.stop(),h=!1,window.__recording=!1,f.hide())}let v=()=>h?_():g(),y=e=>new Promise(t=>setTimeout(t,e)),b=e=>{let t=e.startsWith(`Shift+`),n=t?e.slice(6):e;window.dispatchEvent(new KeyboardEvent(`keydown`,{key:n,shiftKey:t}))};async function x(){let e=o.clientWidth,t=o.clientHeight,n=e*.26,i=t*.74;for(let t=0;t<=10;t++)r.at(n+t*e*.028,i+Math.sin(t*.7)*16),await y(100);r.stop()}async function S(e){if(e.keys)for(let t of e.keys)b(t),await y(70);e.zoom&&t.zoomBy(e.zoom),e.orbit&&t.orbit(e.orbit[0],e.orbit[1]),e.timeTo!==void 0&&n.goTo(e.timeTo),e.office&&a[e.office]?.(),e.ripple&&await x(),e.waitMs&&await y(e.waitMs)}let C={tour:[{keys:[`6`,`0`],waitMs:600},{zoom:.72,waitMs:1700},{ripple:!0,waitMs:2400},{orbit:[.55,0],waitMs:1700},{timeTo:0,waitMs:3e3},{timeTo:.5,waitMs:1500},{keys:[`7`],waitMs:1e3},{zoom:1.5,waitMs:1400},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`8`],waitMs:900},{zoom:.65,waitMs:1200},{ripple:!0,waitMs:2600},{keys:[`7`],waitMs:700},{keys:[`B`],waitMs:300},{keys:[`B`],waitMs:900},{zoom:1.4,waitMs:2600}],daycycle:[{keys:[`6`,`0`],waitMs:700},{timeTo:.75,waitMs:2600},{timeTo:1,waitMs:2600},{timeTo:1.25,waitMs:2600},{timeTo:1.5,waitMs:2600},{timeTo:1.5,waitMs:800}],office:[{keys:[`o`],waitMs:1700},{office:`pet`,waitMs:1300},{office:`feed`,waitMs:1700},{office:`travel`,waitMs:1700},{keys:[`Shift+W`,`Shift+W`,`Shift+W`],waitMs:1800},{timeTo:0,waitMs:2400},{office:`laptop`,waitMs:800},{office:`closeLaptop`,waitMs:300},{timeTo:.5,waitMs:900},{keys:[`Shift+W`],waitMs:200},{keys:[`o`],waitMs:1500}],cities:[{keys:[`6`,`0`],waitMs:500},{timeTo:.78,waitMs:2800},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:2e3}],water:[{keys:[`6`,`0`],waitMs:600},{zoom:1.35,waitMs:2800},{orbit:[.7,0],waitMs:2600},{ripple:!0,waitMs:2200},{timeTo:0,waitMs:3200},{timeTo:.5,waitMs:1500},{orbit:[-.5,0],waitMs:2200}],morph:[{keys:[`6`,`3`],waitMs:700},{zoom:.55,waitMs:1800},{zoom:2.3,waitMs:1700},{zoom:1.26,waitMs:1700},{zoom:1.16,waitMs:1900},{zoom:.3,waitMs:2200}],skin:[{keys:[`o`],waitMs:1800},{keys:[`j`],waitMs:2e3},{keys:[`j`],waitMs:2e3},{timeTo:0,waitMs:2600},{timeTo:.5,waitMs:1500},{keys:[`u`],waitMs:2e3},{keys:[`j`],waitMs:1400},{keys:[`o`],waitMs:1500}]};async function w(e){let t=C[e];if(t){window.__director=e;for(let e of t)await S(e);window.__director=null}}async function T(e){await y(1600),g(),await w(e),await y(400),_(),window.__captureDone=!0}s.has(`capture`)&&window.addEventListener(`keydown`,e=>{(e.key===`s`||e.key===`S`)&&u(),(e.key===`r`||e.key===`R`)&&v()});let E=s.get(`capture`);return E&&C[E]&&T(E),window.__capture={still:u,toggleRec:v,run:w,sequences:Object.keys(C)},window.__capture}function Oi(){let e=document.createElement(`div`);return e.textContent=`● REC`,e.style.cssText=`position:fixed;top:14px;right:16px;z-index:2;font:bold 12px ui-monospace,monospace;color:#ff3b30;letter-spacing:.12em;text-shadow:0 1px 3px #000;display:none;`,document.body.appendChild(e),{show:()=>{e.style.display=`block`},hide:()=>{e.style.display=`none`}}}var ki=`
