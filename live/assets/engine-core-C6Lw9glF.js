import{A as e,B as t,D as n,E as r,G as i,H as a,I as o,J as s,K as c,L as l,M as u,N as d,O as f,P as p,Q as m,R as h,T as g,U as _,V as v,W as y,X as b,Y as x,_ as S,b as C,bt as w,c as T,ct as E,d as D,dt as O,et as k,f as A,g as j,gt as M,i as ee,j as te,k as ne,l as re,lt as N,m as ie,mt as P,n as F,nt as I,o as ae,p as oe,pt as L,q as se,r as ce,rt as le,s as R,st as z,t as ue,tt as de,u as B,ut as fe,v as pe,vt as V,w as me,x as he,y as ge,yt as H,z as U}from"./three-xswymbn-.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var _e=Math.atan(1/Math.SQRT2),ve=Math.atan(.5),W=Math.PI/4,G={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},ye=.12,K=1.45,be=4,q=40,xe=1.5,Se=16,Ce=6,we=22,Te=3.5,Ee=11,De=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),Oe=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function ke({aspect:e,fov:n=48,near:r=.1,far:i=100,target:a=new H(0,.8,0),azimuth:o=W,elevation:c=.52,distance:l=12,zoom:u=5.5}={}){let d=new b(n,e,r,i),f=new s(-1,1,1,-1,r,i),p=G.PERSPECTIVE,m=e,h={azimuth:o,elevation:c,distance:l,zoom:u,target:a.clone()},g={azimuth:o,elevation:c,distance:l,zoom:u,target:a.clone()},_=!1,v=null,y=new H,x=()=>p===G.PERSPECTIVE?d:f;function S(e){e!==p&&(p=e,p===G.ISOMETRIC||p===G.DIMETRIC?(h.elevation=p===G.ISOMETRIC?_e:ve,h.azimuth=Oe(W,g.azimuth),_=!0):_=!1)}function C(e,n){h.azimuth+=e,_||(h.elevation=t.clamp(h.elevation+n,ye,K))}function w(e){p===G.PERSPECTIVE?h.distance=t.clamp(h.distance*e,be,q):h.zoom=t.clamp(h.zoom*e,xe,Se)}function T(e,t){let n=h.azimuth,r=p===G.PERSPECTIVE?h.distance*.04:h.zoom*.08,i=new H(Math.cos(n),0,-Math.sin(n)),a=new H(-Math.sin(n),0,-Math.cos(n));h.target.addScaledVector(i,e*r),h.target.addScaledVector(a,t*r)}function E(e,t){m=e/t,d.aspect=m,d.updateProjectionMatrix()}function D(e){v&&(v(y),h.target.copy(y)),g.azimuth=De(g.azimuth,h.azimuth,e),g.elevation=De(g.elevation,h.elevation,e),g.distance=De(g.distance,h.distance,e),g.zoom=De(g.zoom,h.zoom,e),g.target.x=De(g.target.x,h.target.x,e),g.target.y=De(g.target.y,h.target.y,e),g.target.z=De(g.target.z,h.target.z,e);let t=Math.cos(g.elevation),n=Math.sin(g.elevation),r=Math.cos(g.azimuth),i=Math.sin(g.azimuth),a=x();if(a.position.set(g.target.x+g.distance*t*i,g.target.y+g.distance*n,g.target.z+g.distance*t*r),a.lookAt(g.target),a.isOrthographicCamera){let e=g.zoom,t=e*m;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function O(e,t,n,r=!1){h.target.set(e,t,n),r&&g.target.copy(h.target)}function k(e,n=!1){h.zoom=t.clamp(e,xe,Se),n&&(g.zoom=h.zoom)}function A(e,{frame:n,snap:r=!1}={}){v=e,r&&(v(y),h.target.copy(y),g.target.copy(y)),n!=null&&(p===G.PERSPECTIVE?h.distance=t.clamp(n,be,q):h.zoom=t.clamp(n,xe,Se))}function j(){v=null}return{get camera(){return x()},get mode(){return p},get azimuth(){return g.azimuth},get following(){return!!v},setTarget:O,setZoom:k,setFollow:A,clearFollow:j,get styleT(){return p===G.PERSPECTIVE?t.clamp((g.distance-Ce)/(we-Ce),0,1):t.clamp((g.zoom-Te)/(Ee-Te),0,1)},setMode:S,orbit:C,zoomBy:w,pan:T,setViewport:E,update:D}}var Ae={value:0},je=new j(`#ffffff`),Me={value:0},Ne={value:0},Pe={value:0},Fe=new V,Ie={value:0},Le={value:0},J=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
`;function Re(e){e.uniforms.uVector=Ae,e.uniforms.uVecTint={value:je},e.uniforms.uVecShadow=Me,e.uniforms.uSnow=Ne,e.uniforms.uCloud=Pe,e.uniforms.uCloudOff={value:Fe},e.uniforms.uFogCharm=Ie}function ze(e){return e.replace(`#include <fog_fragment>`,`
    #ifdef USE_FOG
...
#include <shadowmask_pars_fragment>`)}var He=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Ue(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new j(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{Re(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new j(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=Be(e.vertexShader),e.fragmentShader=ze(Ve(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function Y(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{Re(e),s||(e.uniforms.uVecColor={value:new j(t)}),c&&(e.uniforms.uGlow={value:new j(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=Le),e.vertexShader=Be(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,jr={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Mr=[`gb`,`8-bit`,`16-bit`,`modern`],Nr={"ink-gold (day)":[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],"ink-gold (night)":[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],"terminal (day)":[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],"terminal (night)":[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],"neutral (photoreal)":[`#1B1B1E`,`#3D3A3A`,`#5E5750`,`#867C70`,`#A99C8A`,`#C8BCAB`,`#E3DCCF`,`#F5F1E8`],"cool (noir)":[`#0A0E14`,`#16202E`,`#243447`,`#3A536B`,`#5A7D96`,`#86A6BD`,`#B6CDDA`,`#E6EEF2`],"warm (sunset)":[`#190B0A`,`#3B150F`,`#6E2A17`,`#A8421F`,`#DB702F`,`#F2A23E`,`#F9CF76`,`#FDF0C4`],"vibrant (pop)":[`#1A1A2E`,`#E43F5A`,`#F9A826`,`#FFE05D`,`#2EC4B6`,`#3A86FF`,`#8338EC`,`#FFFFFF`],"mono (ink)":[`#0C0C0C`,`#2A2A2A`,`#474747`,`#666666`,`#8A8A8A`,`#B0B0B0`,`#D6D6D6`,`#F5F5F5`]};function Pr(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new j(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let i=new ge(n,t,1,le,r);return i.minFilter=c,i.magFilter=c,i.needsUpdate=!0,i}function Fr(e,t){let n=[];for(let t=0;t+2<e.length;t+=3)n.push([e[t],e[t+1],e[t+2]]);if(n.length===0)return[`#000000`];let r=e=>{let t=[255,255,255],n=[0,0,0];for(let r of e)for(let e=0;e<3;e++)t[e]=Math.min(t[e],r[e]),n[e]=Math.max(n[e],r[e]);let r=[n[0]-t[0],n[1]-t[1],n[2]-t[2]],i=r[0]>=r[1]&&r[0]>=r[2]?0:r[1]>=r[2]?1:2;return{ax:i,range:r[i]}},i=[n];for(;i.length<t;){let e=-1,t=-1;if(i.forEach((n,i)=>{if(n.length>1){let{range:a}=r(n);a>t&&(t=a,e=i)}}),e<0)break;let n=i[e],{ax:a}=r(n);n.sort((e,t)=>e[a]-t[a]);let o=n.length>>1;i.splice(e,1,n.slice(0,o),n.slice(o))}return i.map(e=>{let t=[0,0,0];for(let n of e)for(let e=0;e<3;e++)t[e]+=n[e];return`#`+t.map(t=>Math.round(t/e.length)).map(e=>e.toString(16).padStart(2,`0`)).join(``)})}var Ir=220,Lr={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Rr={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function zr({demo:e=!1,citySeed:r=0,profileIndex:a=0}={}){let o=new ee({antialias:!0,preserveDrawingBuffer:!0});o.shadowMap.enabled=!0,o.shadowMap.type=1,o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0;let l=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);o.setPixelRatio(Math.min(window.devicePixelRatio,l?1.5:2)),o.setSize(window.innerWidth,window.innerHeight),o.setClearColor(920327,1),document.body.appendChild(o.domElement);let u=o.getDrawingBufferSize(new V),d=new E;d.fog=new n(10465470,0);let f=new j(`#aeb6c0`),p=.062,g=new j(`#74508f`),b=new j,x=ke({aspect:window.innerWidth/window.innerHeight}),S=ft({t:.5}),T={type:ne,format:le,minFilter:c,magFilter:c,wrapS:ie,wrapT:ie,depthBuffer:!1,stencilBuffer:!1},D=[new w(256,256,T),new w(256,256,T),new w(256,256,T)];for(let e of D)o.setRenderTarget(e),o.clear();o.setRenderTarget(null);let O=new E,k=new s(-1,1,1,-1,0,1),A=new N({vertexShader:br,fragmentShader:xr,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new V(1/256,1/256)},uMouse:{value:new V(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new H)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new H)}}});O.add(new _(new m(2,2),A));let M=new w(u.x,u.y,{minFilter:h,magFilter:h,depthBuffer:!0,stencilBuffer:!1});function te(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new B(t);return r.colorSpace=z,r}let re=new _(new m(28,28),new y({map:te(e)}));re.rotation.x=-Math.PI/2,re.position.y=-.35,d.add(re);let P=new _(new m(40,24),new N({depthWrite:!1,vertexShader:vr,fragmentShader:yr,uniforms:{uTime:{value:0},uInk:{value:S.horizon},uGold:{value:S.sky},uFogColor:{value:b},uFogAmt:{value:0},uFogCharm:Ie}}));P.position.set(0,3,-8),d.add(P);let F=new N({vertexShader:Sr,fragmentShader:Cr,uniforms:{uHeight:{value:null},uScene:{value:M.texture},uTexel:{value:new V(1/256,1/256)},uResolution:{value:new V(u.x,u.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new v},uLightDir:{value:S.sunDir},uInk:{value:new j(`#2A2218`)},uGold:{value:new j(`#B89968`)},uVector:Ae,uVecWater:{value:new j(`#1fb8d8`)},uVecTint:{value:je}}}),I=new _(new m(28,28,255,255),F);I.rotation.x=-Math.PI/2,I.updateMatrixWorld(!0),F.uniforms.uNormalMatrix.value.getNormalMatrix(I.matrixWorld),d.add(I);let ae={value:0},oe=Rt({windowGlow:ae}),L=at({seed:r,profileIndex:a,landmarkFactory:oe,windowGlow:ae});d.add(L.group);let se=gt({plinthTop:.3,extent:L.extent,profile:L.state.profile});d.add(se.group);let ce=Dt({extent:L.extent,waterSize:28,plinthTop:.3});d.add(ce.group),A.uniforms.uWakeDrops.value=ce.wakeDrops;let R=Bt({extent:L.extent});d.add(R.group),A.uniforms.uRainDrops.value=R.rainDrops;let ue=Ht({extent:L.extent});d.add(ue.group);let de=[se,ce,ue],fe=Gt({rig:x,getCamera:()=>x.camera,sources:de}),pe=_r();d.add(pe.group);let me=er({scale:90});d.add(me.mesh),d.environmentIntensity=.32;let he=!1;function ge(e){let t=e&&S.sunArc.y>-.04;t!==he&&(he=t,me.mesh.visible=t,P.visible=!t)}let U=null,_e=-1;function ve(){let e=Math.floor(S.t%1*4)%4;return(e!==_e||!U)&&(_e=e,U=me.buildEnv(o)),U}let W=null,G=null,ye=null,K=null,be=!1,q=1234,xe=`valley`,Se=un.map(e=>e.key),Ce=new i({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),we=()=>[L.group,se.group,ce.group],Te=()=>[W,G,ye].filter(Boolean);function Ee(){for(let e of Te())d.remove(e),e.userData.dispose?.();let e=hn({seed:q,size:160,preset:xe});K=e,W=Sn(e,{worldSize:26,baseY:0,chunks:6}),G=qn({terrain:e,seed:q,worldSize:26,baseY:0,biomeKeys:Se}),ye=Xn(e,{worldSize:26,baseY:0,maxLakes:3,material:Ce});for(let e of Te())e.visible=be,d.add(e);J!==void 0&&J&&J.clear(),typeof window<`u`&&(window.__world={seed:q,preset:xe,active:be,chunks:W.children.length,scatter:G.userData.counts,lakes:ye.userData.count})}let De=e=>{for(let t of Te())t.visible=e};function Oe(e,t){if(!K)return 0;let{size:n,height:r,sea:i,relief:a}=K,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let J=Qt({heightAt:Oe,seaSurfaceY:0,waterY:.06});J.group.visible=!1,d.add(J.group),de.push(J);let Re=null,ze=new Set;function Be(){!K||!ye||(d.remove(ye),ye.userData.dispose?.(),ye=Xn(K,{worldSize:26,baseY:0,maxLakes:3,material:Ce}),ye.visible=be,d.add(ye),window.__world&&(window.__world.lakes=ye.userData.count))}function Ve(){Be(),G&&Kn(G,K,{worldSize:26,baseY:0})}function He(e,t,n=1,r=2.2,i=.05){if(!K||!W)return;let a=K.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=K.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}ze.clear();for(let e of W.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&ze.add(e)}Cn(W,K,ze),Re&&clearTimeout(Re),Re=setTimeout(Ve,140)}function Ue(e,t,n,r=2.2){if(!K||!W||n==null)return;let i=K.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=K.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);ze.clear();for(let e of W.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&ze.add(e)}Cn(W,K,ze,!0)}let Y=[`tree`,`rock`,`tuft`];function We(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!K||!G)return 0;if(a)return Wn(G,n||`all`,e,t,i);let o=K.size,s=26/(o-1),c=K.height,l=K.sea,u=K.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Gn[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;Un(G,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&G.userData.counts)for(let e of Y)G.userData.counts[e]=(G.userData.placements[e]||[]).length;return g}let Ge=[];function Ke(){if(!G)return null;let e=G.userData.placements,t={};for(let n of Y)t[n]=(e[n]||[]).map(e=>({...e}));return t}function qe(){K&&(Ge.push({h:K.height.slice(),b:K.biome.slice(),sc:Ke(),pl:J.snapshot()}),Ge.length>12&&Ge.shift())}function Je(){if(!K||!Ge.length)return!1;let e=Ge.pop();if(K.height.set(e.h),K.biome.set(e.b),e.sc&&G){let t=G.userData.placements;for(let n of Y)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&J.restore(e.pl),Cn(W,K,W.children,!0),Ve(),!0}let Ye=new Set([`boat`,`fish`]),Xe=new Set([`person`]);function Ze(e,t,n){if(!K)return null;let r=Oe(t,n)<0;return Ye.has(e)&&!r||Xe.has(e)&&r?null:J.spawn(e,t,n)}function Qe(e,t,n=2.5){return J.removeNear(e,t,n)}let $e={enter(){W||Ee(),be=!0,De(!0),J.group.visible=!0;for(let e of we())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){be=!1,De(!1),J.group.visible=!1;for(let e of we())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return q=Math.random()*1e9|0,Ge.length=0,Ee(),$e.enter(),q},reset(){return Ge.length=0,Ee(),$e.enter(),q},setPreset(e){return mn.includes(e)&&(xe=e,Ge.length=0,Ee(),$e.enter()),xe},sculpt:He,paintBiome:Ue,paintScatter:We,repoolWater:Be,snapshot:qe,undo:Je,placeEntity:Ze,removeEntityNear:Qe,heightAt:Oe,get terrainGroup(){return W},get biomes(){return un},get scatterCounts(){return G?G.userData.placements&&Y.reduce((e,t)=>(e[t]=(G.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return J.counts()},setScatterHidden(e){G&&(G.visible=!e)},get placedLife(){return J},get canUndo(){return Ge.length>0},get active(){return be},get seed(){return q},get preset(){return xe},get presets(){return mn}},et=Qn(),tt=an({world:$e,catalog:et,inspector:fe});L.group.remove(L.key),d.add(L.key),L.key.castShadow=!0,L.key.shadow.mapSize.set(2048,2048),L.key.shadow.bias=-18e-5,L.key.shadow.normalBias=.028,d.add(L.key.target);function nt(){let e=L.key.shadow.camera,t=L.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),o.shadowMap.needsUpdate=!0}nt();let rt=new C(u.x,u.y),it=new w(u.x,u.y,{minFilter:h,magFilter:h,depthBuffer:!0,stencilBuffer:!1,depthTexture:rt}),ot=new w(u.x,u.y,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),st=new w(u.x,u.y,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),ct=new w(u.x,u.y,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),lt=Math.max(1,Math.floor(u.x/2)),ut=Math.max(1,Math.floor(u.y/2)),X=new w(lt,ut,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),dt=new w(lt,ut,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),pt=new E,mt=new s(-1,1,1,-1,0,1),ht=new _(new m(2,2));pt.add(ht);let Z=new N({vertexShader:br,fragmentShader:wr,uniforms:{uScene:{value:it.texture},uTime:{value:0},uResolution:{value:new V(u.x,u.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:X.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:S.grade.tint},uGradeLift:{value:S.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1}}}),_t=new N({vertexShader:br,fragmentShader:Or,uniforms:{uScene:{value:it.texture},uThreshold:{value:.78}}}),vt=new N({vertexShader:br,fragmentShader:kr,uniforms:{uScene:{value:X.texture},uDir:{value:new V}}});function yt(e){_t.uniforms.uScene.value=e.texture,kt(_t,X),vt.uniforms.uScene.value=X.texture,vt.uniforms.uDir.value.set(1.6/lt,0),kt(vt,dt),vt.uniforms.uScene.value=dt.texture,vt.uniforms.uDir.value.set(0,1.6/ut),kt(vt,X),Z.uniforms.uBloom.value=X.texture;let n=1-t.clamp(S.sunArc.y*2.2,0,1);Z.uniforms.uBloomStrength.value=.85*(.32+.95*n)}let bt=e=>{let t=e.map(e=>new j(e));for(;t.length<8;)t.push(new j(0,0,0));return t},xt=[`night`,`dawn`,`noon`,`dusk`],St={inkgold:xt.map(e=>bt(Lr[e])),terminal:xt.map(e=>bt(Rr[e]))},Ct=new N({vertexShader:br,fragmentShader:Tr,uniforms:{uScene:{value:ot.texture},uResolution:{value:new V(u.x,u.y)},uPixelSize:{value:Ir},uPalette:{value:St.inkgold[2]},uPaletteB:{value:St.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),wt=new N({vertexShader:br,fragmentShader:Ar,uniforms:{uScene:{value:ot.texture},uResolution:{value:new V(u.x,u.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Pr(jr[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Tt={};for(let e of Mr)Tt[e]=jr[e].palette?Pr(jr[e].palette):null;let Et=new N({vertexShader:br,fragmentShader:Er,uniforms:{uScene:{value:ot.texture},uDepth:{value:rt},uResolution:{value:new V(u.x,u.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:S.toonFloor},uOutline:{value:S.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Ot=new N({vertexShader:br,fragmentShader:Dr,uniforms:{uToon:{value:st.texture},uPixel:{value:ct.texture},uBlend:{value:0}}});function kt(e,t){ht.material=e,o.setRenderTarget(t),o.render(pt,mt)}function At(){x.setViewport(window.innerWidth,window.innerHeight),o.setSize(window.innerWidth,window.innerHeight);let e=o.getDrawingBufferSize(new V);return M.setSize(e.x,e.y),it.setSize(e.x,e.y),ot.setSize(e.x,e.y),st.setSize(e.x,e.y),ct.setSize(e.x,e.y),lt=Math.max(1,e.x>>1),ut=Math.max(1,e.y>>1),X.setSize(lt,ut),dt.setSize(lt,ut),F.uniforms.uResolution.value.set(e.x,e.y),Z.uniforms.uResolution.value.set(e.x,e.y),Ct.uniforms.uResolution.value.set(e.x,e.y),wt.uniforms.uResolution.value.set(e.x,e.y),Et.uniforms.uResolution.value.set(e.x,e.y),e}let Q=3,$=!1,jt=!1,Mt=`native`,Nt=.3,Pt=.46,Ft=[`native`,...Mr],It={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=Q,window.__vector=$,window.__era=Mt);let Lt=0,zt=performance.now(),Vt=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=Vt),Vt&&(o.info.autoReset=!1);let Ut=null;typeof window<`u`&&(window.__loaded=!1);let Wt=0,Kt=new H(1,1,1),qt=!1;function Jt(e){let t=jt?St.terminal:St.inkgold,n=e%1*4,r=Math.floor(n)%4;Ct.uniforms.uPalette.value=t[r],Ct.uniforms.uPaletteB.value=t[(r+1)%4],Ct.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Yt(e){let t=jr[e];t&&(wt.uniforms.uGridWidth.value=t.gridWidth,wt.uniforms.uDither.value=t.dither,wt.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(wt.uniforms.uPalette.value=Tt[e],wt.uniforms.uPaletteSize.value=t.palette.length))}function Xt(){Mt!==`native`&&Yt(Mt)}let Zt=()=>Mt===`native`?Ct:wt;function $t(e,t){ge(!0),d.environment=ve(),I.visible=!1,o.setRenderTarget(M),o.render(d,e),I.visible=!0,o.setRenderTarget(it),o.render(d,e),yt(it),Z.uniforms.uAces.value=1,Z.uniforms.uGrade.value=1,Z.uniforms.uGrain.value=0,Z.uniforms.uChroma.value=0,kt(Z,t)}function en(e,t){let n=!$&&(Q===1||Q===2);if(ge(n),d.environment=n?ve():null,Z.uniforms.uBloomStrength.value=0,I.visible=!1,o.setRenderTarget(M),o.render(d,x.camera),I.visible=!0,Q===1&&!n)o.setRenderTarget(t),o.render(d,x.camera);else if(Q===1)o.setRenderTarget(it),o.render(d,x.camera),yt(it),Z.uniforms.uAces.value=1,Z.uniforms.uGrade.value=1,Z.uniforms.uGrain.value=0,Z.uniforms.uChroma.value=0,kt(Z,t);else if(o.setRenderTarget(it),o.render(d,x.camera),Q===2)n&&yt(it),Z.uniforms.uAces.value=+!!n,Z.uniforms.uGrade.value=+!!n,Z.uniforms.uGrain.value=1,Z.uniforms.uChroma.value=1,kt(Z,t);else{Z.uniforms.uAces.value=0,Z.uniforms.uGrade.value=0,Z.uniforms.uGrain.value=0,Z.uniforms.uChroma.value=0,kt(Z,ot);let n=x.camera;Et.uniforms.uNear.value=n.near,Et.uniforms.uFar.value=n.far,Et.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Yt(e.era),wt):Zt();e.kind===`pixel`?(kt(r,t),window.__style=`pixel`):e.kind===`toon`?(kt(Et,t),window.__style=`toon`):(kt(Et,st),kt(r,ct),Ot.uniforms.uBlend.value=e.blend,kt(Ot,t),window.__style=`blend`)}}function tn(){let e=nn(),n=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return F.uniforms.uChromaScale.value=t.lerp(1,.5,n),e}function nn(){if(Q===1||Q===2)return{kind:`none`};if(Q===7)return{kind:`pixel`};if(Q===8)return{kind:`toon`};let e=x.styleT;return window.__styleT=e,e<=Nt?{kind:`toon`}:e>=Pt?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:t.smoothstep(e,Nt,Pt),era:`16-bit`}}function rn(e){return Q===1||Q===2?``:$&&Q!==7&&Q!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?It[e.era||Mt]||`Pixel`:e.kind===`blend`?`Toon → `+(It[e.era]||`Pixel`):``}function on(e,n,{shadowsOn:r=!0,seasonTarget:i=0}={}){if(Vt){let e=o.info;Ut={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}P.material.uniforms.uTime.value=n,Z.uniforms.uTime.value=n,S.update(e),L.key.position.copy(S.sunDir).multiplyScalar(24),L.key.color.copy(S.sunColor),L.key.intensity=S.sunIntensity,L.fill.color.copy(S.hemiSky),L.fill.groundColor.copy(S.hemiGround),ae.value=S.windowGlow,me.setSun(S.sunArc),me.setParams(S.skyParams),Z.uniforms.uGradeSat.value=S.grade.sat,Z.uniforms.uGradeContrast.value=S.grade.contrast,d.environmentIntensity=.34*(1-.6*t.clamp(S.sunArc.y*1.5,0,1));let a=R.overcast;L.key.intensity*=1-.5*a,L.key.color.lerp(f,.45*a),L.fill.intensity=1+.7*a;let s=t.smoothstep(S.sunDir.y,.06,.34),c=t.lerp(.28,1,1-S.windowGlow),l=r?s*c:0;L.key.shadow.intensity=.72*l,Me.value=.52*l,(r&&!qt||Kt.distanceToSquared(S.sunDir)>2e-5)&&(o.shadowMap.needsUpdate=!0,Kt.copy(S.sunDir)),qt=r;let u=1-S.windowGlow;je.setRGB(t.lerp(.46,1,u),t.lerp(.52,1,u),t.lerp(.74,1,u)),Z.uniforms.uExposure.value=S.exposure,Et.uniforms.uToonGain.value=S.toonGain,o.setClearColor(S.horizon,1),Jt(S.t),window.__t=S.t,se.update(e,n,S),L.update(n),ce.update(e,n,S),A.uniforms.uWakeCount.value=ce.wakeCount,R.update(e,n),A.uniforms.uRainCount.value=R.rainDropCount;let m=R.fog*(1-u);d.fog.density=R.fog*p,b.copy(S.horizon).lerp(g,.85*m),d.fog.color.copy(b),o.setClearColor(b,1),Ie.value=R.fog,P.material.uniforms.uFogAmt.value=.7*R.fog,Ne.value=R.snow,Pe.value=R.cloud*.55,Fe.x+=e*.018,Fe.y+=e*.009,Le.value+=(i-Le.value)*Math.min(1,e*1.5),ue.update(e,n,S,R),be&&J.update(e,n,S);let h=nn(),_=h.kind===`pixel`||h.kind===`blend`?`pixel`:$||h.kind===`toon`?`charm`:`realistic`;pe.update(e,n,S,R,_),Lt++;let v=performance.now();v-zt>=1e3&&(window.__fps=Lt,Vt&&Ut&&(console.log(`[perf] ${Lt} fps · ~${(1e3/Math.max(1,Lt)).toFixed(2)} ms · calls ${Ut.calls} · tris ${Ut.tris} · programs ${Ut.programs} · geo ${Ut.geo} · tex ${Ut.tex}`),window.__perfInfo={fps:Lt,...Ut}),Lt=0,zt=v);let[y,x,C]=D;if(A.uniforms.uPrev.value=y.texture,A.uniforms.uCurr.value=x.texture,o.setRenderTarget(C),o.render(O,k),D=[x,C,y],F.uniforms.uHeight.value=D[1].texture,Wt<2&&typeof document<`u`&&++Wt===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function sn(e){Q=e,window.__mode=Q}function cn(){return $=!$,Ae.value=+!!$,window.__vector=$,$}function ln(e){return $=!!e,Ae.value=+!!$,window.__vector=$,$}function dn(){return Mt=Ft[(Ft.indexOf(Mt)+1)%Ft.length],window.__era=Mt,Xt(),Mt}function fn(){return jt=!jt,jt}return{updateWorld:on,decideStyle:tn,renderCityPipeline:en,renderCityBeautyTo:$t,styleHintName:rn,setPostMode:sn,toggleVector:cn,setVector:ln,cycleEra:dn,togglePalette:fn,get mode(){return Q},get vector(){return $},get sceneEra(){return Mt},renderer:o,drawBuffer:u,scene:d,rig:x,sunRig:S,SIM:256,targets:D,simScene:O,simCamera:k,simMaterial:A,grabRT:M,card:re,backdrop:P,WATER_SIZE:28,water:I,waterMaterial:F,windowGlow:ae,landmarkFactory:oe,city:L,cityLife:se,waterLife:ce,weatherRig:R,clouds:ue,inspector:fe,world:$e,catalog:et,editor:tt,fitShadowFrustum:nt,SHADOW_DIST:24,sceneDepth:rt,sceneRT:it,filmicRT:ot,toonRT:st,pixelRT:ct,postScene:pt,postCamera:mt,postQuad:ht,filmicMaterial:Z,pixelMaterial:Ct,pixelkitMaterial:wt,toonMaterial:Et,mixMaterial:Ot,PALCACHE:St,ERA_TEX:Tt,runPass:kt,OVERCAST_GREY:f,FOG_DENSITY:p,FOG_NIGHT_TINT:g,_fogColor:b,resize:At}}var Br=[`video/mp4;codecs=avc1.42E01E`,`video/mp4`,`video/webm;codecs=vp9`,`video/webm`];function Vr({renderer:e,rig:t,sunRig:n,poke:r,getState:i,office:a={}}){let o=e.domElement,s=new URLSearchParams(window.location.search),c=e=>{let t=i();return`lgr-${t.lesson}-${String(t.clock||``).replace(`:`,``)}-${t.style}.${e}`},l=(e,t)=>{let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,document.body.appendChild(r),r.click(),r.remove(),setTimeout(()=>URL.revokeObjectURL(n),1e3)};function u(){o.toBlob(e=>{e&&(l(e,c(`png`)),window.__lastStill=e.size)},`image/png`)}let d=()=>Br.find(e=>window.MediaRecorder&&MediaRecorder.isTypeSupported(e))||``,f=Hr(),p=null,m=[],h=!1;function g(){if(h)return;let e=d(),t=o.captureStream(60);p=new MediaRecorder(t,e?{mimeType:e,videoBitsPerSecond:12e6}:{}),m=[],p.ondataavailable=e=>{e.data&&e.data.size&&m.push(e.data)},p.onstop=()=>{let e=new Blob(m,{type:p.mimeType});l(e,c(p.mimeType.includes(`mp4`)?`mp4`:`webm`)),window.__lastVideo=e.size},p.start(),h=!0,window.__recording=!0,f.show()}function _(){h&&(p.stop(),h=!1,window.__recording=!1,f.hide())}let v=()=>h?_():g(),y=e=>new Promise(t=>setTimeout(t,e)),b=e=>window.dispatchEvent(new KeyboardEvent(`keydown`,{key:e}));async function x(){let e=o.clientWidth,t=o.clientHeight,n=e*.26,i=t*.74;for(let t=0;t<=10;t++)r.at(n+t*e*.028,i+Math.sin(t*.7)*16),await y(100);r.stop()}async function S(e){if(e.keys)for(let t of e.keys)b(t),await y(70);e.zoom&&t.zoomBy(e.zoom),e.orbit&&t.orbit(e.orbit[0],e.orbit[1]),e.timeTo!==void 0&&n.goTo(e.timeTo),e.office&&a[e.office]?.(),e.ripple&&await x(),e.waitMs&&await y(e.waitMs)}let C={tour:[{keys:[`6`,`0`],waitMs:600},{zoom:.72,waitMs:1700},{ripple:!0,waitMs:2400},{orbit:[.55,0],waitMs:1700},{timeTo:0,waitMs:3e3},{timeTo:.5,waitMs:1500},{keys:[`7`],waitMs:1e3},{zoom:1.5,waitMs:1400},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`8`],waitMs:900},{zoom:.65,waitMs:1200},{ripple:!0,waitMs:2600},{keys:[`7`],waitMs:700},{keys:[`B`],waitMs:300},{keys:[`B`],waitMs:900},{zoom:1.4,waitMs:2600}],daycycle:[{keys:[`6`,`0`],waitMs:700},{timeTo:.75,waitMs:2600},{timeTo:1,waitMs:2600},{timeTo:1.25,waitMs:2600},{timeTo:1.5,waitMs:2600},{timeTo:1.5,waitMs:800}],office:[{keys:[`o`],waitMs:1700},{office:`pet`,waitMs:1300},{office:`feed`,waitMs:1700},{office:`travel`,waitMs:1700},{keys:[`W`,`W`,`W`],waitMs:1800},{timeTo:0,waitMs:2400},{office:`laptop`,waitMs:800},{office:`closeLaptop`,waitMs:300},{timeTo:.5,waitMs:900},{keys:[`W`],waitMs:200},{keys:[`o`],waitMs:1500}],cities:[{keys:[`6`,`0`],waitMs:500},{timeTo:.78,waitMs:2800},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:2e3}],water:[{keys:[`6`,`0`],waitMs:600},{zoom:1.35,waitMs:2800},{orbit:[.7,0],waitMs:2600},{ripple:!0,waitMs:2200},{timeTo:0,waitMs:3200},{timeTo:.5,waitMs:1500},{orbit:[-.5,0],waitMs:2200}],morph:[{keys:[`6`,`3`],waitMs:700},{zoom:.55,waitMs:1800},{zoom:2.3,waitMs:1700},{zoom:1.26,waitMs:1700},{zoom:1.16,waitMs:1900},{zoom:.3,waitMs:2200}],skin:[{keys:[`o`],waitMs:1800},{keys:[`j`],waitMs:2e3},{keys:[`j`],waitMs:2e3},{timeTo:0,waitMs:2600},{timeTo:.5,waitMs:1500},{keys:[`u`],waitMs:2e3},{keys:[`j`],waitMs:1400},{keys:[`o`],waitMs:1500}]};async function w(e){let t=C[e];if(t){window.__director=e;for(let e of t)await S(e);window.__director=null}}async function T(e){await y(1600),g(),await w(e),await y(400),_(),window.__captureDone=!0}window.addEventListener(`keydown`,e=>{(e.key===`s`||e.key===`S`)&&u(),(e.key===`r`||e.key===`R`)&&v()});let E=s.get(`capture`);return E&&C[E]&&T(E),window.__capture={still:u,toggleRec:v,run:w,sequences:Object.keys(C)},window.__capture}function Hr(){let e=document.createElement(`div`);return e.textContent=`● REC`,e.style.cssText=`position:fixed;top:14px;right:16px;z-index:2;font:bold 12px ui-monospace,monospace;color:#ff3b30;letter-spacing:.12em;text-shadow:0 1px 3px #000;display:none;`,document.body.appendChild(e),{show:()=>{e.style.display=`block`},hide:()=>{e.style.display=`none`}}}var Ur=`
...
`;function Wr({controls:e,state:t,show:n,coarse:r}){if(typeof document>`u`)return;let i=document.createElement(`style`);i.textContent=Ur,document.head.appendChild(i);let a=document.createElement(`div`);a.className=`vui`;let o=document.createElement(`div`);o.className=`vui-info`,o.innerHTML=`KEYS · 4/5/6 cam · 0 vector · 7/8 pixel/toon · B era · T time · [ ] scrub · 9 auto · C city · G shuffle · W weather · K season · click a building / O office · J office skin · U painted props · Esc exit · M hide UI · S still · R rec · H shadows · P theme · drag water to ripple`;let s=(e,t,n)=>{let r=document.createElement(`button`);return r.textContent=e,n&&(r.title=n),r.addEventListener(`click`,e=>{navigator.vibrate?.(10),t(e)}),r},c=e=>{let t=document.createElement(`div`);return t.className=`seg`,{seg:t,btns:e.map(([n,r])=>{let i=s(n,()=>e.find(e=>e[1]===r)[2](),n);return i.dataset.val=r,t.appendChild(i),i})}},l=e=>{let t=document.createElement(`span`);return t.className=`clbl`,t.textContent=e,t},u=(e,t,n,r)=>{let i=document.createElement(`input`);return i.type=`range`,i.min=String(e),i.max=String(t),i.step=String(n),i.addEventListener(`input`,()=>r(parseFloat(i.value))),i},d=s(`City`,()=>e.city(),`Next city profile (C)`),f=s(`Shuffle`,()=>e.shuffle(),`New random seed (G)`),p={clear:`Clear`,rain:`Rain`,snow:`Snow`,fog:`Fog`},m=[`Spring`,`Summer`,`Autumn`,`Winter`],h=s(`Clear`,()=>e.weather(),`Cycle weather: clear→rain→snow→fog (W)`),g=s(`Spring`,()=>e.season(),`Cycle season: spring→summer→autumn→winter (K)`),_=s(`Office`,()=>e.office(),`Dive into / exit the office (O · Esc)`),v={"3d":`3D`,dressed2:`Dressed`,night2:`Night`,modern:`Modern`,charm:`Charm`},y=s(`Skin`,()=>e.officeSkin(),`Office look: 3D → dressed → night → modern → charm diffusion (J)`),b={painted:`Painted`,"3d":`Live 3D`},x=s(`Props`,()=>e.officeProps(),`Office props: painted (cohesive) ↔ live 3D (animated) — under a skin (U)`),S=s(`Inspect`,()=>e.inspect(),`Inspect: fly + click/tap any car·person·bird·boat·cloud to follow + watch its behaviour (I)`),C={valley:`Valley`,archipelago:`Archi`,mountains:`Mountains`,plains:`Plains`},w=s(`World`,()=>e.world(),`Generate + explore a procedural terrain world`),T=s(`🎲`,()=>e.worldReroll(),`New random world (seed) — G`),E=s(`Valley`,()=>e.worldPreset(),`Cycle biome preset: valley → archipelago → mountains → plains`),D=s(`✎ Edit`,()=>e.sculpt&&e.sculpt(),`World editor — brush the terrain (Sculpt to reshape, Paint to recolour)`),O=document.createElement(`div`);O.className=`vui-rail`;let k=null;function A(t){k||!t||(k=t.map(t=>{let n=document.createElement(`button`);return n.dataset.id=t.id,n.title=`${t.label} (${t.key})`,n.innerHTML=`${t.icon}<span class="rk">${t.key}</span>`,n.addEventListener(`click`,()=>{navigator.vibrate?.(10),e.editTool&&e.editTool(t.id)}),O.appendChild(n),n}))}let j=document.createElement(`div`);j.className=`vui-card`;let M=document.createElement(`div`);M.className=`ct`;let ee=document.createElement(`div`);ee.className=`crow`;let te=u(.8,6,.1,t=>e.brushSize&&e.brushSize(t));ee.append(l(`Size`),te);let ne=document.createElement(`div`);ne.className=`crow`;let re=u(.01,.15,.005,t=>e.brushStrength&&e.brushStrength(t));ne.append(l(`Force`),re);let N=document.createElement(`div`);N.className=`crow`;let ie=u(.1,1,.05,t=>e.brushDensity&&e.brushDensity(t));N.append(l(`Density`),ie);let P=s(`↑ Raise`,()=>e.sculptDir&&e.sculptDir(),`Brush direction: raise ↔ lower / add ↔ erase / place ↔ delete`),F=s(`↶ Undo`,()=>e.worldUndo&&e.worldUndo(),`Undo the last edit (Z)`),I=s(`↺ Reset`,()=>e.worldReset&&e.worldReset(),`Reset to the generated world (discard edits) — same seed, NOT a reroll`),ae=s(`↺ Reset`,()=>e.worldReset&&e.worldReset(),`Reset the world (discard edits) — same seed`),oe=s(`👁 Trees`,()=>e.hideScatter&&e.hideScatter(),`Hide the scatter (trees/rocks) to see the ground you are editing`),L=document.createElement(`div`);L.className=`seg`,L.style.display=`none`;let se=null;function ce(t){se||!t||(se=t.map((t,n)=>{let r=document.createElement(`button`);return r.title=t.key,r.style.cssText=`min-width:30px;padding:0;background:${t.color};border:0;border-radius:8px;`,r.addEventListener(`click`,()=>{navigator.vibrate?.(8),e.material&&e.material(n)}),L.appendChild(r),r}))}let le=document.createElement(`div`);le.className=`seg`,le.style.display=`none`;let R=null;function z(t){R||!t||(R=t.map(t=>{let n=document.createElement(`button`);return n.dataset.key=t.key,n.textContent=t.icon,n.title=t.label,n.style.cssText=`min-width:30px;padding:4px 6px;`,n.addEventListener(`click`,()=>{navigator.vibrate?.(8),e.scatterType&&e.scatterType(t.key)}),le.appendChild(n),n}))}let ue=document.createElement(`div`);ue.className=`seg`,ue.style.display=`none`;let de=null;function B(t){de||!t||(de=t.map(t=>{let n=document.createElement(`button`);return n.dataset.key=t.key,n.textContent=t.icon,n.title=t.label,n.style.cssText=`min-width:30px;padding:4px 6px;`,n.addEventListener(`click`,()=>{navigator.vibrate?.(8),e.entity&&e.entity(t.key)}),ue.appendChild(n),n}))}let fe=c([[`×1`,`1`,()=>e.dropN&&e.dropN(1)],[`×10`,`10`,()=>e.dropN&&e.dropN(10)],[`×50`,`50`,()=>e.dropN&&e.dropN(50)]]);fe.seg.style.display=`none`,fe.seg.title=`How many to drop per click (scattered in the ring)`;let pe=document.createElement(`div`);pe.className=`crow`,pe.append(P,F,ae,oe),j.append(M,ee,ne,L,le,N,ue,fe.seg,pe);let V=s(`✨ Realistic`,()=>e.realistic(),`Cinematic beauty look — atmospheric sky, glowing sun, colour-graded (showcase)`),me=c([[`Auto`,`auto`,()=>e.post(`auto`)],[`Pixel`,`pixel`,()=>e.post(`pixel`)],[`Toon`,`toon`,()=>e.post(`toon`)],[`None`,`none`,()=>e.post(`none`)]]);me.btns[0].title=`AUTO: zoom morphs the style (toon → 16-bit → 8-bit → Game Boy)`,me.btns[3].title=`NONE: raw beauty render, no post-crunch (clean flat-vector when Vector is on)`;let he=s(`Vector`,()=>e.vector(),`Flat-vector materials — LAYERS onto the post mode (Vector + Pixel/Toon/Auto). Toggle (0)`),ge={native:`Era`,gb:`GB`,"8-bit":`8-bit`,"16-bit":`16-bit`,modern:`Modern`,"1-bit":`1-bit`},H=s(`Era`,()=>e.era(),`Cycle the pixel era (B): native → GB → 8-bit → 16-bit → Modern`),U=document.createElement(`input`);U.type=`range`,U.min=`0`,U.max=`1`,U.step=`0.01`,U.title=`Time of day`;let _e=!1;U.addEventListener(`pointerdown`,()=>{_e=!0}),U.addEventListener(`pointerup`,()=>{_e=!1}),U.addEventListener(`input`,()=>e.time(parseFloat(U.value)));let ve=s(`▶`,()=>e.auto(),`Play/pause day cycle (9)`),W=document.createElement(`div`);W.style.cssText=`display:flex;align-items:center;gap:6px;`;let G=document.createElement(`span`);G.className=`lbl`,G.textContent=`Day`,W.append(G,U,ve);let ye=c([[`Iso`,`iso`,()=>e.cam(`iso`)],[`Dim`,`dimetric`,()=>e.cam(`dimetric`)],[`3D`,`persp`,()=>e.cam(`persp`)]]),K=s(`ⓘ`,()=>o.classList.toggle(`open`),`All keys`),be=s(`⌄`,()=>Fe(!0),`Hide controls — watch unobstructed (M)`),q=document.createElement(`div`);q.className=`vui-more`;let xe=s(`More`,()=>{q.classList.toggle(`open`),Le()},`More controls`);if(r){a.append(d,f,_,S,w,ve,me.seg,xe,be);let e=document.createElement(`div`);e.style.cssText=`display:flex;align-items:center;gap:6px;`,e.append(G,U),q.append(V,T,I,E,D,h,g,y,x,he,H,ye.seg,e)}else a.append(d,f,Ue(),h,g,_,y,x,Ue(),S,w,T,I,E,D,Ue(),me.seg,V,he,H,Ue(),W,Ue(),ye.seg,K,Ue(),be);let Se=document.createElement(`div`);Se.className=`vui-inspect`;let Ce=document.createElement(`div`);Ce.className=`ik`;let we=document.createElement(`div`);we.className=`it`;let Te=document.createElement(`div`);Te.className=`ii`;let Ee=document.createElement(`div`);Ee.className=`ir`;let De=s(`▸ Next`,()=>e.inspectNext&&e.inspectNext(),`Follow the next object (Tab)`),Oe=s(`✕`,()=>e.inspect(),`Exit inspect (Esc)`);Ee.append(De,Oe),Se.append(Ce,we,Te,Ee);let ke=document.createElement(`button`);ke.className=`vui-show`,ke.innerHTML=`⌃ Controls`,ke.title=`Show controls (M)`,ke.addEventListener(`click`,()=>Fe(!1));let Ae=document.createElement(`div`);Ae.className=`vui-style`,document.body.append(o,q,a,ke,Ae,Se,O,j);let je=n,Me=!1;Fe(r);function Ne(){let e=t();me.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===e.post)),he.classList.toggle(`on`,!!e.vector),ye.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===e.cam)),h.textContent=p[e.weather]||`Clear`,h.classList.toggle(`on`,e.weather!==`clear`),g.textContent=m[e.season]||`Spring`,g.classList.toggle(`on`,(e.season||0)>0),_.textContent=e.office?`Exit`:`Office`,_.classList.toggle(`on`,!!e.office),y.textContent=v[e.officeSkin]||`Skin`,y.classList.toggle(`on`,e.officeSkin&&e.officeSkin!==`3d`),x.textContent=b[e.officeProps]||`Props`,x.classList.toggle(`on`,e.officeProps===`painted`&&e.officeSkin&&e.officeSkin!==`3d`),ve.textContent=e.auto?`❚❚`:`▶`,ve.classList.toggle(`on`,e.auto),H.textContent=ge[e.era]||`Era`,H.classList.toggle(`on`,e.era&&e.era!==`native`),S.textContent=e.inspect?`Exit`:`Inspect`,S.classList.toggle(`on`,!!e.inspect),w.textContent=e.world?`Exit`:`World`,w.classList.toggle(`on`,!!e.world),E.textContent=C[e.worldPreset]||`Valley`,T.style.display=e.world?``:`none`,I.style.display=e.world?``:`none`,E.style.display=e.world?``:`none`,D.style.display=e.world?``:`none`,D.classList.toggle(`on`,!!e.sculpt),A(e.tools),O.classList.toggle(`open`,!!e.sculpt),k&&k.forEach(t=>t.classList.toggle(`on`,t.dataset.id===e.editTool)),j.classList.toggle(`open`,!!e.sculpt);let n=e.editTool,r=n===`paint`,i=n===`scatter`,a=n===`place`,o=n===`sculpt`;M.textContent={place:`✚ Place`,sculpt:`⛰ Sculpt`,paint:`🎨 Paint`,scatter:`🌲 Objects`,select:`◳ Select`}[n]||`Editor`,ee.style.display=n===`select`?`none`:``,ne.style.display=o?``:`none`,N.style.display=i?``:`none`,ce(e.materials),L.style.display=r?``:`none`,se&&se.forEach((t,n)=>t.classList.toggle(`on`,n===e.material)),z(e.scatterKinds),le.style.display=i?``:`none`,R&&R.forEach(t=>t.classList.toggle(`on`,t.dataset.key===e.scatterType)),B(e.entityKinds),ue.style.display=a?``:`none`,de&&de.forEach(t=>t.classList.toggle(`on`,t.dataset.key===e.entityKind)),fe.seg.style.display=a?``:`none`,fe.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===String(e.dropN))),P.style.display=i||a||o?``:`none`,P.textContent=a?e.sculptRaise?`➕ Place`:`🗑 Delete`:i?e.sculptRaise?`➕ Add`:`➖ Erase`:e.sculptRaise?`↑ Raise`:`↓ Lower`,F.disabled=!e.canUndo,F.style.opacity=e.canUndo?``:`0.45`,oe.classList.toggle(`on`,!!e.scatterHidden),te.value=String(e.brushRadius),re.value=String(e.brushStrength),ie.value=String(e.brushDensity),V.classList.toggle(`on`,!!e.realistic),_e||(U.value=String(e.t))}Ne();let Pe=setInterval(Ne,200);function Fe(e){if(!je){a.style.display=`none`,ke.classList.remove(`on`),o.classList.remove(`open`),q.classList.remove(`open`),Ae.classList.remove(`on`);return}Me=e,a.style.display=e?`none`:`flex`,ke.classList.toggle(`on`,e),e&&(o.classList.remove(`open`),q.classList.remove(`open`),Ae.classList.remove(`on`))}function Ie(){Fe(!Me)}function Le(){if(!q.classList.contains(`open`))return;let e=a.getBoundingClientRect();q.style.bottom=Math.round(window.innerHeight-e.top+8)+`px`}let J=()=>Le();window.addEventListener(`resize`,J);let Re=null,ze=null;function Be(e){if(!je||Me){Ae.classList.remove(`on`),Re=null;return}if(!e){Ae.classList.remove(`on`),Re=``;return}e!==Re&&(Re=e,Ae.textContent=e,Ae.classList.add(`on`),clearTimeout(ze),ze=setTimeout(()=>Ae.classList.remove(`on`),2e3))}let Ve=null;function He(e){if(!je||!e){Se.classList.remove(`open`),Ve=null;return}let t=e.hint?`hint:${e.hint}`:`${e.kind}|${e.info}`;t!==Ve&&(Ve=t,e.hint?(Ce.textContent=`INSPECT`,we.textContent=`Free-fly`,Te.textContent=e.hint,De.style.display=``):(Ce.textContent=e.kind,we.textContent=e.label||e.kind,Te.textContent=e.info||``,De.style.display=``),Se.classList.add(`open`))}return{toggle:Ie,setHidden:Fe,refresh:Ne,setStyleHint:Be,setInspect:He,destroy(){clearInterval(Pe),window.removeEventListener(`resize`,J),a.remove(),o.remove(),q.remove(),ke.remove(),Ae.remove(),Se.remove(),O.remove(),j.remove(),i.remove(),clearTimeout(ze)}};function Ue(){let e=document.createElement(`div`);return e.className=`sep`,e}}var Gr=`lgr_hints_`,Kr=!1;function qr(){if(Kr||typeof document>`u`)return;Kr=!0;let e=document.createElement(`style`);e.textContent=`
