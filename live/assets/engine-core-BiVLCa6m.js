...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,rr={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},ir=[`gb`,`8-bit`,`16-bit`,`modern`],ar={"ink-gold (day)":[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],"ink-gold (night)":[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],"terminal (day)":[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],"terminal (night)":[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],"neutral (photoreal)":[`#1B1B1E`,`#3D3A3A`,`#5E5750`,`#867C70`,`#A99C8A`,`#C8BCAB`,`#E3DCCF`,`#F5F1E8`],"cool (noir)":[`#0A0E14`,`#16202E`,`#243447`,`#3A536B`,`#5A7D96`,`#86A6BD`,`#B6CDDA`,`#E6EEF2`],"warm (sunset)":[`#190B0A`,`#3B150F`,`#6E2A17`,`#A8421F`,`#DB702F`,`#F2A23E`,`#F9CF76`,`#FDF0C4`],"vibrant (pop)":[`#1A1A2E`,`#E43F5A`,`#F9A826`,`#FFE05D`,`#2EC4B6`,`#3A86FF`,`#8338EC`,`#FFFFFF`],"mono (ink)":[`#0C0C0C`,`#2A2A2A`,`#474747`,`#666666`,`#8A8A8A`,`#B0B0B0`,`#D6D6D6`,`#F5F5F5`]};function or(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new A(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let i=new pe(n,t,1,oe,r);return i.minFilter=c,i.magFilter=c,i.needsUpdate=!0,i}function sr(e,t){let n=[];for(let t=0;t+2<e.length;t+=3)n.push([e[t],e[t+1],e[t+2]]);if(n.length===0)return[`#000000`];let r=e=>{let t=[255,255,255],n=[0,0,0];for(let r of e)for(let e=0;e<3;e++)t[e]=Math.min(t[e],r[e]),n[e]=Math.max(n[e],r[e]);let r=[n[0]-t[0],n[1]-t[1],n[2]-t[2]],i=r[0]>=r[1]&&r[0]>=r[2]?0:r[1]>=r[2]?1:2;return{ax:i,range:r[i]}},i=[n];for(;i.length<t;){let e=-1,t=-1;if(i.forEach((n,i)=>{if(n.length>1){let{range:a}=r(n);a>t&&(t=a,e=i)}}),e<0)break;let n=i[e],{ax:a}=r(n);n.sort((e,t)=>e[a]-t[a]);let o=n.length>>1;i.splice(e,1,n.slice(0,o),n.slice(o))}return i.map(e=>{let t=[0,0,0];for(let n of e)for(let e=0;e<3;e++)t[e]+=n[e];return`#`+t.map(t=>Math.round(t/e.length)).map(e=>e.toString(16).padStart(2,`0`)).join(``)})}var cr=220,lr={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},ur={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function dr({demo:e=!1,citySeed:r=0,profileIndex:a=0}={}){let o=new te({antialias:!0,preserveDrawingBuffer:!0});o.shadowMap.enabled=!0,o.shadowMap.type=1,o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0;let l=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);o.setPixelRatio(Math.min(window.devicePixelRatio,l?1.5:2)),o.setSize(window.innerWidth,window.innerHeight),o.setClearColor(920327,1),document.body.appendChild(o.domElement);let u=o.getDrawingBufferSize(new W),d=new E;d.fog=new n(10465470,0);let f=new A(`#aeb6c0`),p=.062,g=new A(`#74508f`),b=new A,x=ke({aspect:window.innerWidth/window.innerHeight}),S=ft({t:.5}),T={type:ne,format:oe,minFilter:c,magFilter:c,wrapS:re,wrapT:re,depthBuffer:!1,stencilBuffer:!1},D=[new w(256,256,T),new w(256,256,T),new w(256,256,T)];for(let e of D)o.setRenderTarget(e),o.clear();o.setRenderTarget(null);let O=new E,ee=new s(-1,1,1,-1,0,1),k=new P({vertexShader:Kn,fragmentShader:qn,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new W(1/256,1/256)},uMouse:{value:new W(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new G)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new G)}}});O.add(new _(new m(2,2),k));let j=new w(u.x,u.y,{minFilter:h,magFilter:h,depthBuffer:!0,stencilBuffer:!1});function M(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new U(t);return r.colorSpace=H,r}let N=new _(new m(28,28),new y({map:M(e)}));N.rotation.x=-Math.PI/2,N.position.y=-.35,d.add(N);let F=new _(new m(40,24),new P({depthWrite:!1,vertexShader:Wn,fragmentShader:Gn,uniforms:{uTime:{value:0},uInk:{value:S.horizon},uGold:{value:S.sky},uFogColor:{value:b},uFogAmt:{value:0},uFogCharm:Ie}}));F.position.set(0,3,-8),d.add(F);let I=new P({vertexShader:Jn,fragmentShader:Yn,uniforms:{uHeight:{value:null},uScene:{value:j.texture},uTexel:{value:new W(1/256,1/256)},uResolution:{value:new W(u.x,u.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new v},uLightDir:{value:S.sunDir},uInk:{value:new A(`#2A2218`)},uGold:{value:new A(`#B89968`)},uVector:Ae,uVecWater:{value:new A(`#1fb8d8`)},uVecTint:{value:je}}}),L=new _(new m(28,28,255,255),I);L.rotation.x=-Math.PI/2,L.updateMatrixWorld(!0),I.uniforms.uNormalMatrix.value.getNormalMatrix(L.matrixWorld),d.add(L);let R={value:0},ie=Rt({windowGlow:R}),z=at({seed:r,profileIndex:a,landmarkFactory:ie,windowGlow:R});d.add(z.group);let ae=_t({plinthTop:.3,extent:z.extent,profile:z.state.profile});d.add(ae.group);let B=Et({extent:z.extent,waterSize:28,plinthTop:.3});d.add(B.group),k.uniforms.uWakeDrops.value=B.wakeDrops;let V=Bt({extent:z.extent});d.add(V.group),k.uniforms.uRainDrops.value=V.rainDrops;let se=Ht({extent:z.extent});d.add(se.group);let ce=Gt({rig:x,getCamera:()=>x.camera,sources:[ae,B,se]}),le=Un();d.add(le.group);let ue=En({scale:90});d.add(ue.mesh),d.environmentIntensity=.32;let de=!1;function fe(e){let t=e&&S.sunArc.y>-.04;t!==de&&(de=t,ue.mesh.visible=t,F.visible=!t)}let pe=null,me=-1;function he(){let e=Math.floor(S.t%1*4)%4;return(e!==me||!pe)&&(me=e,pe=ue.buildEnv(o)),pe}let K=null,ge=null,q=null,_e=null,ve=!1,ye=1234,be=`valley`,xe=Zt.map(e=>e.key),Se=new i({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Ce=()=>[z.group,ae.group,B.group],we=()=>[K,ge,q].filter(Boolean);function Te(){for(let e of we())d.remove(e),e.userData.dispose?.();let e=nn({seed:ye,size:160,preset:be});_e=e,K=un(e,{worldSize:26,baseY:0,chunks:6}),ge=Sn({terrain:e,seed:ye,worldSize:26,baseY:0,biomeKeys:xe}),q=Tn(e,{worldSize:26,baseY:0,maxLakes:3,material:Se});for(let e of we())e.visible=ve,d.add(e);typeof window<`u`&&(window.__world={seed:ye,preset:be,active:ve,chunks:K.children.length,scatter:ge.userData.counts,lakes:q.userData.count})}let Ee=e=>{for(let t of we())t.visible=e},De=null,Oe=new Set;function Re(){!_e||!q||(d.remove(q),q.userData.dispose?.(),q=Tn(_e,{worldSize:26,baseY:0,maxLakes:3,material:Se}),q.visible=ve,d.add(q),window.__world&&(window.__world.lakes=q.userData.count))}function ze(){Re(),ge&&xn(ge,_e,{worldSize:26,baseY:0})}function Be(){K&&dn(K,_e,K.children)}function Ve(e,t,n=1,r=2.2,i=.05){if(!_e||!K)return;let a=_e.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=_e.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Oe.clear();for(let e of K.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Oe.add(e)}dn(K,_e,Oe),De&&clearTimeout(De),De=setTimeout(ze,140)}let He=[];function Ue(){_e&&(He.push(_e.height.slice()),He.length>10&&He.shift())}function We(){return!_e||!He.length?!1:(_e.height.set(He.pop()),Be(),ze(),!0)}let J={enter(){K||Te(),ve=!0,Ee(!0);for(let e of Ce())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){ve=!1,Ee(!1);for(let e of Ce())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return ye=Math.random()*1e9|0,He.length=0,Te(),J.enter(),ye},reset(){return He.length=0,Te(),J.enter(),ye},setPreset(e){return tn.includes(e)&&(be=e,He.length=0,Te(),J.enter()),be},sculpt:Ve,repoolWater:Re,snapshot:Ue,undo:We,get terrainGroup(){return K},get canUndo(){return He.length>0},get active(){return ve},get seed(){return ye},get preset(){return be},get presets(){return tn}};z.group.remove(z.key),d.add(z.key),z.key.castShadow=!0,z.key.shadow.mapSize.set(2048,2048),z.key.shadow.bias=-18e-5,z.key.shadow.normalBias=.028,d.add(z.key.target);function Ge(){let e=z.key.shadow.camera,t=z.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),o.shadowMap.needsUpdate=!0}Ge();let Ke=new C(u.x,u.y),qe=new w(u.x,u.y,{minFilter:h,magFilter:h,depthBuffer:!0,stencilBuffer:!1,depthTexture:Ke}),Je=new w(u.x,u.y,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),Ye=new w(u.x,u.y,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),Xe=new w(u.x,u.y,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),Ze=Math.max(1,Math.floor(u.x/2)),Qe=Math.max(1,Math.floor(u.y/2)),$e=new w(Ze,Qe,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),et=new w(Ze,Qe,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),tt=new E,nt=new s(-1,1,1,-1,0,1),rt=new _(new m(2,2));tt.add(rt);let Y=new P({vertexShader:Kn,fragmentShader:Xn,uniforms:{uScene:{value:qe.texture},uTime:{value:0},uResolution:{value:new W(u.x,u.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:$e.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:S.grade.tint},uGradeLift:{value:S.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1}}}),it=new P({vertexShader:Kn,fragmentShader:er,uniforms:{uScene:{value:qe.texture},uThreshold:{value:.78}}}),ot=new P({vertexShader:Kn,fragmentShader:tr,uniforms:{uScene:{value:$e.texture},uDir:{value:new W}}});function st(e){it.uniforms.uScene.value=e.texture,gt(it,$e),ot.uniforms.uScene.value=$e.texture,ot.uniforms.uDir.value.set(1.6/Ze,0),gt(ot,et),ot.uniforms.uScene.value=et.texture,ot.uniforms.uDir.value.set(0,1.6/Qe),gt(ot,$e),Y.uniforms.uBloom.value=$e.texture;let n=1-t.clamp(S.sunArc.y*2.2,0,1);Y.uniforms.uBloomStrength.value=.85*(.32+.95*n)}let ct=e=>{let t=e.map(e=>new A(e));for(;t.length<8;)t.push(new A(0,0,0));return t},lt=[`night`,`dawn`,`noon`,`dusk`],ut={inkgold:lt.map(e=>ct(lr[e])),terminal:lt.map(e=>ct(ur[e]))},X=new P({vertexShader:Kn,fragmentShader:Zn,uniforms:{uScene:{value:Je.texture},uResolution:{value:new W(u.x,u.y)},uPixelSize:{value:cr},uPalette:{value:ut.inkgold[2]},uPaletteB:{value:ut.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),dt=new P({vertexShader:Kn,fragmentShader:nr,uniforms:{uScene:{value:Je.texture},uResolution:{value:new W(u.x,u.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:or(rr[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),pt={};for(let e of ir)pt[e]=rr[e].palette?or(rr[e].palette):null;let mt=new P({vertexShader:Kn,fragmentShader:Qn,uniforms:{uScene:{value:Je.texture},uDepth:{value:Ke},uResolution:{value:new W(u.x,u.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:S.toonFloor},uOutline:{value:S.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),ht=new P({vertexShader:Kn,fragmentShader:$n,uniforms:{uToon:{value:Ye.texture},uPixel:{value:Xe.texture},uBlend:{value:0}}});function gt(e,t){rt.material=e,o.setRenderTarget(t),o.render(tt,nt)}function vt(){x.setViewport(window.innerWidth,window.innerHeight),o.setSize(window.innerWidth,window.innerHeight);let e=o.getDrawingBufferSize(new W);return j.setSize(e.x,e.y),qe.setSize(e.x,e.y),Je.setSize(e.x,e.y),Ye.setSize(e.x,e.y),Xe.setSize(e.x,e.y),Ze=Math.max(1,e.x>>1),Qe=Math.max(1,e.y>>1),$e.setSize(Ze,Qe),et.setSize(Ze,Qe),I.uniforms.uResolution.value.set(e.x,e.y),Y.uniforms.uResolution.value.set(e.x,e.y),X.uniforms.uResolution.value.set(e.x,e.y),dt.uniforms.uResolution.value.set(e.x,e.y),mt.uniforms.uResolution.value.set(e.x,e.y),e}let Z=3,Q=!1,yt=!1,bt=`native`,xt=.3,St=.46,Ct=[`native`,...ir],wt={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=Z,window.__vector=Q,window.__era=bt);let Tt=0,Dt=performance.now(),Ot=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=Ot),Ot&&(o.info.autoReset=!1);let kt=null;typeof window<`u`&&(window.__loaded=!1);let $=0,At=new G(1,1,1),jt=!1;function Mt(e){let t=yt?ut.terminal:ut.inkgold,n=e%1*4,r=Math.floor(n)%4;X.uniforms.uPalette.value=t[r],X.uniforms.uPaletteB.value=t[(r+1)%4],X.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Nt(e){let t=rr[e];t&&(dt.uniforms.uGridWidth.value=t.gridWidth,dt.uniforms.uDither.value=t.dither,dt.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(dt.uniforms.uPalette.value=pt[e],dt.uniforms.uPaletteSize.value=t.palette.length))}function Pt(){bt!==`native`&&Nt(bt)}let Ft=()=>bt===`native`?X:dt;function It(e,t){fe(!0),d.environment=he(),L.visible=!1,o.setRenderTarget(j),o.render(d,e),L.visible=!0,o.setRenderTarget(qe),o.render(d,e),st(qe),Y.uniforms.uAces.value=1,Y.uniforms.uGrade.value=1,Y.uniforms.uGrain.value=0,Y.uniforms.uChroma.value=0,gt(Y,t)}function Lt(e,t){let n=!Q&&(Z===1||Z===2);if(fe(n),d.environment=n?he():null,Y.uniforms.uBloomStrength.value=0,L.visible=!1,o.setRenderTarget(j),o.render(d,x.camera),L.visible=!0,Z===1&&!n)o.setRenderTarget(t),o.render(d,x.camera);else if(Z===1)o.setRenderTarget(qe),o.render(d,x.camera),st(qe),Y.uniforms.uAces.value=1,Y.uniforms.uGrade.value=1,Y.uniforms.uGrain.value=0,Y.uniforms.uChroma.value=0,gt(Y,t);else if(o.setRenderTarget(qe),o.render(d,x.camera),Z===2)n&&st(qe),Y.uniforms.uAces.value=+!!n,Y.uniforms.uGrade.value=+!!n,Y.uniforms.uGrain.value=1,Y.uniforms.uChroma.value=1,gt(Y,t);else{Y.uniforms.uAces.value=0,Y.uniforms.uGrade.value=0,Y.uniforms.uGrain.value=0,Y.uniforms.uChroma.value=0,gt(Y,Je);let n=x.camera;mt.uniforms.uNear.value=n.near,mt.uniforms.uFar.value=n.far,mt.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Nt(e.era),dt):Ft();e.kind===`pixel`?(gt(r,t),window.__style=`pixel`):e.kind===`toon`?(gt(mt,t),window.__style=`toon`):(gt(mt,Ye),gt(r,Xe),ht.uniforms.uBlend.value=e.blend,gt(ht,t),window.__style=`blend`)}}function zt(){let e=Vt(),n=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return I.uniforms.uChromaScale.value=t.lerp(1,.5,n),e}function Vt(){if(Z===1||Z===2)return{kind:`none`};if(Z===7)return{kind:`pixel`};if(Z===8)return{kind:`toon`};let e=x.styleT;return window.__styleT=e,e<=xt?{kind:`toon`}:e>=St?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:t.smoothstep(e,xt,St),era:`16-bit`}}function Ut(e){return Z===1||Z===2?``:Q&&Z!==7&&Z!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?wt[e.era||bt]||`Pixel`:e.kind===`blend`?`Toon → `+(wt[e.era]||`Pixel`):``}function Wt(e,n,{shadowsOn:r=!0,seasonTarget:i=0}={}){if(Ot){let e=o.info;kt={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}F.material.uniforms.uTime.value=n,Y.uniforms.uTime.value=n,S.update(e),z.key.position.copy(S.sunDir).multiplyScalar(24),z.key.color.copy(S.sunColor),z.key.intensity=S.sunIntensity,z.fill.color.copy(S.hemiSky),z.fill.groundColor.copy(S.hemiGround),R.value=S.windowGlow,ue.setSun(S.sunArc),ue.setParams(S.skyParams),Y.uniforms.uGradeSat.value=S.grade.sat,Y.uniforms.uGradeContrast.value=S.grade.contrast,d.environmentIntensity=.34*(1-.6*t.clamp(S.sunArc.y*1.5,0,1));let a=V.overcast;z.key.intensity*=1-.5*a,z.key.color.lerp(f,.45*a),z.fill.intensity=1+.7*a;let s=t.smoothstep(S.sunDir.y,.06,.34),c=t.lerp(.28,1,1-S.windowGlow),l=r?s*c:0;z.key.shadow.intensity=.72*l,Me.value=.52*l,(r&&!jt||At.distanceToSquared(S.sunDir)>2e-5)&&(o.shadowMap.needsUpdate=!0,At.copy(S.sunDir)),jt=r;let u=1-S.windowGlow;je.setRGB(t.lerp(.46,1,u),t.lerp(.52,1,u),t.lerp(.74,1,u)),Y.uniforms.uExposure.value=S.exposure,mt.uniforms.uToonGain.value=S.toonGain,o.setClearColor(S.horizon,1),Mt(S.t),window.__t=S.t,ae.update(e,n,S),z.update(n),B.update(e,n,S),k.uniforms.uWakeCount.value=B.wakeCount,V.update(e,n),k.uniforms.uRainCount.value=V.rainDropCount;let m=V.fog*(1-u);d.fog.density=V.fog*p,b.copy(S.horizon).lerp(g,.85*m),d.fog.color.copy(b),o.setClearColor(b,1),Ie.value=V.fog,F.material.uniforms.uFogAmt.value=.7*V.fog,Ne.value=V.snow,Pe.value=V.cloud*.55,Fe.x+=e*.018,Fe.y+=e*.009,Le.value+=(i-Le.value)*Math.min(1,e*1.5),se.update(e,n,S,V);let h=Vt(),_=h.kind===`pixel`||h.kind===`blend`?`pixel`:Q||h.kind===`toon`?`charm`:`realistic`;le.update(e,n,S,V,_),Tt++;let v=performance.now();v-Dt>=1e3&&(window.__fps=Tt,Ot&&kt&&(console.log(`[perf] ${Tt} fps · ~${(1e3/Math.max(1,Tt)).toFixed(2)} ms · calls ${kt.calls} · tris ${kt.tris} · programs ${kt.programs} · geo ${kt.geo} · tex ${kt.tex}`),window.__perfInfo={fps:Tt,...kt}),Tt=0,Dt=v);let[y,x,C]=D;if(k.uniforms.uPrev.value=y.texture,k.uniforms.uCurr.value=x.texture,o.setRenderTarget(C),o.render(O,ee),D=[x,C,y],I.uniforms.uHeight.value=D[1].texture,$<2&&typeof document<`u`&&++$===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Kt(e){Z=e,window.__mode=Z}function qt(){return Q=!Q,Ae.value=+!!Q,window.__vector=Q,Q}function Jt(e){return Q=!!e,Ae.value=+!!Q,window.__vector=Q,Q}function Yt(){return bt=Ct[(Ct.indexOf(bt)+1)%Ct.length],window.__era=bt,Pt(),bt}function Xt(){return yt=!yt,yt}return{updateWorld:Wt,decideStyle:zt,renderCityPipeline:Lt,renderCityBeautyTo:It,styleHintName:Ut,setPostMode:Kt,toggleVector:qt,setVector:Jt,cycleEra:Yt,togglePalette:Xt,get mode(){return Z},get vector(){return Q},get sceneEra(){return bt},renderer:o,drawBuffer:u,scene:d,rig:x,sunRig:S,SIM:256,targets:D,simScene:O,simCamera:ee,simMaterial:k,grabRT:j,card:N,backdrop:F,WATER_SIZE:28,water:L,waterMaterial:I,windowGlow:R,landmarkFactory:ie,city:z,cityLife:ae,waterLife:B,weatherRig:V,clouds:se,inspector:ce,world:J,fitShadowFrustum:Ge,SHADOW_DIST:24,sceneDepth:Ke,sceneRT:qe,filmicRT:Je,toonRT:Ye,pixelRT:Xe,postScene:tt,postCamera:nt,postQuad:rt,filmicMaterial:Y,pixelMaterial:X,pixelkitMaterial:dt,toonMaterial:mt,mixMaterial:ht,PALCACHE:ut,ERA_TEX:pt,runPass:gt,OVERCAST_GREY:f,FOG_DENSITY:p,FOG_NIGHT_TINT:g,_fogColor:b,resize:vt}}var fr=[`video/mp4;codecs=avc1.42E01E`,`video/mp4`,`video/webm;codecs=vp9`,`video/webm`];function pr({renderer:e,rig:t,sunRig:n,poke:r,getState:i,office:a={}}){let o=e.domElement,s=new URLSearchParams(window.location.search),c=e=>{let t=i();return`lgr-${t.lesson}-${String(t.clock||``).replace(`:`,``)}-${t.style}.${e}`},l=(e,t)=>{let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,document.body.appendChild(r),r.click(),r.remove(),setTimeout(()=>URL.revokeObjectURL(n),1e3)};function u(){o.toBlob(e=>{e&&(l(e,c(`png`)),window.__lastStill=e.size)},`image/png`)}let d=()=>fr.find(e=>window.MediaRecorder&&MediaRecorder.isTypeSupported(e))||``,f=mr(),p=null,m=[],h=!1;function g(){if(h)return;let e=d(),t=o.captureStream(60);p=new MediaRecorder(t,e?{mimeType:e,videoBitsPerSecond:12e6}:{}),m=[],p.ondataavailable=e=>{e.data&&e.data.size&&m.push(e.data)},p.onstop=()=>{let e=new Blob(m,{type:p.mimeType});l(e,c(p.mimeType.includes(`mp4`)?`mp4`:`webm`)),window.__lastVideo=e.size},p.start(),h=!0,window.__recording=!0,f.show()}function _(){h&&(p.stop(),h=!1,window.__recording=!1,f.hide())}let v=()=>h?_():g(),y=e=>new Promise(t=>setTimeout(t,e)),b=e=>window.dispatchEvent(new KeyboardEvent(`keydown`,{key:e}));async function x(){let e=o.clientWidth,t=o.clientHeight,n=e*.26,i=t*.74;for(let t=0;t<=10;t++)r.at(n+t*e*.028,i+Math.sin(t*.7)*16),await y(100);r.stop()}async function S(e){if(e.keys)for(let t of e.keys)b(t),await y(70);e.zoom&&t.zoomBy(e.zoom),e.orbit&&t.orbit(e.orbit[0],e.orbit[1]),e.timeTo!==void 0&&n.goTo(e.timeTo),e.office&&a[e.office]?.(),e.ripple&&await x(),e.waitMs&&await y(e.waitMs)}let C={tour:[{keys:[`6`,`0`],waitMs:600},{zoom:.72,waitMs:1700},{ripple:!0,waitMs:2400},{orbit:[.55,0],waitMs:1700},{timeTo:0,waitMs:3e3},{timeTo:.5,waitMs:1500},{keys:[`7`],waitMs:1e3},{zoom:1.5,waitMs:1400},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`8`],waitMs:900},{zoom:.65,waitMs:1200},{ripple:!0,waitMs:2600},{keys:[`7`],waitMs:700},{keys:[`B`],waitMs:300},{keys:[`B`],waitMs:900},{zoom:1.4,waitMs:2600}],daycycle:[{keys:[`6`,`0`],waitMs:700},{timeTo:.75,waitMs:2600},{timeTo:1,waitMs:2600},{timeTo:1.25,waitMs:2600},{timeTo:1.5,waitMs:2600},{timeTo:1.5,waitMs:800}],office:[{keys:[`o`],waitMs:1700},{office:`pet`,waitMs:1300},{office:`feed`,waitMs:1700},{office:`travel`,waitMs:1700},{keys:[`W`,`W`,`W`],waitMs:1800},{timeTo:0,waitMs:2400},{office:`laptop`,waitMs:800},{office:`closeLaptop`,waitMs:300},{timeTo:.5,waitMs:900},{keys:[`W`],waitMs:200},{keys:[`o`],waitMs:1500}],cities:[{keys:[`6`,`0`],waitMs:500},{timeTo:.78,waitMs:2800},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:2e3}],water:[{keys:[`6`,`0`],waitMs:600},{zoom:1.35,waitMs:2800},{orbit:[.7,0],waitMs:2600},{ripple:!0,waitMs:2200},{timeTo:0,waitMs:3200},{timeTo:.5,waitMs:1500},{orbit:[-.5,0],waitMs:2200}],morph:[{keys:[`6`,`3`],waitMs:700},{zoom:.55,waitMs:1800},{zoom:2.3,waitMs:1700},{zoom:1.26,waitMs:1700},{zoom:1.16,waitMs:1900},{zoom:.3,waitMs:2200}],skin:[{keys:[`o`],waitMs:1800},{keys:[`j`],waitMs:2e3},{keys:[`j`],waitMs:2e3},{timeTo:0,waitMs:2600},{timeTo:.5,waitMs:1500},{keys:[`u`],waitMs:2e3},{keys:[`j`],waitMs:1400},{keys:[`o`],waitMs:1500}]};async function w(e){let t=C[e];if(t){window.__director=e;for(let e of t)await S(e);window.__director=null}}async function T(e){await y(1600),g(),await w(e),await y(400),_(),window.__captureDone=!0}window.addEventListener(`keydown`,e=>{(e.key===`s`||e.key===`S`)&&u(),(e.key===`r`||e.key===`R`)&&v()});let E=s.get(`capture`);return E&&C[E]&&T(E),window.__capture={still:u,toggleRec:v,run:w,sequences:Object.keys(C)},window.__capture}function mr(){let e=document.createElement(`div`);return e.textContent=`● REC`,e.style.cssText=`position:fixed;top:14px;right:16px;z-index:2;font:bold 12px ui-monospace,monospace;color:#ff3b30;letter-spacing:.12em;text-shadow:0 1px 3px #000;display:none;`,document.body.appendChild(e),{show:()=>{e.style.display=`block`},hide:()=>{e.style.display=`none`}}}var hr=`
...
`;function gr({controls:e,state:t,show:n,coarse:r}){if(typeof document>`u`)return;let i=document.createElement(`style`);i.textContent=hr,document.head.appendChild(i);let a=document.createElement(`div`);a.className=`vui`;let o=document.createElement(`div`);o.className=`vui-info`,o.innerHTML=`KEYS · 4/5/6 cam · 0 vector · 7/8 pixel/toon · B era · T time · [ ] scrub · 9 auto · C city · G shuffle · W weather · K season · click a building / O office · J office skin · U painted props · Esc exit · M hide UI · S still · R rec · H shadows · P theme · drag water to ripple`;let s=(e,t,n)=>{let r=document.createElement(`button`);return r.textContent=e,n&&(r.title=n),r.addEventListener(`click`,e=>{navigator.vibrate?.(10),t(e)}),r},c=e=>{let t=document.createElement(`div`);return t.className=`seg`,{seg:t,btns:e.map(([n,r])=>{let i=s(n,()=>e.find(e=>e[1]===r)[2](),n);return i.dataset.val=r,t.appendChild(i),i})}},l=s(`City`,()=>e.city(),`Next city profile (C)`),u=s(`Shuffle`,()=>e.shuffle(),`New random seed (G)`),d={clear:`Clear`,rain:`Rain`,snow:`Snow`,fog:`Fog`},f=[`Spring`,`Summer`,`Autumn`,`Winter`],p=s(`Clear`,()=>e.weather(),`Cycle weather: clear→rain→snow→fog (W)`),m=s(`Spring`,()=>e.season(),`Cycle season: spring→summer→autumn→winter (K)`),h=s(`Office`,()=>e.office(),`Dive into / exit the office (O · Esc)`),g={"3d":`3D`,dressed2:`Dressed`,night2:`Night`,modern:`Modern`,charm:`Charm`},_=s(`Skin`,()=>e.officeSkin(),`Office look: 3D → dressed → night → modern → charm diffusion (J)`),v={painted:`Painted`,"3d":`Live 3D`},y=s(`Props`,()=>e.officeProps(),`Office props: painted (cohesive) ↔ live 3D (animated) — under a skin (U)`),b=s(`Inspect`,()=>e.inspect(),`Inspect: fly + click/tap any car·person·bird·boat·cloud to follow + watch its behaviour (I)`),x={valley:`Valley`,archipelago:`Archi`,mountains:`Mountains`,plains:`Plains`},S=s(`World`,()=>e.world(),`Generate + explore a procedural terrain world`),C=s(`🎲`,()=>e.worldReroll(),`New random world (seed) — G`),w=s(`Valley`,()=>e.worldPreset(),`Cycle biome preset: valley → archipelago → mountains → plains`),T=s(`⛰ Sculpt`,()=>e.sculpt&&e.sculpt(),`Sculpt the land — drag to raise, Shift-drag to lower; the water re-pools + trees follow`),E=s(`↑ Raise`,()=>e.sculptDir&&e.sculptDir(),`Brush direction: raise ↔ lower (for touch / no-modifier)`),D=s(`↶ Undo`,()=>e.worldUndo&&e.worldUndo(),`Undo the last sculpt stroke (Z)`),O=s(`↺ Reset`,()=>e.worldReset&&e.worldReset(),`Reset to the generated world (discard sculpt) — same seed, NOT a reroll`),ee=s(`✨ Realistic`,()=>e.realistic(),`Cinematic beauty look — atmospheric sky, glowing sun, colour-graded (showcase)`),k=c([[`Auto`,`auto`,()=>e.post(`auto`)],[`Pixel`,`pixel`,()=>e.post(`pixel`)],[`Toon`,`toon`,()=>e.post(`toon`)],[`None`,`none`,()=>e.post(`none`)]]);k.btns[0].title=`AUTO: zoom morphs the style (toon → 16-bit → 8-bit → Game Boy)`,k.btns[3].title=`NONE: raw beauty render, no post-crunch (clean flat-vector when Vector is on)`;let A=s(`Vector`,()=>e.vector(),`Flat-vector materials — LAYERS onto the post mode (Vector + Pixel/Toon/Auto). Toggle (0)`),j={native:`Era`,gb:`GB`,"8-bit":`8-bit`,"16-bit":`16-bit`,modern:`Modern`,"1-bit":`1-bit`},te=s(`Era`,()=>e.era(),`Cycle the pixel era (B): native → GB → 8-bit → 16-bit → Modern`),M=document.createElement(`input`);M.type=`range`,M.min=`0`,M.max=`1`,M.step=`0.01`,M.title=`Time of day`;let ne=!1;M.addEventListener(`pointerdown`,()=>{ne=!0}),M.addEventListener(`pointerup`,()=>{ne=!1}),M.addEventListener(`input`,()=>e.time(parseFloat(M.value)));let N=s(`▶`,()=>e.auto(),`Play/pause day cycle (9)`),P=document.createElement(`div`);P.style.cssText=`display:flex;align-items:center;gap:6px;`;let re=document.createElement(`span`);re.className=`lbl`,re.textContent=`Day`,P.append(re,M,N);let F=c([[`Iso`,`iso`,()=>e.cam(`iso`)],[`Dim`,`dimetric`,()=>e.cam(`dimetric`)],[`3D`,`persp`,()=>e.cam(`persp`)]]),I=s(`ⓘ`,()=>o.classList.toggle(`open`),`All keys`),L=s(`⌄`,()=>fe(!0),`Hide controls — watch unobstructed (M)`),R=document.createElement(`div`);R.className=`vui-more`;let ie=s(`More`,()=>{R.classList.toggle(`open`),G()},`More controls`);if(r){a.append(l,u,h,b,S,N,k.seg,ie,L);let e=document.createElement(`div`);e.style.cssText=`display:flex;align-items:center;gap:6px;`,e.append(re,M),R.append(ee,C,O,w,T,E,D,p,m,_,y,A,te,F.seg,e)}else a.append(l,u,ve(),p,m,h,_,y,ve(),b,S,C,O,w,T,E,D,ve(),k.seg,ee,A,te,ve(),P,ve(),F.seg,I,ve(),L);let z=document.createElement(`div`);z.className=`vui-inspect`;let ae=document.createElement(`div`);ae.className=`ik`;let B=document.createElement(`div`);B.className=`it`;let oe=document.createElement(`div`);oe.className=`ii`;let V=document.createElement(`div`);V.className=`ir`;let H=s(`▸ Next`,()=>e.inspectNext&&e.inspectNext(),`Follow the next object (Tab)`),se=s(`✕`,()=>e.inspect(),`Exit inspect (Esc)`);V.append(H,se),z.append(ae,B,oe,V);let ce=document.createElement(`button`);ce.className=`vui-show`,ce.innerHTML=`⌃ Controls`,ce.title=`Show controls (M)`,ce.addEventListener(`click`,()=>fe(!1));let U=document.createElement(`div`);U.className=`vui-style`,document.body.append(o,R,a,ce,U,z);let le=n,ue=!1;fe(r);function W(){let e=t();k.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===e.post)),A.classList.toggle(`on`,!!e.vector),F.btns.forEach(t=>t.classList.toggle(`on`,t.dataset.val===e.cam)),p.textContent=d[e.weather]||`Clear`,p.classList.toggle(`on`,e.weather!==`clear`),m.textContent=f[e.season]||`Spring`,m.classList.toggle(`on`,(e.season||0)>0),h.textContent=e.office?`Exit`:`Office`,h.classList.toggle(`on`,!!e.office),_.textContent=g[e.officeSkin]||`Skin`,_.classList.toggle(`on`,e.officeSkin&&e.officeSkin!==`3d`),y.textContent=v[e.officeProps]||`Props`,y.classList.toggle(`on`,e.officeProps===`painted`&&e.officeSkin&&e.officeSkin!==`3d`),N.textContent=e.auto?`❚❚`:`▶`,N.classList.toggle(`on`,e.auto),te.textContent=j[e.era]||`Era`,te.classList.toggle(`on`,e.era&&e.era!==`native`),b.textContent=e.inspect?`Exit`:`Inspect`,b.classList.toggle(`on`,!!e.inspect),S.textContent=e.world?`Exit`:`World`,S.classList.toggle(`on`,!!e.world),w.textContent=x[e.worldPreset]||`Valley`,C.style.display=e.world?``:`none`,O.style.display=e.world?``:`none`,w.style.display=e.world?``:`none`,T.style.display=e.world?``:`none`,T.classList.toggle(`on`,!!e.sculpt),E.style.display=e.sculpt?``:`none`,D.style.display=e.sculpt?``:`none`,E.textContent=e.sculptRaise?`↑ Raise`:`↓ Lower`,D.disabled=!e.canUndo,D.style.opacity=e.canUndo?``:`0.45`,ee.classList.toggle(`on`,!!e.realistic),ne||(M.value=String(e.t))}W();let de=setInterval(W,200);function fe(e){if(!le){a.style.display=`none`,ce.classList.remove(`on`),o.classList.remove(`open`),R.classList.remove(`open`),U.classList.remove(`on`);return}ue=e,a.style.display=e?`none`:`flex`,ce.classList.toggle(`on`,e),e&&(o.classList.remove(`open`),R.classList.remove(`open`),U.classList.remove(`on`))}function pe(){fe(!ue)}function G(){if(!R.classList.contains(`open`))return;let e=a.getBoundingClientRect();R.style.bottom=Math.round(window.innerHeight-e.top+8)+`px`}let me=()=>G();window.addEventListener(`resize`,me);let he=null,K=null;function ge(e){if(!le||ue){U.classList.remove(`on`),he=null;return}if(!e){U.classList.remove(`on`),he=``;return}e!==he&&(he=e,U.textContent=e,U.classList.add(`on`),clearTimeout(K),K=setTimeout(()=>U.classList.remove(`on`),2e3))}let q=null;function _e(e){if(!le||!e){z.classList.remove(`open`),q=null;return}let t=e.hint?`hint:${e.hint}`:`${e.kind}|${e.info}`;t!==q&&(q=t,e.hint?(ae.textContent=`INSPECT`,B.textContent=`Free-fly`,oe.textContent=e.hint,H.style.display=``):(ae.textContent=e.kind,B.textContent=e.label||e.kind,oe.textContent=e.info||``,H.style.display=``),z.classList.add(`open`))}return{toggle:pe,setHidden:fe,refresh:W,setStyleHint:ge,setInspect:_e,destroy(){clearInterval(de),window.removeEventListener(`resize`,me),a.remove(),o.remove(),R.remove(),ce.remove(),U.remove(),z.remove(),i.remove(),clearTimeout(K)}};function ve(){let e=document.createElement(`div`);return e.className=`sep`,e}}var _r=`lgr_hints_`,vr=!1;function yr(){if(vr||typeof document>`u`)return;vr=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var xr=`precision highp float;
...
void main() {
  ...
  gl_FragColor = vec4(col, 1.0);
}`;function Sr({rate:e=4.6}={}){let t=new P({vertexShader:Kn,fragmentShader:xr,uniforms:{uA:{value:null},uB:{value:null},uT:{value:0},uFocus:{value:new W(.5,.5)}}}),n=`a`,r=0;function i(e,n){t.uniforms.uA.value=e,t.uniforms.uB.value=n}function a(e){return n===`a`?(e&&t.uniforms.uFocus.value.copy(e),n=`in`,!0):!1}function o(){return n!==`b`&&n!==`in`?!1:(n=`out`,!0)}function s(e){n=e===`b`?`b`:`a`,r=+(e===`b`),t.uniforms.uT.value=r}function c(i){return r+=(+(n===`b`||n===`in`)-r)*Math.min(1,i*e),n===`in`&&r>.992&&(r=1,n=`b`),n===`out`&&r<.008&&(r=0,n=`a`),t.uniforms.uT.value=r,n}return{material:t,setSources:i,enter:a,exit:o,update:c,snap:s,get mode(){return n},get t(){return r},get transitioning(){return n===`in`||n===`out`}}}var Cr=null;function wr(){if(Cr)return Cr;let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(0,0,0,0.60)`),n.addColorStop(.55,`rgba(0,0,0,0.32)`),n.addColorStop(1,`rgba(0,0,0,0.0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,Math.PI*2),t.fill(),Cr=new U(e),Cr.colorSpace=H,Cr}function Tr({w:e=.6,d:t=.6,x:n=0,y:r=.002,z:i=0,opacity:a=.5,rotation:o=0}={}){let s=new _(new m(e,t),new y({map:wr(),transparent:!0,opacity:a,depthWrite:!1,toneMapped:!1}));return s.rotation.x=-Math.PI/2,s.rotation.z=o,s.position.set(n,r,i),s.renderOrder=-1,s.raycast=()=>{},s}function Er({yawLimit:e=80,pitchUp:t=32,pitchDown:n=20,sensitivity:r=.16,keySpeed:i=70,damp:a=9}={}){let o=Math.PI/180,s=(e,t,n)=>e<t?t:e>n?n:e,c=0,l=0,u=0,d=0;return{addDrag(i,a){u=s(u-i*r,-e,e),d=s(d-a*r,-n,t)},addKeys(r,{left:a,right:o,up:c,down:l}){let f=i*r;a&&(u=s(u+f,-e,e)),o&&(u=s(u-f,-e,e)),c&&(d=s(d+f,-n,t)),l&&(d=s(d-f,-n,t))},recenter(){u=0,d=0},update(e){let t=1-Math.exp(-a*e);c+=(u-c)*t,l+=(d-l)*t},get yaw(){return c*o},get pitch(){return l*o},get active(){return Math.abs(c)>.05||Math.abs(l)>.05}}}var Dr=null;function Or(){if(Dr)return Dr;let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(256/2,256/2,256*.32,256/2,256/2,256*.72);return n.addColorStop(0,`rgba(0,0,0,0)`),n.addColorStop(1,`rgba(0,0,0,1)`),t.fillStyle=n,t.fillRect(0,0,256,256),Dr=new U(e),Dr.colorSpace=H,Dr}function kr({strength:e=.55,dist:n=.5}={}){let r=new _(new m(1,1),new y({map:Or(),transparent:!0,opacity:e,depthTest:!1,depthWrite:!1,toneMapped:!1}));r.renderOrder=9999,r.raycast=()=>{},r.frustumCulled=!1;let i=new G;return r.fit=e=>{e.getWorldDirection(i),r.position.copy(e.position).addScaledVector(i,n),r.quaternion.copy(e.quaternion);let a=2*Math.tan(t.degToRad(e.fov)*.5)*n*1.05;r.scale.set(a*e.aspect,a,1)},r}export{Je as _,br as a,dr as c,or as d,sr as f,qe as g,Z as h,Sr as i,rr as l,Kn as m,Tr as n,gr as o,nr as p,kr as r,pr as s,Er as t,ar as u,J as v,q as y};