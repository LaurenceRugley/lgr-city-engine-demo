...
#include <shadowmask_pars_fragment>`)}var Ge=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Ke(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new M(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{He(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new M(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=X(e.vertexShader),e.fragmentShader=Ue(We(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function Z(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{He(e),s||(e.uniforms.uVecColor={value:new M(t)}),c&&(e.uniforms.uGlow={value:new M(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=Be),e.vertexShader=X(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
void main() {
  ...
  gl_FragColor = vec4(st.x, Snew, 0.0, 0.0);
}`;function zn({renderer:e,N:t,cell:n,half:r,worldSize:o,seaY:s=0,FLOW:u,DAMP:d,MIN_DEPTH:f,KC:p,KE:m,KD:g,KADV:_,MAXD:y,readTerrain:b}){let x=e.getContext();if(!(x&&x.getExtension&&x.getExtension(`EXT_color_buffer_float`)))return typeof console<`u`&&console.warn(`[L87] EXT_color_buffer_float unavailable — GPU flow backend cannot run; staying on CPU.`),null;let S={type:i,format:ue,minFilter:l,magFilter:l,wrapS:ie,wrapT:ie,depthBuffer:!1,stencilBuffer:!1},C=[new W(t,t,S),new W(t,t,S)],w=[new W(t,t,S),new W(t,t,S)],T=[new W(t,t,S),new W(t,t,S)],k=new Float32Array(t*t*4),A=new he(k,t,t,ue,i);A.minFilter=l,A.magFilter=l,A.wrapS=A.wrapT=ie;let te=new Float32Array(t*t),j=!1,N=1,ne=!0,P=new O,F=new c(-1,1,1,-1,0,1),L=new v(new h(2,2),null);L.frustumCulled=!1,P.add(L);let ae=new G(1/t,1/t),oe=(e,t)=>new I({vertexShader:jn,fragmentShader:e,uniforms:t}),se=oe(Mn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uFlow:{value:u},uDamp:{value:d}}),ce=oe(Nn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uSeaY:{value:s}}),R=oe(Pn,{uState:{value:null},uTerr:{value:null},uN:{value:t},uSeaY:{value:s},uRain:{value:0},uPourCount:{value:0},uPours:{value:Array.from({length:8},()=>new E)},uPourR:{value:new Float32Array(8)}}),le=oe(Fn,{uSrc:{value:A}}),z=()=>({uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uCell:{value:n},uSeaY:{value:s},uKC:{value:p},uKE:{value:m},uKD:{value:g},uMaxD:{value:y},uMinDepth:{value:f},uErosK:{value:N}}),B=oe(In,z()),de=oe(Ln,z()),V=oe(Rn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:ae},uN:{value:t},uDt:{value:0},uSeaY:{value:s},uKADV:{value:_}});function H(t,n){L.material=t;let r=e.getRenderTarget();e.setRenderTarget(n),e.render(P,F),e.setRenderTarget(r)}let fe=new M;function pe(t){let n=e.getRenderTarget(),r=e.getClearAlpha();e.getClearColor(fe),e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1),e.setClearColor(fe,r),e.setRenderTarget(n)}function U(){b(te);for(let e=0;e<t*t;e++)k[e*4]=te[e];A.needsUpdate=!0,H(le,T[0])}function me(){pe(C[0]),pe(C[1]),pe(w[0]),pe(w[1])}me();let ge=t*t,_e=new Float32Array(ge*3),ve=new Float32Array(ge*2);for(let e=0;e<t;e++)for(let i=0;i<t;i++){let a=e*t+i;_e[a*3]=i*n-r,_e[a*3+1]=0,_e[a*3+2]=e*n-r,ve[a*2]=(i+.5)/t,ve[a*2+1]=(e+.5)/t}let ye=[];for(let e=0;e<t-1;e++)for(let n=0;n<t-1;n++){let r=e*t+n,i=e*t+n+1,a=(e+1)*t+n,o=(e+1)*t+n+1;ye.push(r,a,i,i,a,o)}let be=new re;be.setAttribute(`position`,new D(_e,3)),be.setAttribute(`aGridUv`,new D(ve,2)),be.setIndex(ye),be.boundingSphere=new ee(new E(0,0,0),o);let xe={uStateTex:{value:C[0].texture},uTerrTex:{value:T[0].texture},uMinDepth:{value:f}},Se=new a({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});Se.onBeforeCompile=e=>{e.uniforms.uStateTex=xe.uStateTex,e.uniforms.uTerrTex=xe.uTerrTex,e.uniforms.uMinDepth=xe.uMinDepth,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
varying float vDepth;`).replace(`#include <dithering_fragment>`,`#include <dithering_fragment>
  ...
  gl_FragColor.a *= clamp((vDepth - 0.012) * 7.0, 0.16, 0.86);`)},Se.customProgramCacheKey=()=>`lgr-flow-gpu`;let Ce=new v(be,Se);Ce.frustumCulled=!1,Ce.castShadow=!1,Ce.receiveShadow=!1,Ce.raycast=()=>{},Ce.renderOrder=3,Ce.visible=!1;function we(){xe.uStateTex.value=C[0].texture,xe.uTerrTex.value=T[0].texture}function K(e){e=Math.min(e,1/30),(!j||ne)&&(U(),ne=!1),se.uniforms.uState.value=C[0].texture,se.uniforms.uTerr.value=T[0].texture,se.uniforms.uFlux.value=w[0].texture,se.uniforms.uDt.value=e,H(se,w[1]),w.reverse(),ce.uniforms.uState.value=C[0].texture,ce.uniforms.uTerr.value=T[0].texture,ce.uniforms.uFlux.value=w[0].texture,ce.uniforms.uDt.value=e,H(ce,C[1]),C.reverse(),j&&(B.uniforms.uState.value=C[0].texture,B.uniforms.uTerr.value=T[0].texture,B.uniforms.uFlux.value=w[0].texture,B.uniforms.uDt.value=e,B.uniforms.uErosK.value=N,H(B,T[1]),de.uniforms.uState.value=C[0].texture,de.uniforms.uTerr.value=T[0].texture,de.uniforms.uFlux.value=w[0].texture,de.uniforms.uDt.value=e,de.uniforms.uErosK.value=N,H(de,C[1]),T.reverse(),C.reverse(),V.uniforms.uState.value=C[0].texture,V.uniforms.uTerr.value=T[0].texture,V.uniforms.uFlux.value=w[0].texture,V.uniforms.uDt.value=e,H(V,C[1]),C.reverse()),we()}function q(){R.uniforms.uState.value=C[0].texture,R.uniforms.uTerr.value=T[0].texture,H(R,C[1]),C.reverse(),we()}function Te(e,t,i=.5,a=1.6){(ne||!j)&&(U(),ne=!1);let o=(e+r)/n,s=(t+r)/n,c=Math.max(1,a/n);R.uniforms.uRain.value=0,R.uniforms.uPourCount.value=1,R.uniforms.uPours.value[0].set(o,s,i),R.uniforms.uPourR.value[0]=c,q()}function J(e=.004){(ne||!j)&&(U(),ne=!1),R.uniforms.uPourCount.value=0,R.uniforms.uRain.value=e,q()}function Ee(){me(),ne=!0,we()}function De(e,t){j=!!e,t!=null&&(N=Math.max(0,t)),ne=!0}let Y=new Float32Array(t*t*4);function Oe(n){return e.readRenderTargetPixels(n,0,0,t,t,Y),Y}function ke(){let e=Oe(C[0]),n=0;for(let r=0;r<t*t;r++)n+=e[r*4];return n}function Ae(e,i){let a=Math.round((e+r)/n),o=Math.round((i+r)/n);return a<0||a>=t||o<0||o>=t?0:Oe(C[0])[(o*t+a)*4]}function je(){let e=Oe(C[0]),n=0;for(let r=0;r<t*t;r++)n+=e[r*4+1];return n}function Me(){let e=Oe(C[0]),n=new Float32Array(t*t);for(let r=0;r<t*t;r++)n[r]=e[r*4];return n}function Ne(){let e=Oe(T[0]),n=new Float32Array(t*t);for(let r=0;r<t*t;r++)n[r]=e[r*4];return n}function Pe(e){Ce.visible=!!e}function Fe(){for(let e of C)e.dispose();for(let e of w)e.dispose();for(let e of T)e.dispose();A.dispose(),be.dispose(),Se.dispose(),L.geometry.dispose(),se.dispose(),ce.dispose(),R.dispose(),le.dispose(),B.dispose(),de.dispose(),V.dispose()}return{mesh:Ce,step:K,pourAt:Te,rain:J,clear:Ee,totalWater:ke,cellAt:Ae,totalSediment:je,readW:Me,readTerr:Ne,setErosion:De,setVisible:Pe,dispose:Fe,get grid(){return t},get erosion(){return j}}}function Bn({worldHeightAt:e,applyErosion:t=null,syncErodedTerrain:n=null,worldSize:r=26,grid:i=96,seaY:o=0,renderer:s=null}={}){let c=i,l=new Float32Array(c*c),u=new Float32Array(c*c),d=new Float32Array(c*c),f=new Float32Array(c*c),m=new Float32Array(c*c),h=new Float32Array(c*c),g=new Float32Array(c*c),_=new Float32Array(c*c),y=new Float32Array(c*c),b=!1,x=1,S=r/(c-1),C=r/2,w=e||(()=>0),T=e=>e*S-C,E=e=>e*S-C,O=(e,t)=>t*c+e,k=26*S,ee=.9,A=.006,te=.5,j=.25,M=.3,N=.006;function ne(){for(let e=0;e<c;e++)for(let t=0;t<c;t++)h[O(t,e)]=w(T(t),E(e))}let P=`cpu`,F=null,I=new Float32Array(c*c),ie=0;function L(e){ne();for(let t=0;t<c*c;t++)e[t]=h[t]}function ae(){return F||!s?F:(F=zn({renderer:s,N:c,cell:S,half:C,worldSize:r,seaY:o,FLOW:k,DAMP:ee,MIN_DEPTH:A,KC:te,KE:j*3,KD:M*3,KADV:6,MAXD:N*3,readTerrain:L}),F&&ge.add(F.mesh),F)}function oe(e){if(e===`gpu`){if(ae(),!F)return typeof console<`u`&&console.info(`[L87] GPU backend unavailable (no renderer / no float RT) — staying on CPU (oracle).`),P=`cpu`,se(),P;P=`gpu`,F.setErosion(b,x),b&&(L(I),ie=0)}else P=`cpu`;return se(),P}function se(){F&&F.setVisible(P===`gpu`),P===`gpu`?G.visible=!1:_e()}let ce=new Float32Array(c*c);function R(){if(++ie<20)return;ie=0;let e=F.readTerr(),t=!1;for(let n=0;n<c*c;n++){let r=e[n]-I[n];ce[n]=r,r!==0&&(t=!0),I[n]=e[n]}t&&n(ce,c)}function le(e){if(P===`gpu`&&F){F.step(e),b&&n&&R();return}e=Math.min(e,1/30),ne();for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t),i=h[r]+l[r],a=0,o=0,s=0,p=0;n>0&&(a=Math.max(0,u[r]*ee+e*k*(i-(h[r-1]+l[r-1])))),n<c-1&&(o=Math.max(0,d[r]*ee+e*k*(i-(h[r+1]+l[r+1])))),t>0&&(p=Math.max(0,m[r]*ee+e*k*(i-(h[r-c]+l[r-c])))),t<c-1&&(s=Math.max(0,f[r]*ee+e*k*(i-(h[r+c]+l[r+c]))));let g=(a+o+s+p)*e,_=g>1e-9?Math.min(1,l[r]/g):1;u[r]=a*_,d[r]=o*_,m[r]=p*_,f[r]=s*_}for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t),i=0;n>0&&(i+=d[r-1]),n<c-1&&(i+=u[r+1]),t>0&&(i+=f[r-c]),t<c-1&&(i+=m[r+c]);let a=u[r]+d[r]+m[r]+f[r];l[r]+=e*(i-a),l[r]<0&&(l[r]=0),h[r]<o-.02&&(l[r]=0)}b&&t&&ue(e),_e()}function ue(e){y.fill(0);for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t);if(l[r]<=A){if(g[r]>0){let t=Math.min(N,M*g[r]*e);y[r]+=t,g[r]-=t}continue}let i=(u[r]+d[r]+f[r]+m[r])/(l[r]+.02),a=n>0?h[r-1]:h[r],o=n<c-1?h[r+1]:h[r],s=t>0?h[r-c]:h[r],p=t<c-1?h[r+c]:h[r],_=Math.min(2,Math.hypot(o-a,p-s)/(2*S)),v=te*i*Math.max(.05,_)*x;if(v>g[r]){let t=Math.min(N,j*(v-g[r])*e);y[r]-=t,g[r]+=t}else{let t=Math.min(N,M*(g[r]-v)*e);y[r]+=t,g[r]-=t,g[r]<0&&(g[r]=0)}}_.set(g);for(let t=0;t<c;t++)for(let n=0;n<c;n++){let r=O(n,t),i=u[r]+d[r]+f[r]+m[r];if(i<=1e-9||g[r]<=1e-9)continue;let a=Math.min(g[r],g[r]*6*e);_[r]-=a,n>0&&(_[r-1]+=a*u[r]/i),n<c-1&&(_[r+1]+=a*d[r]/i),t>0&&(_[r-c]+=a*m[r]/i),t<c-1&&(_[r+c]+=a*f[r]/i)}g.set(_);for(let e=0;e<c*c;e++)g[e]<0&&(g[e]=0),h[e]<o-.02&&(g[e]=0);t(y,c)}function z(e,t){b=!!e,t!=null&&(x=Math.max(0,t)),e||g.fill(0),P===`gpu`&&F&&(F.setErosion(e,t),e&&(L(I),ie=0))}function B(e,t,n=.5,r=1.6){if(P===`gpu`&&F)return F.pourAt(e,t,n,r);let i=(e+C)/S,a=(t+C)/S,o=Math.max(1,r/S),s=Math.max(0,Math.floor(i-o)),u=Math.min(c-1,Math.ceil(i+o)),d=Math.max(0,Math.floor(a-o)),f=Math.min(c-1,Math.ceil(a+o));for(let e=d;e<=f;e++)for(let t=s;t<=u;t++){let r=Math.hypot(t-i,e-a);r<=o&&(l[O(t,e)]+=n*(1-r/o))}}function de(e=.004){if(P===`gpu`&&F)return F.rain(e);ne();for(let t=0;t<c*c;t++)h[t]>o&&(l[t]+=e)}function V(){if(P===`gpu`&&F)return F.clear();l.fill(0),u.fill(0),d.fill(0),f.fill(0),m.fill(0),g.fill(0),_e()}function H(){if(P===`gpu`&&F)return F.totalWater();let e=0;for(let t=0;t<c*c;t++)e+=l[t];return e}function fe(e,t){if(P===`gpu`&&F)return F.cellAt(e,t);let n=Math.round((e+C)/S),r=Math.round((t+C)/S);return n<0||n>=c||r<0||r>=c?0:l[O(n,r)]}let pe=new Float32Array(c*c*3),U=new Float32Array(c*c);for(let e=0;e<c;e++)for(let t=0;t<c;t++){let n=O(t,e);pe[n*3]=T(t),pe[n*3+1]=-50,pe[n*3+2]=E(e)}let me=[];for(let e=0;e<c-1;e++)for(let t=0;t<c-1;t++){let n=O(t,e),r=O(t+1,e),i=O(t,e+1),a=O(t+1,e+1);me.push(n,i,r,r,i,a)}let W=new re;W.setAttribute(`position`,new D(pe,3)),W.setAttribute(`aDepth`,new D(U,1)),W.setIndex(me),W.computeVertexNormals();let he=new a({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});he.onBeforeCompile=e=>{e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
attribute float aDepth;
varying float vDepth;`).replace(`#include <begin_vertex>`,`#include <begin_vertex>
  vDepth = aDepth;`),e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>
varying float vDepth;`).replace(`#include <dithering_fragment>`,`#include <dithering_fragment>
  if (vDepth < 0.012) discard;
  gl_FragColor.a *= clamp((vDepth - 0.012) * 7.0, 0.16, 0.86);`)},he.customProgramCacheKey=()=>`lgr-flow`;let G=new v(W,he);G.frustumCulled=!1,G.castShadow=!1,G.receiveShadow=!1,G.raycast=()=>{},G.renderOrder=3;let ge=new p;ge.add(G),ge.raycast=()=>{};function _e(){let e=0;for(let t=0;t<c*c;t++){let n=l[t];U[t]=n,pe[t*3+1]=n>A?h[t]+n:-50,n>A&&e++}W.attributes.position.needsUpdate=!0,W.attributes.aDepth.needsUpdate=!0,G.visible=e>0,typeof window<`u`&&(window.__flowWet=e)}_e();function ve(){if(P===`gpu`&&F)return F.totalSediment();let e=0;for(let t=0;t<c*c;t++)e+=g[t];return e}return{group:ge,step:le,pourAt:B,rain:de,clear:V,totalWater:H,cellAt:fe,setErosion:z,totalSediment:ve,setBackend:oe,get backend(){return P},_debugReadW:()=>P===`gpu`&&F?F.readW():l.slice(),_debugReadTerr:()=>P===`gpu`&&F?F.readTerr():(ne(),h.slice()),_debugReadS:()=>P===`gpu`&&F?F.totalSediment():ve(),_debugStepN:(e,t=1/60)=>{for(let n=0;n<e;n++)le(t)},get erosion(){return b},get grid(){return c},get visible(){return G.visible}}}function Vn({extent:e=26,count:t=2e3,seed:n=7,yLo:r=.4,yHi:i=7}={}){let a=Ze((n^218462737)>>>0),o=e/2,s=new Float32Array(t*3),c=new Float32Array(t),l=new Float32Array(t);for(let e=0;e<t;e++)s[e*3]=(a()*2-1)*o,s[e*3+1]=r+a()*(i-r),s[e*3+2]=(a()*2-1)*o,c[e]=a()*Math.PI*2,l[e]=.6+a()*.8;let u=new re;u.setAttribute(`position`,new D(s,3)),u.setAttribute(`aPh`,new D(c,1)),u.setAttribute(`aSp`,new D(l,1)),u.setDrawRange(0,t);let d={uTime:{value:0},uWind:{value:0},uHalf:{value:o},uOpacity:{value:0},uColor:{value:new M(`#fff3d4`)},uPx:{value:2.2}},f=new I({uniforms:d,transparent:!0,depthWrite:!1,depthTest:!0,blending:2,vertexShader:`
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Ci={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},wi=[`gb`,`8-bit`,`16-bit`,`modern`],Ti={"ink-gold (day)":[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],"ink-gold (night)":[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],"terminal (day)":[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],"terminal (night)":[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],"neutral (photoreal)":[`#1B1B1E`,`#3D3A3A`,`#5E5750`,`#867C70`,`#A99C8A`,`#C8BCAB`,`#E3DCCF`,`#F5F1E8`],"cool (noir)":[`#0A0E14`,`#16202E`,`#243447`,`#3A536B`,`#5A7D96`,`#86A6BD`,`#B6CDDA`,`#E6EEF2`],"warm (sunset)":[`#190B0A`,`#3B150F`,`#6E2A17`,`#A8421F`,`#DB702F`,`#F2A23E`,`#F9CF76`,`#FDF0C4`],"vibrant (pop)":[`#1A1A2E`,`#E43F5A`,`#F9A826`,`#FFE05D`,`#2EC4B6`,`#3A86FF`,`#8338EC`,`#FFFFFF`],"mono (ink)":[`#0C0C0C`,`#2A2A2A`,`#474747`,`#666666`,`#8A8A8A`,`#B0B0B0`,`#D6D6D6`,`#F5F5F5`]};function Ei(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new M(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new he(n,t,1,ue,i);return r.minFilter=l,r.magFilter=l,r.needsUpdate=!0,r}function Di(e,t){let n=[];for(let t=0;t+2<e.length;t+=3)n.push([e[t],e[t+1],e[t+2]]);if(n.length===0)return[`#000000`];let r=e=>{let t=[255,255,255],n=[0,0,0];for(let r of e)for(let e=0;e<3;e++)t[e]=Math.min(t[e],r[e]),n[e]=Math.max(n[e],r[e]);let r=[n[0]-t[0],n[1]-t[1],n[2]-t[2]],i=r[0]>=r[1]&&r[0]>=r[2]?0:r[1]>=r[2]?1:2;return{ax:i,range:r[i]}},i=[n];for(;i.length<t;){let e=-1,t=-1;if(i.forEach((n,i)=>{if(n.length>1){let{range:a}=r(n);a>t&&(t=a,e=i)}}),e<0)break;let n=i[e],{ax:a}=r(n);n.sort((e,t)=>e[a]-t[a]);let o=n.length>>1;i.splice(e,1,n.slice(0,o),n.slice(o))}return i.map(e=>{let t=[0,0,0];for(let n of e)for(let e=0;e<3;e++)t[e]+=n[e];return`#`+t.map(t=>Math.round(t/e.length)).map(e=>e.toString(16).padStart(2,`0`)).join(``)})}var Oi=220,ki={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Ai={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function ji(e){if(typeof document>`u`||document.getElementById(`lgr-nowebgl`))return;let t=document.createElement(`div`);t.id=`lgr-nowebgl`,t.style.cssText=`position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;background:#0e1116;color:#cdd6e4;font:16px/1.6 system-ui,-apple-system,sans-serif;text-align:center;padding:2rem;`,t.innerHTML=`<div style="max-width:30rem"><div style="font-size:2.4rem;margin-bottom:1rem">🌊</div><h1 style="font-size:1.3rem;margin:0 0 .6rem;color:#fff;font-weight:600">This experience needs a modern browser</h1><p style="margin:0;color:#9aa6b8">`+e+`</p></div>`,document.body&&document.body.appendChild(t)}function Mi({demo:e=!1,citySeed:n=0,profileIndex:i=0}={}){let o;try{o=new ne({antialias:!0,preserveDrawingBuffer:!0})}catch(e){throw ji(`This experience needs WebGL2 — please open it in an up-to-date browser (Chrome, Edge, Firefox, or Safari on iOS 15+) with hardware acceleration enabled.`),e}o.shadowMap.enabled=!0,o.shadowMap.type=1,o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0;let s=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches),u=s?1.5:2;o.setPixelRatio(Math.min(window.devicePixelRatio,u)),o.setSize(window.innerWidth,window.innerHeight),o.setClearColor(920327,1),document.body.appendChild(o.domElement);let d=o.getDrawingBufferSize(new G),f=!1,p=!1,m=()=>{};o.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),f=!0,typeof window<`u`&&(window.__contextLost=!0)},!1),o.domElement.addEventListener(`webglcontextrestored`,()=>{m(),f=!1,typeof window<`u`&&(window.__contextLost=!1)},!1);let _=new O;_.fog=new r(10465470,0);let x=new M(`#aeb6c0`),S=.062,C=new M(`#74508f`),w=new M,D=Me({aspect:window.innerWidth/window.innerHeight}),k=Ct({t:.5}),ee=o.getContext(),A=!!(ee&&ee.getExtension&&(ee.getExtension(`EXT_color_buffer_float`)||ee.getExtension(`EXT_color_buffer_half_float`)));!A&&typeof console<`u`&&console.info(`[L90 H1] No float colour buffer (EXT_color_buffer_float/half_float) — wave sim OFF, flat-sea fallback.`);let te={type:F,format:ue,minFilter:l,magFilter:l,wrapS:ie,wrapT:ie,depthBuffer:!1,stencilBuffer:!1},j=A?[new W(256,256,te),new W(256,256,te),new W(256,256,te)]:null;if(j){for(let e of j)o.setRenderTarget(e),o.clear();o.setRenderTarget(null)}let N=new he(new Uint8Array([0,0,0,255]),1,1,ue);N.needsUpdate=!0;let P=new O,re=new c(-1,1,1,-1,0,1),L=new I({vertexShader:jn,fragmentShader:pi,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new G(1/256,1/256)},uMouse:{value:new G(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new E)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new E)}}});P.add(new v(new h(2,2),L));let ae=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1});function oe(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new H(t);return r.colorSpace=B,r}let se=new v(new h(28,28),new b({map:oe(e)}));se.rotation.x=-Math.PI/2,se.position.y=-.35,_.add(se);let ce=new v(new h(40,24),new I({depthWrite:!1,vertexShader:di,fragmentShader:fi,uniforms:{uTime:{value:0},uInk:{value:k.horizon},uGold:{value:k.sky},uFogColor:{value:w},uFogAmt:{value:0},uFogCharm:ze}}));ce.position.set(0,3,-8),_.add(ce);let R=new I({vertexShader:mi,fragmentShader:hi,uniforms:{uHeight:{value:A?null:N},uScene:{value:ae.texture},uTexel:{value:new G(1/256,1/256)},uResolution:{value:new G(d.x,d.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new y},uLightDir:{value:k.sunDir},uInk:{value:new M(`#2A2218`)},uGold:{value:new M(`#B89968`)},uVector:Ne,uVecWater:{value:new M(`#1fb8d8`)},uVecTint:{value:Pe}}}),le=new v(new h(28,28,255,255),R);le.rotation.x=-Math.PI/2,le.updateMatrixWorld(!0),R.uniforms.uNormalMatrix.value.getNormalMatrix(le.matrixWorld),_.add(le);let z={value:0},de=Xt({windowGlow:z}),V=ht({seed:n,profileIndex:i,landmarkFactory:de,windowGlow:z});_.add(V.group);let fe=Ot({plinthTop:.3,extent:V.extent,profile:V.state.profile});_.add(fe.group);let pe=zt({extent:V.extent,waterSize:28,plinthTop:.3});_.add(pe.group),L.uniforms.uWakeDrops.value=pe.wakeDrops;let U=Qt({extent:V.extent});_.add(U.group),L.uniforms.uRainDrops.value=U.rainDrops;let me=en({extent:V.extent});_.add(me.group);let ge=[fe,pe,me],_e=rn({rig:D,getCamera:()=>D.camera,sources:ge}),ve=ui();_.add(ve.group);let ye=Kr({scale:90});_.add(ye.mesh),_.environmentIntensity=.32;let be=!1;function xe(e){let t=e&&k.sunArc.y>-.04;t!==be&&(be=t,ye.mesh.visible=t,ce.visible=!t)}let Se=null,Ce=-1;m=()=>{Se=null,Ce=-1,o.shadowMap.needsUpdate=!0};function we(){let e=Math.floor(k.t%1*4)%4;return(e!==Ce||!Se)&&(Ce=e,Se=ye.buildEnv(o)),Se}let K=null,q=null,Te=null,J=null,Ee=!1,De=1234,Y=`valley`,Oe=nr.map(e=>e.key),ke=new a({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Ae=()=>[V.group,fe.group,pe.group],je=()=>[K,q,Te].filter(Boolean);function Ve(){for(let e of je())_.remove(e),e.userData.dispose?.();let e=sr({seed:De,size:160,preset:Y});J=e,K=mr(e,{worldSize:26,baseY:0,chunks:6}),q=zr({terrain:e,seed:De,worldSize:26,baseY:0,biomeKeys:Oe}),Te=Hr(e,{worldSize:26,baseY:0,maxLakes:3,material:ke});for(let e of je())e.visible=Ee,_.add(e);X!==void 0&&X&&X.clear(),Z!==void 0&&Z&&Z.clear(),typeof window<`u`&&(window.__world={seed:De,preset:Y,active:Ee,chunks:K.children.length,scatter:q.userData.counts,lakes:Te.userData.count})}let He=e=>{for(let t of je())t.visible=e};function Ue(e,t){if(!J)return 0;let{size:n,height:r,sea:i,relief:a}=J,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let X=kn({heightAt:Ue,seaSurfaceY:0,waterY:.06});X.group.visible=!1,_.add(X.group),ge.push(X);let We=0;function Ge(e,t){if(!J||!K)return;let{size:n,height:r,relief:i}=J,a=26/(n-1),o=26/(t-1),s=i>1e-6?1/i:0,c=!1;for(let i=0;i<t;i++)for(let l=0;l<t;l++){let u=e[i*t+l];if(u===0)continue;c=!0;let d=u*s,f=l*o/a,p=i*o/a,m=Math.max(0,Math.round(f-1)),h=Math.min(n-1,Math.round(f+1)),g=Math.max(0,Math.round(p-1)),_=Math.min(n-1,Math.round(p+1));for(let e=g;e<=_;e++)for(let t=m;t<=h;t++){let i=e*n+t,a=r[i]+d;r[i]=a<0?0:a>1?1:a}}c&&(We++,We%8==0&&hr(K,J,K.children),We%24==0&&q&&Rr(q,J,{worldSize:26,baseY:0}))}function Ke(e,t){if(!J||!K)return;let{size:n,height:r,relief:i}=J,a=i>1e-6?1/i:0,o=(t-1)/(n-1),s=!1;for(let i=0;i<n;i++){let c=i*o,l=Math.floor(c),u=c-l,d=Math.min(t-1,l+1);for(let c=0;c<n;c++){let f=c*o,p=Math.floor(f),m=f-p,h=Math.min(t-1,p+1),g=e[l*t+p],_=e[l*t+h],v=e[d*t+p],y=e[d*t+h],b=(g*(1-m)+_*m)*(1-u)+(v*(1-m)+y*m)*u;if(b!==0){s=!0;let e=i*n+c,t=r[e]+b*a;r[e]=t<0?0:t>1?1:t}}}s&&(hr(K,J,K.children),q&&Rr(q,J,{worldSize:26,baseY:0}))}let Z=Bn({worldHeightAt:Ue,applyErosion:Ge,syncErodedTerrain:Ke,worldSize:26,grid:96,seaY:0,renderer:o});Z.group.visible=!1,_.add(Z.group);let Xe=Vn({extent:26,count:s?500:2e3});Xe.group.visible=!1,_.add(Xe.group);let Ze=null,Qe=new Set;function $e(){!J||!Te||(_.remove(Te),Te.userData.dispose?.(),Te=Hr(J,{worldSize:26,baseY:0,maxLakes:3,material:ke}),Te.visible=Ee,_.add(Te),window.__world&&(window.__world.lakes=Te.userData.count))}function et(){$e(),q&&Rr(q,J,{worldSize:26,baseY:0})}function tt(e,t,n=1,r=2.2,i=.05){if(!J||!K)return;let a=J.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=J.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Qe.clear();for(let e of K.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Qe.add(e)}hr(K,J,Qe),Ze&&clearTimeout(Ze),Ze=setTimeout(et,140)}function nt(e,t,n,r=2.2){if(!J||!K||n==null)return;let i=J.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=J.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);Qe.clear();for(let e of K.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Qe.add(e)}hr(K,J,Qe,!0)}let rt=[`tree`,`rock`,`tuft`];function it(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!J||!q)return 0;if(a)return Ir(q,n||`all`,e,t,i);let o=J.size,s=26/(o-1),c=J.height,l=J.sea,u=J.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Lr[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;Fr(q,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&q.userData.counts)for(let e of rt)q.userData.counts[e]=(q.userData.placements[e]||[]).length;return g}let at=[];function ot(){if(!q)return null;let e=q.userData.placements,t={};for(let n of rt)t[n]=(e[n]||[]).map(e=>({...e}));return t}function st(){J&&(at.push({h:J.height.slice(),b:J.biome.slice(),sc:ot(),pl:X.snapshot()}),at.length>12&&at.shift())}function ct(){if(!J||!at.length)return!1;let e=at.pop();if(J.height.set(e.h),J.biome.set(e.b),e.sc&&q){let t=q.userData.placements;for(let n of rt)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&X.restore(e.pl),hr(K,J,K.children,!0),et(),!0}let lt=new Set([`boat`,`fish`]),ut=new Set([`person`,`atv`]);function dt(e,t,n){if(!J)return null;let r=Ue(t,n)<0;return lt.has(e)&&!r||ut.has(e)&&r?null:X.spawn(e,t,n)}function ft(e,t,n=2.5){return X.removeNear(e,t,n)}function pt(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function mt(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let gt=e=>pt(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),_t=e=>pt(e);function vt(){let e=q?q.userData.placements:{},t={};for(let n of rt)t[n]=(e[n]||[]).map(e=>({...e}));return t}function yt(){return J?{v:1,seed:De,preset:Y,size:J.size,height:gt(J.height),biome:_t(J.biome),scatter:vt(),entities:X.snapshot()}:null}function bt(){if(!J)return null;let e=sr({seed:De,size:160,preset:Y}),t=J.height,n=J.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:De,preset:Y,hd:r,bd:i,entities:X.snapshot()}}function xt(e){q&&(_.remove(q),q.userData.dispose?.()),q=jr(e||{tree:[],rock:[],tuft:[]}),q.userData.counts=rt.reduce((e,t)=>(e[t]=(q.userData.placements[t]||[]).length,e),{}),q.visible=Ee,_.add(q)}function St(e){if(!e||e.v!==1)return!1;let t=25600;if(e.height!=null||e.biome!=null){if(typeof e.height!=`string`||typeof e.biome!=`string`)return!1;let n,r;try{n=mt(e.height),r=mt(e.biome)}catch{return!1}if(n.byteLength%4!=0||n.byteLength>>2!=t||r.length<t)return!1;let i=new Float32Array(n.buffer,n.byteOffset,n.byteLength>>2);for(let e=0;e<i.length;e++)if(!Number.isFinite(i[e]))return!1}if(e.hd!=null&&!Array.isArray(e.hd)||e.bd!=null&&!Array.isArray(e.bd))return!1;if(Array.isArray(e.hd))for(let n=0;n<e.hd.length;n+=2){let r=e.hd[n];if(!Number.isInteger(r)||r<0||r>=t||!Number.isFinite(e.hd[n+1]))return!1}if(Array.isArray(e.bd))for(let n=0;n<e.bd.length;n+=2){let r=e.bd[n];if(!Number.isInteger(r)||r<0||r>=t)return!1}De=e.seed|0,Y=or.includes(e.preset)?e.preset:Y,at.length=0,Ve(),Ee=!0,He(!0),X.group.visible=!0,Z.group.visible=!0,Xe.group.visible=!0;for(let e of Ae())e.visible=!1;window.__world&&(window.__world.active=!0);let n=e=>e<0?0:e>1?1:e,r=nr.length;if(e.height&&e.biome){let t=mt(e.height),i=new Float32Array(t.buffer,t.byteOffset,t.byteLength>>2);for(let e=0;e<i.length;e++)J.height[e]=n(i[e]);let a=mt(e.biome);for(let e=0;e<J.biome.length;e++)J.biome[e]=Math.min(r-1,a[e]|0)}else if(e.hd||e.bd){let t=e.hd||[],i=e.bd||[];for(let e=0;e<t.length;e+=2)J.height[t[e]]=n(t[e+1]);for(let e=0;e<i.length;e+=2)J.biome[i[e]]=Math.min(r-1,Math.max(0,i[e+1]|0))}return hr(K,J,K.children,!0),e.scatter&&xt(e.scatter),$e(),q&&Rr(q,J,{worldSize:26,baseY:0}),X.restore(e.entities),window.__world&&(window.__world.scatter=q.userData.counts,window.__world.seed=De,window.__world.preset=Y),!0}let wt={enter(){K||Ve(),Ee=!0,He(!0),X.group.visible=!0,Z.group.visible=!0,Xe.group.visible=!0;for(let e of Ae())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){Ee=!1,He(!1),X.group.visible=!1,Z.group.visible=!1,Xe.group.visible=!1;for(let e of Ae())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return De=Math.random()*1e9|0,at.length=0,Ve(),wt.enter(),De},reset(){return at.length=0,Ve(),wt.enter(),De},setPreset(e){return or.includes(e)&&(Y=e,at.length=0,Ve(),wt.enter()),Y},sculpt:tt,paintBiome:nt,paintScatter:it,repoolWater:$e,snapshot:st,undo:ct,placeEntity:dt,removeEntityNear:ft,heightAt:Ue,serialize:yt,serializeCompact:bt,deserialize:St,flowPourAt:(e,t,n,r)=>Z.pourAt(e,t,n,r),flowRain:e=>Z.rain(e),flowClear:()=>Z.clear(),get flowTotal(){return Z.totalWater()},flowAt:(e,t)=>Z.cellAt(e,t),flowErosion:(e,t)=>Z.setErosion(e,t),get flowErosionOn(){return Z.erosion},get flowSediment(){return Z.totalSediment()},setSimBackend:e=>Z.setBackend(e),get simBackend(){return Z.backend},_flowReadW:()=>Z._debugReadW(),_flowReadTerr:()=>Z._debugReadTerr(),_flowStepN:(e,t)=>Z._debugStepN(e,t),get terrainGroup(){return K},get biomes(){return nr},get scatterCounts(){return q?q.userData.placements&&rt.reduce((e,t)=>(e[t]=(q.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return X.counts()},setScatterHidden(e){q&&(q.visible=!e)},get placedLife(){return X},get canUndo(){return at.length>0},get active(){return Ee},get seed(){return De},get preset(){return Y},get presets(){return or}},Tt=Wr(),Et=Kn({world:wt,catalog:Tt,inspector:_e});function Dt(e,t){return Ue(e,t)<0?0:-999}let kt=gn({rig:D,world:{heightAt:Ue,waterHeightAt:Dt}});V.group.remove(V.key),_.add(V.key),V.key.castShadow=!0,V.key.shadow.mapSize.set(2048,2048),V.key.shadow.bias=-18e-5,V.key.shadow.normalBias=.028,_.add(V.key.target);function At(){let e=V.key.shadow.camera,t=V.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),o.shadowMap.needsUpdate=!0}At();let jt=new T(d.x,d.y),Mt=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1,depthTexture:jt}),Nt=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Pt=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!0,stencilBuffer:!1,samples:4}),Ft=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),It=new W(d.x,d.y,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Lt=Math.max(1,Math.floor(d.x/2)),Rt=Math.max(1,Math.floor(d.y/2)),Bt=new W(Lt,Rt,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Vt=new W(Lt,Rt,{minFilter:g,magFilter:g,depthBuffer:!1,stencilBuffer:!1}),Ht=new O,Q=new c(-1,1,1,-1,0,1),Ut=new v(new h(2,2));Ht.add(Ut);let $=new I({vertexShader:jn,fragmentShader:gi,uniforms:{uScene:{value:Mt.texture},uTime:{value:0},uResolution:{value:new G(d.x,d.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:Bt.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:k.grade.tint},uGradeLift:{value:k.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1},uDither:{value:0},uTonemap:{value:0}}}),Wt=new I({vertexShader:jn,fragmentShader:bi,uniforms:{uScene:{value:Mt.texture},uThreshold:{value:.78}}}),Gt=new I({vertexShader:jn,fragmentShader:xi,uniforms:{uScene:{value:Bt.texture},uDir:{value:new G}}});function Kt(e){Wt.uniforms.uScene.value=e.texture,on(Wt,Bt),Gt.uniforms.uScene.value=Bt.texture,Gt.uniforms.uDir.value.set(1.6/Lt,0),on(Gt,Vt),Gt.uniforms.uScene.value=Vt.texture,Gt.uniforms.uDir.value.set(0,1.6/Rt),on(Gt,Bt),$.uniforms.uBloom.value=Bt.texture;let n=1-t.clamp(k.sunArc.y*2.2,0,1);$.uniforms.uBloomStrength.value=.85*(.32+.95*n)}let qt=e=>{let t=e.map(e=>new M(e));for(;t.length<8;)t.push(new M(0,0,0));return t},Jt=[`night`,`dawn`,`noon`,`dusk`],Yt={inkgold:Jt.map(e=>qt(ki[e])),terminal:Jt.map(e=>qt(Ai[e]))},Zt=new I({vertexShader:jn,fragmentShader:_i,uniforms:{uScene:{value:Nt.texture},uResolution:{value:new G(d.x,d.y)},uPixelSize:{value:Oi},uPalette:{value:Yt.inkgold[2]},uPaletteB:{value:Yt.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),$t=new I({vertexShader:jn,fragmentShader:Si,uniforms:{uScene:{value:Nt.texture},uResolution:{value:new G(d.x,d.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Ei(Ci[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),tn={};for(let e of wi)tn[e]=Ci[e].palette?Ei(Ci[e].palette):null;let nn=new I({vertexShader:jn,fragmentShader:vi,uniforms:{uScene:{value:Nt.texture},uDepth:{value:jt},uResolution:{value:new G(d.x,d.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:k.toonFloor},uOutline:{value:k.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),an=new I({vertexShader:jn,fragmentShader:yi,uniforms:{uToon:{value:Ft.texture},uPixel:{value:It.texture},uBlend:{value:0}}});function on(e,t){Ut.material=e,o.setRenderTarget(t),o.render(Ht,Q)}function sn(){D.setViewport(window.innerWidth,window.innerHeight),o.setSize(window.innerWidth,window.innerHeight);let e=o.getDrawingBufferSize(new G);return ae.setSize(e.x,e.y),Mt.setSize(e.x,e.y),Nt.setSize(e.x,e.y),Pt.setSize(e.x,e.y),Ft.setSize(e.x,e.y),It.setSize(e.x,e.y),Lt=Math.max(1,e.x>>1),Rt=Math.max(1,e.y>>1),Bt.setSize(Lt,Rt),Vt.setSize(Lt,Rt),R.uniforms.uResolution.value.set(e.x,e.y),$.uniforms.uResolution.value.set(e.x,e.y),Zt.uniforms.uResolution.value.set(e.x,e.y),$t.uniforms.uResolution.value.set(e.x,e.y),nn.uniforms.uResolution.value.set(e.x,e.y),e}let cn=Yn({renderer:o}),ln=!0;function un(e,t){let n=t.dpr==null?u:t.dpr,r=Math.min(window.devicePixelRatio,n);Math.abs(o.getPixelRatio()-r)>.001&&(o.setPixelRatio(r),typeof window<`u`&&window.dispatchEvent?window.dispatchEvent(new Event(`resize`)):sn()),ln=t.shadows!==!1,ln||(o.shadowMap.needsUpdate=!1)}let dn=Zn({profiler:cn,apply:un});function fn(){!p&&!f&&cn.frameStart()}function pn(){p||f||(cn.frameEnd(),dn.update())}function mn(e){p=!e,typeof window<`u`&&(window.__paused=p)}function hn(){try{o.compile(_,D.camera),zn(1/60,0,{shadowsOn:!0}),Fn(In(),Mt),o.setRenderTarget(null)}catch(e){typeof console<`u`&&console.warn(`[L79] prewarm`,e)}}let _n=3,vn=!1,yn=!1,bn=`native`,xn=.3,Sn=.46,Cn=[`native`,...wi],wn={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=_n,window.__vector=vn,window.__era=bn),typeof window<`u`&&(window.__frames=0),typeof window<`u`&&(window.__loaded=!1);let Tn=0,En=new E(1,1,1),Dn=!1;function On(e){let t=yn?Yt.terminal:Yt.inkgold,n=e%1*4,r=Math.floor(n)%4;Zt.uniforms.uPalette.value=t[r],Zt.uniforms.uPaletteB.value=t[(r+1)%4],Zt.uniforms.uPaletteBlend.value=n-Math.floor(n)}function An(e){let t=Ci[e];t&&($t.uniforms.uGridWidth.value=t.gridWidth,$t.uniforms.uDither.value=t.dither,$t.uniforms.uUsePalette.value=+!!t.palette,t.palette&&($t.uniforms.uPalette.value=tn[e],$t.uniforms.uPaletteSize.value=t.palette.length))}function Mn(){bn!==`native`&&An(bn)}let Nn=()=>bn===`native`?Zt:$t;function Pn(e,t){xe(!0),_.environment=we(),qe.value=1,le.visible=!1,o.setRenderTarget(ae),o.render(_,e),le.visible=!0,o.setRenderTarget(Pt),o.render(_,e),Kt(Pt),$.uniforms.uScene.value=Pt.texture,$.uniforms.uAces.value=1,$.uniforms.uGrade.value=1,$.uniforms.uGrain.value=0,$.uniforms.uChroma.value=0,$.uniforms.uDither.value=1,on($,t)}function Fn(e,t){let n=!vn&&(_n===1||_n===2);if(xe(n),_.environment=n?we():null,qe.value=+!!n,$.uniforms.uBloomStrength.value=0,le.visible=!1,o.setRenderTarget(ae),o.render(_,D.camera),le.visible=!0,_n===1&&!n)o.setRenderTarget(t),o.render(_,D.camera);else if(_n===1)o.setRenderTarget(Pt),o.render(_,D.camera),Kt(Pt),$.uniforms.uScene.value=Pt.texture,$.uniforms.uAces.value=1,$.uniforms.uGrade.value=1,$.uniforms.uGrain.value=0,$.uniforms.uChroma.value=0,$.uniforms.uDither.value=1,on($,t);else if(o.setRenderTarget(n?Pt:Mt),o.render(_,D.camera),_n===2)n&&Kt(Pt),$.uniforms.uScene.value=n?Pt.texture:Mt.texture,$.uniforms.uAces.value=+!!n,$.uniforms.uGrade.value=+!!n,$.uniforms.uGrain.value=1,$.uniforms.uChroma.value=1,$.uniforms.uDither.value=+!!n,on($,t);else{$.uniforms.uScene.value=Mt.texture,$.uniforms.uAces.value=0,$.uniforms.uGrade.value=0,$.uniforms.uGrain.value=0,$.uniforms.uChroma.value=0,$.uniforms.uDither.value=0,on($,Nt);let n=D.camera;nn.uniforms.uNear.value=n.near,nn.uniforms.uFar.value=n.far,nn.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(An(e.era),$t):Nn();e.kind===`pixel`?(on(r,t),window.__style=`pixel`):e.kind===`toon`?(on(nn,t),window.__style=`toon`):(on(nn,Ft),on(r,It),an.uniforms.uBlend.value=e.blend,on(an,t),window.__style=`blend`)}}function In(){let e=Ln(),n=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return R.uniforms.uChromaScale.value=t.lerp(1,.5,n),e}function Ln(){if(_n===1||_n===2)return{kind:`none`};if(_n===7)return{kind:`pixel`};if(_n===8)return{kind:`toon`};let e=D.styleT;return window.__styleT=e,e<=xn?{kind:`toon`}:e>=Sn?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:t.smoothstep(e,xn,Sn),era:`16-bit`}}function Rn(e){return _n===1||_n===2?``:vn&&_n!==7&&_n!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?wn[e.era||bn]||`Pixel`:e.kind===`blend`?`Toon → `+(wn[e.era]||`Pixel`):``}function zn(e,n,{shadowsOn:r=!0,seasonTarget:i=0}={}){typeof window<`u`&&window.__frames++,r&&=ln,ce.material.uniforms.uTime.value=n,$.uniforms.uTime.value=n,k.update(e),V.key.position.copy(k.sunDir).multiplyScalar(24),V.key.color.copy(k.sunColor),V.key.intensity=k.sunIntensity,V.fill.color.copy(k.hemiSky),V.fill.groundColor.copy(k.hemiGround),z.value=k.windowGlow,ye.setSun(k.sunArc),ye.setParams(k.skyParams),$.uniforms.uGradeSat.value=k.grade.sat,$.uniforms.uGradeContrast.value=k.grade.contrast,_.environmentIntensity=.34*(1-.6*t.clamp(k.sunArc.y*1.5,0,1));let a=U.overcast;V.key.intensity*=1-.5*a,V.key.color.lerp(x,.45*a),V.fill.intensity=1+.7*a;let s=t.smoothstep(k.sunDir.y,.06,.34),c=t.lerp(.28,1,1-k.windowGlow),l=r?s*c:0;V.key.shadow.intensity=.72*l,Fe.value=.52*l,(r&&!Dn||En.distanceToSquared(k.sunDir)>2e-5)&&(o.shadowMap.needsUpdate=!0,En.copy(k.sunDir)),Dn=r;let u=1-k.windowGlow;Pe.setRGB(t.lerp(.46,1,u),t.lerp(.52,1,u),t.lerp(.74,1,u)),$.uniforms.uExposure.value=k.exposure,nn.uniforms.uToonGain.value=k.toonGain,o.setClearColor(k.horizon,1),On(k.t),window.__t=k.t,fe.update(e,n,k),V.update(n),pe.update(e,n,k),L.uniforms.uWakeCount.value=pe.wakeCount,U.update(e,n),L.uniforms.uRainCount.value=U.rainDropCount;let d=U.fog*(1-u);_.fog.density=.016+U.fog*S,w.copy(k.horizon).lerp(C,.85*d),_.fog.color.copy(w),o.setClearColor(w,1),ze.value=U.fog,ce.material.uniforms.uFogAmt.value=.7*U.fog,Ie.value=U.snow,Le.value=U.cloud*.55,Re.x+=e*.018,Re.y+=e*.009,Be.value+=(i-Be.value)*Math.min(1,e*1.5),Je.value=n,Ye.value=.035+.05*a,me.update(e,n,k,U),Ee&&X.update(e,n,k),Ee&&Z.step(e),Ee&&Xe.update(e,n,k,{wind:.6*U.cloud,qualityLevel:window.__quality&&window.__quality.level||0});let f=Ln(),p=f.kind===`pixel`||f.kind===`blend`?`pixel`:vn?`vector`:f.kind===`toon`?`charm`:`realistic`;if(ve.update(e,n,k,U,p,D.camera),A){let[e,t,n]=j;L.uniforms.uPrev.value=e.texture,L.uniforms.uCurr.value=t.texture,o.setRenderTarget(n),o.render(P,re),j=[t,n,e],R.uniforms.uHeight.value=j[1].texture}if(Tn<2&&typeof document<`u`&&++Tn===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Hn(e){_n=e,window.__mode=_n}function Un(){return vn=!vn,Ne.value=+!!vn,window.__vector=vn,vn}function Wn(e){return vn=!!e,Ne.value=+!!vn,window.__vector=vn,vn}function Gn(){return bn=Cn[(Cn.indexOf(bn)+1)%Cn.length],window.__era=bn,Mn(),bn}function qn(){return yn=!yn,yn}return{updateWorld:zn,decideStyle:In,renderCityPipeline:Fn,renderCityBeautyTo:Pn,styleHintName:Rn,setPostMode:Hn,toggleVector:Un,setVector:Wn,cycleEra:Gn,togglePalette:qn,setTonemap:e=>{let t=e===`agx`||e===1||e===!0;return $.uniforms.uTonemap.value=+!!t,typeof window<`u`&&(window.__tonemap=t?`agx`:`aces`),t?`agx`:`aces`},get mode(){return _n},get vector(){return vn},get sceneEra(){return bn},renderer:o,drawBuffer:d,scene:_,rig:D,sunRig:k,SIM:256,targets:j,simScene:P,simCamera:re,simMaterial:L,grabRT:ae,card:se,backdrop:ce,WATER_SIZE:28,water:le,waterMaterial:R,windowGlow:z,landmarkFactory:de,city:V,cityLife:fe,waterLife:pe,weatherRig:U,clouds:me,inspector:_e,world:wt,catalog:Tt,editor:Et,pilot:kt,profiler:cn,governor:dn,frameStart:fn,frameEnd:pn,setActive:mn,get paused(){return p},get contextLost(){return f},prewarm:hn,fitShadowFrustum:At,SHADOW_DIST:24,sceneDepth:jt,sceneRT:Mt,filmicRT:Nt,toonRT:Ft,pixelRT:It,postScene:Ht,postCamera:Q,postQuad:Ut,filmicMaterial:$,pixelMaterial:Zt,pixelkitMaterial:$t,toonMaterial:nn,mixMaterial:an,PALCACHE:Yt,ERA_TEX:tn,runPass:on,OVERCAST_GREY:x,FOG_DENSITY:S,FOG_NIGHT_TINT:C,_fogColor:w,resize:sn}}var Ni=[`video/mp4;codecs=avc1.42E01E`,`video/mp4`,`video/webm;codecs=vp9`,`video/webm`];function Pi({renderer:e,rig:t,sunRig:n,poke:r,getState:i,office:a={},world:o=null}){let s=e.domElement,c=new URLSearchParams(window.location.search),l=e=>{let t=i();return`lgr-${t.lesson}-${String(t.clock||``).replace(`:`,``)}-${t.style}.${e}`},u=(e,t)=>{let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,document.body.appendChild(r),r.click(),r.remove(),setTimeout(()=>URL.revokeObjectURL(n),1e3)};function d(){s.toBlob(e=>{e&&(u(e,l(`png`)),window.__lastStill=e.size)},`image/png`)}let f=()=>Ni.find(e=>window.MediaRecorder&&MediaRecorder.isTypeSupported(e))||``,p=Fi(),m=null,h=[],g=!1;function _(){if(g)return;let e=f(),t=s.captureStream(60);m=new MediaRecorder(t,e?{mimeType:e,videoBitsPerSecond:12e6}:{}),h=[],m.ondataavailable=e=>{e.data&&e.data.size&&h.push(e.data)},m.onstop=()=>{let e=new Blob(h,{type:m.mimeType});u(e,l(m.mimeType.includes(`mp4`)?`mp4`:`webm`)),window.__lastVideo=e.size},m.start(),g=!0,window.__recording=!0,p.show()}function v(){g&&(m.stop(),g=!1,window.__recording=!1,p.hide())}let y=()=>g?v():_(),b=e=>new Promise(t=>setTimeout(t,e)),x=e=>{let t=e.startsWith(`Shift+`),n=t?e.slice(6):e;window.dispatchEvent(new KeyboardEvent(`keydown`,{key:n,shiftKey:t}))};async function S(){let e=s.clientWidth,t=s.clientHeight,n=e*.26,i=t*.74;for(let t=0;t<=10;t++)r.at(n+t*e*.028,i+Math.sin(t*.7)*16),await b(100);r.stop()}async function C(e){if(e.world&&o?.[e.world]?.(),e.keys)for(let t of e.keys)x(t),await b(70);if(e.zoom&&t.zoomBy(e.zoom),e.orbit&&t.orbit(e.orbit[0],e.orbit[1]),e.timeTo!==void 0&&n.goTo(e.timeTo),e.pour&&o?.flowPourAt)for(let t=0;t<10;t++)o.flowPourAt(e.pour[0],e.pour[1],e.pour[2],e.pour[3]);e.office&&a[e.office]?.(),e.ripple&&await S(),e.waitMs&&await b(e.waitMs)}let w={tour:[{keys:[`6`,`0`],waitMs:600},{zoom:.72,waitMs:1700},{ripple:!0,waitMs:2400},{orbit:[.55,0],waitMs:1700},{timeTo:0,waitMs:3e3},{timeTo:.5,waitMs:1500},{keys:[`7`],waitMs:1e3},{zoom:1.5,waitMs:1400},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`B`],waitMs:2e3},{keys:[`8`],waitMs:900},{zoom:.65,waitMs:1200},{ripple:!0,waitMs:2600},{keys:[`7`],waitMs:700},{keys:[`B`],waitMs:300},{keys:[`B`],waitMs:900},{zoom:1.4,waitMs:2600}],daycycle:[{keys:[`6`,`0`],waitMs:700},{timeTo:.75,waitMs:2600},{timeTo:1,waitMs:2600},{timeTo:1.25,waitMs:2600},{timeTo:1.5,waitMs:2600},{timeTo:1.5,waitMs:800}],office:[{keys:[`o`],waitMs:1700},{office:`pet`,waitMs:1300},{office:`feed`,waitMs:1700},{office:`travel`,waitMs:1700},{keys:[`Shift+W`,`Shift+W`,`Shift+W`],waitMs:1800},{timeTo:0,waitMs:2400},{office:`laptop`,waitMs:800},{office:`closeLaptop`,waitMs:300},{timeTo:.5,waitMs:900},{keys:[`Shift+W`],waitMs:200},{keys:[`o`],waitMs:1500}],cities:[{keys:[`6`,`0`],waitMs:500},{timeTo:.78,waitMs:2800},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:3e3},{keys:[`C`],waitMs:2e3}],water:[{keys:[`6`,`0`],waitMs:600},{zoom:1.35,waitMs:2800},{orbit:[.7,0],waitMs:2600},{ripple:!0,waitMs:2200},{timeTo:0,waitMs:3200},{timeTo:.5,waitMs:1500},{orbit:[-.5,0],waitMs:2200}],morph:[{keys:[`6`,`3`],waitMs:700},{zoom:.55,waitMs:1800},{zoom:2.3,waitMs:1700},{zoom:1.26,waitMs:1700},{zoom:1.16,waitMs:1900},{zoom:.3,waitMs:2200}],skin:[{keys:[`o`],waitMs:1800},{keys:[`j`],waitMs:2e3},{keys:[`j`],waitMs:2e3},{timeTo:0,waitMs:2600},{timeTo:.5,waitMs:1500},{keys:[`u`],waitMs:2e3},{keys:[`j`],waitMs:1400},{keys:[`o`],waitMs:1500}]};w.hero=[{world:`enter`,keys:[`2`],waitMs:1500},{timeTo:.27,waitMs:400},{orbit:[.55,.05],waitMs:2400},{pour:[3.2,-5.24,.6,1.8],waitMs:2800},{orbit:[-.4,-.03],zoom:.9,waitMs:2400},{timeTo:.74,waitMs:3200},{keys:[`8`],waitMs:1600},{keys:[`7`],waitMs:1600},{keys:[`2`],waitMs:2200}];async function T(e){let t=w[e];if(t){window.__director=e;for(let e of t)await C(e);window.__director=null}}async function E(e){await b(1600),_(),await T(e),await b(400),v(),window.__captureDone=!0}c.has(`capture`)&&window.addEventListener(`keydown`,e=>{(e.key===`s`||e.key===`S`)&&d(),(e.key===`r`||e.key===`R`)&&y()});let D=c.get(`capture`);return D&&w[D]&&E(D),window.__capture={still:d,toggleRec:y,run:T,sequences:Object.keys(w)},window.__capture}function Fi(){let e=document.createElement(`div`);return e.textContent=`● REC`,e.style.cssText=`position:fixed;top:14px;right:16px;z-index:2;font:bold 12px ui-monospace,monospace;color:#ff3b30;letter-spacing:.12em;text-shadow:0 1px 3px #000;display:none;`,document.body.appendChild(e),{show:()=>{e.style.display=`block`},hide:()=>{e.style.display=`none`}}}var Ii=`
