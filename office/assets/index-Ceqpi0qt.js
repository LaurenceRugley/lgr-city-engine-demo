import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,Q as _,R as v,S as y,T as b,U as x,V as S,W as C,X as w,Y as T,Z as E,_ as ee,a as D,b as te,c as O,d as k,et as A,f as j,g as ne,h as M,i as N,j as P,k as F,l as re,m as ie,n as ae,nt as I,o as L,p as R,q as oe,r as se,s as ce,t as z,tt as B,u as le,v as ue,w as de,x as fe,y as pe,z as me}from"./three-D0DmFcFN.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var he=Math.atan(1/Math.SQRT2),ge=Math.atan(.5),_e=Math.PI/4,V={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},ve=.12,ye=1.45,H=4,be=40,xe=1.5,Se=16,U=6,W=22,Ce=3.5,we=11,Te=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),Ee=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function De({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new B(0,.8,0),azimuth:a=_e,elevation:o=.52,distance:s=12,zoom:c=5.5}={}){let u=new v(t,e,n,r),d=new l(-1,1,1,-1,n,r),f=V.PERSPECTIVE,p=e,m={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},h={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},g=!1,_=()=>f===V.PERSPECTIVE?u:d;function y(e){e!==f&&(f=e,f===V.ISOMETRIC||f===V.DIMETRIC?(m.elevation=f===V.ISOMETRIC?he:ge,m.azimuth=Ee(_e,h.azimuth),g=!0):g=!1)}function b(e,t){m.azimuth+=e,g||(m.elevation=F.clamp(m.elevation+t,ve,ye))}function x(e){f===V.PERSPECTIVE?m.distance=F.clamp(m.distance*e,H,be):m.zoom=F.clamp(m.zoom*e,xe,Se)}function S(e,t){let n=m.azimuth,r=f===V.PERSPECTIVE?m.distance*.04:m.zoom*.08,i=new B(Math.cos(n),0,-Math.sin(n)),a=new B(-Math.sin(n),0,-Math.cos(n));m.target.addScaledVector(i,e*r),m.target.addScaledVector(a,t*r)}function C(e,t){p=e/t,u.aspect=p,u.updateProjectionMatrix()}function w(e){h.azimuth=Te(h.azimuth,m.azimuth,e),h.elevation=Te(h.elevation,m.elevation,e),h.distance=Te(h.distance,m.distance,e),h.zoom=Te(h.zoom,m.zoom,e),h.target.x=Te(h.target.x,m.target.x,e),h.target.y=Te(h.target.y,m.target.y,e),h.target.z=Te(h.target.z,m.target.z,e);let t=Math.cos(h.elevation),n=Math.sin(h.elevation),r=Math.cos(h.azimuth),i=Math.sin(h.azimuth),a=_();if(a.position.set(h.target.x+h.distance*t*i,h.target.y+h.distance*n,h.target.z+h.distance*t*r),a.lookAt(h.target),a.isOrthographicCamera){let e=h.zoom,t=e*p;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function T(e,t,n,r=!1){m.target.set(e,t,n),r&&h.target.copy(m.target)}function E(e,t=!1){m.zoom=F.clamp(e,xe,Se),t&&(h.zoom=m.zoom)}return{get camera(){return _()},get mode(){return f},get azimuth(){return h.azimuth},setTarget:T,setZoom:E,get styleT(){return f===V.PERSPECTIVE?F.clamp((h.distance-U)/(W-U),0,1):F.clamp((h.zoom-Ce)/(we-Ce),0,1)},setMode:y,orbit:b,zoomBy:x,pan:S,setViewport:C,update:w}}var Oe={value:0},ke=new R(`#ffffff`),Ae={value:0},je={value:0},Me={value:0},Ne=new A,Pe={value:0},Fe={value:0},Ie=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
`;function G(e){e.uniforms.uVector=Oe,e.uniforms.uVecTint={value:ke},e.uniforms.uVecShadow=Ae,e.uniforms.uSnow=je,e.uniforms.uCloud=Me,e.uniforms.uCloudOff={value:Ne},e.uniforms.uFogCharm=Pe}function K(e){return e.replace(`#include <fog_fragment>`,`
    #ifdef USE_FOG
...
#include <shadowmask_pars_fragment>`)}var Re=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function ze(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new R(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{G(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new R(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=Le(e.vertexShader),e.fragmentShader=K(q(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function J(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{G(e),s||(e.uniforms.uVecColor={value:new R(t)}),c&&(e.uniforms.uGlow={value:new R(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=Fe),e.vertexShader=Le(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
`:``),f=c?`uGlow * mix(uGlowDay, uGlowNight, uWindowGlow)`:`vec3(0.0)`,p=K(q(e.fragmentShader.replace(`#include <common>`,`#include <common>
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Kt={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},qt=[`gb`,`8-bit`,`16-bit`,`modern`];function Jt(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new R(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new ne(n,t,1,x,te);return r.minFilter=g,r.magFilter=g,r.needsUpdate=!0,r}var Yt=220,Xt={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Zt={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Qt({demo:e=!1,citySeed:n=0,profileIndex:a=0}={}){let o=new ae({antialias:!0,preserveDrawingBuffer:!0});o.shadowMap.enabled=!0,o.shadowMap.type=1,o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0;let c=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);o.setPixelRatio(Math.min(window.devicePixelRatio,c?1.5:2)),o.setSize(window.innerWidth,window.innerHeight),o.setClearColor(920327,1),document.body.appendChild(o.domElement);let u=o.getDrawingBufferSize(new A),f=new d;f.fog=new fe(10465470,0);let m=new R(`#aeb6c0`),h=.062,_=new R(`#74508f`),v=new R,y=De({aspect:window.innerWidth/window.innerHeight}),b=ot({t:.5}),S={type:r,format:x,minFilter:g,magFilter:g,wrapS:j,wrapT:j,depthBuffer:!1,stencilBuffer:!1},C=[new I(256,256,S),new I(256,256,S),new I(256,256,S)];for(let e of C)o.setRenderTarget(e),o.clear();o.setRenderTarget(null);let w=new d,T=new l(-1,1,1,-1,0,1),E=new oe({vertexShader:Lt,fragmentShader:Rt,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new A(1/256,1/256)},uMouse:{value:new A(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new B)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new B)}}});w.add(new P(new me(2,2),E));let D=new I(u.x,u.y,{minFilter:i,magFilter:i,depthBuffer:!0,stencilBuffer:!1});function te(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new O(t);return r.colorSpace=s,r}let k=new P(new me(28,28),new p({map:te(e)}));k.rotation.x=-Math.PI/2,k.position.y=-.35,f.add(k);let ne=new P(new me(40,24),new oe({depthWrite:!1,vertexShader:Ft,fragmentShader:It,uniforms:{uTime:{value:0},uInk:{value:b.horizon},uGold:{value:b.sky},uFogColor:{value:v},uFogAmt:{value:0},uFogCharm:Pe}}));ne.position.set(0,3,-8),f.add(ne);let M=new oe({vertexShader:zt,fragmentShader:Bt,uniforms:{uHeight:{value:null},uScene:{value:D.texture},uTexel:{value:new A(1/256,1/256)},uResolution:{value:new A(u.x,u.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new t},uLightDir:{value:b.sunDir},uInk:{value:new R(`#2A2218`)},uGold:{value:new R(`#B89968`)},uVector:Oe,uVecWater:{value:new R(`#1fb8d8`)},uVecTint:{value:ke}}}),N=new P(new me(28,28,255,255),M);N.rotation.x=-Math.PI/2,N.updateMatrixWorld(!0),M.uniforms.uNormalMatrix.value.getNormalMatrix(N.matrixWorld),f.add(N);let re={value:0},ie=kt({windowGlow:re}),L=Qe({seed:n,profileIndex:a,landmarkFactory:ie,windowGlow:re});f.add(L.group);let se=dt({plinthTop:.3,extent:L.extent,profile:L.state.profile});f.add(se.group);let ce=_t({extent:L.extent,waterSize:28,plinthTop:.3});f.add(ce.group),E.uniforms.uWakeDrops.value=ce.wakeDrops;let z=jt({extent:L.extent});f.add(z.group),E.uniforms.uRainDrops.value=z.rainDrops;let le=Nt({extent:L.extent});f.add(le.group),L.group.remove(L.key),f.add(L.key),L.key.castShadow=!0,L.key.shadow.mapSize.set(2048,2048),L.key.shadow.bias=-18e-5,L.key.shadow.normalBias=.028,f.add(L.key.target);function ue(){let e=L.key.shadow.camera,t=L.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),o.shadowMap.needsUpdate=!0}ue();let de=new ee(u.x,u.y),pe=new I(u.x,u.y,{minFilter:i,magFilter:i,depthBuffer:!0,stencilBuffer:!1,depthTexture:de}),he=new I(u.x,u.y,{minFilter:i,magFilter:i,depthBuffer:!1,stencilBuffer:!1}),ge=new I(u.x,u.y,{minFilter:i,magFilter:i,depthBuffer:!1,stencilBuffer:!1}),_e=new I(u.x,u.y,{minFilter:i,magFilter:i,depthBuffer:!1,stencilBuffer:!1}),V=new d,ve=new l(-1,1,1,-1,0,1),ye=new P(new me(2,2));V.add(ye);let H=new oe({vertexShader:Lt,fragmentShader:Vt,uniforms:{uScene:{value:pe.texture},uTime:{value:0},uResolution:{value:new A(u.x,u.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),be=e=>{let t=e.map(e=>new R(e));for(;t.length<8;)t.push(new R(0,0,0));return t},xe=[`night`,`dawn`,`noon`,`dusk`],Se={inkgold:xe.map(e=>be(Xt[e])),terminal:xe.map(e=>be(Zt[e]))},U=new oe({vertexShader:Lt,fragmentShader:Ht,uniforms:{uScene:{value:he.texture},uResolution:{value:new A(u.x,u.y)},uPixelSize:{value:Yt},uPalette:{value:Se.inkgold[2]},uPaletteB:{value:Se.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),W=new oe({vertexShader:Lt,fragmentShader:Gt,uniforms:{uScene:{value:he.texture},uResolution:{value:new A(u.x,u.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Jt(Kt[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Ce={};for(let e of qt)Ce[e]=Kt[e].palette?Jt(Kt[e].palette):null;let we=new oe({vertexShader:Lt,fragmentShader:Ut,uniforms:{uScene:{value:he.texture},uDepth:{value:de},uResolution:{value:new A(u.x,u.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:b.toonFloor},uOutline:{value:b.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Te=new oe({vertexShader:Lt,fragmentShader:Wt,uniforms:{uToon:{value:ge.texture},uPixel:{value:_e.texture},uBlend:{value:0}}});function Ee(e,t){ye.material=e,o.setRenderTarget(t),o.render(V,ve)}function Ie(){y.setViewport(window.innerWidth,window.innerHeight),o.setSize(window.innerWidth,window.innerHeight);let e=o.getDrawingBufferSize(new A);return D.setSize(e.x,e.y),pe.setSize(e.x,e.y),he.setSize(e.x,e.y),ge.setSize(e.x,e.y),_e.setSize(e.x,e.y),M.uniforms.uResolution.value.set(e.x,e.y),H.uniforms.uResolution.value.set(e.x,e.y),U.uniforms.uResolution.value.set(e.x,e.y),W.uniforms.uResolution.value.set(e.x,e.y),we.uniforms.uResolution.value.set(e.x,e.y),e}let G=3,K=!1,Le=!1,q=`native`,Re=.3,ze=.46,J=[`native`,...qt],Y={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=G,window.__vector=K,window.__era=q);let Be=0,Ve=performance.now(),X=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=X),X&&(o.info.autoReset=!1);let He=null;typeof window<`u`&&(window.__loaded=!1);let Ue=0,We=new B(1,1,1),Ge=!1;function Ke(e){let t=Le?Se.terminal:Se.inkgold,n=e%1*4,r=Math.floor(n)%4;U.uniforms.uPalette.value=t[r],U.uniforms.uPaletteB.value=t[(r+1)%4],U.uniforms.uPaletteBlend.value=n-Math.floor(n)}function qe(e){let t=Kt[e];t&&(W.uniforms.uGridWidth.value=t.gridWidth,W.uniforms.uDither.value=t.dither,W.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(W.uniforms.uPalette.value=Ce[e],W.uniforms.uPaletteSize.value=t.palette.length))}function Je(){q!==`native`&&qe(q)}let Ye=()=>q===`native`?U:W;function Xe(e,t){N.visible=!1,o.setRenderTarget(D),o.render(f,e),N.visible=!0,o.setRenderTarget(t),o.render(f,e)}function Ze(e,t){if(N.visible=!1,o.setRenderTarget(D),o.render(f,y.camera),N.visible=!0,G===1||K&&G!==7&&G!==8)o.setRenderTarget(t),o.render(f,y.camera);else if(o.setRenderTarget(pe),o.render(f,y.camera),G===2)H.uniforms.uGrain.value=1,H.uniforms.uChroma.value=1,Ee(H,t);else{H.uniforms.uGrain.value=0,H.uniforms.uChroma.value=0,Ee(H,he);let n=y.camera;we.uniforms.uNear.value=n.near,we.uniforms.uFar.value=n.far,we.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(qe(e.era),W):Ye();e.kind===`pixel`?(Ee(r,t),window.__style=`pixel`):e.kind===`toon`?(Ee(we,t),window.__style=`toon`):(Ee(we,ge),Ee(r,_e),Te.uniforms.uBlend.value=e.blend,Ee(Te,t),window.__style=`blend`)}}function $e(){let e=et(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return M.uniforms.uChromaScale.value=F.lerp(1,.5,t),e}function et(){if(G===1||G===2)return{kind:`none`};if(G===7)return{kind:`pixel`};if(G===8)return{kind:`toon`};let e=y.styleT;return window.__styleT=e,e<=Re?{kind:`toon`}:e>=ze?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:F.smoothstep(e,Re,ze),era:`16-bit`}}function tt(e){return G===1||G===2?``:K&&G!==7&&G!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Y[e.era||q]||`Pixel`:e.kind===`blend`?`Toon → `+(Y[e.era]||`Pixel`):``}function nt(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){if(X){let e=o.info;He={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}ne.material.uniforms.uTime.value=t,H.uniforms.uTime.value=t,b.update(e),L.key.position.copy(b.sunDir).multiplyScalar(24),L.key.color.copy(b.sunColor),L.key.intensity=b.sunIntensity,L.fill.color.copy(b.hemiSky),L.fill.groundColor.copy(b.hemiGround),re.value=b.windowGlow;let i=z.overcast;L.key.intensity*=1-.5*i,L.key.color.lerp(m,.45*i),L.fill.intensity=1+.7*i;let a=F.smoothstep(b.sunDir.y,.06,.34),s=F.lerp(.28,1,1-b.windowGlow),c=n?a*s:0;L.key.shadow.intensity=.72*c,Ae.value=.52*c,(n&&!Ge||We.distanceToSquared(b.sunDir)>2e-5)&&(o.shadowMap.needsUpdate=!0,We.copy(b.sunDir)),Ge=n;let l=1-b.windowGlow;ke.setRGB(F.lerp(.46,1,l),F.lerp(.52,1,l),F.lerp(.74,1,l)),H.uniforms.uExposure.value=b.exposure,we.uniforms.uToonGain.value=b.toonGain,o.setClearColor(b.horizon,1),Ke(b.t),window.__t=b.t,se.update(e,t,b),L.update(t),ce.update(e,t,b),E.uniforms.uWakeCount.value=ce.wakeCount,z.update(e,t),E.uniforms.uRainCount.value=z.rainDropCount;let u=z.fog*(1-l);f.fog.density=z.fog*h,v.copy(b.horizon).lerp(_,.85*u),f.fog.color.copy(v),o.setClearColor(v,1),Pe.value=z.fog,ne.material.uniforms.uFogAmt.value=.7*z.fog,je.value=z.snow,Me.value=z.cloud*.55,Ne.x+=e*.018,Ne.y+=e*.009,Fe.value+=(r-Fe.value)*Math.min(1,e*1.5),le.update(e,t,b,z),Be++;let d=performance.now();d-Ve>=1e3&&(window.__fps=Be,X&&He&&(console.log(`[perf] ${Be} fps · ~${(1e3/Math.max(1,Be)).toFixed(2)} ms · calls ${He.calls} · tris ${He.tris} · programs ${He.programs} · geo ${He.geo} · tex ${He.tex}`),window.__perfInfo={fps:Be,...He}),Be=0,Ve=d);let[p,g,y]=C;if(E.uniforms.uPrev.value=p.texture,E.uniforms.uCurr.value=g.texture,o.setRenderTarget(y),o.render(w,T),C=[g,y,p],M.uniforms.uHeight.value=C[1].texture,Ue<2&&typeof document<`u`&&++Ue===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function rt(e){G=e,window.__mode=G}function it(){return K=!K,Oe.value=+!!K,window.__vector=K,K}function at(e){return K=!!e,Oe.value=+!!K,window.__vector=K,K}function st(){return q=J[(J.indexOf(q)+1)%J.length],window.__era=q,Je(),q}function ct(){return Le=!Le,Le}return{updateWorld:nt,decideStyle:$e,renderCityPipeline:Ze,renderCityBeautyTo:Xe,styleHintName:tt,setPostMode:rt,toggleVector:it,setVector:at,cycleEra:st,togglePalette:ct,get mode(){return G},get vector(){return K},get sceneEra(){return q},renderer:o,drawBuffer:u,scene:f,rig:y,sunRig:b,SIM:256,targets:C,simScene:w,simCamera:T,simMaterial:E,grabRT:D,card:k,backdrop:ne,WATER_SIZE:28,water:N,waterMaterial:M,windowGlow:re,landmarkFactory:ie,city:L,cityLife:se,waterLife:ce,weatherRig:z,clouds:le,fitShadowFrustum:ue,SHADOW_DIST:24,sceneDepth:de,sceneRT:pe,filmicRT:he,toonRT:ge,pixelRT:_e,postScene:V,postCamera:ve,postQuad:ye,filmicMaterial:H,pixelMaterial:U,pixelkitMaterial:W,toonMaterial:we,mixMaterial:Te,PALCACHE:Se,ERA_TEX:Ce,runPass:Ee,OVERCAST_GREY:m,FOG_DENSITY:h,FOG_NIGHT_TINT:_,_fogColor:v,resize:Ie}}var $t=`lgr_hints_`,en=!1;function tn(){if(en||typeof document>`u`)return;en=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var rn=``+new URL(`office-smooth-DEluvd7o.png`,import.meta.url).href,an=``+new URL(`office-charm-D7t90SkH.png`,import.meta.url).href;function Q(e,t,n,r,{rough:i=.62,metal:a=0,x:o=0,y:s=0,z:c=0,emissive:l=null,emissiveIntensity:u=1}={}){let d=new P(new D(e,t,n),new m({color:r,roughness:i,metalness:a,...l?{emissive:l,emissiveIntensity:u}:{}}));return d.position.set(o,s,c),d}function on({tier:t=`corner`}={}){let r=new d,i=new v(43,1,.1,100),a=new B(0,1.62,4.35);i.position.copy(a),i.lookAt(0,1.12,-1);let o=new y;r.add(o);let c=new y,l=new y,u=new y,f=new y,h=new y;o.add(c,l,u,f,h);let g=[],b=`#3a2618`,x=`#5b3d27`,S=`#5a5650`;c.add(Q(11,.2,11,`#3c2a1c`,{rough:.5,y:-.1})),c.add(Q(11,.2,11,`#241a13`,{rough:.9,y:3}));function C(e){let t=new y;t.add(Q(.2,3.2,8,`#4a3322`,{rough:.7,x:e*3.6,y:1.5,z:0}));for(let n of[.9,2.1])t.add(Q(.22,.06,8,b,{x:e*3.59,y:n,z:0}));let n=new P(new me(1.5,1),new m({map:mn(e),roughness:.8}));return n.position.set(e*3.49,1.7,.4),n.rotation.y=-e*Math.PI/2,t.add(Q(.06,1.18,1.68,`#2a1c10`,{x:e*3.52,y:1.7,z:.4}),n),t}c.add(C(-1),C(1));let T=new me(3,2.5),ee=new p({color:`#ffffff`,toneMapped:!1}),te=new p({color:`#ffffff`,toneMapped:!1}),O=1.55,A=new P(T,ee);A.position.set(-1.06,O,-2.64),A.rotation.y=Math.PI/4;let j=new P(T,te);j.position.set(1.06,O,-2.64),j.rotation.y=-Math.PI/4,u.add(A,j),c.add(Q(.08,2.7,.08,b,{x:0,y:O,z:-2.2}));for(let[e,t,n]of[[-1.06,-2.64,Math.PI/4],[1.06,-2.64,-Math.PI/4]]){let r=new y;r.add(Q(3.05,.09,.09,b,{y:1.3})),r.add(Q(3.05,.09,.09,b,{y:-1.25})),r.add(Q(.09,2.6,.09,b,{x:-1.5})),r.position.set(e,O,t),r.rotation.y=n,c.add(r)}c.add(Q(5.4,.5,.3,x,{x:0,y:.25,z:-2.1500000000000004})),c.add(Q(.4,.06,.4,`#1a130c`,{y:2.94,z:1.3}));let ne=new P(new k(.16,20),new p({color:`#ffe6b0`,toneMapped:!1}));ne.position.set(0,2.9,1.3),ne.rotation.x=Math.PI/2,c.add(ne),c.add(cn(g,{x:-3.46,y:2.15,z:.2,ry:Math.PI/2,face:`#efe2c8`,rim:`#2a1c10`})),l.add(Q(11,.2,11,`#403d38`,{rough:.85,y:-.1})),l.add(Q(11,.2,11,`#1c1a17`,{rough:.95,y:2.8})),l.add(Q(7,3,.2,S,{rough:.92,x:0,y:1.4,z:-2.9})),l.add(Q(.2,3,6,S,{rough:.92,x:-3.2,y:1.4,z:-.2})),l.add(Q(.2,3,6,S,{rough:.92,x:3.2,y:1.4,z:-.2}));for(let e of[-1.6,-.4]){let t=new P(new M(.07,.07,6,10),new m({color:`#6b6258`,roughness:.6,metalness:.4}));t.rotation.z=Math.PI/2,t.position.set(0,2.62,e),l.add(t)}let N=new p({color:`#ffffff`,toneMapped:!1}),re=new P(new me(1.9,1.2),N);re.position.set(0,1.5,-2.79),l.add(re),l.add(Q(2.06,1.36,.06,`#241a12`,{x:0,y:1.5,z:-2.83})),l.add(Q(.04,.34,.04,`#1a1410`,{x:-.1,y:2.45,z:-.4}));let ae=new P(new k(.1,16),new p({color:`#ffdb8a`,toneMapped:!1}));ae.position.set(-.1,2.26,-.4),ae.rotation.x=Math.PI/2,l.add(ae);let I=new y;I.add(Q(1.3,.05,.32,`#3a2c1e`,{x:0,y:0,z:0}));let L=[`#7a3a2a`,`#2a4a6a`,`#b08a3a`,`#3a5a3a`,`#6a2a4a`];for(let e=0;e<8;e++)I.add(Q(.12,.34,.24,L[e%L.length],{x:-.55+e*.14,y:.2,z:0}));I.position.set(-2.3,1.5,-2.66),l.add(I);let oe=new y;oe.add(Q(.34,.34,.34,`#7a4a2a`,{y:.17}));let se=new y;for(let e=0;e<6;e++){let t=Q(.05,.5,.14,`#3a7a3a`,{rough:.7});t.geometry.translate(0,.25,0),t.rotation.z=(e/6-.5)*1.2,t.rotation.x=Math.sin(e)*.25,se.add(t)}se.position.y=.34,oe.add(se),oe.position.set(2.45,0,-1.4),l.add(oe),l.add(cn(g,{x:1.9,y:2.1,z:-2.78,ry:0,face:`#d8d2c4`,rim:`#1a130c`}));let ce=new y;ce.add(Q(3.4,.12,1.5,`#6e4a30`,{rough:.32,y:.86,z:1.5})),ce.add(Q(3.2,.78,1.36,x,{y:.46,z:1.5}));for(let e of[.66,.4,.14])ce.add(Q(.9,.2,.04,`#4a3120`,{x:1.05,y:e,z:2.2}));ce.add(Q(.12,.04,.04,`#caa15a`,{x:1.05,y:.66,z:2.23,metal:.6})),o.add(ce);let z=new y;z.add(Q(.06,.5,.06,`#2a1c10`,{x:-1.15,y:1.15,z:1.6}));let le=new P(new ie(.22,.26,16,1,!0),new m({color:`#c2802e`,roughness:.5,side:2,emissive:`#3a2208`,emissiveIntensity:.6}));le.position.set(-1.15,1.42,1.6),z.add(le);let ue=new n(`#ffb15a`,7,7,1.8);ue.position.set(-1.15,1.34,1.6),z.add(ue),o.add(z);let fe=new y;fe.add(Q(.62,.03,.42,`#1c1c20`,{y:.93,z:1.5,metal:.4,rough:.4}));let pe=new P(new D(.62,.4,.025),new m({color:`#0a0c10`,emissive:`#2a4a6a`,emissiveIntensity:.7,roughness:.3}));pe.position.set(0,1.14,1.31),pe.rotation.x=-.32,fe.add(pe),fe.userData.role=`laptop`,o.add(fe);let he=new y;he.add(Q(.26,.07,.34,`#15151a`,{x:1,y:.93,z:1.5}));let ge=Q(.3,.06,.08,`#101015`,{x:1,y:1,z:1.34,emissive:`#234a6a`,emissiveIntensity:.4});he.add(ge),he.userData.role=`phone`,o.add(he);let _e=new de(`#6a5238`,`#140d08`,.55);r.add(_e);let V=new w(`#ffd9a0`,9,9,.7,.5,1.2);V.position.set(0,2.95,1.3),V.target.position.set(0,.86,1.5),r.add(V,V.target);let ve=ln(!1),ye=ln(!0),H=.62,be=1.32,xe=1.22,Se=1.78,U=new E(new _({map:ve,transparent:!0,depthWrite:!1}));U.scale.set(H,H,1),U.position.set(be,xe,Se),U.userData.role=`cat`,o.add(U);let W=new E(new _({map:dn(),transparent:!0,depthWrite:!1,opacity:0}));W.scale.set(.3,.3,1),W.raycast=()=>{},o.add(W);let Ce=0;function we(){Ce=1.3}let Te=.62,Ee=.42,De=.34,Oe=new y;Oe.position.set(-.78,1.06,1.95),Oe.add(Q(Te,.05,De,`#3a3026`,{y:-.19}));let ke=new P(new D(Te-.04,Ee-.08,De-.04),new m({color:`#1f9fc0`,transparent:!0,opacity:.26,roughness:.1,emissive:`#0a3a4a`,emissiveIntensity:.4,depthWrite:!1}));ke.position.y=.02,Oe.add(ke);for(let e of[-1,1])for(let t of[-1,1])Oe.add(Q(.03,Ee,.03,`#20262c`,{x:e*(Te/2-.015),z:t*(De/2-.015),metal:.5}));let Ae=new P(new D(Te,Ee,De),new p({visible:!1}));Ae.userData.role=`tank`,Oe.add(Ae);let je=new n(`#5fd8ff`,0,3,2);Oe.add(je);let Me=[fn(`#e8a23c`),fn(`#d85a6a`),fn(`#6cc0e0`)],Ne=[],Pe=Ee/2-.12;for(let e=0;e<3;e++){let t=new E(new _({map:Me[e],transparent:!0,depthWrite:!1})),n=.15-e*.015;t.userData={sz:n,sp:.6+e*.22,ph:e*2.1,ax:.21*(.7+.1*e),ay:Pe,az:.09000000000000001,prevx:0},t.scale.set(n,n,1),Ne.push(t),Oe.add(t)}let Fe=pn(),Ie=[];for(let e=0;e<5;e++){let t=new E(new _({map:Fe,color:`#cfeffb`,transparent:!0,opacity:.5,depthWrite:!1}));t.userData={ph:e/5,sp:.16+Math.random()*.06,x:-.1+e%3*.07},t.scale.setScalar(.03+e%2*.015),t.raycast=()=>{},Ie.push(t),Oe.add(t)}let G=new E(new _({map:Fe,color:`#c8a24a`,transparent:!0,opacity:0,depthWrite:!1}));G.scale.setScalar(.04),G.raycast=()=>{},Oe.add(G);let K=0;function Le(){K=3,G.position.set(-.05,Pe,0),G.material.opacity=1}o.add(Oe);let q=new y;for(let e=0;e<8;e++){let t=new E(new _({map:Fe,color:`#ffd9a0`,transparent:!0,opacity:0,depthWrite:!1,blending:2}));t.scale.setScalar(.018),t.userData={ph:e*.9,sp:.1+e%3*.04,r:.1+e%4*.03},t.raycast=()=>{},q.add(t)}q.position.set(-1.15,1.2,1.6),o.add(q),[ce,z,fe,he,U,Oe,q].forEach(e=>f.add(e));function Re(e,t,n,r,i,a,o){let s=new P(new D(t,n,r),new p({visible:!1}));s.position.set(i,a,o),s.userData.role=e,h.add(s)}Re(`laptop`,.95,.6,.7,0,1.05,1.4),Re(`phone`,.5,.4,.5,1,.98,1.42),Re(`cat`,.62,.74,.5,be,xe,Se);let ze=sn(),J={smooth:new e().load(rn),charm:new e().load(an)};for(let e of[`smooth`,`charm`]){let t=J[e];t.colorSpace=s,t.repeat.set(1,.86),t.offset.set(0,.14),t.needsUpdate=!0}let Y=new P(new me(1,1),new p({map:J.smooth,toneMapped:!1}));Y.position.set(0,1.45,-5),Y.visible=!1,Y.raycast=()=>{},r.add(Y);let Be=`3d`,Ve=`painted`;function X(){let e=Xe===`corner`,t=Be!==`3d`,n=t&&Ve===`painted`;c.visible=e&&!t,l.visible=!e&&!t,u.visible=t||e,Y.visible=t,f.visible=!n}function He(e){return Be=e===`smooth`||e===`charm`?e:`3d`,Be!==`3d`&&(Y.material.map=J[Be],Y.material.needsUpdate=!0),X(),Be}function Ue(e){return Ve=e===`3d`?`3d`:`painted`,X(),Ve}let We=ue.intensity,Ge=pe.material.emissiveIntensity,Ke=new R;function qe(e,t,n){let r=n?n.windowGlow:0,o=r>.55;U.material.map=o?ye:ve,Ce>0&&(Ce=Math.max(0,Ce-e));let s=Ce>0?Math.sin((1.3-Ce)/1.3*Math.PI):0,c=o?.012*Math.sin(t*1.2):.03*Math.sin(t*2.4);U.scale.set(H,H*(1+c+.12*s),1),U.position.y=xe+.06*s,W.material.opacity=s,W.position.set(be,1.72+.5*(1-Ce/1.3),Se),W.scale.setScalar(.22+.1*s),K>0&&(K=Math.max(0,K-e),G.position.y=Math.max(-.09,G.position.y-e*.06),G.material.opacity=K>.3?1:K/.3);for(let e of Ne){let n=e.userData,r=Math.sin(t*n.sp+n.ph)*n.ax,i=Math.sin(t*n.sp*.8+n.ph*1.7)*n.ay*.7,a=Math.cos(t*n.sp*.6+n.ph)*n.az,o=K>0?G.position.x:r,s=K>0?G.position.y:i,c=K>0?G.position.z:a,l=K>0?.05:.1;e.position.x+=(o-e.position.x)*l,e.position.y+=(s-e.position.y)*l,e.position.z+=(c-e.position.z)*l,e.scale.x=(e.position.x>=n.prevx?1:-1)*n.sz,n.prevx=e.position.x}for(let e of Ie){let n=(t*e.userData.sp+e.userData.ph)%1;e.position.set(e.userData.x+Math.sin(t*2+e.userData.ph*9)*.015,-.09+2*Pe*n,.02),e.material.opacity=.5*Math.sin(n*Math.PI)}je.intensity=2.6*r,ke.material.emissiveIntensity=.4+.9*r,ue.intensity=We*(.97+.03*Math.sin(t*7)*Math.sin(t*2.3)),pe.material.emissiveIntensity=Ge*(.85+.15*Math.sin(t*3.1+1)),ge.material.emissiveIntensity=.4*(.65+.35*Math.sin(t*2.2)),Ke.setRGB(1,.85,.62),q.children.forEach((e,n)=>{let i=e.userData,a=(t*i.sp+i.ph)%1;e.position.set(Math.cos(t*.5+i.ph*5)*i.r,-.15+a*.45,Math.sin(t*.4+i.ph*5)*i.r),e.material.opacity=(.1+.18*r)*Math.sin(a*Math.PI)}),se.rotation.z=Math.sin(t*.8)*.05,se.rotation.x=Math.sin(t*.6+1)*.04;let l=n?n.t%1:0;for(let e of g)e.rotation.z=-l*Math.PI*2;if(ze.update(e),Y.visible){let e=i.position.z-Y.position.z,t=2*Math.tan(F.degToRad(i.fov)*.5)*e*1.18;Y.scale.set(t*i.aspect,t,1);let n=.55+.45*(1-r);Y.material.color.setRGB(n,n*.97,n*.92)}i.position.set(a.x+Math.sin(t*.5)*.04,a.y+Math.sin(t*.7)*.02,a.z),i.lookAt(0,1.12,-1)}function Je(e){ee.map=e,te.map=e,ee.needsUpdate=!0,te.needsUpdate=!0}function Ye(e){N.map=e,N.needsUpdate=!0}let Xe=t;function Ze(e){Xe=e===`basement`?`basement`:`corner`;let t=Xe===`corner`;return X(),V.intensity=t?9:3.2,_e.intensity=t?.55:.78,_e.color.set(t?`#6a5238`:`#7a5a34`),Xe}return Ze(Xe),{scene:r,camera:i,update:qe,setCityTexture:Je,setVignetteTexture:Ye,setFitout:Ze,setSkin:He,setProps:Ue,petCat:we,feedFish:Le,vignette:ze,get interactables(){return Be!==`3d`&&Ve===`painted`?h.children:[fe,he,U,Ae]},get tier(){return Xe},get skin(){return Be},get props(){return Ve}}}function sn(){let e=new d;e.background=new R(`#7fb0dd`);let t=new l(-1.4,1.4,.9,-.9,0,10);t.position.set(0,0,5);let n=(e,t={})=>new p({color:e,toneMapped:!1,...t}),r=(e,t,r,i,a,o,s)=>{let c=new P(new me(e,t),n(o,s));return c.position.set(r,i,a),c};e.add(r(3.2,.9,.5,-.95,1,`#2a4a30`)),e.add(r(3.2,.7,-.7,-1.05,2,`#1d3724`)),e.add(r(.06,.3,-.95,-.55,3,`#3a2a1a`));let i=new P(new k(.22,18),n(`#234a2a`));i.position.set(-.95,-.32,3),e.add(i),e.add(r(.04,.55,.9,-.55,3,`#20242a`));let a=new P(new k(.1,16),n(`#ffd98a`,{transparent:!0,opacity:0}));a.position.set(.9,-.26,3.1),e.add(a);let o=new P(new k(.16,24),n(`#fff4d8`));e.add(o);let s=[];for(let[t,r]of[[-1,.5],[-.6,.7],[.2,.6],[.7,.72],[1.05,.45],[-.2,.78],[.45,.4]]){let i=new P(new k(.015,8),n(`#ffffff`,{transparent:!0,opacity:0}));i.position.set(t,r,.5),s.push(i),e.add(i)}let c=new R(`#141d33`),u=new R(`#7fb6e0`),f=new R(`#d6824a`),m=new R(`#fff0cc`),h=new R(`#cdd8ef`),g=.34;function _(t){g=(g+t*.04)%1;let n=g*Math.PI*2,r=-Math.cos(n);o.position.set(Math.sin(n)*1.15,r*.66+.06,0);let i=F.smoothstep(r,-.18,.5),l=F.smoothstep(.32,0,Math.abs(r));e.background.copy(c).lerp(u,i).lerp(f,l*.45),o.material.color.copy(r>0?m:h),a.material.opacity=1-i;let d=(1-i)*.85;for(let e of s)e.material.opacity=d}return{scene:e,camera:t,update:_}}function cn(e,{x:t,y:n,z:r,ry:i=0,face:a=`#efe2c8`,rim:o=`#2a1c10`}){let s=new y,c=new P(new k(.2,28),new m({color:o,roughness:.6})),l=new P(new k(.17,28),new m({color:a,roughness:.7}));l.position.z=.01;let u=new P(new me(.018,.14),new m({color:`#1a130c`,roughness:.5}));return u.geometry.translate(0,.05,0),u.position.z=.02,e.push(u),s.add(c,l,u),s.position.set(t,n,r),s.rotation.y=i,s}function ln(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=`#e08a3c`,i=`#b96a26`,a=`#3a2410`;if(n.lineJoin=`round`,e){n.fillStyle=r,n.beginPath(),n.ellipse(64,78,44,26,0,0,7),n.fill(),n.fillStyle=i,n.beginPath(),n.ellipse(64,86,44,16,0,0,7),n.fill(),n.fillStyle=r,n.beginPath(),n.arc(36,70,20,0,7),n.fill(),n.fillStyle=r,un(n,24,56,34,44,42,58),un(n,40,54,50,44,54,60),n.strokeStyle=i,n.lineWidth=7,n.lineCap=`round`,n.beginPath(),n.moveTo(100,70),n.quadraticCurveTo(112,90,88,96),n.stroke(),n.strokeStyle=a,n.lineWidth=2.5,n.beginPath(),n.arc(30,70,5,.1,Math.PI-.1),n.stroke(),n.strokeStyle=i,n.lineWidth=3;for(let e of[60,74,88])n.beginPath(),n.moveTo(e,58),n.lineTo(e,70),n.stroke()}else{n.fillStyle=r,n.beginPath(),n.ellipse(64,86,30,34,0,0,7),n.fill(),n.fillStyle=`#f3c98a`,n.beginPath(),n.ellipse(64,92,14,22,0,0,7),n.fill(),n.strokeStyle=i,n.lineWidth=8,n.lineCap=`round`,n.beginPath(),n.moveTo(92,100),n.quadraticCurveTo(116,86,104,60),n.stroke(),n.fillStyle=r,n.beginPath(),n.arc(64,48,24,0,7),n.fill(),n.fillStyle=r,un(n,44,34,50,18,60,34),un(n,84,34,78,18,68,34),n.fillStyle=`#f0b0c0`,un(n,47,30,50,22,56,32),un(n,81,30,78,22,72,32),n.fillStyle=a,n.beginPath(),n.arc(55,47,3.4,0,7),n.arc(73,47,3.4,0,7),n.fill(),n.fillStyle=`#e06a7a`,un(n,61,54,67,54,64,58),n.strokeStyle=a,n.lineWidth=1.6;for(let e of[-2,3])n.beginPath(),n.moveTo(50,55+e),n.lineTo(34,53+e),n.moveTo(78,55+e),n.lineTo(94,53+e),n.stroke();n.strokeStyle=i,n.lineWidth=3;for(let e of[78,90,102])n.beginPath(),n.moveTo(50,e),n.lineTo(78,e),n.stroke()}let o=new O(t);return o.colorSpace=s,o}function un(e,t,n,r,i,a,o){e.beginPath(),e.moveTo(t,n),e.lineTo(r,i),e.lineTo(a,o),e.closePath(),e.fill()}function dn(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`);t.fillStyle=`#ff5a8a`,t.beginPath(),t.moveTo(32,52),t.bezierCurveTo(6,32,14,10,32,24),t.bezierCurveTo(50,10,58,32,32,52),t.fill();let n=new O(e);return n.colorSpace=s,n}function fn(e){let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);n.fillStyle=e,n.beginPath(),n.ellipse(30,32,18,11,0,0,7),n.fill(),n.beginPath(),n.moveTo(46,32),n.lineTo(60,22),n.lineTo(60,42),n.closePath(),n.fill(),n.fillStyle=`rgba(255,255,255,0.35)`,n.beginPath(),n.ellipse(28,36,12,5,0,0,7),n.fill(),n.fillStyle=`#15212a`,n.beginPath(),n.arc(20,30,2.6,0,7),n.fill();let r=new O(t);return r.colorSpace=s,r}function pn(){let e=document.createElement(`canvas`);e.width=e.height=32;let t=e.getContext(`2d`),n=t.createRadialGradient(16,16,0,16,16,16);n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.6,`rgba(255,255,255,0.7)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(16,16,16,0,7),t.fill();let r=new O(e);return r.colorSpace=s,r}function mn(e){let t=document.createElement(`canvas`);t.width=t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,256,256);e<0?(r.addColorStop(0,`#6a3b1c`),r.addColorStop(1,`#caa15a`)):(r.addColorStop(0,`#3a4a6a`),r.addColorStop(1,`#a86a3a`)),n.fillStyle=r,n.fillRect(0,0,256,256),n.globalAlpha=.5;for(let e=0;e<5;e++)n.fillStyle=e%2?`#2a1c10`:`#e0c080`,n.fillRect(30+e*36,40+e%3*30,26,150);let i=new O(t);return i.colorSpace=s,i}var{Timer:hn}=se,gn=new URLSearchParams(window.location.search),_n=gn.get(`demo`)===`1`||gn.has(`capture`);window.__demo=_n;var vn=(gn.get(`city`)?Number(gn.get(`city`)):0)||Math.random()*1e9|0,yn=0,bn=Qt({demo:_n,citySeed:vn,profileIndex:yn}),{renderer:xn,rig:Sn,sunRig:Cn,city:wn,cityLife:Tn,waterMaterial:En,fitShadowFrustum:Dn,landmarkFactory:On,renderCityBeautyTo:kn}=bn,$=on({tier:`corner`});$.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix();var An=!0;window.__shadows=An,window.__scene=`office`;var jn=new v(55,1.4,.1,100);jn.position.set(2.2,3.4,11.5),jn.lookAt(0,2,0);var Mn=new I(640,448,{minFilter:i,magFilter:i,depthBuffer:!0,stencilBuffer:!1});$.setCityTexture(Mn.texture);var Nn=0,Pn=3,Fn=new I(512,320,{minFilter:i,magFilter:i,depthBuffer:!0,stencilBuffer:!1});$.setVignetteTexture(Fn.texture);var In=!1,Ln=(()=>{if(typeof document>`u`)return{showLap(){},toast(){},flash(){}};let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.className=`lap`,t.innerHTML=`<div class="lap-win"><div class="lap-bar"><b>PORTFOLIO OS — John's Game</b>
    ...
    </div></div>`;let n=document.createElement(`div`);n.className=`otoast`;let r=document.createElement(`div`);r.className=`oflash`,document.body.append(t,n,r),t.querySelector(`.lap-x`).addEventListener(`click`,()=>zn()),t.addEventListener(`click`,e=>{e.target===t&&zn()}),t.addEventListener(`click`,e=>{e.target.closest(`button`)&&navigator.vibrate?.(10)});let i=0;return{showLap(e){t.classList.toggle(`on`,e)},toast(e){n.textContent=e,n.classList.add(`on`),clearTimeout(i),i=setTimeout(()=>n.classList.remove(`on`),1400)},flash(){r.style.transition=`none`,r.style.opacity=`0.85`,requestAnimationFrame(()=>{r.style.transition=`opacity .55s`,r.style.opacity=`0`})}}})();function Rn(){In=!0,Ln.showLap(!0)}function zn(){In=!1,Ln.showLap(!1)}function Bn(){yn=(yn+1)%Ve.length,Ln.flash(),wn.generate(vn,yn),En.uniforms.uVecWater.value.set(wn.waterColor),Tn.setProfile(wn.state.profile),Dn(),Ln.toast(`✈  `+wn.state.profile.name),window.__profile=wn.state.profile.key}function Vn(e){let t=$.setFitout(e);return Ln.toast(t===`basement`?`🏚  Basement office`:`🏙  Corner office`),window.__tier=t,t}function Hn(){return Vn($.tier===`corner`?`basement`:`corner`)}window.__tier=$.tier;var Un=[`3d`,`smooth`,`charm`],Wn={"3d":`🧊  Stylized 3D office`,smooth:`🖼  Smooth diffusion skin`,charm:`🕹  Charm diffusion skin`};function Gn(e){let t=$.setSkin(e);return window.__officeSkin=t,Ln.toast(Wn[t]),t}function Kn(){return Gn(Un[(Un.indexOf($.skin)+1)%Un.length])}window.__officeSkin=$.skin;var qn={painted:`🎨  Painted props (cohesive)`,"3d":`🧊  Live 3D props (animated)`};function Jn(e){let t=$.setProps(e);return window.__officeProps=t,$.skin!==`3d`&&Ln.toast(qn[t]),t}function Yn(){return Jn($.props===`painted`?`3d`:`painted`)}window.__officeProps=$.props;var Xn=new C,Zn=new A,Qn=(e,t)=>{Zn.x=e/window.innerWidth*2-1,Zn.y=-(t/window.innerHeight)*2+1};function $n(){Xn.setFromCamera(Zn,$.camera);let e=Xn.intersectObjects($.interactables,!0)[0];if(!e)return null;let t=e.object;for(;t&&!t.userData.role;)t=t.parent;return t?t.userData.role:null}function er(e){e===`laptop`?Rn():e===`phone`?Bn():e===`cat`?$.petCat():e===`tank`&&$.feedFish()}var tr=0,nr=0,rr=0;xn.domElement.addEventListener(`mousedown`,e=>{tr=e.clientX,nr=e.clientY,rr=performance.now()}),window.addEventListener(`mousemove`,e=>{Qn(e.clientX,e.clientY),xn.domElement.style.cursor=$n()?`pointer`:`default`}),window.addEventListener(`mouseup`,e=>{if(Math.hypot(e.clientX-tr,e.clientY-nr)<6&&performance.now()-rr<350&&!In){Qn(e.clientX,e.clientY);let t=$n();t&&er(t)}});var ir=!1;xn.domElement.addEventListener(`touchstart`,e=>{e.touches.length===1&&(tr=e.touches[0].clientX,nr=e.touches[0].clientY,rr=performance.now(),ir=!1)},{passive:!0}),xn.domElement.addEventListener(`touchmove`,e=>{e.touches.length===1&&Math.hypot(e.touches[0].clientX-tr,e.touches[0].clientY-nr)>8&&(ir=!0)},{passive:!0}),window.addEventListener(`touchend`,e=>{if(!ir&&performance.now()-rr<350&&(!e.touches||e.touches.length===0)&&!In){let e=$n();e&&er(e)}}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&In&&zn(),(e.key===`f`||e.key===`F`)&&Hn(),(e.key===`j`||e.key===`J`)&&Kn(),(e.key===`u`||e.key===`U`)&&Yn(),(e.key===`t`||e.key===`T`)&&Cn.cyclePreset(),(e.key===`h`||e.key===`H`)&&(An=!An,window.__shadows=An)}),On.whenReady.then(()=>{wn.generate(vn,yn),Dn(),window.__cityReady=!0}),gn.get(`office`)===`basement`&&Vn(`basement`);var ar=gn.get(`officeskin`);[`3d`,`smooth`,`charm`].includes(ar)&&Gn(ar);var or=gn.get(`officeprops`);[`painted`,`3d`].includes(or)&&Jn(or);var sr=new hn;sr.connect(document);function cr(){sr.update();let e=Math.min(sr.getDelta(),.1);Sn.update(e),bn.updateWorld(e,sr.getElapsed(),{shadowsOn:An,seasonTarget:0}),$.update(e,sr.getElapsed(),Cn),$.tier===`basement`?(xn.setRenderTarget(Fn),xn.render($.vignette.scene,$.vignette.camera)):Nn%Pn===0&&kn(jn,Mn),Nn++,xn.setRenderTarget(null),xn.render($.scene,$.camera),requestAnimationFrame(cr)}cr(),nn({key:`office`,title:`The Office`,tips:[`Click / tap the LAPTOP to open the game panel`,`Tap the PHONE to travel to another city · pet the CAT · feed the FISH`,`Esc exits · F fitout · J skin · U props · T time`]}),window.addEventListener(`resize`,()=>{bn.resize(),$.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix()});