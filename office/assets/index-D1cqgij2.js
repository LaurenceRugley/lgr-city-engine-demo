...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,wi={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Ti=[`gb`,`8-bit`,`16-bit`,`modern`];function Ei(t){let n=Math.max(t.length,1),r=new Float32Array(n*4);t.forEach((e,t)=>{let n=new I(e);r[t*4+0]=n.r,r[t*4+1]=n.g,r[t*4+2]=n.b,r[t*4+3]=1});let i=new ye(r,n,1,e,be);return i.minFilter=x,i.magFilter=x,i.needsUpdate=!0,i}var Di=220,Oi={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},ki={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Ai({demo:t=!1,citySeed:r=0,profileIndex:a=0}={}){let l=new re({antialias:!0,preserveDrawingBuffer:!0});l.shadowMap.enabled=!0,l.shadowMap.type=1,l.shadowMap.autoUpdate=!1,l.shadowMap.needsUpdate=!0;let d=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches?1.5:2;l.setPixelRatio(Math.min(window.devicePixelRatio,d)),l.setSize(window.innerWidth,window.innerHeight),l.setClearColor(920327,1),document.body.appendChild(l.domElement);let p=l.getDrawingBufferSize(new de),m=!1,h=!1,g=()=>{};l.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),m=!0,typeof window<`u`&&(window.__contextLost=!0)},!1),l.domElement.addEventListener(`webglcontextrestored`,()=>{g(),m=!1,typeof window<`u`&&(window.__contextLost=!1)},!1);let _=new me;_.fog=new b(10465470,0);let y=new I(`#aeb6c0`),C=.062,w=new I(`#74508f`),T=new I,E=ze({aspect:window.innerWidth/window.innerHeight}),D=Tt({t:.5}),O={type:i,format:e,minFilter:x,magFilter:x,wrapS:se,wrapT:se,depthBuffer:!1,stencilBuffer:!1},k=[new L(256,256,O),new L(256,256,O),new L(256,256,O)];for(let e of k)l.setRenderTarget(e),l.clear();l.setRenderTarget(null);let ee=new me,A=new s(-1,1,1,-1,0,1),j=new ie({vertexShader:Nn,fragmentShader:mi,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new de(1/256,1/256)},uMouse:{value:new de(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new B)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new B)}}});ee.add(new n(new u(2,2),j));let te=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1});function ne(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new W(t);return r.colorSpace=V,r}let M=new n(new u(28,28),new S({map:ne(t)}));M.rotation.x=-Math.PI/2,M.position.y=-.35,_.add(M);let N=new n(new u(40,24),new ie({depthWrite:!1,vertexShader:fi,fragmentShader:pi,uniforms:{uTime:{value:0},uInk:{value:D.horizon},uGold:{value:D.sky},uFogColor:{value:T},uFogAmt:{value:0},uFogCharm:Ke}}));N.position.set(0,3,-8),_.add(N);let P=new ie({vertexShader:hi,fragmentShader:gi,uniforms:{uHeight:{value:null},uScene:{value:te.texture},uTexel:{value:new de(1/256,1/256)},uResolution:{value:new de(p.x,p.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new v},uLightDir:{value:D.sunDir},uInk:{value:new I(`#2A2218`)},uGold:{value:new I(`#B89968`)},uVector:Be,uVecWater:{value:new I(`#1fb8d8`)},uVecTint:{value:Ve}}}),F=new n(new u(28,28,255,255),P);F.rotation.x=-Math.PI/2,F.updateMatrixWorld(!0),P.uniforms.uNormalMatrix.value.getNormalMatrix(F.matrixWorld),_.add(F);let ae={value:0},oe=Qt({windowGlow:ae}),R=_t({seed:r,profileIndex:a,landmarkFactory:oe,windowGlow:ae});_.add(R.group);let z=At({plinthTop:.3,extent:R.extent,profile:R.state.profile});_.add(z.group);let ce=Bt({extent:R.extent,waterSize:28,plinthTop:.3});_.add(ce.group),j.uniforms.uWakeDrops.value=ce.wakeDrops;let H=en({extent:R.extent});_.add(H.group),j.uniforms.uRainDrops.value=H.rainDrops;let le=nn({extent:R.extent});_.add(le.group);let ue=[z,ce,le],fe=on({rig:E,getCamera:()=>E.camera,sources:ue}),pe=di();_.add(pe.group);let U=qr({scale:90});_.add(U.mesh),_.environmentIntensity=.32;let he=!1;function ge(e){let t=e&&D.sunArc.y>-.04;t!==he&&(he=t,U.mesh.visible=t,N.visible=!t)}let _e=null,ve=-1;g=()=>{_e=null,ve=-1,l.shadowMap.needsUpdate=!0};function ye(){let e=Math.floor(D.t%1*4)%4;return(e!==ve||!_e)&&(ve=e,_e=U.buildEnv(l)),_e}let be=null,G=null,Se=null,K=null,Ce=!1,we=1234,Te=`valley`,Ee=rr.map(e=>e.key),De=new c({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Oe=()=>[R.group,z.group,ce.group],ke=()=>[be,G,Se].filter(Boolean);function Ae(){for(let e of ke())_.remove(e),e.userData.dispose?.();let e=cr({seed:we,size:160,preset:Te});K=e,be=hr(e,{worldSize:26,baseY:0,chunks:6}),G=Br({terrain:e,seed:we,worldSize:26,baseY:0,biomeKeys:Ee}),Se=Ur(e,{worldSize:26,baseY:0,maxLakes:3,material:De});for(let e of ke())e.visible=Ce,_.add(e);q!==void 0&&q&&q.clear(),J!==void 0&&J&&J.clear(),typeof window<`u`&&(window.__world={seed:we,preset:Te,active:Ce,chunks:be.children.length,scatter:G.userData.counts,lakes:Se.userData.count})}let je=e=>{for(let t of ke())t.visible=e};function Me(e,t){if(!K)return 0;let{size:n,height:r,sea:i,relief:a}=K,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let q=jn({heightAt:Me,seaSurfaceY:0,waterY:.06});q.group.visible=!1,_.add(q.group),ue.push(q);let Ne=0;function Pe(e,t){if(!K||!be)return;let{size:n,height:r,relief:i}=K,a=26/(n-1),o=26/(t-1),s=i>1e-6?1/i:0,c=!1;for(let i=0;i<t;i++)for(let l=0;l<t;l++){let u=e[i*t+l];if(u===0)continue;c=!0;let d=u*s,f=l*o/a,p=i*o/a,m=Math.max(0,Math.round(f-1)),h=Math.min(n-1,Math.round(f+1)),g=Math.max(0,Math.round(p-1)),_=Math.min(n-1,Math.round(p+1));for(let e=g;e<=_;e++)for(let t=m;t<=h;t++){let i=e*n+t,a=r[i]+d;r[i]=a<0?0:a>1?1:a}}c&&(Ne++,Ne%8==0&&gr(be,K,be.children),Ne%24==0&&G&&zr(G,K,{worldSize:26,baseY:0}))}function Fe(e,t){if(!K||!be)return;let{size:n,height:r,relief:i}=K,a=i>1e-6?1/i:0,o=(t-1)/(n-1),s=!1;for(let i=0;i<n;i++){let c=i*o,l=Math.floor(c),u=c-l,d=Math.min(t-1,l+1);for(let c=0;c<n;c++){let f=c*o,p=Math.floor(f),m=f-p,h=Math.min(t-1,p+1),g=e[l*t+p],_=e[l*t+h],v=e[d*t+p],y=e[d*t+h],b=(g*(1-m)+_*m)*(1-u)+(v*(1-m)+y*m)*u;if(b!==0){s=!0;let e=i*n+c,t=r[e]+b*a;r[e]=t<0?0:t>1?1:t}}}s&&(gr(be,K,be.children),G&&zr(G,K,{worldSize:26,baseY:0}))}let J=Hn({worldHeightAt:Me,applyErosion:Pe,syncErodedTerrain:Fe,worldSize:26,grid:96,seaY:0,renderer:l});J.group.visible=!1,_.add(J.group);let Ie=null,Le=new Set;function Re(){!K||!Se||(_.remove(Se),Se.userData.dispose?.(),Se=Ur(K,{worldSize:26,baseY:0,maxLakes:3,material:De}),Se.visible=Ce,_.add(Se),window.__world&&(window.__world.lakes=Se.userData.count))}function Je(){Re(),G&&zr(G,K,{worldSize:26,baseY:0})}function Ye(e,t,n=1,r=2.2,i=.05){if(!K||!be)return;let a=K.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=K.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Le.clear();for(let e of be.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Le.add(e)}gr(be,K,Le),Ie&&clearTimeout(Ie),Ie=setTimeout(Je,140)}function Xe(e,t,n,r=2.2){if(!K||!be||n==null)return;let i=K.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=K.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);Le.clear();for(let e of be.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Le.add(e)}gr(be,K,Le,!0)}let Ze=[`tree`,`rock`,`tuft`];function Qe(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!K||!G)return 0;if(a)return Lr(G,n||`all`,e,t,i);let o=K.size,s=26/(o-1),c=K.height,l=K.sea,u=K.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Rr[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;Ir(G,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&G.userData.counts)for(let e of Ze)G.userData.counts[e]=(G.userData.placements[e]||[]).length;return g}let $e=[];function et(){if(!G)return null;let e=G.userData.placements,t={};for(let n of Ze)t[n]=(e[n]||[]).map(e=>({...e}));return t}function Y(){K&&($e.push({h:K.height.slice(),b:K.biome.slice(),sc:et(),pl:q.snapshot()}),$e.length>12&&$e.shift())}function nt(){if(!K||!$e.length)return!1;let e=$e.pop();if(K.height.set(e.h),K.biome.set(e.b),e.sc&&G){let t=G.userData.placements;for(let n of Ze)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&q.restore(e.pl),gr(be,K,be.children,!0),Je(),!0}let rt=new Set([`boat`,`fish`]),it=new Set([`person`,`atv`]);function at(e,t,n){if(!K)return null;let r=Me(t,n)<0;return rt.has(e)&&!r||it.has(e)&&r?null:q.spawn(e,t,n)}function ot(e,t,n=2.5){return q.removeNear(e,t,n)}function st(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function ct(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let lt=e=>st(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),ut=e=>st(e);function dt(){let e=G?G.userData.placements:{},t={};for(let n of Ze)t[n]=(e[n]||[]).map(e=>({...e}));return t}function ft(){return K?{v:1,seed:we,preset:Te,size:K.size,height:lt(K.height),biome:ut(K.biome),scatter:dt(),entities:q.snapshot()}:null}function pt(){if(!K)return null;let e=cr({seed:we,size:160,preset:Te}),t=K.height,n=K.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:we,preset:Te,hd:r,bd:i,entities:q.snapshot()}}function mt(e){G&&(_.remove(G),G.userData.dispose?.()),G=Mr(e||{tree:[],rock:[],tuft:[]}),G.userData.counts=Ze.reduce((e,t)=>(e[t]=(G.userData.placements[t]||[]).length,e),{}),G.visible=Ce,_.add(G)}function ht(e){if(!e||e.v!==1)return!1;we=e.seed|0,Te=sr.includes(e.preset)?e.preset:Te,$e.length=0,Ae(),Ce=!0,je(!0),q.group.visible=!0,J.group.visible=!0;for(let e of Oe())e.visible=!1;if(window.__world&&(window.__world.active=!0),e.height&&e.biome){let t=ct(e.height);K.height.set(new Float32Array(t.buffer,t.byteOffset,t.byteLength/4));let n=ct(e.biome);K.biome.set(n.subarray(0,K.biome.length))}else if(e.hd||e.bd){let t=e.hd||[],n=e.bd||[];for(let e=0;e<t.length;e+=2)K.height[t[e]]=t[e+1];for(let e=0;e<n.length;e+=2)K.biome[n[e]]=n[e+1]}return gr(be,K,be.children,!0),e.scatter&&mt(e.scatter),Re(),G&&zr(G,K,{worldSize:26,baseY:0}),q.restore(e.entities),window.__world&&(window.__world.scatter=G.userData.counts,window.__world.seed=we,window.__world.preset=Te),!0}let gt={enter(){be||Ae(),Ce=!0,je(!0),q.group.visible=!0,J.group.visible=!0;for(let e of Oe())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){Ce=!1,je(!1),q.group.visible=!1,J.group.visible=!1;for(let e of Oe())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return we=Math.random()*1e9|0,$e.length=0,Ae(),gt.enter(),we},reset(){return $e.length=0,Ae(),gt.enter(),we},setPreset(e){return sr.includes(e)&&(Te=e,$e.length=0,Ae(),gt.enter()),Te},sculpt:Ye,paintBiome:Xe,paintScatter:Qe,repoolWater:Re,snapshot:Y,undo:nt,placeEntity:at,removeEntityNear:ot,heightAt:Me,serialize:ft,serializeCompact:pt,deserialize:ht,flowPourAt:(e,t,n,r)=>J.pourAt(e,t,n,r),flowRain:e=>J.rain(e),flowClear:()=>J.clear(),get flowTotal(){return J.totalWater()},flowAt:(e,t)=>J.cellAt(e,t),flowErosion:(e,t)=>J.setErosion(e,t),get flowErosionOn(){return J.erosion},get flowSediment(){return J.totalSediment()},setSimBackend:e=>J.setBackend(e),get simBackend(){return J.backend},_flowReadW:()=>J._debugReadW(),_flowReadTerr:()=>J._debugReadTerr(),_flowStepN:(e,t)=>J._debugStepN(e,t),get terrainGroup(){return be},get biomes(){return rr},get scatterCounts(){return G?G.userData.placements&&Ze.reduce((e,t)=>(e[t]=(G.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return q.counts()},setScatterHidden(e){G&&(G.visible=!e)},get placedLife(){return q},get canUndo(){return $e.length>0},get active(){return Ce},get seed(){return we},get preset(){return Te},get presets(){return sr}},vt=Gr(),yt=qn({world:gt,catalog:vt,inspector:fe});function bt(e,t){return Me(e,t)<0?0:-999}let xt=vn({rig:E,world:{heightAt:Me,waterHeightAt:bt}});R.group.remove(R.key),_.add(R.key),R.key.castShadow=!0,R.key.shadow.mapSize.set(2048,2048),R.key.shadow.bias=-18e-5,R.key.shadow.normalBias=.028,_.add(R.key.target);function St(){let e=R.key.shadow.camera,t=R.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),l.shadowMap.needsUpdate=!0}St();let Ct=new xe(p.x,p.y),wt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1,depthTexture:Ct}),Et=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Dt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1,samples:4}),Ot=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),kt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),jt=Math.max(1,Math.floor(p.x/2)),Mt=Math.max(1,Math.floor(p.y/2)),Nt=new L(jt,Mt,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Pt=new L(jt,Mt,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Ft=new me,It=new s(-1,1,1,-1,0,1),Lt=new n(new u(2,2));Ft.add(Lt);let X=new ie({vertexShader:Nn,fragmentShader:_i,uniforms:{uScene:{value:wt.texture},uTime:{value:0},uResolution:{value:new de(p.x,p.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:Nt.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:D.grade.tint},uGradeLift:{value:D.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1},uDither:{value:0},uTonemap:{value:0}}}),Rt=new ie({vertexShader:Nn,fragmentShader:xi,uniforms:{uScene:{value:wt.texture},uThreshold:{value:.78}}}),zt=new ie({vertexShader:Nn,fragmentShader:Si,uniforms:{uScene:{value:Nt.texture},uDir:{value:new de}}});function Vt(e){Rt.uniforms.uScene.value=e.texture,Yt(Rt,Nt),zt.uniforms.uScene.value=Nt.texture,zt.uniforms.uDir.value.set(1.6/jt,0),Yt(zt,Pt),zt.uniforms.uScene.value=Pt.texture,zt.uniforms.uDir.value.set(0,1.6/Mt),Yt(zt,Nt),X.uniforms.uBloom.value=Nt.texture;let t=1-f.clamp(D.sunArc.y*2.2,0,1);X.uniforms.uBloomStrength.value=.85*(.32+.95*t)}let Ht=e=>{let t=e.map(e=>new I(e));for(;t.length<8;)t.push(new I(0,0,0));return t},Ut=[`night`,`dawn`,`noon`,`dusk`],Z={inkgold:Ut.map(e=>Ht(Oi[e])),terminal:Ut.map(e=>Ht(ki[e]))},Wt=new ie({vertexShader:Nn,fragmentShader:vi,uniforms:{uScene:{value:Et.texture},uResolution:{value:new de(p.x,p.y)},uPixelSize:{value:Di},uPalette:{value:Z.inkgold[2]},uPaletteB:{value:Z.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),Gt=new ie({vertexShader:Nn,fragmentShader:Ci,uniforms:{uScene:{value:Et.texture},uResolution:{value:new de(p.x,p.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Ei(wi[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Kt={};for(let e of Ti)Kt[e]=wi[e].palette?Ei(wi[e].palette):null;let qt=new ie({vertexShader:Nn,fragmentShader:yi,uniforms:{uScene:{value:Et.texture},uDepth:{value:Ct},uResolution:{value:new de(p.x,p.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:D.toonFloor},uOutline:{value:D.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Jt=new ie({vertexShader:Nn,fragmentShader:bi,uniforms:{uToon:{value:Ot.texture},uPixel:{value:kt.texture},uBlend:{value:0}}});function Yt(e,t){Lt.material=e,l.setRenderTarget(t),l.render(Ft,It)}function Xt(){E.setViewport(window.innerWidth,window.innerHeight),l.setSize(window.innerWidth,window.innerHeight);let e=l.getDrawingBufferSize(new de);return te.setSize(e.x,e.y),wt.setSize(e.x,e.y),Et.setSize(e.x,e.y),Dt.setSize(e.x,e.y),Ot.setSize(e.x,e.y),kt.setSize(e.x,e.y),jt=Math.max(1,e.x>>1),Mt=Math.max(1,e.y>>1),Nt.setSize(jt,Mt),Pt.setSize(jt,Mt),P.uniforms.uResolution.value.set(e.x,e.y),X.uniforms.uResolution.value.set(e.x,e.y),Wt.uniforms.uResolution.value.set(e.x,e.y),Gt.uniforms.uResolution.value.set(e.x,e.y),qt.uniforms.uResolution.value.set(e.x,e.y),e}let Zt=Xn({renderer:l}),$t=!0;function tn(e,t){let n=t.dpr==null?d:t.dpr,r=Math.min(window.devicePixelRatio,n);Math.abs(l.getPixelRatio()-r)>.001&&(l.setPixelRatio(r),typeof window<`u`&&window.dispatchEvent?window.dispatchEvent(new Event(`resize`)):Xt()),$t=t.shadows!==!1,$t||(l.shadowMap.needsUpdate=!1)}let rn=Qn({profiler:Zt,apply:tn});function an(){!h&&!m&&Zt.frameStart()}function sn(){h||m||(Zt.frameEnd(),rn.update())}function cn(e){h=!e,typeof window<`u`&&(window.__paused=h)}function ln(){try{l.compile(_,E.camera),Mn(1/60,0,{shadowsOn:!0}),Dn(On(),wt),l.setRenderTarget(null)}catch(e){typeof console<`u`&&console.warn(`[L79] prewarm`,e)}}let un=3,dn=!1,fn=!1,pn=`native`,mn=.3,hn=.46,gn=[`native`,...Ti],_n={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=un,window.__vector=dn,window.__era=pn),typeof window<`u`&&(window.__frames=0),typeof window<`u`&&(window.__loaded=!1);let yn=0,bn=new B(1,1,1),xn=!1;function Sn(e){let t=fn?Z.terminal:Z.inkgold,n=e%1*4,r=Math.floor(n)%4;Wt.uniforms.uPalette.value=t[r],Wt.uniforms.uPaletteB.value=t[(r+1)%4],Wt.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Cn(e){let t=wi[e];t&&(Gt.uniforms.uGridWidth.value=t.gridWidth,Gt.uniforms.uDither.value=t.dither,Gt.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(Gt.uniforms.uPalette.value=Kt[e],Gt.uniforms.uPaletteSize.value=t.palette.length))}function wn(){pn!==`native`&&Cn(pn)}let Tn=()=>pn===`native`?Wt:Gt;function En(e,t){ge(!0),_.environment=ye(),tt.value=1,F.visible=!1,l.setRenderTarget(te),l.render(_,e),F.visible=!0,l.setRenderTarget(Dt),l.render(_,e),Vt(Dt),X.uniforms.uScene.value=Dt.texture,X.uniforms.uAces.value=1,X.uniforms.uGrade.value=1,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=1,Yt(X,t)}function Dn(e,t){let n=!dn&&(un===1||un===2);if(ge(n),_.environment=n?ye():null,tt.value=+!!n,X.uniforms.uBloomStrength.value=0,F.visible=!1,l.setRenderTarget(te),l.render(_,E.camera),F.visible=!0,un===1&&!n)l.setRenderTarget(t),l.render(_,E.camera);else if(un===1)l.setRenderTarget(Dt),l.render(_,E.camera),Vt(Dt),X.uniforms.uScene.value=Dt.texture,X.uniforms.uAces.value=1,X.uniforms.uGrade.value=1,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=1,Yt(X,t);else if(l.setRenderTarget(n?Dt:wt),l.render(_,E.camera),un===2)n&&Vt(Dt),X.uniforms.uScene.value=n?Dt.texture:wt.texture,X.uniforms.uAces.value=+!!n,X.uniforms.uGrade.value=+!!n,X.uniforms.uGrain.value=1,X.uniforms.uChroma.value=1,X.uniforms.uDither.value=+!!n,Yt(X,t);else{X.uniforms.uScene.value=wt.texture,X.uniforms.uAces.value=0,X.uniforms.uGrade.value=0,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=0,Yt(X,Et);let n=E.camera;qt.uniforms.uNear.value=n.near,qt.uniforms.uFar.value=n.far,qt.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Cn(e.era),Gt):Tn();e.kind===`pixel`?(Yt(r,t),window.__style=`pixel`):e.kind===`toon`?(Yt(qt,t),window.__style=`toon`):(Yt(qt,Ot),Yt(r,kt),Jt.uniforms.uBlend.value=e.blend,Yt(Jt,t),window.__style=`blend`)}}function On(){let e=kn(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return P.uniforms.uChromaScale.value=f.lerp(1,.5,t),e}function kn(){if(un===1||un===2)return{kind:`none`};if(un===7)return{kind:`pixel`};if(un===8)return{kind:`toon`};let e=E.styleT;return window.__styleT=e,e<=mn?{kind:`toon`}:e>=hn?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:f.smoothstep(e,mn,hn),era:`16-bit`}}function An(e){return un===1||un===2?``:dn&&un!==7&&un!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?_n[e.era||pn]||`Pixel`:e.kind===`blend`?`Toon → `+(_n[e.era]||`Pixel`):``}function Mn(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){typeof window<`u`&&window.__frames++,n&&=$t,N.material.uniforms.uTime.value=t,X.uniforms.uTime.value=t,D.update(e),R.key.position.copy(D.sunDir).multiplyScalar(24),R.key.color.copy(D.sunColor),R.key.intensity=D.sunIntensity,R.fill.color.copy(D.hemiSky),R.fill.groundColor.copy(D.hemiGround),ae.value=D.windowGlow,U.setSun(D.sunArc),U.setParams(D.skyParams),X.uniforms.uGradeSat.value=D.grade.sat,X.uniforms.uGradeContrast.value=D.grade.contrast,_.environmentIntensity=.34*(1-.6*f.clamp(D.sunArc.y*1.5,0,1));let i=H.overcast;R.key.intensity*=1-.5*i,R.key.color.lerp(y,.45*i),R.fill.intensity=1+.7*i;let a=f.smoothstep(D.sunDir.y,.06,.34),o=f.lerp(.28,1,1-D.windowGlow),s=n?a*o:0;R.key.shadow.intensity=.72*s,He.value=.52*s,(n&&!xn||bn.distanceToSquared(D.sunDir)>2e-5)&&(l.shadowMap.needsUpdate=!0,bn.copy(D.sunDir)),xn=n;let c=1-D.windowGlow;Ve.setRGB(f.lerp(.46,1,c),f.lerp(.52,1,c),f.lerp(.74,1,c)),X.uniforms.uExposure.value=D.exposure,qt.uniforms.uToonGain.value=D.toonGain,l.setClearColor(D.horizon,1),Sn(D.t),window.__t=D.t,z.update(e,t,D),R.update(t),ce.update(e,t,D),j.uniforms.uWakeCount.value=ce.wakeCount,H.update(e,t),j.uniforms.uRainCount.value=H.rainDropCount;let u=H.fog*(1-c);_.fog.density=H.fog*C,T.copy(D.horizon).lerp(w,.85*u),_.fog.color.copy(T),l.setClearColor(T,1),Ke.value=H.fog,N.material.uniforms.uFogAmt.value=.7*H.fog,Ue.value=H.snow,We.value=H.cloud*.55,Ge.x+=e*.018,Ge.y+=e*.009,qe.value+=(r-qe.value)*Math.min(1,e*1.5),le.update(e,t,D,H),Ce&&q.update(e,t,D),Ce&&J.step(e);let d=kn(),p=d.kind===`pixel`||d.kind===`blend`?`pixel`:dn?`vector`:d.kind===`toon`?`charm`:`realistic`;pe.update(e,t,D,H,p,E.camera);let[m,h,g]=k;if(j.uniforms.uPrev.value=m.texture,j.uniforms.uCurr.value=h.texture,l.setRenderTarget(g),l.render(ee,A),k=[h,g,m],P.uniforms.uHeight.value=k[1].texture,yn<2&&typeof document<`u`&&++yn===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Pn(e){un=e,window.__mode=un}function Fn(){return dn=!dn,Be.value=+!!dn,window.__vector=dn,dn}function In(e){return dn=!!e,Be.value=+!!dn,window.__vector=dn,dn}function Ln(){return pn=gn[(gn.indexOf(pn)+1)%gn.length],window.__era=pn,wn(),pn}function Rn(){return fn=!fn,fn}return{updateWorld:Mn,decideStyle:On,renderCityPipeline:Dn,renderCityBeautyTo:En,styleHintName:An,setPostMode:Pn,toggleVector:Fn,setVector:In,cycleEra:Ln,togglePalette:Rn,setTonemap:e=>{let t=e===`agx`||e===1||e===!0;return X.uniforms.uTonemap.value=+!!t,typeof window<`u`&&(window.__tonemap=t?`agx`:`aces`),t?`agx`:`aces`},get mode(){return un},get vector(){return dn},get sceneEra(){return pn},renderer:l,drawBuffer:p,scene:_,rig:E,sunRig:D,SIM:256,targets:k,simScene:ee,simCamera:A,simMaterial:j,grabRT:te,card:M,backdrop:N,WATER_SIZE:28,water:F,waterMaterial:P,windowGlow:ae,landmarkFactory:oe,city:R,cityLife:z,waterLife:ce,weatherRig:H,clouds:le,inspector:fe,world:gt,catalog:vt,editor:yt,pilot:xt,profiler:Zt,governor:rn,frameStart:an,frameEnd:sn,setActive:cn,get paused(){return h},get contextLost(){return m},prewarm:ln,fitShadowFrustum:St,SHADOW_DIST:24,sceneDepth:Ct,sceneRT:wt,filmicRT:Et,toonRT:Ot,pixelRT:kt,postScene:Ft,postCamera:It,postQuad:Lt,filmicMaterial:X,pixelMaterial:Wt,pixelkitMaterial:Gt,toonMaterial:qt,mixMaterial:Jt,PALCACHE:Z,ERA_TEX:Kt,runPass:Yt,OVERCAST_GREY:y,FOG_DENSITY:C,FOG_NIGHT_TINT:w,_fogColor:T,resize:Xt}}var ji=`lgr_hints_`,Mi=!1;function Ni(){if(Mi||typeof document>`u`)return;Mi=!0;let e=document.createElement(`style`);e.textContent=`
