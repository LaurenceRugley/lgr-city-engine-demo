import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,Q as _,R as v,S as y,T as b,U as x,V as S,W as C,X as w,Y as T,Z as E,_ as ee,a as D,b as te,c as O,d as k,et as ne,f as re,g as ie,h as A,i as j,it as M,j as N,k as P,l as ae,m as F,n as oe,nt as I,o as se,p as L,q as ce,r as le,rt as R,s as z,t as ue,tt as de,u as fe,v as pe,w as me,x as he,y as ge,z as _e}from"./three-Pxe5c5S4.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var ve=Math.atan(1/Math.SQRT2),ye=Math.atan(.5),be=Math.PI/4,B={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},xe=.12,Se=1.45,Ce=4,we=40,Te=1.5,V=16,Ee=6,De=22,Oe=3.5,H=11,ke=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),U=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function Ae({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new R(0,.8,0),azimuth:a=be,elevation:o=.52,distance:s=12,zoom:c=5.5}={}){let u=new v(t,e,n,r),d=new l(-1,1,1,-1,n,r),f=B.PERSPECTIVE,p=e,m={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},h={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},g=!1,_=()=>f===B.PERSPECTIVE?u:d;function y(e){e!==f&&(f=e,f===B.ISOMETRIC||f===B.DIMETRIC?(m.elevation=f===B.ISOMETRIC?ve:ye,m.azimuth=U(be,h.azimuth),g=!0):g=!1)}function b(e,t){m.azimuth+=e,g||(m.elevation=P.clamp(m.elevation+t,xe,Se))}function x(e){f===B.PERSPECTIVE?m.distance=P.clamp(m.distance*e,Ce,we):m.zoom=P.clamp(m.zoom*e,Te,V)}function S(e,t){let n=m.azimuth,r=f===B.PERSPECTIVE?m.distance*.04:m.zoom*.08,i=new R(Math.cos(n),0,-Math.sin(n)),a=new R(-Math.sin(n),0,-Math.cos(n));m.target.addScaledVector(i,e*r),m.target.addScaledVector(a,t*r)}function C(e,t){p=e/t,u.aspect=p,u.updateProjectionMatrix()}function w(e){h.azimuth=ke(h.azimuth,m.azimuth,e),h.elevation=ke(h.elevation,m.elevation,e),h.distance=ke(h.distance,m.distance,e),h.zoom=ke(h.zoom,m.zoom,e),h.target.x=ke(h.target.x,m.target.x,e),h.target.y=ke(h.target.y,m.target.y,e),h.target.z=ke(h.target.z,m.target.z,e);let t=Math.cos(h.elevation),n=Math.sin(h.elevation),r=Math.cos(h.azimuth),i=Math.sin(h.azimuth),a=_();if(a.position.set(h.target.x+h.distance*t*i,h.target.y+h.distance*n,h.target.z+h.distance*t*r),a.lookAt(h.target),a.isOrthographicCamera){let e=h.zoom,t=e*p;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function T(e,t,n,r=!1){m.target.set(e,t,n),r&&h.target.copy(m.target)}function E(e,t=!1){m.zoom=P.clamp(e,Te,V),t&&(h.zoom=m.zoom)}return{get camera(){return _()},get mode(){return f},get azimuth(){return h.azimuth},setTarget:T,setZoom:E,get styleT(){return f===B.PERSPECTIVE?P.clamp((h.distance-Ee)/(De-Ee),0,1):P.clamp((h.zoom-Oe)/(H-Oe),0,1)},setMode:y,orbit:b,zoomBy:x,pan:S,setViewport:C,update:w}}var je={value:0},Me=new L(`#ffffff`),Ne={value:0},Pe={value:0},Fe={value:0},Ie=new I,Le={value:0},Re={value:0},W=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
`;function ze(e){e.uniforms.uVector=je,e.uniforms.uVecTint={value:Me},e.uniforms.uVecShadow=Ne,e.uniforms.uSnow=Pe,e.uniforms.uCloud=Fe,e.uniforms.uCloudOff={value:Ie},e.uniforms.uFogCharm=Le}function Be(e){return e.replace(`#include <fog_fragment>`,`
    #ifdef USE_FOG
...
#include <shadowmask_pars_fragment>`)}var K=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function He(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new L(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{ze(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new L(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=Ve(e.vertexShader),e.fragmentShader=Be(G(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        if (uVector > 0.5) {
          ...
          ${K}                                  // the sun's shadow darkens the body
          vec3 wcol; vec2 w = winTerms(wcol);
          vec3 glass = vec3(0.17, 0.23, 0.34);          // dark glass-blue panes (day)
          col = mix(col, glass, w.x * 0.85);
          col += w.x * w.y * wcol * uWindowGlow * 1.5;  // …windows EMIT (unshadowed) at night
          gl_FragColor = vec4(col, diffuseColor.a);
        }`)))},e}function q(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{ze(e),s||(e.uniforms.uVecColor={value:new L(t)}),c&&(e.uniforms.uGlow={value:new L(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=Re),e.vertexShader=Ve(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Yt={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Xt=[`gb`,`8-bit`,`16-bit`,`modern`];function Zt(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new L(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new ie(n,t,1,x,te);return r.minFilter=g,r.magFilter=g,r.needsUpdate=!0,r}var Qt=220,$t={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},en={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function tn({demo:e=!1,citySeed:n=0,profileIndex:a=0}={}){let o=new oe({antialias:!0,preserveDrawingBuffer:!0});o.shadowMap.enabled=!0,o.shadowMap.type=1,o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0;let s=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);o.setPixelRatio(Math.min(window.devicePixelRatio,s?1.5:2)),o.setSize(window.innerWidth,window.innerHeight),o.setClearColor(920327,1),document.body.appendChild(o.domElement);let c=o.getDrawingBufferSize(new I),f=new ce;f.fog=new he(10465470,0);let m=new L(`#aeb6c0`),h=.062,_=new L(`#74508f`),v=new L,y=Ae({aspect:window.innerWidth/window.innerHeight}),b=ct({t:.5}),S={type:r,format:x,minFilter:g,magFilter:g,wrapS:re,wrapT:re,depthBuffer:!1,stencilBuffer:!1},C=[new M(256,256,S),new M(256,256,S),new M(256,256,S)];for(let e of C)o.setRenderTarget(e),o.clear();o.setRenderTarget(null);let w=new ce,T=new l(-1,1,1,-1,0,1),E=new u({vertexShader:Bt,fragmentShader:Vt,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new I(1/256,1/256)},uMouse:{value:new I(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new R)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new R)}}});w.add(new N(new _e(2,2),E));let D=new M(c.x,c.y,{minFilter:i,magFilter:i,depthBuffer:!0,stencilBuffer:!1});function te(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new O(t);return r.colorSpace=d,r}let k=new N(new _e(28,28),new p({map:te(e)}));k.rotation.x=-Math.PI/2,k.position.y=-.35,f.add(k);let ne=new N(new _e(40,24),new u({depthWrite:!1,vertexShader:Rt,fragmentShader:zt,uniforms:{uTime:{value:0},uInk:{value:b.horizon},uGold:{value:b.sky},uFogColor:{value:v},uFogAmt:{value:0},uFogCharm:Le}}));ne.position.set(0,3,-8),f.add(ne);let ie=new u({vertexShader:Ht,fragmentShader:Ut,uniforms:{uHeight:{value:null},uScene:{value:D.texture},uTexel:{value:new I(1/256,1/256)},uResolution:{value:new I(c.x,c.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new t},uLightDir:{value:b.sunDir},uInk:{value:new L(`#2A2218`)},uGold:{value:new L(`#B89968`)},uVector:je,uVecWater:{value:new L(`#1fb8d8`)},uVecTint:{value:Me}}}),A=new N(new _e(28,28,255,255),ie);A.rotation.x=-Math.PI/2,A.updateMatrixWorld(!0),ie.uniforms.uNormalMatrix.value.getNormalMatrix(A.matrixWorld),f.add(A);let j={value:0},ae=Mt({windowGlow:j}),F=et({seed:n,profileIndex:a,landmarkFactory:ae,windowGlow:j});f.add(F.group);let se=pt({plinthTop:.3,extent:F.extent,profile:F.state.profile});f.add(se.group);let le=bt({extent:F.extent,waterSize:28,plinthTop:.3});f.add(le.group),E.uniforms.uWakeDrops.value=le.wakeDrops;let z=Pt({extent:F.extent});f.add(z.group),E.uniforms.uRainDrops.value=z.rainDrops;let ue=It({extent:F.extent});f.add(ue.group),F.group.remove(F.key),f.add(F.key),F.key.castShadow=!0,F.key.shadow.mapSize.set(2048,2048),F.key.shadow.bias=-18e-5,F.key.shadow.normalBias=.028,f.add(F.key.target);function de(){let e=F.key.shadow.camera,t=F.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),o.shadowMap.needsUpdate=!0}de();let fe=new ee(c.x,c.y),pe=new M(c.x,c.y,{minFilter:i,magFilter:i,depthBuffer:!0,stencilBuffer:!1,depthTexture:fe}),me=new M(c.x,c.y,{minFilter:i,magFilter:i,depthBuffer:!1,stencilBuffer:!1}),ge=new M(c.x,c.y,{minFilter:i,magFilter:i,depthBuffer:!1,stencilBuffer:!1}),ve=new M(c.x,c.y,{minFilter:i,magFilter:i,depthBuffer:!1,stencilBuffer:!1}),ye=new ce,be=new l(-1,1,1,-1,0,1),B=new N(new _e(2,2));ye.add(B);let xe=new u({vertexShader:Bt,fragmentShader:Wt,uniforms:{uScene:{value:pe.texture},uTime:{value:0},uResolution:{value:new I(c.x,c.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),Se=e=>{let t=e.map(e=>new L(e));for(;t.length<8;)t.push(new L(0,0,0));return t},Ce=[`night`,`dawn`,`noon`,`dusk`],we={inkgold:Ce.map(e=>Se($t[e])),terminal:Ce.map(e=>Se(en[e]))},Te=new u({vertexShader:Bt,fragmentShader:Gt,uniforms:{uScene:{value:me.texture},uResolution:{value:new I(c.x,c.y)},uPixelSize:{value:Qt},uPalette:{value:we.inkgold[2]},uPaletteB:{value:we.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),V=new u({vertexShader:Bt,fragmentShader:Jt,uniforms:{uScene:{value:me.texture},uResolution:{value:new I(c.x,c.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Zt(Yt[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Ee={};for(let e of Xt)Ee[e]=Yt[e].palette?Zt(Yt[e].palette):null;let De=new u({vertexShader:Bt,fragmentShader:Kt,uniforms:{uScene:{value:me.texture},uDepth:{value:fe},uResolution:{value:new I(c.x,c.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:b.toonFloor},uOutline:{value:b.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Oe=new u({vertexShader:Bt,fragmentShader:qt,uniforms:{uToon:{value:ge.texture},uPixel:{value:ve.texture},uBlend:{value:0}}});function H(e,t){B.material=e,o.setRenderTarget(t),o.render(ye,be)}function ke(){y.setViewport(window.innerWidth,window.innerHeight),o.setSize(window.innerWidth,window.innerHeight);let e=o.getDrawingBufferSize(new I);return D.setSize(e.x,e.y),pe.setSize(e.x,e.y),me.setSize(e.x,e.y),ge.setSize(e.x,e.y),ve.setSize(e.x,e.y),ie.uniforms.uResolution.value.set(e.x,e.y),xe.uniforms.uResolution.value.set(e.x,e.y),Te.uniforms.uResolution.value.set(e.x,e.y),V.uniforms.uResolution.value.set(e.x,e.y),De.uniforms.uResolution.value.set(e.x,e.y),e}let U=3,W=!1,ze=!1,Be=`native`,Ve=.3,G=.46,K=[`native`,...Xt],He={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=U,window.__vector=W,window.__era=Be);let q=0,Ue=performance.now(),We=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=We),We&&(o.info.autoReset=!1);let J=null;typeof window<`u`&&(window.__loaded=!1);let Y=0,X=new R(1,1,1),Ge=!1;function Ke(e){let t=ze?we.terminal:we.inkgold,n=e%1*4,r=Math.floor(n)%4;Te.uniforms.uPalette.value=t[r],Te.uniforms.uPaletteB.value=t[(r+1)%4],Te.uniforms.uPaletteBlend.value=n-Math.floor(n)}function qe(e){let t=Yt[e];t&&(V.uniforms.uGridWidth.value=t.gridWidth,V.uniforms.uDither.value=t.dither,V.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(V.uniforms.uPalette.value=Ee[e],V.uniforms.uPaletteSize.value=t.palette.length))}function Je(){Be!==`native`&&qe(Be)}let Ye=()=>Be===`native`?Te:V;function Xe(e,t){A.visible=!1,o.setRenderTarget(D),o.render(f,e),A.visible=!0,o.setRenderTarget(t),o.render(f,e)}function Ze(e,t){if(A.visible=!1,o.setRenderTarget(D),o.render(f,y.camera),A.visible=!0,U===1||W&&U!==7&&U!==8)o.setRenderTarget(t),o.render(f,y.camera);else if(o.setRenderTarget(pe),o.render(f,y.camera),U===2)xe.uniforms.uGrain.value=1,xe.uniforms.uChroma.value=1,H(xe,t);else{xe.uniforms.uGrain.value=0,xe.uniforms.uChroma.value=0,H(xe,me);let n=y.camera;De.uniforms.uNear.value=n.near,De.uniforms.uFar.value=n.far,De.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(qe(e.era),V):Ye();e.kind===`pixel`?(H(r,t),window.__style=`pixel`):e.kind===`toon`?(H(De,t),window.__style=`toon`):(H(De,ge),H(r,ve),Oe.uniforms.uBlend.value=e.blend,H(Oe,t),window.__style=`blend`)}}function Qe(){let e=$e(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return ie.uniforms.uChromaScale.value=P.lerp(1,.5,t),e}function $e(){if(U===1||U===2)return{kind:`none`};if(U===7)return{kind:`pixel`};if(U===8)return{kind:`toon`};let e=y.styleT;return window.__styleT=e,e<=Ve?{kind:`toon`}:e>=G?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:P.smoothstep(e,Ve,G),era:`16-bit`}}function tt(e){return U===1||U===2?``:W&&U!==7&&U!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?He[e.era||Be]||`Pixel`:e.kind===`blend`?`Toon → `+(He[e.era]||`Pixel`):``}function nt(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){if(We){let e=o.info;J={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}ne.material.uniforms.uTime.value=t,xe.uniforms.uTime.value=t,b.update(e),F.key.position.copy(b.sunDir).multiplyScalar(24),F.key.color.copy(b.sunColor),F.key.intensity=b.sunIntensity,F.fill.color.copy(b.hemiSky),F.fill.groundColor.copy(b.hemiGround),j.value=b.windowGlow;let i=z.overcast;F.key.intensity*=1-.5*i,F.key.color.lerp(m,.45*i),F.fill.intensity=1+.7*i;let a=P.smoothstep(b.sunDir.y,.06,.34),s=P.lerp(.28,1,1-b.windowGlow),c=n?a*s:0;F.key.shadow.intensity=.72*c,Ne.value=.52*c,(n&&!Ge||X.distanceToSquared(b.sunDir)>2e-5)&&(o.shadowMap.needsUpdate=!0,X.copy(b.sunDir)),Ge=n;let l=1-b.windowGlow;Me.setRGB(P.lerp(.46,1,l),P.lerp(.52,1,l),P.lerp(.74,1,l)),xe.uniforms.uExposure.value=b.exposure,De.uniforms.uToonGain.value=b.toonGain,o.setClearColor(b.horizon,1),Ke(b.t),window.__t=b.t,se.update(e,t,b),F.update(t),le.update(e,t,b),E.uniforms.uWakeCount.value=le.wakeCount,z.update(e,t),E.uniforms.uRainCount.value=z.rainDropCount;let u=z.fog*(1-l);f.fog.density=z.fog*h,v.copy(b.horizon).lerp(_,.85*u),f.fog.color.copy(v),o.setClearColor(v,1),Le.value=z.fog,ne.material.uniforms.uFogAmt.value=.7*z.fog,Pe.value=z.snow,Fe.value=z.cloud*.55,Ie.x+=e*.018,Ie.y+=e*.009,Re.value+=(r-Re.value)*Math.min(1,e*1.5),ue.update(e,t,b,z),q++;let d=performance.now();d-Ue>=1e3&&(window.__fps=q,We&&J&&(console.log(`[perf] ${q} fps · ~${(1e3/Math.max(1,q)).toFixed(2)} ms · calls ${J.calls} · tris ${J.tris} · programs ${J.programs} · geo ${J.geo} · tex ${J.tex}`),window.__perfInfo={fps:q,...J}),q=0,Ue=d);let[p,g,y]=C;if(E.uniforms.uPrev.value=p.texture,E.uniforms.uCurr.value=g.texture,o.setRenderTarget(y),o.render(w,T),C=[g,y,p],ie.uniforms.uHeight.value=C[1].texture,Y<2&&typeof document<`u`&&++Y===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function rt(e){U=e,window.__mode=U}function it(){return W=!W,je.value=+!!W,window.__vector=W,W}function at(e){return W=!!e,je.value=+!!W,window.__vector=W,W}function ot(){return Be=K[(K.indexOf(Be)+1)%K.length],window.__era=Be,Je(),Be}function st(){return ze=!ze,ze}return{updateWorld:nt,decideStyle:Qe,renderCityPipeline:Ze,renderCityBeautyTo:Xe,styleHintName:tt,setPostMode:rt,toggleVector:it,setVector:at,cycleEra:ot,togglePalette:st,get mode(){return U},get vector(){return W},get sceneEra(){return Be},renderer:o,drawBuffer:c,scene:f,rig:y,sunRig:b,SIM:256,targets:C,simScene:w,simCamera:T,simMaterial:E,grabRT:D,card:k,backdrop:ne,WATER_SIZE:28,water:A,waterMaterial:ie,windowGlow:j,landmarkFactory:ae,city:F,cityLife:se,waterLife:le,weatherRig:z,clouds:ue,fitShadowFrustum:de,SHADOW_DIST:24,sceneDepth:fe,sceneRT:pe,filmicRT:me,toonRT:ge,pixelRT:ve,postScene:ye,postCamera:be,postQuad:B,filmicMaterial:xe,pixelMaterial:Te,pixelkitMaterial:V,toonMaterial:De,mixMaterial:Oe,PALCACHE:we,ERA_TEX:Ee,runPass:H,OVERCAST_GREY:m,FOG_DENSITY:h,FOG_NIGHT_TINT:_,_fogColor:v,resize:ke}}var nn=`lgr_hints_`,rn=!1;function an(){if(rn||typeof document>`u`)return;rn=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var sn=``+new URL(`office-smooth-DEluvd7o.png`,import.meta.url).href,cn=``+new URL(`office-charm-D7t90SkH.png`,import.meta.url).href;function ln(){let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`);t.fillStyle=`#6e4a2c`,t.fillRect(0,0,256,256);for(let e=0;e<150;e++){let e=Math.random()*256,n=.7+Math.random()*.7;t.strokeStyle=`rgba(${Math.round(110*n)},${Math.round(74*n)},${Math.round(44*n)},${.16+Math.random()*.28})`,t.lineWidth=.5+Math.random()*1.6,t.beginPath(),t.moveTo(e,0);for(let n=0;n<=256;n+=14)t.lineTo(e+Math.sin(n*.05+e)*3,n);t.stroke()}t.strokeStyle=`rgba(30,18,8,0.5)`,t.lineWidth=2;for(let e of[256*.34,256*.67])t.beginPath(),t.moveTo(0,e),t.lineTo(256,e),t.stroke();let n=new O(e);return n.colorSpace=d,n.wrapS=n.wrapT=s,n}function Q(e,t,n,r,{rough:i=.62,metal:a=0,x:o=0,y:c=0,z:l=0,emissive:u=null,emissiveIntensity:d=1,map:f=null,mapRepeat:p=null}={}){let h=f;f&&p&&(h=f.clone(),h.needsUpdate=!0,h.wrapS=h.wrapT=s,h.repeat.set(p[0],p[1]));let g=new N(new D(e,t,n),new m({color:h?`#ffffff`:r,roughness:i,metalness:a,...h?{map:h}:{},...u?{emissive:u,emissiveIntensity:d}:{}}));return g.position.set(o,c,l),g}function un({tier:t=`corner`}={}){let r=new ce,i=new v(43,1,.1,100),a=new R(0,1.62,4.35);i.position.copy(a),i.lookAt(0,1.12,-1);let o=new y;r.add(o);let s=new y,c=new y,l=new y,u=new y,f=new y;o.add(s,c,l,u,f);let h=[],g=`#3a2618`,b=`#5b3d27`,x=`#5a5650`,S=ln();s.add(Q(11,.2,11,`#3c2a1c`,{rough:.5,y:-.1,map:S,mapRepeat:[5,5]})),s.add(Q(11,.2,11,`#3a2a1d`,{rough:.9,y:3,map:S,mapRepeat:[4,4]}));for(let e of[-2.4,0,2.4])s.add(Q(.18,.16,7.4,g,{rough:.7,x:e,y:2.9,z:0,map:S,mapRepeat:[1,4]}));for(let e of[-2,.4])s.add(Q(7.4,.16,.18,g,{rough:.7,x:0,y:2.88,z:e,map:S,mapRepeat:[4,1]}));function C(e){let t=new y;t.add(Q(.2,3.2,8,`#4a3322`,{rough:.7,x:e*3.6,y:1.5,z:0,map:S,mapRepeat:[3,1.4]}));for(let n of[.9,2.1])t.add(Q(.22,.06,8,g,{x:e*3.59,y:n,z:0}));for(let n of[-2.6,-.9,.8,2.5])t.add(Q(.22,3,.05,g,{x:e*3.585,y:1.5,z:n}));let n=new N(new _e(1.5,1),new m({map:vn(e),roughness:.8}));return n.position.set(e*3.49,1.7,.4),n.rotation.y=-e*Math.PI/2,t.add(Q(.06,1.18,1.68,`#2a1c10`,{x:e*3.52,y:1.7,z:.4}),n),t}s.add(C(-1),C(1));let w=new _e(3,2.5),T=new _e(3,2.5);{let e=w.attributes.uv,t=T.attributes.uv;for(let n=0;n<e.count;n++)e.setX(n,e.getX(n)*.5),t.setX(n,t.getX(n)*.5+.5);e.needsUpdate=!0,t.needsUpdate=!0}let ee=new p({color:`#ffffff`,toneMapped:!1}),te=new p({color:`#ffffff`,toneMapped:!1}),O=1.55,re=new N(w,ee);re.position.set(-1.06,O,-2.64),re.rotation.y=Math.PI/4;let ie=new N(T,te);ie.position.set(1.06,O,-2.64),ie.rotation.y=-Math.PI/4,l.add(re,ie),s.add(Q(.08,2.7,.08,g,{x:0,y:O,z:-2.2}));for(let[e,t,n]of[[-1.06,-2.64,Math.PI/4],[1.06,-2.64,-Math.PI/4]]){let r=new y;r.add(Q(3.05,.09,.09,g,{y:1.3})),r.add(Q(3.05,.09,.09,g,{y:-1.25})),r.add(Q(.09,2.6,.09,g,{x:-1.5})),r.position.set(e,O,t),r.rotation.y=n,s.add(r)}s.add(Q(5.4,.5,.3,b,{x:0,y:.25,z:-2.1500000000000004})),s.add(Q(.4,.06,.4,`#1a130c`,{y:2.94,z:1.3}));let j=new N(new k(.16,20),new p({color:`#ffe6b0`,toneMapped:!1}));j.position.set(0,2.9,1.3),j.rotation.x=Math.PI/2,s.add(j),s.add(fn(h,{x:-3.46,y:2.15,z:.2,ry:Math.PI/2,face:`#efe2c8`,rim:`#2a1c10`})),c.add(Q(11,.2,11,`#403d38`,{rough:.85,y:-.1})),c.add(Q(11,.2,11,`#1c1a17`,{rough:.95,y:2.8})),c.add(Q(7,3,.2,x,{rough:.92,x:0,y:1.4,z:-2.9})),c.add(Q(.2,3,6,x,{rough:.92,x:-3.2,y:1.4,z:-.2})),c.add(Q(.2,3,6,x,{rough:.92,x:3.2,y:1.4,z:-.2}));for(let e of[-1.6,-.4]){let t=new N(new A(.07,.07,6,10),new m({color:`#6b6258`,roughness:.6,metalness:.4}));t.rotation.z=Math.PI/2,t.position.set(0,2.62,e),c.add(t)}let M=new p({color:`#ffffff`,toneMapped:!1}),ae=new N(new _e(1.9,1.2),M);ae.position.set(0,1.5,-2.79),c.add(ae),c.add(Q(2.06,1.36,.06,`#241a12`,{x:0,y:1.5,z:-2.83})),c.add(Q(.04,.34,.04,`#1a1410`,{x:-.1,y:2.45,z:-.4}));let oe=new N(new k(.1,16),new p({color:`#ffdb8a`,toneMapped:!1}));oe.position.set(-.1,2.26,-.4),oe.rotation.x=Math.PI/2,c.add(oe);let I=new y;I.add(Q(1.3,.05,.32,`#3a2c1e`,{x:0,y:0,z:0}));let se=[`#7a3a2a`,`#2a4a6a`,`#b08a3a`,`#3a5a3a`,`#6a2a4a`];for(let e=0;e<8;e++)I.add(Q(.12,.34,.24,se[e%se.length],{x:-.55+e*.14,y:.2,z:0}));I.position.set(-2.3,1.5,-2.66),c.add(I);let le=new y;le.add(Q(.34,.34,.34,`#7a4a2a`,{y:.17}));let z=new y;for(let e=0;e<6;e++){let t=Q(.05,.5,.14,`#3a7a3a`,{rough:.7});t.geometry.translate(0,.25,0),t.rotation.z=(e/6-.5)*1.2,t.rotation.x=Math.sin(e)*.25,z.add(t)}z.position.y=.34,le.add(z),le.position.set(2.45,0,-1.4),c.add(le),c.add(fn(h,{x:1.9,y:2.1,z:-2.78,ry:0,face:`#d8d2c4`,rim:`#1a130c`}));let ue=new y;ue.add(Q(3.4,.12,1.5,`#6e4a30`,{rough:.32,y:.86,z:1.5,map:S,mapRepeat:[3,1.4]})),ue.add(Q(3.2,.78,1.36,b,{y:.46,z:1.5,map:S,mapRepeat:[3,1]}));for(let e of[.66,.4,.14])ue.add(Q(.9,.2,.04,`#4a3120`,{x:1.05,y:e,z:2.2}));ue.add(Q(.12,.04,.04,`#caa15a`,{x:1.05,y:.66,z:2.23,metal:.6}));let fe=new N(new A(.05,.045,.1,16),new m({color:`#d8cbb4`,roughness:.6}));fe.position.set(-.55,.97,1.95);let pe=new N(new de(.035,.012,8,14),new m({color:`#d8cbb4`,roughness:.6}));pe.position.set(-.61,.97,1.95),pe.rotation.y=Math.PI/2,ue.add(fe,pe),ue.add(Q(.26,.03,.34,`#efe7d4`,{rough:.85,x:.5,y:.935,z:1.9})),o.add(ue);let he=new y;he.add(Q(.06,.5,.06,`#2a1c10`,{x:-1.15,y:1.15,z:1.6}));let ge=new N(new F(.22,.26,16,1,!0),new m({color:`#c2802e`,roughness:.5,side:2,emissive:`#3a2208`,emissiveIntensity:.6}));ge.position.set(-1.15,1.42,1.6),he.add(ge);let ve=new n(`#ffb15a`,7,7,1.8);ve.position.set(-1.15,1.34,1.6),he.add(ve),o.add(he);let ye=new y;ye.add(Q(.62,.03,.42,`#1c1c20`,{y:.93,z:1.5,metal:.4,rough:.4}));let be=new N(new D(.62,.4,.025),new m({color:`#0a0c10`,emissive:`#2a4a6a`,emissiveIntensity:.7,roughness:.3}));be.position.set(0,1.14,1.31),be.rotation.x=-.32,ye.add(be),ye.userData.role=`laptop`,o.add(ye);let B=new y;B.add(Q(.26,.07,.34,`#15151a`,{x:1,y:.93,z:1.5}));let xe=Q(.3,.06,.08,`#101015`,{x:1,y:1,z:1.34,emissive:`#234a6a`,emissiveIntensity:.4});B.add(xe),B.userData.role=`phone`,o.add(B);let Se=new me(`#8a6a42`,`#1c130a`,.78);r.add(Se);let Ce=new E(`#ffd9a0`,9,9,.7,.5,1.2);Ce.position.set(0,2.95,1.3),Ce.target.position.set(0,.86,1.5),r.add(Ce,Ce.target);let we=pn(!1),Te=pn(!0),V=.62,Ee=1.32,De=1.22,Oe=1.78,H=new _(new e({map:we,transparent:!0,depthWrite:!1}));H.scale.set(V,V,1),H.position.set(Ee,De,Oe),H.userData.role=`cat`,o.add(H);let ke=new _(new e({map:hn(),transparent:!0,depthWrite:!1,opacity:0}));ke.scale.set(.3,.3,1),ke.raycast=()=>{},o.add(ke);let U=0;function Ae(){U=1.3}let je=.62,Me=.42,Ne=.34,Pe=new y;Pe.position.set(-.78,1.06,1.95),Pe.add(Q(je,.05,Ne,`#3a3026`,{y:-.19}));let Fe=new N(new D(je-.04,Me-.08,Ne-.04),new m({color:`#1f9fc0`,transparent:!0,opacity:.26,roughness:.1,emissive:`#0a3a4a`,emissiveIntensity:.4,depthWrite:!1}));Fe.position.y=.02,Pe.add(Fe);for(let e of[-1,1])for(let t of[-1,1])Pe.add(Q(.03,Me,.03,`#20262c`,{x:e*(je/2-.015),z:t*(Ne/2-.015),metal:.5}));let Ie=new N(new D(je,Me,Ne),new p({visible:!1}));Ie.userData.role=`tank`,Pe.add(Ie);let Le=new n(`#5fd8ff`,0,3,2);Pe.add(Le);let Re=[gn(`#e8a23c`),gn(`#d85a6a`),gn(`#6cc0e0`)],W=[],ze=Me/2-.12;for(let t=0;t<3;t++){let n=new _(new e({map:Re[t],transparent:!0,depthWrite:!1})),r=.15-t*.015;n.userData={sz:r,sp:.6+t*.22,ph:t*2.1,ax:.21*(.7+.1*t),ay:ze,az:.09000000000000001,prevx:0},n.scale.set(r,r,1),W.push(n),Pe.add(n)}let Be=_n(),Ve=[];for(let t=0;t<5;t++){let n=new _(new e({map:Be,color:`#cfeffb`,transparent:!0,opacity:.5,depthWrite:!1}));n.userData={ph:t/5,sp:.16+Math.random()*.06,x:-.1+t%3*.07},n.scale.setScalar(.03+t%2*.015),n.raycast=()=>{},Ve.push(n),Pe.add(n)}let G=new _(new e({map:Be,color:`#c8a24a`,transparent:!0,opacity:0,depthWrite:!1}));G.scale.setScalar(.04),G.raycast=()=>{},Pe.add(G);let K=0;function He(){K=3,G.position.set(-.05,ze,0),G.material.opacity=1}o.add(Pe);let q=new y;for(let t=0;t<8;t++){let n=new _(new e({map:Be,color:`#ffd9a0`,transparent:!0,opacity:0,depthWrite:!1,blending:2}));n.scale.setScalar(.018),n.userData={ph:t*.9,sp:.1+t%3*.04,r:.1+t%4*.03},n.raycast=()=>{},q.add(n)}q.position.set(-1.15,1.2,1.6),o.add(q),[ue,he,ye,B,H,Pe,q].forEach(e=>u.add(e));function Ue(e,t,n,r,i,a,o){let s=new N(new D(t,n,r),new p({visible:!1}));s.position.set(i,a,o),s.userData.role=e,f.add(s)}Ue(`laptop`,.95,.6,.7,0,1.05,1.4),Ue(`phone`,.5,.4,.5,1,.98,1.42),Ue(`cat`,.62,.74,.5,Ee,De,Oe);let We=dn(),J={smooth:new ne().load(sn),charm:new ne().load(cn)};for(let e of[`smooth`,`charm`]){let t=J[e];t.colorSpace=d,t.repeat.set(1,.86),t.offset.set(0,.14),t.needsUpdate=!0}let Y=new N(new _e(1,1),new p({map:J.smooth,toneMapped:!1}));Y.position.set(0,1.45,-5),Y.visible=!1,Y.raycast=()=>{},r.add(Y);let X=`3d`,Ge=`painted`;function Ke(){let e=tt===`corner`,t=X!==`3d`,n=t&&Ge===`painted`;s.visible=e&&!t,c.visible=!e&&!t,l.visible=t||e,Y.visible=t,u.visible=!n}function qe(e){return X=e===`smooth`||e===`charm`?e:`3d`,X!==`3d`&&(Y.material.map=J[X],Y.material.needsUpdate=!0),Ke(),X}function Je(e){return Ge=e===`3d`?`3d`:`painted`,Ke(),Ge}let Ye=ve.intensity,Xe=be.material.emissiveIntensity,Ze=new L;function Qe(e,t,n){let r=n?n.windowGlow:0,o=r>.55;H.material.map=o?Te:we,U>0&&(U=Math.max(0,U-e));let s=U>0?Math.sin((1.3-U)/1.3*Math.PI):0,c=o?.012*Math.sin(t*1.2):.03*Math.sin(t*2.4);H.scale.set(V,V*(1+c+.12*s),1),H.position.y=De+.06*s,ke.material.opacity=s,ke.position.set(Ee,1.72+.5*(1-U/1.3),Oe),ke.scale.setScalar(.22+.1*s),K>0&&(K=Math.max(0,K-e),G.position.y=Math.max(-.09,G.position.y-e*.06),G.material.opacity=K>.3?1:K/.3);for(let e of W){let n=e.userData,r=Math.sin(t*n.sp+n.ph)*n.ax,i=Math.sin(t*n.sp*.8+n.ph*1.7)*n.ay*.7,a=Math.cos(t*n.sp*.6+n.ph)*n.az,o=K>0?G.position.x:r,s=K>0?G.position.y:i,c=K>0?G.position.z:a,l=K>0?.05:.1;e.position.x+=(o-e.position.x)*l,e.position.y+=(s-e.position.y)*l,e.position.z+=(c-e.position.z)*l,e.scale.x=(e.position.x>=n.prevx?1:-1)*n.sz,n.prevx=e.position.x}for(let e of Ve){let n=(t*e.userData.sp+e.userData.ph)%1;e.position.set(e.userData.x+Math.sin(t*2+e.userData.ph*9)*.015,-.09+2*ze*n,.02),e.material.opacity=.5*Math.sin(n*Math.PI)}Le.intensity=2.6*r,Fe.material.emissiveIntensity=.4+.9*r,ve.intensity=Ye*(.97+.03*Math.sin(t*7)*Math.sin(t*2.3)),be.material.emissiveIntensity=Xe*(.85+.15*Math.sin(t*3.1+1)),xe.material.emissiveIntensity=.4*(.65+.35*Math.sin(t*2.2)),Ze.setRGB(1,.85,.62),q.children.forEach((e,n)=>{let i=e.userData,a=(t*i.sp+i.ph)%1;e.position.set(Math.cos(t*.5+i.ph*5)*i.r,-.15+a*.45,Math.sin(t*.4+i.ph*5)*i.r),e.material.opacity=(.1+.18*r)*Math.sin(a*Math.PI)}),z.rotation.z=Math.sin(t*.8)*.05,z.rotation.x=Math.sin(t*.6+1)*.04;let l=n?n.t%1:0;for(let e of h)e.rotation.z=-l*Math.PI*2;if(We.update(e),Y.visible){let e=i.position.z-Y.position.z,t=2*Math.tan(P.degToRad(i.fov)*.5)*e*1.18;Y.scale.set(t*i.aspect,t,1);let n=.55+.45*(1-r);Y.material.color.setRGB(n,n*.97,n*.92)}i.position.set(a.x+Math.sin(t*.5)*.04,a.y+Math.sin(t*.7)*.02,a.z),i.lookAt(0,1.12,-1)}function $e(e){ee.map=e,te.map=e,ee.needsUpdate=!0,te.needsUpdate=!0}function et(e){M.map=e,M.needsUpdate=!0}let tt=t;function nt(e){tt=e===`basement`?`basement`:`corner`;let t=tt===`corner`;return Ke(),Ce.intensity=t?9:3.2,Se.intensity=t?.78:.82,Se.color.set(t?`#6a5238`:`#7a5a34`),tt}return nt(tt),{scene:r,camera:i,update:Qe,setCityTexture:$e,setVignetteTexture:et,setFitout:nt,setSkin:qe,setProps:Je,petCat:Ae,feedFish:He,vignette:We,get interactables(){return X!==`3d`&&Ge===`painted`?f.children:[ye,B,H,Ie]},get tier(){return tt},get skin(){return X},get props(){return Ge}}}function dn(){let e=new ce;e.background=new L(`#7fb0dd`);let t=new l(-1.4,1.4,.9,-.9,0,10);t.position.set(0,0,5);let n=(e,t={})=>new p({color:e,toneMapped:!1,...t}),r=(e,t,r,i,a,o,s)=>{let c=new N(new _e(e,t),n(o,s));return c.position.set(r,i,a),c};e.add(r(3.2,.9,.5,-.95,1,`#2a4a30`)),e.add(r(3.2,.7,-.7,-1.05,2,`#1d3724`)),e.add(r(.06,.3,-.95,-.55,3,`#3a2a1a`));let i=new N(new k(.22,18),n(`#234a2a`));i.position.set(-.95,-.32,3),e.add(i),e.add(r(.04,.55,.9,-.55,3,`#20242a`));let a=new N(new k(.1,16),n(`#ffd98a`,{transparent:!0,opacity:0}));a.position.set(.9,-.26,3.1),e.add(a);let o=new N(new k(.16,24),n(`#fff4d8`));e.add(o);let s=[];for(let[t,r]of[[-1,.5],[-.6,.7],[.2,.6],[.7,.72],[1.05,.45],[-.2,.78],[.45,.4]]){let i=new N(new k(.015,8),n(`#ffffff`,{transparent:!0,opacity:0}));i.position.set(t,r,.5),s.push(i),e.add(i)}let c=new L(`#141d33`),u=new L(`#7fb6e0`),d=new L(`#d6824a`),f=new L(`#fff0cc`),m=new L(`#cdd8ef`),h=.34;function g(t){h=(h+t*.04)%1;let n=h*Math.PI*2,r=-Math.cos(n);o.position.set(Math.sin(n)*1.15,r*.66+.06,0);let i=P.smoothstep(r,-.18,.5),l=P.smoothstep(.32,0,Math.abs(r));e.background.copy(c).lerp(u,i).lerp(d,l*.45),o.material.color.copy(r>0?f:m),a.material.opacity=1-i;let p=(1-i)*.85;for(let e of s)e.material.opacity=p}return{scene:e,camera:t,update:g}}function fn(e,{x:t,y:n,z:r,ry:i=0,face:a=`#efe2c8`,rim:o=`#2a1c10`}){let s=new y,c=new N(new k(.2,28),new m({color:o,roughness:.6})),l=new N(new k(.17,28),new m({color:a,roughness:.7}));l.position.z=.01;let u=new N(new _e(.018,.14),new m({color:`#1a130c`,roughness:.5}));return u.geometry.translate(0,.05,0),u.position.z=.02,e.push(u),s.add(c,l,u),s.position.set(t,n,r),s.rotation.y=i,s}function pn(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=`#e08a3c`,i=`#b96a26`,a=`#3a2410`;if(n.lineJoin=`round`,e){n.fillStyle=r,n.beginPath(),n.ellipse(64,78,44,26,0,0,7),n.fill(),n.fillStyle=i,n.beginPath(),n.ellipse(64,86,44,16,0,0,7),n.fill(),n.fillStyle=r,n.beginPath(),n.arc(36,70,20,0,7),n.fill(),n.fillStyle=r,mn(n,24,56,34,44,42,58),mn(n,40,54,50,44,54,60),n.strokeStyle=i,n.lineWidth=7,n.lineCap=`round`,n.beginPath(),n.moveTo(100,70),n.quadraticCurveTo(112,90,88,96),n.stroke(),n.strokeStyle=a,n.lineWidth=2.5,n.beginPath(),n.arc(30,70,5,.1,Math.PI-.1),n.stroke(),n.strokeStyle=i,n.lineWidth=3;for(let e of[60,74,88])n.beginPath(),n.moveTo(e,58),n.lineTo(e,70),n.stroke()}else{n.fillStyle=r,n.beginPath(),n.ellipse(64,86,30,34,0,0,7),n.fill(),n.fillStyle=`#f3c98a`,n.beginPath(),n.ellipse(64,92,14,22,0,0,7),n.fill(),n.strokeStyle=i,n.lineWidth=8,n.lineCap=`round`,n.beginPath(),n.moveTo(92,100),n.quadraticCurveTo(116,86,104,60),n.stroke(),n.fillStyle=r,n.beginPath(),n.arc(64,48,24,0,7),n.fill(),n.fillStyle=r,mn(n,44,34,50,18,60,34),mn(n,84,34,78,18,68,34),n.fillStyle=`#f0b0c0`,mn(n,47,30,50,22,56,32),mn(n,81,30,78,22,72,32),n.fillStyle=a,n.beginPath(),n.arc(55,47,3.4,0,7),n.arc(73,47,3.4,0,7),n.fill(),n.fillStyle=`#e06a7a`,mn(n,61,54,67,54,64,58),n.strokeStyle=a,n.lineWidth=1.6;for(let e of[-2,3])n.beginPath(),n.moveTo(50,55+e),n.lineTo(34,53+e),n.moveTo(78,55+e),n.lineTo(94,53+e),n.stroke();n.strokeStyle=i,n.lineWidth=3;for(let e of[78,90,102])n.beginPath(),n.moveTo(50,e),n.lineTo(78,e),n.stroke()}let o=new O(t);return o.colorSpace=d,o}function mn(e,t,n,r,i,a,o){e.beginPath(),e.moveTo(t,n),e.lineTo(r,i),e.lineTo(a,o),e.closePath(),e.fill()}function hn(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`);t.fillStyle=`#ff5a8a`,t.beginPath(),t.moveTo(32,52),t.bezierCurveTo(6,32,14,10,32,24),t.bezierCurveTo(50,10,58,32,32,52),t.fill();let n=new O(e);return n.colorSpace=d,n}function gn(e){let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);n.fillStyle=e,n.beginPath(),n.ellipse(30,32,18,11,0,0,7),n.fill(),n.beginPath(),n.moveTo(46,32),n.lineTo(60,22),n.lineTo(60,42),n.closePath(),n.fill(),n.fillStyle=`rgba(255,255,255,0.35)`,n.beginPath(),n.ellipse(28,36,12,5,0,0,7),n.fill(),n.fillStyle=`#15212a`,n.beginPath(),n.arc(20,30,2.6,0,7),n.fill();let r=new O(t);return r.colorSpace=d,r}function _n(){let e=document.createElement(`canvas`);e.width=e.height=32;let t=e.getContext(`2d`),n=t.createRadialGradient(16,16,0,16,16,16);n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.6,`rgba(255,255,255,0.7)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(16,16,16,0,7),t.fill();let r=new O(e);return r.colorSpace=d,r}function vn(e){let t=document.createElement(`canvas`);t.width=t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,256,256);e<0?(r.addColorStop(0,`#6a3b1c`),r.addColorStop(1,`#caa15a`)):(r.addColorStop(0,`#3a4a6a`),r.addColorStop(1,`#a86a3a`)),n.fillStyle=r,n.fillRect(0,0,256,256),n.globalAlpha=.5;for(let e=0;e<5;e++)n.fillStyle=e%2?`#2a1c10`:`#e0c080`,n.fillRect(30+e*36,40+e%3*30,26,150);let i=new O(t);return i.colorSpace=d,i}var{Timer:yn}=le,bn=new URLSearchParams(window.location.search),xn=bn.get(`demo`)===`1`||bn.has(`capture`);window.__demo=xn;var Sn=(bn.get(`city`)?Number(bn.get(`city`)):0)||Math.random()*1e9|0,Cn=0,wn=tn({demo:xn,citySeed:Sn,profileIndex:Cn}),{renderer:Tn,rig:En,sunRig:Dn,city:On,cityLife:kn,waterMaterial:An,fitShadowFrustum:jn,landmarkFactory:Mn,renderCityBeautyTo:Nn}=wn,$=un({tier:`corner`});$.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix();var Pn=!0;window.__shadows=Pn,window.__scene=`office`;var Fn=new v(55,1.4,.1,100);Fn.position.set(2.2,3.4,11.5),Fn.lookAt(0,2,0);var In=new M(640,448,{minFilter:i,magFilter:i,depthBuffer:!0,stencilBuffer:!1});$.setCityTexture(In.texture);var Ln=0,Rn=3,zn=new M(512,320,{minFilter:i,magFilter:i,depthBuffer:!0,stencilBuffer:!1});$.setVignetteTexture(zn.texture);var Bn=!1,Vn=(()=>{if(typeof document>`u`)return{showLap(){},toast(){},flash(){}};let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.className=`lap`,t.innerHTML=`<div class="lap-win"><div class="lap-bar"><b>PORTFOLIO OS — John's Game</b>
    ...
    </div></div>`;let n=document.createElement(`div`);n.className=`otoast`;let r=document.createElement(`div`);r.className=`oflash`,document.body.append(t,n,r),t.querySelector(`.lap-x`).addEventListener(`click`,()=>Un()),t.addEventListener(`click`,e=>{e.target===t&&Un()}),t.addEventListener(`click`,e=>{e.target.closest(`button`)&&navigator.vibrate?.(10)});let i=0;return{showLap(e){t.classList.toggle(`on`,e)},toast(e){n.textContent=e,n.classList.add(`on`),clearTimeout(i),i=setTimeout(()=>n.classList.remove(`on`),1400)},flash(){r.style.transition=`none`,r.style.opacity=`0.85`,requestAnimationFrame(()=>{r.style.transition=`opacity .55s`,r.style.opacity=`0`})}}})();function Hn(){Bn=!0,Vn.showLap(!0)}function Un(){Bn=!1,Vn.showLap(!1)}function Wn(){Cn=(Cn+1)%J.length,Vn.flash(),On.generate(Sn,Cn),An.uniforms.uVecWater.value.set(On.waterColor),kn.setProfile(On.state.profile),jn(),Vn.toast(`✈  `+On.state.profile.name),window.__profile=On.state.profile.key}function Gn(e){let t=$.setFitout(e);return Vn.toast(t===`basement`?`🏚  Basement office`:`🏙  Corner office`),window.__tier=t,t}function Kn(){return Gn($.tier===`corner`?`basement`:`corner`)}window.__tier=$.tier;var qn=[`3d`,`smooth`,`charm`],Jn={"3d":`🧊  Stylized 3D office`,smooth:`🖼  Smooth diffusion skin`,charm:`🕹  Charm diffusion skin`};function Yn(e){let t=$.setSkin(e);return window.__officeSkin=t,Vn.toast(Jn[t]),t}function Xn(){return Yn(qn[(qn.indexOf($.skin)+1)%qn.length])}window.__officeSkin=$.skin;var Zn={painted:`🎨  Painted props (cohesive)`,"3d":`🧊  Live 3D props (animated)`};function Qn(e){let t=$.setProps(e);return window.__officeProps=t,$.skin!==`3d`&&Vn.toast(Zn[t]),t}function $n(){return Qn($.props===`painted`?`3d`:`painted`)}window.__officeProps=$.props;var er=new C,tr=new I,nr=(e,t)=>{tr.x=e/window.innerWidth*2-1,tr.y=-(t/window.innerHeight)*2+1};function rr(){er.setFromCamera(tr,$.camera);let e=er.intersectObjects($.interactables,!0)[0];if(!e)return null;let t=e.object;for(;t&&!t.userData.role;)t=t.parent;return t?t.userData.role:null}function ir(e){e===`laptop`?Hn():e===`phone`?Wn():e===`cat`?$.petCat():e===`tank`&&$.feedFish()}var ar=0,or=0,sr=0;Tn.domElement.addEventListener(`mousedown`,e=>{ar=e.clientX,or=e.clientY,sr=performance.now()}),window.addEventListener(`mousemove`,e=>{nr(e.clientX,e.clientY),Tn.domElement.style.cursor=rr()?`pointer`:`default`}),window.addEventListener(`mouseup`,e=>{if(Math.hypot(e.clientX-ar,e.clientY-or)<6&&performance.now()-sr<350&&!Bn){nr(e.clientX,e.clientY);let t=rr();t&&ir(t)}});var cr=!1;Tn.domElement.addEventListener(`touchstart`,e=>{e.touches.length===1&&(ar=e.touches[0].clientX,or=e.touches[0].clientY,sr=performance.now(),cr=!1)},{passive:!0}),Tn.domElement.addEventListener(`touchmove`,e=>{e.touches.length===1&&Math.hypot(e.touches[0].clientX-ar,e.touches[0].clientY-or)>8&&(cr=!0)},{passive:!0}),window.addEventListener(`touchend`,e=>{if(!cr&&performance.now()-sr<350&&(!e.touches||e.touches.length===0)&&!Bn){let e=rr();e&&ir(e)}}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&Bn&&Un(),(e.key===`f`||e.key===`F`)&&Kn(),(e.key===`j`||e.key===`J`)&&Xn(),(e.key===`u`||e.key===`U`)&&$n(),(e.key===`t`||e.key===`T`)&&Dn.cyclePreset(),(e.key===`h`||e.key===`H`)&&(Pn=!Pn,window.__shadows=Pn)}),Mn.whenReady.then(()=>{On.generate(Sn,Cn),jn(),window.__cityReady=!0}),bn.get(`office`)===`basement`&&Gn(`basement`);var lr=bn.get(`officeskin`);[`3d`,`smooth`,`charm`].includes(lr)&&Yn(lr);var ur=bn.get(`officeprops`);[`painted`,`3d`].includes(ur)&&Qn(ur);var dr=new yn;dr.connect(document);function fr(){dr.update();let e=Math.min(dr.getDelta(),.1);En.update(e),wn.updateWorld(e,dr.getElapsed(),{shadowsOn:Pn,seasonTarget:0}),$.update(e,dr.getElapsed(),Dn),$.tier===`basement`?(Tn.setRenderTarget(zn),Tn.render($.vignette.scene,$.vignette.camera)):Ln%Rn===0&&Nn(Fn,In),Ln++,Tn.setRenderTarget(null),Tn.render($.scene,$.camera),requestAnimationFrame(fr)}fr(),on({key:`office`,title:`The Office`,tips:[`Click / tap the LAPTOP to open the game panel`,`Tap the PHONE to travel to another city · pet the CAT · feed the FISH`,`Esc exits · F fitout · J skin · U props · T time`]}),window.addEventListener(`resize`,()=>{wn.resize(),$.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix()});