...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Ai={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},ji=[`gb`,`8-bit`,`16-bit`,`modern`];function Mi(t){let n=Math.max(t.length,1),r=new Float32Array(n*4);t.forEach((e,t)=>{let n=new I(e);r[t*4+0]=n.r,r[t*4+1]=n.g,r[t*4+2]=n.b,r[t*4+3]=1});let i=new ve(r,n,1,e,ye);return i.minFilter=x,i.magFilter=x,i.needsUpdate=!0,i}var Ni=220,Pi={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Fi={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Ii(e){if(typeof document>`u`||document.getElementById(`lgr-nowebgl`))return;let t=document.createElement(`div`);t.id=`lgr-nowebgl`,t.style.cssText=`position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;background:#0e1116;color:#cdd6e4;font:16px/1.6 system-ui,-apple-system,sans-serif;text-align:center;padding:2rem;`,t.innerHTML=`<div style="max-width:30rem"><div style="font-size:2.4rem;margin-bottom:1rem">🌊</div><h1 style="font-size:1.3rem;margin:0 0 .6rem;color:#fff;font-weight:600">This experience needs a modern browser</h1><p style="margin:0;color:#9aa6b8">`+e+`</p></div>`,document.body&&document.body.appendChild(t)}function Li({demo:t=!1,citySeed:r=0,profileIndex:a=0}={}){let l;try{l=new re({antialias:!0,preserveDrawingBuffer:!0})}catch(e){throw Ii(`This experience needs WebGL2 — please open it in an up-to-date browser (Chrome, Edge, Firefox, or Safari on iOS 15+) with hardware acceleration enabled.`),e}l.shadowMap.enabled=!0,l.shadowMap.type=1,l.shadowMap.autoUpdate=!1,l.shadowMap.needsUpdate=!0;let d=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches),p=d?1.5:2;l.setPixelRatio(Math.min(window.devicePixelRatio,p)),l.setSize(window.innerWidth,window.innerHeight),l.setClearColor(920327,1),document.body.appendChild(l.domElement);let m=l.getDrawingBufferSize(new fe),h=!1,g=!1,_=()=>{};l.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),h=!0,typeof window<`u`&&(window.__contextLost=!0)},!1),l.domElement.addEventListener(`webglcontextrestored`,()=>{_(),h=!1,typeof window<`u`&&(window.__contextLost=!1)},!1);let y=new me;y.fog=new b(10465470,0);let C=new I(`#aeb6c0`),w=.062,T=new I(`#74508f`),E=new I,D=Be({aspect:window.innerWidth/window.innerHeight}),O=At({t:.5}),k=l.getContext(),ee=!!(k&&k.getExtension&&(k.getExtension(`EXT_color_buffer_float`)||k.getExtension(`EXT_color_buffer_half_float`)));!ee&&typeof console<`u`&&console.info(`[L90 H1] No float colour buffer (EXT_color_buffer_float/half_float) — wave sim OFF, flat-sea fallback.`);let A={type:i,format:e,minFilter:x,magFilter:x,wrapS:ce,wrapT:ce,depthBuffer:!1,stencilBuffer:!1},j=ee?[new L(256,256,A),new L(256,256,A),new L(256,256,A)]:null;if(j){for(let e of j)l.setRenderTarget(e),l.clear();l.setRenderTarget(null)}let te=new ve(new Uint8Array([0,0,0,255]),1,1,e);te.needsUpdate=!0;let M=new me,ne=new s(-1,1,1,-1,0,1),N=new ie({vertexShader:Rn,fragmentShader:bi,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new fe(1/256,1/256)},uMouse:{value:new fe(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new z)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new z)}}});M.add(new n(new u(2,2),N));let P=new L(m.x,m.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1});function F(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new W(t);return r.colorSpace=B,r}let ae=new n(new u(28,28),new S({map:F(t)}));ae.rotation.x=-Math.PI/2,ae.position.y=-.35,y.add(ae);let oe=new n(new u(40,24),new ie({depthWrite:!1,vertexShader:vi,fragmentShader:yi,uniforms:{uTime:{value:0},uInk:{value:O.horizon},uGold:{value:O.sky},uFogColor:{value:E},uFogAmt:{value:0},uFogCharm:qe}}));oe.position.set(0,3,-8),y.add(oe);let se=new ie({vertexShader:xi,fragmentShader:Si,uniforms:{uHeight:{value:ee?null:te},uScene:{value:P.texture},uTexel:{value:new fe(1/256,1/256)},uResolution:{value:new fe(m.x,m.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new v},uLightDir:{value:O.sunDir},uInk:{value:new I(`#2A2218`)},uGold:{value:new I(`#B89968`)},uVector:Ve,uVecWater:{value:new I(`#1fb8d8`)},uVecTint:{value:He}}}),R=new n(new u(28,28,255,255),se);R.rotation.x=-Math.PI/2,R.updateMatrixWorld(!0),se.uniforms.uNormalMatrix.value.getNormalMatrix(R.matrixWorld),y.add(R);let le={value:0},ue=rn({windowGlow:le}),V=St({seed:r,profileIndex:a,landmarkFactory:ue,windowGlow:le});y.add(V.group);let de=Ft({plinthTop:.3,extent:V.extent,profile:V.state.profile});y.add(de.group);let pe=Kt({extent:V.extent,waterSize:28,plinthTop:.3});y.add(pe.group),N.uniforms.uWakeDrops.value=pe.wakeDrops;let H=on({extent:V.extent});y.add(H.group),N.uniforms.uRainDrops.value=H.rainDrops;let U=cn({extent:V.extent});y.add(U.group);let he=[de,pe,U],ge=dn({rig:D,getCamera:()=>D.camera,sources:he}),_e=_i();y.add(_e.group);let G=$r({scale:90});y.add(G.mesh),y.environmentIntensity=.32;let ye=!1;function be(e){let t=e&&O.sunArc.y>-.04;t!==ye&&(ye=t,G.mesh.visible=t,oe.visible=!t)}let Se=null,Ce=-1;_=()=>{Se=null,Ce=-1,l.shadowMap.needsUpdate=!0};function we(){let e=Math.floor(O.t%1*4)%4;return(e!==Ce||!Se)&&(Ce=e,Se=G.buildEnv(l)),Se}let Te=null,K=null,Ee=null,q=null,De=!1,Oe=1234,ke=`valley`,Ae=lr.map(e=>e.key),je=new c({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Me=()=>[V.group,de.group,pe.group],Ne=()=>[Te,K,Ee].filter(Boolean);function Pe(){for(let e of Ne())y.remove(e),e.userData.dispose?.();let e=mr({seed:Oe,size:160,preset:ke});q=e,Te=xr(e,{worldSize:26,baseY:0,chunks:6}),K=Kr({terrain:e,seed:Oe,worldSize:26,baseY:0,biomeKeys:Ae}),Ee=Yr(e,{worldSize:26,baseY:0,maxLakes:3,material:je});for(let e of Ne())e.visible=De,y.add(e);Le!==void 0&&Le&&Le.clear(),J!==void 0&&J&&J.clear(),typeof window<`u`&&(window.__world={seed:Oe,preset:ke,active:De,chunks:Te.children.length,scatter:K.userData.counts,lakes:Ee.userData.count})}let Fe=e=>{for(let t of Ne())t.visible=e};function Ie(e,t){if(!q)return 0;let{size:n,height:r,sea:i,relief:a}=q,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let Le=In({heightAt:Ie,seaSurfaceY:0,waterY:.06});Le.group.visible=!1,y.add(Le.group),he.push(Le);let Re=0;function ze(e,t){if(!q||!Te)return;let{size:n,height:r,relief:i}=q,a=26/(n-1),o=26/(t-1),s=i>1e-6?1/i:0,c=!1;for(let i=0;i<t;i++)for(let l=0;l<t;l++){let u=e[i*t+l];if(u===0)continue;c=!0;let d=u*s,f=l*o/a,p=i*o/a,m=Math.max(0,Math.round(f-1)),h=Math.min(n-1,Math.round(f+1)),g=Math.max(0,Math.round(p-1)),_=Math.min(n-1,Math.round(p+1));for(let e=g;e<=_;e++)for(let t=m;t<=h;t++){let i=e*n+t,a=r[i]+d;r[i]=a<0?0:a>1?1:a}}c&&(Re++,Re%8==0&&Sr(Te,q,Te.children),Re%24==0&&K&&Gr(K,q,{worldSize:26,baseY:0}))}function Ye(e,t){if(!q||!Te)return;let{size:n,height:r,relief:i}=q,a=i>1e-6?1/i:0,o=(t-1)/(n-1),s=!1;for(let i=0;i<n;i++){let c=i*o,l=Math.floor(c),u=c-l,d=Math.min(t-1,l+1);for(let c=0;c<n;c++){let f=c*o,p=Math.floor(f),m=f-p,h=Math.min(t-1,p+1),g=e[l*t+p],_=e[l*t+h],v=e[d*t+p],y=e[d*t+h],b=(g*(1-m)+_*m)*(1-u)+(v*(1-m)+y*m)*u;if(b!==0){s=!0;let e=i*n+c,t=r[e]+b*a;r[e]=t<0?0:t>1?1:t}}}s&&(Sr(Te,q,Te.children),K&&Gr(K,q,{worldSize:26,baseY:0}))}let J=qn({worldHeightAt:Ie,applyErosion:ze,syncErodedTerrain:Ye,worldSize:26,grid:96,seaY:0,renderer:l});J.group.visible=!1,y.add(J.group);let Xe=Jn({extent:26,count:d?500:2e3});Xe.group.visible=!1,y.add(Xe.group);let Ze=null,Qe=new Set;function $e(){!q||!Ee||(y.remove(Ee),Ee.userData.dispose?.(),Ee=Yr(q,{worldSize:26,baseY:0,maxLakes:3,material:je}),Ee.visible=De,y.add(Ee),window.__world&&(window.__world.lakes=Ee.userData.count))}function et(){$e(),K&&Gr(K,q,{worldSize:26,baseY:0})}function Y(e,t,n=1,r=2.2,i=.05){if(!q||!Te)return;let a=q.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=q.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Qe.clear();for(let e of Te.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Qe.add(e)}Sr(Te,q,Qe),Ze&&clearTimeout(Ze),Ze=setTimeout(et,140)}function it(e,t,n,r=2.2){if(!q||!Te||n==null)return;let i=q.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=q.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);Qe.clear();for(let e of Te.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Qe.add(e)}Sr(Te,q,Qe,!0)}let at=[`tree`,`rock`,`tuft`];function ot(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!q||!K)return 0;if(a)return Ur(K,n||`all`,e,t,i);let o=q.size,s=26/(o-1),c=q.height,l=q.sea,u=q.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Wr[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;Hr(K,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&K.userData.counts)for(let e of at)K.userData.counts[e]=(K.userData.placements[e]||[]).length;return g}let st=[];function ct(){if(!K)return null;let e=K.userData.placements,t={};for(let n of at)t[n]=(e[n]||[]).map(e=>({...e}));return t}function lt(){q&&(st.push({h:q.height.slice(),b:q.biome.slice(),sc:ct(),pl:Le.snapshot()}),st.length>12&&st.shift())}function ut(){if(!q||!st.length)return!1;let e=st.pop();if(q.height.set(e.h),q.biome.set(e.b),e.sc&&K){let t=K.userData.placements;for(let n of at)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&Le.restore(e.pl),Sr(Te,q,Te.children,!0),et(),!0}let dt=new Set([`boat`,`fish`]),ft=new Set([`person`,`atv`]);function pt(e,t,n){if(!q)return null;let r=Ie(t,n)<0;return dt.has(e)&&!r||ft.has(e)&&r?null:Le.spawn(e,t,n)}function mt(e,t,n=2.5){return Le.removeNear(e,t,n)}function ht(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function gt(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let _t=e=>ht(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),vt=e=>ht(e);function yt(){let e=K?K.userData.placements:{},t={};for(let n of at)t[n]=(e[n]||[]).map(e=>({...e}));return t}function bt(){return q?{v:1,seed:Oe,preset:ke,size:q.size,height:_t(q.height),biome:vt(q.biome),scatter:yt(),entities:Le.snapshot()}:null}function xt(){if(!q)return null;let e=mr({seed:Oe,size:160,preset:ke}),t=q.height,n=q.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:Oe,preset:ke,hd:r,bd:i,entities:Le.snapshot()}}function Ct(e){K&&(y.remove(K),K.userData.dispose?.()),K=Rr(e||{tree:[],rock:[],tuft:[]}),K.userData.counts=at.reduce((e,t)=>(e[t]=(K.userData.placements[t]||[]).length,e),{}),K.visible=De,y.add(K)}function wt(e){if(!e||e.v!==1)return!1;let t=25600;if(e.height!=null||e.biome!=null){if(typeof e.height!=`string`||typeof e.biome!=`string`)return!1;let n,r;try{n=gt(e.height),r=gt(e.biome)}catch{return!1}if(n.byteLength%4!=0||n.byteLength>>2!=t||r.length<t)return!1;let i=new Float32Array(n.buffer,n.byteOffset,n.byteLength>>2);for(let e=0;e<i.length;e++)if(!Number.isFinite(i[e]))return!1}if(e.hd!=null&&!Array.isArray(e.hd)||e.bd!=null&&!Array.isArray(e.bd))return!1;if(Array.isArray(e.hd))for(let n=0;n<e.hd.length;n+=2){let r=e.hd[n];if(!Number.isInteger(r)||r<0||r>=t||!Number.isFinite(e.hd[n+1]))return!1}if(Array.isArray(e.bd))for(let n=0;n<e.bd.length;n+=2){let r=e.bd[n];if(!Number.isInteger(r)||r<0||r>=t)return!1}Oe=e.seed|0,ke=pr.includes(e.preset)?e.preset:ke,st.length=0,Pe(),De=!0,Fe(!0),Le.group.visible=!0,J.group.visible=!0,Xe.group.visible=!0;for(let e of Me())e.visible=!1;window.__world&&(window.__world.active=!0);let n=e=>e<0?0:e>1?1:e,r=lr.length;if(e.height&&e.biome){let t=gt(e.height),i=new Float32Array(t.buffer,t.byteOffset,t.byteLength>>2);for(let e=0;e<i.length;e++)q.height[e]=n(i[e]);let a=gt(e.biome);for(let e=0;e<q.biome.length;e++)q.biome[e]=Math.min(r-1,a[e]|0)}else if(e.hd||e.bd){let t=e.hd||[],i=e.bd||[];for(let e=0;e<t.length;e+=2)q.height[t[e]]=n(t[e+1]);for(let e=0;e<i.length;e+=2)q.biome[i[e]]=Math.min(r-1,Math.max(0,i[e+1]|0))}return Sr(Te,q,Te.children,!0),e.scatter&&Ct(e.scatter),$e(),K&&Gr(K,q,{worldSize:26,baseY:0}),Le.restore(e.entities),window.__world&&(window.__world.scatter=K.userData.counts,window.__world.seed=Oe,window.__world.preset=ke),!0}let Tt={enter(){Te||Pe(),De=!0,Fe(!0),Le.group.visible=!0,J.group.visible=!0,Xe.group.visible=!0;for(let e of Me())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){De=!1,Fe(!1),Le.group.visible=!1,J.group.visible=!1,Xe.group.visible=!1;for(let e of Me())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return Oe=Math.random()*1e9|0,st.length=0,Pe(),Tt.enter(),Oe},reset(){return st.length=0,Pe(),Tt.enter(),Oe},setPreset(e){return pr.includes(e)&&(ke=e,st.length=0,Pe(),Tt.enter()),ke},sculpt:Y,paintBiome:it,paintScatter:ot,repoolWater:$e,snapshot:lt,undo:ut,placeEntity:pt,removeEntityNear:mt,heightAt:Ie,serialize:bt,serializeCompact:xt,deserialize:wt,flowPourAt:(e,t,n,r)=>J.pourAt(e,t,n,r),flowRain:e=>J.rain(e),flowClear:()=>J.clear(),get flowTotal(){return J.totalWater()},flowAt:(e,t)=>J.cellAt(e,t),flowErosion:(e,t)=>J.setErosion(e,t),get flowErosionOn(){return J.erosion},get flowSediment(){return J.totalSediment()},setSimBackend:e=>J.setBackend(e),get simBackend(){return J.backend},_flowReadW:()=>J._debugReadW(),_flowReadTerr:()=>J._debugReadTerr(),_flowStepN:(e,t)=>J._debugStepN(e,t),get terrainGroup(){return Te},get biomes(){return lr},get scatterCounts(){return K?K.userData.placements&&at.reduce((e,t)=>(e[t]=(K.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return Le.counts()},setScatterHidden(e){K&&(K.visible=!e)},get placedLife(){return Le},get canUndo(){return st.length>0},get active(){return De},get seed(){return Oe},get preset(){return ke},get presets(){return pr}},Et=Zr(),Dt=$n({world:Tt,catalog:Et,inspector:ge});function Ot(e,t){return Ie(e,t)<0?0:-999}let kt=Cn({rig:D,world:{heightAt:Ie,waterHeightAt:Ot}});V.group.remove(V.key),y.add(V.key),V.key.castShadow=!0,V.key.shadow.mapSize.set(2048,2048),V.key.shadow.bias=-18e-5,V.key.shadow.normalBias=.028,y.add(V.key.target);function jt(){let e=V.key.shadow.camera,t=V.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),l.shadowMap.needsUpdate=!0}jt();let Mt=new xe(m.x,m.y),Nt=new L(m.x,m.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1,depthTexture:Mt}),Pt=new L(m.x,m.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),It=new L(m.x,m.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1,samples:4}),Lt=new L(m.x,m.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Rt=new L(m.x,m.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),zt=Math.max(1,Math.floor(m.x/2)),Bt=Math.max(1,Math.floor(m.y/2)),Vt=new L(zt,Bt,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Ht=new L(zt,Bt,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Ut=new me,Wt=new s(-1,1,1,-1,0,1),Gt=new n(new u(2,2));Ut.add(Gt);let X=new ie({vertexShader:Rn,fragmentShader:Ci,uniforms:{uScene:{value:Nt.texture},uTime:{value:0},uResolution:{value:new fe(m.x,m.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:Vt.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:O.grade.tint},uGradeLift:{value:O.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1},uDither:{value:0},uTonemap:{value:0}}}),qt=new ie({vertexShader:Rn,fragmentShader:Di,uniforms:{uScene:{value:Nt.texture},uThreshold:{value:.78}}}),Jt=new ie({vertexShader:Rn,fragmentShader:Oi,uniforms:{uScene:{value:Vt.texture},uDir:{value:new fe}}});function Z(e){qt.uniforms.uScene.value=e.texture,an(qt,Vt),Jt.uniforms.uScene.value=Vt.texture,Jt.uniforms.uDir.value.set(1.6/zt,0),an(Jt,Ht),Jt.uniforms.uScene.value=Ht.texture,Jt.uniforms.uDir.value.set(0,1.6/Bt),an(Jt,Vt),X.uniforms.uBloom.value=Vt.texture;let t=1-f.clamp(O.sunArc.y*2.2,0,1);X.uniforms.uBloomStrength.value=.85*(.32+.95*t)}let Yt=e=>{let t=e.map(e=>new I(e));for(;t.length<8;)t.push(new I(0,0,0));return t},Xt=[`night`,`dawn`,`noon`,`dusk`],Zt={inkgold:Xt.map(e=>Yt(Pi[e])),terminal:Xt.map(e=>Yt(Fi[e]))},Qt=new ie({vertexShader:Rn,fragmentShader:wi,uniforms:{uScene:{value:Pt.texture},uResolution:{value:new fe(m.x,m.y)},uPixelSize:{value:Ni},uPalette:{value:Zt.inkgold[2]},uPaletteB:{value:Zt.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),$t=new ie({vertexShader:Rn,fragmentShader:ki,uniforms:{uScene:{value:Pt.texture},uResolution:{value:new fe(m.x,m.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Mi(Ai[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),en={};for(let e of ji)en[e]=Ai[e].palette?Mi(Ai[e].palette):null;let tn=new ie({vertexShader:Rn,fragmentShader:Ti,uniforms:{uScene:{value:Pt.texture},uDepth:{value:Mt},uResolution:{value:new fe(m.x,m.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:O.toonFloor},uOutline:{value:O.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),nn=new ie({vertexShader:Rn,fragmentShader:Ei,uniforms:{uToon:{value:Lt.texture},uPixel:{value:Rt.texture},uBlend:{value:0}}});function an(e,t){Gt.material=e,l.setRenderTarget(t),l.render(Ut,Wt)}function sn(){D.setViewport(window.innerWidth,window.innerHeight),l.setSize(window.innerWidth,window.innerHeight);let e=l.getDrawingBufferSize(new fe);return P.setSize(e.x,e.y),Nt.setSize(e.x,e.y),Pt.setSize(e.x,e.y),It.setSize(e.x,e.y),Lt.setSize(e.x,e.y),Rt.setSize(e.x,e.y),zt=Math.max(1,e.x>>1),Bt=Math.max(1,e.y>>1),Vt.setSize(zt,Bt),Ht.setSize(zt,Bt),se.uniforms.uResolution.value.set(e.x,e.y),X.uniforms.uResolution.value.set(e.x,e.y),Qt.uniforms.uResolution.value.set(e.x,e.y),$t.uniforms.uResolution.value.set(e.x,e.y),tn.uniforms.uResolution.value.set(e.x,e.y),e}let ln=nr({renderer:l}),un=!0;function fn(e,t){let n=t.dpr==null?p:t.dpr,r=Math.min(window.devicePixelRatio,n);Math.abs(l.getPixelRatio()-r)>.001&&(l.setPixelRatio(r),typeof window<`u`&&window.dispatchEvent?window.dispatchEvent(new Event(`resize`)):sn()),un=t.shadows!==!1,un||(l.shadowMap.needsUpdate=!1)}let pn=ir({profiler:ln,apply:fn});function mn(){!g&&!h&&ln.frameStart()}function hn(){g||h||(ln.frameEnd(),pn.update())}function gn(e){g=!e,typeof window<`u`&&(window.__paused=g)}function _n(){try{l.compile(y,D.camera),Vn(1/60,0,{shadowsOn:!0}),Fn(Ln(),Nt),l.setRenderTarget(null)}catch(e){typeof console<`u`&&console.warn(`[L79] prewarm`,e)}}let vn=3,yn=!1,bn=!1,xn=`native`,Sn=.3,wn=.46,Tn=[`native`,...ji],En={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=vn,window.__vector=yn,window.__era=xn),typeof window<`u`&&(window.__frames=0),typeof window<`u`&&(window.__loaded=!1);let Dn=0,On=new z(1,1,1),kn=!1;function An(e){let t=bn?Zt.terminal:Zt.inkgold,n=e%1*4,r=Math.floor(n)%4;Qt.uniforms.uPalette.value=t[r],Qt.uniforms.uPaletteB.value=t[(r+1)%4],Qt.uniforms.uPaletteBlend.value=n-Math.floor(n)}function jn(e){let t=Ai[e];t&&($t.uniforms.uGridWidth.value=t.gridWidth,$t.uniforms.uDither.value=t.dither,$t.uniforms.uUsePalette.value=+!!t.palette,t.palette&&($t.uniforms.uPalette.value=en[e],$t.uniforms.uPaletteSize.value=t.palette.length))}function Mn(){xn!==`native`&&jn(xn)}let Nn=()=>xn===`native`?Qt:$t;function Pn(e,t){be(!0),y.environment=we(),tt.value=1,R.visible=!1,l.setRenderTarget(P),l.render(y,e),R.visible=!0,l.setRenderTarget(It),l.render(y,e),Z(It),X.uniforms.uScene.value=It.texture,X.uniforms.uAces.value=1,X.uniforms.uGrade.value=1,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=1,an(X,t)}function Fn(e,t){let n=!yn&&(vn===1||vn===2);if(be(n),y.environment=n?we():null,tt.value=+!!n,X.uniforms.uBloomStrength.value=0,R.visible=!1,l.setRenderTarget(P),l.render(y,D.camera),R.visible=!0,vn===1&&!n)l.setRenderTarget(t),l.render(y,D.camera);else if(vn===1)l.setRenderTarget(It),l.render(y,D.camera),Z(It),X.uniforms.uScene.value=It.texture,X.uniforms.uAces.value=1,X.uniforms.uGrade.value=1,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=1,an(X,t);else if(l.setRenderTarget(n?It:Nt),l.render(y,D.camera),vn===2)n&&Z(It),X.uniforms.uScene.value=n?It.texture:Nt.texture,X.uniforms.uAces.value=+!!n,X.uniforms.uGrade.value=+!!n,X.uniforms.uGrain.value=1,X.uniforms.uChroma.value=1,X.uniforms.uDither.value=+!!n,an(X,t);else{X.uniforms.uScene.value=Nt.texture,X.uniforms.uAces.value=0,X.uniforms.uGrade.value=0,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=0,an(X,Pt);let n=D.camera;tn.uniforms.uNear.value=n.near,tn.uniforms.uFar.value=n.far,tn.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(jn(e.era),$t):Nn();e.kind===`pixel`?(an(r,t),window.__style=`pixel`):e.kind===`toon`?(an(tn,t),window.__style=`toon`):(an(tn,Lt),an(r,Rt),nn.uniforms.uBlend.value=e.blend,an(nn,t),window.__style=`blend`)}}function Ln(){let e=zn(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return se.uniforms.uChromaScale.value=f.lerp(1,.5,t),e}function zn(){if(vn===1||vn===2)return{kind:`none`};if(vn===7)return{kind:`pixel`};if(vn===8)return{kind:`toon`};let e=D.styleT;return window.__styleT=e,e<=Sn?{kind:`toon`}:e>=wn?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:f.smoothstep(e,Sn,wn),era:`16-bit`}}function Bn(e){return vn===1||vn===2?``:yn&&vn!==7&&vn!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?En[e.era||xn]||`Pixel`:e.kind===`blend`?`Toon → `+(En[e.era]||`Pixel`):``}function Vn(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){typeof window<`u`&&window.__frames++,n&&=un,oe.material.uniforms.uTime.value=t,X.uniforms.uTime.value=t,O.update(e),V.key.position.copy(O.sunDir).multiplyScalar(24),V.key.color.copy(O.sunColor),V.key.intensity=O.sunIntensity,V.fill.color.copy(O.hemiSky),V.fill.groundColor.copy(O.hemiGround),le.value=O.windowGlow,G.setSun(O.sunArc),G.setParams(O.skyParams),X.uniforms.uGradeSat.value=O.grade.sat,X.uniforms.uGradeContrast.value=O.grade.contrast,y.environmentIntensity=.34*(1-.6*f.clamp(O.sunArc.y*1.5,0,1));let i=H.overcast;V.key.intensity*=1-.5*i,V.key.color.lerp(C,.45*i),V.fill.intensity=1+.7*i;let a=f.smoothstep(O.sunDir.y,.06,.34),o=f.lerp(.28,1,1-O.windowGlow),s=n?a*o:0;V.key.shadow.intensity=.72*s,Ue.value=.52*s,(n&&!kn||On.distanceToSquared(O.sunDir)>2e-5)&&(l.shadowMap.needsUpdate=!0,On.copy(O.sunDir)),kn=n;let c=1-O.windowGlow;He.setRGB(f.lerp(.46,1,c),f.lerp(.52,1,c),f.lerp(.74,1,c)),X.uniforms.uExposure.value=O.exposure,tn.uniforms.uToonGain.value=O.toonGain,l.setClearColor(O.horizon,1),An(O.t),window.__t=O.t,de.update(e,t,O),V.update(t),pe.update(e,t,O),N.uniforms.uWakeCount.value=pe.wakeCount,H.update(e,t),N.uniforms.uRainCount.value=H.rainDropCount;let u=H.fog*(1-c);y.fog.density=.016+H.fog*w,E.copy(O.horizon).lerp(T,.85*u),y.fog.color.copy(E),l.setClearColor(E,1),qe.value=H.fog,oe.material.uniforms.uFogAmt.value=.7*H.fog,We.value=H.snow,Ge.value=H.cloud*.55,Ke.x+=e*.018,Ke.y+=e*.009,Je.value+=(r-Je.value)*Math.min(1,e*1.5),nt.value=t,rt.value=.035+.05*i,U.update(e,t,O,H),De&&Le.update(e,t,O),De&&J.step(e),De&&Xe.update(e,t,O,{wind:.6*H.cloud,qualityLevel:window.__quality&&window.__quality.level||0});let d=zn(),p=d.kind===`pixel`||d.kind===`blend`?`pixel`:yn?`vector`:d.kind===`toon`?`charm`:`realistic`;if(_e.update(e,t,O,H,p,D.camera),ee){let[e,t,n]=j;N.uniforms.uPrev.value=e.texture,N.uniforms.uCurr.value=t.texture,l.setRenderTarget(n),l.render(M,ne),j=[t,n,e],se.uniforms.uHeight.value=j[1].texture}if(Dn<2&&typeof document<`u`&&++Dn===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Hn(e){vn=e,window.__mode=vn}function Un(){return yn=!yn,Ve.value=+!!yn,window.__vector=yn,yn}function Wn(e){return yn=!!e,Ve.value=+!!yn,window.__vector=yn,yn}function Gn(){return xn=Tn[(Tn.indexOf(xn)+1)%Tn.length],window.__era=xn,Mn(),xn}function Kn(){return bn=!bn,bn}return{updateWorld:Vn,decideStyle:Ln,renderCityPipeline:Fn,renderCityBeautyTo:Pn,styleHintName:Bn,setPostMode:Hn,toggleVector:Un,setVector:Wn,cycleEra:Gn,togglePalette:Kn,setTonemap:e=>{let t=e===`agx`||e===1||e===!0;return X.uniforms.uTonemap.value=+!!t,typeof window<`u`&&(window.__tonemap=t?`agx`:`aces`),t?`agx`:`aces`},get mode(){return vn},get vector(){return yn},get sceneEra(){return xn},renderer:l,drawBuffer:m,scene:y,rig:D,sunRig:O,SIM:256,targets:j,simScene:M,simCamera:ne,simMaterial:N,grabRT:P,card:ae,backdrop:oe,WATER_SIZE:28,water:R,waterMaterial:se,windowGlow:le,landmarkFactory:ue,city:V,cityLife:de,waterLife:pe,weatherRig:H,clouds:U,inspector:ge,world:Tt,catalog:Et,editor:Dt,pilot:kt,profiler:ln,governor:pn,frameStart:mn,frameEnd:hn,setActive:gn,get paused(){return g},get contextLost(){return h},prewarm:_n,fitShadowFrustum:jt,SHADOW_DIST:24,sceneDepth:Mt,sceneRT:Nt,filmicRT:Pt,toonRT:Lt,pixelRT:Rt,postScene:Ut,postCamera:Wt,postQuad:Gt,filmicMaterial:X,pixelMaterial:Qt,pixelkitMaterial:$t,toonMaterial:tn,mixMaterial:nn,PALCACHE:Zt,ERA_TEX:en,runPass:an,OVERCAST_GREY:C,FOG_DENSITY:w,FOG_NIGHT_TINT:T,_fogColor:E,resize:sn}}var Ri=`lgr_hints_`,zi=!1;function Bi(){if(zi||typeof document>`u`)return;zi=!0;let e=document.createElement(`style`);e.textContent=`
