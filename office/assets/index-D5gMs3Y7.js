...
#include <shadowmask_pars_fragment>`)}var We=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Ge(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new U(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{Ve(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new U(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=Ue(e.vertexShader),e.fragmentShader=He(J(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function Y(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{Ve(e),s||(e.uniforms.uVecColor={value:new U(t)}),c&&(e.uniforms.uGlow={value:new U(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=ze),e.vertexShader=Ue(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
`:``),f=c?`uGlow * mix(uGlowDay, uGlowNight, uWindowGlow)`:`vec3(0.0)`,p=He(J(e.fragmentShader.replace(`#include <common>`,`#include <common>
...
}`,un={realistic:0,charm:0,pixel:2,vector:1},dn={realistic:1,charm:1,pixel:1.9,vector:1.2};function fn({seed:n=1517,count:r=340,spreadX:i=21,yLo:a=3,yHi:o=18,zBase:c=7.2}={}){let l=new G;l.raycast=()=>{};let u=Ke(n>>>0),d=new Float32Array(r*3),f=new Float32Array(r),p=new Float32Array(r),m=new Float32Array(r),h=[];for(let e=0;e<r;e++){let t=(u()*2-1)*i,n=a+u()*(o-a),r=-c-u()*.7;d[e*3]=t,d[e*3+1]=n,d[e*3+2]=r;let s=.35+u()*.65;p[e]=s,f[e]=1.6+u()*2.8+(s>.85?2.2:0),m[e]=u()*Math.PI*2,s>.82&&h.push([t,n,r])}let g=new le;g.setAttribute(`position`,new H(d,3)),g.setAttribute(`aSize`,new H(f,1)),g.setAttribute(`aBright`,new H(p,1)),g.setAttribute(`aPhase`,new H(m,1));let _=new e({vertexShader:cn,fragmentShader:ln,uniforms:{uTime:{value:0},uTwinkle:{value:1},uSizeScale:{value:1},uColor:{value:new U(`#eaf0ff`)},uNight:{value:0},uMode:{value:0}},transparent:!0,depthWrite:!1,blending:2,fog:!1,toneMapped:!1}),v=new s(g,_);v.raycast=()=>{},v.frustumCulled=!1,l.add(v);let y=[];if(h.length>6)for(let e=0;e<3;e++){let e=Math.floor(u()*h.length);for(let t=0;t<3;t++){let t=h[e],n=h[(e+1+Math.floor(u()*2))%h.length];y.push(t[0],t[1],t[2],n[0],n[1],n[2]),e=(e+1)%h.length}}let b=[[[0,2],[0,0]],[[0,0],[.7,0]],[[2.1,2],[1.4,2]],[[1.4,2],[1.4,0]],[[1.4,0],[2.1,0]],[[2.1,0],[2.1,1]],[[2.1,1],[1.7,1]],[[2.8,0],[2.8,2]],[[2.8,2],[3.5,2]],[[3.5,2],[3.5,1]],[[3.5,1],[2.8,1]],[[2.8,1],[3.6,0]]],x=-c-.4,S=.62;for(let[[e,t],[n,r]]of b)y.push(-3+e*S,12+t*S,x,-3+n*S,12+r*S,x);let C=new le;C.setAttribute(`position`,new me(y,3));let w=new t(C,new z({color:`#9fb6e8`,transparent:!0,opacity:0,depthWrite:!1,fog:!1,toneMapped:!1}));w.raycast=()=>{},w.frustumCulled=!1,l.add(w);let T=new ce(new L({map:pn(),transparent:!0,opacity:0,depthWrite:!1,blending:2,fog:!1,toneMapped:!1}));T.raycast=()=>{},T.scale.set(i*2.4,i*.95,1),T.position.set(2,12,-c-.7),T.material.rotation=-.5,T.renderOrder=-3,l.add(T);let E=-1;function D(e,t=`realistic`,n=0,r=!1){_.uniforms.uTime.value=n,_.uniforms.uTwinkle.value=+!r,_.uniforms.uNight.value=e;let i=un[t]??0;i!==E&&(_.uniforms.uMode.value=i,E=i),_.uniforms.uSizeScale.value=dn[t]??1,w.material.opacity=e*.5,T.material.opacity=e*.32,l.visible=e>.001}return{group:l,update:D}}function pn(){let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(256/2,256/2,0,256/2,256/2,256/2);n.addColorStop(0,`rgba(150,170,230,0.5)`),n.addColorStop(.4,`rgba(120,130,200,0.22)`),n.addColorStop(1,`rgba(90,100,160,0)`),t.fillStyle=n,t.fillRect(0,0,256,256);let r=Ke(20145);for(let e=0;e<7;e++){let e=40+r()*176,n=70+r()*116,i=14+r()*30,a=t.createRadialGradient(e,n,0,e,n,i);a.addColorStop(0,`rgba(200,210,255,0.18)`),a.addColorStop(1,`rgba(200,210,255,0)`),t.fillStyle=a,t.beginPath(),t.arc(e,n,i,0,Math.PI*2),t.fill()}let i=new j(e);return i.colorSpace=E,i}var mn=Math.PI*2;function hn(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=n.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return r.addColorStop(0,`#ffffff`),r.addColorStop(.34,`#fffaf0`),r.addColorStop(.66,e),r.addColorStop(.86,e),r.addColorStop(1,`rgba(255,255,255,0)`),n.fillStyle=r,n.beginPath(),n.arc(128/2,128/2,128/2,0,mn),n.fill(),Sn(t,!0)}function gn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);n.addColorStop(0,`#ffffff`),n.addColorStop(.4,`#eef3ff`),n.addColorStop(.82,`#c4cee6`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,mn),t.fill(),t.globalAlpha=.14,t.fillStyle=`#8b97b4`;for(let[e,n,r]of[[54,50,9],[78,66,7],[60,82,5]])t.beginPath(),t.arc(e,n,r,0,mn),t.fill();return Sn(e,!0)}function _n(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`);t.translate(128/2,128/2),t.fillStyle=`rgba(255,210,120,0.9)`;for(let e=0;e<12;e++)t.rotate(mn/12),t.beginPath(),t.moveTo(0,-28),t.lineTo(7,-54),t.lineTo(-7,-54),t.closePath(),t.fill();let n=t.createRadialGradient(0,0,0,0,0,32);return n.addColorStop(0,`#ffffff`),n.addColorStop(.4,`#fff1c8`),n.addColorStop(.8,`#ffb24a`),n.addColorStop(1,`#ff8a2a`),t.fillStyle=n,t.beginPath(),t.arc(0,0,32,0,mn),t.fill(),Sn(e,!0)}function vn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,46);n.addColorStop(0,`#ffffff`),n.addColorStop(.5,`#e6ecfb`),n.addColorStop(1,`#c2cce4`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,46,0,mn),t.fill(),t.fillStyle=`#aab6d2`;for(let[e,n,r]of[[52,48,11],[80,62,8],[58,82,7],[40,66,5]])t.beginPath(),t.arc(e,n,r,0,mn),t.fill();return Sn(e,!0)}function yn(e,t,n){let r=document.createElement(`canvas`);r.width=r.height=144;let i=r.getContext(`2d`),a=17/2,o=18/2-.5;for(let r=0;r<18;r++)for(let s=0;s<18;s++){let c=Math.hypot(s-a,r-a);c>o||(i.fillStyle=c<o*.45?e:c<o*.78?t:n,i.fillRect(Math.round(s*8),Math.round(r*8),8,8))}return Sn(r,!1)}function bn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(255,255,255,0.9)`),n.addColorStop(.38,`rgba(255,255,255,0.3)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,mn),t.fill(),Sn(e,!0)}function xn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2),r=`20,30,48`;return n.addColorStop(0,`rgba(${r},0)`),n.addColorStop(.42,`rgba(${r},0)`),n.addColorStop(.6,`rgba(${r},0.6)`),n.addColorStop(1,`rgba(${r},0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,mn),t.fill(),Sn(e,!0)}function Sn(e,t){let n=new j(e);return n.colorSpace=E,t||(n.magFilter=v,n.minFilter=v),n}var Cn=(e,t,n)=>{let r=Math.max(0,Math.min(1,(e-t)/(n-t)));return r*r*(3-2*r)};function wn({skyW:e=15,skyY0:t=3.4,skyH:n=3.8,z:r=-7.8,biasX:i=4.5,sunSize:a=4.6,moonSize:o=4}={}){let s=new G;s.raycast=()=>{};let c=(e,t)=>{let n=new ce(new L({map:e,transparent:!0,depthWrite:!1,fog:!1,toneMapped:!1,...t?{blending:2}:{}}));return n.raycast=()=>{},n},l={realistic:hn(`#ffcf8a`),charm:_n(),pixel:yn(`#fff6e0`,`#ffc24a`,`#ff8a2a`)},u={realistic:gn(),charm:vn(),pixel:yn(`#ffffff`,`#cdd6ee`,`#9aa6c6`)},d=bn(),f=c(xn(),!1),p=c(d,!0),m=c(l.realistic),h=c(d,!0),g=c(u.realistic);f.renderOrder=-2,p.renderOrder=-1,s.add(f,p,m,h,g);let _=fn({});_.group.renderOrder=-4,s.add(_.group);let v=typeof window<`u`&&window.matchMedia?window.matchMedia(`(prefers-reduced-motion: reduce)`):null,y={realistic:{sunGlow:3,sunGlowOp:.7,moonGlow:2.6,moonGlowOp:.5,sizeMul:1,sunHaloOp:.85},charm:{sunGlow:2.2,sunGlowOp:.55,moonGlow:2.1,moonGlowOp:.42,sizeMul:1.08,sunHaloOp:.7},pixel:{sunGlow:1.7,sunGlowOp:.4,moonGlow:1.7,moonGlowOp:.32,sizeMul:1,sunHaloOp:.6}},b=`realistic`;function x(e){e===b||!y[e]||(b=e,m.material.map=l[e],m.material.needsUpdate=!0,g.material.map=u[e],g.material.needsUpdate=!0)}new U;let S=new U(`#fff3df`),C=new U(`#ffb060`),w=new U(`#ff6a2a`),T=new U(`#eef2ff`),E=new U(`#9fbcff`);function D(s,c,l,u,d=`realistic`){x(d);let D=y[b],O=l.sunArc,k=u?Math.min(1,(u.cloud||0)*.85+(u.fog||0)*.7):0,A=O.y,j=Cn(A,-.04,.1)*(1-.7*k),M=1-Cn(Math.abs(A),.02,.5);m.position.set(O.x*e+i,t+O.y*n,r),p.position.copy(m.position);let N=a*D.sizeMul*(1+.55*M);m.scale.setScalar(N),p.scale.setScalar(N*D.sunGlow),m.material.color.copy(S),p.material.color.copy(C).lerp(w,M),m.material.opacity=j,p.material.opacity=j*D.sunGlowOp*(.7+.5*M),f.position.copy(m.position),f.scale.setScalar(N*1.7),f.material.opacity=j*(1-M)*D.sunHaloOp;let P=Cn(-O.y,-.04,.1)*(1-.65*k);g.position.set(-O.x*e+i,t+-O.y*n,r),h.position.copy(g.position);let F=o*D.sizeMul;g.scale.setScalar(F),h.scale.setScalar(F*D.moonGlow),g.material.color.copy(T),h.material.color.copy(E),g.material.opacity=P,h.material.opacity=P*D.moonGlowOp;let ee=Cn(-O.y,-.05,.18)*(1-.85*k);_.update(ee,d,c,!!(v&&v.matches))}return{group:s,update:D}}var Tn=`varying vec2 vUv;
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,In={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Ln=[`gb`,`8-bit`,`16-bit`,`modern`];function Rn(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new U(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new ee(n,t,1,u,y);return r.minFilter=v,r.magFilter=v,r.needsUpdate=!0,r}var zn=220,Bn={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Vn={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Hn({demo:t=!1,citySeed:i=0,profileIndex:a=0}={}){let s=new ie({antialias:!0,preserveDrawingBuffer:!0});s.shadowMap.enabled=!0,s.shadowMap.type=1,s.shadowMap.autoUpdate=!1,s.shadowMap.needsUpdate=!0;let c=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);s.setPixelRatio(Math.min(window.devicePixelRatio,c?1.5:2)),s.setSize(window.innerWidth,window.innerHeight),s.setClearColor(920327,1),document.body.appendChild(s.domElement);let d=s.getDrawingBufferSize(new W),f=new _;f.fog=new r(10465470,0);let p=new U(`#aeb6c0`),h=.062,y=new U(`#74508f`),S=new U,C=je({aspect:window.innerWidth/window.innerHeight}),w=pt({t:.5}),T={type:b,format:u,minFilter:v,magFilter:v,wrapS:F,wrapT:F,depthBuffer:!1,stencilBuffer:!1},O=[new B(256,256,T),new B(256,256,T),new B(256,256,T)];for(let e of O)s.setRenderTarget(e),s.clear();s.setRenderTarget(null);let k=new _,A=new n(-1,1,1,-1,0,1),N=new e({vertexShader:Dn,fragmentShader:On,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new W(1/256,1/256)},uMouse:{value:new W(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new M)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new M)}}});k.add(new o(new x(2,2),N));let P=new B(d.x,d.y,{minFilter:R,magFilter:R,depthBuffer:!0,stencilBuffer:!1});function ee(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new j(t);return r.colorSpace=E,r}let te=new o(new x(28,28),new l({map:ee(t)}));te.rotation.x=-Math.PI/2,te.position.y=-.35,f.add(te);let I=new o(new x(40,24),new e({depthWrite:!1,vertexShader:Tn,fragmentShader:En,uniforms:{uTime:{value:0},uInk:{value:w.horizon},uGold:{value:w.sky},uFogColor:{value:S},uFogAmt:{value:0},uFogCharm:Re}}));I.position.set(0,3,-8),f.add(I);let L=new e({vertexShader:kn,fragmentShader:An,uniforms:{uHeight:{value:null},uScene:{value:P.texture},uTexel:{value:new W(1/256,1/256)},uResolution:{value:new W(d.x,d.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new g},uLightDir:{value:w.sunDir},uInk:{value:new U(`#2A2218`)},uGold:{value:new U(`#B89968`)},uVector:Me,uVecWater:{value:new U(`#1fb8d8`)},uVecTint:{value:Ne}}}),z=new o(new x(28,28,255,255),L);z.rotation.x=-Math.PI/2,z.updateMatrixWorld(!0),L.uniforms.uNormalMatrix.value.getNormalMatrix(z.matrixWorld),f.add(z);let ne={value:0},re=Vt({windowGlow:ne}),V=at({seed:i,profileIndex:a,landmarkFactory:re,windowGlow:ne});f.add(V.group);let H=vt({plinthTop:.3,extent:V.extent,profile:V.state.profile});f.add(H.group);let ae=kt({extent:V.extent,waterSize:28,plinthTop:.3});f.add(ae.group),N.uniforms.uWakeDrops.value=ae.wakeDrops;let oe=Ut({extent:V.extent});f.add(oe.group),N.uniforms.uRainDrops.value=oe.rainDrops;let se=Gt({extent:V.extent});f.add(se.group);let ce=Jt({rig:C,getCamera:()=>C.camera,sources:[H,ae,se]}),le=wn();f.add(le.group);let ue=null,de=!1,fe=1234,pe=`valley`,G=()=>[V.group,H.group,ae.group];function me(){ue&&(f.remove(ue),ue.userData.dispose?.()),ue=sn(on({seed:fe,size:160,preset:pe}),{worldSize:26,baseY:0,chunks:6}),ue.visible=de,f.add(ue),typeof window<`u`&&(window.__world={seed:fe,preset:pe,active:de,chunks:ue.children.length})}let he={enter(){ue||me(),de=!0,ue.visible=!0;for(let e of G())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){de=!1,ue&&(ue.visible=!1);for(let e of G())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return fe=Math.random()*1e9|0,me(),he.enter(),fe},setPreset(e){return an.includes(e)&&(pe=e,me(),he.enter()),pe},get active(){return de},get seed(){return fe},get preset(){return pe},get presets(){return an}};V.group.remove(V.key),f.add(V.key),V.key.castShadow=!0,V.key.shadow.mapSize.set(2048,2048),V.key.shadow.bias=-18e-5,V.key.shadow.normalBias=.028,f.add(V.key.target);function ge(){let e=V.key.shadow.camera,t=V.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),s.shadowMap.needsUpdate=!0}ge();let _e=new D(d.x,d.y),K=new B(d.x,d.y,{minFilter:R,magFilter:R,depthBuffer:!0,stencilBuffer:!1,depthTexture:_e}),ve=new B(d.x,d.y,{minFilter:R,magFilter:R,depthBuffer:!1,stencilBuffer:!1}),ye=new B(d.x,d.y,{minFilter:R,magFilter:R,depthBuffer:!1,stencilBuffer:!1}),be=new B(d.x,d.y,{minFilter:R,magFilter:R,depthBuffer:!1,stencilBuffer:!1}),xe=new _,Se=new n(-1,1,1,-1,0,1),Ce=new o(new x(2,2));xe.add(Ce);let we=new e({vertexShader:Dn,fragmentShader:jn,uniforms:{uScene:{value:K.texture},uTime:{value:0},uResolution:{value:new W(d.x,d.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),Te=e=>{let t=e.map(e=>new U(e));for(;t.length<8;)t.push(new U(0,0,0));return t},Ee=[`night`,`dawn`,`noon`,`dusk`],De={inkgold:Ee.map(e=>Te(Bn[e])),terminal:Ee.map(e=>Te(Vn[e]))},Oe=new e({vertexShader:Dn,fragmentShader:Mn,uniforms:{uScene:{value:ve.texture},uResolution:{value:new W(d.x,d.y)},uPixelSize:{value:zn},uPalette:{value:De.inkgold[2]},uPaletteB:{value:De.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),q=new e({vertexShader:Dn,fragmentShader:Fn,uniforms:{uScene:{value:ve.texture},uResolution:{value:new W(d.x,d.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Rn(In[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),ke={};for(let e of Ln)ke[e]=In[e].palette?Rn(In[e].palette):null;let Ae=new e({vertexShader:Dn,fragmentShader:Nn,uniforms:{uScene:{value:ve.texture},uDepth:{value:_e},uResolution:{value:new W(d.x,d.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:w.toonFloor},uOutline:{value:w.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Be=new e({vertexShader:Dn,fragmentShader:Pn,uniforms:{uToon:{value:ye.texture},uPixel:{value:be.texture},uBlend:{value:0}}});function Ve(e,t){Ce.material=e,s.setRenderTarget(t),s.render(xe,Se)}function He(){C.setViewport(window.innerWidth,window.innerHeight),s.setSize(window.innerWidth,window.innerHeight);let e=s.getDrawingBufferSize(new W);return P.setSize(e.x,e.y),K.setSize(e.x,e.y),ve.setSize(e.x,e.y),ye.setSize(e.x,e.y),be.setSize(e.x,e.y),L.uniforms.uResolution.value.set(e.x,e.y),we.uniforms.uResolution.value.set(e.x,e.y),Oe.uniforms.uResolution.value.set(e.x,e.y),q.uniforms.uResolution.value.set(e.x,e.y),Ae.uniforms.uResolution.value.set(e.x,e.y),e}let Ue=3,J=!1,We=!1,Ge=`native`,Y=.3,Ke=.46,qe=[`native`,...Ln],Je={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=Ue,window.__vector=J,window.__era=Ge);let Ye=0,Xe=performance.now(),Ze=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=Ze),Ze&&(s.info.autoReset=!1);let Qe=null;typeof window<`u`&&(window.__loaded=!1);let $e=0,et=new M(1,1,1),tt=!1;function X(e){let t=We?De.terminal:De.inkgold,n=e%1*4,r=Math.floor(n)%4;Oe.uniforms.uPalette.value=t[r],Oe.uniforms.uPaletteB.value=t[(r+1)%4],Oe.uniforms.uPaletteBlend.value=n-Math.floor(n)}function nt(e){let t=In[e];t&&(q.uniforms.uGridWidth.value=t.gridWidth,q.uniforms.uDither.value=t.dither,q.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(q.uniforms.uPalette.value=ke[e],q.uniforms.uPaletteSize.value=t.palette.length))}function rt(){Ge!==`native`&&nt(Ge)}let it=()=>Ge===`native`?Oe:q;function ot(e,t){z.visible=!1,s.setRenderTarget(P),s.render(f,e),z.visible=!0,s.setRenderTarget(t),s.render(f,e)}function st(e,t){if(z.visible=!1,s.setRenderTarget(P),s.render(f,C.camera),z.visible=!0,Ue===1)s.setRenderTarget(t),s.render(f,C.camera);else if(s.setRenderTarget(K),s.render(f,C.camera),Ue===2)we.uniforms.uGrain.value=1,we.uniforms.uChroma.value=1,Ve(we,t);else{we.uniforms.uGrain.value=0,we.uniforms.uChroma.value=0,Ve(we,ve);let n=C.camera;Ae.uniforms.uNear.value=n.near,Ae.uniforms.uFar.value=n.far,Ae.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(nt(e.era),q):it();e.kind===`pixel`?(Ve(r,t),window.__style=`pixel`):e.kind===`toon`?(Ve(Ae,t),window.__style=`toon`):(Ve(Ae,ye),Ve(r,be),Be.uniforms.uBlend.value=e.blend,Ve(Be,t),window.__style=`blend`)}}function ct(){let e=lt(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return L.uniforms.uChromaScale.value=m.lerp(1,.5,t),e}function lt(){if(Ue===1||Ue===2)return{kind:`none`};if(Ue===7)return{kind:`pixel`};if(Ue===8)return{kind:`toon`};let e=C.styleT;return window.__styleT=e,e<=Y?{kind:`toon`}:e>=Ke?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:m.smoothstep(e,Y,Ke),era:`16-bit`}}function ut(e){return Ue===1||Ue===2?``:J&&Ue!==7&&Ue!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Je[e.era||Ge]||`Pixel`:e.kind===`blend`?`Toon → `+(Je[e.era]||`Pixel`):``}function dt(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){if(Ze){let e=s.info;Qe={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}I.material.uniforms.uTime.value=t,we.uniforms.uTime.value=t,w.update(e),V.key.position.copy(w.sunDir).multiplyScalar(24),V.key.color.copy(w.sunColor),V.key.intensity=w.sunIntensity,V.fill.color.copy(w.hemiSky),V.fill.groundColor.copy(w.hemiGround),ne.value=w.windowGlow;let i=oe.overcast;V.key.intensity*=1-.5*i,V.key.color.lerp(p,.45*i),V.fill.intensity=1+.7*i;let a=m.smoothstep(w.sunDir.y,.06,.34),o=m.lerp(.28,1,1-w.windowGlow),c=n?a*o:0;V.key.shadow.intensity=.72*c,Pe.value=.52*c,(n&&!tt||et.distanceToSquared(w.sunDir)>2e-5)&&(s.shadowMap.needsUpdate=!0,et.copy(w.sunDir)),tt=n;let l=1-w.windowGlow;Ne.setRGB(m.lerp(.46,1,l),m.lerp(.52,1,l),m.lerp(.74,1,l)),we.uniforms.uExposure.value=w.exposure,Ae.uniforms.uToonGain.value=w.toonGain,s.setClearColor(w.horizon,1),X(w.t),window.__t=w.t,H.update(e,t,w),V.update(t),ae.update(e,t,w),N.uniforms.uWakeCount.value=ae.wakeCount,oe.update(e,t),N.uniforms.uRainCount.value=oe.rainDropCount;let u=oe.fog*(1-l);f.fog.density=oe.fog*h,S.copy(w.horizon).lerp(y,.85*u),f.fog.color.copy(S),s.setClearColor(S,1),Re.value=oe.fog,I.material.uniforms.uFogAmt.value=.7*oe.fog,Fe.value=oe.snow,Ie.value=oe.cloud*.55,Le.x+=e*.018,Le.y+=e*.009,ze.value+=(r-ze.value)*Math.min(1,e*1.5),se.update(e,t,w,oe);let d=lt(),g=d.kind===`pixel`||d.kind===`blend`?`pixel`:J||d.kind===`toon`?`charm`:`realistic`;le.update(e,t,w,oe,g),Ye++;let _=performance.now();_-Xe>=1e3&&(window.__fps=Ye,Ze&&Qe&&(console.log(`[perf] ${Ye} fps · ~${(1e3/Math.max(1,Ye)).toFixed(2)} ms · calls ${Qe.calls} · tris ${Qe.tris} · programs ${Qe.programs} · geo ${Qe.geo} · tex ${Qe.tex}`),window.__perfInfo={fps:Ye,...Qe}),Ye=0,Xe=_);let[v,b,x]=O;if(N.uniforms.uPrev.value=v.texture,N.uniforms.uCurr.value=b.texture,s.setRenderTarget(x),s.render(k,A),O=[b,x,v],L.uniforms.uHeight.value=O[1].texture,$e<2&&typeof document<`u`&&++$e===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function ft(e){Ue=e,window.__mode=Ue}function mt(){return J=!J,Me.value=+!!J,window.__vector=J,J}function ht(e){return J=!!e,Me.value=+!!J,window.__vector=J,J}function gt(){return Ge=qe[(qe.indexOf(Ge)+1)%qe.length],window.__era=Ge,rt(),Ge}function _t(){return We=!We,We}return{updateWorld:dt,decideStyle:ct,renderCityPipeline:st,renderCityBeautyTo:ot,styleHintName:ut,setPostMode:ft,toggleVector:mt,setVector:ht,cycleEra:gt,togglePalette:_t,get mode(){return Ue},get vector(){return J},get sceneEra(){return Ge},renderer:s,drawBuffer:d,scene:f,rig:C,sunRig:w,SIM:256,targets:O,simScene:k,simCamera:A,simMaterial:N,grabRT:P,card:te,backdrop:I,WATER_SIZE:28,water:z,waterMaterial:L,windowGlow:ne,landmarkFactory:re,city:V,cityLife:H,waterLife:ae,weatherRig:oe,clouds:se,inspector:ce,world:he,fitShadowFrustum:ge,SHADOW_DIST:24,sceneDepth:_e,sceneRT:K,filmicRT:ve,toonRT:ye,pixelRT:be,postScene:xe,postCamera:Se,postQuad:Ce,filmicMaterial:we,pixelMaterial:Oe,pixelkitMaterial:q,toonMaterial:Ae,mixMaterial:Be,PALCACHE:De,ERA_TEX:ke,runPass:Ve,OVERCAST_GREY:p,FOG_DENSITY:h,FOG_NIGHT_TINT:y,_fogColor:S,resize:He}}var Un=`lgr_hints_`,Wn=!1;function Gn(){if(Wn||typeof document>`u`)return;Wn=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  }`,document.head.appendChild(e)}function Kn({key:e,title:t=`Tips`,tips:n=[],force:r=!1}={}){let i={key:e,shown:!1,dismissed:!1,seen:!1};if(typeof window<`u`&&(window.__hints=i),typeof document>`u`||!e)return{dismiss(){},el:null};let a=Un+e,o=!1;try{o=localStorage.getItem(a)===`1`}catch{}if(o&&!r)return i.seen=!0,{dismiss(){},el:null};Gn();let s=!!(window.matchMedia&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches),c=document.createElement(`div`);c.className=`lgr-hints`,c.innerHTML=`<div class="lgr-hints-card">
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var qn=null;function Jn(){if(qn)return qn;let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(0,0,0,0.60)`),n.addColorStop(.55,`rgba(0,0,0,0.32)`),n.addColorStop(1,`rgba(0,0,0,0.0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,Math.PI*2),t.fill(),qn=new j(e),qn.colorSpace=E,qn}function Yn({w:e=.6,d:t=.6,x:n=0,y:r=.002,z:i=0,opacity:a=.5,rotation:s=0}={}){let c=new o(new x(e,t),new l({map:Jn(),transparent:!0,opacity:a,depthWrite:!1,toneMapped:!1}));return c.rotation.x=-Math.PI/2,c.rotation.z=s,c.position.set(n,r,i),c.renderOrder=-1,c.raycast=()=>{},c}function Xn({yawLimit:e=80,pitchUp:t=32,pitchDown:n=20,sensitivity:r=.16,keySpeed:i=70,damp:a=9}={}){let o=Math.PI/180,s=(e,t,n)=>e<t?t:e>n?n:e,c=0,l=0,u=0,d=0;return{addDrag(i,a){u=s(u-i*r,-e,e),d=s(d-a*r,-n,t)},addKeys(r,{left:a,right:o,up:c,down:l}){let f=i*r;a&&(u=s(u+f,-e,e)),o&&(u=s(u-f,-e,e)),c&&(d=s(d+f,-n,t)),l&&(d=s(d-f,-n,t))},recenter(){u=0,d=0},update(e){let t=1-Math.exp(-a*e);c+=(u-c)*t,l+=(d-l)*t},get yaw(){return c*o},get pitch(){return l*o},get active(){return Math.abs(c)>.05||Math.abs(l)>.05}}}var Zn=null;function Qn(){if(Zn)return Zn;let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(256/2,256/2,256*.32,256/2,256/2,256*.72);return n.addColorStop(0,`rgba(0,0,0,0)`),n.addColorStop(1,`rgba(0,0,0,1)`),t.fillStyle=n,t.fillRect(0,0,256,256),Zn=new j(e),Zn.colorSpace=E,Zn}function $n({strength:e=.55,dist:t=.5}={}){let n=new o(new x(1,1),new l({map:Qn(),transparent:!0,opacity:e,depthTest:!1,depthWrite:!1,toneMapped:!1}));n.renderOrder=9999,n.raycast=()=>{},n.frustumCulled=!1;let r=new M;return n.fit=e=>{e.getWorldDirection(r),n.position.copy(e.position).addScaledVector(r,t),n.quaternion.copy(e.quaternion);let i=2*Math.tan(m.degToRad(e.fov)*.5)*t*1.05;n.scale.set(i*e.aspect,i,1)},n}var er=``+new URL(`office-dressed2-CNZL1Pge.png`,import.meta.url).href,tr=``+new URL(`office-night2-Tdv47G8J.png`,import.meta.url).href,nr=``+new URL(`office-modern-CQqt-EK1.png`,import.meta.url).href,rr=``+new URL(`office-charm2-qAn3JlVo.png`,import.meta.url).href;function ir(){let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`);t.fillStyle=`#6e4a2c`,t.fillRect(0,0,256,256);for(let e=0;e<150;e++){let e=Math.random()*256,n=.7+Math.random()*.7;t.strokeStyle=`rgba(${Math.round(110*n)},${Math.round(74*n)},${Math.round(44*n)},${.16+Math.random()*.28})`,t.lineWidth=.5+Math.random()*1.6,t.beginPath(),t.moveTo(e,0);for(let n=0;n<=256;n+=14)t.lineTo(e+Math.sin(n*.05+e)*3,n);t.stroke()}t.strokeStyle=`rgba(30,18,8,0.5)`,t.lineWidth=2;for(let e of[256*.34,256*.67])t.beginPath(),t.moveTo(0,e),t.lineTo(256,e),t.stroke();let n=new j(e);return n.colorSpace=E,n.wrapS=n.wrapT=w,n}function Q(e,t,n,r,{rough:i=.62,metal:a=0,x:s=0,y:c=0,z:l=0,emissive:u=null,emissiveIntensity:d=1,map:p=null,mapRepeat:m=null}={}){let h=p;p&&m&&(h=p.clone(),h.needsUpdate=!0,h.wrapS=h.wrapT=w,h.repeat.set(m[0],m[1]));let g=new o(new O(e,t,n),new f({color:h?`#ffffff`:r,roughness:i,metalness:a,...h?{map:h}:{},...u?{emissive:u,emissiveIntensity:d}:{}}));return g.position.set(s,c,l),g}function ar(){let e=document.createElement(`canvas`);e.width=512,e.height=304;let t=e.getContext(`2d`);t.fillStyle=`#fff`,t.fillRect(0,0,512,304);let n=.13*512,r=.87*512,i=.1*304,a=.66*304;return t.filter=`blur(7px)`,t.fillStyle=`#000`,t.beginPath(),t.moveTo(80.56,i),t.arcTo(r,i,r,a,14),t.arcTo(r,a,n,a,14),t.arcTo(n,a,n,i,14),t.arcTo(n,i,r,i,14),t.closePath(),t.fill(),t.filter=`none`,new j(e)}function or({tier:e=`corner`,layout:t=`straight-on`}={}){let n=new _,r=new c(43,1,.1,100),i=new M(0,1.62,4.35),s=new M(0,1.12,-1);r.position.copy(i),r.lookAt(s);let u=Xn({yawLimit:80,pitchUp:34,pitchDown:20}),d=new he(0,0,0,`YXZ`),p=new oe,h=new G;n.add(h);let g=new G,v=new G,y=new G,b=new G,S=new G;h.add(g,v,y,b,S);let w=[],T=`#4a3322`,D=`#3a2618`,A=`#5b3d27`,j=`#6e4a30`,P=`#5a5650`,F=ir();g.add(Q(11,.2,11,`#3c2a1c`,{rough:.5,y:-.1,map:F,mapRepeat:[5,5]})),g.add(Q(11,.2,11,`#3a2a1d`,{rough:.9,y:3,map:F,mapRepeat:[4,4]}));for(let e of[-2.4,0,2.4])g.add(Q(.18,.16,7.4,D,{rough:.7,x:e,y:2.9,z:0,map:F,mapRepeat:[1,4]}));for(let e of[-2,.4])g.add(Q(7.4,.16,.18,D,{rough:.7,x:0,y:2.88,z:e,map:F,mapRepeat:[4,1]}));function ee(e){let t=new G;t.add(Q(.2,3.2,8,T,{rough:.7,x:e*3.6,y:1.5,z:0,map:F,mapRepeat:[3,1.4]}));let n=e*3.45;t.add(Q(.06,.22,8,D,{x:n,y:.13,z:0})),t.add(Q(.08,.16,8,D,{x:n,y:2.84,z:0})),t.add(Q(.05,.05,8,D,{x:n,y:1,z:0}));for(let e of[-2.6,-1.3,1.3,2.6])t.add(Q(.05,1.6,.06,D,{x:n,y:1.95,z:e}));for(let e of[-2.6,-1.3,1.3,2.6])t.add(Q(.05,.7,.06,D,{x:n,y:.6,z:e}));let r=new o(new x(1.5,1),new f({map:mr(e),roughness:.8}));r.position.set(e*3.49,1.7,.4),r.rotation.y=-e*Math.PI/2,t.add(Q(.06,1.18,1.68,`#2a1c10`,{x:e*3.52,y:1.7,z:.4}),r);let i=new o(new x(1,1.3),new f({map:mr(-e),roughness:.8}));i.position.set(e*3.49,1.78,-2),i.rotation.y=-e*Math.PI/2,t.add(Q(.06,1.46,1.16,`#2a1c10`,{x:e*3.52,y:1.78,z:-2}),i),t.add(Q(.12,.3,.16,`#2a1c10`,{x:e*3.4,y:2.2,z:2.2}));let a=new ce(new L({map:pr(),color:`#ffcf8a`,transparent:!0,opacity:.5,depthWrite:!1,blending:2}));return a.scale.set(.6,.75,1),a.position.set(e*3.32,2.34,2.2),a.raycast=()=>{},t.add(a),t}g.add(ee(-1),ee(1));let I=new G;I.add(Q(.3,1.9,1.5,A,{rough:.5,y:.95}));for(let e of[.4,.95,1.5])I.add(Q(.3,.04,1.46,`#3a2c1e`,{y:e}));let R=[`#7a3a2a`,`#2a4a6a`,`#b08a3a`,`#3a5a3a`,`#6a2a4a`,`#8a5a2a`];for(let e of[.6,1.15,1.7])for(let t=0;t<7;t++)I.add(Q(.18,.3,.11,R[(t+Math.round(e))%R.length],{x:.02,y:e-.06,z:-.6+t*.17}));I.position.set(-3.34,0,-1.9),g.add(I),g.add(Yn({w:1,d:1.8,x:-3.2,y:.02,z:-1.9,opacity:.4}));let z=new G;z.add(Q(.5,.1,.5,`#4a3526`,{rough:.7,y:.45})),z.add(Q(.5,.55,.08,`#4a3526`,{rough:.7,y:.72,z:-.21}));for(let[e,t]of[[-.2,-.2],[.2,-.2],[-.2,.2],[.2,.2]])z.add(Q(.05,.45,.05,`#2a1c10`,{x:e,y:.22,z:t}));z.position.set(2.7,0,2.6),z.rotation.y=-.5,g.add(z),g.add(Yn({w:.7,d:.7,x:2.7,y:.02,z:2.6,opacity:.42}));let ne=new x(3,2.5),B=new x(3,2.5),ie=new l({color:`#ffffff`,toneMapped:!1}),H=new l({color:`#ffffff`,toneMapped:!1}),se=-3.7,le=1.55,W=m.degToRad(30),ue=3/2*Math.cos(W),de=se+3/2*Math.sin(W),fe=new o(ne,ie);fe.position.set(-ue,le,de),fe.rotation.y=W;let pe=new o(B,H);pe.position.set(ue,le,de),pe.rotation.y=-W;let me=new l({color:`#ffffff`,toneMapped:!1}),ge=new o(new x(5.4,2.6),me);ge.position.set(0,le,-3.5500000000000003),ge.visible=!1,y.add(fe,pe,ge);let _e=new G;_e.add(Q(.08,2.7,.08,D,{x:0,y:le,z:de+3/2*Math.sin(W)+.02}));for(let[e,t,n]of[[-ue,de,W],[ue,de,-W]]){let r=new G;r.add(Q(3.05,.09,.09,D,{y:1.3})),r.add(Q(3.05,.09,.09,D,{y:-1.25})),r.add(Q(.09,2.6,.09,D,{x:-1.5})),r.position.set(e,le,t),r.rotation.y=n,_e.add(r)}_e.add(Q(5.4,.5,.3,A,{x:0,y:.25,z:de+.5})),g.add(_e);let K=new G;K.add(Q(11,3.2,.2,T,{rough:.7,x:0,y:1.5,z:se-.05,map:F,mapRepeat:[4,1.4]})),K.add(Q(5.8,.14,.12,D,{x:0,y:2.9000000000000004,z:-3.5})),K.add(Q(5.8,.14,.12,D,{x:0,y:le-1.35,z:-3.5})),K.add(Q(.14,2.84,.12,D,{x:-2.8,y:le,z:-3.5})),K.add(Q(.14,2.84,.12,D,{x:2.8,y:le,z:-3.5})),K.add(Q(.09,2.6,.09,D,{x:0,y:le,z:-3.49})),K.add(Q(5.4,.5,.3,A,{x:0,y:.25,z:-3.35}));let ve=new G;ve.add(Q(2.4,.9,.55,A,{rough:.42,y:.45,z:0})),ve.add(Q(2.46,.06,.58,j,{rough:.3,y:.91,z:0}));for(let e of[-.62,0,.62])ve.add(Q(.66,.72,.03,`#4a3120`,{x:e,y:.45,z:.285}));for(let e of[-.62,0,.62])ve.add(Q(.05,.04,.05,`#caa15a`,{x:e+.2,y:.45,z:.31,metal:.6}));let ye=[`#7a3a2a`,`#2a4a6a`,`#b08a3a`,`#3a5a3a`];for(let e=0;e<4;e++)ve.add(Q(.1,.26+e%2*.05,.2,ye[e],{x:-.95+e*.13,y:1.07,z:-.06}));ve.add(Q(.04,.34,.42,`#241a12`,{x:.7,y:1.12,z:-.02})),ve.position.set(-3.9,0,-3.25),K.add(ve),K.add(Yn({w:2.8,d:.95,x:-3.9,y:.02,z:-3.25,opacity:.45}));for(let[e,t]of[[-3.55,-1],[3.55,1]]){let n=new G,r=new o(new x(.78,.98),new f({map:mr(t),roughness:.82}));r.position.z=.05,n.add(Q(.06,1.12,.92,`#241a10`,{}),r),n.position.set(e,1.45,-3.5700000000000003),K.add(n)}for(let e of[-3.55,3.55]){K.add(Q(.16,.32,.13,`#2a1c10`,{x:e,y:2.35,z:-3.5}));let t=new ce(new L({map:pr(),color:`#ffcf8a`,transparent:!0,opacity:.5,depthWrite:!1,blending:2}));t.scale.set(.55,.7,1),t.position.set(e,2.5,-3.42),t.raycast=()=>{},K.add(t)}K.visible=!1,g.add(K),g.add(Q(.4,.06,.4,`#1a130c`,{y:2.94,z:1.3}));let be=new o(new N(.16,20),new l({color:`#ffe6b0`,toneMapped:!1}));be.position.set(0,2.9,1.3),be.rotation.x=Math.PI/2,g.add(be);for(let[e,t]of[[-1.6,-1],[1.6,-1],[-1.6,-2.6],[1.6,-2.6],[0,-2.6]]){g.add(Q(.28,.05,.28,`#1a130c`,{y:2.95,x:e,z:t}));let n=new o(new N(.1,16),new l({color:`#ffe6b0`,toneMapped:!1}));n.position.set(e,2.915,t),n.rotation.x=Math.PI/2,n.raycast=()=>{},g.add(n)}g.add(cr(w,{x:-3.46,y:2.15,z:.2,ry:Math.PI/2,face:`#efe2c8`,rim:`#2a1c10`})),g.add(Q(3.4,.03,2.4,`#3a1410`,{rough:.98,x:0,y:.012,z:1.95})),g.add(Q(3,.04,2,`#6e2a26`,{rough:.96,x:0,y:.02,z:1.95}));let xe=new G;xe.add(Q(.32,.32,.32,`#7a4a2a`,{rough:.8,y:.16}));for(let e=0;e<6;e++){let t=Q(.05,.55,.13,`#356a32`,{rough:.7,y:.32});t.geometry.translate(0,.27,0),t.rotation.z=(e/6-.5)*1.1,t.rotation.x=Math.sin(e*1.3)*.22,xe.add(t)}xe.position.set(2.7,0,.4),g.add(xe),g.add(Yn({w:.7,d:.7,x:2.7,y:.03,z:.4,opacity:.45})),v.add(Q(11,.2,11,`#403d38`,{rough:.85,y:-.1})),v.add(Q(11,.2,11,`#1c1a17`,{rough:.95,y:2.8})),v.add(Q(7,3,.2,P,{rough:.92,x:0,y:1.4,z:-2.9})),v.add(Q(.2,3,6,P,{rough:.92,x:-3.2,y:1.4,z:-.2})),v.add(Q(.2,3,6,P,{rough:.92,x:3.2,y:1.4,z:-.2}));for(let e of[-1.6,-.4]){let t=new o(new te(.07,.07,6,10),new f({color:`#6b6258`,roughness:.6,metalness:.4}));t.rotation.z=Math.PI/2,t.position.set(0,2.62,e),v.add(t)}let Se=new l({color:`#ffffff`,toneMapped:!1}),Ce=new o(new x(1.9,1.2),Se);Ce.position.set(0,1.5,-2.79),v.add(Ce),v.add(Q(2.06,1.36,.06,`#241a12`,{x:0,y:1.5,z:-2.83})),v.add(Q(.04,.34,.04,`#1a1410`,{x:-.1,y:2.45,z:-.4}));let we=new o(new N(.1,16),new l({color:`#ffdb8a`,toneMapped:!1}));we.position.set(-.1,2.26,-.4),we.rotation.x=Math.PI/2,v.add(we);let Te=new G;Te.add(Q(1.3,.05,.32,`#3a2c1e`,{x:0,y:0,z:0}));let Ee=[`#7a3a2a`,`#2a4a6a`,`#b08a3a`,`#3a5a3a`,`#6a2a4a`];for(let e=0;e<8;e++)Te.add(Q(.12,.34,.24,Ee[e%Ee.length],{x:-.55+e*.14,y:.2,z:0}));Te.position.set(-2.3,1.5,-2.66),v.add(Te);let De=new G;De.add(Q(.34,.34,.34,`#7a4a2a`,{y:.17}));let Oe=new G;for(let e=0;e<6;e++){let t=Q(.05,.5,.14,`#3a7a3a`,{rough:.7});t.geometry.translate(0,.25,0),t.rotation.z=(e/6-.5)*1.2,t.rotation.x=Math.sin(e)*.25,Oe.add(t)}Oe.position.y=.34,De.add(Oe),De.position.set(2.45,0,-1.4),v.add(De),v.add(cr(w,{x:1.9,y:2.1,z:-2.78,ry:0,face:`#d8d2c4`,rim:`#1a130c`}));let q=new G;q.add(Q(3.4,.12,1.5,j,{rough:.32,y:.86,z:1.5,map:F,mapRepeat:[3,1.4]})),q.add(Q(3.2,.78,1.36,A,{y:.46,z:1.5,map:F,mapRepeat:[3,1]}));for(let e of[.66,.4,.14])q.add(Q(.9,.2,.04,`#4a3120`,{x:1.05,y:e,z:2.2}));q.add(Q(.12,.04,.04,`#caa15a`,{x:1.05,y:.66,z:2.23,metal:.6}));let ke=new o(new te(.05,.045,.1,16),new f({color:`#d8cbb4`,roughness:.6}));ke.position.set(-.55,.97,1.95);let Ae=new o(new ae(.035,.012,8,14),new f({color:`#d8cbb4`,roughness:.6}));Ae.position.set(-.61,.97,1.95),Ae.rotation.y=Math.PI/2,q.add(ke,Ae);let je=new ce(new L({map:pr(),color:`#fff4e0`,transparent:!0,opacity:0,depthWrite:!1,blending:2}));je.scale.set(.12,.18,1),je.position.set(-.55,1.05,1.95),je.raycast=()=>{},q.add(je),q.add(Q(.26,.03,.34,`#efe7d4`,{rough:.85,x:.5,y:.935,z:1.9})),h.add(q);let Me=new G;Me.add(Q(.06,.5,.06,`#2a1c10`,{x:-1.15,y:1.15,z:1.6}));let Ne=new o(new re(.22,.26,16,1,!0),new f({color:`#c2802e`,roughness:.5,side:2,emissive:`#3a2208`,emissiveIntensity:.6}));Ne.position.set(-1.15,1.42,1.6),Me.add(Ne);let Pe=new C(`#ffb15a`,7,7,1.8);Pe.position.set(-1.15,1.34,1.6),Me.add(Pe);let Fe=new ce(new L({map:pr(),color:`#ffcf8a`,transparent:!0,opacity:.55,depthWrite:!1,blending:2}));Fe.scale.set(.85,.85,1),Fe.position.set(-1.15,1.35,1.6),Fe.raycast=()=>{},Me.add(Fe),Me.position.x=-.3,h.add(Me);let Ie=new G;Ie.add(Q(.62,.03,.42,`#1c1c20`,{y:.93,z:1.5,metal:.4,rough:.4}));let Le=new o(new O(.62,.4,.025),new f({color:`#0a0c10`,emissive:`#2a4a6a`,emissiveIntensity:.7,roughness:.3}));Le.position.set(0,1.14,1.31),Le.rotation.x=-.32,Ie.add(Le),Ie.userData.role=`laptop`,h.add(Ie);let Re=new G;Re.add(Q(.26,.07,.34,`#15151a`,{x:1,y:.93,z:1.5}));let ze=Q(.3,.06,.08,`#101015`,{x:1,y:1,z:1.34,emissive:`#234a6a`,emissiveIntensity:.4});Re.add(ze),Re.userData.role=`phone`,h.add(Re);let Be=new a(`#8a6a42`,`#1c130a`,.78);n.add(Be);let Ve=new V(`#ffd9a0`,9,9,.7,.5,1.2);Ve.position.set(0,2.95,1.3),Ve.target.position.set(0,.86,1.5),n.add(Ve,Ve.target);let He=lr(!1),Ue=lr(!0),J=.62,We=1.32,Ge=1.22,Y=1.78,Ke=new ce(new L({map:He,transparent:!0,depthWrite:!1}));Ke.scale.set(J,J,1),Ke.position.set(We,Ge,Y),Ke.userData.role=`cat`,h.add(Ke);let qe=new ce(new L({map:dr(),transparent:!0,depthWrite:!1,opacity:0}));qe.scale.set(.3,.3,1),qe.raycast=()=>{},h.add(qe);let Je=0;function Ye(){Je=1.3}let Xe=-.95,Ze=1.06,Qe=1.95,$e=.62,et=.42,tt=.34,X=new G;X.position.set(Xe,Ze,Qe),X.add(Q($e,.05,tt,`#3a3026`,{y:-.19}));let nt=new o(new O($e-.04,et-.08,tt-.04),new f({color:`#1f9fc0`,transparent:!0,opacity:.26,roughness:.1,emissive:`#0a3a4a`,emissiveIntensity:.4,depthWrite:!1}));nt.position.y=.02,X.add(nt);for(let e of[-1,1])for(let t of[-1,1])X.add(Q(.03,et,.03,`#20262c`,{x:e*($e/2-.015),z:t*(tt/2-.015),metal:.5}));let rt=new o(new O($e,et,tt),new l({visible:!1}));rt.userData.role=`tank`,X.add(rt);let it=new C(`#5fd8ff`,0,3,2);X.add(it);let at=[fr(`#e8a23c`),fr(`#d85a6a`),fr(`#6cc0e0`)],ot=[],st=et/2-.12;for(let e=0;e<3;e++){let t=new ce(new L({map:at[e],transparent:!0,depthWrite:!1})),n=.15-e*.015;t.userData={sz:n,sp:.6+e*.22,ph:e*2.1,ax:.21*(.7+.1*e),ay:st,az:.09000000000000001,prevx:0},t.scale.set(n,n,1),ot.push(t),X.add(t)}let ct=pr(),lt=[];for(let e=0;e<5;e++){let t=new ce(new L({map:ct,color:`#cfeffb`,transparent:!0,opacity:.5,depthWrite:!1}));t.userData={ph:e/5,sp:.16+Math.random()*.06,x:-.1+e%3*.07},t.scale.setScalar(.03+e%2*.015),t.raycast=()=>{},lt.push(t),X.add(t)}let ut=new ce(new L({map:ct,color:`#c8a24a`,transparent:!0,opacity:0,depthWrite:!1}));ut.scale.setScalar(.04),ut.raycast=()=>{},X.add(ut);let dt=0;function ft(){dt=3,ut.position.set(-.05,st,0),ut.material.opacity=1}h.add(X);let pt=new G;for(let e=0;e<8;e++){let t=new ce(new L({map:ct,color:`#ffd9a0`,transparent:!0,opacity:0,depthWrite:!1,blending:2}));t.scale.setScalar(.018),t.userData={ph:e*.9,sp:.1+e%3*.04,r:.1+e%4*.03},t.raycast=()=>{},pt.add(t)}pt.position.set(-1.45,1.2,1.6),h.add(pt);let mt=new G,ht=.925;mt.add(Yn({w:4,d:2,x:0,y:.045,z:1.55,opacity:.5})),mt.add(Yn({w:.95,d:.62,x:0,y:ht,z:1.42,opacity:.42})),mt.add(Yn({w:.3,d:.3,x:-.55,y:ht,z:1.95,opacity:.4})),mt.add(Yn({w:.42,d:.46,x:.5,y:ht,z:1.9,opacity:.35})),mt.add(Yn({w:.42,d:.46,x:1,y:ht,z:1.5,opacity:.42})),mt.add(Yn({w:.7,d:.42,x:Xe,y:ht,z:1.95,opacity:.42})),mt.add(Yn({w:.55,d:.4,x:1.32,y:ht,z:1.78,opacity:.4})),mt.add(Yn({w:.34,d:.34,x:-1.45,y:ht,z:1.6,opacity:.35})),h.add(mt),[q,Me,Ie,Re,Ke,X,pt,mt].forEach(e=>b.add(e));function gt(e,t,n,r,i,a,s){let c=new o(new O(t,n,r),new l({visible:!1}));c.position.set(i,a,s),c.userData.role=e,S.add(c)}gt(`laptop`,.95,.6,.7,0,1.05,1.4),gt(`phone`,.5,.4,.5,1,.98,1.42),gt(`cat`,.62,.74,.5,We,Ge,Y),gt(`tank`,$e,et,.5,Xe,Ze,Qe);let _t=sr(),vt={dressed2:new k().load(er),night2:new k().load(tr),modern:new k().load(nr),charm:new k().load(rr)},yt=[`dressed2`,`night2`,`modern`,`charm`];for(let e of yt)vt[e].colorSpace=E;let bt=ar(),xt=new o(new x(1,1),new l({map:vt.dressed2,alphaMap:bt,transparent:!0,toneMapped:!1}));xt.position.set(0,1.45,-5),xt.visible=!1,xt.raycast=()=>{},n.add(xt);let St=$n({strength:.5});n.add(St);let Ct=`3d`,wt=`painted`;function Tt(){let e=Lt===`corner`,t=Ct!==`3d`,n=t&&wt===`painted`;g.visible=e&&!t,v.visible=!e&&!t,y.visible=t||e,xt.visible=t,b.visible=!n,Pt()}function Et(e){return Ct=yt.includes(e)?e:`3d`,Ct!==`3d`&&(xt.material.map=vt[Ct],xt.material.needsUpdate=!0),Tt(),Ct}function Dt(e){return wt=e===`3d`?`3d`:`painted`,Tt(),wt}let Ot=Pe.intensity,kt=Le.material.emissiveIntensity,At=new U;function jt(e,t,n){let a=n?n.windowGlow:0,o=a>.55;Ke.material.map=o?Ue:He,Je>0&&(Je=Math.max(0,Je-e));let c=Je>0?Math.sin((1.3-Je)/1.3*Math.PI):0,l=o?.012*Math.sin(t*1.2):.03*Math.sin(t*2.4);Ke.scale.set(J,J*(1+l+.12*c),1),Ke.position.y=Ge+.06*c,qe.material.opacity=c,qe.position.set(We,1.72+.5*(1-Je/1.3),Y),qe.scale.setScalar(.22+.1*c),dt>0&&(dt=Math.max(0,dt-e),ut.position.y=Math.max(-.09,ut.position.y-e*.06),ut.material.opacity=dt>.3?1:dt/.3);for(let e of ot){let n=e.userData,r=Math.sin(t*n.sp+n.ph)*n.ax,i=Math.sin(t*n.sp*.8+n.ph*1.7)*n.ay*.7,a=Math.cos(t*n.sp*.6+n.ph)*n.az,o=dt>0?ut.position.x:r,s=dt>0?ut.position.y:i,c=dt>0?ut.position.z:a,l=dt>0?.05:.1;e.position.x+=(o-e.position.x)*l,e.position.y+=(s-e.position.y)*l,e.position.z+=(c-e.position.z)*l,e.scale.x=(e.position.x>=n.prevx?1:-1)*n.sz,n.prevx=e.position.x}for(let e of lt){let n=(t*e.userData.sp+e.userData.ph)%1;e.position.set(e.userData.x+Math.sin(t*2+e.userData.ph*9)*.015,-.09+2*st*n,.02),e.material.opacity=.5*Math.sin(n*Math.PI)}it.intensity=2.6*a,nt.material.emissiveIntensity=.4+.9*a,Pe.intensity=Ot*(.97+.03*Math.sin(t*7)*Math.sin(t*2.3)),Le.material.emissiveIntensity=kt*(.85+.15*Math.sin(t*3.1+1)),ze.material.emissiveIntensity=.4*(.65+.35*Math.sin(t*2.2)),At.setRGB(1,.85,.62),pt.children.forEach((e,n)=>{let r=e.userData,i=(t*r.sp+r.ph)%1;e.position.set(Math.cos(t*.5+r.ph*5)*r.r,-.15+i*.45,Math.sin(t*.4+r.ph*5)*r.r),e.material.opacity=(.1+.18*a)*Math.sin(i*Math.PI)});let f=t*.4%1;je.position.y=1.04+f*.22,je.position.x=-.55+Math.sin(t*1.5)*.02,je.material.opacity=.26*Math.sin(f*Math.PI),je.scale.set(.1+f*.08,.16+f*.12,1),Oe.rotation.z=Math.sin(t*.8)*.05,Oe.rotation.x=Math.sin(t*.6+1)*.04;let h=n?n.t%1:0;for(let e of w)e.rotation.z=-h*Math.PI*2;if(_t.update(e),xt.visible){let e=r.position.z-xt.position.z,t=2*Math.tan(m.degToRad(r.fov)*.5)*e*1.18;xt.scale.set(t*r.aspect,t,1);let n=.55+.45*(1-a);xt.material.color.setRGB(n,n*.97,n*.92)}r.position.set(i.x+Math.sin(t*.5)*.04,i.y+Math.sin(t*.7)*.02,i.z),r.lookAt(s),u.update(e),d.set(u.pitch,u.yaw,0,`YXZ`),r.quaternion.multiply(p.setFromEuler(d)),St.fit(r)}function Mt(e,t=e){ie.map=e,H.map=t,ie.needsUpdate=!0,H.needsUpdate=!0}function Z(e){me.map=e,me.needsUpdate=!0}let Nt=`corner`;function Pt(){let e=Nt===`corner`;fe.visible=pe.visible=e,ge.visible=!e||Ct!==`3d`,_e.visible=e,K.visible=!e}function Ft(e){return Nt=e===`straight-on`?`straight-on`:`corner`,Pt(),Nt}function It(e){Se.map=e,Se.needsUpdate=!0}let Lt=e;function Rt(e){Lt=e===`basement`?`basement`:`corner`;let t=Lt===`corner`;return Tt(),Ve.intensity=t?9:3.2,Be.intensity=t?.78:.82,Be.color.set(t?`#6a5238`:`#7a5a34`),Lt}return Rt(Lt),Ft(t),{scene:n,camera:r,update:jt,setCityTexture:Mt,setStraightCityTexture:Z,setVignetteTexture:It,setFitout:Rt,setSkin:Et,setProps:Dt,setLayout:Ft,petCat:Ye,feedFish:ft,look:u,vignette:_t,get interactables(){return Ct!==`3d`&&wt===`painted`?S.children:[Ie,Re,Ke,rt]},get tier(){return Lt},get skin(){return Ct},get props(){return wt},get layout(){return Nt}}}function sr(){let e=new _;e.background=new U(`#7fb0dd`);let t=new n(-1.4,1.4,.9,-.9,0,10);t.position.set(0,0,5);let r=(e,t={})=>new l({color:e,toneMapped:!1,...t}),i=(e,t,n,i,a,s,c)=>{let l=new o(new x(e,t),r(s,c));return l.position.set(n,i,a),l};e.add(i(3.2,.9,.5,-.95,1,`#2a4a30`)),e.add(i(3.2,.7,-.7,-1.05,2,`#1d3724`)),e.add(i(.06,.3,-.95,-.55,3,`#3a2a1a`));let a=new o(new N(.22,18),r(`#234a2a`));a.position.set(-.95,-.32,3),e.add(a),e.add(i(.04,.55,.9,-.55,3,`#20242a`));let s=new o(new N(.1,16),r(`#ffd98a`,{transparent:!0,opacity:0}));s.position.set(.9,-.26,3.1),e.add(s);let c=new o(new N(.16,24),r(`#fff4d8`));e.add(c);let u=[];for(let[t,n]of[[-1,.5],[-.6,.7],[.2,.6],[.7,.72],[1.05,.45],[-.2,.78],[.45,.4]]){let i=new o(new N(.015,8),r(`#ffffff`,{transparent:!0,opacity:0}));i.position.set(t,n,.5),u.push(i),e.add(i)}let d=new U(`#141d33`),f=new U(`#7fb6e0`),p=new U(`#d6824a`),h=new U(`#fff0cc`),g=new U(`#cdd8ef`),v=.34;function y(t){v=(v+t*.04)%1;let n=v*Math.PI*2,r=-Math.cos(n);c.position.set(Math.sin(n)*1.15,r*.66+.06,0);let i=m.smoothstep(r,-.18,.5),a=m.smoothstep(.32,0,Math.abs(r));e.background.copy(d).lerp(f,i).lerp(p,a*.45),c.material.color.copy(r>0?h:g),s.material.opacity=1-i;let o=(1-i)*.85;for(let e of u)e.material.opacity=o}return{scene:e,camera:t,update:y}}function cr(e,{x:t,y:n,z:r,ry:i=0,face:a=`#efe2c8`,rim:s=`#2a1c10`}){let c=new G,l=new o(new N(.2,28),new f({color:s,roughness:.6})),u=new o(new N(.17,28),new f({color:a,roughness:.7}));u.position.z=.01;let d=new o(new x(.018,.14),new f({color:`#1a130c`,roughness:.5}));return d.geometry.translate(0,.05,0),d.position.z=.02,e.push(d),c.add(l,u,d),c.position.set(t,n,r),c.rotation.y=i,c}function lr(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=`#e08a3c`,i=`#b96a26`,a=`#3a2410`;if(n.lineJoin=`round`,e){n.fillStyle=r,n.beginPath(),n.ellipse(64,78,44,26,0,0,7),n.fill(),n.fillStyle=i,n.beginPath(),n.ellipse(64,86,44,16,0,0,7),n.fill(),n.fillStyle=r,n.beginPath(),n.arc(36,70,20,0,7),n.fill(),n.fillStyle=r,ur(n,24,56,34,44,42,58),ur(n,40,54,50,44,54,60),n.strokeStyle=i,n.lineWidth=7,n.lineCap=`round`,n.beginPath(),n.moveTo(100,70),n.quadraticCurveTo(112,90,88,96),n.stroke(),n.strokeStyle=a,n.lineWidth=2.5,n.beginPath(),n.arc(30,70,5,.1,Math.PI-.1),n.stroke(),n.strokeStyle=i,n.lineWidth=3;for(let e of[60,74,88])n.beginPath(),n.moveTo(e,58),n.lineTo(e,70),n.stroke()}else{n.fillStyle=r,n.beginPath(),n.ellipse(64,86,30,34,0,0,7),n.fill(),n.fillStyle=`#f3c98a`,n.beginPath(),n.ellipse(64,92,14,22,0,0,7),n.fill(),n.strokeStyle=i,n.lineWidth=8,n.lineCap=`round`,n.beginPath(),n.moveTo(92,100),n.quadraticCurveTo(116,86,104,60),n.stroke(),n.fillStyle=r,n.beginPath(),n.arc(64,48,24,0,7),n.fill(),n.fillStyle=r,ur(n,44,34,50,18,60,34),ur(n,84,34,78,18,68,34),n.fillStyle=`#f0b0c0`,ur(n,47,30,50,22,56,32),ur(n,81,30,78,22,72,32),n.fillStyle=a,n.beginPath(),n.arc(55,47,3.4,0,7),n.arc(73,47,3.4,0,7),n.fill(),n.fillStyle=`#e06a7a`,ur(n,61,54,67,54,64,58),n.strokeStyle=a,n.lineWidth=1.6;for(let e of[-2,3])n.beginPath(),n.moveTo(50,55+e),n.lineTo(34,53+e),n.moveTo(78,55+e),n.lineTo(94,53+e),n.stroke();n.strokeStyle=i,n.lineWidth=3;for(let e of[78,90,102])n.beginPath(),n.moveTo(50,e),n.lineTo(78,e),n.stroke()}let o=new j(t);return o.colorSpace=E,o}function ur(e,t,n,r,i,a,o){e.beginPath(),e.moveTo(t,n),e.lineTo(r,i),e.lineTo(a,o),e.closePath(),e.fill()}function dr(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`);t.fillStyle=`#ff5a8a`,t.beginPath(),t.moveTo(32,52),t.bezierCurveTo(6,32,14,10,32,24),t.bezierCurveTo(50,10,58,32,32,52),t.fill();let n=new j(e);return n.colorSpace=E,n}function fr(e){let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);n.fillStyle=e,n.beginPath(),n.ellipse(30,32,18,11,0,0,7),n.fill(),n.beginPath(),n.moveTo(46,32),n.lineTo(60,22),n.lineTo(60,42),n.closePath(),n.fill(),n.fillStyle=`rgba(255,255,255,0.35)`,n.beginPath(),n.ellipse(28,36,12,5,0,0,7),n.fill(),n.fillStyle=`#15212a`,n.beginPath(),n.arc(20,30,2.6,0,7),n.fill();let r=new j(t);return r.colorSpace=E,r}function pr(){let e=document.createElement(`canvas`);e.width=e.height=32;let t=e.getContext(`2d`),n=t.createRadialGradient(16,16,0,16,16,16);n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.6,`rgba(255,255,255,0.7)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(16,16,16,0,7),t.fill();let r=new j(e);return r.colorSpace=E,r}function mr(e){let t=document.createElement(`canvas`);t.width=t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,256,256);e<0?(r.addColorStop(0,`#6a3b1c`),r.addColorStop(1,`#caa15a`)):(r.addColorStop(0,`#3a4a6a`),r.addColorStop(1,`#a86a3a`)),n.fillStyle=r,n.fillRect(0,0,256,256),n.globalAlpha=.5;for(let e=0;e<5;e++)n.fillStyle=e%2?`#2a1c10`:`#e0c080`,n.fillRect(30+e*36,40+e%3*30,26,150);let i=new j(t);return i.colorSpace=E,i}var{Timer:hr}=se,gr=new URLSearchParams(window.location.search),_r=gr.get(`demo`)===`1`||gr.has(`capture`);window.__demo=_r;var vr=(gr.get(`city`)?Number(gr.get(`city`)):0)||Math.random()*1e9|0,yr=0,br=Hn({demo:_r,citySeed:vr,profileIndex:yr}),{renderer:xr,rig:Sr,sunRig:Cr,city:wr,cityLife:Tr,waterMaterial:Er,fitShadowFrustum:Dr,landmarkFactory:Or,renderCityBeautyTo:kr}=br,$=or({tier:`corner`});typeof window<`u`&&(window.__office=$),$.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix();var Ar=!0;window.__shadows=Ar,window.__scene=`office`;var jr={minFilter:R,magFilter:R,depthBuffer:!0,stencilBuffer:!1},Mr=new M(2.2,3.4,11.5),Nr=new M(0,2,0).sub(Mr),Pr=new M(0,1,0),Fr=30,Ir=384/320,Lr=m.radToDeg(2*Math.atan(Math.tan(m.degToRad(Fr))/Ir));function Rr(e){let t=new c(Lr,Ir,.1,100);t.position.copy(Mr);let n=Nr.clone().applyAxisAngle(Pr,m.degToRad(e));return t.lookAt(Mr.clone().add(n)),t}var zr=Rr(30),Br=Rr(-30),Vr=new B(384,320,jr),Hr=new B(384,320,jr);$.setCityTexture(Vr.texture,Hr.texture);var Ur=new c(52,540/320,.1,100);Ur.position.copy(Mr),Ur.lookAt(Mr.clone().add(Nr));var Wr=new B(540,320,jr);$.setStraightCityTexture(Wr.texture);var Gr=0,Kr=3,qr=new B(512,320,{minFilter:R,magFilter:R,depthBuffer:!0,stencilBuffer:!1});$.setVignetteTexture(qr.texture);var Jr=!1,Yr=(()=>{if(typeof document>`u`)return{showLap(){},toast(){},flash(){}};let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.className=`lap`,t.innerHTML=`<div class="lap-win"><div class="lap-bar"><b>PORTFOLIO OS — John's Game</b>
    ...
    </div></div>`;let n=document.createElement(`div`);n.className=`otoast`;let r=document.createElement(`div`);r.className=`oflash`,document.body.append(t,n,r),t.querySelector(`.lap-x`).addEventListener(`click`,()=>Zr()),t.addEventListener(`click`,e=>{e.target===t&&Zr()}),t.addEventListener(`click`,e=>{e.target.closest(`button`)&&navigator.vibrate?.(10)});let i=0;return{showLap(e){t.classList.toggle(`on`,e)},toast(e){n.textContent=e,n.classList.add(`on`),clearTimeout(i),i=setTimeout(()=>n.classList.remove(`on`),1400)},flash(){r.style.transition=`none`,r.style.opacity=`0.85`,requestAnimationFrame(()=>{r.style.transition=`opacity .55s`,r.style.opacity=`0`})}}})();function Xr(){Jr=!0,Yr.showLap(!0)}function Zr(){Jr=!1,Yr.showLap(!1)}function Qr(){yr=(yr+1)%Je.length,Yr.flash(),wr.generate(vr,yr),Er.uniforms.uVecWater.value.set(wr.waterColor),Tr.setProfile(wr.state.profile),Dr(),Yr.toast(`✈  `+wr.state.profile.name),window.__profile=wr.state.profile.key}function $r(e){let t=$.setFitout(e);return Yr.toast(t===`basement`?`🏚  Basement office`:`🏙  Corner office`),window.__tier=t,t}function ei(){return $r($.tier===`corner`?`basement`:`corner`)}window.__tier=$.tier;var ti=[`3d`,`dressed2`,`night2`,`modern`,`charm`],ni={"3d":`🧊  Stylized 3D office`,dressed2:`📚  Dressed office (day)`,night2:`🌙  Night office`,modern:`🏙  Modern office (day)`,charm:`🎨  Charm office`};function ri(e){let t=$.setSkin(e);return window.__officeSkin=t,Yr.toast(ni[t]),t}function ii(){return ri(ti[(ti.indexOf($.skin)+1)%ti.length])}window.__officeSkin=$.skin;var ai={painted:`🎨  Painted props (cohesive)`,"3d":`🧊  Live 3D props (animated)`};function oi(e){let t=$.setProps(e);return window.__officeProps=t,$.skin!==`3d`&&Yr.toast(ai[t]),t}function si(){return oi($.props===`painted`?`3d`:`painted`)}window.__officeProps=$.props;var ci={corner:`🏙  Corner window`,"straight-on":`🖼  Straight-on window`};function li(e){let t=$.setLayout(e);return window.__officeLayout=t,Yr.toast(ci[t]),t}function ui(){return li($.layout===`corner`?`straight-on`:`corner`)}window.__officeLayout=$.layout;var di=new T,fi=new W,pi=(e,t)=>{fi.x=e/window.innerWidth*2-1,fi.y=-(t/window.innerHeight)*2+1};function mi(){di.setFromCamera(fi,$.camera);let e=di.intersectObjects($.interactables,!0)[0];if(!e)return null;let t=e.object;for(;t&&!t.userData.role;)t=t.parent;return t?t.userData.role:null}function hi(e){e===`laptop`?Xr():e===`phone`?Qr():e===`cat`?$.petCat():e===`tank`&&$.feedFish()}var gi=6,_i=0,vi=0,yi=0,bi=0,xi=0,Si=!1,Ci=!1;xr.domElement.style.cursor=`grab`,xr.domElement.addEventListener(`mousedown`,e=>{Si=!0,Ci=!1,_i=bi=e.clientX,vi=xi=e.clientY,yi=performance.now()}),window.addEventListener(`mousemove`,e=>{Si?(!Ci&&Math.hypot(e.clientX-_i,e.clientY-vi)>gi&&(Ci=!0),Ci&&($.look.addDrag(e.clientX-bi,e.clientY-xi),xr.domElement.style.cursor=`grabbing`),bi=e.clientX,xi=e.clientY):(pi(e.clientX,e.clientY),xr.domElement.style.cursor=mi()?`pointer`:`grab`)}),window.addEventListener(`mouseup`,e=>{if(Si&&!Ci&&!Jr){pi(e.clientX,e.clientY);let t=mi();t&&hi(t)}Si=!1,Ci=!1,xr.domElement.style.cursor=`grab`});var wi=!1;xr.domElement.addEventListener(`touchstart`,e=>{e.touches.length===1&&(_i=bi=e.touches[0].clientX,vi=xi=e.touches[0].clientY,yi=performance.now(),wi=!1)},{passive:!0}),xr.domElement.addEventListener(`touchmove`,e=>{if(e.touches.length!==1)return;let t=e.touches[0].clientX,n=e.touches[0].clientY;!wi&&Math.hypot(t-_i,n-vi)>8&&(wi=!0),wi&&$.look.addDrag(t-bi,n-xi),bi=t,xi=n},{passive:!0}),window.addEventListener(`touchend`,e=>{if(!wi&&performance.now()-yi<350&&(!e.touches||e.touches.length===0)&&!Jr){let e=mi();e&&hi(e)}wi=!1});var Ti={left:!1,right:!1,up:!1,down:!1},Ei={ArrowLeft:`left`,ArrowRight:`right`,ArrowUp:`up`,ArrowDown:`down`};window.addEventListener(`keydown`,e=>{if(Ei[e.key]){Ti[Ei[e.key]]=!0,e.preventDefault();return}e.key===`Escape`&&(Jr?Zr():$.look.recenter()),(e.key===`f`||e.key===`F`)&&ei(),(e.key===`j`||e.key===`J`)&&ii(),(e.key===`u`||e.key===`U`)&&si(),(e.key===`t`||e.key===`T`)&&Cr.cyclePreset(),(e.key===`h`||e.key===`H`)&&(Ar=!Ar,window.__shadows=Ar),(e.key===`w`||e.key===`W`)&&ui()}),window.addEventListener(`keyup`,e=>{Ei[e.key]&&(Ti[Ei[e.key]]=!1)}),Or.whenReady.then(()=>{wr.generate(vr,yr),Dr(),window.__cityReady=!0}),gr.get(`office`)===`basement`&&$r(`basement`);var Di=gr.get(`officeskin`);ti.includes(Di)&&ri(Di);var Oi=gr.get(`officeprops`);[`painted`,`3d`].includes(Oi)&&oi(Oi);var ki=gr.get(`officelayout`);[`corner`,`straight-on`].includes(ki)&&li(ki);var Ai=new hr;Ai.connect(document);function ji(){Ai.update();let e=Math.min(Ai.getDelta(),.1);Sr.update(e),br.updateWorld(e,Ai.getElapsed(),{shadowsOn:Ar,seasonTarget:0}),$.look.addKeys(e,Ti),$.update(e,Ai.getElapsed(),Cr),window.__lookYaw=$.look.yaw,window.__lookPitch=$.look.pitch,$.tier===`basement`?(xr.setRenderTarget(qr),xr.render($.vignette.scene,$.vignette.camera)):Gr%Kr===0&&($.layout===`straight-on`?kr(Ur,Wr):(kr(zr,Vr),kr(Br,Hr),$.skin!==`3d`&&kr(Ur,Wr))),Gr++,xr.setRenderTarget(null),xr.render($.scene,$.camera),requestAnimationFrame(ji)}ji(),Kn({key:`office`,title:`The Office`,tips:[`Drag to look around the office (or use the arrow keys)`,`Click / tap the LAPTOP to open the game panel`,`Tap the PHONE to travel to another city · pet the CAT · feed the FISH`,`Esc exits · F fitout · J skin · U props · W window · T time`]}),window.addEventListener(`resize`,()=>{br.resize(),$.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix()});