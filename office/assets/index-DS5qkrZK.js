import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,Q as _,R as v,S as y,T as b,U as x,V as S,W as C,X as w,Y as T,Z as E,_ as D,a as O,at as k,b as ee,c as A,ct as j,d as te,dt as ne,et as M,f as N,ft as P,g as F,h as I,ht as L,i as re,it as ie,j as R,k as ae,l as oe,lt as z,m as se,mt as B,n as ce,nt as V,o as H,ot as le,p as ue,pt as de,q as fe,r as pe,rt as me,s as U,st as he,t as ge,tt as _e,u as W,ut as ve,v as ye,w as be,x as xe,y as Se,z as Ce}from"./three-D_aL4whJ.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var we=(e,t,n,r)=>e+(t-e)*(1-Math.exp(-n*r)),G=(e,t,n)=>e<t?t:e>n?n:e,K=Math.atan(1/Math.SQRT2),Te=Math.atan(.5),q=Math.PI/4,Ee={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},De=8,Oe=.12,ke=1.45,Ae=4,je=40,Me=1.5,Ne=16,Pe=6,Fe=22,Ie=3.5,Le=11,Re=(e,t,n)=>we(e,t,De,n),ze=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function Be({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new B(0,.8,0),azimuth:a=q,elevation:o=.52,distance:c=12,zoom:l=5.5}={}){let u=new fe(t,e,n,r),d=new s(-1,1,1,-1,n,r),p=Ee.PERSPECTIVE,m=e,h={azimuth:a,elevation:o,distance:c,zoom:l,target:i.clone()},g={azimuth:a,elevation:o,distance:c,zoom:l,target:i.clone()},_=!1,v=null,y=new B,b=()=>p===Ee.PERSPECTIVE?u:d;function x(e){e!==p&&(p=e,p===Ee.ISOMETRIC||p===Ee.DIMETRIC?(h.elevation=p===Ee.ISOMETRIC?K:Te,h.azimuth=ze(q,g.azimuth),_=!0):_=!1)}function S(e,t){h.azimuth+=e,_||(h.elevation=f.clamp(h.elevation+t,Oe,ke))}function C(e){p===Ee.PERSPECTIVE?h.distance=f.clamp(h.distance*e,Ae,je):h.zoom=f.clamp(h.zoom*e,Me,Ne)}function w(e,t){let n=h.azimuth,r=p===Ee.PERSPECTIVE?h.distance*.04:h.zoom*.08,i=new B(Math.cos(n),0,-Math.sin(n)),a=new B(-Math.sin(n),0,-Math.cos(n));h.target.addScaledVector(i,e*r),h.target.addScaledVector(a,t*r)}function T(e,t){m=e/t,u.aspect=m,u.updateProjectionMatrix()}function E(e){v&&(v(y),h.target.copy(y)),g.azimuth=Re(g.azimuth,h.azimuth,e),g.elevation=Re(g.elevation,h.elevation,e),g.distance=Re(g.distance,h.distance,e),g.zoom=Re(g.zoom,h.zoom,e),g.target.x=Re(g.target.x,h.target.x,e),g.target.y=Re(g.target.y,h.target.y,e),g.target.z=Re(g.target.z,h.target.z,e);let t=Math.cos(g.elevation),n=Math.sin(g.elevation),r=Math.cos(g.azimuth),i=Math.sin(g.azimuth),a=b();if(a.position.set(g.target.x+g.distance*t*i,g.target.y+g.distance*n,g.target.z+g.distance*t*r),a.lookAt(g.target),a.isOrthographicCamera){let e=g.zoom,t=e*m;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function D(e,t,n,r=!1){h.target.set(e,t,n),r&&g.target.copy(h.target)}function O(e,t=!1){h.zoom=f.clamp(e,Me,Ne),t&&(g.zoom=h.zoom)}function k(e,t=!1){h.azimuth=ze(e,g.azimuth),t&&(g.azimuth=h.azimuth)}function ee(e,t=!1){h.elevation=f.clamp(e,Oe,ke),t&&(g.elevation=h.elevation)}function A(e,{frame:t,snap:n=!1}={}){v=e,n&&(v(y),h.target.copy(y),g.target.copy(y)),t!=null&&(p===Ee.PERSPECTIVE?h.distance=f.clamp(t,Ae,je):h.zoom=f.clamp(t,Me,Ne))}function j(){v=null}return{get camera(){return b()},get mode(){return p},get azimuth(){return g.azimuth},get following(){return!!v},setTarget:D,setZoom:O,setFollow:A,clearFollow:j,setAzimuth:k,setElevation:ee,get styleT(){return p===Ee.PERSPECTIVE?f.clamp((g.distance-Pe)/(Fe-Pe),0,1):f.clamp((g.zoom-Ie)/(Le-Ie),0,1)},setMode:x,orbit:S,zoomBy:C,pan:w,setViewport:T,update:E}}var Ve={value:0},He=new I(`#ffffff`),Ue={value:0},We={value:0},Ge={value:0},Ke=new de,qe={value:0},Je={value:0},J=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
void main() {
  ...
  gl_FragColor = vec4(st.x, Snew, 0.0, 0.0);
}`;function Vn({renderer:t,N:r,cell:i,half:a,worldSize:o,seaY:l=0,FLOW:d,DAMP:f,MIN_DEPTH:p,KC:m,KE:h,KD:g,KADV:_,MAXD:v,readTerrain:y}){let b=t.getContext();if(!(b&&b.getExtension&&b.getExtension(`EXT_color_buffer_float`)))return typeof console<`u`&&console.warn(`[L87] EXT_color_buffer_float unavailable — GPU flow backend cannot run; staying on CPU.`),null;let S={type:be,format:e,minFilter:x,magFilter:x,wrapS:se,wrapT:se,depthBuffer:!1,stencilBuffer:!1},C=[new L(r,r,S),new L(r,r,S)],w=[new L(r,r,S),new L(r,r,S)],T=[new L(r,r,S),new L(r,r,S)],E=new Float32Array(r*r*4),D=new ye(E,r,r,e,be);D.minFilter=x,D.magFilter=x,D.wrapS=D.wrapT=se;let O=new Float32Array(r*r),k=!1,ee=1,j=!0,te=new me,ne=new s(-1,1,1,-1,0,1),M=new n(new u(2,2),null);M.frustumCulled=!1,te.add(M);let N=new de(1/r,1/r),P=(e,t)=>new ie({vertexShader:Nn,fragmentShader:e,uniforms:t}),F=P(Pn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:N},uN:{value:r},uDt:{value:0},uFlow:{value:d},uDamp:{value:f}}),re=P(Fn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:N},uN:{value:r},uDt:{value:0},uSeaY:{value:l}}),R=P(In,{uState:{value:null},uTerr:{value:null},uN:{value:r},uSeaY:{value:l},uRain:{value:0},uPourCount:{value:0},uPours:{value:Array.from({length:8},()=>new B)},uPourR:{value:new Float32Array(8)}}),ae=P(Ln,{uSrc:{value:D}}),z=()=>({uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:N},uN:{value:r},uDt:{value:0},uCell:{value:i},uSeaY:{value:l},uKC:{value:m},uKE:{value:h},uKD:{value:g},uMaxD:{value:v},uMinDepth:{value:p},uErosK:{value:ee}}),ce=P(Rn,z()),V=P(zn,z()),H=P(Bn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:N},uN:{value:r},uDt:{value:0},uSeaY:{value:l},uKADV:{value:_}});function ue(e,n){M.material=e;let r=t.getRenderTarget();t.setRenderTarget(n),t.render(te,ne),t.setRenderTarget(r)}let fe=new I;function pe(e){let n=t.getRenderTarget(),r=t.getClearAlpha();t.getClearColor(fe),t.setRenderTarget(e),t.setClearColor(0,0),t.clear(!0,!1,!1),t.setClearColor(fe,r),t.setRenderTarget(n)}function U(){y(O);for(let e=0;e<r*r;e++)E[e*4]=O[e];D.needsUpdate=!0,ue(ae,T[0])}function he(){pe(C[0]),pe(C[1]),pe(w[0]),pe(w[1])}he();let ge=r*r,_e=new Float32Array(ge*3),W=new Float32Array(ge*2);for(let e=0;e<r;e++)for(let t=0;t<r;t++){let n=e*r+t;_e[n*3]=t*i-a,_e[n*3+1]=0,_e[n*3+2]=e*i-a,W[n*2]=(t+.5)/r,W[n*2+1]=(e+.5)/r}let ve=[];for(let e=0;e<r-1;e++)for(let t=0;t<r-1;t++){let n=e*r+t,i=e*r+t+1,a=(e+1)*r+t,o=(e+1)*r+t+1;ve.push(n,a,i,i,a,o)}let xe=new oe;xe.setAttribute(`position`,new A(_e,3)),xe.setAttribute(`aGridUv`,new A(W,2)),xe.setIndex(ve),xe.boundingSphere=new le(new B(0,0,0),o);let Se={uStateTex:{value:C[0].texture},uTerrTex:{value:T[0].texture},uMinDepth:{value:p}},Ce=new c({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});Ce.onBeforeCompile=e=>{e.uniforms.uStateTex=Se.uStateTex,e.uniforms.uTerrTex=Se.uTerrTex,e.uniforms.uMinDepth=Se.uMinDepth,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,wi={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Ti=[`gb`,`8-bit`,`16-bit`,`modern`];function Ei(t){let n=Math.max(t.length,1),r=new Float32Array(n*4);t.forEach((e,t)=>{let n=new I(e);r[t*4+0]=n.r,r[t*4+1]=n.g,r[t*4+2]=n.b,r[t*4+3]=1});let i=new ye(r,n,1,e,be);return i.minFilter=x,i.magFilter=x,i.needsUpdate=!0,i}var Di=220,Oi={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},ki={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Ai(e){if(typeof document>`u`||document.getElementById(`lgr-nowebgl`))return;let t=document.createElement(`div`);t.id=`lgr-nowebgl`,t.style.cssText=`position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;background:#0e1116;color:#cdd6e4;font:16px/1.6 system-ui,-apple-system,sans-serif;text-align:center;padding:2rem;`,t.innerHTML=`<div style="max-width:30rem"><div style="font-size:2.4rem;margin-bottom:1rem">🌊</div><h1 style="font-size:1.3rem;margin:0 0 .6rem;color:#fff;font-weight:600">This experience needs a modern browser</h1><p style="margin:0;color:#9aa6b8">`+e+`</p></div>`,document.body&&document.body.appendChild(t)}function ji({demo:t=!1,citySeed:r=0,profileIndex:a=0}={}){let l;try{l=new re({antialias:!0,preserveDrawingBuffer:!0})}catch(e){throw Ai(`This experience needs WebGL2 — please open it in an up-to-date browser (Chrome, Edge, Firefox, or Safari on iOS 15+) with hardware acceleration enabled.`),e}l.shadowMap.enabled=!0,l.shadowMap.type=1,l.shadowMap.autoUpdate=!1,l.shadowMap.needsUpdate=!0;let d=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches?1.5:2;l.setPixelRatio(Math.min(window.devicePixelRatio,d)),l.setSize(window.innerWidth,window.innerHeight),l.setClearColor(920327,1),document.body.appendChild(l.domElement);let p=l.getDrawingBufferSize(new de),m=!1,h=!1,g=()=>{};l.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),m=!0,typeof window<`u`&&(window.__contextLost=!0)},!1),l.domElement.addEventListener(`webglcontextrestored`,()=>{g(),m=!1,typeof window<`u`&&(window.__contextLost=!1)},!1);let _=new me;_.fog=new b(10465470,0);let y=new I(`#aeb6c0`),C=.062,w=new I(`#74508f`),T=new I,E=Be({aspect:window.innerWidth/window.innerHeight}),D=Tt({t:.5}),O=l.getContext(),k=!!(O&&O.getExtension&&(O.getExtension(`EXT_color_buffer_float`)||O.getExtension(`EXT_color_buffer_half_float`)));!k&&typeof console<`u`&&console.info(`[L90 H1] No float colour buffer (EXT_color_buffer_float/half_float) — wave sim OFF, flat-sea fallback.`);let ee={type:i,format:e,minFilter:x,magFilter:x,wrapS:se,wrapT:se,depthBuffer:!1,stencilBuffer:!1},A=k?[new L(256,256,ee),new L(256,256,ee),new L(256,256,ee)]:null;if(A){for(let e of A)l.setRenderTarget(e),l.clear();l.setRenderTarget(null)}let j=new ye(new Uint8Array([0,0,0,255]),1,1,e);j.needsUpdate=!0;let te=new me,ne=new s(-1,1,1,-1,0,1),M=new ie({vertexShader:Nn,fragmentShader:mi,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new de(1/256,1/256)},uMouse:{value:new de(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new B)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new B)}}});te.add(new n(new u(2,2),M));let N=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1});function P(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new W(t);return r.colorSpace=V,r}let F=new n(new u(28,28),new S({map:P(t)}));F.rotation.x=-Math.PI/2,F.position.y=-.35,_.add(F);let R=new n(new u(40,24),new ie({depthWrite:!1,vertexShader:fi,fragmentShader:pi,uniforms:{uTime:{value:0},uInk:{value:D.horizon},uGold:{value:D.sky},uFogColor:{value:T},uFogAmt:{value:0},uFogCharm:qe}}));R.position.set(0,3,-8),_.add(R);let ae=new ie({vertexShader:hi,fragmentShader:gi,uniforms:{uHeight:{value:k?null:j},uScene:{value:N.texture},uTexel:{value:new de(1/256,1/256)},uResolution:{value:new de(p.x,p.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new v},uLightDir:{value:D.sunDir},uInk:{value:new I(`#2A2218`)},uGold:{value:new I(`#B89968`)},uVector:Ve,uVecWater:{value:new I(`#1fb8d8`)},uVecTint:{value:He}}}),oe=new n(new u(28,28,255,255),ae);oe.rotation.x=-Math.PI/2,oe.updateMatrixWorld(!0),ae.uniforms.uNormalMatrix.value.getNormalMatrix(oe.matrixWorld),_.add(oe);let z={value:0},ce=Qt({windowGlow:z}),H=_t({seed:r,profileIndex:a,landmarkFactory:ce,windowGlow:z});_.add(H.group);let le=At({plinthTop:.3,extent:H.extent,profile:H.state.profile});_.add(le.group);let ue=Vt({extent:H.extent,waterSize:28,plinthTop:.3});_.add(ue.group),M.uniforms.uWakeDrops.value=ue.wakeDrops;let fe=en({extent:H.extent});_.add(fe.group),M.uniforms.uRainDrops.value=fe.rainDrops;let pe=nn({extent:H.extent});_.add(pe.group);let U=[le,ue,pe],he=on({rig:E,getCamera:()=>E.camera,sources:U}),ge=di();_.add(ge.group);let _e=qr({scale:90});_.add(_e.mesh),_.environmentIntensity=.32;let ve=!1;function be(e){let t=e&&D.sunArc.y>-.04;t!==ve&&(ve=t,_e.mesh.visible=t,R.visible=!t)}let xe=null,Ce=-1;g=()=>{xe=null,Ce=-1,l.shadowMap.needsUpdate=!0};function we(){let e=Math.floor(D.t%1*4)%4;return(e!==Ce||!xe)&&(Ce=e,xe=_e.buildEnv(l)),xe}let G=null,K=null,Te=null,q=null,Ee=!1,De=1234,Oe=`valley`,ke=rr.map(e=>e.key),Ae=new c({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),je=()=>[H.group,le.group,ue.group],Me=()=>[G,K,Te].filter(Boolean);function Ne(){for(let e of Me())_.remove(e),e.userData.dispose?.();let e=cr({seed:De,size:160,preset:Oe});q=e,G=hr(e,{worldSize:26,baseY:0,chunks:6}),K=Br({terrain:e,seed:De,worldSize:26,baseY:0,biomeKeys:ke}),Te=Ur(e,{worldSize:26,baseY:0,maxLakes:3,material:Ae});for(let e of Me())e.visible=Ee,_.add(e);Ie!==void 0&&Ie&&Ie.clear(),J!==void 0&&J&&J.clear(),typeof window<`u`&&(window.__world={seed:De,preset:Oe,active:Ee,chunks:G.children.length,scatter:K.userData.counts,lakes:Te.userData.count})}let Pe=e=>{for(let t of Me())t.visible=e};function Fe(e,t){if(!q)return 0;let{size:n,height:r,sea:i,relief:a}=q,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let Ie=jn({heightAt:Fe,seaSurfaceY:0,waterY:.06});Ie.group.visible=!1,_.add(Ie.group),U.push(Ie);let Le=0;function Re(e,t){if(!q||!G)return;let{size:n,height:r,relief:i}=q,a=26/(n-1),o=26/(t-1),s=i>1e-6?1/i:0,c=!1;for(let i=0;i<t;i++)for(let l=0;l<t;l++){let u=e[i*t+l];if(u===0)continue;c=!0;let d=u*s,f=l*o/a,p=i*o/a,m=Math.max(0,Math.round(f-1)),h=Math.min(n-1,Math.round(f+1)),g=Math.max(0,Math.round(p-1)),_=Math.min(n-1,Math.round(p+1));for(let e=g;e<=_;e++)for(let t=m;t<=h;t++){let i=e*n+t,a=r[i]+d;r[i]=a<0?0:a>1?1:a}}c&&(Le++,Le%8==0&&gr(G,q,G.children),Le%24==0&&K&&zr(K,q,{worldSize:26,baseY:0}))}function ze(e,t){if(!q||!G)return;let{size:n,height:r,relief:i}=q,a=i>1e-6?1/i:0,o=(t-1)/(n-1),s=!1;for(let i=0;i<n;i++){let c=i*o,l=Math.floor(c),u=c-l,d=Math.min(t-1,l+1);for(let c=0;c<n;c++){let f=c*o,p=Math.floor(f),m=f-p,h=Math.min(t-1,p+1),g=e[l*t+p],_=e[l*t+h],v=e[d*t+p],y=e[d*t+h],b=(g*(1-m)+_*m)*(1-u)+(v*(1-m)+y*m)*u;if(b!==0){s=!0;let e=i*n+c,t=r[e]+b*a;r[e]=t<0?0:t>1?1:t}}}s&&(gr(G,q,G.children),K&&zr(K,q,{worldSize:26,baseY:0}))}let J=Hn({worldHeightAt:Fe,applyErosion:Re,syncErodedTerrain:ze,worldSize:26,grid:96,seaY:0,renderer:l});J.group.visible=!1,_.add(J.group);let Ye=null,Xe=new Set;function Ze(){!q||!Te||(_.remove(Te),Te.userData.dispose?.(),Te=Ur(q,{worldSize:26,baseY:0,maxLakes:3,material:Ae}),Te.visible=Ee,_.add(Te),window.__world&&(window.__world.lakes=Te.userData.count))}function Qe(){Ze(),K&&zr(K,q,{worldSize:26,baseY:0})}function $e(e,t,n=1,r=2.2,i=.05){if(!q||!G)return;let a=q.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=q.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Xe.clear();for(let e of G.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Xe.add(e)}gr(G,q,Xe),Ye&&clearTimeout(Ye),Ye=setTimeout(Qe,140)}function et(e,t,n,r=2.2){if(!q||!G||n==null)return;let i=q.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=q.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);Xe.clear();for(let e of G.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Xe.add(e)}gr(G,q,Xe,!0)}let Y=[`tree`,`rock`,`tuft`];function nt(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!q||!K)return 0;if(a)return Lr(K,n||`all`,e,t,i);let o=q.size,s=26/(o-1),c=q.height,l=q.sea,u=q.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Rr[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;Ir(K,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&K.userData.counts)for(let e of Y)K.userData.counts[e]=(K.userData.placements[e]||[]).length;return g}let rt=[];function it(){if(!K)return null;let e=K.userData.placements,t={};for(let n of Y)t[n]=(e[n]||[]).map(e=>({...e}));return t}function at(){q&&(rt.push({h:q.height.slice(),b:q.biome.slice(),sc:it(),pl:Ie.snapshot()}),rt.length>12&&rt.shift())}function ot(){if(!q||!rt.length)return!1;let e=rt.pop();if(q.height.set(e.h),q.biome.set(e.b),e.sc&&K){let t=K.userData.placements;for(let n of Y)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&Ie.restore(e.pl),gr(G,q,G.children,!0),Qe(),!0}let st=new Set([`boat`,`fish`]),ct=new Set([`person`,`atv`]);function lt(e,t,n){if(!q)return null;let r=Fe(t,n)<0;return st.has(e)&&!r||ct.has(e)&&r?null:Ie.spawn(e,t,n)}function ut(e,t,n=2.5){return Ie.removeNear(e,t,n)}function dt(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function ft(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let pt=e=>dt(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),mt=e=>dt(e);function ht(){let e=K?K.userData.placements:{},t={};for(let n of Y)t[n]=(e[n]||[]).map(e=>({...e}));return t}function gt(){return q?{v:1,seed:De,preset:Oe,size:q.size,height:pt(q.height),biome:mt(q.biome),scatter:ht(),entities:Ie.snapshot()}:null}function vt(){if(!q)return null;let e=cr({seed:De,size:160,preset:Oe}),t=q.height,n=q.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:De,preset:Oe,hd:r,bd:i,entities:Ie.snapshot()}}function yt(e){K&&(_.remove(K),K.userData.dispose?.()),K=Mr(e||{tree:[],rock:[],tuft:[]}),K.userData.counts=Y.reduce((e,t)=>(e[t]=(K.userData.placements[t]||[]).length,e),{}),K.visible=Ee,_.add(K)}function bt(e){if(!e||e.v!==1)return!1;let t=25600;if(e.height!=null||e.biome!=null){if(typeof e.height!=`string`||typeof e.biome!=`string`)return!1;let n,r;try{n=ft(e.height),r=ft(e.biome)}catch{return!1}if(n.byteLength%4!=0||n.byteLength>>2!=t||r.length<t)return!1;let i=new Float32Array(n.buffer,n.byteOffset,n.byteLength>>2);for(let e=0;e<i.length;e++)if(!Number.isFinite(i[e]))return!1}if(e.hd!=null&&!Array.isArray(e.hd)||e.bd!=null&&!Array.isArray(e.bd))return!1;if(Array.isArray(e.hd))for(let n=0;n<e.hd.length;n+=2){let r=e.hd[n];if(!Number.isInteger(r)||r<0||r>=t||!Number.isFinite(e.hd[n+1]))return!1}if(Array.isArray(e.bd))for(let n=0;n<e.bd.length;n+=2){let r=e.bd[n];if(!Number.isInteger(r)||r<0||r>=t)return!1}De=e.seed|0,Oe=sr.includes(e.preset)?e.preset:Oe,rt.length=0,Ne(),Ee=!0,Pe(!0),Ie.group.visible=!0,J.group.visible=!0;for(let e of je())e.visible=!1;window.__world&&(window.__world.active=!0);let n=e=>e<0?0:e>1?1:e,r=rr.length;if(e.height&&e.biome){let t=ft(e.height),i=new Float32Array(t.buffer,t.byteOffset,t.byteLength>>2);for(let e=0;e<i.length;e++)q.height[e]=n(i[e]);let a=ft(e.biome);for(let e=0;e<q.biome.length;e++)q.biome[e]=Math.min(r-1,a[e]|0)}else if(e.hd||e.bd){let t=e.hd||[],i=e.bd||[];for(let e=0;e<t.length;e+=2)q.height[t[e]]=n(t[e+1]);for(let e=0;e<i.length;e+=2)q.biome[i[e]]=Math.min(r-1,Math.max(0,i[e+1]|0))}return gr(G,q,G.children,!0),e.scatter&&yt(e.scatter),Ze(),K&&zr(K,q,{worldSize:26,baseY:0}),Ie.restore(e.entities),window.__world&&(window.__world.scatter=K.userData.counts,window.__world.seed=De,window.__world.preset=Oe),!0}let xt={enter(){G||Ne(),Ee=!0,Pe(!0),Ie.group.visible=!0,J.group.visible=!0;for(let e of je())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){Ee=!1,Pe(!1),Ie.group.visible=!1,J.group.visible=!1;for(let e of je())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return De=Math.random()*1e9|0,rt.length=0,Ne(),xt.enter(),De},reset(){return rt.length=0,Ne(),xt.enter(),De},setPreset(e){return sr.includes(e)&&(Oe=e,rt.length=0,Ne(),xt.enter()),Oe},sculpt:$e,paintBiome:et,paintScatter:nt,repoolWater:Ze,snapshot:at,undo:ot,placeEntity:lt,removeEntityNear:ut,heightAt:Fe,serialize:gt,serializeCompact:vt,deserialize:bt,flowPourAt:(e,t,n,r)=>J.pourAt(e,t,n,r),flowRain:e=>J.rain(e),flowClear:()=>J.clear(),get flowTotal(){return J.totalWater()},flowAt:(e,t)=>J.cellAt(e,t),flowErosion:(e,t)=>J.setErosion(e,t),get flowErosionOn(){return J.erosion},get flowSediment(){return J.totalSediment()},setSimBackend:e=>J.setBackend(e),get simBackend(){return J.backend},_flowReadW:()=>J._debugReadW(),_flowReadTerr:()=>J._debugReadTerr(),_flowStepN:(e,t)=>J._debugStepN(e,t),get terrainGroup(){return G},get biomes(){return rr},get scatterCounts(){return K?K.userData.placements&&Y.reduce((e,t)=>(e[t]=(K.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return Ie.counts()},setScatterHidden(e){K&&(K.visible=!e)},get placedLife(){return Ie},get canUndo(){return rt.length>0},get active(){return Ee},get seed(){return De},get preset(){return Oe},get presets(){return sr}},St=Gr(),Ct=qn({world:xt,catalog:St,inspector:he});function wt(e,t){return Fe(e,t)<0?0:-999}let Et=vn({rig:E,world:{heightAt:Fe,waterHeightAt:wt}});H.group.remove(H.key),_.add(H.key),H.key.castShadow=!0,H.key.shadow.mapSize.set(2048,2048),H.key.shadow.bias=-18e-5,H.key.shadow.normalBias=.028,_.add(H.key.target);function Dt(){let e=H.key.shadow.camera,t=H.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),l.shadowMap.needsUpdate=!0}Dt();let Ot=new Se(p.x,p.y),kt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1,depthTexture:Ot}),jt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Mt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1,samples:4}),Nt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Pt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Ft=Math.max(1,Math.floor(p.x/2)),It=Math.max(1,Math.floor(p.y/2)),Lt=new L(Ft,It,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Rt=new L(Ft,It,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),zt=new me,Bt=new s(-1,1,1,-1,0,1),Ht=new n(new u(2,2));zt.add(Ht);let X=new ie({vertexShader:Nn,fragmentShader:_i,uniforms:{uScene:{value:kt.texture},uTime:{value:0},uResolution:{value:new de(p.x,p.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:Lt.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:D.grade.tint},uGradeLift:{value:D.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1},uDither:{value:0},uTonemap:{value:0}}}),Ut=new ie({vertexShader:Nn,fragmentShader:xi,uniforms:{uScene:{value:kt.texture},uThreshold:{value:.78}}}),Z=new ie({vertexShader:Nn,fragmentShader:Si,uniforms:{uScene:{value:Lt.texture},uDir:{value:new de}}});function Wt(e){Ut.uniforms.uScene.value=e.texture,tn(Ut,Lt),Z.uniforms.uScene.value=Lt.texture,Z.uniforms.uDir.value.set(1.6/Ft,0),tn(Z,Rt),Z.uniforms.uScene.value=Rt.texture,Z.uniforms.uDir.value.set(0,1.6/It),tn(Z,Lt),X.uniforms.uBloom.value=Lt.texture;let t=1-f.clamp(D.sunArc.y*2.2,0,1);X.uniforms.uBloomStrength.value=.85*(.32+.95*t)}let Gt=e=>{let t=e.map(e=>new I(e));for(;t.length<8;)t.push(new I(0,0,0));return t},Kt=[`night`,`dawn`,`noon`,`dusk`],qt={inkgold:Kt.map(e=>Gt(Oi[e])),terminal:Kt.map(e=>Gt(ki[e]))},Jt=new ie({vertexShader:Nn,fragmentShader:vi,uniforms:{uScene:{value:jt.texture},uResolution:{value:new de(p.x,p.y)},uPixelSize:{value:Di},uPalette:{value:qt.inkgold[2]},uPaletteB:{value:qt.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),Yt=new ie({vertexShader:Nn,fragmentShader:Ci,uniforms:{uScene:{value:jt.texture},uResolution:{value:new de(p.x,p.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Ei(wi[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Xt={};for(let e of Ti)Xt[e]=wi[e].palette?Ei(wi[e].palette):null;let Zt=new ie({vertexShader:Nn,fragmentShader:yi,uniforms:{uScene:{value:jt.texture},uDepth:{value:Ot},uResolution:{value:new de(p.x,p.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:D.toonFloor},uOutline:{value:D.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),$t=new ie({vertexShader:Nn,fragmentShader:bi,uniforms:{uToon:{value:Nt.texture},uPixel:{value:Pt.texture},uBlend:{value:0}}});function tn(e,t){Ht.material=e,l.setRenderTarget(t),l.render(zt,Bt)}function rn(){E.setViewport(window.innerWidth,window.innerHeight),l.setSize(window.innerWidth,window.innerHeight);let e=l.getDrawingBufferSize(new de);return N.setSize(e.x,e.y),kt.setSize(e.x,e.y),jt.setSize(e.x,e.y),Mt.setSize(e.x,e.y),Nt.setSize(e.x,e.y),Pt.setSize(e.x,e.y),Ft=Math.max(1,e.x>>1),It=Math.max(1,e.y>>1),Lt.setSize(Ft,It),Rt.setSize(Ft,It),ae.uniforms.uResolution.value.set(e.x,e.y),X.uniforms.uResolution.value.set(e.x,e.y),Jt.uniforms.uResolution.value.set(e.x,e.y),Yt.uniforms.uResolution.value.set(e.x,e.y),Zt.uniforms.uResolution.value.set(e.x,e.y),e}let an=Xn({renderer:l}),sn=!0;function cn(e,t){let n=t.dpr==null?d:t.dpr,r=Math.min(window.devicePixelRatio,n);Math.abs(l.getPixelRatio()-r)>.001&&(l.setPixelRatio(r),typeof window<`u`&&window.dispatchEvent?window.dispatchEvent(new Event(`resize`)):rn()),sn=t.shadows!==!1,sn||(l.shadowMap.needsUpdate=!1)}let ln=Qn({profiler:an,apply:cn});function un(){!h&&!m&&an.frameStart()}function dn(){h||m||(an.frameEnd(),ln.update())}function fn(e){h=!e,typeof window<`u`&&(window.__paused=h)}function pn(){try{l.compile(_,E.camera),Ln(1/60,0,{shadowsOn:!0}),Mn(Pn(),kt),l.setRenderTarget(null)}catch(e){typeof console<`u`&&console.warn(`[L79] prewarm`,e)}}let mn=3,hn=!1,gn=!1,_n=`native`,yn=.3,bn=.46,xn=[`native`,...Ti],Sn={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=mn,window.__vector=hn,window.__era=_n),typeof window<`u`&&(window.__frames=0),typeof window<`u`&&(window.__loaded=!1);let Cn=0,wn=new B(1,1,1),Tn=!1;function En(e){let t=gn?qt.terminal:qt.inkgold,n=e%1*4,r=Math.floor(n)%4;Jt.uniforms.uPalette.value=t[r],Jt.uniforms.uPaletteB.value=t[(r+1)%4],Jt.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Dn(e){let t=wi[e];t&&(Yt.uniforms.uGridWidth.value=t.gridWidth,Yt.uniforms.uDither.value=t.dither,Yt.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(Yt.uniforms.uPalette.value=Xt[e],Yt.uniforms.uPaletteSize.value=t.palette.length))}function On(){_n!==`native`&&Dn(_n)}let kn=()=>_n===`native`?Jt:Yt;function An(e,t){be(!0),_.environment=we(),tt.value=1,oe.visible=!1,l.setRenderTarget(N),l.render(_,e),oe.visible=!0,l.setRenderTarget(Mt),l.render(_,e),Wt(Mt),X.uniforms.uScene.value=Mt.texture,X.uniforms.uAces.value=1,X.uniforms.uGrade.value=1,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=1,tn(X,t)}function Mn(e,t){let n=!hn&&(mn===1||mn===2);if(be(n),_.environment=n?we():null,tt.value=+!!n,X.uniforms.uBloomStrength.value=0,oe.visible=!1,l.setRenderTarget(N),l.render(_,E.camera),oe.visible=!0,mn===1&&!n)l.setRenderTarget(t),l.render(_,E.camera);else if(mn===1)l.setRenderTarget(Mt),l.render(_,E.camera),Wt(Mt),X.uniforms.uScene.value=Mt.texture,X.uniforms.uAces.value=1,X.uniforms.uGrade.value=1,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=1,tn(X,t);else if(l.setRenderTarget(n?Mt:kt),l.render(_,E.camera),mn===2)n&&Wt(Mt),X.uniforms.uScene.value=n?Mt.texture:kt.texture,X.uniforms.uAces.value=+!!n,X.uniforms.uGrade.value=+!!n,X.uniforms.uGrain.value=1,X.uniforms.uChroma.value=1,X.uniforms.uDither.value=+!!n,tn(X,t);else{X.uniforms.uScene.value=kt.texture,X.uniforms.uAces.value=0,X.uniforms.uGrade.value=0,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=0,tn(X,jt);let n=E.camera;Zt.uniforms.uNear.value=n.near,Zt.uniforms.uFar.value=n.far,Zt.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Dn(e.era),Yt):kn();e.kind===`pixel`?(tn(r,t),window.__style=`pixel`):e.kind===`toon`?(tn(Zt,t),window.__style=`toon`):(tn(Zt,Nt),tn(r,Pt),$t.uniforms.uBlend.value=e.blend,tn($t,t),window.__style=`blend`)}}function Pn(){let e=Fn(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return ae.uniforms.uChromaScale.value=f.lerp(1,.5,t),e}function Fn(){if(mn===1||mn===2)return{kind:`none`};if(mn===7)return{kind:`pixel`};if(mn===8)return{kind:`toon`};let e=E.styleT;return window.__styleT=e,e<=yn?{kind:`toon`}:e>=bn?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:f.smoothstep(e,yn,bn),era:`16-bit`}}function In(e){return mn===1||mn===2?``:hn&&mn!==7&&mn!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Sn[e.era||_n]||`Pixel`:e.kind===`blend`?`Toon → `+(Sn[e.era]||`Pixel`):``}function Ln(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){typeof window<`u`&&window.__frames++,n&&=sn,R.material.uniforms.uTime.value=t,X.uniforms.uTime.value=t,D.update(e),H.key.position.copy(D.sunDir).multiplyScalar(24),H.key.color.copy(D.sunColor),H.key.intensity=D.sunIntensity,H.fill.color.copy(D.hemiSky),H.fill.groundColor.copy(D.hemiGround),z.value=D.windowGlow,_e.setSun(D.sunArc),_e.setParams(D.skyParams),X.uniforms.uGradeSat.value=D.grade.sat,X.uniforms.uGradeContrast.value=D.grade.contrast,_.environmentIntensity=.34*(1-.6*f.clamp(D.sunArc.y*1.5,0,1));let i=fe.overcast;H.key.intensity*=1-.5*i,H.key.color.lerp(y,.45*i),H.fill.intensity=1+.7*i;let a=f.smoothstep(D.sunDir.y,.06,.34),o=f.lerp(.28,1,1-D.windowGlow),s=n?a*o:0;H.key.shadow.intensity=.72*s,Ue.value=.52*s,(n&&!Tn||wn.distanceToSquared(D.sunDir)>2e-5)&&(l.shadowMap.needsUpdate=!0,wn.copy(D.sunDir)),Tn=n;let c=1-D.windowGlow;He.setRGB(f.lerp(.46,1,c),f.lerp(.52,1,c),f.lerp(.74,1,c)),X.uniforms.uExposure.value=D.exposure,Zt.uniforms.uToonGain.value=D.toonGain,l.setClearColor(D.horizon,1),En(D.t),window.__t=D.t,le.update(e,t,D),H.update(t),ue.update(e,t,D),M.uniforms.uWakeCount.value=ue.wakeCount,fe.update(e,t),M.uniforms.uRainCount.value=fe.rainDropCount;let u=fe.fog*(1-c);_.fog.density=fe.fog*C,T.copy(D.horizon).lerp(w,.85*u),_.fog.color.copy(T),l.setClearColor(T,1),qe.value=fe.fog,R.material.uniforms.uFogAmt.value=.7*fe.fog,We.value=fe.snow,Ge.value=fe.cloud*.55,Ke.x+=e*.018,Ke.y+=e*.009,Je.value+=(r-Je.value)*Math.min(1,e*1.5),pe.update(e,t,D,fe),Ee&&Ie.update(e,t,D),Ee&&J.step(e);let d=Fn(),p=d.kind===`pixel`||d.kind===`blend`?`pixel`:hn?`vector`:d.kind===`toon`?`charm`:`realistic`;if(ge.update(e,t,D,fe,p,E.camera),k){let[e,t,n]=A;M.uniforms.uPrev.value=e.texture,M.uniforms.uCurr.value=t.texture,l.setRenderTarget(n),l.render(te,ne),A=[t,n,e],ae.uniforms.uHeight.value=A[1].texture}if(Cn<2&&typeof document<`u`&&++Cn===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Rn(e){mn=e,window.__mode=mn}function zn(){return hn=!hn,Ve.value=+!!hn,window.__vector=hn,hn}function Bn(e){return hn=!!e,Ve.value=+!!hn,window.__vector=hn,hn}function Vn(){return _n=xn[(xn.indexOf(_n)+1)%xn.length],window.__era=_n,On(),_n}function Un(){return gn=!gn,gn}return{updateWorld:Ln,decideStyle:Pn,renderCityPipeline:Mn,renderCityBeautyTo:An,styleHintName:In,setPostMode:Rn,toggleVector:zn,setVector:Bn,cycleEra:Vn,togglePalette:Un,setTonemap:e=>{let t=e===`agx`||e===1||e===!0;return X.uniforms.uTonemap.value=+!!t,typeof window<`u`&&(window.__tonemap=t?`agx`:`aces`),t?`agx`:`aces`},get mode(){return mn},get vector(){return hn},get sceneEra(){return _n},renderer:l,drawBuffer:p,scene:_,rig:E,sunRig:D,SIM:256,targets:A,simScene:te,simCamera:ne,simMaterial:M,grabRT:N,card:F,backdrop:R,WATER_SIZE:28,water:oe,waterMaterial:ae,windowGlow:z,landmarkFactory:ce,city:H,cityLife:le,waterLife:ue,weatherRig:fe,clouds:pe,inspector:he,world:xt,catalog:St,editor:Ct,pilot:Et,profiler:an,governor:ln,frameStart:un,frameEnd:dn,setActive:fn,get paused(){return h},get contextLost(){return m},prewarm:pn,fitShadowFrustum:Dt,SHADOW_DIST:24,sceneDepth:Ot,sceneRT:kt,filmicRT:jt,toonRT:Nt,pixelRT:Pt,postScene:zt,postCamera:Bt,postQuad:Ht,filmicMaterial:X,pixelMaterial:Jt,pixelkitMaterial:Yt,toonMaterial:Zt,mixMaterial:$t,PALCACHE:qt,ERA_TEX:Xt,runPass:tn,OVERCAST_GREY:y,FOG_DENSITY:C,FOG_NIGHT_TINT:w,_fogColor:T,resize:rn}}var Mi=`lgr_hints_`,Ni=!1;function Pi(){if(Ni||typeof document>`u`)return;Ni=!0;let e=document.createElement(`style`);e.textContent=`
