import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,Q as _,R as v,S as y,T as b,U as x,V as S,W as C,X as w,Y as T,Z as E,_ as ee,a as D,at as O,b as te,c as k,d as A,et as j,f as ne,g as re,h as ie,i as M,it as N,j as ae,k as P,l as oe,m as F,n as se,nt as ce,o as I,ot as L,p as R,q as le,r as ue,rt as z,s as B,t as de,tt as V,u as fe,v as pe,w as me,x as he,y as ge,z as _e}from"./three-fWsc3c0P.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var H=Math.atan(1/Math.SQRT2),ve=Math.atan(.5),ye=Math.PI/4,be={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},xe=.12,Se=1.45,Ce=4,we=40,Te=1.5,Ee=16,De=6,Oe=22,ke=3.5,U=11,W=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),Ae=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function je({aspect:e,fov:n=48,near:r=.1,far:i=100,target:a=new O(0,.8,0),azimuth:o=ye,elevation:s=.52,distance:c=12,zoom:l=5.5}={}){let u=new _e(n,e,r,i),d=new f(-1,1,1,-1,r,i),p=be.PERSPECTIVE,m=e,h={azimuth:o,elevation:s,distance:c,zoom:l,target:a.clone()},g={azimuth:o,elevation:s,distance:c,zoom:l,target:a.clone()},_=!1,v=()=>p===be.PERSPECTIVE?u:d;function y(e){e!==p&&(p=e,p===be.ISOMETRIC||p===be.DIMETRIC?(h.elevation=p===be.ISOMETRIC?H:ve,h.azimuth=Ae(ye,g.azimuth),_=!0):_=!1)}function b(e,n){h.azimuth+=e,_||(h.elevation=t.clamp(h.elevation+n,xe,Se))}function x(e){p===be.PERSPECTIVE?h.distance=t.clamp(h.distance*e,Ce,we):h.zoom=t.clamp(h.zoom*e,Te,Ee)}function S(e,t){let n=h.azimuth,r=p===be.PERSPECTIVE?h.distance*.04:h.zoom*.08,i=new O(Math.cos(n),0,-Math.sin(n)),a=new O(-Math.sin(n),0,-Math.cos(n));h.target.addScaledVector(i,e*r),h.target.addScaledVector(a,t*r)}function C(e,t){m=e/t,u.aspect=m,u.updateProjectionMatrix()}function w(e){g.azimuth=W(g.azimuth,h.azimuth,e),g.elevation=W(g.elevation,h.elevation,e),g.distance=W(g.distance,h.distance,e),g.zoom=W(g.zoom,h.zoom,e),g.target.x=W(g.target.x,h.target.x,e),g.target.y=W(g.target.y,h.target.y,e),g.target.z=W(g.target.z,h.target.z,e);let t=Math.cos(g.elevation),n=Math.sin(g.elevation),r=Math.cos(g.azimuth),i=Math.sin(g.azimuth),a=v();if(a.position.set(g.target.x+g.distance*t*i,g.target.y+g.distance*n,g.target.z+g.distance*t*r),a.lookAt(g.target),a.isOrthographicCamera){let e=g.zoom,t=e*m;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function T(e,t,n,r=!1){h.target.set(e,t,n),r&&g.target.copy(h.target)}function E(e,n=!1){h.zoom=t.clamp(e,Te,Ee),n&&(g.zoom=h.zoom)}return{get camera(){return v()},get mode(){return p},get azimuth(){return g.azimuth},setTarget:T,setZoom:E,get styleT(){return p===be.PERSPECTIVE?t.clamp((g.distance-De)/(Oe-De),0,1):t.clamp((g.zoom-ke)/(U-ke),0,1)},setMode:y,orbit:b,zoomBy:x,pan:S,setViewport:C,update:w}}var Me={value:0},Ne=new R(`#ffffff`),Pe={value:0},Fe={value:0},Ie={value:0},Le=new N,Re={value:0},ze={value:0},G=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
#include <shadowmask_pars_fragment>`)}var We=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Ge(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new R(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{Be(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new R(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=He(e.vertexShader),e.fragmentShader=Ve(Ue(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function K(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{Be(e),s||(e.uniforms.uVecColor={value:new R(t)}),c&&(e.uniforms.uGlow={value:new R(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=ze),e.vertexShader=He(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Zt={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Qt=[`gb`,`8-bit`,`16-bit`,`modern`];function $t(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new R(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new re(n,t,1,s,he);return r.minFilter=o,r.magFilter=o,r.needsUpdate=!0,r}var en=220,tn={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},nn={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function rn({demo:e=!1,citySeed:r=0,profileIndex:i=0}={}){let a=new se({antialias:!0,preserveDrawingBuffer:!0});a.shadowMap.enabled=!0,a.shadowMap.type=1,a.shadowMap.autoUpdate=!1,a.shadowMap.needsUpdate=!0;let c=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);a.setPixelRatio(Math.min(window.devicePixelRatio,c?1.5:2)),a.setSize(window.innerWidth,window.innerHeight),a.setClearColor(920327,1),document.body.appendChild(a.domElement);let l=a.getDrawingBufferSize(new N),d=new T;d.fog=new y(10465470,0);let g=new R(`#aeb6c0`),_=.062,v=new R(`#74508f`),b=new R,x=je({aspect:window.innerWidth/window.innerHeight}),S=ut({t:.5}),C={type:me,format:s,minFilter:o,magFilter:o,wrapS:ne,wrapT:ne,depthBuffer:!1,stencilBuffer:!1},E=[new L(256,256,C),new L(256,256,C),new L(256,256,C)];for(let e of E)a.setRenderTarget(e),a.clear();a.setRenderTarget(null);let D=new T,te=new f(-1,1,1,-1,0,1),A=new w({vertexShader:Ht,fragmentShader:Ut,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new N(1/256,1/256)},uMouse:{value:new N(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new O)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new O)}}});D.add(new p(new n(2,2),A));let j=new L(l.x,l.y,{minFilter:h,magFilter:h,depthBuffer:!0,stencilBuffer:!1});function re(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new k(t);return r.colorSpace=u,r}let ie=new p(new n(28,28),new m({map:re(e)}));ie.rotation.x=-Math.PI/2,ie.position.y=-.35,d.add(ie);let M=new p(new n(40,24),new w({depthWrite:!1,vertexShader:Bt,fragmentShader:Vt,uniforms:{uTime:{value:0},uInk:{value:S.horizon},uGold:{value:S.sky},uFogColor:{value:b},uFogAmt:{value:0},uFogCharm:Re}}));M.position.set(0,3,-8),d.add(M);let P=new w({vertexShader:Wt,fragmentShader:Gt,uniforms:{uHeight:{value:null},uScene:{value:j.texture},uTexel:{value:new N(1/256,1/256)},uResolution:{value:new N(l.x,l.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new ae},uLightDir:{value:S.sunDir},uInk:{value:new R(`#2A2218`)},uGold:{value:new R(`#B89968`)},uVector:Me,uVecWater:{value:new R(`#1fb8d8`)},uVecTint:{value:Ne}}}),oe=new p(new n(28,28,255,255),P);oe.rotation.x=-Math.PI/2,oe.updateMatrixWorld(!0),P.uniforms.uNormalMatrix.value.getNormalMatrix(oe.matrixWorld),d.add(oe);let F={value:0},ce=Pt({windowGlow:F}),I=rt({seed:r,profileIndex:i,landmarkFactory:ce,windowGlow:F});d.add(I.group);let le=ht({plinthTop:.3,extent:I.extent,profile:I.state.profile});d.add(le.group);let ue=St({extent:I.extent,waterSize:28,plinthTop:.3});d.add(ue.group),A.uniforms.uWakeDrops.value=ue.wakeDrops;let z=It({extent:I.extent});d.add(z.group),A.uniforms.uRainDrops.value=z.rainDrops;let B=Rt({extent:I.extent});d.add(B.group),I.group.remove(I.key),d.add(I.key),I.key.castShadow=!0,I.key.shadow.mapSize.set(2048,2048),I.key.shadow.bias=-18e-5,I.key.shadow.normalBias=.028,d.add(I.key.target);function de(){let e=I.key.shadow.camera,t=I.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),a.shadowMap.needsUpdate=!0}de();let V=new ee(l.x,l.y),fe=new L(l.x,l.y,{minFilter:h,magFilter:h,depthBuffer:!0,stencilBuffer:!1,depthTexture:V}),pe=new L(l.x,l.y,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),he=new L(l.x,l.y,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),ge=new L(l.x,l.y,{minFilter:h,magFilter:h,depthBuffer:!1,stencilBuffer:!1}),_e=new T,H=new f(-1,1,1,-1,0,1),ve=new p(new n(2,2));_e.add(ve);let ye=new w({vertexShader:Ht,fragmentShader:Kt,uniforms:{uScene:{value:fe.texture},uTime:{value:0},uResolution:{value:new N(l.x,l.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),be=e=>{let t=e.map(e=>new R(e));for(;t.length<8;)t.push(new R(0,0,0));return t},xe=[`night`,`dawn`,`noon`,`dusk`],Se={inkgold:xe.map(e=>be(tn[e])),terminal:xe.map(e=>be(nn[e]))},Ce=new w({vertexShader:Ht,fragmentShader:qt,uniforms:{uScene:{value:pe.texture},uResolution:{value:new N(l.x,l.y)},uPixelSize:{value:en},uPalette:{value:Se.inkgold[2]},uPaletteB:{value:Se.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),we=new w({vertexShader:Ht,fragmentShader:Xt,uniforms:{uScene:{value:pe.texture},uResolution:{value:new N(l.x,l.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:$t(Zt[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Te={};for(let e of Qt)Te[e]=Zt[e].palette?$t(Zt[e].palette):null;let Ee=new w({vertexShader:Ht,fragmentShader:Jt,uniforms:{uScene:{value:pe.texture},uDepth:{value:V},uResolution:{value:new N(l.x,l.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:S.toonFloor},uOutline:{value:S.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),De=new w({vertexShader:Ht,fragmentShader:Yt,uniforms:{uToon:{value:he.texture},uPixel:{value:ge.texture},uBlend:{value:0}}});function Oe(e,t){ve.material=e,a.setRenderTarget(t),a.render(_e,H)}function ke(){x.setViewport(window.innerWidth,window.innerHeight),a.setSize(window.innerWidth,window.innerHeight);let e=a.getDrawingBufferSize(new N);return j.setSize(e.x,e.y),fe.setSize(e.x,e.y),pe.setSize(e.x,e.y),he.setSize(e.x,e.y),ge.setSize(e.x,e.y),P.uniforms.uResolution.value.set(e.x,e.y),ye.uniforms.uResolution.value.set(e.x,e.y),Ce.uniforms.uResolution.value.set(e.x,e.y),we.uniforms.uResolution.value.set(e.x,e.y),Ee.uniforms.uResolution.value.set(e.x,e.y),e}let U=3,W=!1,Ae=!1,G=`native`,Be=.3,Ve=.46,He=[`native`,...Qt],Ue={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=U,window.__vector=W,window.__era=G);let We=0,Ge=performance.now(),K=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=K),K&&(a.info.autoReset=!1);let q=null;typeof window<`u`&&(window.__loaded=!1);let Ke=0,qe=new O(1,1,1),J=!1;function Je(e){let t=Ae?Se.terminal:Se.inkgold,n=e%1*4,r=Math.floor(n)%4;Ce.uniforms.uPalette.value=t[r],Ce.uniforms.uPaletteB.value=t[(r+1)%4],Ce.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Ye(e){let t=Zt[e];t&&(we.uniforms.uGridWidth.value=t.gridWidth,we.uniforms.uDither.value=t.dither,we.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(we.uniforms.uPalette.value=Te[e],we.uniforms.uPaletteSize.value=t.palette.length))}function Y(){G!==`native`&&Ye(G)}let Xe=()=>G===`native`?Ce:we;function Ze(e,t){oe.visible=!1,a.setRenderTarget(j),a.render(d,e),oe.visible=!0,a.setRenderTarget(t),a.render(d,e)}function Qe(e,t){if(oe.visible=!1,a.setRenderTarget(j),a.render(d,x.camera),oe.visible=!0,U===1||W&&U!==7&&U!==8)a.setRenderTarget(t),a.render(d,x.camera);else if(a.setRenderTarget(fe),a.render(d,x.camera),U===2)ye.uniforms.uGrain.value=1,ye.uniforms.uChroma.value=1,Oe(ye,t);else{ye.uniforms.uGrain.value=0,ye.uniforms.uChroma.value=0,Oe(ye,pe);let n=x.camera;Ee.uniforms.uNear.value=n.near,Ee.uniforms.uFar.value=n.far,Ee.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Ye(e.era),we):Xe();e.kind===`pixel`?(Oe(r,t),window.__style=`pixel`):e.kind===`toon`?(Oe(Ee,t),window.__style=`toon`):(Oe(Ee,he),Oe(r,ge),De.uniforms.uBlend.value=e.blend,Oe(De,t),window.__style=`blend`)}}function $e(){let e=et(),n=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return P.uniforms.uChromaScale.value=t.lerp(1,.5,n),e}function et(){if(U===1||U===2)return{kind:`none`};if(U===7)return{kind:`pixel`};if(U===8)return{kind:`toon`};let e=x.styleT;return window.__styleT=e,e<=Be?{kind:`toon`}:e>=Ve?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:t.smoothstep(e,Be,Ve),era:`16-bit`}}function tt(e){return U===1||U===2?``:W&&U!==7&&U!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Ue[e.era||G]||`Pixel`:e.kind===`blend`?`Toon → `+(Ue[e.era]||`Pixel`):``}function nt(e,n,{shadowsOn:r=!0,seasonTarget:i=0}={}){if(K){let e=a.info;q={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}M.material.uniforms.uTime.value=n,ye.uniforms.uTime.value=n,S.update(e),I.key.position.copy(S.sunDir).multiplyScalar(24),I.key.color.copy(S.sunColor),I.key.intensity=S.sunIntensity,I.fill.color.copy(S.hemiSky),I.fill.groundColor.copy(S.hemiGround),F.value=S.windowGlow;let o=z.overcast;I.key.intensity*=1-.5*o,I.key.color.lerp(g,.45*o),I.fill.intensity=1+.7*o;let s=t.smoothstep(S.sunDir.y,.06,.34),c=t.lerp(.28,1,1-S.windowGlow),l=r?s*c:0;I.key.shadow.intensity=.72*l,Pe.value=.52*l,(r&&!J||qe.distanceToSquared(S.sunDir)>2e-5)&&(a.shadowMap.needsUpdate=!0,qe.copy(S.sunDir)),J=r;let u=1-S.windowGlow;Ne.setRGB(t.lerp(.46,1,u),t.lerp(.52,1,u),t.lerp(.74,1,u)),ye.uniforms.uExposure.value=S.exposure,Ee.uniforms.uToonGain.value=S.toonGain,a.setClearColor(S.horizon,1),Je(S.t),window.__t=S.t,le.update(e,n,S),I.update(n),ue.update(e,n,S),A.uniforms.uWakeCount.value=ue.wakeCount,z.update(e,n),A.uniforms.uRainCount.value=z.rainDropCount;let f=z.fog*(1-u);d.fog.density=z.fog*_,b.copy(S.horizon).lerp(v,.85*f),d.fog.color.copy(b),a.setClearColor(b,1),Re.value=z.fog,M.material.uniforms.uFogAmt.value=.7*z.fog,Fe.value=z.snow,Ie.value=z.cloud*.55,Le.x+=e*.018,Le.y+=e*.009,ze.value+=(i-ze.value)*Math.min(1,e*1.5),B.update(e,n,S,z),We++;let p=performance.now();p-Ge>=1e3&&(window.__fps=We,K&&q&&(console.log(`[perf] ${We} fps · ~${(1e3/Math.max(1,We)).toFixed(2)} ms · calls ${q.calls} · tris ${q.tris} · programs ${q.programs} · geo ${q.geo} · tex ${q.tex}`),window.__perfInfo={fps:We,...q}),We=0,Ge=p);let[m,h,y]=E;if(A.uniforms.uPrev.value=m.texture,A.uniforms.uCurr.value=h.texture,a.setRenderTarget(y),a.render(D,te),E=[h,y,m],P.uniforms.uHeight.value=E[1].texture,Ke<2&&typeof document<`u`&&++Ke===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function it(e){U=e,window.__mode=U}function at(){return W=!W,Me.value=+!!W,window.__vector=W,W}function ot(e){return W=!!e,Me.value=+!!W,window.__vector=W,W}function st(){return G=He[(He.indexOf(G)+1)%He.length],window.__era=G,Y(),G}function X(){return Ae=!Ae,Ae}return{updateWorld:nt,decideStyle:$e,renderCityPipeline:Qe,renderCityBeautyTo:Ze,styleHintName:tt,setPostMode:it,toggleVector:at,setVector:ot,cycleEra:st,togglePalette:X,get mode(){return U},get vector(){return W},get sceneEra(){return G},renderer:a,drawBuffer:l,scene:d,rig:x,sunRig:S,SIM:256,targets:E,simScene:D,simCamera:te,simMaterial:A,grabRT:j,card:ie,backdrop:M,WATER_SIZE:28,water:oe,waterMaterial:P,windowGlow:F,landmarkFactory:ce,city:I,cityLife:le,waterLife:ue,weatherRig:z,clouds:B,fitShadowFrustum:de,SHADOW_DIST:24,sceneDepth:V,sceneRT:fe,filmicRT:pe,toonRT:he,pixelRT:ge,postScene:_e,postCamera:H,postQuad:ve,filmicMaterial:ye,pixelMaterial:Ce,pixelkitMaterial:we,toonMaterial:Ee,mixMaterial:De,PALCACHE:Se,ERA_TEX:Te,runPass:Oe,OVERCAST_GREY:g,FOG_DENSITY:_,FOG_NIGHT_TINT:v,_fogColor:b,resize:ke}}var an=`lgr_hints_`,on=!1;function sn(){if(on||typeof document>`u`)return;on=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var ln=null;function un(){if(ln)return ln;let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(0,0,0,0.60)`),n.addColorStop(.55,`rgba(0,0,0,0.32)`),n.addColorStop(1,`rgba(0,0,0,0.0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,Math.PI*2),t.fill(),ln=new k(e),ln.colorSpace=u,ln}function dn({w:e=.6,d:t=.6,x:r=0,y:i=.002,z:a=0,opacity:o=.5,rotation:s=0}={}){let c=new p(new n(e,t),new m({map:un(),transparent:!0,opacity:o,depthWrite:!1,toneMapped:!1}));return c.rotation.x=-Math.PI/2,c.rotation.z=s,c.position.set(r,i,a),c.renderOrder=-1,c.raycast=()=>{},c}function fn({yawLimit:e=80,pitchUp:t=32,pitchDown:n=20,sensitivity:r=.16,keySpeed:i=70,damp:a=9}={}){let o=Math.PI/180,s=(e,t,n)=>e<t?t:e>n?n:e,c=0,l=0,u=0,d=0;return{addDrag(i,a){u=s(u-i*r,-e,e),d=s(d-a*r,-n,t)},addKeys(r,{left:a,right:o,up:c,down:l}){let f=i*r;a&&(u=s(u+f,-e,e)),o&&(u=s(u-f,-e,e)),c&&(d=s(d+f,-n,t)),l&&(d=s(d-f,-n,t))},recenter(){u=0,d=0},update(e){let t=1-Math.exp(-a*e);c+=(u-c)*t,l+=(d-l)*t},get yaw(){return c*o},get pitch(){return l*o},get active(){return Math.abs(c)>.05||Math.abs(l)>.05}}}var pn=null;function mn(){if(pn)return pn;let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(256/2,256/2,256*.32,256/2,256/2,256*.72);return n.addColorStop(0,`rgba(0,0,0,0)`),n.addColorStop(1,`rgba(0,0,0,1)`),t.fillStyle=n,t.fillRect(0,0,256,256),pn=new k(e),pn.colorSpace=u,pn}function hn({strength:e=.55,dist:r=.5}={}){let i=new p(new n(1,1),new m({map:mn(),transparent:!0,opacity:e,depthTest:!1,depthWrite:!1,toneMapped:!1}));i.renderOrder=9999,i.raycast=()=>{},i.frustumCulled=!1;let a=new O;return i.fit=e=>{e.getWorldDirection(a),i.position.copy(e.position).addScaledVector(a,r),i.quaternion.copy(e.quaternion);let n=2*Math.tan(t.degToRad(e.fov)*.5)*r*1.05;i.scale.set(n*e.aspect,n,1)},i}var gn=``+new URL(`office-smooth-DEluvd7o.png`,import.meta.url).href,_n=``+new URL(`office-charm-D7t90SkH.png`,import.meta.url).href;function vn(){let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`);t.fillStyle=`#6e4a2c`,t.fillRect(0,0,256,256);for(let e=0;e<150;e++){let e=Math.random()*256,n=.7+Math.random()*.7;t.strokeStyle=`rgba(${Math.round(110*n)},${Math.round(74*n)},${Math.round(44*n)},${.16+Math.random()*.28})`,t.lineWidth=.5+Math.random()*1.6,t.beginPath(),t.moveTo(e,0);for(let n=0;n<=256;n+=14)t.lineTo(e+Math.sin(n*.05+e)*3,n);t.stroke()}t.strokeStyle=`rgba(30,18,8,0.5)`,t.lineWidth=2;for(let e of[256*.34,256*.67])t.beginPath(),t.moveTo(0,e),t.lineTo(256,e),t.stroke();let n=new k(e);return n.colorSpace=u,n.wrapS=n.wrapT=le,n}function Q(e,t,n,r,{rough:i=.62,metal:a=0,x:o=0,y:s=0,z:c=0,emissive:l=null,emissiveIntensity:u=1,map:d=null,mapRepeat:f=null}={}){let m=d;d&&f&&(m=d.clone(),m.needsUpdate=!0,m.wrapS=m.wrapT=le,m.repeat.set(f[0],f[1]));let h=new p(new D(e,t,n),new g({color:m?`#ffffff`:r,roughness:i,metalness:a,...m?{map:m}:{},...l?{emissive:l,emissiveIntensity:u}:{}}));return h.position.set(o,s,c),h}function yn({tier:i=`corner`,layout:a=`straight-on`}={}){let o=new T,s=new _e(43,1,.1,100),c=new O(0,1.62,4.35),l=new O(0,1.12,-1);s.position.copy(c),s.lookAt(l);let d=fn({yawLimit:80,pitchUp:34,pitchDown:20}),f=new ge(0,0,0,`YXZ`),h=new C,_=new r;o.add(_);let v=new r,y=new r,x=new r,w=new r,E=new r;_.add(v,y,x,w,E);let ee=[],te=`#4a3322`,k=`#3a2618`,ne=`#5b3d27`,re=`#6e4a30`,M=`#5a5650`,N=vn();v.add(Q(11,.2,11,`#3c2a1c`,{rough:.5,y:-.1,map:N,mapRepeat:[5,5]})),v.add(Q(11,.2,11,`#3a2a1d`,{rough:.9,y:3,map:N,mapRepeat:[4,4]}));for(let e of[-2.4,0,2.4])v.add(Q(.18,.16,7.4,k,{rough:.7,x:e,y:2.9,z:0,map:N,mapRepeat:[1,4]}));for(let e of[-2,.4])v.add(Q(7.4,.16,.18,k,{rough:.7,x:0,y:2.88,z:e,map:N,mapRepeat:[4,1]}));function ae(e){let t=new r;t.add(Q(.2,3.2,8,te,{rough:.7,x:e*3.6,y:1.5,z:0,map:N,mapRepeat:[3,1.4]}));let i=e*3.45;t.add(Q(.06,.22,8,k,{x:i,y:.13,z:0})),t.add(Q(.08,.16,8,k,{x:i,y:2.84,z:0})),t.add(Q(.05,.05,8,k,{x:i,y:1,z:0}));for(let e of[-2.6,-1.3,1.3,2.6])t.add(Q(.05,1.6,.06,k,{x:i,y:1.95,z:e}));for(let e of[-2.6,-1.3,1.3,2.6])t.add(Q(.05,.7,.06,k,{x:i,y:.6,z:e}));let a=new p(new n(1.5,1),new g({map:Dn(e),roughness:.8}));a.position.set(e*3.49,1.7,.4),a.rotation.y=-e*Math.PI/2,t.add(Q(.06,1.18,1.68,`#2a1c10`,{x:e*3.52,y:1.7,z:.4}),a);let o=new p(new n(1,1.3),new g({map:Dn(-e),roughness:.8}));o.position.set(e*3.49,1.78,-2),o.rotation.y=-e*Math.PI/2,t.add(Q(.06,1.46,1.16,`#2a1c10`,{x:e*3.52,y:1.78,z:-2}),o),t.add(Q(.12,.3,.16,`#2a1c10`,{x:e*3.4,y:2.2,z:2.2}));let s=new j(new V({map:En(),color:`#ffcf8a`,transparent:!0,opacity:.5,depthWrite:!1,blending:2}));return s.scale.set(.6,.75,1),s.position.set(e*3.32,2.34,2.2),s.raycast=()=>{},t.add(s),t}v.add(ae(-1),ae(1));let P=new r;P.add(Q(.3,1.9,1.5,ne,{rough:.5,y:.95}));for(let e of[.4,.95,1.5])P.add(Q(.3,.04,1.46,`#3a2c1e`,{y:e}));let oe=[`#7a3a2a`,`#2a4a6a`,`#b08a3a`,`#3a5a3a`,`#6a2a4a`,`#8a5a2a`];for(let e of[.6,1.15,1.7])for(let t=0;t<7;t++)P.add(Q(.18,.3,.11,oe[(t+Math.round(e))%oe.length],{x:.02,y:e-.06,z:-.6+t*.17}));P.position.set(-3.34,0,-1.9),v.add(P),v.add(dn({w:1,d:1.8,x:-3.2,y:.02,z:-1.9,opacity:.4}));let se=new r;se.add(Q(.5,.1,.5,`#4a3526`,{rough:.7,y:.45})),se.add(Q(.5,.55,.08,`#4a3526`,{rough:.7,y:.72,z:-.21}));for(let[e,t]of[[-.2,-.2],[.2,-.2],[-.2,.2],[.2,.2]])se.add(Q(.05,.45,.05,`#2a1c10`,{x:e,y:.22,z:t}));se.position.set(2.7,0,2.6),se.rotation.y=-.5,v.add(se),v.add(dn({w:.7,d:.7,x:2.7,y:.02,z:2.6,opacity:.42}));let I=new n(3,2.5),L=new n(3,2.5),le=new m({color:`#ffffff`,toneMapped:!1}),ue=new m({color:`#ffffff`,toneMapped:!1}),B=1.55,de=new p(I,le);de.position.set(-1.06,B,-2.64),de.rotation.y=Math.PI/4;let fe=new p(L,ue);fe.position.set(1.06,B,-2.64),fe.rotation.y=-Math.PI/4;let pe=new m({color:`#ffffff`,toneMapped:!1}),me=new p(new n(5.4,2.6),pe);me.position.set(0,B,-3.5500000000000003),me.visible=!1,x.add(de,fe,me);let he=new r;he.add(Q(.08,2.7,.08,k,{x:0,y:B,z:-2.2}));for(let[e,t,n]of[[-1.06,-2.64,Math.PI/4],[1.06,-2.64,-Math.PI/4]]){let i=new r;i.add(Q(3.05,.09,.09,k,{y:1.3})),i.add(Q(3.05,.09,.09,k,{y:-1.25})),i.add(Q(.09,2.6,.09,k,{x:-1.5})),i.position.set(e,B,t),i.rotation.y=n,he.add(i)}he.add(Q(5.4,.5,.3,ne,{x:0,y:.25,z:-2.1500000000000004})),v.add(he);let H=new r;H.add(Q(11,3.2,.2,te,{rough:.7,x:0,y:1.5,z:-3.75,map:N,mapRepeat:[4,1.4]})),H.add(Q(5.8,.14,.12,k,{x:0,y:2.9000000000000004,z:-3.5})),H.add(Q(5.8,.14,.12,k,{x:0,y:B-1.35,z:-3.5})),H.add(Q(.14,2.84,.12,k,{x:-2.8,y:B,z:-3.5})),H.add(Q(.14,2.84,.12,k,{x:2.8,y:B,z:-3.5})),H.add(Q(.09,2.6,.09,k,{x:0,y:B,z:-3.49})),H.add(Q(5.4,.5,.3,ne,{x:0,y:.25,z:-3.35}));let ve=new r;ve.add(Q(2.4,.9,.55,ne,{rough:.42,y:.45,z:0})),ve.add(Q(2.46,.06,.58,re,{rough:.3,y:.91,z:0}));for(let e of[-.62,0,.62])ve.add(Q(.66,.72,.03,`#4a3120`,{x:e,y:.45,z:.285}));for(let e of[-.62,0,.62])ve.add(Q(.05,.04,.05,`#caa15a`,{x:e+.2,y:.45,z:.31,metal:.6}));let ye=[`#7a3a2a`,`#2a4a6a`,`#b08a3a`,`#3a5a3a`];for(let e=0;e<4;e++)ve.add(Q(.1,.26+e%2*.05,.2,ye[e],{x:-.95+e*.13,y:1.07,z:-.06}));ve.add(Q(.04,.34,.42,`#241a12`,{x:.7,y:1.12,z:-.02})),ve.position.set(-3.9,0,-3.25),H.add(ve),H.add(dn({w:2.8,d:.95,x:-3.9,y:.02,z:-3.25,opacity:.45}));for(let[e,t]of[[-3.55,-1],[3.55,1]]){let i=new r,a=new p(new n(.78,.98),new g({map:Dn(t),roughness:.82}));a.position.z=.05,i.add(Q(.06,1.12,.92,`#241a10`,{}),a),i.position.set(e,1.45,-3.5700000000000003),H.add(i)}for(let e of[-3.55,3.55]){H.add(Q(.16,.32,.13,`#2a1c10`,{x:e,y:2.35,z:-3.5}));let t=new j(new V({map:En(),color:`#ffcf8a`,transparent:!0,opacity:.5,depthWrite:!1,blending:2}));t.scale.set(.55,.7,1),t.position.set(e,2.5,-3.42),t.raycast=()=>{},H.add(t)}H.visible=!1,v.add(H),v.add(Q(.4,.06,.4,`#1a130c`,{y:2.94,z:1.3}));let be=new p(new A(.16,20),new m({color:`#ffe6b0`,toneMapped:!1}));be.position.set(0,2.9,1.3),be.rotation.x=Math.PI/2,v.add(be);for(let[e,t]of[[-1.6,-1],[1.6,-1],[-1.6,-2.6],[1.6,-2.6],[0,-2.6]]){v.add(Q(.28,.05,.28,`#1a130c`,{y:2.95,x:e,z:t}));let n=new p(new A(.1,16),new m({color:`#ffe6b0`,toneMapped:!1}));n.position.set(e,2.915,t),n.rotation.x=Math.PI/2,n.raycast=()=>{},v.add(n)}v.add(xn(ee,{x:-3.46,y:2.15,z:.2,ry:Math.PI/2,face:`#efe2c8`,rim:`#2a1c10`})),v.add(Q(3.4,.03,2.4,`#3a1410`,{rough:.98,x:0,y:.012,z:1.95})),v.add(Q(3,.04,2,`#6e2a26`,{rough:.96,x:0,y:.02,z:1.95}));let xe=new r;xe.add(Q(.32,.32,.32,`#7a4a2a`,{rough:.8,y:.16}));for(let e=0;e<6;e++){let t=Q(.05,.55,.13,`#356a32`,{rough:.7,y:.32});t.geometry.translate(0,.27,0),t.rotation.z=(e/6-.5)*1.1,t.rotation.x=Math.sin(e*1.3)*.22,xe.add(t)}xe.position.set(2.7,0,.4),v.add(xe),v.add(dn({w:.7,d:.7,x:2.7,y:.03,z:.4,opacity:.45})),y.add(Q(11,.2,11,`#403d38`,{rough:.85,y:-.1})),y.add(Q(11,.2,11,`#1c1a17`,{rough:.95,y:2.8})),y.add(Q(7,3,.2,M,{rough:.92,x:0,y:1.4,z:-2.9})),y.add(Q(.2,3,6,M,{rough:.92,x:-3.2,y:1.4,z:-.2})),y.add(Q(.2,3,6,M,{rough:.92,x:3.2,y:1.4,z:-.2}));for(let e of[-1.6,-.4]){let t=new p(new ie(.07,.07,6,10),new g({color:`#6b6258`,roughness:.6,metalness:.4}));t.rotation.z=Math.PI/2,t.position.set(0,2.62,e),y.add(t)}let Se=new m({color:`#ffffff`,toneMapped:!1}),Ce=new p(new n(1.9,1.2),Se);Ce.position.set(0,1.5,-2.79),y.add(Ce),y.add(Q(2.06,1.36,.06,`#241a12`,{x:0,y:1.5,z:-2.83})),y.add(Q(.04,.34,.04,`#1a1410`,{x:-.1,y:2.45,z:-.4}));let we=new p(new A(.1,16),new m({color:`#ffdb8a`,toneMapped:!1}));we.position.set(-.1,2.26,-.4),we.rotation.x=Math.PI/2,y.add(we);let Te=new r;Te.add(Q(1.3,.05,.32,`#3a2c1e`,{x:0,y:0,z:0}));let Ee=[`#7a3a2a`,`#2a4a6a`,`#b08a3a`,`#3a5a3a`,`#6a2a4a`];for(let e=0;e<8;e++)Te.add(Q(.12,.34,.24,Ee[e%Ee.length],{x:-.55+e*.14,y:.2,z:0}));Te.position.set(-2.3,1.5,-2.66),y.add(Te);let De=new r;De.add(Q(.34,.34,.34,`#7a4a2a`,{y:.17}));let Oe=new r;for(let e=0;e<6;e++){let t=Q(.05,.5,.14,`#3a7a3a`,{rough:.7});t.geometry.translate(0,.25,0),t.rotation.z=(e/6-.5)*1.2,t.rotation.x=Math.sin(e)*.25,Oe.add(t)}Oe.position.y=.34,De.add(Oe),De.position.set(2.45,0,-1.4),y.add(De),y.add(xn(ee,{x:1.9,y:2.1,z:-2.78,ry:0,face:`#d8d2c4`,rim:`#1a130c`}));let ke=new r;ke.add(Q(3.4,.12,1.5,re,{rough:.32,y:.86,z:1.5,map:N,mapRepeat:[3,1.4]})),ke.add(Q(3.2,.78,1.36,ne,{y:.46,z:1.5,map:N,mapRepeat:[3,1]}));for(let e of[.66,.4,.14])ke.add(Q(.9,.2,.04,`#4a3120`,{x:1.05,y:e,z:2.2}));ke.add(Q(.12,.04,.04,`#caa15a`,{x:1.05,y:.66,z:2.23,metal:.6}));let U=new p(new ie(.05,.045,.1,16),new g({color:`#d8cbb4`,roughness:.6}));U.position.set(-.55,.97,1.95);let W=new p(new z(.035,.012,8,14),new g({color:`#d8cbb4`,roughness:.6}));W.position.set(-.61,.97,1.95),W.rotation.y=Math.PI/2,ke.add(U,W);let Ae=new j(new V({map:En(),color:`#fff4e0`,transparent:!0,opacity:0,depthWrite:!1,blending:2}));Ae.scale.set(.12,.18,1),Ae.position.set(-.55,1.05,1.95),Ae.raycast=()=>{},ke.add(Ae),ke.add(Q(.26,.03,.34,`#efe7d4`,{rough:.85,x:.5,y:.935,z:1.9})),_.add(ke);let je=new r;je.add(Q(.06,.5,.06,`#2a1c10`,{x:-1.15,y:1.15,z:1.6}));let Me=new p(new F(.22,.26,16,1,!0),new g({color:`#c2802e`,roughness:.5,side:2,emissive:`#3a2208`,emissiveIntensity:.6}));Me.position.set(-1.15,1.42,1.6),je.add(Me);let Ne=new S(`#ffb15a`,7,7,1.8);Ne.position.set(-1.15,1.34,1.6),je.add(Ne);let Pe=new j(new V({map:En(),color:`#ffcf8a`,transparent:!0,opacity:.55,depthWrite:!1,blending:2}));Pe.scale.set(.85,.85,1),Pe.position.set(-1.15,1.35,1.6),Pe.raycast=()=>{},je.add(Pe),_.add(je);let Fe=new r;Fe.add(Q(.62,.03,.42,`#1c1c20`,{y:.93,z:1.5,metal:.4,rough:.4}));let Ie=new p(new D(.62,.4,.025),new g({color:`#0a0c10`,emissive:`#2a4a6a`,emissiveIntensity:.7,roughness:.3}));Ie.position.set(0,1.14,1.31),Ie.rotation.x=-.32,Fe.add(Ie),Fe.userData.role=`laptop`,_.add(Fe);let Le=new r;Le.add(Q(.26,.07,.34,`#15151a`,{x:1,y:.93,z:1.5}));let Re=Q(.3,.06,.08,`#101015`,{x:1,y:1,z:1.34,emissive:`#234a6a`,emissiveIntensity:.4});Le.add(Re),Le.userData.role=`phone`,_.add(Le);let ze=new b(`#8a6a42`,`#1c130a`,.78);o.add(ze);let G=new e(`#ffd9a0`,9,9,.7,.5,1.2);G.position.set(0,2.95,1.3),G.target.position.set(0,.86,1.5),o.add(G,G.target);let Be=Sn(!1),Ve=Sn(!0),He=.62,Ue=1.32,We=1.22,Ge=1.78,K=new j(new V({map:Be,transparent:!0,depthWrite:!1}));K.scale.set(He,He,1),K.position.set(Ue,We,Ge),K.userData.role=`cat`,_.add(K);let q=new j(new V({map:wn(),transparent:!0,depthWrite:!1,opacity:0}));q.scale.set(.3,.3,1),q.raycast=()=>{},_.add(q);let Ke=0;function qe(){Ke=1.3}let J=.62,Je=.42,Ye=.34,Y=new r;Y.position.set(-.78,1.06,1.95),Y.add(Q(J,.05,Ye,`#3a3026`,{y:-.19}));let Xe=new p(new D(J-.04,Je-.08,Ye-.04),new g({color:`#1f9fc0`,transparent:!0,opacity:.26,roughness:.1,emissive:`#0a3a4a`,emissiveIntensity:.4,depthWrite:!1}));Xe.position.y=.02,Y.add(Xe);for(let e of[-1,1])for(let t of[-1,1])Y.add(Q(.03,Je,.03,`#20262c`,{x:e*(J/2-.015),z:t*(Ye/2-.015),metal:.5}));let Ze=new p(new D(J,Je,Ye),new m({visible:!1}));Ze.userData.role=`tank`,Y.add(Ze);let Qe=new S(`#5fd8ff`,0,3,2);Y.add(Qe);let $e=[Tn(`#e8a23c`),Tn(`#d85a6a`),Tn(`#6cc0e0`)],et=[],tt=Je/2-.12;for(let e=0;e<3;e++){let t=new j(new V({map:$e[e],transparent:!0,depthWrite:!1})),n=.15-e*.015;t.userData={sz:n,sp:.6+e*.22,ph:e*2.1,ax:.21*(.7+.1*e),ay:tt,az:.09000000000000001,prevx:0},t.scale.set(n,n,1),et.push(t),Y.add(t)}let nt=En(),rt=[];for(let e=0;e<5;e++){let t=new j(new V({map:nt,color:`#cfeffb`,transparent:!0,opacity:.5,depthWrite:!1}));t.userData={ph:e/5,sp:.16+Math.random()*.06,x:-.1+e%3*.07},t.scale.setScalar(.03+e%2*.015),t.raycast=()=>{},rt.push(t),Y.add(t)}let it=new j(new V({map:nt,color:`#c8a24a`,transparent:!0,opacity:0,depthWrite:!1}));it.scale.setScalar(.04),it.raycast=()=>{},Y.add(it);let at=0;function ot(){at=3,it.position.set(-.05,tt,0),it.material.opacity=1}_.add(Y);let st=new r;for(let e=0;e<8;e++){let t=new j(new V({map:nt,color:`#ffd9a0`,transparent:!0,opacity:0,depthWrite:!1,blending:2}));t.scale.setScalar(.018),t.userData={ph:e*.9,sp:.1+e%3*.04,r:.1+e%4*.03},t.raycast=()=>{},st.add(t)}st.position.set(-1.15,1.2,1.6),_.add(st);let X=new r,ct=.925;X.add(dn({w:4,d:2,x:0,y:.045,z:1.55,opacity:.5})),X.add(dn({w:.95,d:.62,x:0,y:ct,z:1.42,opacity:.42})),X.add(dn({w:.3,d:.3,x:-.55,y:ct,z:1.95,opacity:.4})),X.add(dn({w:.42,d:.46,x:.5,y:ct,z:1.9,opacity:.35})),X.add(dn({w:.42,d:.46,x:1,y:ct,z:1.5,opacity:.42})),X.add(dn({w:.7,d:.42,x:-.78,y:ct,z:1.95,opacity:.42})),X.add(dn({w:.55,d:.4,x:1.32,y:ct,z:1.78,opacity:.4})),X.add(dn({w:.34,d:.34,x:-1.15,y:ct,z:1.6,opacity:.35})),_.add(X),[ke,je,Fe,Le,K,Y,st,X].forEach(e=>w.add(e));function lt(e,t,n,r,i,a,o){let s=new p(new D(t,n,r),new m({visible:!1}));s.position.set(i,a,o),s.userData.role=e,E.add(s)}lt(`laptop`,.95,.6,.7,0,1.05,1.4),lt(`phone`,.5,.4,.5,1,.98,1.42),lt(`cat`,.62,.74,.5,Ue,We,Ge);let ut=bn(),dt={smooth:new ce().load(gn),charm:new ce().load(_n)};for(let e of[`smooth`,`charm`]){let t=dt[e];t.colorSpace=u,t.repeat.set(1,.86),t.offset.set(0,.14),t.needsUpdate=!0}let ft=new p(new n(1,1),new m({map:dt.smooth,toneMapped:!1}));ft.position.set(0,1.45,-5),ft.visible=!1,ft.raycast=()=>{},o.add(ft);let pt=hn({strength:.5});o.add(pt);let mt=`3d`,ht=`painted`;function gt(){let e=Dt===`corner`,t=mt!==`3d`,n=t&&ht===`painted`;v.visible=e&&!t,y.visible=!e&&!t,x.visible=t||e,ft.visible=t,w.visible=!n}function _t(e){return mt=e===`smooth`||e===`charm`?e:`3d`,mt!==`3d`&&(ft.material.map=dt[mt],ft.material.needsUpdate=!0),gt(),mt}function vt(e){return ht=e===`3d`?`3d`:`painted`,gt(),ht}let yt=Ne.intensity,bt=Ie.material.emissiveIntensity,xt=new R;function St(e,n,r){let i=r?r.windowGlow:0,a=i>.55;K.material.map=a?Ve:Be,Ke>0&&(Ke=Math.max(0,Ke-e));let o=Ke>0?Math.sin((1.3-Ke)/1.3*Math.PI):0,u=a?.012*Math.sin(n*1.2):.03*Math.sin(n*2.4);K.scale.set(He,He*(1+u+.12*o),1),K.position.y=We+.06*o,q.material.opacity=o,q.position.set(Ue,1.72+.5*(1-Ke/1.3),Ge),q.scale.setScalar(.22+.1*o),at>0&&(at=Math.max(0,at-e),it.position.y=Math.max(-.09,it.position.y-e*.06),it.material.opacity=at>.3?1:at/.3);for(let e of et){let t=e.userData,r=Math.sin(n*t.sp+t.ph)*t.ax,i=Math.sin(n*t.sp*.8+t.ph*1.7)*t.ay*.7,a=Math.cos(n*t.sp*.6+t.ph)*t.az,o=at>0?it.position.x:r,s=at>0?it.position.y:i,c=at>0?it.position.z:a,l=at>0?.05:.1;e.position.x+=(o-e.position.x)*l,e.position.y+=(s-e.position.y)*l,e.position.z+=(c-e.position.z)*l,e.scale.x=(e.position.x>=t.prevx?1:-1)*t.sz,t.prevx=e.position.x}for(let e of rt){let t=(n*e.userData.sp+e.userData.ph)%1;e.position.set(e.userData.x+Math.sin(n*2+e.userData.ph*9)*.015,-.09+2*tt*t,.02),e.material.opacity=.5*Math.sin(t*Math.PI)}Qe.intensity=2.6*i,Xe.material.emissiveIntensity=.4+.9*i,Ne.intensity=yt*(.97+.03*Math.sin(n*7)*Math.sin(n*2.3)),Ie.material.emissiveIntensity=bt*(.85+.15*Math.sin(n*3.1+1)),Re.material.emissiveIntensity=.4*(.65+.35*Math.sin(n*2.2)),xt.setRGB(1,.85,.62),st.children.forEach((e,t)=>{let r=e.userData,a=(n*r.sp+r.ph)%1;e.position.set(Math.cos(n*.5+r.ph*5)*r.r,-.15+a*.45,Math.sin(n*.4+r.ph*5)*r.r),e.material.opacity=(.1+.18*i)*Math.sin(a*Math.PI)});let p=n*.4%1;Ae.position.y=1.04+p*.22,Ae.position.x=-.55+Math.sin(n*1.5)*.02,Ae.material.opacity=.26*Math.sin(p*Math.PI),Ae.scale.set(.1+p*.08,.16+p*.12,1),Oe.rotation.z=Math.sin(n*.8)*.05,Oe.rotation.x=Math.sin(n*.6+1)*.04;let m=r?r.t%1:0;for(let e of ee)e.rotation.z=-m*Math.PI*2;if(ut.update(e),ft.visible){let e=s.position.z-ft.position.z,n=2*Math.tan(t.degToRad(s.fov)*.5)*e*1.18;ft.scale.set(n*s.aspect,n,1);let r=.55+.45*(1-i);ft.material.color.setRGB(r,r*.97,r*.92)}s.position.set(c.x+Math.sin(n*.5)*.04,c.y+Math.sin(n*.7)*.02,c.z),s.lookAt(l),d.update(e),f.set(d.pitch,d.yaw,0,`YXZ`),s.quaternion.multiply(h.setFromEuler(f)),pt.fit(s)}function Ct(e,t=e){le.map=e,ue.map=t,le.needsUpdate=!0,ue.needsUpdate=!0}function wt(e){pe.map=e,pe.needsUpdate=!0}let Tt=`corner`;function Z(e){Tt=e===`straight-on`?`straight-on`:`corner`;let t=Tt===`corner`;return de.visible=fe.visible=t,me.visible=!t,he.visible=t,H.visible=!t,Tt}function Et(e){Se.map=e,Se.needsUpdate=!0}let Dt=i;function Ot(e){Dt=e===`basement`?`basement`:`corner`;let t=Dt===`corner`;return gt(),G.intensity=t?9:3.2,ze.intensity=t?.78:.82,ze.color.set(t?`#6a5238`:`#7a5a34`),Dt}return Ot(Dt),Z(a),{scene:o,camera:s,update:St,setCityTexture:Ct,setStraightCityTexture:wt,setVignetteTexture:Et,setFitout:Ot,setSkin:_t,setProps:vt,setLayout:Z,petCat:qe,feedFish:ot,look:d,vignette:ut,get interactables(){return mt!==`3d`&&ht===`painted`?E.children:[Fe,Le,K,Ze]},get tier(){return Dt},get skin(){return mt},get props(){return ht},get layout(){return Tt}}}function bn(){let e=new T;e.background=new R(`#7fb0dd`);let r=new f(-1.4,1.4,.9,-.9,0,10);r.position.set(0,0,5);let i=(e,t={})=>new m({color:e,toneMapped:!1,...t}),a=(e,t,r,a,o,s,c)=>{let l=new p(new n(e,t),i(s,c));return l.position.set(r,a,o),l};e.add(a(3.2,.9,.5,-.95,1,`#2a4a30`)),e.add(a(3.2,.7,-.7,-1.05,2,`#1d3724`)),e.add(a(.06,.3,-.95,-.55,3,`#3a2a1a`));let o=new p(new A(.22,18),i(`#234a2a`));o.position.set(-.95,-.32,3),e.add(o),e.add(a(.04,.55,.9,-.55,3,`#20242a`));let s=new p(new A(.1,16),i(`#ffd98a`,{transparent:!0,opacity:0}));s.position.set(.9,-.26,3.1),e.add(s);let c=new p(new A(.16,24),i(`#fff4d8`));e.add(c);let l=[];for(let[t,n]of[[-1,.5],[-.6,.7],[.2,.6],[.7,.72],[1.05,.45],[-.2,.78],[.45,.4]]){let r=new p(new A(.015,8),i(`#ffffff`,{transparent:!0,opacity:0}));r.position.set(t,n,.5),l.push(r),e.add(r)}let u=new R(`#141d33`),d=new R(`#7fb6e0`),h=new R(`#d6824a`),g=new R(`#fff0cc`),_=new R(`#cdd8ef`),v=.34;function y(n){v=(v+n*.04)%1;let r=v*Math.PI*2,i=-Math.cos(r);c.position.set(Math.sin(r)*1.15,i*.66+.06,0);let a=t.smoothstep(i,-.18,.5),o=t.smoothstep(.32,0,Math.abs(i));e.background.copy(u).lerp(d,a).lerp(h,o*.45),c.material.color.copy(i>0?g:_),s.material.opacity=1-a;let f=(1-a)*.85;for(let e of l)e.material.opacity=f}return{scene:e,camera:r,update:y}}function xn(e,{x:t,y:i,z:a,ry:o=0,face:s=`#efe2c8`,rim:c=`#2a1c10`}){let l=new r,u=new p(new A(.2,28),new g({color:c,roughness:.6})),d=new p(new A(.17,28),new g({color:s,roughness:.7}));d.position.z=.01;let f=new p(new n(.018,.14),new g({color:`#1a130c`,roughness:.5}));return f.geometry.translate(0,.05,0),f.position.z=.02,e.push(f),l.add(u,d,f),l.position.set(t,i,a),l.rotation.y=o,l}function Sn(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=`#e08a3c`,i=`#b96a26`,a=`#3a2410`;if(n.lineJoin=`round`,e){n.fillStyle=r,n.beginPath(),n.ellipse(64,78,44,26,0,0,7),n.fill(),n.fillStyle=i,n.beginPath(),n.ellipse(64,86,44,16,0,0,7),n.fill(),n.fillStyle=r,n.beginPath(),n.arc(36,70,20,0,7),n.fill(),n.fillStyle=r,Cn(n,24,56,34,44,42,58),Cn(n,40,54,50,44,54,60),n.strokeStyle=i,n.lineWidth=7,n.lineCap=`round`,n.beginPath(),n.moveTo(100,70),n.quadraticCurveTo(112,90,88,96),n.stroke(),n.strokeStyle=a,n.lineWidth=2.5,n.beginPath(),n.arc(30,70,5,.1,Math.PI-.1),n.stroke(),n.strokeStyle=i,n.lineWidth=3;for(let e of[60,74,88])n.beginPath(),n.moveTo(e,58),n.lineTo(e,70),n.stroke()}else{n.fillStyle=r,n.beginPath(),n.ellipse(64,86,30,34,0,0,7),n.fill(),n.fillStyle=`#f3c98a`,n.beginPath(),n.ellipse(64,92,14,22,0,0,7),n.fill(),n.strokeStyle=i,n.lineWidth=8,n.lineCap=`round`,n.beginPath(),n.moveTo(92,100),n.quadraticCurveTo(116,86,104,60),n.stroke(),n.fillStyle=r,n.beginPath(),n.arc(64,48,24,0,7),n.fill(),n.fillStyle=r,Cn(n,44,34,50,18,60,34),Cn(n,84,34,78,18,68,34),n.fillStyle=`#f0b0c0`,Cn(n,47,30,50,22,56,32),Cn(n,81,30,78,22,72,32),n.fillStyle=a,n.beginPath(),n.arc(55,47,3.4,0,7),n.arc(73,47,3.4,0,7),n.fill(),n.fillStyle=`#e06a7a`,Cn(n,61,54,67,54,64,58),n.strokeStyle=a,n.lineWidth=1.6;for(let e of[-2,3])n.beginPath(),n.moveTo(50,55+e),n.lineTo(34,53+e),n.moveTo(78,55+e),n.lineTo(94,53+e),n.stroke();n.strokeStyle=i,n.lineWidth=3;for(let e of[78,90,102])n.beginPath(),n.moveTo(50,e),n.lineTo(78,e),n.stroke()}let o=new k(t);return o.colorSpace=u,o}function Cn(e,t,n,r,i,a,o){e.beginPath(),e.moveTo(t,n),e.lineTo(r,i),e.lineTo(a,o),e.closePath(),e.fill()}function wn(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`);t.fillStyle=`#ff5a8a`,t.beginPath(),t.moveTo(32,52),t.bezierCurveTo(6,32,14,10,32,24),t.bezierCurveTo(50,10,58,32,32,52),t.fill();let n=new k(e);return n.colorSpace=u,n}function Tn(e){let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);n.fillStyle=e,n.beginPath(),n.ellipse(30,32,18,11,0,0,7),n.fill(),n.beginPath(),n.moveTo(46,32),n.lineTo(60,22),n.lineTo(60,42),n.closePath(),n.fill(),n.fillStyle=`rgba(255,255,255,0.35)`,n.beginPath(),n.ellipse(28,36,12,5,0,0,7),n.fill(),n.fillStyle=`#15212a`,n.beginPath(),n.arc(20,30,2.6,0,7),n.fill();let r=new k(t);return r.colorSpace=u,r}function En(){let e=document.createElement(`canvas`);e.width=e.height=32;let t=e.getContext(`2d`),n=t.createRadialGradient(16,16,0,16,16,16);n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.6,`rgba(255,255,255,0.7)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(16,16,16,0,7),t.fill();let r=new k(e);return r.colorSpace=u,r}function Dn(e){let t=document.createElement(`canvas`);t.width=t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,256,256);e<0?(r.addColorStop(0,`#6a3b1c`),r.addColorStop(1,`#caa15a`)):(r.addColorStop(0,`#3a4a6a`),r.addColorStop(1,`#a86a3a`)),n.fillStyle=r,n.fillRect(0,0,256,256),n.globalAlpha=.5;for(let e=0;e<5;e++)n.fillStyle=e%2?`#2a1c10`:`#e0c080`,n.fillRect(30+e*36,40+e%3*30,26,150);let i=new k(t);return i.colorSpace=u,i}var{Timer:On}=ue,kn=new URLSearchParams(window.location.search),An=kn.get(`demo`)===`1`||kn.has(`capture`);window.__demo=An;var jn=(kn.get(`city`)?Number(kn.get(`city`)):0)||Math.random()*1e9|0,Mn=0,Nn=rn({demo:An,citySeed:jn,profileIndex:Mn}),{renderer:Pn,rig:Fn,sunRig:In,city:Ln,cityLife:Rn,waterMaterial:zn,fitShadowFrustum:Bn,landmarkFactory:Vn,renderCityBeautyTo:Hn}=Nn,$=yn({tier:`corner`});$.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix();var Un=!0;window.__shadows=Un,window.__scene=`office`;var Wn={minFilter:h,magFilter:h,depthBuffer:!0,stencilBuffer:!1},Gn=new O(2.2,3.4,11.5),Kn=new O(0,2,0).sub(Gn),qn=new O(0,1,0);function Jn(e){let n=new _e(58,384/320,.1,100);n.position.copy(Gn);let r=Kn.clone().applyAxisAngle(qn,t.degToRad(e));return n.lookAt(Gn.clone().add(r)),n}var Yn=Jn(45),Xn=Jn(-45),Zn=new L(384,320,Wn),Qn=new L(384,320,Wn);$.setCityTexture(Zn.texture,Qn.texture);var $n=new _e(52,540/320,.1,100);$n.position.copy(Gn),$n.lookAt(Gn.clone().add(Kn));var er=new L(540,320,Wn);$.setStraightCityTexture(er.texture);var tr=0,nr=3,rr=new L(512,320,{minFilter:h,magFilter:h,depthBuffer:!0,stencilBuffer:!1});$.setVignetteTexture(rr.texture);var ir=!1,ar=(()=>{if(typeof document>`u`)return{showLap(){},toast(){},flash(){}};let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.className=`lap`,t.innerHTML=`<div class="lap-win"><div class="lap-bar"><b>PORTFOLIO OS — John's Game</b>
    ...
    </div></div>`;let n=document.createElement(`div`);n.className=`otoast`;let r=document.createElement(`div`);r.className=`oflash`,document.body.append(t,n,r),t.querySelector(`.lap-x`).addEventListener(`click`,()=>sr()),t.addEventListener(`click`,e=>{e.target===t&&sr()}),t.addEventListener(`click`,e=>{e.target.closest(`button`)&&navigator.vibrate?.(10)});let i=0;return{showLap(e){t.classList.toggle(`on`,e)},toast(e){n.textContent=e,n.classList.add(`on`),clearTimeout(i),i=setTimeout(()=>n.classList.remove(`on`),1400)},flash(){r.style.transition=`none`,r.style.opacity=`0.85`,requestAnimationFrame(()=>{r.style.transition=`opacity .55s`,r.style.opacity=`0`})}}})();function or(){ir=!0,ar.showLap(!0)}function sr(){ir=!1,ar.showLap(!1)}function cr(){Mn=(Mn+1)%qe.length,ar.flash(),Ln.generate(jn,Mn),zn.uniforms.uVecWater.value.set(Ln.waterColor),Rn.setProfile(Ln.state.profile),Bn(),ar.toast(`✈  `+Ln.state.profile.name),window.__profile=Ln.state.profile.key}function lr(e){let t=$.setFitout(e);return ar.toast(t===`basement`?`🏚  Basement office`:`🏙  Corner office`),window.__tier=t,t}function ur(){return lr($.tier===`corner`?`basement`:`corner`)}window.__tier=$.tier;var dr=[`3d`,`smooth`,`charm`],fr={"3d":`🧊  Stylized 3D office`,smooth:`🖼  Smooth diffusion skin`,charm:`🕹  Charm diffusion skin`};function pr(e){let t=$.setSkin(e);return window.__officeSkin=t,ar.toast(fr[t]),t}function mr(){return pr(dr[(dr.indexOf($.skin)+1)%dr.length])}window.__officeSkin=$.skin;var hr={painted:`🎨  Painted props (cohesive)`,"3d":`🧊  Live 3D props (animated)`};function gr(e){let t=$.setProps(e);return window.__officeProps=t,$.skin!==`3d`&&ar.toast(hr[t]),t}function _r(){return gr($.props===`painted`?`3d`:`painted`)}window.__officeProps=$.props;var vr={corner:`🏙  Corner window`,"straight-on":`🖼  Straight-on window`};function yr(e){let t=$.setLayout(e);return window.__officeLayout=t,ar.toast(vr[t]),t}function br(){return yr($.layout===`corner`?`straight-on`:`corner`)}window.__officeLayout=$.layout;var xr=new d,Sr=new N,Cr=(e,t)=>{Sr.x=e/window.innerWidth*2-1,Sr.y=-(t/window.innerHeight)*2+1};function wr(){xr.setFromCamera(Sr,$.camera);let e=xr.intersectObjects($.interactables,!0)[0];if(!e)return null;let t=e.object;for(;t&&!t.userData.role;)t=t.parent;return t?t.userData.role:null}function Tr(e){e===`laptop`?or():e===`phone`?cr():e===`cat`?$.petCat():e===`tank`&&$.feedFish()}var Er=6,Dr=0,Or=0,kr=0,Ar=0,jr=0,Mr=!1,Nr=!1;Pn.domElement.style.cursor=`grab`,Pn.domElement.addEventListener(`mousedown`,e=>{Mr=!0,Nr=!1,Dr=Ar=e.clientX,Or=jr=e.clientY,kr=performance.now()}),window.addEventListener(`mousemove`,e=>{Mr?(!Nr&&Math.hypot(e.clientX-Dr,e.clientY-Or)>Er&&(Nr=!0),Nr&&($.look.addDrag(e.clientX-Ar,e.clientY-jr),Pn.domElement.style.cursor=`grabbing`),Ar=e.clientX,jr=e.clientY):(Cr(e.clientX,e.clientY),Pn.domElement.style.cursor=wr()?`pointer`:`grab`)}),window.addEventListener(`mouseup`,e=>{if(Mr&&!Nr&&!ir){Cr(e.clientX,e.clientY);let t=wr();t&&Tr(t)}Mr=!1,Nr=!1,Pn.domElement.style.cursor=`grab`});var Pr=!1;Pn.domElement.addEventListener(`touchstart`,e=>{e.touches.length===1&&(Dr=Ar=e.touches[0].clientX,Or=jr=e.touches[0].clientY,kr=performance.now(),Pr=!1)},{passive:!0}),Pn.domElement.addEventListener(`touchmove`,e=>{if(e.touches.length!==1)return;let t=e.touches[0].clientX,n=e.touches[0].clientY;!Pr&&Math.hypot(t-Dr,n-Or)>8&&(Pr=!0),Pr&&$.look.addDrag(t-Ar,n-jr),Ar=t,jr=n},{passive:!0}),window.addEventListener(`touchend`,e=>{if(!Pr&&performance.now()-kr<350&&(!e.touches||e.touches.length===0)&&!ir){let e=wr();e&&Tr(e)}Pr=!1});var Fr={left:!1,right:!1,up:!1,down:!1},Ir={ArrowLeft:`left`,ArrowRight:`right`,ArrowUp:`up`,ArrowDown:`down`};window.addEventListener(`keydown`,e=>{if(Ir[e.key]){Fr[Ir[e.key]]=!0,e.preventDefault();return}e.key===`Escape`&&(ir?sr():$.look.recenter()),(e.key===`f`||e.key===`F`)&&ur(),(e.key===`j`||e.key===`J`)&&mr(),(e.key===`u`||e.key===`U`)&&_r(),(e.key===`t`||e.key===`T`)&&In.cyclePreset(),(e.key===`h`||e.key===`H`)&&(Un=!Un,window.__shadows=Un),(e.key===`w`||e.key===`W`)&&br()}),window.addEventListener(`keyup`,e=>{Ir[e.key]&&(Fr[Ir[e.key]]=!1)}),Vn.whenReady.then(()=>{Ln.generate(jn,Mn),Bn(),window.__cityReady=!0}),kn.get(`office`)===`basement`&&lr(`basement`);var Lr=kn.get(`officeskin`);[`3d`,`smooth`,`charm`].includes(Lr)&&pr(Lr);var Rr=kn.get(`officeprops`);[`painted`,`3d`].includes(Rr)&&gr(Rr);var zr=kn.get(`officelayout`);[`corner`,`straight-on`].includes(zr)&&yr(zr);var Br=new On;Br.connect(document);function Vr(){Br.update();let e=Math.min(Br.getDelta(),.1);Fn.update(e),Nn.updateWorld(e,Br.getElapsed(),{shadowsOn:Un,seasonTarget:0}),$.look.addKeys(e,Fr),$.update(e,Br.getElapsed(),In),window.__lookYaw=$.look.yaw,window.__lookPitch=$.look.pitch,$.tier===`basement`?(Pn.setRenderTarget(rr),Pn.render($.vignette.scene,$.vignette.camera)):tr%nr===0&&($.layout===`straight-on`?Hn($n,er):(Hn(Yn,Zn),Hn(Xn,Qn))),tr++,Pn.setRenderTarget(null),Pn.render($.scene,$.camera),requestAnimationFrame(Vr)}Vr(),cn({key:`office`,title:`The Office`,tips:[`Drag to look around the office (or use the arrow keys)`,`Click / tap the LAPTOP to open the game panel`,`Tap the PHONE to travel to another city · pet the CAT · feed the FISH`,`Esc exits · F fitout · J skin · U props · W window · T time`]}),window.addEventListener(`resize`,()=>{Nn.resize(),$.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix()});