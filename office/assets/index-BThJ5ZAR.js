...
#include <shadowmask_pars_fragment>`)}var Qe=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function $e(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new I(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{Je(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new I(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=Xe(e.vertexShader),e.fragmentShader=Ye(Ze(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function K(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{Je(e),s||(e.uniforms.uVecColor={value:new I(t)}),c&&(e.uniforms.uGlow={value:new I(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=Ke),e.vertexShader=Xe(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
}`,Fn={realistic:0,charm:0,pixel:2,vector:1},In={realistic:1,charm:1,pixel:1.9,vector:1.2};function Ln({seed:e=1517,count:t=340,spreadX:n=21,yLo:i=3,yHi:o=18,zBase:s=7.2}={}){let c=new a;c.raycast=()=>{};let l=et(e>>>0),u=new Float32Array(t*3),d=new Float32Array(t),f=new Float32Array(t),p=new Float32Array(t),h=[];for(let e=0;e<t;e++){let t=(l()*2-1)*n,r=i+l()*(o-i),a=-s-l()*.7;u[e*3]=t,u[e*3+1]=r,u[e*3+2]=a;let c=.35+l()*.65;f[e]=c,d[e]=1.6+l()*2.8+(c>.85?2.2:0),p[e]=l()*Math.PI*2,c>.82&&h.push([t,r,a])}let _=new ae;_.setAttribute(`position`,new A(u,3)),_.setAttribute(`aSize`,new A(d,1)),_.setAttribute(`aBright`,new A(f,1)),_.setAttribute(`aPhase`,new A(p,1));let v=new L({vertexShader:Nn,fragmentShader:Pn,uniforms:{uTime:{value:0},uTwinkle:{value:1},uSizeScale:{value:1},uColor:{value:new I(`#eaf0ff`)},uNight:{value:0},uMode:{value:0}},transparent:!0,depthWrite:!1,blending:2,fog:!1,toneMapped:!1}),y=new w(_,v);y.raycast=()=>{},y.frustumCulled=!1,c.add(y);let b=[];if(h.length>6)for(let e=0;e<3;e++){let e=Math.floor(l()*h.length);for(let t=0;t<3;t++){let t=h[e],n=h[(e+1+Math.floor(l()*2))%h.length];b.push(t[0],t[1],t[2],n[0],n[1],n[2]),e=(e+1)%h.length}}let x=[[[0,2],[0,0]],[[0,0],[.7,0]],[[2.1,2],[1.4,2]],[[1.4,2],[1.4,0]],[[1.4,0],[2.1,0]],[[2.1,0],[2.1,1]],[[2.1,1],[1.7,1]],[[2.8,0],[2.8,2]],[[2.8,2],[3.5,2]],[[3.5,2],[3.5,1]],[[3.5,1],[2.8,1]],[[2.8,1],[3.6,0]]],S=-s-.4,C=.62;for(let[[e,t],[n,r]]of x)b.push(-3+e*C,12+t*C,S,-3+n*C,12+r*C,S);let T=new ae;T.setAttribute(`position`,new r(b,3));let E=new g(T,new m({color:`#9fb6e8`,transparent:!0,opacity:0,depthWrite:!1,fog:!1,toneMapped:!1}));E.raycast=()=>{},E.frustumCulled=!1,c.add(E);let D=new j(new z({map:Rn(),transparent:!0,opacity:0,depthWrite:!1,blending:2,fog:!1,toneMapped:!1}));D.raycast=()=>{},D.scale.set(n*2.4,n*.95,1),D.position.set(2,12,-s-.7),D.material.rotation=-.5,D.renderOrder=-3,c.add(D);let O=-1;function k(e,t=`realistic`,n=0,r=!1){v.uniforms.uTime.value=n,v.uniforms.uTwinkle.value=+!r,v.uniforms.uNight.value=e;let i=Fn[t]??0;i!==O&&(v.uniforms.uMode.value=i,O=i),v.uniforms.uSizeScale.value=In[t]??1,E.material.opacity=e*.5,D.material.opacity=e*.32,c.visible=e>.001}return{group:c,update:k}}function Rn(){let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(256/2,256/2,0,256/2,256/2,256/2);n.addColorStop(0,`rgba(150,170,230,0.5)`),n.addColorStop(.4,`rgba(120,130,200,0.22)`),n.addColorStop(1,`rgba(90,100,160,0)`),t.fillStyle=n,t.fillRect(0,0,256,256);let r=et(20145);for(let e=0;e<7;e++){let e=40+r()*176,n=70+r()*116,i=14+r()*30,a=t.createRadialGradient(e,n,0,e,n,i);a.addColorStop(0,`rgba(200,210,255,0.18)`),a.addColorStop(1,`rgba(200,210,255,0)`),t.fillStyle=a,t.beginPath(),t.arc(e,n,i,0,Math.PI*2),t.fill()}let i=new U(e);return i.colorSpace=ce,i}var zn=Math.PI*2;function Bn(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=n.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return r.addColorStop(0,`#ffffff`),r.addColorStop(.34,`#fffaf0`),r.addColorStop(.66,e),r.addColorStop(.86,e),r.addColorStop(1,`rgba(255,255,255,0)`),n.fillStyle=r,n.beginPath(),n.arc(128/2,128/2,128/2,0,zn),n.fill(),qn(t,!0)}function Vn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);n.addColorStop(0,`#ffffff`),n.addColorStop(.4,`#eef3ff`),n.addColorStop(.82,`#c4cee6`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,zn),t.fill(),t.globalAlpha=.14,t.fillStyle=`#8b97b4`;for(let[e,n,r]of[[54,50,9],[78,66,7],[60,82,5]])t.beginPath(),t.arc(e,n,r,0,zn),t.fill();return qn(e,!0)}function Hn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`);t.translate(128/2,128/2),t.fillStyle=`rgba(255,210,120,0.9)`;for(let e=0;e<12;e++)t.rotate(zn/12),t.beginPath(),t.moveTo(0,-28),t.lineTo(7,-54),t.lineTo(-7,-54),t.closePath(),t.fill();let n=t.createRadialGradient(0,0,0,0,0,32);return n.addColorStop(0,`#ffffff`),n.addColorStop(.4,`#fff1c8`),n.addColorStop(.8,`#ffb24a`),n.addColorStop(1,`#ff8a2a`),t.fillStyle=n,t.beginPath(),t.arc(0,0,32,0,zn),t.fill(),qn(e,!0)}function Un(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,46);n.addColorStop(0,`#ffffff`),n.addColorStop(.5,`#e6ecfb`),n.addColorStop(1,`#c2cce4`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,46,0,zn),t.fill(),t.fillStyle=`#aab6d2`;for(let[e,n,r]of[[52,48,11],[80,62,8],[58,82,7],[40,66,5]])t.beginPath(),t.arc(e,n,r,0,zn),t.fill();return qn(e,!0)}function Wn(e,t,n){let r=document.createElement(`canvas`);r.width=r.height=144;let i=r.getContext(`2d`),a=17/2,o=18/2-.5;for(let r=0;r<18;r++)for(let s=0;s<18;s++){let c=Math.hypot(s-a,r-a);c>o||(i.fillStyle=c<o*.45?e:c<o*.78?t:n,i.fillRect(Math.round(s*8),Math.round(r*8),8,8))}return qn(r,!1)}function Gn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(255,255,255,0.9)`),n.addColorStop(.38,`rgba(255,255,255,0.3)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,zn),t.fill(),qn(e,!0)}function Kn(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2),r=`20,30,48`;return n.addColorStop(0,`rgba(${r},0)`),n.addColorStop(.42,`rgba(${r},0)`),n.addColorStop(.6,`rgba(${r},0.6)`),n.addColorStop(1,`rgba(${r},0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,zn),t.fill(),qn(e,!0)}function qn(e,t){let n=new U(e);return n.colorSpace=ce,t||(n.magFilter=x,n.minFilter=x),n}var Jn=(e,t,n)=>{let r=Math.max(0,Math.min(1,(e-t)/(n-t)));return r*r*(3-2*r)};function Yn({skyW:e=15,skyY0:t=3.4,skyH:n=3.8,z:r=-7.8,biasX:i=4.5,sunSize:o=4.6,moonSize:s=4}={}){let c=new a;c.raycast=()=>{};let l=(e,t)=>{let n=new j(new z({map:e,transparent:!0,depthWrite:!1,fog:!1,toneMapped:!1,...t?{blending:2}:{}}));return n.raycast=()=>{},n},u={realistic:Bn(`#ffcf8a`),charm:Hn(),pixel:Wn(`#fff6e0`,`#ffc24a`,`#ff8a2a`)},d={realistic:Vn(),charm:Un(),pixel:Wn(`#ffffff`,`#cdd6ee`,`#9aa6c6`)},f=Gn(),p=l(Kn(),!1),m=l(f,!0),h=l(u.realistic),g=l(f,!0),_=l(d.realistic);p.renderOrder=-2,m.renderOrder=-1,c.add(p,m,h,g,_);let v=Ln({});v.group.renderOrder=-4,c.add(v.group);let y=typeof window<`u`&&window.matchMedia?window.matchMedia(`(prefers-reduced-motion: reduce)`):null,b={realistic:{sunGlow:3,sunGlowOp:.7,moonGlow:2.6,moonGlowOp:.5,sizeMul:1,sunHaloOp:.85},charm:{sunGlow:2.2,sunGlowOp:.55,moonGlow:2.1,moonGlowOp:.42,sizeMul:1.08,sunHaloOp:.7},pixel:{sunGlow:1.7,sunGlowOp:.4,moonGlow:1.7,moonGlowOp:.32,sizeMul:1,sunHaloOp:.6}},x=`realistic`;function S(e){e===x||!b[e]||(x=e,h.material.map=u[e],h.material.needsUpdate=!0,_.material.map=d[e],_.material.needsUpdate=!0)}new I;let C=new I(`#fff3df`),w=new I(`#ffb060`),T=new I(`#ff6a2a`),E=new I(`#eef2ff`),D=new I(`#9fbcff`);function O(a,c,l,u,d=`realistic`){S(d);let f=b[x],O=l.sunArc,k=u?Math.min(1,(u.cloud||0)*.85+(u.fog||0)*.7):0,ee=O.y,A=Jn(ee,-.04,.1)*(1-.7*k),j=1-Jn(Math.abs(ee),.02,.5);h.position.set(O.x*e+i,t+O.y*n,r),m.position.copy(h.position);let M=o*f.sizeMul*(1+.55*j);h.scale.setScalar(M),m.scale.setScalar(M*f.sunGlow),h.material.color.copy(C),m.material.color.copy(w).lerp(T,j),h.material.opacity=A,m.material.opacity=A*f.sunGlowOp*(.7+.5*j),p.position.copy(h.position),p.scale.setScalar(M*1.7),p.material.opacity=A*(1-j)*f.sunHaloOp;let te=Jn(-O.y,-.04,.1)*(1-.65*k);_.position.set(-O.x*e+i,t+-O.y*n,r),g.position.copy(_.position);let N=s*f.sizeMul;_.scale.setScalar(N),g.scale.setScalar(N*f.moonGlow),_.material.color.copy(E),g.material.color.copy(D),_.material.opacity=te,g.material.opacity=te*f.moonGlowOp;let P=Jn(-O.y,-.05,.18)*(1-.85*k);v.update(P,d,c,!!(y&&y.matches))}return{group:c,update:O}}var Xn=`varying vec2 vUv;
...
}`,nr=`const float CA_STRENGTH   = 0.0030;  
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,lr={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},ur=[`gb`,`8-bit`,`16-bit`,`modern`];function dr(t){let n=Math.max(t.length,1),r=new Float32Array(n*4);t.forEach((e,t)=>{let n=new I(e);r[t*4+0]=n.r,r[t*4+1]=n.g,r[t*4+2]=n.b,r[t*4+3]=1});let i=new W(r,n,1,e,ye);return i.minFilter=x,i.magFilter=x,i.needsUpdate=!0,i}var fr=220,pr={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},mr={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function hr({demo:t=!1,citySeed:r=0,profileIndex:a=0}={}){let l=new re({antialias:!0,preserveDrawingBuffer:!0});l.shadowMap.enabled=!0,l.shadowMap.type=1,l.shadowMap.autoUpdate=!1,l.shadowMap.needsUpdate=!0;let d=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);l.setPixelRatio(Math.min(window.devicePixelRatio,d?1.5:2)),l.setSize(window.innerWidth,window.innerHeight),l.setClearColor(920327,1),document.body.appendChild(l.domElement);let p=l.getDrawingBufferSize(new F),m=new me;m.fog=new b(10465470,0);let h=new I(`#aeb6c0`),g=.062,_=new I(`#74508f`),y=new I,C=Re({aspect:window.innerWidth/window.innerHeight}),w=vt({t:.5}),T={type:i,format:e,minFilter:x,magFilter:x,wrapS:oe,wrapT:oe,depthBuffer:!1,stencilBuffer:!1},E=[new B(256,256,T),new B(256,256,T),new B(256,256,T)];for(let e of E)l.setRenderTarget(e),l.clear();l.setRenderTarget(null);let D=new me,O=new s(-1,1,1,-1,0,1),k=new L({vertexShader:Qn,fragmentShader:$n,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new F(1/256,1/256)},uMouse:{value:new F(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new V)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new V)}}});D.add(new n(new u(2,2),k));let ee=new B(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1});function A(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new U(t);return r.colorSpace=ce,r}let j=new n(new u(28,28),new S({map:A(t)}));j.rotation.x=-Math.PI/2,j.position.y=-.35,m.add(j);let M=new n(new u(40,24),new L({depthWrite:!1,vertexShader:Xn,fragmentShader:Zn,uniforms:{uTime:{value:0},uInk:{value:w.horizon},uGold:{value:w.sky},uFogColor:{value:y},uFogAmt:{value:0},uFogCharm:Ge}}));M.position.set(0,3,-8),m.add(M);let te=new L({vertexShader:er,fragmentShader:tr,uniforms:{uHeight:{value:null},uScene:{value:ee.texture},uTexel:{value:new F(1/256,1/256)},uResolution:{value:new F(p.x,p.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new v},uLightDir:{value:w.sunDir},uInk:{value:new I(`#2A2218`)},uGold:{value:new I(`#B89968`)},uVector:ze,uVecWater:{value:new I(`#1fb8d8`)},uVecTint:{value:Be}}}),N=new n(new u(28,28,255,255),te);N.rotation.x=-Math.PI/2,N.updateMatrixWorld(!0),te.uniforms.uNormalMatrix.value.getNormalMatrix(N.matrixWorld),m.add(N);let P={value:0},ne=Kt({windowGlow:P}),R=ft({seed:r,profileIndex:a,landmarkFactory:ne,windowGlow:P});m.add(R.group);let ie=Ct({plinthTop:.3,extent:R.extent,profile:R.state.profile});m.add(ie.group);let ae=Pt({extent:R.extent,waterSize:28,plinthTop:.3});m.add(ae.group),k.uniforms.uWakeDrops.value=ae.wakeDrops;let z=Jt({extent:R.extent});m.add(z.group),k.uniforms.uRainDrops.value=z.rainDrops;let se=Xt({extent:R.extent});m.add(se.group);let le=$t({rig:C,getCamera:()=>C.camera,sources:[ie,ae,se]}),ue=Yn();m.add(ue.group);let de=Mn({scale:90});m.add(de.mesh),m.environmentIntensity=.32;let fe=!1;function pe(e){let t=e&&w.sunArc.y>-.04;t!==fe&&(fe=t,de.mesh.visible=t,M.visible=!t)}let H=null,he=-1;function ge(){let e=Math.floor(w.t%1*4)%4;return(e!==he||!H)&&(he=e,H=de.buildEnv(l)),H}let _e=null,ve=null,W=null,ye=null,be=!1,Se=1234,Ce=`valley`,we=on.map(e=>e.key),Te=new c({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Ee=()=>[R.group,ie.group,ae.group],De=()=>[_e,ve,W].filter(Boolean);function Oe(){for(let e of De())m.remove(e),e.userData.dispose?.();let e=dn({seed:Se,size:160,preset:Ce});ye=e,_e=vn(e,{worldSize:26,baseY:0,chunks:6}),ve=On({terrain:e,seed:Se,worldSize:26,baseY:0,biomeKeys:we}),W=jn(e,{worldSize:26,baseY:0,maxLakes:3,material:Te});for(let e of De())e.visible=be,m.add(e);typeof window<`u`&&(window.__world={seed:Se,preset:Ce,active:be,chunks:_e.children.length,scatter:ve.userData.counts,lakes:W.userData.count})}let ke=e=>{for(let t of De())t.visible=e},Ae=null,je=new Set;function Me(){!ye||!W||(m.remove(W),W.userData.dispose?.(),W=jn(ye,{worldSize:26,baseY:0,maxLakes:3,material:Te}),W.visible=be,m.add(W),window.__world&&(window.__world.lakes=W.userData.count))}function Ne(e,t,n=1,r=2.2,i=.05){if(!ye||!_e)return;let a=ye.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=ye.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}je.clear();for(let e of _e.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&je.add(e)}yn(_e,ye,je),Ae&&clearTimeout(Ae),Ae=setTimeout(Me,140)}let Pe={enter(){_e||Oe(),be=!0,ke(!0);for(let e of Ee())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){be=!1,ke(!1);for(let e of Ee())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return Se=Math.random()*1e9|0,Oe(),Pe.enter(),Se},setPreset(e){return un.includes(e)&&(Ce=e,Oe(),Pe.enter()),Ce},sculpt:Ne,repoolWater:Me,get terrainGroup(){return _e},get active(){return be},get seed(){return Se},get preset(){return Ce},get presets(){return un}};R.group.remove(R.key),m.add(R.key),R.key.castShadow=!0,R.key.shadow.mapSize.set(2048,2048),R.key.shadow.bias=-18e-5,R.key.shadow.normalBias=.028,m.add(R.key.target);function Fe(){let e=R.key.shadow.camera,t=R.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),l.shadowMap.needsUpdate=!0}Fe();let Ie=new xe(p.x,p.y),G=new B(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1,depthTexture:Ie}),Le=new B(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),qe=new B(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Je=new B(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Ye=Math.max(1,Math.floor(p.x/2)),Xe=Math.max(1,Math.floor(p.y/2)),Ze=new B(Ye,Xe,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Qe=new B(Ye,Xe,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),$e=new me,K=new s(-1,1,1,-1,0,1),et=new n(new u(2,2));$e.add(et);let q=new L({vertexShader:Qn,fragmentShader:nr,uniforms:{uScene:{value:G.texture},uTime:{value:0},uResolution:{value:new F(p.x,p.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:Ze.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:w.grade.tint},uGradeLift:{value:w.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1}}}),tt=new L({vertexShader:Qn,fragmentShader:or,uniforms:{uScene:{value:G.texture},uThreshold:{value:.78}}}),J=new L({vertexShader:Qn,fragmentShader:sr,uniforms:{uScene:{value:Ze.texture},uDir:{value:new F}}});function nt(e){tt.uniforms.uScene.value=e.texture,dt(tt,Ze),J.uniforms.uScene.value=Ze.texture,J.uniforms.uDir.value.set(1.6/Ye,0),dt(J,Qe),J.uniforms.uScene.value=Qe.texture,J.uniforms.uDir.value.set(0,1.6/Xe),dt(J,Ze),q.uniforms.uBloom.value=Ze.texture;let t=1-f.clamp(w.sunArc.y*2.2,0,1);q.uniforms.uBloomStrength.value=.85*(.32+.95*t)}let rt=e=>{let t=e.map(e=>new I(e));for(;t.length<8;)t.push(new I(0,0,0));return t},it=[`night`,`dawn`,`noon`,`dusk`],at={inkgold:it.map(e=>rt(pr[e])),terminal:it.map(e=>rt(mr[e]))},ot=new L({vertexShader:Qn,fragmentShader:rr,uniforms:{uScene:{value:Le.texture},uResolution:{value:new F(p.x,p.y)},uPixelSize:{value:fr},uPalette:{value:at.inkgold[2]},uPaletteB:{value:at.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),st=new L({vertexShader:Qn,fragmentShader:cr,uniforms:{uScene:{value:Le.texture},uResolution:{value:new F(p.x,p.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:dr(lr[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),ct={};for(let e of ur)ct[e]=lr[e].palette?dr(lr[e].palette):null;let lt=new L({vertexShader:Qn,fragmentShader:ir,uniforms:{uScene:{value:Le.texture},uDepth:{value:Ie},uResolution:{value:new F(p.x,p.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:w.toonFloor},uOutline:{value:w.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),ut=new L({vertexShader:Qn,fragmentShader:ar,uniforms:{uToon:{value:qe.texture},uPixel:{value:Je.texture},uBlend:{value:0}}});function dt(e,t){et.material=e,l.setRenderTarget(t),l.render($e,K)}function pt(){C.setViewport(window.innerWidth,window.innerHeight),l.setSize(window.innerWidth,window.innerHeight);let e=l.getDrawingBufferSize(new F);return ee.setSize(e.x,e.y),G.setSize(e.x,e.y),Le.setSize(e.x,e.y),qe.setSize(e.x,e.y),Je.setSize(e.x,e.y),Ye=Math.max(1,e.x>>1),Xe=Math.max(1,e.y>>1),Ze.setSize(Ye,Xe),Qe.setSize(Ye,Xe),te.uniforms.uResolution.value.set(e.x,e.y),q.uniforms.uResolution.value.set(e.x,e.y),ot.uniforms.uResolution.value.set(e.x,e.y),st.uniforms.uResolution.value.set(e.x,e.y),lt.uniforms.uResolution.value.set(e.x,e.y),e}let Y=3,mt=!1,ht=!1,X=`native`,gt=.3,_t=.46,yt=[`native`,...ur],bt={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=Y,window.__vector=mt,window.__era=X);let xt=0,St=performance.now(),wt=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=wt),wt&&(l.info.autoReset=!1);let Tt=null;typeof window<`u`&&(window.__loaded=!1);let Et=0,Dt=new V(1,1,1),Ot=!1;function kt(e){let t=ht?at.terminal:at.inkgold,n=e%1*4,r=Math.floor(n)%4;ot.uniforms.uPalette.value=t[r],ot.uniforms.uPaletteB.value=t[(r+1)%4],ot.uniforms.uPaletteBlend.value=n-Math.floor(n)}function At(e){let t=lr[e];t&&(st.uniforms.uGridWidth.value=t.gridWidth,st.uniforms.uDither.value=t.dither,st.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(st.uniforms.uPalette.value=ct[e],st.uniforms.uPaletteSize.value=t.palette.length))}function jt(){X!==`native`&&At(X)}let Mt=()=>X===`native`?ot:st;function Nt(e,t){pe(!0),m.environment=ge(),N.visible=!1,l.setRenderTarget(ee),l.render(m,e),N.visible=!0,l.setRenderTarget(G),l.render(m,e),nt(G),q.uniforms.uAces.value=1,q.uniforms.uGrade.value=1,q.uniforms.uGrain.value=0,q.uniforms.uChroma.value=0,dt(q,t)}function Ft(e,t){let n=!mt&&(Y===1||Y===2);if(pe(n),m.environment=n?ge():null,q.uniforms.uBloomStrength.value=0,N.visible=!1,l.setRenderTarget(ee),l.render(m,C.camera),N.visible=!0,Y===1&&!n)l.setRenderTarget(t),l.render(m,C.camera);else if(Y===1)l.setRenderTarget(G),l.render(m,C.camera),nt(G),q.uniforms.uAces.value=1,q.uniforms.uGrade.value=1,q.uniforms.uGrain.value=0,q.uniforms.uChroma.value=0,dt(q,t);else if(l.setRenderTarget(G),l.render(m,C.camera),Y===2)n&&nt(G),q.uniforms.uAces.value=+!!n,q.uniforms.uGrade.value=+!!n,q.uniforms.uGrain.value=1,q.uniforms.uChroma.value=1,dt(q,t);else{q.uniforms.uAces.value=0,q.uniforms.uGrade.value=0,q.uniforms.uGrain.value=0,q.uniforms.uChroma.value=0,dt(q,Le);let n=C.camera;lt.uniforms.uNear.value=n.near,lt.uniforms.uFar.value=n.far,lt.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(At(e.era),st):Mt();e.kind===`pixel`?(dt(r,t),window.__style=`pixel`):e.kind===`toon`?(dt(lt,t),window.__style=`toon`):(dt(lt,qe),dt(r,Je),ut.uniforms.uBlend.value=e.blend,dt(ut,t),window.__style=`blend`)}}function It(){let e=Lt(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return te.uniforms.uChromaScale.value=f.lerp(1,.5,t),e}function Lt(){if(Y===1||Y===2)return{kind:`none`};if(Y===7)return{kind:`pixel`};if(Y===8)return{kind:`toon`};let e=C.styleT;return window.__styleT=e,e<=gt?{kind:`toon`}:e>=_t?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:f.smoothstep(e,gt,_t),era:`16-bit`}}function Z(e){return Y===1||Y===2?``:mt&&Y!==7&&Y!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?bt[e.era||X]||`Pixel`:e.kind===`blend`?`Toon → `+(bt[e.era]||`Pixel`):``}function Rt(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){if(wt){let e=l.info;Tt={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}M.material.uniforms.uTime.value=t,q.uniforms.uTime.value=t,w.update(e),R.key.position.copy(w.sunDir).multiplyScalar(24),R.key.color.copy(w.sunColor),R.key.intensity=w.sunIntensity,R.fill.color.copy(w.hemiSky),R.fill.groundColor.copy(w.hemiGround),P.value=w.windowGlow,de.setSun(w.sunArc),de.setParams(w.skyParams),q.uniforms.uGradeSat.value=w.grade.sat,q.uniforms.uGradeContrast.value=w.grade.contrast,m.environmentIntensity=.34*(1-.6*f.clamp(w.sunArc.y*1.5,0,1));let i=z.overcast;R.key.intensity*=1-.5*i,R.key.color.lerp(h,.45*i),R.fill.intensity=1+.7*i;let a=f.smoothstep(w.sunDir.y,.06,.34),o=f.lerp(.28,1,1-w.windowGlow),s=n?a*o:0;R.key.shadow.intensity=.72*s,Ve.value=.52*s,(n&&!Ot||Dt.distanceToSquared(w.sunDir)>2e-5)&&(l.shadowMap.needsUpdate=!0,Dt.copy(w.sunDir)),Ot=n;let c=1-w.windowGlow;Be.setRGB(f.lerp(.46,1,c),f.lerp(.52,1,c),f.lerp(.74,1,c)),q.uniforms.uExposure.value=w.exposure,lt.uniforms.uToonGain.value=w.toonGain,l.setClearColor(w.horizon,1),kt(w.t),window.__t=w.t,ie.update(e,t,w),R.update(t),ae.update(e,t,w),k.uniforms.uWakeCount.value=ae.wakeCount,z.update(e,t),k.uniforms.uRainCount.value=z.rainDropCount;let u=z.fog*(1-c);m.fog.density=z.fog*g,y.copy(w.horizon).lerp(_,.85*u),m.fog.color.copy(y),l.setClearColor(y,1),Ge.value=z.fog,M.material.uniforms.uFogAmt.value=.7*z.fog,He.value=z.snow,Ue.value=z.cloud*.55,We.x+=e*.018,We.y+=e*.009,Ke.value+=(r-Ke.value)*Math.min(1,e*1.5),se.update(e,t,w,z);let d=Lt(),p=d.kind===`pixel`||d.kind===`blend`?`pixel`:mt||d.kind===`toon`?`charm`:`realistic`;ue.update(e,t,w,z,p),xt++;let v=performance.now();v-St>=1e3&&(window.__fps=xt,wt&&Tt&&(console.log(`[perf] ${xt} fps · ~${(1e3/Math.max(1,xt)).toFixed(2)} ms · calls ${Tt.calls} · tris ${Tt.tris} · programs ${Tt.programs} · geo ${Tt.geo} · tex ${Tt.tex}`),window.__perfInfo={fps:xt,...Tt}),xt=0,St=v);let[b,x,S]=E;if(k.uniforms.uPrev.value=b.texture,k.uniforms.uCurr.value=x.texture,l.setRenderTarget(S),l.render(D,O),E=[x,S,b],te.uniforms.uHeight.value=E[1].texture,Et<2&&typeof document<`u`&&++Et===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function zt(e){Y=e,window.__mode=Y}function Bt(){return mt=!mt,ze.value=+!!mt,window.__vector=mt,mt}function Vt(e){return mt=!!e,ze.value=+!!mt,window.__vector=mt,mt}function Ht(){return X=yt[(yt.indexOf(X)+1)%yt.length],window.__era=X,jt(),X}function Ut(){return ht=!ht,ht}return{updateWorld:Rt,decideStyle:It,renderCityPipeline:Ft,renderCityBeautyTo:Nt,styleHintName:Z,setPostMode:zt,toggleVector:Bt,setVector:Vt,cycleEra:Ht,togglePalette:Ut,get mode(){return Y},get vector(){return mt},get sceneEra(){return X},renderer:l,drawBuffer:p,scene:m,rig:C,sunRig:w,SIM:256,targets:E,simScene:D,simCamera:O,simMaterial:k,grabRT:ee,card:j,backdrop:M,WATER_SIZE:28,water:N,waterMaterial:te,windowGlow:P,landmarkFactory:ne,city:R,cityLife:ie,waterLife:ae,weatherRig:z,clouds:se,inspector:le,world:Pe,fitShadowFrustum:Fe,SHADOW_DIST:24,sceneDepth:Ie,sceneRT:G,filmicRT:Le,toonRT:qe,pixelRT:Je,postScene:$e,postCamera:K,postQuad:et,filmicMaterial:q,pixelMaterial:ot,pixelkitMaterial:st,toonMaterial:lt,mixMaterial:ut,PALCACHE:at,ERA_TEX:ct,runPass:dt,OVERCAST_GREY:h,FOG_DENSITY:g,FOG_NIGHT_TINT:_,_fogColor:y,resize:pt}}var gr=`lgr_hints_`,_r=!1;function vr(){if(_r||typeof document>`u`)return;_r=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  }`,document.head.appendChild(e)}function yr({key:e,title:t=`Tips`,tips:n=[],force:r=!1}={}){let i={key:e,shown:!1,dismissed:!1,seen:!1};if(typeof window<`u`&&(window.__hints=i),typeof document>`u`||!e)return{dismiss(){},el:null};let a=gr+e,o=!1;try{o=localStorage.getItem(a)===`1`}catch{}if(o&&!r)return i.seen=!0,{dismiss(){},el:null};vr();let s=!!(window.matchMedia&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches),c=document.createElement(`div`);c.className=`lgr-hints`,c.innerHTML=`<div class="lgr-hints-card">
  ...
  </div>`,document.body.appendChild(c),i.shown=!0,s?c.classList.add(`on`):requestAnimationFrame(()=>c.classList.add(`on`));let l=!1;function u(e=!0){if(!l){if(l=!0,e)try{localStorage.setItem(a,`1`)}catch{}i.dismissed=!0,window.removeEventListener(`keydown`,d),c.classList.remove(`on`),setTimeout(()=>c.remove(),s?0:300)}}function d(e){e.key===`Escape`&&u(!0)}return window.addEventListener(`keydown`,d),c.querySelector(`.lgr-hints-ok`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),c.querySelector(`.lgr-hints-x`).addEventListener(`click`,()=>{navigator.vibrate?.(10),u(!0)}),{dismiss:u,el:c}}var br=null;function xr(){if(br)return br;let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(128/2,128/2,0,128/2,128/2,128/2);return n.addColorStop(0,`rgba(0,0,0,0.60)`),n.addColorStop(.55,`rgba(0,0,0,0.32)`),n.addColorStop(1,`rgba(0,0,0,0.0)`),t.fillStyle=n,t.beginPath(),t.arc(128/2,128/2,128/2,0,Math.PI*2),t.fill(),br=new U(e),br.colorSpace=ce,br}function Sr({w:e=.6,d:t=.6,x:r=0,y:i=.002,z:a=0,opacity:o=.5,rotation:s=0}={}){let c=new n(new u(e,t),new S({map:xr(),transparent:!0,opacity:o,depthWrite:!1,toneMapped:!1}));return c.rotation.x=-Math.PI/2,c.rotation.z=s,c.position.set(r,i,a),c.renderOrder=-1,c.raycast=()=>{},c}function Cr({yawLimit:e=80,pitchUp:t=32,pitchDown:n=20,sensitivity:r=.16,keySpeed:i=70,damp:a=9}={}){let o=Math.PI/180,s=(e,t,n)=>e<t?t:e>n?n:e,c=0,l=0,u=0,d=0;return{addDrag(i,a){u=s(u-i*r,-e,e),d=s(d-a*r,-n,t)},addKeys(r,{left:a,right:o,up:c,down:l}){let f=i*r;a&&(u=s(u+f,-e,e)),o&&(u=s(u-f,-e,e)),c&&(d=s(d+f,-n,t)),l&&(d=s(d-f,-n,t))},recenter(){u=0,d=0},update(e){let t=1-Math.exp(-a*e);c+=(u-c)*t,l+=(d-l)*t},get yaw(){return c*o},get pitch(){return l*o},get active(){return Math.abs(c)>.05||Math.abs(l)>.05}}}var wr=null;function Tr(){if(wr)return wr;let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(256/2,256/2,256*.32,256/2,256/2,256*.72);return n.addColorStop(0,`rgba(0,0,0,0)`),n.addColorStop(1,`rgba(0,0,0,1)`),t.fillStyle=n,t.fillRect(0,0,256,256),wr=new U(e),wr.colorSpace=ce,wr}function Er({strength:e=.55,dist:t=.5}={}){let r=new n(new u(1,1),new S({map:Tr(),transparent:!0,opacity:e,depthTest:!1,depthWrite:!1,toneMapped:!1}));r.renderOrder=9999,r.raycast=()=>{},r.frustumCulled=!1;let i=new V;return r.fit=e=>{e.getWorldDirection(i),r.position.copy(e.position).addScaledVector(i,t),r.quaternion.copy(e.quaternion);let n=2*Math.tan(f.degToRad(e.fov)*.5)*t*1.05;r.scale.set(n*e.aspect,n,1)},r}var Dr=``+new URL(`office-dressed2-CNZL1Pge.png`,import.meta.url).href,Or=``+new URL(`office-night2-Tdv47G8J.png`,import.meta.url).href,kr=``+new URL(`office-modern-CQqt-EK1.png`,import.meta.url).href,Ar=``+new URL(`office-charm2-qAn3JlVo.png`,import.meta.url).href;function jr(){let e=document.createElement(`canvas`);e.width=e.height=256;let t=e.getContext(`2d`);t.fillStyle=`#6e4a2c`,t.fillRect(0,0,256,256);for(let e=0;e<150;e++){let e=Math.random()*256,n=.7+Math.random()*.7;t.strokeStyle=`rgba(${Math.round(110*n)},${Math.round(74*n)},${Math.round(44*n)},${.16+Math.random()*.28})`,t.lineWidth=.5+Math.random()*1.6,t.beginPath(),t.moveTo(e,0);for(let n=0;n<=256;n+=14)t.lineTo(e+Math.sin(n*.05+e)*3,n);t.stroke()}t.strokeStyle=`rgba(30,18,8,0.5)`,t.lineWidth=2;for(let e of[256*.34,256*.67])t.beginPath(),t.moveTo(0,e),t.lineTo(256,e),t.stroke();let n=new U(e);return n.colorSpace=ce,n.wrapS=n.wrapT=_e,n}function Q(e,t,r,i,{rough:a=.62,metal:o=0,x:s=0,y:l=0,z:u=0,emissive:d=null,emissiveIntensity:f=1,map:p=null,mapRepeat:m=null}={}){let h=p;p&&m&&(h=p.clone(),h.needsUpdate=!0,h.wrapS=h.wrapT=_e,h.repeat.set(m[0],m[1]));let g=new n(new H(e,t,r),new c({color:h?`#ffffff`:i,roughness:a,metalness:o,...h?{map:h}:{},...d?{emissive:d,emissiveIntensity:f}:{}}));return g.position.set(s,l,u),g}function Mr(){let e=document.createElement(`canvas`);e.width=512,e.height=304;let t=e.getContext(`2d`);t.fillStyle=`#fff`,t.fillRect(0,0,512,304);let n=.13*512,r=.87*512,i=.1*304,a=.66*304;return t.filter=`blur(7px)`,t.fillStyle=`#000`,t.beginPath(),t.moveTo(80.56,i),t.arcTo(r,i,r,a,14),t.arcTo(r,a,n,a,14),t.arcTo(n,a,n,i,14),t.arcTo(n,i,r,i,14),t.closePath(),t.fill(),t.filter=`none`,new U(e)}function Nr({tier:e=`corner`,layout:t=`straight-on`}={}){let r=new me,i=new fe(43,1,.1,100),o=new V(0,1.62,4.35),s=new V(0,1.12,-1);i.position.copy(o),i.lookAt(s);let l=Cr({yawLimit:80,pitchUp:34,pitchDown:20}),d=new be(0,0,0,`YXZ`),p=new _,m=new a;r.add(m);let g=new a,v=new a,y=new a,b=new a,x=new a;m.add(g,v,y,b,x);let C=[],w=`#4a3322`,E=`#3a2618`,O=`#5b3d27`,k=`#6e4a30`,ee=`#5a5650`,A=jr();g.add(Q(11,.2,11,`#3c2a1c`,{rough:.5,y:-.1,map:A,mapRepeat:[5,5]})),g.add(Q(11,.2,11,`#3a2a1d`,{rough:.9,y:3,map:A,mapRepeat:[4,4]}));for(let e of[-2.4,0,2.4])g.add(Q(.18,.16,7.4,E,{rough:.7,x:e,y:2.9,z:0,map:A,mapRepeat:[1,4]}));for(let e of[-2,.4])g.add(Q(7.4,.16,.18,E,{rough:.7,x:0,y:2.88,z:e,map:A,mapRepeat:[4,1]}));function M(e){let t=new a;t.add(Q(.2,3.2,8,w,{rough:.7,x:e*3.6,y:1.5,z:0,map:A,mapRepeat:[3,1.4]}));let r=e*3.45;t.add(Q(.06,.22,8,E,{x:r,y:.13,z:0})),t.add(Q(.08,.16,8,E,{x:r,y:2.84,z:0})),t.add(Q(.05,.05,8,E,{x:r,y:1,z:0}));for(let e of[-2.6,-1.3,1.3,2.6])t.add(Q(.05,1.6,.06,E,{x:r,y:1.95,z:e}));for(let e of[-2.6,-1.3,1.3,2.6])t.add(Q(.05,.7,.06,E,{x:r,y:.6,z:e}));let i=new n(new u(1.5,1),new c({map:Vr(e),roughness:.8}));i.position.set(e*3.49,1.7,.4),i.rotation.y=-e*Math.PI/2,t.add(Q(.06,1.18,1.68,`#2a1c10`,{x:e*3.52,y:1.7,z:.4}),i);let o=new n(new u(1,1.3),new c({map:Vr(-e),roughness:.8}));o.position.set(e*3.49,1.78,-2),o.rotation.y=-e*Math.PI/2,t.add(Q(.06,1.46,1.16,`#2a1c10`,{x:e*3.52,y:1.78,z:-2}),o),t.add(Q(.12,.3,.16,`#2a1c10`,{x:e*3.4,y:2.2,z:2.2}));let s=new j(new z({map:Br(),color:`#ffcf8a`,transparent:!0,opacity:.5,depthWrite:!1,blending:2}));return s.scale.set(.6,.75,1),s.position.set(e*3.32,2.34,2.2),s.raycast=()=>{},t.add(s),t}g.add(M(-1),M(1));let N=new a;N.add(Q(.3,1.9,1.5,O,{rough:.5,y:.95}));for(let e of[.4,.95,1.5])N.add(Q(.3,.04,1.46,`#3a2c1e`,{y:e}));let P=[`#7a3a2a`,`#2a4a6a`,`#b08a3a`,`#3a5a3a`,`#6a2a4a`,`#8a5a2a`];for(let e of[.6,1.15,1.7])for(let t=0;t<7;t++)N.add(Q(.18,.3,.11,P[(t+Math.round(e))%P.length],{x:.02,y:e-.06,z:-.6+t*.17}));N.position.set(-3.34,0,-1.9),g.add(N),g.add(Sr({w:1,d:1.8,x:-3.2,y:.02,z:-1.9,opacity:.4}));let F=new a;F.add(Q(.5,.1,.5,`#4a3526`,{rough:.7,y:.45})),F.add(Q(.5,.55,.08,`#4a3526`,{rough:.7,y:.72,z:-.21}));for(let[e,t]of[[-.2,-.2],[.2,-.2],[-.2,.2],[.2,.2]])F.add(Q(.05,.45,.05,`#2a1c10`,{x:e,y:.22,z:t}));F.position.set(2.7,0,2.6),F.rotation.y=-.5,g.add(F),g.add(Sr({w:.7,d:.7,x:2.7,y:.02,z:2.6,opacity:.42}));let re=new u(3,2.5),L=new u(3,2.5),R=new S({color:`#ffffff`,toneMapped:!1}),ie=new S({color:`#ffffff`,toneMapped:!1}),ae=-3.7,oe=1.55,B=f.degToRad(30),se=3/2*Math.cos(B),le=ae+3/2*Math.sin(B),ue=new n(re,R);ue.position.set(-se,oe,le),ue.rotation.y=B;let pe=new n(L,ie);pe.position.set(se,oe,le),pe.rotation.y=-B;let ge=new S({color:`#ffffff`,toneMapped:!1}),_e=new n(new u(5.4,2.6),ge);_e.position.set(0,oe,-3.5500000000000003),_e.visible=!1,y.add(ue,pe,_e);let U=new a;U.add(Q(.08,2.7,.08,E,{x:0,y:oe,z:le+3/2*Math.sin(B)+.02}));for(let[e,t,n]of[[-se,le,B],[se,le,-B]]){let r=new a;r.add(Q(3.05,.09,.09,E,{y:1.3})),r.add(Q(3.05,.09,.09,E,{y:-1.25})),r.add(Q(.09,2.6,.09,E,{x:-1.5})),r.position.set(e,oe,t),r.rotation.y=n,U.add(r)}U.add(Q(5.4,.5,.3,O,{x:0,y:.25,z:le+.5})),g.add(U);let W=new a;W.add(Q(11,3.2,.2,w,{rough:.7,x:0,y:1.5,z:ae-.05,map:A,mapRepeat:[4,1.4]})),W.add(Q(5.8,.14,.12,E,{x:0,y:2.9000000000000004,z:-3.5})),W.add(Q(5.8,.14,.12,E,{x:0,y:oe-1.35,z:-3.5})),W.add(Q(.14,2.84,.12,E,{x:-2.8,y:oe,z:-3.5})),W.add(Q(.14,2.84,.12,E,{x:2.8,y:oe,z:-3.5})),W.add(Q(.09,2.6,.09,E,{x:0,y:oe,z:-3.49})),W.add(Q(5.4,.5,.3,O,{x:0,y:.25,z:-3.35}));let ye=new a;ye.add(Q(2.4,.9,.55,O,{rough:.42,y:.45,z:0})),ye.add(Q(2.46,.06,.58,k,{rough:.3,y:.91,z:0}));for(let e of[-.62,0,.62])ye.add(Q(.66,.72,.03,`#4a3120`,{x:e,y:.45,z:.285}));for(let e of[-.62,0,.62])ye.add(Q(.05,.04,.05,`#caa15a`,{x:e+.2,y:.45,z:.31,metal:.6}));let xe=[`#7a3a2a`,`#2a4a6a`,`#b08a3a`,`#3a5a3a`];for(let e=0;e<4;e++)ye.add(Q(.1,.26+e%2*.05,.2,xe[e],{x:-.95+e*.13,y:1.07,z:-.06}));ye.add(Q(.04,.34,.42,`#241a12`,{x:.7,y:1.12,z:-.02})),ye.position.set(-3.9,0,-3.25),W.add(ye),W.add(Sr({w:2.8,d:.95,x:-3.9,y:.02,z:-3.25,opacity:.45}));for(let[e,t]of[[-3.55,-1],[3.55,1]]){let r=new a,i=new n(new u(.78,.98),new c({map:Vr(t),roughness:.82}));i.position.z=.05,r.add(Q(.06,1.12,.92,`#241a10`,{}),i),r.position.set(e,1.45,-3.5700000000000003),W.add(r)}for(let e of[-3.55,3.55]){W.add(Q(.16,.32,.13,`#2a1c10`,{x:e,y:2.35,z:-3.5}));let t=new j(new z({map:Br(),color:`#ffcf8a`,transparent:!0,opacity:.5,depthWrite:!1,blending:2}));t.scale.set(.55,.7,1),t.position.set(e,2.5,-3.42),t.raycast=()=>{},W.add(t)}W.visible=!1,g.add(W),g.add(Q(.4,.06,.4,`#1a130c`,{y:2.94,z:1.3}));let Se=new n(new de(.16,20),new S({color:`#ffe6b0`,toneMapped:!1}));Se.position.set(0,2.9,1.3),Se.rotation.x=Math.PI/2,g.add(Se);for(let[e,t]of[[-1.6,-1],[1.6,-1],[-1.6,-2.6],[1.6,-2.6],[0,-2.6]]){g.add(Q(.28,.05,.28,`#1a130c`,{y:2.95,x:e,z:t}));let r=new n(new de(.1,16),new S({color:`#ffe6b0`,toneMapped:!1}));r.position.set(e,2.915,t),r.rotation.x=Math.PI/2,r.raycast=()=>{},g.add(r)}g.add(Fr(C,{x:-3.46,y:2.15,z:.2,ry:Math.PI/2,face:`#efe2c8`,rim:`#2a1c10`})),g.add(Q(3.4,.03,2.4,`#3a1410`,{rough:.98,x:0,y:.012,z:1.95})),g.add(Q(3,.04,2,`#6e2a26`,{rough:.96,x:0,y:.02,z:1.95}));let Ce=new a;Ce.add(Q(.32,.32,.32,`#7a4a2a`,{rough:.8,y:.16}));for(let e=0;e<6;e++){let t=Q(.05,.55,.13,`#356a32`,{rough:.7,y:.32});t.geometry.translate(0,.27,0),t.rotation.z=(e/6-.5)*1.1,t.rotation.x=Math.sin(e*1.3)*.22,Ce.add(t)}Ce.position.set(2.7,0,.4),g.add(Ce),g.add(Sr({w:.7,d:.7,x:2.7,y:.03,z:.4,opacity:.45})),v.add(Q(11,.2,11,`#403d38`,{rough:.85,y:-.1})),v.add(Q(11,.2,11,`#1c1a17`,{rough:.95,y:2.8})),v.add(Q(7,3,.2,ee,{rough:.92,x:0,y:1.4,z:-2.9})),v.add(Q(.2,3,6,ee,{rough:.92,x:-3.2,y:1.4,z:-.2})),v.add(Q(.2,3,6,ee,{rough:.92,x:3.2,y:1.4,z:-.2}));for(let e of[-1.6,-.4]){let t=new n(new D(.07,.07,6,10),new c({color:`#6b6258`,roughness:.6,metalness:.4}));t.rotation.z=Math.PI/2,t.position.set(0,2.62,e),v.add(t)}let we=new S({color:`#ffffff`,toneMapped:!1}),Te=new n(new u(1.9,1.2),we);Te.position.set(0,1.5,-2.79),v.add(Te),v.add(Q(2.06,1.36,.06,`#241a12`,{x:0,y:1.5,z:-2.83})),v.add(Q(.04,.34,.04,`#1a1410`,{x:-.1,y:2.45,z:-.4}));let Ee=new n(new de(.1,16),new S({color:`#ffdb8a`,toneMapped:!1}));Ee.position.set(-.1,2.26,-.4),Ee.rotation.x=Math.PI/2,v.add(Ee);let De=new a;De.add(Q(1.3,.05,.32,`#3a2c1e`,{x:0,y:0,z:0}));let Oe=[`#7a3a2a`,`#2a4a6a`,`#b08a3a`,`#3a5a3a`,`#6a2a4a`];for(let e=0;e<8;e++)De.add(Q(.12,.34,.24,Oe[e%Oe.length],{x:-.55+e*.14,y:.2,z:0}));De.position.set(-2.3,1.5,-2.66),v.add(De);let ke=new a;ke.add(Q(.34,.34,.34,`#7a4a2a`,{y:.17}));let Ae=new a;for(let e=0;e<6;e++){let t=Q(.05,.5,.14,`#3a7a3a`,{rough:.7});t.geometry.translate(0,.25,0),t.rotation.z=(e/6-.5)*1.2,t.rotation.x=Math.sin(e)*.25,Ae.add(t)}Ae.position.y=.34,ke.add(Ae),ke.position.set(2.45,0,-1.4),v.add(ke),v.add(Fr(C,{x:1.9,y:2.1,z:-2.78,ry:0,face:`#d8d2c4`,rim:`#1a130c`}));let je=new a;je.add(Q(3.4,.12,1.5,k,{rough:.32,y:.86,z:1.5,map:A,mapRepeat:[3,1.4]})),je.add(Q(3.2,.78,1.36,O,{y:.46,z:1.5,map:A,mapRepeat:[3,1]}));for(let e of[.66,.4,.14])je.add(Q(.9,.2,.04,`#4a3120`,{x:1.05,y:e,z:2.2}));je.add(Q(.12,.04,.04,`#caa15a`,{x:1.05,y:.66,z:2.23,metal:.6}));let Me=new n(new D(.05,.045,.1,16),new c({color:`#d8cbb4`,roughness:.6}));Me.position.set(-.55,.97,1.95);let Ne=new n(new te(.035,.012,8,14),new c({color:`#d8cbb4`,roughness:.6}));Ne.position.set(-.61,.97,1.95),Ne.rotation.y=Math.PI/2,je.add(Me,Ne);let Pe=new j(new z({map:Br(),color:`#fff4e0`,transparent:!0,opacity:0,depthWrite:!1,blending:2}));Pe.scale.set(.12,.18,1),Pe.position.set(-.55,1.05,1.95),Pe.raycast=()=>{},je.add(Pe),je.add(Q(.26,.03,.34,`#efe7d4`,{rough:.85,x:.5,y:.935,z:1.9})),m.add(je);let Fe=new a;Fe.add(Q(.06,.5,.06,`#2a1c10`,{x:-1.15,y:1.15,z:1.6}));let Ie=new n(new ne(.22,.26,16,1,!0),new c({color:`#c2802e`,roughness:.5,side:2,emissive:`#3a2208`,emissiveIntensity:.6}));Ie.position.set(-1.15,1.42,1.6),Fe.add(Ie);let G=new T(`#ffb15a`,7,7,1.8);G.position.set(-1.15,1.34,1.6),Fe.add(G);let Le=new j(new z({map:Br(),color:`#ffcf8a`,transparent:!0,opacity:.55,depthWrite:!1,blending:2}));Le.scale.set(.85,.85,1),Le.position.set(-1.15,1.35,1.6),Le.raycast=()=>{},Fe.add(Le),Fe.position.x=-.3,m.add(Fe);let Re=new a;Re.add(Q(.62,.03,.42,`#1c1c20`,{y:.93,z:1.5,metal:.4,rough:.4}));let ze=new n(new H(.62,.4,.025),new c({color:`#0a0c10`,emissive:`#2a4a6a`,emissiveIntensity:.7,roughness:.3}));ze.position.set(0,1.14,1.31),ze.rotation.x=-.32,Re.add(ze),Re.userData.role=`laptop`,m.add(Re);let Be=new a;Be.add(Q(.26,.07,.34,`#15151a`,{x:1,y:.93,z:1.5}));let Ve=Q(.3,.06,.08,`#101015`,{x:1,y:1,z:1.34,emissive:`#234a6a`,emissiveIntensity:.4});Be.add(Ve),Be.userData.role=`phone`,m.add(Be);let He=new h(`#8a6a42`,`#1c130a`,.78);r.add(He);let Ue=new he(`#ffd9a0`,9,9,.7,.5,1.2);Ue.position.set(0,2.95,1.3),Ue.target.position.set(0,.86,1.5),r.add(Ue,Ue.target);let We=Ir(!1),Ge=Ir(!0),Ke=.62,qe=1.32,Je=1.22,Ye=1.78,Xe=new j(new z({map:We,transparent:!0,depthWrite:!1}));Xe.scale.set(Ke,Ke,1),Xe.position.set(qe,Je,Ye),Xe.userData.role=`cat`,m.add(Xe);let Ze=new j(new z({map:Rr(),transparent:!0,depthWrite:!1,opacity:0}));Ze.scale.set(.3,.3,1),Ze.raycast=()=>{},m.add(Ze);let Qe=0;function $e(){Qe=1.3}let K=-.95,et=1.06,q=1.95,tt=.62,J=.42,nt=.34,rt=new a;rt.position.set(K,et,q),rt.add(Q(tt,.05,nt,`#3a3026`,{y:-.19}));let it=new n(new H(tt-.04,J-.08,nt-.04),new c({color:`#1f9fc0`,transparent:!0,opacity:.26,roughness:.1,emissive:`#0a3a4a`,emissiveIntensity:.4,depthWrite:!1}));it.position.y=.02,rt.add(it);for(let e of[-1,1])for(let t of[-1,1])rt.add(Q(.03,J,.03,`#20262c`,{x:e*(tt/2-.015),z:t*(nt/2-.015),metal:.5}));let at=new n(new H(tt,J,nt),new S({visible:!1}));at.userData.role=`tank`,rt.add(at);let ot=new T(`#5fd8ff`,0,3,2);rt.add(ot);let st=[zr(`#e8a23c`),zr(`#d85a6a`),zr(`#6cc0e0`)],ct=[],lt=J/2-.12;for(let e=0;e<3;e++){let t=new j(new z({map:st[e],transparent:!0,depthWrite:!1})),n=.15-e*.015;t.userData={sz:n,sp:.6+e*.22,ph:e*2.1,ax:.21*(.7+.1*e),ay:lt,az:.09000000000000001,prevx:0},t.scale.set(n,n,1),ct.push(t),rt.add(t)}let ut=Br(),dt=[];for(let e=0;e<5;e++){let t=new j(new z({map:ut,color:`#cfeffb`,transparent:!0,opacity:.5,depthWrite:!1}));t.userData={ph:e/5,sp:.16+Math.random()*.06,x:-.1+e%3*.07},t.scale.setScalar(.03+e%2*.015),t.raycast=()=>{},dt.push(t),rt.add(t)}let ft=new j(new z({map:ut,color:`#c8a24a`,transparent:!0,opacity:0,depthWrite:!1}));ft.scale.setScalar(.04),ft.raycast=()=>{},rt.add(ft);let pt=0;function Y(){pt=3,ft.position.set(-.05,lt,0),ft.material.opacity=1}m.add(rt);let mt=new a;for(let e=0;e<8;e++){let t=new j(new z({map:ut,color:`#ffd9a0`,transparent:!0,opacity:0,depthWrite:!1,blending:2}));t.scale.setScalar(.018),t.userData={ph:e*.9,sp:.1+e%3*.04,r:.1+e%4*.03},t.raycast=()=>{},mt.add(t)}mt.position.set(-1.45,1.2,1.6),m.add(mt);let ht=new a,X=.925;ht.add(Sr({w:4,d:2,x:0,y:.045,z:1.55,opacity:.5})),ht.add(Sr({w:.95,d:.62,x:0,y:X,z:1.42,opacity:.42})),ht.add(Sr({w:.3,d:.3,x:-.55,y:X,z:1.95,opacity:.4})),ht.add(Sr({w:.42,d:.46,x:.5,y:X,z:1.9,opacity:.35})),ht.add(Sr({w:.42,d:.46,x:1,y:X,z:1.5,opacity:.42})),ht.add(Sr({w:.7,d:.42,x:K,y:X,z:1.95,opacity:.42})),ht.add(Sr({w:.55,d:.4,x:1.32,y:X,z:1.78,opacity:.4})),ht.add(Sr({w:.34,d:.34,x:-1.45,y:X,z:1.6,opacity:.35})),m.add(ht),[je,Fe,Re,Be,Xe,rt,mt,ht].forEach(e=>b.add(e));function gt(e,t,r,i,a,o,s){let c=new n(new H(t,r,i),new S({visible:!1}));c.position.set(a,o,s),c.userData.role=e,x.add(c)}gt(`laptop`,.95,.6,.7,0,1.05,1.4),gt(`phone`,.5,.4,.5,1,.98,1.42),gt(`cat`,.62,.74,.5,qe,Je,Ye),gt(`tank`,tt,J,.5,K,et,q);let _t=Pr(),vt={dressed2:new ve().load(Dr),night2:new ve().load(Or),modern:new ve().load(kr),charm:new ve().load(Ar)},yt=[`dressed2`,`night2`,`modern`,`charm`];for(let e of yt)vt[e].colorSpace=ce;let bt=Mr(),xt=new n(new u(1,1),new S({map:vt.dressed2,alphaMap:bt,transparent:!0,toneMapped:!1}));xt.position.set(0,1.45,-5),xt.visible=!1,xt.raycast=()=>{},r.add(xt);let St=Er({strength:.5});r.add(St);let Ct=`3d`,wt=`painted`;function Tt(){let e=Z===`corner`,t=Ct!==`3d`,n=t&&wt===`painted`;g.visible=e&&!t,v.visible=!e&&!t,y.visible=t||e,xt.visible=t,b.visible=!n,Ft()}function Et(e){return Ct=yt.includes(e)?e:`3d`,Ct!==`3d`&&(xt.material.map=vt[Ct],xt.material.needsUpdate=!0),Tt(),Ct}function Dt(e){return wt=e===`3d`?`3d`:`painted`,Tt(),wt}let Ot=G.intensity,kt=ze.material.emissiveIntensity,At=new I;function jt(e,t,n){let r=n?n.windowGlow:0,a=r>.55;Xe.material.map=a?Ge:We,Qe>0&&(Qe=Math.max(0,Qe-e));let c=Qe>0?Math.sin((1.3-Qe)/1.3*Math.PI):0,u=a?.012*Math.sin(t*1.2):.03*Math.sin(t*2.4);Xe.scale.set(Ke,Ke*(1+u+.12*c),1),Xe.position.y=Je+.06*c,Ze.material.opacity=c,Ze.position.set(qe,1.72+.5*(1-Qe/1.3),Ye),Ze.scale.setScalar(.22+.1*c),pt>0&&(pt=Math.max(0,pt-e),ft.position.y=Math.max(-.09,ft.position.y-e*.06),ft.material.opacity=pt>.3?1:pt/.3);for(let e of ct){let n=e.userData,r=Math.sin(t*n.sp+n.ph)*n.ax,i=Math.sin(t*n.sp*.8+n.ph*1.7)*n.ay*.7,a=Math.cos(t*n.sp*.6+n.ph)*n.az,o=pt>0?ft.position.x:r,s=pt>0?ft.position.y:i,c=pt>0?ft.position.z:a,l=pt>0?.05:.1;e.position.x+=(o-e.position.x)*l,e.position.y+=(s-e.position.y)*l,e.position.z+=(c-e.position.z)*l,e.scale.x=(e.position.x>=n.prevx?1:-1)*n.sz,n.prevx=e.position.x}for(let e of dt){let n=(t*e.userData.sp+e.userData.ph)%1;e.position.set(e.userData.x+Math.sin(t*2+e.userData.ph*9)*.015,-.09+2*lt*n,.02),e.material.opacity=.5*Math.sin(n*Math.PI)}ot.intensity=2.6*r,it.material.emissiveIntensity=.4+.9*r,G.intensity=Ot*(.97+.03*Math.sin(t*7)*Math.sin(t*2.3)),ze.material.emissiveIntensity=kt*(.85+.15*Math.sin(t*3.1+1)),Ve.material.emissiveIntensity=.4*(.65+.35*Math.sin(t*2.2)),At.setRGB(1,.85,.62),mt.children.forEach((e,n)=>{let i=e.userData,a=(t*i.sp+i.ph)%1;e.position.set(Math.cos(t*.5+i.ph*5)*i.r,-.15+a*.45,Math.sin(t*.4+i.ph*5)*i.r),e.material.opacity=(.1+.18*r)*Math.sin(a*Math.PI)});let m=t*.4%1;Pe.position.y=1.04+m*.22,Pe.position.x=-.55+Math.sin(t*1.5)*.02,Pe.material.opacity=.26*Math.sin(m*Math.PI),Pe.scale.set(.1+m*.08,.16+m*.12,1),Ae.rotation.z=Math.sin(t*.8)*.05,Ae.rotation.x=Math.sin(t*.6+1)*.04;let h=n?n.t%1:0;for(let e of C)e.rotation.z=-h*Math.PI*2;if(_t.update(e),xt.visible){let e=i.position.z-xt.position.z,t=2*Math.tan(f.degToRad(i.fov)*.5)*e*1.18;xt.scale.set(t*i.aspect,t,1);let n=.55+.45*(1-r);xt.material.color.setRGB(n,n*.97,n*.92)}i.position.set(o.x+Math.sin(t*.5)*.04,o.y+Math.sin(t*.7)*.02,o.z),i.lookAt(s),l.update(e),d.set(l.pitch,l.yaw,0,`YXZ`),i.quaternion.multiply(p.setFromEuler(d)),St.fit(i)}function Mt(e,t=e){R.map=e,ie.map=t,R.needsUpdate=!0,ie.needsUpdate=!0}function Nt(e){ge.map=e,ge.needsUpdate=!0}let Pt=`corner`;function Ft(){let e=Pt===`corner`;ue.visible=pe.visible=e,_e.visible=!e||Ct!==`3d`,U.visible=e,W.visible=!e}function It(e){return Pt=e===`straight-on`?`straight-on`:`corner`,Ft(),Pt}function Lt(e){we.map=e,we.needsUpdate=!0}let Z=e;function Rt(e){Z=e===`basement`?`basement`:`corner`;let t=Z===`corner`;return Tt(),Ue.intensity=t?9:3.2,He.intensity=t?.78:.82,He.color.set(t?`#6a5238`:`#7a5a34`),Z}return Rt(Z),It(t),{scene:r,camera:i,update:jt,setCityTexture:Mt,setStraightCityTexture:Nt,setVignetteTexture:Lt,setFitout:Rt,setSkin:Et,setProps:Dt,setLayout:It,petCat:$e,feedFish:Y,look:l,vignette:_t,get interactables(){return Ct!==`3d`&&wt===`painted`?x.children:[Re,Be,Xe,at]},get tier(){return Z},get skin(){return Ct},get props(){return wt},get layout(){return Pt}}}function Pr(){let e=new me;e.background=new I(`#7fb0dd`);let t=new s(-1.4,1.4,.9,-.9,0,10);t.position.set(0,0,5);let r=(e,t={})=>new S({color:e,toneMapped:!1,...t}),i=(e,t,i,a,o,s,c)=>{let l=new n(new u(e,t),r(s,c));return l.position.set(i,a,o),l};e.add(i(3.2,.9,.5,-.95,1,`#2a4a30`)),e.add(i(3.2,.7,-.7,-1.05,2,`#1d3724`)),e.add(i(.06,.3,-.95,-.55,3,`#3a2a1a`));let a=new n(new de(.22,18),r(`#234a2a`));a.position.set(-.95,-.32,3),e.add(a),e.add(i(.04,.55,.9,-.55,3,`#20242a`));let o=new n(new de(.1,16),r(`#ffd98a`,{transparent:!0,opacity:0}));o.position.set(.9,-.26,3.1),e.add(o);let c=new n(new de(.16,24),r(`#fff4d8`));e.add(c);let l=[];for(let[t,i]of[[-1,.5],[-.6,.7],[.2,.6],[.7,.72],[1.05,.45],[-.2,.78],[.45,.4]]){let a=new n(new de(.015,8),r(`#ffffff`,{transparent:!0,opacity:0}));a.position.set(t,i,.5),l.push(a),e.add(a)}let d=new I(`#141d33`),p=new I(`#7fb6e0`),m=new I(`#d6824a`),h=new I(`#fff0cc`),g=new I(`#cdd8ef`),_=.34;function v(t){_=(_+t*.04)%1;let n=_*Math.PI*2,r=-Math.cos(n);c.position.set(Math.sin(n)*1.15,r*.66+.06,0);let i=f.smoothstep(r,-.18,.5),a=f.smoothstep(.32,0,Math.abs(r));e.background.copy(d).lerp(p,i).lerp(m,a*.45),c.material.color.copy(r>0?h:g),o.material.opacity=1-i;let s=(1-i)*.85;for(let e of l)e.material.opacity=s}return{scene:e,camera:t,update:v}}function Fr(e,{x:t,y:r,z:i,ry:o=0,face:s=`#efe2c8`,rim:l=`#2a1c10`}){let d=new a,f=new n(new de(.2,28),new c({color:l,roughness:.6})),p=new n(new de(.17,28),new c({color:s,roughness:.7}));p.position.z=.01;let m=new n(new u(.018,.14),new c({color:`#1a130c`,roughness:.5}));return m.geometry.translate(0,.05,0),m.position.z=.02,e.push(m),d.add(f,p,m),d.position.set(t,r,i),d.rotation.y=o,d}function Ir(e){let t=document.createElement(`canvas`);t.width=t.height=128;let n=t.getContext(`2d`),r=`#e08a3c`,i=`#b96a26`,a=`#3a2410`;if(n.lineJoin=`round`,e){n.fillStyle=r,n.beginPath(),n.ellipse(64,78,44,26,0,0,7),n.fill(),n.fillStyle=i,n.beginPath(),n.ellipse(64,86,44,16,0,0,7),n.fill(),n.fillStyle=r,n.beginPath(),n.arc(36,70,20,0,7),n.fill(),n.fillStyle=r,Lr(n,24,56,34,44,42,58),Lr(n,40,54,50,44,54,60),n.strokeStyle=i,n.lineWidth=7,n.lineCap=`round`,n.beginPath(),n.moveTo(100,70),n.quadraticCurveTo(112,90,88,96),n.stroke(),n.strokeStyle=a,n.lineWidth=2.5,n.beginPath(),n.arc(30,70,5,.1,Math.PI-.1),n.stroke(),n.strokeStyle=i,n.lineWidth=3;for(let e of[60,74,88])n.beginPath(),n.moveTo(e,58),n.lineTo(e,70),n.stroke()}else{n.fillStyle=r,n.beginPath(),n.ellipse(64,86,30,34,0,0,7),n.fill(),n.fillStyle=`#f3c98a`,n.beginPath(),n.ellipse(64,92,14,22,0,0,7),n.fill(),n.strokeStyle=i,n.lineWidth=8,n.lineCap=`round`,n.beginPath(),n.moveTo(92,100),n.quadraticCurveTo(116,86,104,60),n.stroke(),n.fillStyle=r,n.beginPath(),n.arc(64,48,24,0,7),n.fill(),n.fillStyle=r,Lr(n,44,34,50,18,60,34),Lr(n,84,34,78,18,68,34),n.fillStyle=`#f0b0c0`,Lr(n,47,30,50,22,56,32),Lr(n,81,30,78,22,72,32),n.fillStyle=a,n.beginPath(),n.arc(55,47,3.4,0,7),n.arc(73,47,3.4,0,7),n.fill(),n.fillStyle=`#e06a7a`,Lr(n,61,54,67,54,64,58),n.strokeStyle=a,n.lineWidth=1.6;for(let e of[-2,3])n.beginPath(),n.moveTo(50,55+e),n.lineTo(34,53+e),n.moveTo(78,55+e),n.lineTo(94,53+e),n.stroke();n.strokeStyle=i,n.lineWidth=3;for(let e of[78,90,102])n.beginPath(),n.moveTo(50,e),n.lineTo(78,e),n.stroke()}let o=new U(t);return o.colorSpace=ce,o}function Lr(e,t,n,r,i,a,o){e.beginPath(),e.moveTo(t,n),e.lineTo(r,i),e.lineTo(a,o),e.closePath(),e.fill()}function Rr(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`);t.fillStyle=`#ff5a8a`,t.beginPath(),t.moveTo(32,52),t.bezierCurveTo(6,32,14,10,32,24),t.bezierCurveTo(50,10,58,32,32,52),t.fill();let n=new U(e);return n.colorSpace=ce,n}function zr(e){let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`);n.fillStyle=e,n.beginPath(),n.ellipse(30,32,18,11,0,0,7),n.fill(),n.beginPath(),n.moveTo(46,32),n.lineTo(60,22),n.lineTo(60,42),n.closePath(),n.fill(),n.fillStyle=`rgba(255,255,255,0.35)`,n.beginPath(),n.ellipse(28,36,12,5,0,0,7),n.fill(),n.fillStyle=`#15212a`,n.beginPath(),n.arc(20,30,2.6,0,7),n.fill();let r=new U(t);return r.colorSpace=ce,r}function Br(){let e=document.createElement(`canvas`);e.width=e.height=32;let t=e.getContext(`2d`),n=t.createRadialGradient(16,16,0,16,16,16);n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.6,`rgba(255,255,255,0.7)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.beginPath(),t.arc(16,16,16,0,7),t.fill();let r=new U(e);return r.colorSpace=ce,r}function Vr(e){let t=document.createElement(`canvas`);t.width=t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,256,256);e<0?(r.addColorStop(0,`#6a3b1c`),r.addColorStop(1,`#caa15a`)):(r.addColorStop(0,`#3a4a6a`),r.addColorStop(1,`#a86a3a`)),n.fillStyle=r,n.fillRect(0,0,256,256),n.globalAlpha=.5;for(let e=0;e<5;e++)n.fillStyle=e%2?`#2a1c10`:`#e0c080`,n.fillRect(30+e*36,40+e%3*30,26,150);let i=new U(t);return i.colorSpace=ce,i}var{Timer:Hr}=O,Ur=new URLSearchParams(window.location.search),Wr=Ur.get(`demo`)===`1`||Ur.has(`capture`);window.__demo=Wr;var Gr=(Ur.get(`city`)?Number(Ur.get(`city`)):0)||Math.random()*1e9|0,Kr=0,qr=hr({demo:Wr,citySeed:Gr,profileIndex:Kr}),{renderer:Jr,rig:Yr,sunRig:Xr,city:Zr,cityLife:Qr,waterMaterial:$r,fitShadowFrustum:ei,landmarkFactory:ti,renderCityBeautyTo:ni}=qr,$=Nr({tier:`corner`});typeof window<`u`&&(window.__office=$),$.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix();var ri=!0;window.__shadows=ri,window.__scene=`office`;var ii={minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1},ai=new V(2.2,3.4,11.5),oi=new V(0,2,0).sub(ai),si=new V(0,1,0),ci=30,li=384/320,ui=f.radToDeg(2*Math.atan(Math.tan(f.degToRad(ci))/li));function di(e){let t=new fe(ui,li,.1,100);t.position.copy(ai);let n=oi.clone().applyAxisAngle(si,f.degToRad(e));return t.lookAt(ai.clone().add(n)),t}var fi=di(30),pi=di(-30),mi=new B(384,320,ii),hi=new B(384,320,ii);$.setCityTexture(mi.texture,hi.texture);var gi=new fe(52,540/320,.1,100);gi.position.copy(ai),gi.lookAt(ai.clone().add(oi));var _i=new B(540,320,ii);$.setStraightCityTexture(_i.texture);var vi=0,yi=3,bi=new B(512,320,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1});$.setVignetteTexture(bi.texture);var xi=!1,Si=(()=>{if(typeof document>`u`)return{showLap(){},toast(){},flash(){}};let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.className=`lap`,t.innerHTML=`<div class="lap-win"><div class="lap-bar"><b>PORTFOLIO OS — John's Game</b>
    ...
    </div></div>`;let n=document.createElement(`div`);n.className=`otoast`;let r=document.createElement(`div`);r.className=`oflash`,document.body.append(t,n,r),t.querySelector(`.lap-x`).addEventListener(`click`,()=>wi()),t.addEventListener(`click`,e=>{e.target===t&&wi()}),t.addEventListener(`click`,e=>{e.target.closest(`button`)&&navigator.vibrate?.(10)});let i=0;return{showLap(e){t.classList.toggle(`on`,e)},toast(e){n.textContent=e,n.classList.add(`on`),clearTimeout(i),i=setTimeout(()=>n.classList.remove(`on`),1400)},flash(){r.style.transition=`none`,r.style.opacity=`0.85`,requestAnimationFrame(()=>{r.style.transition=`opacity .55s`,r.style.opacity=`0`})}}})();function Ci(){xi=!0,Si.showLap(!0)}function wi(){xi=!1,Si.showLap(!1)}function Ti(){Kr=(Kr+1)%tt.length,Si.flash(),Zr.generate(Gr,Kr),$r.uniforms.uVecWater.value.set(Zr.waterColor),Qr.setProfile(Zr.state.profile),ei(),Si.toast(`✈  `+Zr.state.profile.name),window.__profile=Zr.state.profile.key}function Ei(e){let t=$.setFitout(e);return Si.toast(t===`basement`?`🏚  Basement office`:`🏙  Corner office`),window.__tier=t,t}function Di(){return Ei($.tier===`corner`?`basement`:`corner`)}window.__tier=$.tier;var Oi=[`3d`,`dressed2`,`night2`,`modern`,`charm`],ki={"3d":`🧊  Stylized 3D office`,dressed2:`📚  Dressed office (day)`,night2:`🌙  Night office`,modern:`🏙  Modern office (day)`,charm:`🎨  Charm office`};function Ai(e){let t=$.setSkin(e);return window.__officeSkin=t,Si.toast(ki[t]),t}function ji(){return Ai(Oi[(Oi.indexOf($.skin)+1)%Oi.length])}window.__officeSkin=$.skin;var Mi={painted:`🎨  Painted props (cohesive)`,"3d":`🧊  Live 3D props (animated)`};function Ni(e){let t=$.setProps(e);return window.__officeProps=t,$.skin!==`3d`&&Si.toast(Mi[t]),t}function Pi(){return Ni($.props===`painted`?`3d`:`painted`)}window.__officeProps=$.props;var Fi={corner:`🏙  Corner window`,"straight-on":`🖼  Straight-on window`};function Ii(e){let t=$.setLayout(e);return window.__officeLayout=t,Si.toast(Fi[t]),t}function Li(){return Ii($.layout===`corner`?`straight-on`:`corner`)}window.__officeLayout=$.layout;var Ri=new N,zi=new F,Bi=(e,t)=>{zi.x=e/window.innerWidth*2-1,zi.y=-(t/window.innerHeight)*2+1};function Vi(){Ri.setFromCamera(zi,$.camera);let e=Ri.intersectObjects($.interactables,!0)[0];if(!e)return null;let t=e.object;for(;t&&!t.userData.role;)t=t.parent;return t?t.userData.role:null}function Hi(e){e===`laptop`?Ci():e===`phone`?Ti():e===`cat`?$.petCat():e===`tank`&&$.feedFish()}var Ui=6,Wi=0,Gi=0,Ki=0,qi=0,Ji=0,Yi=!1,Xi=!1;Jr.domElement.style.cursor=`grab`,Jr.domElement.addEventListener(`mousedown`,e=>{Yi=!0,Xi=!1,Wi=qi=e.clientX,Gi=Ji=e.clientY,Ki=performance.now()}),window.addEventListener(`mousemove`,e=>{Yi?(!Xi&&Math.hypot(e.clientX-Wi,e.clientY-Gi)>Ui&&(Xi=!0),Xi&&($.look.addDrag(e.clientX-qi,e.clientY-Ji),Jr.domElement.style.cursor=`grabbing`),qi=e.clientX,Ji=e.clientY):(Bi(e.clientX,e.clientY),Jr.domElement.style.cursor=Vi()?`pointer`:`grab`)}),window.addEventListener(`mouseup`,e=>{if(Yi&&!Xi&&!xi){Bi(e.clientX,e.clientY);let t=Vi();t&&Hi(t)}Yi=!1,Xi=!1,Jr.domElement.style.cursor=`grab`});var Zi=!1;Jr.domElement.addEventListener(`touchstart`,e=>{e.touches.length===1&&(Wi=qi=e.touches[0].clientX,Gi=Ji=e.touches[0].clientY,Ki=performance.now(),Zi=!1)},{passive:!0}),Jr.domElement.addEventListener(`touchmove`,e=>{if(e.touches.length!==1)return;let t=e.touches[0].clientX,n=e.touches[0].clientY;!Zi&&Math.hypot(t-Wi,n-Gi)>8&&(Zi=!0),Zi&&$.look.addDrag(t-qi,n-Ji),qi=t,Ji=n},{passive:!0}),window.addEventListener(`touchend`,e=>{if(!Zi&&performance.now()-Ki<350&&(!e.touches||e.touches.length===0)&&!xi){let e=Vi();e&&Hi(e)}Zi=!1});var Qi={left:!1,right:!1,up:!1,down:!1},$i={ArrowLeft:`left`,ArrowRight:`right`,ArrowUp:`up`,ArrowDown:`down`};window.addEventListener(`keydown`,e=>{if($i[e.key]){Qi[$i[e.key]]=!0,e.preventDefault();return}e.key===`Escape`&&(xi?wi():$.look.recenter()),(e.key===`f`||e.key===`F`)&&Di(),(e.key===`j`||e.key===`J`)&&ji(),(e.key===`u`||e.key===`U`)&&Pi(),(e.key===`t`||e.key===`T`)&&Xr.cyclePreset(),(e.key===`h`||e.key===`H`)&&(ri=!ri,window.__shadows=ri),(e.key===`w`||e.key===`W`)&&Li()}),window.addEventListener(`keyup`,e=>{$i[e.key]&&(Qi[$i[e.key]]=!1)}),ti.whenReady.then(()=>{Zr.generate(Gr,Kr),ei(),window.__cityReady=!0}),Ur.get(`office`)===`basement`&&Ei(`basement`);var ea=Ur.get(`officeskin`);Oi.includes(ea)&&Ai(ea);var ta=Ur.get(`officeprops`);[`painted`,`3d`].includes(ta)&&Ni(ta);var na=Ur.get(`officelayout`);[`corner`,`straight-on`].includes(na)&&Ii(na);var ra=new Hr;ra.connect(document);function ia(){ra.update();let e=Math.min(ra.getDelta(),.1);Yr.update(e),qr.updateWorld(e,ra.getElapsed(),{shadowsOn:ri,seasonTarget:0}),$.look.addKeys(e,Qi),$.update(e,ra.getElapsed(),Xr),window.__lookYaw=$.look.yaw,window.__lookPitch=$.look.pitch,$.tier===`basement`?(Jr.setRenderTarget(bi),Jr.render($.vignette.scene,$.vignette.camera)):vi%yi===0&&($.layout===`straight-on`?ni(gi,_i):(ni(fi,mi),ni(pi,hi),$.skin!==`3d`&&ni(gi,_i))),vi++,Jr.setRenderTarget(null),Jr.render($.scene,$.camera),requestAnimationFrame(ia)}ia(),yr({key:`office`,title:`The Office`,tips:[`Drag to look around the office (or use the arrow keys)`,`Click / tap the LAPTOP to open the game panel`,`Tap the PHONE to travel to another city · pet the CAT · feed the FISH`,`Esc exits · F fitout · J skin · U props · W window · T time`]}),window.addEventListener(`resize`,()=>{qr.resize(),$.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix()});