...
void main() {
  ...
  gl_FragColor = vec4(st.x, Snew, 0.0, 0.0);
}`;function Wn({renderer:t,N:r,cell:i,half:a,worldSize:o,seaY:l=0,FLOW:d,DAMP:f,MIN_DEPTH:p,KC:m,KE:h,KD:g,KADV:_,MAXD:v,readTerrain:y}){let b=t.getContext();if(!(b&&b.getExtension&&b.getExtension(`EXT_color_buffer_float`)))return typeof console<`u`&&console.warn(`[L87] EXT_color_buffer_float unavailable — GPU flow backend cannot run; staying on CPU.`),null;let S={type:xe,format:e,minFilter:x,magFilter:x,wrapS:ce,wrapT:ce,depthBuffer:!1,stencilBuffer:!1},C=[new L(r,r,S),new L(r,r,S)],w=[new L(r,r,S),new L(r,r,S)],T=[new L(r,r,S),new L(r,r,S)],E=new Float32Array(r*r*4),D=new be(E,r,r,e,xe);D.minFilter=x,D.magFilter=x,D.wrapS=D.wrapT=ce;let O=new Float32Array(r*r),k=!1,ee=1,j=!0,te=new he,ne=new s(-1,1,1,-1,0,1),M=new n(new u(2,2),null);M.frustumCulled=!1,te.add(M);let N=new fe(1/r,1/r),P=(e,t)=>new ie({vertexShader:In,fragmentShader:e,uniforms:t}),F=P(Ln,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:N},uN:{value:r},uDt:{value:0},uFlow:{value:d},uDamp:{value:f}}),re=P(Rn,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:N},uN:{value:r},uDt:{value:0},uSeaY:{value:l}}),ae=P(zn,{uState:{value:null},uTerr:{value:null},uN:{value:r},uSeaY:{value:l},uRain:{value:0},uPourCount:{value:0},uPours:{value:Array.from({length:8},()=>new z)},uPourR:{value:new Float32Array(8)}}),oe=P(Bn,{uSrc:{value:D}}),R=()=>({uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:N},uN:{value:r},uDt:{value:0},uCell:{value:i},uSeaY:{value:l},uKC:{value:m},uKE:{value:h},uKD:{value:g},uMaxD:{value:v},uMinDepth:{value:p},uErosK:{value:ee}}),le=P(Vn,R()),B=P(Hn,R()),V=P(Un,{uState:{value:null},uTerr:{value:null},uFlux:{value:null},uTexel:{value:N},uN:{value:r},uDt:{value:0},uSeaY:{value:l},uKADV:{value:_}});function de(e,n){M.material=e;let r=t.getRenderTarget();t.setRenderTarget(n),t.render(te,ne),t.setRenderTarget(r)}let pe=new I;function me(e){let n=t.getRenderTarget(),r=t.getClearAlpha();t.getClearColor(pe),t.setRenderTarget(e),t.setClearColor(0,0),t.clear(!0,!1,!1),t.setClearColor(pe,r),t.setRenderTarget(n)}function H(){y(O);for(let e=0;e<r*r;e++)E[e*4]=O[e];D.needsUpdate=!0,de(oe,T[0])}function ge(){me(C[0]),me(C[1]),me(w[0]),me(w[1])}ge();let _e=r*r,ve=new Float32Array(_e*3),U=new Float32Array(_e*2);for(let e=0;e<r;e++)for(let t=0;t<r;t++){let n=e*r+t;ve[n*3]=t*i-a,ve[n*3+1]=0,ve[n*3+2]=e*i-a,U[n*2]=(t+.5)/r,U[n*2+1]=(e+.5)/r}let ye=[];for(let e=0;e<r-1;e++)for(let t=0;t<r-1;t++){let n=e*r+t,i=e*r+t+1,a=(e+1)*r+t,o=(e+1)*r+t+1;ye.push(n,a,i,i,a,o)}let Se=new se;Se.setAttribute(`position`,new A(ve,3)),Se.setAttribute(`aGridUv`,new A(U,2)),Se.setIndex(ye),Se.boundingSphere=new ue(new z(0,0,0),o);let Ce={uStateTex:{value:C[0].texture},uTerrTex:{value:T[0].texture},uMinDepth:{value:p}},we=new c({color:`#2f6f96`,roughness:.14,metalness:.45,transparent:!0,depthWrite:!1});we.onBeforeCompile=e=>{e.uniforms.uStateTex=Ce.uStateTex,e.uniforms.uTerrTex=Ce.uTerrTex,e.uniforms.uMinDepth=Ce.uMinDepth,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,Di={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Oi=[`gb`,`8-bit`,`16-bit`,`modern`];function ki(t){let n=Math.max(t.length,1),r=new Float32Array(n*4);t.forEach((e,t)=>{let n=new I(e);r[t*4+0]=n.r,r[t*4+1]=n.g,r[t*4+2]=n.b,r[t*4+3]=1});let i=new be(r,n,1,e,xe);return i.minFilter=x,i.magFilter=x,i.needsUpdate=!0,i}var Ai=220,ji={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Mi={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function Ni(e){if(typeof document>`u`||document.getElementById(`lgr-nowebgl`))return;let t=document.createElement(`div`);t.id=`lgr-nowebgl`,t.style.cssText=`position:fixed;inset:0;z-index:99999;display:flex;align-items:center;justify-content:center;background:#0e1116;color:#cdd6e4;font:16px/1.6 system-ui,-apple-system,sans-serif;text-align:center;padding:2rem;`,t.innerHTML=`<div style="max-width:30rem"><div style="font-size:2.4rem;margin-bottom:1rem">🌊</div><h1 style="font-size:1.3rem;margin:0 0 .6rem;color:#fff;font-weight:600">This experience needs a modern browser</h1><p style="margin:0;color:#9aa6b8">`+e+`</p></div>`,document.body&&document.body.appendChild(t)}function Pi({demo:t=!1,citySeed:r=0,profileIndex:a=0}={}){let l;try{l=new re({antialias:!0,preserveDrawingBuffer:!0})}catch(e){throw Ni(`This experience needs WebGL2 — please open it in an up-to-date browser (Chrome, Edge, Firefox, or Safari on iOS 15+) with hardware acceleration enabled.`),e}l.shadowMap.enabled=!0,l.shadowMap.type=1,l.shadowMap.autoUpdate=!1,l.shadowMap.needsUpdate=!0;let d=window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches?1.5:2;l.setPixelRatio(Math.min(window.devicePixelRatio,d)),l.setSize(window.innerWidth,window.innerHeight),l.setClearColor(920327,1),document.body.appendChild(l.domElement);let p=l.getDrawingBufferSize(new fe),m=!1,h=!1,g=()=>{};l.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),m=!0,typeof window<`u`&&(window.__contextLost=!0)},!1),l.domElement.addEventListener(`webglcontextrestored`,()=>{g(),m=!1,typeof window<`u`&&(window.__contextLost=!1)},!1);let _=new he;_.fog=new b(10465470,0);let y=new I(`#aeb6c0`),C=.062,w=new I(`#74508f`),T=new I,E=Be({aspect:window.innerWidth/window.innerHeight}),D=Ot({t:.5}),O=l.getContext(),k=!!(O&&O.getExtension&&(O.getExtension(`EXT_color_buffer_float`)||O.getExtension(`EXT_color_buffer_half_float`)));!k&&typeof console<`u`&&console.info(`[L90 H1] No float colour buffer (EXT_color_buffer_float/half_float) — wave sim OFF, flat-sea fallback.`);let ee={type:i,format:e,minFilter:x,magFilter:x,wrapS:ce,wrapT:ce,depthBuffer:!1,stencilBuffer:!1},A=k?[new L(256,256,ee),new L(256,256,ee),new L(256,256,ee)]:null;if(A){for(let e of A)l.setRenderTarget(e),l.clear();l.setRenderTarget(null)}let j=new be(new Uint8Array([0,0,0,255]),1,1,e);j.needsUpdate=!0;let te=new he,ne=new s(-1,1,1,-1,0,1),M=new ie({vertexShader:In,fragmentShader:_i,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new fe(1/256,1/256)},uMouse:{value:new fe(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new z)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new z)}}});te.add(new n(new u(2,2),M));let N=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1});function P(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new U(t);return r.colorSpace=B,r}let F=new n(new u(28,28),new S({map:P(t)}));F.rotation.x=-Math.PI/2,F.position.y=-.35,_.add(F);let ae=new n(new u(40,24),new ie({depthWrite:!1,vertexShader:hi,fragmentShader:gi,uniforms:{uTime:{value:0},uInk:{value:D.horizon},uGold:{value:D.sky},uFogColor:{value:T},uFogAmt:{value:0},uFogCharm:qe}}));ae.position.set(0,3,-8),_.add(ae);let oe=new ie({vertexShader:vi,fragmentShader:yi,uniforms:{uHeight:{value:k?null:j},uScene:{value:N.texture},uTexel:{value:new fe(1/256,1/256)},uResolution:{value:new fe(p.x,p.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new v},uLightDir:{value:D.sunDir},uInk:{value:new I(`#2A2218`)},uGold:{value:new I(`#B89968`)},uVector:Ve,uVecWater:{value:new I(`#1fb8d8`)},uVecTint:{value:He}}}),se=new n(new u(28,28,255,255),oe);se.rotation.x=-Math.PI/2,se.updateMatrixWorld(!0),oe.uniforms.uNormalMatrix.value.getNormalMatrix(se.matrixWorld),_.add(se);let R={value:0},le=tn({windowGlow:R}),V=bt({seed:r,profileIndex:a,landmarkFactory:le,windowGlow:R});_.add(V.group);let ue=Nt({plinthTop:.3,extent:V.extent,profile:V.state.profile});_.add(ue.group);let de=Ut({extent:V.extent,waterSize:28,plinthTop:.3});_.add(de.group),M.uniforms.uWakeDrops.value=de.wakeDrops;let pe=rn({extent:V.extent});_.add(pe.group),M.uniforms.uRainDrops.value=pe.rainDrops;let me=on({extent:V.extent});_.add(me.group);let H=[ue,de,me],ge=ln({rig:E,getCamera:()=>E.camera,sources:H}),_e=mi();_.add(_e.group);let ve=Xr({scale:90});_.add(ve.mesh),_.environmentIntensity=.32;let ye=!1;function xe(e){let t=e&&D.sunArc.y>-.04;t!==ye&&(ye=t,ve.mesh.visible=t,ae.visible=!t)}let Se=null,we=-1;g=()=>{Se=null,we=-1,l.shadowMap.needsUpdate=!0};function Te(){let e=Math.floor(D.t%1*4)%4;return(e!==we||!Se)&&(we=e,Se=ve.buildEnv(l)),Se}let W=null,G=null,Ee=null,K=null,De=!1,Oe=1234,ke=`valley`,Ae=or.map(e=>e.key),je=new c({color:`#3f6f8c`,roughness:.07,metalness:.4,transparent:!0,opacity:.9}),Me=()=>[V.group,ue.group,de.group],Ne=()=>[W,G,Ee].filter(Boolean);function Pe(){for(let e of Ne())_.remove(e),e.userData.dispose?.();let e=dr({seed:Oe,size:160,preset:ke});K=e,W=vr(e,{worldSize:26,baseY:0,chunks:6}),G=Ur({terrain:e,seed:Oe,worldSize:26,baseY:0,biomeKeys:Ae}),Ee=Kr(e,{worldSize:26,baseY:0,maxLakes:3,material:je});for(let e of Ne())e.visible=De,_.add(e);q!==void 0&&q&&q.clear(),J!==void 0&&J&&J.clear(),typeof window<`u`&&(window.__world={seed:Oe,preset:ke,active:De,chunks:W.children.length,scatter:G.userData.counts,lakes:Ee.userData.count})}let Fe=e=>{for(let t of Ne())t.visible=e};function Ie(e,t){if(!K)return 0;let{size:n,height:r,sea:i,relief:a}=K,o=26/(n-1),s=Math.round((e+13)/o),c=Math.round((t+13)/o),l=s<0?0:s>=n?n-1:s;return(r[(c<0?0:c>=n?n-1:c)*n+l]-i)*a}let q=Pn({heightAt:Ie,seaSurfaceY:0,waterY:.06});q.group.visible=!1,_.add(q.group),H.push(q);let Le=0;function Re(e,t){if(!K||!W)return;let{size:n,height:r,relief:i}=K,a=26/(n-1),o=26/(t-1),s=i>1e-6?1/i:0,c=!1;for(let i=0;i<t;i++)for(let l=0;l<t;l++){let u=e[i*t+l];if(u===0)continue;c=!0;let d=u*s,f=l*o/a,p=i*o/a,m=Math.max(0,Math.round(f-1)),h=Math.min(n-1,Math.round(f+1)),g=Math.max(0,Math.round(p-1)),_=Math.min(n-1,Math.round(p+1));for(let e=g;e<=_;e++)for(let t=m;t<=h;t++){let i=e*n+t,a=r[i]+d;r[i]=a<0?0:a>1?1:a}}c&&(Le++,Le%8==0&&yr(W,K,W.children),Le%24==0&&G&&Hr(G,K,{worldSize:26,baseY:0}))}function ze(e,t){if(!K||!W)return;let{size:n,height:r,relief:i}=K,a=i>1e-6?1/i:0,o=(t-1)/(n-1),s=!1;for(let i=0;i<n;i++){let c=i*o,l=Math.floor(c),u=c-l,d=Math.min(t-1,l+1);for(let c=0;c<n;c++){let f=c*o,p=Math.floor(f),m=f-p,h=Math.min(t-1,p+1),g=e[l*t+p],_=e[l*t+h],v=e[d*t+p],y=e[d*t+h],b=(g*(1-m)+_*m)*(1-u)+(v*(1-m)+y*m)*u;if(b!==0){s=!0;let e=i*n+c,t=r[e]+b*a;r[e]=t<0?0:t>1?1:t}}}s&&(yr(W,K,W.children),G&&Hr(G,K,{worldSize:26,baseY:0}))}let J=Gn({worldHeightAt:Ie,applyErosion:Re,syncErodedTerrain:ze,worldSize:26,grid:96,seaY:0,renderer:l});J.group.visible=!1,_.add(J.group);let Ye=null,Xe=new Set;function Ze(){!K||!Ee||(_.remove(Ee),Ee.userData.dispose?.(),Ee=Kr(K,{worldSize:26,baseY:0,maxLakes:3,material:je}),Ee.visible=De,_.add(Ee),window.__world&&(window.__world.lakes=Ee.userData.count))}function Qe(){Ze(),G&&Hr(G,K,{worldSize:26,baseY:0})}function $e(e,t,n=1,r=2.2,i=.05){if(!K||!W)return;let a=K.size,o=26/(a-1),s=(e+13)/o,c=(t+13)/o,l=r/o,u=Math.max(0,Math.floor(s-l)),d=Math.min(a-1,Math.ceil(s+l)),f=Math.max(0,Math.floor(c-l)),p=Math.min(a-1,Math.ceil(c+l)),m=K.height,h=l*.5*2*(l*.5);for(let e=f;e<=p;e++)for(let t=u;t<=d;t++){let r=(t-s)*(t-s)+(e-c)*(e-c);if(r>l*l)continue;let o=m[e*a+t]+n*i*Math.exp(-r/h);m[e*a+t]=o<0?0:o>1?1:o}Xe.clear();for(let e of W.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Xe.add(e)}yr(W,K,Xe),Ye&&clearTimeout(Ye),Ye=setTimeout(Qe,140)}function et(e,t,n,r=2.2){if(!K||!W||n==null)return;let i=K.size,a=26/(i-1),o=(e+13)/a,s=(t+13)/a,c=r/a,l=c*c,u=Math.max(0,Math.floor(o-c)),d=Math.min(i-1,Math.ceil(o+c)),f=Math.max(0,Math.floor(s-c)),p=Math.min(i-1,Math.ceil(s+c)),m=K.biome;for(let e=f;e<=p;e++)for(let t=u;t<=d;t++)(t-o)*(t-o)+(e-s)*(e-s)<=l&&(m[e*i+t]=n);Xe.clear();for(let e of W.children){let t=e.userData.chunk;t&&t.i0<=d&&t.i1>=u-1&&t.j0<=p&&t.j1>=f-1&&Xe.add(e)}yr(W,K,Xe,!0)}let Y=[`tree`,`rock`,`tuft`];function nt(e,t,{type:n=`tree`,density:r=.5,radius:i=2.2,erase:a=!1}={}){if(!K||!G)return 0;if(a)return Br(G,n||`all`,e,t,i);let o=K.size,s=26/(o-1),c=K.height,l=K.sea,u=K.relief,d=e=>e<0?0:e>=o?o-1:e,f=(e,t)=>c[d(Math.round((t+13)/s))*o+d(Math.round((e+13)/s))],p=(e,t)=>{let n=Math.max(1,Math.min(o-2,Math.round((e+13)/s))),r=Math.max(1,Math.min(o-2,Math.round((t+13)/s))),i=(c[r*o+n+1]-c[r*o+n-1])*u/(2*s),a=(c[(r+1)*o+n]-c[(r-1)*o+n])*u/(2*s);return Math.hypot(i,a)},m=Vr[n]??1.2,h=Math.max(1,Math.round((r||.5)*6)),g=0;for(let r=0;r<h;r++){let r=Math.random()*Math.PI*2,a=Math.sqrt(Math.random())*i,o=e+Math.cos(r)*a,s=t+Math.sin(r)*a,c=f(o,s);if(c<l+.005||p(o,s)>m)continue;let d=(c-l)*u;zr(G,n,o,d,s,.7+Math.random()*.6,Math.random()*Math.PI*2,.82+Math.random()*.36)&&g++}if(window.__world&&G.userData.counts)for(let e of Y)G.userData.counts[e]=(G.userData.placements[e]||[]).length;return g}let rt=[];function it(){if(!G)return null;let e=G.userData.placements,t={};for(let n of Y)t[n]=(e[n]||[]).map(e=>({...e}));return t}function at(){K&&(rt.push({h:K.height.slice(),b:K.biome.slice(),sc:it(),pl:q.snapshot()}),rt.length>12&&rt.shift())}function ot(){if(!K||!rt.length)return!1;let e=rt.pop();if(K.height.set(e.h),K.biome.set(e.b),e.sc&&G){let t=G.userData.placements;for(let n of Y)t[n]=(e.sc[n]||[]).map(e=>({...e}))}return e.pl&&q.restore(e.pl),yr(W,K,W.children,!0),Qe(),!0}let st=new Set([`boat`,`fish`]),ct=new Set([`person`,`atv`]);function lt(e,t,n){if(!K)return null;let r=Ie(t,n)<0;return st.has(e)&&!r||ct.has(e)&&r?null:q.spawn(e,t,n)}function ut(e,t,n=2.5){return q.removeNear(e,t,n)}function dt(e){let t=``,n=32768;for(let r=0;r<e.length;r+=n)t+=String.fromCharCode.apply(null,e.subarray(r,Math.min(r+n,e.length)));return btoa(t)}function ft(e){let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}let pt=e=>dt(new Uint8Array(e.buffer,e.byteOffset,e.byteLength)),mt=e=>dt(e);function ht(){let e=G?G.userData.placements:{},t={};for(let n of Y)t[n]=(e[n]||[]).map(e=>({...e}));return t}function gt(){return K?{v:1,seed:Oe,preset:ke,size:K.size,height:pt(K.height),biome:mt(K.biome),scatter:ht(),entities:q.snapshot()}:null}function _t(){if(!K)return null;let e=dr({seed:Oe,size:160,preset:ke}),t=K.height,n=K.biome,r=[],i=[];for(let n=0;n<t.length;n++)Math.abs(t[n]-e.height[n])>1e-6&&r.push(n,Math.round(t[n]*1e4)/1e4);for(let t=0;t<n.length;t++)n[t]!==e.biome[t]&&i.push(t,n[t]);return{v:1,c:1,seed:Oe,preset:ke,hd:r,bd:i,entities:q.snapshot()}}function vt(e){G&&(_.remove(G),G.userData.dispose?.()),G=Fr(e||{tree:[],rock:[],tuft:[]}),G.userData.counts=Y.reduce((e,t)=>(e[t]=(G.userData.placements[t]||[]).length,e),{}),G.visible=De,_.add(G)}function yt(e){if(!e||e.v!==1)return!1;let t=25600;if(e.height!=null||e.biome!=null){if(typeof e.height!=`string`||typeof e.biome!=`string`)return!1;let n,r;try{n=ft(e.height),r=ft(e.biome)}catch{return!1}if(n.byteLength%4!=0||n.byteLength>>2!=t||r.length<t)return!1;let i=new Float32Array(n.buffer,n.byteOffset,n.byteLength>>2);for(let e=0;e<i.length;e++)if(!Number.isFinite(i[e]))return!1}if(e.hd!=null&&!Array.isArray(e.hd)||e.bd!=null&&!Array.isArray(e.bd))return!1;if(Array.isArray(e.hd))for(let n=0;n<e.hd.length;n+=2){let r=e.hd[n];if(!Number.isInteger(r)||r<0||r>=t||!Number.isFinite(e.hd[n+1]))return!1}if(Array.isArray(e.bd))for(let n=0;n<e.bd.length;n+=2){let r=e.bd[n];if(!Number.isInteger(r)||r<0||r>=t)return!1}Oe=e.seed|0,ke=ur.includes(e.preset)?e.preset:ke,rt.length=0,Pe(),De=!0,Fe(!0),q.group.visible=!0,J.group.visible=!0;for(let e of Me())e.visible=!1;window.__world&&(window.__world.active=!0);let n=e=>e<0?0:e>1?1:e,r=or.length;if(e.height&&e.biome){let t=ft(e.height),i=new Float32Array(t.buffer,t.byteOffset,t.byteLength>>2);for(let e=0;e<i.length;e++)K.height[e]=n(i[e]);let a=ft(e.biome);for(let e=0;e<K.biome.length;e++)K.biome[e]=Math.min(r-1,a[e]|0)}else if(e.hd||e.bd){let t=e.hd||[],i=e.bd||[];for(let e=0;e<t.length;e+=2)K.height[t[e]]=n(t[e+1]);for(let e=0;e<i.length;e+=2)K.biome[i[e]]=Math.min(r-1,Math.max(0,i[e+1]|0))}return yr(W,K,W.children,!0),e.scatter&&vt(e.scatter),Ze(),G&&Hr(G,K,{worldSize:26,baseY:0}),q.restore(e.entities),window.__world&&(window.__world.scatter=G.userData.counts,window.__world.seed=Oe,window.__world.preset=ke),!0}let xt={enter(){W||Pe(),De=!0,Fe(!0),q.group.visible=!0,J.group.visible=!0;for(let e of Me())e.visible=!1;window.__world&&(window.__world.active=!0)},exit(){De=!1,Fe(!1),q.group.visible=!1,J.group.visible=!1;for(let e of Me())e.visible=!0;window.__world&&(window.__world.active=!1)},reroll(){return Oe=Math.random()*1e9|0,rt.length=0,Pe(),xt.enter(),Oe},reset(){return rt.length=0,Pe(),xt.enter(),Oe},setPreset(e){return ur.includes(e)&&(ke=e,rt.length=0,Pe(),xt.enter()),ke},sculpt:$e,paintBiome:et,paintScatter:nt,repoolWater:Ze,snapshot:at,undo:ot,placeEntity:lt,removeEntityNear:ut,heightAt:Ie,serialize:gt,serializeCompact:_t,deserialize:yt,flowPourAt:(e,t,n,r)=>J.pourAt(e,t,n,r),flowRain:e=>J.rain(e),flowClear:()=>J.clear(),get flowTotal(){return J.totalWater()},flowAt:(e,t)=>J.cellAt(e,t),flowErosion:(e,t)=>J.setErosion(e,t),get flowErosionOn(){return J.erosion},get flowSediment(){return J.totalSediment()},setSimBackend:e=>J.setBackend(e),get simBackend(){return J.backend},_flowReadW:()=>J._debugReadW(),_flowReadTerr:()=>J._debugReadTerr(),_flowStepN:(e,t)=>J._debugStepN(e,t),get terrainGroup(){return W},get biomes(){return or},get scatterCounts(){return G?G.userData.placements&&Y.reduce((e,t)=>(e[t]=(G.userData.placements[t]||[]).length,e),{}):null},get placedCounts(){return q.counts()},setScatterHidden(e){G&&(G.visible=!e)},get placedLife(){return q},get canUndo(){return rt.length>0},get active(){return De},get seed(){return Oe},get preset(){return ke},get presets(){return ur}},St=Jr(),Ct=Xn({world:xt,catalog:St,inspector:ge});function wt(e,t){return Ie(e,t)<0?0:-999}let Tt=xn({rig:E,world:{heightAt:Ie,waterHeightAt:wt}});V.group.remove(V.key),_.add(V.key),V.key.castShadow=!0,V.key.shadow.mapSize.set(2048,2048),V.key.shadow.bias=-18e-5,V.key.shadow.normalBias=.028,_.add(V.key.target);function Et(){let e=V.key.shadow.camera,t=V.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),l.shadowMap.needsUpdate=!0}Et();let Dt=new Ce(p.x,p.y),kt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1,depthTexture:Dt}),At=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),jt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!0,stencilBuffer:!1,samples:4}),Mt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Pt=new L(p.x,p.y,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Ft=Math.max(1,Math.floor(p.x/2)),It=Math.max(1,Math.floor(p.y/2)),Lt=new L(Ft,It,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),Rt=new L(Ft,It,{minFilter:o,magFilter:o,depthBuffer:!1,stencilBuffer:!1}),zt=new he,Bt=new s(-1,1,1,-1,0,1),Vt=new n(new u(2,2));zt.add(Vt);let X=new ie({vertexShader:In,fragmentShader:bi,uniforms:{uScene:{value:kt.texture},uTime:{value:0},uResolution:{value:new fe(p.x,p.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1},uAces:{value:0},uBloom:{value:Lt.texture},uBloomStrength:{value:0},uGrade:{value:0},uGradeTint:{value:D.grade.tint},uGradeLift:{value:D.grade.lift},uGradeSat:{value:1},uGradeContrast:{value:1},uDither:{value:0},uTonemap:{value:0}}}),Ht=new ie({vertexShader:In,fragmentShader:wi,uniforms:{uScene:{value:kt.texture},uThreshold:{value:.78}}}),Wt=new ie({vertexShader:In,fragmentShader:Ti,uniforms:{uScene:{value:Lt.texture},uDir:{value:new fe}}});function Gt(e){Ht.uniforms.uScene.value=e.texture,$t(Ht,Lt),Wt.uniforms.uScene.value=Lt.texture,Wt.uniforms.uDir.value.set(1.6/Ft,0),$t(Wt,Rt),Wt.uniforms.uScene.value=Rt.texture,Wt.uniforms.uDir.value.set(0,1.6/It),$t(Wt,Lt),X.uniforms.uBloom.value=Lt.texture;let t=1-f.clamp(D.sunArc.y*2.2,0,1);X.uniforms.uBloomStrength.value=.85*(.32+.95*t)}let Kt=e=>{let t=e.map(e=>new I(e));for(;t.length<8;)t.push(new I(0,0,0));return t},Z=[`night`,`dawn`,`noon`,`dusk`],qt={inkgold:Z.map(e=>Kt(ji[e])),terminal:Z.map(e=>Kt(Mi[e]))},Jt=new ie({vertexShader:In,fragmentShader:xi,uniforms:{uScene:{value:At.texture},uResolution:{value:new fe(p.x,p.y)},uPixelSize:{value:Ai},uPalette:{value:qt.inkgold[2]},uPaletteB:{value:qt.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),Yt=new ie({vertexShader:In,fragmentShader:Ei,uniforms:{uScene:{value:At.texture},uResolution:{value:new fe(p.x,p.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:ki(Di[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Xt={};for(let e of Oi)Xt[e]=Di[e].palette?ki(Di[e].palette):null;let Zt=new ie({vertexShader:In,fragmentShader:Si,uniforms:{uScene:{value:At.texture},uDepth:{value:Dt},uResolution:{value:new fe(p.x,p.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:D.toonFloor},uOutline:{value:D.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Qt=new ie({vertexShader:In,fragmentShader:Ci,uniforms:{uToon:{value:Mt.texture},uPixel:{value:Pt.texture},uBlend:{value:0}}});function $t(e,t){Vt.material=e,l.setRenderTarget(t),l.render(zt,Bt)}function en(){E.setViewport(window.innerWidth,window.innerHeight),l.setSize(window.innerWidth,window.innerHeight);let e=l.getDrawingBufferSize(new fe);return N.setSize(e.x,e.y),kt.setSize(e.x,e.y),At.setSize(e.x,e.y),jt.setSize(e.x,e.y),Mt.setSize(e.x,e.y),Pt.setSize(e.x,e.y),Ft=Math.max(1,e.x>>1),It=Math.max(1,e.y>>1),Lt.setSize(Ft,It),Rt.setSize(Ft,It),oe.uniforms.uResolution.value.set(e.x,e.y),X.uniforms.uResolution.value.set(e.x,e.y),Jt.uniforms.uResolution.value.set(e.x,e.y),Yt.uniforms.uResolution.value.set(e.x,e.y),Zt.uniforms.uResolution.value.set(e.x,e.y),e}let nn=$n({renderer:l}),an=!0;function sn(e,t){let n=t.dpr==null?d:t.dpr,r=Math.min(window.devicePixelRatio,n);Math.abs(l.getPixelRatio()-r)>.001&&(l.setPixelRatio(r),typeof window<`u`&&window.dispatchEvent?window.dispatchEvent(new Event(`resize`)):en()),an=t.shadows!==!1,an||(l.shadowMap.needsUpdate=!1)}let cn=tr({profiler:nn,apply:sn});function un(){!h&&!m&&nn.frameStart()}function dn(){h||m||(nn.frameEnd(),cn.update())}function fn(e){h=!e,typeof window<`u`&&(window.__paused=h)}function pn(){try{l.compile(_,E.camera),Ln(1/60,0,{shadowsOn:!0}),jn(Mn(),kt),l.setRenderTarget(null)}catch(e){typeof console<`u`&&console.warn(`[L79] prewarm`,e)}}let mn=3,hn=!1,gn=!1,_n=`native`,vn=.3,yn=.46,bn=[`native`,...Oi],Sn={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=mn,window.__vector=hn,window.__era=_n),typeof window<`u`&&(window.__frames=0),typeof window<`u`&&(window.__loaded=!1);let Cn=0,wn=new z(1,1,1),Tn=!1;function En(e){let t=gn?qt.terminal:qt.inkgold,n=e%1*4,r=Math.floor(n)%4;Jt.uniforms.uPalette.value=t[r],Jt.uniforms.uPaletteB.value=t[(r+1)%4],Jt.uniforms.uPaletteBlend.value=n-Math.floor(n)}function Dn(e){let t=Di[e];t&&(Yt.uniforms.uGridWidth.value=t.gridWidth,Yt.uniforms.uDither.value=t.dither,Yt.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(Yt.uniforms.uPalette.value=Xt[e],Yt.uniforms.uPaletteSize.value=t.palette.length))}function On(){_n!==`native`&&Dn(_n)}let kn=()=>_n===`native`?Jt:Yt;function An(e,t){xe(!0),_.environment=Te(),tt.value=1,se.visible=!1,l.setRenderTarget(N),l.render(_,e),se.visible=!0,l.setRenderTarget(jt),l.render(_,e),Gt(jt),X.uniforms.uScene.value=jt.texture,X.uniforms.uAces.value=1,X.uniforms.uGrade.value=1,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=1,$t(X,t)}function jn(e,t){let n=!hn&&(mn===1||mn===2);if(xe(n),_.environment=n?Te():null,tt.value=+!!n,X.uniforms.uBloomStrength.value=0,se.visible=!1,l.setRenderTarget(N),l.render(_,E.camera),se.visible=!0,mn===1&&!n)l.setRenderTarget(t),l.render(_,E.camera);else if(mn===1)l.setRenderTarget(jt),l.render(_,E.camera),Gt(jt),X.uniforms.uScene.value=jt.texture,X.uniforms.uAces.value=1,X.uniforms.uGrade.value=1,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=1,$t(X,t);else if(l.setRenderTarget(n?jt:kt),l.render(_,E.camera),mn===2)n&&Gt(jt),X.uniforms.uScene.value=n?jt.texture:kt.texture,X.uniforms.uAces.value=+!!n,X.uniforms.uGrade.value=+!!n,X.uniforms.uGrain.value=1,X.uniforms.uChroma.value=1,X.uniforms.uDither.value=+!!n,$t(X,t);else{X.uniforms.uScene.value=kt.texture,X.uniforms.uAces.value=0,X.uniforms.uGrade.value=0,X.uniforms.uGrain.value=0,X.uniforms.uChroma.value=0,X.uniforms.uDither.value=0,$t(X,At);let n=E.camera;Zt.uniforms.uNear.value=n.near,Zt.uniforms.uFar.value=n.far,Zt.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(Dn(e.era),Yt):kn();e.kind===`pixel`?($t(r,t),window.__style=`pixel`):e.kind===`toon`?($t(Zt,t),window.__style=`toon`):($t(Zt,Mt),$t(r,Pt),Qt.uniforms.uBlend.value=e.blend,$t(Qt,t),window.__style=`blend`)}}function Mn(){let e=Nn(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return oe.uniforms.uChromaScale.value=f.lerp(1,.5,t),e}function Nn(){if(mn===1||mn===2)return{kind:`none`};if(mn===7)return{kind:`pixel`};if(mn===8)return{kind:`toon`};let e=E.styleT;return window.__styleT=e,e<=vn?{kind:`toon`}:e>=yn?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:f.smoothstep(e,vn,yn),era:`16-bit`}}function Fn(e){return mn===1||mn===2?``:hn&&mn!==7&&mn!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Sn[e.era||_n]||`Pixel`:e.kind===`blend`?`Toon → `+(Sn[e.era]||`Pixel`):``}function Ln(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){typeof window<`u`&&window.__frames++,n&&=an,ae.material.uniforms.uTime.value=t,X.uniforms.uTime.value=t,D.update(e),V.key.position.copy(D.sunDir).multiplyScalar(24),V.key.color.copy(D.sunColor),V.key.intensity=D.sunIntensity,V.fill.color.copy(D.hemiSky),V.fill.groundColor.copy(D.hemiGround),R.value=D.windowGlow,ve.setSun(D.sunArc),ve.setParams(D.skyParams),X.uniforms.uGradeSat.value=D.grade.sat,X.uniforms.uGradeContrast.value=D.grade.contrast,_.environmentIntensity=.34*(1-.6*f.clamp(D.sunArc.y*1.5,0,1));let i=pe.overcast;V.key.intensity*=1-.5*i,V.key.color.lerp(y,.45*i),V.fill.intensity=1+.7*i;let a=f.smoothstep(D.sunDir.y,.06,.34),o=f.lerp(.28,1,1-D.windowGlow),s=n?a*o:0;V.key.shadow.intensity=.72*s,Ue.value=.52*s,(n&&!Tn||wn.distanceToSquared(D.sunDir)>2e-5)&&(l.shadowMap.needsUpdate=!0,wn.copy(D.sunDir)),Tn=n;let c=1-D.windowGlow;He.setRGB(f.lerp(.46,1,c),f.lerp(.52,1,c),f.lerp(.74,1,c)),X.uniforms.uExposure.value=D.exposure,Zt.uniforms.uToonGain.value=D.toonGain,l.setClearColor(D.horizon,1),En(D.t),window.__t=D.t,ue.update(e,t,D),V.update(t),de.update(e,t,D),M.uniforms.uWakeCount.value=de.wakeCount,pe.update(e,t),M.uniforms.uRainCount.value=pe.rainDropCount;let u=pe.fog*(1-c);_.fog.density=.016+pe.fog*C,T.copy(D.horizon).lerp(w,.85*u),_.fog.color.copy(T),l.setClearColor(T,1),qe.value=pe.fog,ae.material.uniforms.uFogAmt.value=.7*pe.fog,We.value=pe.snow,Ge.value=pe.cloud*.55,Ke.x+=e*.018,Ke.y+=e*.009,Je.value+=(r-Je.value)*Math.min(1,e*1.5),me.update(e,t,D,pe),De&&q.update(e,t,D),De&&J.step(e);let d=Nn(),p=d.kind===`pixel`||d.kind===`blend`?`pixel`:hn?`vector`:d.kind===`toon`?`charm`:`realistic`;if(_e.update(e,t,D,pe,p,E.camera),k){let[e,t,n]=A;M.uniforms.uPrev.value=e.texture,M.uniforms.uCurr.value=t.texture,l.setRenderTarget(n),l.render(te,ne),A=[t,n,e],oe.uniforms.uHeight.value=A[1].texture}if(Cn<2&&typeof document<`u`&&++Cn===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function Rn(e){mn=e,window.__mode=mn}function zn(){return hn=!hn,Ve.value=+!!hn,window.__vector=hn,hn}function Bn(e){return hn=!!e,Ve.value=+!!hn,window.__vector=hn,hn}function Vn(){return _n=bn[(bn.indexOf(_n)+1)%bn.length],window.__era=_n,On(),_n}function Hn(){return gn=!gn,gn}return{updateWorld:Ln,decideStyle:Mn,renderCityPipeline:jn,renderCityBeautyTo:An,styleHintName:Fn,setPostMode:Rn,toggleVector:zn,setVector:Bn,cycleEra:Vn,togglePalette:Hn,setTonemap:e=>{let t=e===`agx`||e===1||e===!0;return X.uniforms.uTonemap.value=+!!t,typeof window<`u`&&(window.__tonemap=t?`agx`:`aces`),t?`agx`:`aces`},get mode(){return mn},get vector(){return hn},get sceneEra(){return _n},renderer:l,drawBuffer:p,scene:_,rig:E,sunRig:D,SIM:256,targets:A,simScene:te,simCamera:ne,simMaterial:M,grabRT:N,card:F,backdrop:ae,WATER_SIZE:28,water:se,waterMaterial:oe,windowGlow:R,landmarkFactory:le,city:V,cityLife:ue,waterLife:de,weatherRig:pe,clouds:me,inspector:ge,world:xt,catalog:St,editor:Ct,pilot:Tt,profiler:nn,governor:cn,frameStart:un,frameEnd:dn,setActive:fn,get paused(){return h},get contextLost(){return m},prewarm:pn,fitShadowFrustum:Et,SHADOW_DIST:24,sceneDepth:Dt,sceneRT:kt,filmicRT:At,toonRT:Mt,pixelRT:Pt,postScene:zt,postCamera:Bt,postQuad:Vt,filmicMaterial:X,pixelMaterial:Jt,pixelkitMaterial:Yt,toonMaterial:Zt,mixMaterial:Qt,PALCACHE:qt,ERA_TEX:Xt,runPass:$t,OVERCAST_GREY:y,FOG_DENSITY:C,FOG_NIGHT_TINT:w,_fogColor:T,resize:en}}var Fi=`lgr_hints_`,Ii=!1;function Li(){if(Ii||typeof document>`u`)return;Ii=!0;let e=document.createElement(`style`);e.textContent=`
  ...
  `,document.head.appendChild(e);let t=document.createElement(`div`);t.className=`lap`,t.innerHTML=`<div class="lap-win"><div class="lap-bar"><b>PORTFOLIO OS — John's Game</b>
    ...
    </div></div>`;let n=document.createElement(`div`);n.className=`otoast`;let r=document.createElement(`div`);r.className=`oflash`,document.body.append(t,n,r),t.querySelector(`.lap-x`).addEventListener(`click`,()=>Ua()),t.addEventListener(`click`,e=>{e.target===t&&Ua()}),t.addEventListener(`click`,e=>{e.target.closest(`button`)&&navigator.vibrate?.(10)});let i=0;return{showLap(e){t.classList.toggle(`on`,e)},toast(e){n.textContent=e,n.classList.add(`on`),clearTimeout(i),i=setTimeout(()=>n.classList.remove(`on`),1400)},flash(){r.style.transition=`none`,r.style.opacity=`0.85`,requestAnimationFrame(()=>{r.style.transition=`opacity .55s`,r.style.opacity=`0`})}}})();function Ha(){Ba=!0,Va.showLap(!0)}function Ua(){Ba=!1,Va.showLap(!1)}function Wa(){da=(da+1)%ct.length,Va.flash(),ga.generate(ua,da),va.uniforms.uVecWater.value.set(ga.waterColor),_a.setProfile(ga.state.profile),ya(),Va.toast(`✈  `+ga.state.profile.name),window.__profile=ga.state.profile.key}function Ga(e){let t=$.setFitout(e);return Va.toast(t===`basement`?`🏚  Basement office`:`🏙  Corner office`),window.__tier=t,t}function Ka(){return Ga($.tier===`corner`?`basement`:`corner`)}window.__tier=$.tier;var qa=[`3d`,`dressed2`,`night2`,`modern`,`charm`],Ja={"3d":`🧊  Stylized 3D office`,dressed2:`📚  Dressed office (day)`,night2:`🌙  Night office`,modern:`🏙  Modern office (day)`,charm:`🎨  Charm office`};function Ya(e){let t=$.setSkin(e);return window.__officeSkin=t,Va.toast(Ja[t]),t}function Xa(){return Ya(qa[(qa.indexOf($.skin)+1)%qa.length])}window.__officeSkin=$.skin;var Za={painted:`🎨  Painted props (cohesive)`,"3d":`🧊  Live 3D props (animated)`};function Qa(e){let t=$.setProps(e);return window.__officeProps=t,$.skin!==`3d`&&Va.toast(Za[t]),t}function $a(){return Qa($.props===`painted`?`3d`:`painted`)}window.__officeProps=$.props;var eo={corner:`🏙  Corner window`,"straight-on":`🖼  Straight-on window`};function to(e){let t=$.setLayout(e);return window.__officeLayout=t,Va.toast(eo[t]),t}function no(){return to($.layout===`corner`?`straight-on`:`corner`)}window.__officeLayout=$.layout;var ro=new M,io=new fe,ao=(e,t)=>{io.x=e/window.innerWidth*2-1,io.y=-(t/window.innerHeight)*2+1};function oo(){ro.setFromCamera(io,$.camera);let e=ro.intersectObjects($.interactables,!0)[0];if(!e)return null;let t=e.object;for(;t&&!t.userData.role;)t=t.parent;return t?t.userData.role:null}function so(e){e===`laptop`?Ha():e===`phone`?Wa():e===`cat`?$.petCat():e===`tank`&&$.feedFish()}var co=6,lo=0,uo=0,fo=0,po=0,mo=0,ho=!1,go=!1;pa.domElement.style.cursor=`grab`,pa.domElement.addEventListener(`mousedown`,e=>{ho=!0,go=!1,lo=po=e.clientX,uo=mo=e.clientY,fo=performance.now()}),window.addEventListener(`mousemove`,e=>{ho?(!go&&Math.hypot(e.clientX-lo,e.clientY-uo)>co&&(go=!0),go&&($.look.addDrag(e.clientX-po,e.clientY-mo),pa.domElement.style.cursor=`grabbing`),po=e.clientX,mo=e.clientY):(ao(e.clientX,e.clientY),pa.domElement.style.cursor=oo()?`pointer`:`grab`)}),window.addEventListener(`mouseup`,e=>{if(ho&&!go&&!Ba){ao(e.clientX,e.clientY);let t=oo();t&&so(t)}ho=!1,go=!1,pa.domElement.style.cursor=`grab`});var _o=!1;pa.domElement.addEventListener(`touchstart`,e=>{e.touches.length===1&&(lo=po=e.touches[0].clientX,uo=mo=e.touches[0].clientY,fo=performance.now(),_o=!1)},{passive:!0}),pa.domElement.addEventListener(`touchmove`,e=>{if(e.touches.length!==1)return;let t=e.touches[0].clientX,n=e.touches[0].clientY;!_o&&Math.hypot(t-lo,n-uo)>8&&(_o=!0),_o&&$.look.addDrag(t-po,n-mo),po=t,mo=n},{passive:!0}),window.addEventListener(`touchend`,e=>{if(!_o&&performance.now()-fo<350&&(!e.touches||e.touches.length===0)&&!Ba){let e=oo();e&&so(e)}_o=!1});var vo=0,yo=e=>Math.hypot(e.touches[0].clientX-e.touches[1].clientX,e.touches[0].clientY-e.touches[1].clientY);pa.domElement.addEventListener(`touchstart`,e=>{e.touches.length===2&&(vo=yo(e))},{passive:!0}),pa.domElement.addEventListener(`touchmove`,e=>{if(e.touches.length!==2)return;e.preventDefault();let t=yo(e);vo>0&&t>0&&($.camera.fov=Math.max(32,Math.min(72,$.camera.fov*(vo/t))),$.camera.updateProjectionMatrix()),vo=t},{passive:!1}),window.addEventListener(`touchend`,e=>{(!e.touches||e.touches.length<2)&&(vo=0)});var bo={left:!1,right:!1,up:!1,down:!1},xo={ArrowLeft:`left`,ArrowRight:`right`,ArrowUp:`up`,ArrowDown:`down`};window.addEventListener(`keydown`,e=>{if(xo[e.key]){bo[xo[e.key]]=!0,e.preventDefault();return}e.key===`Escape`&&(Ba?Ua():$.look.recenter()),(e.key===`f`||e.key===`F`)&&Ka(),(e.key===`j`||e.key===`J`)&&Xa(),(e.key===`u`||e.key===`U`)&&$a(),(e.key===`t`||e.key===`T`)&&ha.cyclePreset(),(e.key===`h`||e.key===`H`)&&(Sa=!Sa,window.__shadows=Sa),(e.key===`w`||e.key===`W`)&&no()}),window.addEventListener(`keyup`,e=>{xo[e.key]&&(bo[xo[e.key]]=!1)}),ba.whenReady.then(()=>{ga.generate(ua,da),ya(),window.__cityReady=!0}),ca.get(`office`)===`basement`&&Ga(`basement`);var So=ca.get(`officeskin`);qa.includes(So)&&Ya(So);var Co=ca.get(`officeprops`);[`painted`,`3d`].includes(Co)&&Qa(Co);var wo=ca.get(`officelayout`);[`corner`,`straight-on`].includes(wo)&&to(wo);var To=new sa;To.connect(document);function Eo(){To.update(),fa.frameStart();let e=Math.min(To.getDelta(),.1);ma.update(e),fa.updateWorld(e,To.getElapsed(),{shadowsOn:Sa,seasonTarget:0}),$.look.addKeys(e,bo),$.update(e,To.getElapsed(),ha),window.__lookYaw=$.look.yaw,window.__lookPitch=$.look.pitch,$.tier===`basement`?(pa.setRenderTarget(za),pa.render($.vignette.scene,$.vignette.camera)):La%Ra===0&&($.layout===`straight-on`?xa(Fa,Ia):(xa(ja,Na),xa(Ma,Pa),$.skin!==`3d`&&xa(Fa,Ia))),La++,pa.setRenderTarget(null),pa.render($.scene,$.camera),fa.frameEnd(),requestAnimationFrame(Eo)}Eo(),Ri({key:`office`,title:`The Office`,tips:[`Drag to look around the office (or use the arrow keys)`,`Click / tap the LAPTOP to open the game panel`,`Tap the PHONE to travel to another city · pet the CAT · feed the FISH`,`Esc exits · F fitout · J skin · U props · W window · T time`]}),window.addEventListener(`resize`,()=>{fa.resize(),$.camera.aspect=window.innerWidth/window.innerHeight,$.camera.updateProjectionMatrix()});