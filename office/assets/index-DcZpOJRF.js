import{$ as e,A as t,B as n,C as r,D as i,E as a,F as o,G as s,H as c,I as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,Q as _,R as v,S as y,T as b,U as x,V as S,W as C,X as w,Y as T,Z as E,_ as ee,a as D,b as te,c as O,d as k,et as A,f as ne,g as re,h as j,i as M,j as N,k as P,l as ie,m as ae,n as oe,nt as F,o as I,p as L,q as se,r as ce,s as le,t as R,tt as z,u as ue,v as de,w as fe,x as pe,y as me,z as B}from"./three-D0DmFcFN.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var he=Math.atan(1/Math.SQRT2),ge=Math.atan(.5),_e=Math.PI/4,V={PERSPECTIVE:4,ISOMETRIC:5,DIMETRIC:6},ve=.12,ye=1.45,be=4,xe=40,Se=1.5,Ce=16,we=6,H=22,Te=3.5,U=11,Ee=(e,t,n)=>e+(t-e)*(1-Math.exp(-8*n)),De=(e,t)=>e+Math.PI*2*Math.round((t-e)/(Math.PI*2));function Oe({aspect:e,fov:t=48,near:n=.1,far:r=100,target:i=new z(0,.8,0),azimuth:a=_e,elevation:o=.52,distance:s=12,zoom:c=5.5}={}){let u=new v(t,e,n,r),d=new l(-1,1,1,-1,n,r),f=V.PERSPECTIVE,p=e,m={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},h={azimuth:a,elevation:o,distance:s,zoom:c,target:i.clone()},g=!1,_=()=>f===V.PERSPECTIVE?u:d;function y(e){e!==f&&(f=e,f===V.ISOMETRIC||f===V.DIMETRIC?(m.elevation=f===V.ISOMETRIC?he:ge,m.azimuth=De(_e,h.azimuth),g=!0):g=!1)}function b(e,t){m.azimuth+=e,g||(m.elevation=P.clamp(m.elevation+t,ve,ye))}function x(e){f===V.PERSPECTIVE?m.distance=P.clamp(m.distance*e,be,xe):m.zoom=P.clamp(m.zoom*e,Se,Ce)}function S(e,t){let n=m.azimuth,r=f===V.PERSPECTIVE?m.distance*.04:m.zoom*.08,i=new z(Math.cos(n),0,-Math.sin(n)),a=new z(-Math.sin(n),0,-Math.cos(n));m.target.addScaledVector(i,e*r),m.target.addScaledVector(a,t*r)}function C(e,t){p=e/t,u.aspect=p,u.updateProjectionMatrix()}function w(e){h.azimuth=Ee(h.azimuth,m.azimuth,e),h.elevation=Ee(h.elevation,m.elevation,e),h.distance=Ee(h.distance,m.distance,e),h.zoom=Ee(h.zoom,m.zoom,e),h.target.x=Ee(h.target.x,m.target.x,e),h.target.y=Ee(h.target.y,m.target.y,e),h.target.z=Ee(h.target.z,m.target.z,e);let t=Math.cos(h.elevation),n=Math.sin(h.elevation),r=Math.cos(h.azimuth),i=Math.sin(h.azimuth),a=_();if(a.position.set(h.target.x+h.distance*t*i,h.target.y+h.distance*n,h.target.z+h.distance*t*r),a.lookAt(h.target),a.isOrthographicCamera){let e=h.zoom,t=e*p;a.left=-t,a.right=t,a.top=e,a.bottom=-e,a.updateProjectionMatrix()}}function T(e,t,n,r=!1){m.target.set(e,t,n),r&&h.target.copy(m.target)}function E(e,t=!1){m.zoom=P.clamp(e,Se,Ce),t&&(h.zoom=m.zoom)}return{get camera(){return _()},get mode(){return f},get azimuth(){return h.azimuth},setTarget:T,setZoom:E,get styleT(){return f===V.PERSPECTIVE?P.clamp((h.distance-we)/(H-we),0,1):P.clamp((h.zoom-Te)/(U-Te),0,1)},setMode:y,orbit:b,zoomBy:x,pan:S,setViewport:C,update:w}}var ke={value:0},Ae=new L(`#ffffff`),je={value:0},Me={value:0},Ne={value:0},Pe=new A,Fe={value:0},Ie={value:0},Le=`
  varying vec3 vVecN;
  varying vec3 vVecP;
...
#include <shadowmask_pars_fragment>`)}var ze=`col *= mix(1.0, getShadowMask(), uVecShadow);`;function Be(e,{color:t,id:n,windowGlow:r,winColors:i=[`#ffb852`,`#8cd9ff`],litFrac:a=.55}={}){let o=[0,1,2].map(e=>new L(i[e]??i[i.length-1]));return e.customProgramCacheKey=()=>`lgr-vec-tower`,e.onBeforeCompile=e=>{W(e),e.uniforms.uWindowGlow=r,e.uniforms.uWinId={value:n},e.uniforms.uVecColor={value:new L(t)},e.uniforms.uWinA={value:o[0]},e.uniforms.uWinB={value:o[1]},e.uniforms.uWinC={value:o[2]},e.uniforms.uWinLit={value:a},e.vertexShader=K(e.vertexShader),e.fragmentShader=G(Re(e.fragmentShader.replace(`#include <common>`,`#include <common>
        ...
        }`)))},e}function q(e,{color:t=null,glow:n=null,glowDay:r=0,glowNight:i=1,windowGlow:a=null,season:o=!1}={}){let s=t===null,c=n!==null&&a!==null;return e.customProgramCacheKey=()=>`lgr-vec|`+(s?`d`:`c`)+(c?`g`:``)+(o?`s`:``),e.onBeforeCompile=e=>{W(e),s||(e.uniforms.uVecColor={value:new L(t)}),c&&(e.uniforms.uGlow={value:new L(n)},e.uniforms.uGlowDay={value:r},e.uniforms.uGlowNight={value:i},e.uniforms.uWindowGlow=a),o&&(e.uniforms.uSeason=Ie),e.vertexShader=K(e.vertexShader);let l=s?`diffuseColor.rgb`:`uVecColor`,u=o?`seasonShift(${l})`:l,d=(s?``:`uniform vec3 uVecColor;
...
`:``),f=c?`uGlow * mix(uGlowDay, uGlowNight, uWindowGlow)`:`vec3(0.0)`,p=G(Re(e.fragmentShader.replace(`#include <common>`,`#include <common>
...
void main() {
  ...
  gl_FragColor = vec4(best, 1.0);
}`,qt={"1-bit":{gridWidth:110,dither:.6,palette:[`#15120c`,`#c8b486`]},gb:{gridWidth:130,dither:.4,palette:[`#0f380f`,`#306230`,`#8bac0f`,`#9bbc0f`]},"8-bit":{gridWidth:160,dither:.55,palette:[`#140c1c`,`#442434`,`#30346d`,`#4e4a4e`,`#854c30`,`#346524`,`#d04648`,`#757161`,`#597dce`,`#d27d2c`,`#8595a1`,`#6daa2c`,`#d2aa99`,`#6dc2ca`,`#dad45e`,`#deeed6`]},"16-bit":{gridWidth:280,dither:.3,palette:`#000000.#222034.#45283c.#663931.#8f563b.#df7126.#d9a066.#eec39a.#fbf236.#99e550.#6abe30.#37946e.#4b692f.#524b24.#323c39.#3f3f74.#306082.#5b6ee1.#639bff.#5fcde4.#cbdbfc.#ffffff.#9badb7.#847e87.#696a6a.#595652.#76428a.#ac3232.#d95763.#d77bba.#8f974a.#8a6f30`.split(`.`)},modern:{gridWidth:460,dither:.6,palette:null}},Jt=[`gb`,`8-bit`,`16-bit`,`modern`];function Yt(e){let t=Math.max(e.length,1),n=new Float32Array(t*4);e.forEach((e,t)=>{let r=new L(e);n[t*4+0]=r.r,n[t*4+1]=r.g,n[t*4+2]=r.b,n[t*4+3]=1});let r=new re(n,t,1,x,te);return r.minFilter=g,r.magFilter=g,r.needsUpdate=!0,r}var Xt=220,Zt={night:[`#0A0C16`,`#1C2236`,`#3A3A52`,`#5A5A78`,`#8A92B0`],dawn:[`#1A1008`,`#43281A`,`#7A4A30`,`#B07A4E`,`#E8A86A`],noon:[`#16100A`,`#3A2F1E`,`#6B563A`,`#937B54`,`#B89968`],dusk:[`#140A0A`,`#3E1E1A`,`#7A3828`,`#B85A36`,`#F0884A`]},Qt={night:[`#020604`,`#06180E`,`#10401E`,`#1E9040`,`#7FE0FF`],dawn:[`#060603`,`#1A2410`,`#3A6B22`,`#6CC040`,`#FFC060`],noon:[`#050805`,`#0E2912`,`#1E6B2F`,`#3CF06A`,`#FFB000`],dusk:[`#080402`,`#241408`,`#6B4A12`,`#E0A030`,`#FF7030`]};function $t({demo:e=!1,citySeed:n=0,profileIndex:a=0}={}){let o=new oe({antialias:!0,preserveDrawingBuffer:!0});o.shadowMap.enabled=!0,o.shadowMap.type=1,o.shadowMap.autoUpdate=!1,o.shadowMap.needsUpdate=!0;let c=!!(window.matchMedia&&window.matchMedia(`(pointer: coarse)`).matches);o.setPixelRatio(Math.min(window.devicePixelRatio,c?1.5:2)),o.setSize(window.innerWidth,window.innerHeight),o.setClearColor(920327,1),document.body.appendChild(o.domElement);let u=o.getDrawingBufferSize(new A),f=new d;f.fog=new pe(10465470,0);let m=new L(`#aeb6c0`),h=.062,_=new L(`#74508f`),v=new L,y=Oe({aspect:window.innerWidth/window.innerHeight}),b=ot({t:.5}),S={type:r,format:x,minFilter:g,magFilter:g,wrapS:ne,wrapT:ne,depthBuffer:!1,stencilBuffer:!1},C=[new F(256,256,S),new F(256,256,S),new F(256,256,S)];for(let e of C)o.setRenderTarget(e),o.clear();o.setRenderTarget(null);let w=new d,T=new l(-1,1,1,-1,0,1),E=new se({vertexShader:Rt,fragmentShader:zt,uniforms:{uCurr:{value:null},uPrev:{value:null},uTexel:{value:new A(1/256,1/256)},uMouse:{value:new A(-1,-1)},uMouseStrength:{value:0},uC2:{value:.25},uDamping:{value:.992},uRainCount:{value:0},uRainDrops:{value:Array.from({length:8},()=>new z)},uWakeCount:{value:0},uWakeDrops:{value:Array.from({length:8},()=>new z)}}});w.add(new N(new B(2,2),E));let D=new F(u.x,u.y,{minFilter:i,magFilter:i,depthBuffer:!0,stencilBuffer:!1});function te(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);n.fillStyle=e?`#0c1418`:`#15110b`,n.fillRect(0,0,1024,1024),n.strokeStyle=e?`rgba(120,150,170,0.22)`:`rgba(184,153,104,0.30)`,n.lineWidth=2;for(let e=0;e<=1024;e+=64)n.beginPath(),n.moveTo(e,0),n.lineTo(e,1024),n.stroke(),n.beginPath(),n.moveTo(0,e),n.lineTo(1024,e),n.stroke();e||(n.fillStyle=`#B89968`,n.font=`bold 360px Georgia, serif`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillText(`LGR`,512,470),n.font=`600 64px ui-monospace, monospace`,n.fillText(`WEB · STUDIO`,512,720));let r=new O(t);return r.colorSpace=s,r}let k=new N(new B(28,28),new p({map:te(e)}));k.rotation.x=-Math.PI/2,k.position.y=-.35,f.add(k);let re=new N(new B(40,24),new se({depthWrite:!1,vertexShader:It,fragmentShader:Lt,uniforms:{uTime:{value:0},uInk:{value:b.horizon},uGold:{value:b.sky},uFogColor:{value:v},uFogAmt:{value:0},uFogCharm:Fe}}));re.position.set(0,3,-8),f.add(re);let j=new se({vertexShader:Bt,fragmentShader:Vt,uniforms:{uHeight:{value:null},uScene:{value:D.texture},uTexel:{value:new A(1/256,1/256)},uResolution:{value:new A(u.x,u.y)},uDisplace:{value:.42},uNormalStrength:{value:22},uRefractStrength:{value:.06},uChromaScale:{value:1},uNormalMatrix:{value:new t},uLightDir:{value:b.sunDir},uInk:{value:new L(`#2A2218`)},uGold:{value:new L(`#B89968`)},uVector:ke,uVecWater:{value:new L(`#1fb8d8`)},uVecTint:{value:Ae}}}),M=new N(new B(28,28,255,255),j);M.rotation.x=-Math.PI/2,M.updateMatrixWorld(!0),j.uniforms.uNormalMatrix.value.getNormalMatrix(M.matrixWorld),f.add(M);let ie={value:0},ae=At({windowGlow:ie}),I=Qe({seed:n,profileIndex:a,landmarkFactory:ae,windowGlow:ie});f.add(I.group);let ce=dt({plinthTop:.3,extent:I.extent,profile:I.state.profile});f.add(ce.group);let le=vt({extent:I.extent,waterSize:28,plinthTop:.3});f.add(le.group),E.uniforms.uWakeDrops.value=le.wakeDrops;let R=Mt({extent:I.extent});f.add(R.group),E.uniforms.uRainDrops.value=R.rainDrops;let ue=Pt({extent:I.extent});f.add(ue.group),I.group.remove(I.key),f.add(I.key),I.key.castShadow=!0,I.key.shadow.mapSize.set(2048,2048),I.key.shadow.bias=-18e-5,I.key.shadow.normalBias=.028,f.add(I.key.target);function de(){let e=I.key.shadow.camera,t=I.extent+4.5;e.left=-t,e.right=t,e.top=t,e.bottom=-t,e.near=1,e.far=48,e.updateProjectionMatrix(),o.shadowMap.needsUpdate=!0}de();let fe=new ee(u.x,u.y),me=new F(u.x,u.y,{minFilter:i,magFilter:i,depthBuffer:!0,stencilBuffer:!1,depthTexture:fe}),he=new F(u.x,u.y,{minFilter:i,magFilter:i,depthBuffer:!1,stencilBuffer:!1}),ge=new F(u.x,u.y,{minFilter:i,magFilter:i,depthBuffer:!1,stencilBuffer:!1}),_e=new F(u.x,u.y,{minFilter:i,magFilter:i,depthBuffer:!1,stencilBuffer:!1}),V=new d,ve=new l(-1,1,1,-1,0,1),ye=new N(new B(2,2));V.add(ye);let be=new se({vertexShader:Rt,fragmentShader:Ht,uniforms:{uScene:{value:me.texture},uTime:{value:0},uResolution:{value:new A(u.x,u.y)},uGrain:{value:1},uChroma:{value:1},uExposure:{value:1}}}),xe=e=>{let t=e.map(e=>new L(e));for(;t.length<8;)t.push(new L(0,0,0));return t},Se=[`night`,`dawn`,`noon`,`dusk`],Ce={inkgold:Se.map(e=>xe(Zt[e])),terminal:Se.map(e=>xe(Qt[e]))},we=new se({vertexShader:Rt,fragmentShader:Ut,uniforms:{uScene:{value:he.texture},uResolution:{value:new A(u.x,u.y)},uPixelSize:{value:Xt},uPalette:{value:Ce.inkgold[2]},uPaletteB:{value:Ce.inkgold[2]},uPaletteBlend:{value:0},uPaletteSize:{value:5}}}),H=new se({vertexShader:Rt,fragmentShader:Kt,uniforms:{uScene:{value:he.texture},uResolution:{value:new A(u.x,u.y)},uGridWidth:{value:160},uDither:{value:.55},uPalette:{value:Yt(qt[`8-bit`].palette)},uPaletteSize:{value:1},uUsePalette:{value:1}}}),Te={};for(let e of Jt)Te[e]=qt[e].palette?Yt(qt[e].palette):null;let U=new se({vertexShader:Rt,fragmentShader:Wt,uniforms:{uScene:{value:he.texture},uDepth:{value:fe},uResolution:{value:new A(u.x,u.y)},uBands:{value:4},uToonGain:{value:1.7},uToonGamma:{value:.6},uToonFloor:{value:b.toonFloor},uOutline:{value:b.outline},uNear:{value:.1},uFar:{value:100},uIsPerspective:{value:1}}}),Ee=new se({vertexShader:Rt,fragmentShader:Gt,uniforms:{uToon:{value:ge.texture},uPixel:{value:_e.texture},uBlend:{value:0}}});function De(e,t){ye.material=e,o.setRenderTarget(t),o.render(V,ve)}function Le(){y.setViewport(window.innerWidth,window.innerHeight),o.setSize(window.innerWidth,window.innerHeight);let e=o.getDrawingBufferSize(new A);return D.setSize(e.x,e.y),me.setSize(e.x,e.y),he.setSize(e.x,e.y),ge.setSize(e.x,e.y),_e.setSize(e.x,e.y),j.uniforms.uResolution.value.set(e.x,e.y),be.uniforms.uResolution.value.set(e.x,e.y),we.uniforms.uResolution.value.set(e.x,e.y),H.uniforms.uResolution.value.set(e.x,e.y),U.uniforms.uResolution.value.set(e.x,e.y),e}let W=3,G=!1,K=!1,Re=`native`,ze=.3,Be=.46,q=[`native`,...Jt],Ve={"16-bit":`16-bit`,"8-bit":`8-bit`,gb:`Game Boy`,modern:`Modern`,native:`Pixel`,"1-bit":`1-bit`};typeof window<`u`&&(window.__mode=W,window.__vector=G,window.__era=Re);let J=0,He=performance.now(),Y=typeof window<`u`&&new URLSearchParams(window.location.search).has(`perf`);typeof window<`u`&&(window.__perf=Y),Y&&(o.info.autoReset=!1);let X=null;typeof window<`u`&&(window.__loaded=!1);let Ue=0,We=new z(1,1,1),Ge=!1;function Ke(e){let t=K?Ce.terminal:Ce.inkgold,n=e%1*4,r=Math.floor(n)%4;we.uniforms.uPalette.value=t[r],we.uniforms.uPaletteB.value=t[(r+1)%4],we.uniforms.uPaletteBlend.value=n-Math.floor(n)}function qe(e){let t=qt[e];t&&(H.uniforms.uGridWidth.value=t.gridWidth,H.uniforms.uDither.value=t.dither,H.uniforms.uUsePalette.value=+!!t.palette,t.palette&&(H.uniforms.uPalette.value=Te[e],H.uniforms.uPaletteSize.value=t.palette.length))}function Je(){Re!==`native`&&qe(Re)}let Ye=()=>Re===`native`?we:H;function Xe(e,t){M.visible=!1,o.setRenderTarget(D),o.render(f,e),M.visible=!0,o.setRenderTarget(t),o.render(f,e)}function Ze(e,t){if(M.visible=!1,o.setRenderTarget(D),o.render(f,y.camera),M.visible=!0,W===1||G&&W!==7&&W!==8)o.setRenderTarget(t),o.render(f,y.camera);else if(o.setRenderTarget(me),o.render(f,y.camera),W===2)be.uniforms.uGrain.value=1,be.uniforms.uChroma.value=1,De(be,t);else{be.uniforms.uGrain.value=0,be.uniforms.uChroma.value=0,De(be,he);let n=y.camera;U.uniforms.uNear.value=n.near,U.uniforms.uFar.value=n.far,U.uniforms.uIsPerspective.value=+!!n.isPerspectiveCamera;let r=e.era?(qe(e.era),H):Ye();e.kind===`pixel`?(De(r,t),window.__style=`pixel`):e.kind===`toon`?(De(U,t),window.__style=`toon`):(De(U,ge),De(r,_e),Ee.uniforms.uBlend.value=e.blend,De(Ee,t),window.__style=`blend`)}}function $e(){let e=et(),t=e.kind===`toon`?1:e.kind===`blend`?1-e.blend:0;return j.uniforms.uChromaScale.value=P.lerp(1,.5,t),e}function et(){if(W===1||W===2)return{kind:`none`};if(W===7)return{kind:`pixel`};if(W===8)return{kind:`toon`};let e=y.styleT;return window.__styleT=e,e<=ze?{kind:`toon`}:e>=Be?{kind:`pixel`,era:e<.62?`16-bit`:e<.8?`8-bit`:`gb`}:{kind:`blend`,blend:P.smoothstep(e,ze,Be),era:`16-bit`}}function tt(e){return W===1||W===2?``:G&&W!==7&&W!==8?`Vector`:e.kind===`toon`?`Toon`:e.kind===`pixel`?Ve[e.era||Re]||`Pixel`:e.kind===`blend`?`Toon → `+(Ve[e.era]||`Pixel`):``}function nt(e,t,{shadowsOn:n=!0,seasonTarget:r=0}={}){if(Y){let e=o.info;X={calls:e.render.calls,tris:e.render.triangles,programs:e.programs?e.programs.length:0,geo:e.memory.geometries,tex:e.memory.textures},e.reset()}re.material.uniforms.uTime.value=t,be.uniforms.uTime.value=t,b.update(e),I.key.position.copy(b.sunDir).multiplyScalar(24),I.key.color.copy(b.sunColor),I.key.intensity=b.sunIntensity,I.fill.color.copy(b.hemiSky),I.fill.groundColor.copy(b.hemiGround),ie.value=b.windowGlow;let i=R.overcast;I.key.intensity*=1-.5*i,I.key.color.lerp(m,.45*i),I.fill.intensity=1+.7*i;let a=P.smoothstep(b.sunDir.y,.06,.34),s=P.lerp(.28,1,1-b.windowGlow),c=n?a*s:0;I.key.shadow.intensity=.72*c,je.value=.52*c,(n&&!Ge||We.distanceToSquared(b.sunDir)>2e-5)&&(o.shadowMap.needsUpdate=!0,We.copy(b.sunDir)),Ge=n;let l=1-b.windowGlow;Ae.setRGB(P.lerp(.46,1,l),P.lerp(.52,1,l),P.lerp(.74,1,l)),be.uniforms.uExposure.value=b.exposure,U.uniforms.uToonGain.value=b.toonGain,o.setClearColor(b.horizon,1),Ke(b.t),window.__t=b.t,ce.update(e,t,b),I.update(t),le.update(e,t,b),E.uniforms.uWakeCount.value=le.wakeCount,R.update(e,t),E.uniforms.uRainCount.value=R.rainDropCount;let u=R.fog*(1-l);f.fog.density=R.fog*h,v.copy(b.horizon).lerp(_,.85*u),f.fog.color.copy(v),o.setClearColor(v,1),Fe.value=R.fog,re.material.uniforms.uFogAmt.value=.7*R.fog,Me.value=R.snow,Ne.value=R.cloud*.55,Pe.x+=e*.018,Pe.y+=e*.009,Ie.value+=(r-Ie.value)*Math.min(1,e*1.5),ue.update(e,t,b,R),J++;let d=performance.now();d-He>=1e3&&(window.__fps=J,Y&&X&&(console.log(`[perf] ${J} fps · ~${(1e3/Math.max(1,J)).toFixed(2)} ms · calls ${X.calls} · tris ${X.tris} · programs ${X.programs} · geo ${X.geo} · tex ${X.tex}`),window.__perfInfo={fps:J,...X}),J=0,He=d);let[p,g,y]=C;if(E.uniforms.uPrev.value=p.texture,E.uniforms.uCurr.value=g.texture,o.setRenderTarget(y),o.render(w,T),C=[g,y,p],j.uniforms.uHeight.value=C[1].texture,Ue<2&&typeof document<`u`&&++Ue===2){let e=document.getElementById(`lgr-loader`);e&&e.classList.add(`gone`),window.__loaded=!0}}function rt(e){W=e,window.__mode=W}function it(){return G=!G,ke.value=+!!G,window.__vector=G,G}function at(e){return G=!!e,ke.value=+!!G,window.__vector=G,G}function st(){return Re=q[(q.indexOf(Re)+1)%q.length],window.__era=Re,Je(),Re}function ct(){return K=!K,K}return{updateWorld:nt,decideStyle:$e,renderCityPipeline:Ze,renderCityBeautyTo:Xe,styleHintName:tt,setPostMode:rt,toggleVector:it,setVector:at,cycleEra:st,togglePalette:ct,get mode(){return W},get vector(){return G},get sceneEra(){return Re},renderer:o,drawBuffer:u,scene:f,rig:y,sunRig:b,SIM:256,targets:C,simScene:w,simCamera:T,simMaterial:E,grabRT:D,card:k,backdrop:re,WATER_SIZE:28,water:M,waterMaterial:j,windowGlow:ie,landmarkFactory:ae,city:I,cityLife:ce,waterLife:le,weatherRig:R,clouds:ue,fitShadowFrustum:de,SHADOW_DIST:24,sceneDepth:fe,sceneRT:me,filmicRT:he,toonRT:ge,pixelRT:_e,postScene:V,postCamera:ve,postQuad:ye,filmicMaterial:be,pixelMaterial:we,pixelkitMaterial:H,toonMaterial:U,mixMaterial:Ee,PALCACHE:Ce,ERA_TEX:Te,runPass:De,OVERCAST_GREY:m,FOG_DENSITY:h,FOG_NIGHT_TINT:_,_fogColor:v,resize:Le}}var en=`lgr_hints_`,tn=!1;function nn(){if(tn||typeof document>`u`)return;tn=!0;let e=document.createElement(`style`);e.textContent=`
